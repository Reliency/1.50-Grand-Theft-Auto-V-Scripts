...
void func_1()
{
	switch (iLocal_80)
	{
		...
		case 1:
			...
			func_221(&uLocal_83, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
{
	if (((!func_245(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_244(0)) || func_243(1))
			{
			}
			else
			{
...
void func_250(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_255(*iParam1, 0, &uVar0))
		{
...
int func_255(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_282(iVar0, bParam1, uParam2) && !func_281(PLAYER_ID())) && !func_265(iParam0))
	{
		return 0;
	}
	if (func_281(PLAYER_ID()))
	{
		if (func_264(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_263(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_261(iParam0)) && !bVar1) && !(func_260(IS_BIG_VEHICLE(iParam0)) && func_257(IS_BIG_VEHICLE())))
	{
	...
	{
		if ((func_256(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_280(PLAYER_ID()) || func_279(PLAYER_ID()))
	{
		if (func_266(iParam0))
		{
			return 1;
...
int func_267(int iParam0)
{
	...
	if (func_268(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_269(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_271(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_282(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_263(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_286(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_303(iParam0, 0, 0)) || func_303(iParam0, 1, 0)) || func_303(iParam0, 2, 0)) || func_302(iParam0) != 145) || func_301(iParam0)) || func_300(iParam0)) || func_256(iParam0)) || func_299(iParam0)) || !func_289(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_300(iParam0))
		{
		}
...
int func_308(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_278(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_311(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_311(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_310(iParam0);
	if (func_309(*iParam0))
	{
...
void func_314(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_315(iParam0, iParam1))
				{
	...
	if (func_341(uParam0))
	{
		...
		if (func_340(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_326(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_326(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_328(iParam0, uVar1[iVar3], 1) && func_327(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_322(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_329(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_286(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_286(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_286(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_332(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_331())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_286(iVar2 + 1)))
				{
...
void func_368(bool bParam0)
{
	...
	if (!func_389())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_369(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_370(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_376())
	{
		...
		{
			iVar2 = func_371(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
