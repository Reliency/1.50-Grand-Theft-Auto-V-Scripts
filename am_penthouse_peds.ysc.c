...
void __EntryFunction__()
{
	...
	{
		func_47();
		if ((!NETWORK_IS_GAME_IN_PROGRESS() || func_35()) || Global_1316819 == 0)
		{
			func_32();
		}
		func_3();
...
void func_1()
{
	...
	if (iLocal_21 == 1)
	{
		...
		if (iVar0 > -1)
		{
			if (DOES_ENTITY_EXIST(Local_23[iVar0 /*13*/]) && !DOES_ENTITY_EXIST(Local_23[iVar0 /*13*/], 0))
			{
				PLAY_STREAM_FROM_PED(Local_23[iVar0 /*13*/]);
				iLocal_21++;
			}
		}
	}
...
void func_3()
{
	...
	while (iVar0 < 50)
	{
		...
		{
			if (!DOES_ENTITY_EXIST(Local_23[iVar0 /*13*/]))
			{
				func_11(&(Local_23[iVar0 /*13*/]));
			}
			else if (IS_ENTITY_DEAD(Local_23[iVar0 /*13*/], 0))
			{
	...
	if (iVar3 != 0 && iVar3 != 1)
	{
		if (HAS_ANIM_DICT_LOADED(sVar0))
		{
			...
			if (!func_7(uParam0))
			{
				if (func_6(uParam0))
				{
					TASK_PLAY_ANIM_ADVANCED(0, sVar0, sVar1, uParam0->f_6, 0f, 0f, uParam0->f_9, 8f, -8f, -1, 790529, fVar2, 2, 3);
				}
				else
				{
			...
			else
			{
				...
				while (iVar8 < 4)
				{
					...
					{
						case 0:
							TASK_PLAY_ANIM(0, sVar0, "IDLE_A", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 1:
							TASK_PLAY_ANIM(0, sVar0, "IDLE_B", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 2:
							TASK_PLAY_ANIM(0, sVar0, "IDLE_C", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 3:
							TASK_PLAY_ANIM(0, sVar0, "IDLE_D", 8f, -8f, -1, 0, 0f, 0, 0, 0);
							break;
					}
					iVar8++;
				}
...
void func_11(var uParam0)
{
	if (iLocal_20 < 2)
	{
		...
		if (func_28(uParam0))
		{
			*uParam0 = CREATE_PED(26, func_26(uParam0), uParam0->f_6, uParam0->f_9, 0, false);
			if (DOES_ENTITY_EXIST(*uParam0))
			{
				...
				if (func_16(uParam0))
				{
					...
					{
						uParam0->f_1 = CREATE_OBJECT(func_15(uParam0), CREATE_OBJECT(*uParam0, func_14(uParam0), 0f, 0f, 0f), false, false, false);
						ATTACH_ENTITY_TO_ENTITY(uParam0->f_1, *uParam0, ATTACH_ENTITY_TO_ENTITY(*uParam0, func_14(uParam0)), func_13(uParam0), 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
					}
				}
				if (func_7(uParam0))
				{
...
int func_28(var uParam0)
{
	if (func_30(uParam0))
	{
		if (HAS_MODEL_LOADED(func_26(uParam0)) && HAS_MODEL_LOADED(func_9(uParam0)))
		{
			if (func_7(uParam0))
			{
...
void func_54()
{
	while (!_NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT_2(32, 0, Global_1316834))
	{
		wait(0);
	}
	Global_1316834++;
