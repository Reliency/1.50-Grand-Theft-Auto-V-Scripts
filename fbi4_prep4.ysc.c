...
void func_23()
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				TASK_LOOK_AT_COORD(TASK_LOOK_AT_COORD(), -1335.905f, -1278.671f, 5.07569f, -1, 0, 2);
				iLocal_81 = 1;
			}
			break;
		
		case 1:
			if (func_93(PLAYER_PED_ID(), vLocal_196, 2f) && func_87(21))
			{
			...
			else
			{
				...
				else if (!func_93(PLAYER_PED_ID(), vLocal_195, 75f))
				{
					if (!iLocal_201)
					{
						func_22(&iLocal_192);
				...
				else if (func_93(PLAYER_PED_ID(), vLocal_196, 12f))
				{
					if (iLocal_201)
					{
						func_22(&iLocal_192);
...
int func_94(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (bParam1)
			{
				func_95(PLAYER_PED_ID(), vLocal_196, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_101()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_197)
			{
				if (func_93(PLAYER_PED_ID(), vLocal_195, 60f))
				{
		...
		case 3:
			func_95(PLAYER_PED_ID(), vLocal_196, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
void func_116(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
...
int func_121(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_148(iVar0, bParam1, uParam2) && !func_147(PLAYER_ID())) && !func_131(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_129(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_127(iParam0)) && !bVar1) && !(func_126(IS_BIG_VEHICLE(iParam0)) && func_123(IS_BIG_VEHICLE())))
	{
...
{
	if (func_146(PLAYER_ID()) || func_145(PLAYER_ID()))
	{
		if (func_132(iParam0))
		{
			return 1;
...
int func_133(int iParam0)
{
	...
	if (func_134(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_148(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_129(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_152(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_170(iParam0, 0, 0)) || func_170(iParam0, 1, 0)) || func_170(iParam0, 2, 0)) || func_169(iParam0) != 145) || func_168(iParam0)) || func_167(iParam0)) || func_122(iParam0)) || func_166(iParam0)) || !func_156(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_167(iParam0))
		{
		}
...
int func_175(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_144(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_178(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_178(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_177(iParam0);
	if (func_176(*iParam0))
	{
...
void func_181(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_182(iParam0, iParam1))
				{
	...
	if (func_210(uParam0))
	{
		...
		if (func_209(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_196(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_196(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_197(iParam0, uVar1[iVar3], 1) && func_98(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_192(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_198(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_152(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_152(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_152(iVar1 + 1));
			}
		}
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_152(iVar2 + 1)))
				{
...
void func_220()
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_93(PLAYER_PED_ID(), vLocal_195, 150f))
				{
					func_226(2);
				}
				else if (!func_93(PLAYER_PED_ID(), vLocal_195, 75f))
...
void func_239(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_241() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_241() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_240(iParam0));
...
bool func_245(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_241() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_284(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_277(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_277(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_285(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_343(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		vVar5 = { vVar3 - vVar4 };
		vVar5 = { vVar5 / FtoV(sqrt(((vVar5.x * vVar5.x) + (vVar5.y * vVar5.f_1)))) };
