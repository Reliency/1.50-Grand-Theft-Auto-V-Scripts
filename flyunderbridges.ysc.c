			...
			if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
			{
				...
				switch (iLocal_27)
				{
					case 0:
						...
						{
							if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), vLocal_39[iLocal_31 /*3*/]) < fLocal_40)
							{
								if (IS_PED_IN_ANY_HELI(IS_PED_IN_ANY_HELI()) || IS_PED_IN_ANY_HELI(IS_PED_IN_ANY_HELI()))
								{
									...
									if (IS_VEHICLE_DRIVEABLE(IS_VEHICLE_DRIVEABLE(IS_VEHICLE_DRIVEABLE(), 0), 0))
									{
										if (func_15())
										{
											if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0))
											{
												bLocal_33 = true;
												iLocal_27 = 1;
											}
											if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
											{
												bLocal_34 = true;
												iLocal_27 = 1;
											}
					...
					case 1:
						if (!IS_PED_INJURED(IS_PED_INJURED()))
						{
							...
							else if (!IS_ENTITY_IN_AIR(IS_ENTITY_IN_AIR(IS_ENTITY_IN_AIR(), 0)))
							{
								func_14();
							}
							if (bLocal_33)
							{
								if (iLocal_37)
								{
									if (iLocal_36)
									{
										if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0) && !IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
										{
											func_14();
											func_1();
									...
									else if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
									{
										iLocal_36 = 1;
									}
									else if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0) && !IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
...
void func_1()
{
	...
	if (iLocal_31 < 32)
	{
		bVar0 = IS_BIT_SET(Global_111560.f_10044.f_96, iLocal_31);
	}
	else if (iLocal_31 < 64)
	{
		bVar0 = IS_BIT_SET(Global_111560.f_10044.f_97, (iLocal_31 - 32));
	}
	else
	{
		bVar0 = IS_BIT_SET(Global_111560.f_10044.f_98, (iLocal_31 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (iLocal_31 < 32)
		{
			SET_BIT(&(Global_111560.f_10044.f_96), iLocal_31);
		}
		else if (iLocal_31 < 64)
		{
			SET_BIT(&(Global_111560.f_10044.f_97), (iLocal_31 - 32));
		}
		else
		{
			SET_BIT(&(Global_111560.f_10044.f_98), (iLocal_31 - 64));
		}
		Global_95144 = 1;
		func_30();
		iLocal_29 = 1;
...
int func_15()
{
	if (bLocal_38)
	{
		...
		{
			if (GET_ENTITY_UPRIGHT_VALUE(GET_ENTITY_UPRIGHT_VALUE(GET_ENTITY_UPRIGHT_VALUE(), 0)) > -0.6f && GET_ENTITY_UPRIGHT_VALUE(GET_ENTITY_UPRIGHT_VALUE(GET_ENTITY_UPRIGHT_VALUE(), 0)) < 0.6f)
			{
				return 1;
			}
		}
...
void func_16()
{
	if ((GET_GAME_TIMER() - iLocal_48) > 500)
	{
		if (iLocal_31 == 29)
		{
			if (IS_BIT_SET(Global_111560.f_10044.f_96, iLocal_31))
			{
				bLocal_47 = true;
			}
		}
	...
	switch (iLocal_28)
	{
		case 0:
			if (iLocal_29 && !bLocal_47)
			{
				if (!func_23())
				{
					iLocal_30 = 0x67D02A194A2FC2BD("MIDSIZED_MESSAGE");
					...
					{
						func_22("FU_KNIFE");
						_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(15);
					}
					else
					{
						func_22("FU_TITLE");
						_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(50);
					}
					func_22("FU_PASS");
					if (bLocal_38)
					{
					...
					_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_30());
		...
		case 1:
			if ((((((timerb() > 3750 || IS_SCREEN_FADED_OUT()) || !IS_SCREEN_FADED_OUT(IS_SCREEN_FADED_OUT())) || func_23()) || !IS_SCREEN_FADED_OUT(IS_SCREEN_FADED_OUT())) || func_21()) || func_20())
			{
		...
		case 2:
			if ((((((timerb() > 500 || IS_SCREEN_FADED_OUT()) || !IS_SCREEN_FADED_OUT(IS_SCREEN_FADED_OUT())) || func_23()) || !IS_SCREEN_FADED_OUT(IS_SCREEN_FADED_OUT())) || func_21()) || func_20())
			{
				iLocal_28 = 3;
			}
			else
...
void func_26()
{
	...
	{
		if (IS_BIT_SET(Global_111560.f_10044.f_97, (iLocal_31 - 32)))
		{
			bLocal_47 = true;
		}
	}
	else if (IS_BIT_SET(Global_111560.f_10044.f_98, (iLocal_31 - 64)))
	{
		bLocal_47 = true;
	}
	if (bLocal_47)
...
void func_45()
{
	...
	{
		func_48(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_49()
{
	...
	while (iVar1 < 32)
	{
		if (IS_BIT_SET(Global_111560.f_10044.f_96, iVar1))
		{
			if (func_50(iVar1))
			{
				iVar0++;
		...
		if (IS_BIT_SET(Global_111560.f_10044.f_97, iVar1))
		{
			if (func_50(iVar1 + 32))
			{
				iVar0++;
		...
		if (IS_BIT_SET(Global_111560.f_10044.f_98, iVar1))
		{
			if (func_50(iVar1 + 64))
			{
				iVar0++;
