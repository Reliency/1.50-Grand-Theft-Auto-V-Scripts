...
void __EntryFunction__()
{
	...
	if (func_463(Local_54.f_28[0]))
	{
		...
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_61, true, 1);
	}
	func_462();
	if (func_461())
	{
...
void func_9()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			else if (func_232(PLAYER_PED_ID(), iLocal_61) > 250f)
			{
				if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
				{
					iLocal_60 = 2;
			...
			else
			{
				...
				{
					TASK_SMART_FLEE_PED(iLocal_61, TASK_SMART_FLEE_PED(), 250f, -1, 0, 0);
				}
				if (iLocal_230 == 0)
				{
					if (((!func_229() && func_228(iLocal_61, PLAYER_PED_ID(), 20f, 1)) && !PLAYER_PED_ID(iLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_230 = 1;
					}
				}
				else if (((((iLocal_238 < 15 && !func_229()) && (GET_GAME_TIMER() - iLocal_235) > 10000) && func_228(iLocal_61, GET_GAME_TIMER(), 20f, 1)) && !GET_GAME_TIMER(iLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
void func_238(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_263(iParam1) && IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_244(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_251() || func_250(Global_4456448.f_190930)) || func_249())
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			iVar1 = func_248(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(iVar0, iVar1) || (_0xE33FFA906CE74880(iVar0) == 562680400 && iVar1 != -1)) || (_0xE33FFA906CE74880(iVar0) == 1181327175 && iVar1 != -1)) || (((_0xE33FFA906CE74880(iVar0) == -1693015116 && iVar1 == 0) && func_247(iVar0, 10)) && _0xE33FFA906CE74880(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_245(int iParam0)
{
	if (iParam0 != func_217())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_246(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_258(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_261(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1) || func_259(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_265()
{
	if (!DOES_BLIP_EXIST(iLocal_62) && func_463(iLocal_61))
	{
		iLocal_62 = func_266(iLocal_61, 1, 0, 5);
	}
	if (DOES_BLIP_EXIST(iLocal_62) && DOES_BLIP_EXIST(iLocal_62) != 1)
	{
...
void func_267()
{
	switch (iLocal_60)
	{
		...
		case 1:
			...
			{
				if (((iLocal_232 == 0 && !func_229()) && func_228(iLocal_61, PLAYER_PED_ID(), 20f, 1)) && func_211(&uLocal_65, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_232 = 1;
					func_265();
				}
				if (func_232(PLAYER_PED_ID(), iLocal_61) > 250f)
				{
					iLocal_60 = 2;
				}
			}
...
void func_269()
{
	...
	{
		case 0:
			iLocal_243 = ADD_SCENARIO_BLOCKING_AREA(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
			func_297();
			if (func_463(iLocal_61))
			{
				func_295();
				if (func_3(iLocal_56))
				{
					...
					if (!IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 0))
					{
					...
					TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, iLocal_56, vLocal_239, 20f, 786469, 10f);
					TASK_VEHICLE_PARK(0, iLocal_56, vLocal_239, 49.567f, 3, 1092616192, 0);
					TASK_LEAVE_VEHICLE(0, iLocal_56, 256);
					TASK_SMART_FLEE_PED(0, TASK_SMART_FLEE_PED(), 250f, -1, 0, 0);
					CLOSE_SEQUENCE_TASK(iLocal_236);
					TASK_PERFORM_SEQUENCE(iLocal_61, iLocal_236);
				}
				else
				{
					TASK_WANDER_STANDARD(iLocal_61, 1193033728, 0);
				}
			}
		...
		case 1:
			...
			else if (IS_ENTITY_AT_COORD(iLocal_61, vLocal_239, 5f, 5f, 5f, false, true, 0))
			{
				func_234(3);
			}
			else
			{
				...
				if (iLocal_231 == 0)
				{
					if (((func_463(iLocal_56) && IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 1)) && func_228(iLocal_61, IS_PED_IN_VEHICLE(), 20f, 1)) && func_211(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_231 = 1;
					}
					if (((((iLocal_237 < 7 && !func_229()) && (GET_GAME_TIMER() - iLocal_234) > 10000) && func_228(iLocal_61, GET_GAME_TIMER(), 20f, 1)) && !GET_GAME_TIMER(iLocal_61)) && func_211(&uLocal_65, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_234 = GET_GAME_TIMER();
						iLocal_237++;
					}
	...
	if (DOES_BLIP_EXIST(*iParam0))
	{
		if ((GET_GAME_TIMER() - *iParam3) > 500)
		{
			if (GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_271(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_271(sParam2, 0, 0))
					{
...
int func_274()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()) && IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()) > 0)
	{
		return 1;
	}
	if (func_463(iLocal_56))
	{
		...
		if (func_463(iLocal_56))
		{
			if (IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 0) && IS_PED_IN_VEHICLE(iLocal_56, IS_PED_IN_VEHICLE(), 1))
			{
				return 1;
			}
			if (((IS_VEHICLE_TYRE_BURST(iLocal_56, 0, 0) || IS_VEHICLE_TYRE_BURST(iLocal_56, 1, 0)) || IS_VEHICLE_TYRE_BURST(iLocal_56, 4, 0)) || IS_VEHICLE_TYRE_BURST(iLocal_56, 5, 0))
			{
				return 1;
			}
		}
...
int func_275(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_463(PLAYER_PED_ID()) && func_463(iParam0))
	{
...
int func_276(int iParam0, float fParam1)
{
	...
	if (func_463(PLAYER_PED_ID()) && func_463(iParam0))
	{
		if (func_287(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 6))
			{
				fVar0 = 40f;
...
int func_282(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_284(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_284(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_292(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_284(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_295()
{
	if (func_463(iLocal_61))
	{
		...
		SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_61, 0);
		SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_61, 0);
	}
}
...
void func_297()
{
	if (!func_463(iLocal_56))
	{
		iLocal_56 = CREATE_VEHICLE(iLocal_55, vLocal_57, fLocal_58, true, true, false);
	...
	if (func_463(iLocal_56))
	{
		...
		_0x2B6747FAA9DB9D6B(iLocal_56, 1);
	}
}
		...
		case 1:
			switch (iLocal_241)
			{
				...
				case 2:
					if (IS_CUTSCENE_PLAYING())
					{
						if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_498(16)) && func_463(iLocal_61))
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
						}
					...
					else
					{
						...
						if (iLocal_240 == 1)
						{
							if (func_463(iLocal_61))
							{
								...
								TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_61, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
								_0x2208438012482A1A(iLocal_61, 0, 0);
							}
...
void func_303(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_305() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_305() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_304(iParam0));
...
bool func_307(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_305() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_331(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_335(IS_PED_INJURED())) && !func_333(IS_PED_INJURED(), 0)) && !func_332()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_335(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_341(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_342(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_353(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		if ((!IS_PED_IN_ANY_HELI(IS_PED_IN_ANY_HELI()) && !IS_PED_IN_ANY_HELI(IS_PED_IN_ANY_HELI())) && !IS_PED_IN_ANY_HELI(IS_PED_IN_ANY_HELI()))
		{
			...
			{
				iVar0 = 0;
				if (!func_230(PLAYER_PED_ID(), -828834893))
				{
...
void func_360()
{
	...
	if ((!func_229() && HAS_ADDITIONAL_TEXT_LOADED(0)) && HAS_ADDITIONAL_TEXT_LOADED(iLocal_55))
	{
		...
		if (func_463(Local_54.f_35[0]))
		{
			...
			SET_ENTITY_AS_MISSION_ENTITY(iLocal_56, true, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_55);
		}
		iLocal_59 = 1;
	}
...
{
	if (((!func_381(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_253(0)) || func_380(1))
			{
			}
			else
			{
...
void func_384(int iParam0)
{
	...
	if (!func_389())
	{
		func_387(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 1112014848, 12, 5000, 0, 0);
	}
	func_386(0, -1, 1);
	func_385(1, 1, 1);
}
...
void func_390(vector3 vParam0, float fParam1, vector3 vParam2, float fParam3, vector3 vParam4, float fParam5, vector3 vParam6, float fParam7)
{
	...
	if (func_346(vParam0))
	{
		...
		SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), iVar0, -1);
		func_394(&iVar0);
	}
	else if (!func_461())
	{
		func_339(PLAYER_PED_ID(), vParam0, fParam1, 0, 1);
	}
	REQUEST_MODEL(iLocal_55);
	...
	iLocal_56 = CREATE_VEHICLE(iLocal_55, vParam6, fParam7, true, true, false);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, true);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_55);
	func_297();
	if (func_346(vParam4))
...
void func_396(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_160(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_401(*iParam1, 0, &uVar0))
		{
...
int func_401(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_427(iVar0, bParam1, uParam2) && !func_426(PLAYER_ID())) && !func_410(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_408(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_406(iParam0)) && !bVar1) && !(func_405(IS_BIG_VEHICLE(iParam0)) && func_403(IS_BIG_VEHICLE())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_402(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_425(PLAYER_ID()) || func_424(PLAYER_ID()))
	{
		if (func_411(iParam0))
		{
			return 1;
...
int func_412(int iParam0)
{
	...
	if (func_413(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_414(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_416(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_427(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_408(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_431(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_347(iParam0, 0, 0)) || func_347(iParam0, 1, 0)) || func_347(iParam0, 2, 0)) || func_447(iParam0) != 145) || func_446(iParam0)) || func_445(iParam0)) || func_402(iParam0)) || func_444(iParam0)) || !func_434(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_445(iParam0))
		{
		}
...
void func_449(var uParam0)
{
	if (!func_450(*uParam0))
	{
		SET_VEHICLE_EXTRA(*uParam0, 5, !Global_111560.f_9080.f_99.f_58[119]);
	}
}
...
int func_451(var uParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (iVar1 == 22)
		{
			if ((*uParam1)[iVar0] > 0)
			{
				...
				if ((*uParam1)[iVar0] == 1)
				{
					0xE41033B25D003A07(*uParam0, 255);
				}
				else
				{
					0xE41033B25D003A07(*uParam0, ((*uParam1)[iVar0] - 2));
				}
			}
			else
			{
	...
	if (func_423(GET_ENTITY_MODEL(*uParam0), 1) && GET_ENTITY_MODEL(*uParam0, 24) != func_454(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_454(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_453(uParam0);
	if (func_452(*uParam0))
	{
...
void func_464(int iParam0)
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_243, 0);
	if (iParam0 == 1)
	{
