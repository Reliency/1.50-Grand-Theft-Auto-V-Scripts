						...
						else
						{
							...
							if (iLocal_57 == -1)
							{
								...
								if (iLocal_64)
								{
									...
									{
										if (!IS_BIT_SET(Global_4269615, 17))
										{
											SET_BIT(&Global_4269615, 17);
...
void func_4()
{
	if (Global_51873 != -1)
	{
		SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(func_13(Global_51873));
		Global_51873 = -1;
	}
	Global_42564 = 0;
...
void func_5()
{
	...
	switch (Global_19486.f_1)
	{
		case 6:
			...
			if (Global_7961 == 1)
			{
				func_61(Global_19467, "DISPLAY_VIEW", 1f, to_float(Global_19490), -1082130432, -1082130432, -1082130432);
				Global_19466 = Global_19490;
			}
			else
			{
				func_61(Global_19467, "DISPLAY_VIEW", 1f, to_float(Global_19491), -1082130432, -1082130432, -1082130432);
		...
		case 9:
			...
			{
				func_9();
				func_61(Global_19467, "SET_THEME", to_float(Global_111560.f_14046[Global_19486 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_20818)
				{
				...
				{
					func_10(Global_19467, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_117[Global_6671 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_10(Global_19467, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_1798[Global_6671 /*29*/].f_3), &(Global_1798[Global_6671 /*29*/].f_7), "CELL_217", &(Global_1798[Global_6671 /*29*/].f_3), 0);
				}
				func_61(Global_19467, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_20805 == 4 || Global_20805 == 3)
			{
				...
				else
				{
					...
					if (func_7(Global_6671, Global_19486) == 0)
					{
						...
						func_10(Global_19467, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_117[Global_6671 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_61(Global_19467, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_10(Global_19467, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_1798[Global_6671 /*29*/].f_3), &(Global_1798[Global_6671 /*29*/].f_7), &cVar0, &(Global_1798[Global_6671 /*29*/].f_3), 0);
					}
				}
				func_61(Global_19467, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (Global_2458994)
							{
								if (iVar1 == 14)
								{
									func_10(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(Global_21868), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_7925[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_10(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(Global_21873), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76577)
								{
									...
									func_10(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19486)
									...
									func_10(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7363[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_10(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_10(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_7925[iVar0] = 1;
						}
					}
...
void func_14()
{
	...
	if (!iLocal_60)
	{
		...
		{
			iLocal_60 = 1;
			BEGIN_SCALEFORM_MOVIE_METHOD(Global_19467, "SET_INPUT_EVENT");
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
			END_SCALEFORM_MOVIE_METHOD();
	...
	if (!iLocal_59)
	{
		if (IS_CONTROL_PRESSED(2, 176) && timerb() > 100)
		{
			if (iLocal_56 == -1)
			{
				...
				iLocal_49 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
				while (!_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_49))
				{
					wait(0);
				}
				iLocal_50 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_49);
				iLocal_56 = iLocal_50;
				if (func_36(iLocal_51) == 0)
				{
					iLocal_56 = -1;
...
void func_25(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_26(_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_27(iParam1)), 0));
		}
		else
		{
			func_26(_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_27(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
	...
	if (!bVar5)
	{
		...
		if (Global_45899[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar11 < iVar9)
			{
				...
				BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(9);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar11 + 1);
		...
		else
		{
			...
			if (!bVar19)
			{
				...
				if (Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/].f_6 > 0)
				{
					...
					{
						ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_51874[iVar13 /*203*/].f_10[iVar3 /*48*/].f_7[iVar20 /*4*/]));
						iVar20++;
					}
					END_TEXT_COMMAND_SCALEFORM_STRING();
				}
...
int func_54(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar5 < 16)
	{
		...
		if (bVar7)
		{
			...
			ADD_TEXT_COMPONENT_INTEGER(Global_111560.f_24899[iVar6 /*4*/].f_3);
			END_TEXT_COMMAND_SCALEFORM_STRING();
			END_SCALEFORM_MOVIE_METHOD();
			iVar2++;
			iVar0 = 1;
...
void func_58(int iParam0, int iParam1)
{
	...
	Global_51873 = iVar5;
	REQUEST_STREAMED_TEXTURE_DICT(func_13(iVar5), false);
	while (!HAS_STREAMED_TEXTURE_DICT_LOADED(func_13(iVar5)))
	{
		wait(100);
	}
}
...
void func_60()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			_REMOVE_NOTIFICATION(Global_42569[iVar0]);
...
float func_66(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)
{
	...
	fVar1 = func_68((to_float((GET_GAME_TIMER() - iLocal_18)) / fParam4), 0f, 1f);
	if (fVar1 < 1f)
	{
		fVar2 = fVar1;
		if (bParam5)
...
void func_72(bool bParam0)
{
	...
	if (bParam0)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(Global_19467, "SET_SOFT_KEYS");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
