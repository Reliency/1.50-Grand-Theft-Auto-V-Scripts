...
void func_1()
{
	...
	if (iLocal_219)
	{
		...
		{
			if ((((!func_183() && !IS_PED_FLEEING(iLocal_53)) && !IS_PED_FLEEING(iLocal_53)) && !IS_PED_FLEEING(iLocal_53)) && !IS_PED_FLEEING(iLocal_53))
			{
				if (func_182(iLocal_53, PLAYER_PED_ID(), 1) <= 3f)
				{
			...
			if (func_182(iLocal_53, PLAYER_PED_ID(), 1) > 150f)
			{
				func_170(&iLocal_53);
			}
		}
	...
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()) && func_168(0))
	{
		switch (iLocal_222)
		{
			case 0:
				if (func_189(91) && IS_PLAYER_CONTROL_ON(IS_PLAYER_CONTROL_ON()))
				{
					func_165(4, 10, 1);
					...
					iLocal_226 = (Global_111560.f_10044.f_104 + 2 % func_148(GET_CLOCK_MONTH(), GET_CLOCK_MONTH()));
				...
				else if (!func_189(91))
				{
					if (iLocal_50 == 0)
					{
						if (func_145())
						{
							func_144(&uLocal_54, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
			...
			case 1:
				iLocal_223 = func_157();
				iLocal_226 = (Global_111560.f_10044.f_104 + 2 % func_148(GET_CLOCK_MONTH(), GET_CLOCK_MONTH()));
				if ((((func_142(iLocal_223, iLocal_225) || GET_CLOCK_DAY_OF_MONTH() == iLocal_226) && GET_CLOCK_DAY_OF_MONTH(GET_CLOCK_DAY_OF_MONTH())) && GET_CLOCK_DAY_OF_MONTH(GET_CLOCK_DAY_OF_MONTH()) != GET_CLOCK_DAY_OF_MONTH("V_Michael_1_M_Ward")) && GET_CLOCK_DAY_OF_MONTH(GET_CLOCK_DAY_OF_MONTH()) != GET_CLOCK_DAY_OF_MONTH("V_Michael_1_Master"))
				{
			...
			case 2:
				if ((func_47(PLAYER_PED_ID(), 12, iLocal_47) && PLAYER_PED_ID(PLAYER_PED_ID())) && !PLAYER_PED_ID())
				{
			...
			case 3:
				if (!func_47(PLAYER_PED_ID(), 12, iLocal_47) && !func_45())
				{
					iLocal_222 = 2;
				}
				...
				if (iLocal_48)
				{
					if ((IS_PLAYER_CONTROL_ON(IS_PLAYER_CONTROL_ON()) && !IS_PLAYER_CONTROL_ON()) && !func_44(14))
					{
...
void func_11()
{
	...
	{
		if (func_138(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
{
	return (shift_right(iParam0, 26) & 31 * func_38(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_40()
{
	if (((!func_43() && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0)) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD())) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (iLocal_49 == 1)
		{
			if (IS_PED_WALKING(IS_PED_WALKING()) || IS_PED_WALKING(IS_PED_WALKING()))
			{
				func_41(PLAYER_PED_ID(), "CULT_TALK", 4);
				fLocal_51 = GET_RANDOM_FLOAT_IN_RANGE(120000f, 240000f);
				iLocal_52 = GET_GAME_TIMER();
				iLocal_49 = 0;
			}
...
{
	_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_42(iParam2), 1);
}
...
int func_47(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_48(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_48(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_48(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_48(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_70(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_70(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_48(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_160(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_161(_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_162(iParam1)), 0));
		}
		else
		{
			func_161(_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_162(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
...
void func_185()
{
	...
	if (Global_111560.f_10044.f_105 < 240)
	{
		...
		else if (!func_47(PLAYER_PED_ID(), 12, iLocal_47))
		{
			Global_111560.f_10044.f_105 = 0;
			iLocal_50 = 1;
			iLocal_222 = 2;
...
int func_187()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (GET_ENTITY_MODEL(uVar2[iVar1]) == func_188(60))
			{
				iLocal_53 = uVar2[iVar1];
				if (!IS_ENTITY_A_MISSION_ENTITY(iLocal_53))
				{
					SET_ENTITY_AS_MISSION_ENTITY(iLocal_53, true, 0);
				}
...
void func_193()
{
	...
	{
		func_197(13, floor(Global_111560.f_10189.f_3853));
	}
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_76577)
		{
			if (func_194() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
