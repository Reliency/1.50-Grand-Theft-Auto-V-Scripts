...
void func_1()
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(iVar0);
			if (IS_BIT_SET(Global_111560.f_24974.f_1, iVar0))
			{
				if (IS_BIT_SET(Global_111560.f_24974.f_3, iVar0))
				{
					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_111534[iVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								CLEAR_BIT(&(Global_111560.f_24974.f_3), iVar0);
							}
							else if ((GET_GAME_TIMER() - Global_111540[iVar0]) > 60000)
							{
								Global_111534[iVar0] = 0;
								Global_111540[iVar0] = GET_GAME_TIMER();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								CLEAR_BIT(&(Global_111560.f_24974.f_3), iVar0);
							}
...
{
	return IS_BIT_SET(Global_111560.f_9080.f_99.f_219[0], iParam0);
}
...
void func_13()
{
	...
	{
		if (func_17(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_19()
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_22(iVar0);
			if (IS_BIT_SET(Global_111560.f_24971.f_2, iVar0))
			{
				fVar2 = vdist2(func_9(PLAYER_ID()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_111524[iVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							CLEAR_BIT(&(Global_111560.f_24971.f_2), iVar0);
						}
						else if ((GET_GAME_TIMER() - Global_111529[iVar0]) > 60000)
						{
							Global_111524[iVar0] = 0;
							Global_111529[iVar0] = GET_GAME_TIMER();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							CLEAR_BIT(&(Global_111560.f_24971.f_2), iVar0);
						}
