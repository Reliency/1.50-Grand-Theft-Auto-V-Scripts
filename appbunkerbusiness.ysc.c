...
void __EntryFunction__()
{
	...
	iLocal_398 = -1;
	iLocal_399 = -1;
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH("appBunkerBusiness")) > 1)
	{
		func_526(0, 1);
	}
	func_515();
	...
	{
		func_513();
		if (!IS_BIT_SET(iLocal_197, 7))
		{
			func_510();
			func_487();
		}
		if (!IS_BIT_SET(iLocal_197, 10))
		{
			func_477();
		}
		func_460();
		...
		func_455();
		func_453();
		if (iLocal_212 == -1 && !IS_BIT_SET(iLocal_197, 4))
		{
			func_11();
		}
		...
		{
			if (!IS_BIT_SET(iLocal_197, 4))
			{
				func_3(PLAYER_ID(), iLocal_209, iLocal_212, 1);
				func_526(0, 0);
			}
			else if (!Global_1676879.f_2897 && IS_SCREEN_FADED_OUT())
			{
				func_1();
				Global_1676739 = 1;
				func_526(0, 1);
...
void func_11()
{
	...
	func_451();
	func_450();
	if (IS_BIT_SET(iLocal_197, 0))
	{
		if (_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_391) && _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_392))
		{
			iVar0 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_391);
			iVar1 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_392);
			iLocal_210 = iVar1;
			switch (iVar0)
			{
				case 0:
				...
				case 21:
					if (func_12(iLocal_209, PLAYER_ID()) > 0)
					{
						func_449();
						func_242(7);
					}
...
void func_15()
{
	...
	if (iLocal_201 == 0 || func_35(PLAYER_ID(), iLocal_209) == 0)
	{
		if (func_34(PLAYER_ID(), iLocal_209) == 0)
		{
	...
	else if (func_29(PLAYER_ID(), iLocal_209))
	{
	...
	else if (!NETWORK_CAN_SPEND_MONEY(iVar0, false, true, 0, -1, 0))
	{
		func_239("UA_FTR_FAIL_NM", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
	}
	else
	{
		SET_BIT(&iLocal_197, 15);
		iLocal_206 = iVar0;
...
void func_37()
{
	if (func_34(PLAYER_ID(), iLocal_209) == 2)
	{
...
void func_47()
{
	if (func_34(PLAYER_ID(), iLocal_209) == 1)
	{
...
void func_49(int iParam0)
{
	...
	if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_4 <= 0)
	{
	...
	else if (func_55(PLAYER_ID(), iLocal_209, iParam0))
	{
		func_239("OR_UPGR_OWN", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
	}
	else if (NETWORK_CAN_SPEND_MONEY(func_50(iParam0, iLocal_209), false, true, 0, -1, 0))
	{
	...
	switch (iVar0)
	{
		...
		case 5:
			...
			if (NETWORK_IS_GAME_IN_PROGRESS() && func_53())
			{
				...
				if (_NETWORK_SHOP_DOES_ITEM_EXIST_HASH(iVar5))
				{
					iVar6 = _NETWORK_SHOP_GET_PRICE(iVar5, 426439576, 1);
					return iVar6;
				}
			}
			switch (iParam0)
...
int func_60(int iParam0)
{
	...
	if (!func_222(PLAYER_ID(), iParam0, 0))
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_139(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		
		case 233:
			return func_132(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		...
		case 243:
			return func_115(iParam1, iParam2, INT_TO_PLAYERINDEX(iParam5), iParam4);
...
void func_224()
{
	...
	else if (!NETWORK_CAN_SPEND_MONEY(iVar1, false, true, 0, -1, 0))
	{
...
void func_227()
{
	...
	else if (func_12(iLocal_209, PLAYER_ID()) > 25)
	{
...
int func_228(int iParam0)
{
	...
	if (func_7(PLAYER_ID(), iParam0))
	{
		...
		return Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_1 == 0;
	}
	return 0;
}
...
void func_230(int iParam0)
{
	...
	if (iParam0 == 0)
	{
		SET_BIT(&iLocal_197, 2);
	}
	else
	{
		SET_BIT(&iLocal_197, 3);
	}
}

void func_231()
{
	CLEAR_BIT(&iLocal_197, 3);
	CLEAR_BIT(&iLocal_197, 2);
}
...
void func_232()
{
	...
	else if (Global_1366494[5] <= 0)
	{
		...
		else if (func_34(PLAYER_ID(), iLocal_209) == 1)
		{
	...
	else if (func_34(PLAYER_ID(), iLocal_209) == 0)
	{
...
void func_233()
{
	if (func_234(PLAYER_ID()) == 225 || func_223(5))
	{
		func_239("UA_CANT_SDOWN", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
	}
	else if (func_234(PLAYER_ID()) == 227)
	{
...
int func_237()
{
	if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_4 > 0 || func_238(5))
	{
		return 1;
	}
	return 0;
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SHOW_OVERLAY");
...
void func_242(int iParam0)
{
	...
	{
		iLocal_210 = iParam0;
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SHOW_SCREEN");
...
int func_243()
{
	if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_4 == 1 && !func_238(5))
	{
		return 1;
	}
	return 0;
...
void func_245()
{
	...
	switch (func_445())
	{
		...
		case 6:
			...
			if (func_408(PLAYER_ID(), 5) || func_238(5))
			{
				func_392();
				func_391(5, 1);
				func_389(0, -1, 1, 0, 0, func_34(PLAYER_ID(), iLocal_209), 0);
		...
		case 15:
			if (!NETWORK_CAN_SPEND_MONEY(func_36(iLocal_201, 0), false, true, 0, -1, 0))
			{
				func_446();
				func_239("UA_FTR_FAIL_NM", "OR_OVRLY_OK", "", 1, 0, -1, 0, 0, 0);
				return;
			...
			else
			{
				...
				func_446();
				iLocal_215 = func_16();
				SET_BIT(&iLocal_197, 11);
				func_287();
				BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "ACTIVATE_FAST_TRACK");
				END_SCALEFORM_MOVIE_METHOD();
				func_273(iLocal_201, iVar1);
				Global_1590446[PLAYER_ID() /*871*/].f_273.f_252 = 0;
...
void func_246(bool bParam0)
{
	...
	func_247();
	Global_2458930 = 1;
	func_389(1, iVar1, 0, 0, 0, func_34(PLAYER_ID(), func_54(PLAYER_ID())), bParam0);
	switch (iVar1)
	{
		case 1:
			break;
		...
		case 23:
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_273.f_259), 10);
			break;
		
		default:
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_273.f_259), 11);
			break;
	}
	if (func_38())
	{
		SET_BIT(&(Global_2531497.f_1735), 27);
	}
}
...
void func_253(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	SET_BIT(&(Global_2531497.f_4898.f_19[iVar0]), iVar1);
}
...
void func_254(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	StringIntConCat(&Global_101491, GET_RANDOM_INT_IN_RANGE(0, 3), 16);
}
...
void func_259(int iParam0, bool bParam1, bool bParam2)
{
	...
	bVar1 = false;
	iVar2 = func_271(PLAYER_ID(), iParam0);
	if (!bParam1)
	{
	...
	else if (func_266(iParam0, bParam2))
	{
		...
		iVar3 = func_264(PLAYER_ID(), iVar2);
	...
	{
		if (func_262(PLAYER_ID(), iVar2) > 0)
		{
			func_261(iParam0, (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[iParam0 /*12*/].f_2 - (func_263(iVar2, bParam2) / 2)));
		}
		iVar0 = (func_265(iVar2, bParam2) / func_262(PLAYER_ID(), iVar2) + 1);
	}
	if (!bVar1)
	{
		if (func_32(iVar2) && func_34(PLAYER_ID(), iVar2) == 2)
	...
	func_260(PLAYER_ID(), iVar2, iVar0, bParam2);
}
...
int func_269(int iParam0, bool bParam1)
{
	...
	iVar0 = Global_2507929[iParam0];
	iVar1 = func_271(PLAYER_ID(), iParam0);
	if (bParam1)
	{
...
void func_273(int iParam0, int iParam1)
{
	...
	iVar4 = GET_HASH_KEY(func_286(iVar0));
	...
	{
		0x0035BB914316F1E3(iVar3, iVar4, 5, iVar2);
	}
}
...
void func_287()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_BUTTON_STATES");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(2));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(3));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(4));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(5));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(6));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(7));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(8));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(21));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(19));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_288(11));
	END_SCALEFORM_MOVIE_METHOD();
}
...
int func_288(int iParam0)
{
	switch (iParam0)
	{
		...
		case 21:
			...
			else if (func_12(iLocal_209, PLAYER_ID()) <= 0)
			{
				return 1;
			}
			break;
		...
		case 19:
			if (((!func_237() || func_35(PLAYER_ID(), iLocal_209) < 1) || func_35(PLAYER_ID(), iLocal_209) > 99) || func_289())
			{
				return 1;
			}
			break;
...
bool func_289()
{
	return IS_BIT_SET(iLocal_197, 11);
}
...
int func_290()
{
	...
	if (func_53())
	{
		if (iVar1 > 0)
		{
			...
			if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_2 < 0)
			{
				func_261(5, 0);
			}
		}
		...
		func_291(PLAYER_ID(), iLocal_209, 0, 1);
		func_259(5, 0, 1);
	...
	{
		iVar3 = Global_1590446[PLAYER_ID() /*871*/].f_273.f_252 + 1;
		func_261(5, (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_2 - iVar1));
		if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_2 < 0)
		{
			func_261(5, 0);
		}
		func_272(5442, iVar3, -1, 1, 0);
		func_272(func_312(5), Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_2, -1, 1, 0);
		func_291(PLAYER_ID(), iLocal_209, 0, 1);
		func_259(5, 0, 1);
		func_307(&Global_2507937);
...
bool func_305(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	{
		case 0:
			if ((func_304() != -1 || _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH("appInternet")) > 0) || Global_98721.f_346 > 0)
			{
				return 0;
			}
			else
...
int func_308(int iParam0, int iParam1, bool bParam2)
{
	...
	fVar4 = to_float(func_263(iParam1, bParam2));
...
int func_309(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (func_269(iParam3, bParam4) > 0)
	{
		...
		iVar1 = (iVar0 - iVar2);
		iVar3 = (func_310(PLAYER_ID(), iParam0, bParam4) - func_311(&uParam1, 0, 0));
...
void func_313(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&Global_1676879, 26);
	}
	else
	{
		CLEAR_BIT(&Global_1676879, 26);
	}
}
...
void func_318(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_7(PLAYER_ID(), iParam0))
	{
		...
		if (bParam2)
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_273.f_179[iVar0 /*12*/].f_5), iParam1);
		}
		else
		{
			CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_273.f_179[iVar0 /*12*/].f_5), iParam1);
		}
...
int func_321(int iParam0)
{
	...
	if (bVar0)
	{
		if (iVar3 > 0)
		{
			vVar7.x = GET_HASH_KEY(func_286(iLocal_209));
			vVar7.y = 5;
			vVar7.z = iParam0;
			0x675D19C6067CAE08(iVar3, &vVar7, 0, 1);
		}
		if (func_53())
		{
			func_277(func_304());
			...
			if (func_296(func_304()))
			{
				if (func_295(func_304()) == 2)
				{
					*iParam5 = 2;
					if (iParam4 != 0)
					{
						_NETWORK_SHOP_SET_TELEMETRY_NONCE_SEED(func_298(func_304()));
...
{
	if (!func_55(PLAYER_ID(), iParam1, iParam0) && PLAYER_ID(func_50(iParam0, iParam1), false, true, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
void func_330()
{
	...
	iVar0 = func_35(PLAYER_ID(), iLocal_209);
	iVar1 = 0;
	...
	else if (iVar0 == 0 && func_34(PLAYER_ID(), iLocal_209) == 0)
	{
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_RESEARCH");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam1);
	0x77FE3402004CD1B0(&cParam2);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam16);
	func_241(&sParam8);
	func_241(&sParam12);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam17);
	END_SCALEFORM_MOVIE_METHOD();
}
...
void func_333()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_STATS");
	0x77FE3402004CD1B0(0x77FE3402004CD1B0(0x77FE3402004CD1B0()));
	0x77FE3402004CD1B0(func_335(0x77FE3402004CD1B0()));
	0x77FE3402004CD1B0(&cVar6);
	func_241(sVar5);
	func_241(GET_NAME_OF_ZONE(vVar0));
	...
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar18);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT((iVar10 + iVar12));
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar17);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar16);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar15);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_334());
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_25());
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_21());
...
char* func_335(int iParam0)
{
	...
	if (((func_62(iParam0, 28) || func_62(PLAYER_ID(), 28)) || func_338(iParam0)) && !func_336(iParam0))
	{
...
int func_359(int iParam0)
{
	...
	iVar0 = func_229(iParam0);
	if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_4 <= 0)
	{
		return 4;
	}
	else if (!func_408(PLAYER_ID(), iVar0) && !func_238(iVar0))
	{
		return 2;
	}
...
int func_360(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1366494[iParam0] > 0 && (!func_361(iParam1) || !func_29(PLAYER_ID(), iParam1)))
		{
			if (!Global_262145.f_21064 || func_63(PLAYER_ID()))
			{
				return 1;
			}
		}
	...
	if ((Global_1366494[iParam0] > 0 && !func_361(iParam1)) && (!Global_262145.f_18467 || func_66(PLAYER_ID())))
	{
		return 1;
	}
	return 0;
...
{
	return func_362(PLAYER_ID(), iParam0);
}
...
void func_367(int iParam0, int iParam1)
{
	...
	iVar0 = func_229(iParam0);
	iVar1 = Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_11;
	if (((iVar0 > -1 && func_33(iParam0) == 5) && func_7(PLAYER_ID(), iParam0)) && iVar1 != iParam1)
	{
		...
		Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[iVar0 /*12*/].f_11 = iParam1;
...
void func_370(int iParam0, var uParam1, bool bParam2)
{
	...
	iVar0 = func_271(PLAYER_ID(), iParam0);
	func_260(PLAYER_ID(), iVar0, uParam1, bParam2);
...
int func_371(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	iVar0 = func_310(PLAYER_ID(), iParam0, bParam3);
...
void func_372(int iParam0)
{
	...
	{
		Global_1366477[iParam0] = 0xF12E6CD06C73D69E();
...
void func_374(int iParam0)
{
	...
	iVar0 = func_383(PLAYER_ID(), iParam0);
	if (!func_382(iVar0))
	{
		return;
	}
	...
	if (iParam0 < 4)
	{
		...
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_273.f_277.f_2), iVar1);
	}
	else
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_273.f_277.f_3), iVar1);
	}
...
void func_379(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	iVar1 = (iVar0 - ABSI(ABSI(ABSI(), Global_2508018[iParam1 /*2*/])));
	if (bParam2)
	{
...
int func_383(int iParam0, int iParam1)
{
	...
	if (iParam1 < 4)
	{
		...
		while (iVar0 <= iVar3)
		{
			if (IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_277.f_2, iVar0))
			{
	...
	else
	{
		...
		while (iVar0 <= 7)
		{
			if (IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_277.f_3, iVar0))
			{
				iVar1 = iVar0;
			}
			else
...
int func_386(int iParam0, int iParam1)
{
	...
	if (iParam0 < 4)
	{
		...
		if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_273.f_277.f_2, iVar0))
		{
			return 1;
		}
	}
	...
	{
		iVar0 = iParam1;
		if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_273.f_277.f_3, iVar0))
		{
			return 1;
		}
	}
...
void func_389(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	0x6BC0ACD0673ACEBE(func_19(), &Var0, &(Var0.f_1));
...
void func_392()
{
	...
	if (func_53())
	{
		...
		if (iLocal_214 == 2 || iVar0 <= 0)
		{
			...
			{
				func_397(PLAYER_ID(), iLocal_209, 1, 0, 0, 1);
				func_393(5, 0, 0);
			}
		}
	}
...
{
	CLEAR_BIT(&Global_1366501, iParam0);
	CLEAR_BIT(&Global_1366501, iParam0 + 6);
}
			...
			if (func_296(func_304()))
			{
				if (func_295(func_304()) == 2)
				{
					if (iParam2 > 0)
					{
						...
						iVar0 = func_271(PLAYER_ID(), iParam0);
						iVar1 = func_33(iVar0);
						0x8586789730B10CAF(iParam2, 0x8586789730B10CAF(func_286(iVar0)), iVar1, iParam5);
					}
					*iParam4 = 2;
					func_277(func_304());
				}
...
void func_412(int iParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "ADD_RESEARCH_UNLOCKABLE");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar0);
	0x77FE3402004CD1B0(&Var2);
	func_241(&Var3);
	func_241(&Var4);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
	END_SCALEFORM_MOVIE_METHOD();
...
void func_415()
{
	...
	iVar0 = func_13(PLAYER_ID(), iLocal_209);
	iVar1 = func_416(PLAYER_ID(), iLocal_209, iVar0);
	fVar2 = (to_float(iVar1) * Global_262145.f_21022);
	fVar3 = (to_float(iVar1) * Global_262145.f_21023);
	iVar4 = round(fVar2);
	iVar5 = round(fVar3);
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_SELL_PRICES");
...
void func_417()
{
	...
	if (func_55(PLAYER_ID(), iLocal_209, 0))
	{
		iVar0 = -1;
		iVar3 = -1;
	}
	...
	if (func_55(PLAYER_ID(), iLocal_209, 1))
	{
		iVar1 = -1;
		iVar5 = -1;
	}
	...
	if (func_55(PLAYER_ID(), iLocal_209, 2))
	{
		iVar2 = -1;
		iVar4 = -1;
	}
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_UPGRADES");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar0);
...
void func_418()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_RESUPPLIES");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar0);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar1);
...
void func_419(int iParam0)
{
	...
	{
		Global_1366470[iParam0] = 0xF12E6CD06C73D69E();
...
int func_422()
{
	...
	while (!func_8(&uVar1, 15000, 0))
	{
		...
		{
			if (GET_EVENT_AT_INDEX(1, iVar3) == 226)
			{
				if (GET_EVENT_DATA(1, iVar3, &vVar0, 7))
				{
...
void func_423(int iParam0, int iParam1)
{
	...
	iVar4 = GET_HASH_KEY(func_286(iParam0));
	...
	{
		0x0035BB914316F1E3(iVar3, iVar4, iVar5, iVar2);
	}
}
...
int func_425()
{
	if (IS_BIT_SET(iLocal_197, 2))
	{
		return 0;
	}
	else if (IS_BIT_SET(iLocal_197, 3))
	{
		return 1;
	}
	return 1;
...
{
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_208 = uParam0;
}
...
void func_446()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "HIDE_OVERLAY");
	END_SCALEFORM_MOVIE_METHOD();
	func_240(0);
	CLEAR_BIT(&iLocal_197, 1);
	if (func_448())
	{
		func_447(0);
		if (iLocal_215 != -1)
		...
		if (!IS_BIT_SET(iLocal_197, 14) && func_38())
		{
			SET_BIT(&iLocal_197, 14);
			func_447(1);
			func_239("UA_RES_DONE", "WHOUSE_CONF", "", 0, 0, -1, 0, "ua_research", "UA_RES_DONE_T");
		}
	}
	CLEAR_BIT(&iLocal_197, 15);
	func_421();
}
...
void func_447(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&iLocal_197, 13);
	}
	else
	{
		CLEAR_BIT(&iLocal_197, 13);
	}
}

bool func_448()
{
	return IS_BIT_SET(iLocal_197, 13);
}
...
void func_450()
{
	...
	if (IS_BIT_SET(iLocal_197, 11))
	{
		if (!IS_BIT_SET(iLocal_197, 12))
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "APP_IS_DEACTIVATED");
			iLocal_393 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			SET_BIT(&iLocal_197, 12);
		}
		else if (_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_393))
		{
			bVar0 = 0xD80A80346A45D761(iLocal_393);
			if (bVar0)
			{
				SET_BIT(&iLocal_197, 11);
			}
...
void func_451()
{
	if (func_452())
	{
		if (!IS_BIT_SET(iLocal_197, 0))
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "GET_CURRENT_SELECTION");
			iLocal_391 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "GET_CURRENT_SCREEN_ID");
			iLocal_392 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			SET_BIT(&iLocal_197, 0);
		}
	}
}
...
void func_453()
{
	if (IS_BIT_SET(iLocal_197, 15))
	{
		if (func_454())
		{
			if (func_29(PLAYER_ID(), iLocal_209))
			{
				func_449();
				func_446();
			}
...
bool func_454()
{
	return IS_BIT_SET(iLocal_197, 1);
}
...
void func_455()
{
	...
	if (((GET_FRAME_COUNT() % 30) == 0 && !func_289()) && !func_448())
	{
		iVar0 = Global_1366494[5];
		iVar1 = func_12(iLocal_209, PLAYER_ID());
		iVar2 = func_35(PLAYER_ID(), iLocal_209);
		iVar3 = 0;
		if (iVar0 != iLocal_199)
		{
...
void func_456()
{
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_458(2, 206, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 206))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_458(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (IS_CONTROL_JUST_PRESSED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_458(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_458(2, 189, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 189))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_458(2, 190, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 190))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_458(2, 201, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 201))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_458(2, 202, 1);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_458(2, 204, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 204))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_MOUSE_INPUT");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(2, 239));
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(2, 240));
		END_SCALEFORM_MOVIE_METHOD();
		func_458(2, 237, 1);
	...
	else
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_ANALOG_STICK_INPUT");
			iLocal_394 = iVar0;
			iLocal_395 = iVar1;
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_394);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_395);
			END_SCALEFORM_MOVIE_METHOD();
		}
	}
	func_458(2, 197, 1);
	...
	{
		bVar4 = (IS_CONTROL_PRESSED(2, 242) || IS_CONTROL_PRESSED(2, 242));
		if (!bVar4)
		{
			bVar4 = (IS_CONTROL_PRESSED(2, 241) || IS_CONTROL_PRESSED(2, 241));
		}
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_390, "SET_ANALOG_STICK_INPUT");
		iLocal_396 = iVar2;
		iLocal_397 = iVar3;
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(false);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_396);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_397);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar4);
		END_SCALEFORM_MOVIE_METHOD();
	}
	if ((IS_CONTROL_JUST_PRESSED(2, 204) || IS_CONTROL_JUST_PRESSED(2, 204)) && !IS_CONTROL_JUST_PRESSED(2))
	{
		func_526(0, 1);
	}
}
...
void func_457()
{
	...
	_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_390, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_460()
{
	...
	_SET_UI_LAYER(1);
	DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_390, 255, 255, 255, 255, 0);
	func_471();
	func_464(0);
	func_461(1);
	Global_1694982.f_5 = GET_FRAME_COUNT();
}
...
void func_477()
{
	...
	if (!IS_BIT_SET(iLocal_197, 9) && IS_BIT_SET(iLocal_197, 8))
	{
		if (func_486(23))
		{
			sVar0 = "UA_TUT_RESUP";
			iLocal_203 = 9000;
			SET_BIT(&Global_1676733, 23);
		...
		else if (func_486(29))
		{
			sVar0 = "UA_TUT_UPGR";
			iLocal_203 = 8500;
			SET_BIT(&Global_1676733, 29);
			func_485(&iLocal_204, &iLocal_205, 57);
		}
	}
	if (!IS_BIT_SET(iLocal_197, 9) && !IS_BIT_SET(sVar0))
	{
		func_482(sVar0, iLocal_203);
		SET_BIT(&iLocal_197, 9);
	}
	else if (IS_BIT_SET(iLocal_197, 9))
	{
		...
		{
			CLEAR_BIT(&iLocal_197, 9);
			iLocal_203 = 0;
			func_307(&uLocal_221);
			if (func_478())
			{
				SET_BIT(&iLocal_197, 10);
			}
		}
	}
}
...
int func_481(int iParam0, int iParam1, var uParam2)
{
	...
	while (iVar1 < 3)
	{
		...
		if (!bVar0)
		{
			if (IS_BIT_SET(iParam0, iVar4))
			{
				iVar2++;
			}
		}
		else if (IS_BIT_SET(iParam1, iVar4))
		{
			iVar2++;
		}
		iVar1++;
...
int func_486(int iParam0)
{
	...
	{
		case 23:
			if ((!func_479(&iLocal_204, &iLocal_205, 39) && !IS_BIT_SET(Global_1676733, iVar0)) && iLocal_210 == 2)
			{
				return 1;
			}
			break;
		...
		case 24:
			if ((!func_479(&iLocal_204, &iLocal_205, 42) && !IS_BIT_SET(Global_1676733, iVar0)) && iLocal_210 == 3)
			{
				return 1;
			}
			break;
		...
		case 25:
			if ((((iLocal_201 > 0 && !func_479(&iLocal_204, &iLocal_205, 45)) && (func_479(&iLocal_204, &iLocal_205, 42) || IS_BIT_SET(Global_1676733, 24))) && !IS_BIT_SET(Global_1676733, iVar0)) && iLocal_210 == 3)
			{
				return 1;
			}
			break;
		...
		case 26:
			if ((!func_479(&iLocal_204, &iLocal_205, 48) && !IS_BIT_SET(Global_1676733, iVar0)) && iLocal_210 == 6)
			{
				return 1;
			}
			break;
		...
		case 27:
			if ((!func_479(&iLocal_204, &iLocal_205, 51) && !IS_BIT_SET(Global_1676733, iVar0)) && iLocal_210 == 7)
			{
				return 1;
			}
			break;
		...
		case 28:
			if ((!func_479(&iLocal_204, &iLocal_205, 54) && !IS_BIT_SET(Global_1676733, iVar0)) && iLocal_210 == 4)
			{
				return 1;
			}
			break;
		...
		case 29:
			if ((!func_479(&iLocal_204, &iLocal_205, 57) && !IS_BIT_SET(Global_1676733, iVar0)) && iLocal_210 == 5)
			{
				return 1;
			}
			break;
...
void func_499()
{
	...
	{
		if (func_502(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
			iVar0 = func_501(PLAYER_PED_ID());
...
void func_510()
{
	...
	if (!IS_BIT_SET(iLocal_197, 6) && !func_512())
	{
		if (iLocal_210 == 1)
		{
			if ((!IS_BIT_SET(iLocal_197, 8) && !func_237()) && func_41(15375, -1, -1))
			{
				CLEAR_HELP(1);
				func_482("DL_WEAP_SETUP", 9000);
				SET_BIT(&iLocal_197, 8);
			}
	...
	if (bVar0)
	{
		SET_BIT(&iLocal_197, 6);
	}
	else if (IS_BIT_SET(iLocal_197, 6))
	{
		...
		{
			CLEAR_BIT(&iLocal_197, 6);
			iLocal_203 = 0;
			func_307(&uLocal_219);
			if (func_511())
			{
				SET_BIT(&iLocal_197, 7);
			}
		}
	}
}
...
{
	func_513();
	iLocal_390 = 0x67D02A194A2FC2BD("DISRUPTION_LOGISTICS");
	while (!HAS_SCALEFORM_MOVIE_LOADED(iLocal_390))
	{
		wait(0);
	}
	func_465(1);
	...
	THEFEED_PAUSE();
	func_522(1);
	if (HAS_FORCE_CLEANUP_OCCURRED(3) || Global_2531497.f_1852)
	{
	...
	func_522(1);
	iLocal_209 = func_54(PLAYER_ID());
	iLocal_199 = Global_1366494[5];
	iLocal_200 = func_12(iLocal_209, PLAYER_ID());
	iLocal_201 = func_35(PLAYER_ID(), iLocal_209);
	iLocal_216 = func_34(PLAYER_ID(), iLocal_209);
	func_410(1);
	func_521();
	func_518();
	if (func_478())
	...
	else if (func_517(PLAYER_ID(), iLocal_209))
	{
		SET_BIT(&iLocal_197, 8);
	}
	if (IS_PC_VERSION())
...
void func_526(int iParam0, bool bParam1)
{
	...
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_390);
	func_522(iParam0);
	func_524(0);
	func_532();
	...
	THEFEED_RESUME();
	iVar0 = func_34(PLAYER_ID(), iLocal_209);
	if (IS_PC_VERSION())
	{
		if (IS_AUDIO_SCENE_ACTIVE("GTAO_Computer_Screen_Active_Scene"))
		{
...
void func_528(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_531() || !NETWORK_IS_ACTIVITY_SESSION()) || !func_327(NETWORK_IS_ACTIVITY_SESSION(), 0))
	{
		return;
	}
