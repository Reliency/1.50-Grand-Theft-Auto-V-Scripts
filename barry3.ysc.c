...
void func_6()
{
	...
	{
		func_8(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_74(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_74(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_74(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_65(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_74(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_51(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_74(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_74(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_52(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_52(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_52(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_52(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_85(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_85(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_74(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_147(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_74(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_74(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_154()
{
	...
	{
		if (func_149(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_165()
{
	...
	{
		func_154();
		_0xBF59707B3E5ED531(func_166(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
	...
	switch (iLocal_42)
	{
		case 0:
			if (func_237())
			{
				...
				if (!bLocal_59[3] && func_234(PLAYER_PED_ID(), iLocal_45, 15f, 1))
				{
				...
				if (!bLocal_55)
				{
					...
					if (IS_PED_HEADTRACKING_PED(iLocal_45, IS_PED_HEADTRACKING_PED()))
					{
						TASK_CLEAR_LOOK_AT(iLocal_45);
					}
				}
				if (IS_PED_HEADTRACKING_PED(IS_PED_HEADTRACKING_PED(), iLocal_45))
				{
		...
		case 1:
			...
			{
				if ((func_217(iLocal_47[0], vLocal_237, 30f) || func_214(iLocal_47[0], PLAYER_PED_ID(), 1126825984, 0)) || func_214(iLocal_47[1], PLAYER_PED_ID(), 1126825984, 0))
				{
...
int func_214(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_216(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_216(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_218(bool bParam0)
{
	if (bParam0)
	{
		if (DOES_ENTITY_EXIST(iLocal_46))
		{
			...
			TASK_PLAY_ANIM(0, sLocal_43, "barry_get_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_SMART_FLEE_COORD(0, TASK_SMART_FLEE_COORD(iLocal_46, false), 200f, -1, 0, 0);
...
void func_236(bool bParam0)
{
	if (DOES_ENTITY_EXIST(Local_39.f_41[0]))
	{
		if (bParam0)
		{
			...
			{
				ATTACH_ENTITY_TO_ENTITY(Local_39.f_41[0], iLocal_45, ATTACH_ENTITY_TO_ENTITY(iLocal_45, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
		}
		else if (IS_ENTITY_ATTACHED(Local_39.f_41[0]))
		{
			DETACH_ENTITY(Local_39.f_41[0], 1, true);
			SET_ENTITY_HAS_GRAVITY(Local_39.f_41[0], 1);
		}
	}
}
...
int func_237()
{
	...
	if ((!DOES_ENTITY_EXIST(iLocal_46) && DOES_ENTITY_EXIST(iLocal_49)) && DOES_ENTITY_EXIST(iLocal_50))
	{
		vVar0 = { vLocal_235 };
		fVar1 = fLocal_240;
		if (func_238(PLAYER_PED_ID(), vLocal_235, 1) < func_238(PLAYER_PED_ID(), vLocal_236, 1))
		{
			vVar0 = { vLocal_236 };
			fVar1 = fLocal_241;
		}
		iLocal_46 = CREATE_VEHICLE(iLocal_49, vVar0, fVar1, true, true, false);
		iLocal_47[0] = CREATE_PED_INSIDE_VEHICLE(iLocal_46, 6, iLocal_50, -1, 1, true);
		GIVE_DELAYED_WEAPON_TO_PED(iLocal_47[0], joaat("weapon_pistol"), -1, true);
		SET_PED_INFINITE_AMMO(iLocal_47[0], 1, joaat("weapon_pistol"));
		iLocal_47[1] = CREATE_PED_INSIDE_VEHICLE(iLocal_46, 6, iLocal_50, 0, 1, true);
		GIVE_DELAYED_WEAPON_TO_PED(iLocal_47[1], joaat("weapon_pistol"), -1, true);
		SET_PED_INFINITE_AMMO(iLocal_47[1], 1, joaat("weapon_pistol"));
		SET_VEHICLE_SIREN(iLocal_46, true);
		SET_VEHICLE_FORWARD_SPEED(iLocal_46, 20f);
		TASK_VEHICLE_DRIVE_TO_COORD(iLocal_47[0], iLocal_46, vLocal_237, 20f, 1, iLocal_49, 786603, 5f, 5f);
		return 1;
	}
	return 0;
}
...
void func_239()
{
	switch (iLocal_42)
	{
		case 0:
			...
			{
				CLEAR_AREA_OF_COPS(CLEAR_AREA_OF_COPS(iLocal_45, true), 1000f, 0);
				iLocal_243 = CREATE_SYNCHRONIZED_SCENE(vLocal_247, vLocal_248, 2);
				SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_243, true);
				TASK_SYNCHRONIZED_SCENE(iLocal_45, iLocal_243, sLocal_43, "barry_3_sit_loop", 1000f, -8f, 1, 16, 1148846080, 0);
			}
		...
		case 1:
			if (!func_244())
			{
				...
				if (iLocal_58 < 3)
				{
					if (func_234(PLAYER_PED_ID(), iLocal_45, 15f, 1))
					{
			...
			else if (func_234(PLAYER_PED_ID(), iLocal_45, 15f, 1))
			{
				if (!bLocal_61)
				{
			...
			if (!iLocal_53)
			{
				if ((GET_GAME_TIMER() - iLocal_52) > 40000 || GET_GAME_TIMER(GET_GAME_TIMER()) > 0)
				{
					iLocal_53 = 1;
					iLocal_42 = 2;
				}
				else if (!func_234(PLAYER_PED_ID(), iLocal_45, 100f, 1))
				{
					iLocal_42 = 2;
				}
			}
...
void func_243()
{
	if (func_234(iLocal_45, PLAYER_PED_ID(), 7f, 1))
	{
		if (!IS_PED_HEADTRACKING_PED(iLocal_45, IS_PED_HEADTRACKING_PED()))
		{
			TASK_LOOK_AT_ENTITY(iLocal_45, TASK_LOOK_AT_ENTITY(), -1, 2048, 2);
		}
	}
	...
	else if (IS_PED_HEADTRACKING_PED(iLocal_45, IS_PED_HEADTRACKING_PED()))
	{
		TASK_CLEAR_LOOK_AT(iLocal_45);
	}
	if (func_234(iLocal_45, PLAYER_PED_ID(), 6f, 1))
	{
		if (!IS_PED_HEADTRACKING_PED(IS_PED_HEADTRACKING_PED(), iLocal_45))
		{
			TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), iLocal_45, -1, 0, 2);
		}
	}
	else if (IS_PED_HEADTRACKING_PED(IS_PED_HEADTRACKING_PED(), iLocal_45))
	{
		TASK_CLEAR_LOOK_AT(TASK_CLEAR_LOOK_AT());
	}
}
...
bool func_244()
{
	if (IS_PED_IN_ANY_POLICE_VEHICLE(IS_PED_IN_ANY_POLICE_VEHICLE()))
	{
		...
		{
			if (func_234(iLocal_45, PLAYER_PED_ID(), 40f, 1))
			{
				bLocal_54 = true;
			}
			else
		...
		{
			if (func_234(iLocal_45, GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 15f, 1))
			{
				bLocal_55 = true;
				STOP_SCRIPTED_CONVERSATION(false);
				func_218(0);
...
bool func_246()
{
	return IS_BIT_SET(Global_2531497.f_795, 2);
}
		...
		case 0:
			if (!IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_242))
			{
				if (func_350(iLocal_45))
				{
					...
					TASK_SYNCHRONIZED_SCENE(iLocal_45, iLocal_242, sLocal_43, "lead_out", 1000f, -8f, 1, 16, 1148846080, 0);
				}
			}
			func_236(1);
			iLocal_64 = 0;
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (_0xB56BBBCC2955D9CB())
			{
				if (func_350(PLAYER_PED_ID()))
				{
					func_281(sLocal_244, PLAYER_PED_ID(), 0, 2);
				}
			...
			if (func_274(1, 1093140480, 0))
			{
				...
				REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), sLocal_244, 0, 0, 0);
				if (DOES_ENTITY_EXIST(Local_39.f_41[0]))
				{
					func_236(0);
...
void func_253(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_257(IS_PED_INJURED())) && !func_255(IS_PED_INJURED(), 0)) && !func_254()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_257(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_261()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_48))
	{
		SET_ENTITY_ROTATION(iLocal_48, 0f, 0f, 20f, 2, 1);
	}
}
...
void func_262(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_263(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_274(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_279(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_287()
{
	...
	if (iLocal_42 == 0)
	{
		...
		if (!func_460())
		{
			if (func_350(iLocal_45))
			{
				TASK_PLAY_ANIM(iLocal_45, sLocal_43, "lead_in", 8f, -8f, -1, 2, 0, 0, 0, 0);
				iLocal_42 = 1;
			}
		}
		else
	...
	else if (iLocal_42 == 1)
	{
		...
		{
			if (!bLocal_57 && (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, 0, true, 0) || func_288()))
			{
				bLocal_57 = true;
				if (func_234(PLAYER_PED_ID(), iLocal_45, 5f, 1))
				{
					bLocal_63 = true;
				}
			}
			if (bLocal_57)
			{
				if (!bLocal_63)
				{
					if (func_288())
					{
						SET_GAMEPLAY_ENTITY_HINT(iLocal_45, 0f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
					}
					else
					{
						SET_GAMEPLAY_ENTITY_HINT(iLocal_45, 0.5f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
				...
				if (func_234(PLAYER_PED_ID(), iLocal_45, 2.5f, 1))
				{
					SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 256);
					TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), iLocal_45, 0);
				}
			}
...
void func_289()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()) && func_350(iLocal_45))
	{
		SET_IK_TARGET(iLocal_45, 1, SET_IK_TARGET(), 31086, 0f, 0f, 0f, 0, -1, -1);
		SET_IK_TARGET(SET_IK_TARGET(), 1, iLocal_45, 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
...
void func_291()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_279(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_298()
{
	...
	if (iLocal_42 == 0)
	{
		...
		iLocal_232[1] = 20000;
		iLocal_232[2] = 7000;
		iLocal_246 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
		...
		SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_45, 0);
		func_306(&uLocal_67, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	...
	if (iLocal_42 == 1)
	{
		if ((HAS_ADDITIONAL_TEXT_LOADED(0) && HAS_ADDITIONAL_TEXT_LOADED(iLocal_51)) && HAS_ADDITIONAL_TEXT_LOADED(sLocal_43))
		{
			if (func_460())
			{
				switch (func_305())
				{
					case 0:
						...
						if (func_350(iLocal_45))
						{
							iLocal_243 = CREATE_SYNCHRONIZED_SCENE(vLocal_247, vLocal_248, 2);
							SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_243, true);
							TASK_SYNCHRONIZED_SCENE(iLocal_45, iLocal_243, sLocal_43, "barry_3_sit_loop", 1000f, -8f, 0, 0, 1148846080, 0);
						}
						func_261();
...
int func_307()
{
	...
	{
		if (IS_ENTITY_DEAD(iLocal_45, 0))
		{
			func_236(0);
			func_325("B3BARRYDEAD");
			return 1;
		}
		else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_45, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) || func_324(HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), iLocal_45, 1))
		{
			TASK_SMART_FLEE_PED(iLocal_45, TASK_SMART_FLEE_PED(), 500f, -1, 0, 0);
			func_236(0);
			func_325("B3BARRYHURT");
			return 1;
		}
		else if (func_308(iLocal_45, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_324(PLAYER_PED_ID(), iLocal_45, 1))
		{
			if (!iLocal_53)
			{
				if ((iLocal_41 == -2 && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_242)) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_242) < 0.82f)
				{
				}
				else
				{
...
int func_308(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_350(PLAYER_PED_ID()) && func_350(iParam0))
	{
		...
		if (!IS_PED_ARMED(IS_PED_ARMED(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT()))
			{
				...
				{
					return func_318(PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_309(int iParam0, float fParam1)
{
	...
	if (func_350(PLAYER_PED_ID()) && func_350(iParam0))
	{
		if (func_317(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 6))
			{
				fVar0 = 40f;
...
{
	return func_311(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_322(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_216(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if (func_252(iParam0) && IS_PED_IN_ANY_VEHICLE(iParam0, 0))
	{
		if (func_252(iParam1))
		{
	...
	switch (iLocal_42)
	{
		...
		case 1:
			...
			else if (!IS_STRING_NULL_OR_EMPTY(sLocal_40))
			{
				if (func_252(iLocal_45))
				{
					if (func_252(PLAYER_PED_ID()) && func_234(PLAYER_PED_ID(), iLocal_45, 15f, 1))
					{
						func_327();
					}
				}
...
{
	if (((!func_345(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_296(0)) || func_344(1))
			{
			}
			else
			{
...
void func_353(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_151(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_358(*iParam1, 0, &uVar0))
		{
...
int func_358(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_385(iVar0, bParam1, uParam2) && !func_384(PLAYER_ID())) && !func_368(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_366(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_364(iParam0)) && !bVar1) && !(func_363(IS_BIG_VEHICLE(iParam0)) && func_360(IS_BIG_VEHICLE())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_359(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_383(PLAYER_ID()) || func_382(PLAYER_ID()))
	{
		if (func_369(iParam0))
		{
			return 1;
...
int func_370(int iParam0)
{
	...
	if (func_371(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_372(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_374(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_385(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_366(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_389(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_268(iParam0, 0, 0)) || func_268(iParam0, 1, 0)) || func_268(iParam0, 2, 0)) || func_405(iParam0) != 145) || func_404(iParam0)) || func_403(iParam0)) || func_359(iParam0)) || func_402(iParam0)) || !func_392(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_403(iParam0))
		{
		}
...
int func_409(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_381(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_412(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_412(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_411(iParam0);
	if (func_410(*iParam0))
	{
...
void func_415(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_416(iParam0, iParam1))
				{
	...
	if (func_442(uParam0))
	{
		...
		if (func_441(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_427(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_427(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_429(iParam0, uVar1[iVar3], 1) && func_428(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_423(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_430(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_389(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_433(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_432())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_389(iVar2 + 1)))
				{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				{
					ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_28[0], ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar4 = false;
...
int func_478(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_484())
	{
		...
		{
			iVar2 = func_479(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
