...
void func_1()
{
	...
	if (func_109(PLAYER_PED_ID()))
	{
		if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
		{
			...
			{
				iLocal_49 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
				func_125(1);
				func_13(0);
				if (func_109(PLAYER_PED_ID()))
				{
					if (func_11(&Local_42, &Local_48, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), &iLocal_54))
					{
						func_8();
					}
				}
			...
			{
				if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), GET_ENTITY_COORDS(iLocal_49, true)) > 62500f)
				{
					func_5();
				}
...
int func_3(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(iVar0, func_4(SET_BLIP_SCALE(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(iVar0, func_4(SET_BLIP_SCALE(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_9(vector3 vParam0, bool bParam1, bool bParam2)
{
	...
	CLEAR_BIT(&Global_7357, 30);
	if (bParam1)
	{
		SET_BIT(&Global_7357, 29);
	}
	else
	{
		CLEAR_BIT(&Global_7357, 29);
	}
	if (bParam2)
	{
		SET_BIT(&Global_7358, 1);
	}
	else
	{
		CLEAR_BIT(&Global_7358, 1);
	}
}
...
void func_47()
{
	...
	{
		func_50(13, floor(Global_111560.f_10189.f_3853));
	}
...
void func_53(int iParam0, int iParam1)
{
	...
	STAT_GET_INT(func_54(iParam0, 1), &iVar0, -1);
	iVar0 = (iVar0 + iParam1);
...
void func_59(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_61() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_61() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_65(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_61() /*10828*/].f_6168.f_10, iParam0);
}
	...
	if (*uParam0)
	{
		switch (*iParam4)
		{
			...
			case 1:
				...
				ADD_TEXT_COMPONENT_INTEGER(func_85(iParam3));
				END_TEXT_COMMAND_SCALEFORM_STRING();
...
int func_85(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_111560.f_10044.f_108, func_87(func_88(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_90(int iParam0, bool bParam1)
{
	...
	{
		if (!bParam1 && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), Local_48[iParam0 /*11*/].f_3) < (100f * 100f))
			{
				if (func_91(&iVar0))
				{
	...
	{
		if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), Local_48[iParam0 /*11*/].f_3) > (105f * 105f))
		{
...
int func_93(var uParam0, var uParam1, vector3 vParam2)
{
	...
	if ((uParam1[iVar0 /*11*/])->f_10)
	{
		...
		{
			if (HAS_PICKUP_BEEN_COLLECTED((uParam1[iVar0 /*11*/])->f_1) || func_105((uParam1[iVar0 /*11*/])->f_1))
			{
...
void func_97()
{
	...
	iVar3 = 0;
	STAT_GET_INT(func_98(0), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_50(18, iVar0);
	}
	STAT_GET_INT(func_98(1), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_50(19, iVar0);
	}
	STAT_GET_INT(func_98(3), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_50(20, iVar0);
