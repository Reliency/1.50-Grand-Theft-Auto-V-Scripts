...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_205(Var0.f_28[0]))
		{
			if (Var0 == 2)
			{
				if (func_203(&Var0, GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_203(&Var0, GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_188(&uLocal_58, GET_ENTITY_COORDS(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar2 = 0;
		if (func_187(Var0))
...
void func_188(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3)
{
	switch (*uParam0)
	{
		...
		case 1:
			if (func_201(PLAYER_PED_ID(), vParam1, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_201(PLAYER_PED_ID(), vParam1, 1) >= 25f)
			{
				func_143();
				*uParam0 = 0;
			}
...
int func_203(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(PLAYER_PED_ID()) && func_205(iParam0->f_28[0])) && !func_145()) && (PLAYER_PED_ID() - iParam0->f_60) > iParam6) && func_201(PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_206(int iParam0, char* sParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_201(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_209(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_201(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_211(iParam0);
				}
			}
...
void func_252()
{
	...
	if (func_205(PLAYER_PED_ID()))
	{
		if (func_253(PLAYER_PED_ID(), vVar0, fVar1))
		{
			func_150();
		}
	}
...
void func_255(var uParam0)
{
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		...
		if (func_205(uParam0->f_28[0]))
		{
			...
			TASK_SMART_FLEE_PED(uParam0->f_28[0], TASK_SMART_FLEE_PED(), 10000f, -1, 0, 0);
		}
		func_220(&(uParam0->f_41[2]));
	}
}
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				{
					ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, vVar3, vVar4, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar8 = false;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				if (DOES_ENTITY_EXIST(uParam0->f_41[0]) && DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
					ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, vVar2, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
				}
				else
				{
					bVar7 = false;
