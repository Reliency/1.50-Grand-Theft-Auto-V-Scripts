...
void func_7()
{
	...
	{
		func_199(13, floor(Global_111560.f_10189.f_3853));
	}
...
void func_202(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_203(_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_204(iParam1)), 0));
		}
		else
		{
			func_203(_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_204(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
...
void func_217(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_221(IS_PED_INJURED())) && !func_219(IS_PED_INJURED(), 0)) && !func_218()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_221(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_229(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_231(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_245(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_252(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_251(PLAYER_PED_ID(), -828834893))
				{
...
void func_255()
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			if (func_272(PLAYER_PED_ID(), Local_84.f_28[0], 1) >= 4.5f)
			{
				if (!IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (func_271())
					{
						SET_GAMEPLAY_ENTITY_HINT(Local_84.f_28[0], 0f, 0f, 0.5f, 1, 30000, 2000, 2000, 0);
					}
					else
					{
						SET_GAMEPLAY_ENTITY_HINT(Local_84.f_28[0], -1f, 0f, 0f, 0, 30000, 2000, 2000, 0);
					}
					SET_GAMEPLAY_HINT_FOV(fLocal_253);
					_0xF8BDBF3D573049A1(fLocal_254);
					_0xD1F8363DFAD03848(fLocal_255);
					_0x5D7B620DAE436138(fLocal_256);
					_0xC92717EF615B6704(fLocal_257);
			...
			if (iLocal_252 == 0)
			{
				if (func_272(PLAYER_PED_ID(), Local_84.f_28[0], 1) <= 2.5f)
				{
					SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 256);
					TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), Local_84.f_28[0], 0);
					iLocal_252 = 1;
				}
			}
				...
				if (func_244(Local_84.f_28[0]))
				{
					if (IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						if (GET_ENTITY_ANIM_CURRENT_TIME(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f)
						{
							...
							func_270(&uLocal_85, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
							TASK_LOOK_AT_ENTITY(Local_84.f_28[0], TASK_LOOK_AT_ENTITY(), -1, 12, 2);
							TASK_PLAY_ANIM(Local_84.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, 0, 0, 0, 0);
							iLocal_82 = 2;
						}
					}
				}
...
void func_274()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_252(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_294(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_279(0)) || func_293(1))
			{
			}
			else
			{
...
int func_304(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (func_305(&(uParam0->f_28[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_216(PLAYER_PED_ID()))
				{
...
void func_313()
{
	...
	if (func_244(Local_84.f_28[0]))
	{
		...
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_84.f_28[0], 1862763509);
	}
...
void func_328(bool bParam0)
{
	...
	if (!func_345())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_329(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
