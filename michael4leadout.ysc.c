	...
	while (iLocal_21 != 5)
	{
		if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			switch (iLocal_21)
			{
				...
				case 2:
					if ((HAS_THIS_CUTSCENE_LOADED("SOL_5_MCS_2_P5") && func_99(0, 1)) && HAS_THIS_CUTSCENE_LOADED(HAS_THIS_CUTSCENE_LOADED()))
					{
						SET_CLOCK_TIME(7, 5, 30);
						SET_WEATHER_TYPE_NOW_PERSIST("EXTRASUNNY");
						CLEAR_WEATHER_TYPE_PERSIST();
						CLEAR_AREA(-1590.055f, -1037.067f, 12.0186f, 4f, 1, 0, 0, false);
				...
				case 3:
					if (IS_CUTSCENE_PLAYING())
					{
						if (!iLocal_20)
						{
							iLocal_23 = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_PED_INDEX_FROM_ENTITY_INDEX("Michael", joaat("player_zero")));
				...
				case 4:
					if (!IS_CUTSCENE_PLAYING())
					{
						...
						func_6(0, &sLocal_24);
						iLocal_32 = GET_INTERIOR_AT_COORDS_WITH_TYPE(Global_93737[0 /*10*/].f_3, &sLocal_24);
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_26(iParam0, 0, 0)) || func_26(iParam0, 1, 0)) || func_26(iParam0, 2, 0)) || func_49(iParam0) != 145) || func_25(iParam0)) || func_24(iParam0)) || func_23(iParam0)) || func_22(iParam0)) || !func_12(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_24(iParam0))
		{
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_35(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_58(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_2(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_62(*iParam1, 0, &uVar0))
		{
...
int func_62(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	bVar1 = false;
	if (func_70(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_68(iParam0)) && !bVar1) && !(func_67(IS_BIG_VEHICLE(iParam0)) && func_63(IS_BIG_VEHICLE())))
	{
...
int func_89(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_70(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
...
int func_94(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_85(GET_ENTITY_MODEL(*uParam0), 1) && GET_ENTITY_MODEL(*uParam0, 24) != func_97(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_97(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_96(uParam0);
	if (func_95(*uParam0))
	{
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_111(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_111(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_111(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_143(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_111(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_111(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_111(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
int func_102(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_111(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_111(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_122(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_111(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_111(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_123(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_123(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_123(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_123(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_162(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_155(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_155(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_111(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_218(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			RESET_PED_AUDIO_FLAGS(RESET_PED_AUDIO_FLAGS());
		}
	}
	wait(0);
	SET_GAME_PAUSED(true);
	NEW_LOAD_SCENE_START_SPHERE(vParam0, iParam3, 0);
	iVar0 = 0;
