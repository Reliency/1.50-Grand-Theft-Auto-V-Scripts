...
void __EntryFunction__()
{
	...
	iLocal_52 = _0x4A9923385BDB9DAD();
	iLocal_53 = _GET_BLIP_INFO_ID_ITERATOR();
	iLocal_228 = -1;
	fLocal_230 = 1f;
	iLocal_337 = 100;
	iLocal_338 = 3;
	...
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_1075, true);
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_1076, true);
	_F4F2C0D4EE209E20();
	if (func_525())
	{
		bLocal_330 = true;
		...
		if (iLocal_1029 == 0)
		{
			if (iLocal_978)
			{
				...
				if (((!IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar0)) && !IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar0))) && !IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar0))) && !IS_THIS_MODEL_A_BOAT(iVar0))
				{
		...
		else if (iLocal_1029 == 1)
		{
			if (iLocal_978)
			{
				...
				if (((!IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar1)) && !IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar1))) && !IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar1))) && !IS_THIS_MODEL_A_BOAT(iVar1))
				{
					SET_VEHICLE_ON_GROUND_PROPERLY(iVar1, 1084227584);
				}
				else
				{
		...
		else if (iLocal_1029 == 2)
		{
			if (iLocal_978)
			{
				...
				if (((!IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar2)) && !IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar2))) && !IS_THIS_MODEL_A_BOAT(IS_THIS_MODEL_A_BOAT(iVar2))) && !IS_THIS_MODEL_A_BOAT(iVar2))
				{
	...
	while (true)
	{
		...
		else if (!IS_PED_INJURED(iLocal_938))
		{
			func_454();
			if (iLocal_931 < 10)
			{
			...
			if (((iLocal_959 || bLocal_964) && iLocal_931 < 11) || (bLocal_994 && iLocal_931 < 11))
			{
				...
				else if (func_52(&iLocal_1102) > 2.5f)
				{
					if (!iLocal_995)
					{
						...
						{
							if (!IS_PED_INJURED(iLocal_943))
							{
								CLEAR_PED_TASKS(iLocal_943);
								if (iLocal_937 == 1)
								{
									if (DOES_ENTITY_EXIST(iLocal_1067))
									{
										if (!IS_PED_IN_ANY_VEHICLE(iLocal_943, 0))
										{
											TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_943, iLocal_1067, iLocal_1067, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
										}
									}
									if (DOES_ENTITY_EXIST(iLocal_943) && !DOES_ENTITY_EXIST(iLocal_943))
									{
								...
								{
									if (DOES_ENTITY_EXIST(iLocal_1065) && DOES_ENTITY_EXIST(iLocal_1065, 0))
									{
										TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_943, iLocal_1065, iLocal_1065, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
									}
								...
								{
									TASK_AIM_GUN_AT_ENTITY(iLocal_943, TASK_AIM_GUN_AT_ENTITY(), -1, 0);
									func_2(iLocal_943);
								}
							}
						}
...
void func_1()
{
	...
	if (IS_PED_IN_ANY_VEHICLE(iLocal_938, 0))
	{
		iVar0 = GET_VEHICLE_PED_IS_IN(iLocal_938, 0);
	...
	if (bLocal_969)
	{
		if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar0, iLocal_1065))
		{
			DETACH_VEHICLE_FROM_TOW_TRUCK(iVar0, iLocal_1065);
		}
	}
}
...
void func_2(int iParam0)
{
	...
	if (!iLocal_1005)
	{
		if ((DOES_ENTITY_EXIST(iParam0) && !DOES_ENTITY_EXIST(iParam0)) && func_29(iParam0, 1) < 50f)
		{
			if (!func_28())
			{
				if (iLocal_937 == 4)
...
void func_19()
{
	...
	{
		if (func_22(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
{
	return func_30(GET_PLAYER_PED(GET_PLAYER_PED()), iParam0, bParam1);
}
...
int func_31(float fParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!IS_PED_INJURED(iLocal_941[iVar0]))
		{
	...
	while (iVar0 <= 1)
	{
		if (!IS_PED_INJURED(iLocal_942[iVar0]))
		{
...
float func_32(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	return GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), vParam1, bParam2);
}
...
int func_36(int iParam0, bool bParam1)
{
	...
	while (iVar0 <= 2)
	{
		if (!IS_PED_INJURED(iLocal_941[iVar0]))
		{
			if (bParam1 || (!bParam1 && !IS_PED_IN_ANY_VEHICLE(iLocal_941[iVar0], 0)))
			{
	...
	while (iVar0 <= 1)
	{
		if (!IS_PED_INJURED(iLocal_942[iVar0]))
		{
			if (bParam1 || (!bParam1 && !IS_PED_IN_ANY_VEHICLE(iLocal_942[iVar0], 0)))
			{
	...
	while (iVar0 <= 1)
	{
		if (!IS_PED_INJURED(iLocal_940[iVar0]))
		{
			if (bParam1 || (!bParam1 && !IS_PED_IN_ANY_VEHICLE(iLocal_942[iVar0], 0)))
			{
...
float func_52(int iParam0)
{
	if (func_58(iParam0))
	{
		...
		{
			return (func_53(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_53(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
int func_60(int iParam0)
{
	...
	if (iLocal_931 > 11)
	{
		...
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				if (IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
				{
					bVar1 = true;
				}
			}
			...
			if (!IS_PED_INJURED(iLocal_939))
			{
				if (func_30(iLocal_938, iLocal_939, 1) >= fVar0)
				{
					if (bVar1)
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
						{
							if (IS_ENTITY_OCCLUDED(iLocal_1065) || !IS_ENTITY_OCCLUDED(iLocal_1065))
							{
								*iParam0 = 6;
								return 1;
							}
					...
					else if (IS_ENTITY_OCCLUDED(iLocal_939))
					{
						*iParam0 = 6;
						return 1;
					}
				}
				else if (DOES_BLIP_EXIST(iLocal_950))
				{
					if (func_30(iLocal_938, iLocal_939, 1) >= (fVar0 * 0.5f))
					{
						if (!IS_BLIP_FLASHING(iLocal_950))
						{
							SET_BLIP_FLASHES(iLocal_950, true);
						}
					}
					else if (IS_BLIP_FLASHING(iLocal_950))
					{
						SET_BLIP_FLASHES(iLocal_950, false);
					}
				}
			}
		}
...
void func_65(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_89(iParam1) && IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_70(char* sParam0)
{
	if (!func_71(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_91(sParam0)) || func_91("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_71(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_78() || func_77(Global_4456448.f_190930)) || func_76())
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			iVar1 = func_75(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(iVar0, iVar1) || (_0xE33FFA906CE74880(iVar0) == 562680400 && iVar1 != -1)) || (_0xE33FFA906CE74880(iVar0) == 1181327175 && iVar1 != -1)) || (((_0xE33FFA906CE74880(iVar0) == -1693015116 && iVar1 == 0) && func_74(iVar0, 10)) && _0xE33FFA906CE74880(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_72(int iParam0)
{
	if (iParam0 != func_12())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_73(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_84(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_87(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1) || func_85(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_93(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	if (!REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\ASSASSINATION_MULTI", false, -1))
	{
		bLocal_1111 = false;
	}
	else
	...
	if (iLocal_1033 < 30000)
	{
		...
		if (bLocal_1111)
		{
			if (func_58(&iLocal_1108))
			{
				...
				{
					PLAY_SOUND_FRONTEND(-1, "ASSASSINATIONS_HOTEL_TIMER_COUNTDOWN", "ASSASSINATION_MULTI", true);
					func_56(&iLocal_1108);
				}
			}
			else
...
void func_97()
{
	...
	switch (iLocal_1027)
	{
		case 0:
			if (!func_28())
			{
				if (!IS_ENTITY_DEAD(iLocal_941[0], 0))
				{
					TASK_CLEAR_LOOK_AT(iLocal_941[0]);
				}
				if (!IS_ENTITY_DEAD(iLocal_941[1], 0))
				{
					TASK_CLEAR_LOOK_AT(iLocal_941[1]);
				}
				iVar0 = func_101();
				if (bLocal_982)
				{
				...
				else if (!bLocal_989 && IS_PED_INJURED(iLocal_939))
				{
					if (!iLocal_998)
					{
						func_34(iVar0, 3, "OJAvaGUARD");
		...
		case 2:
			if (iLocal_998 || !IS_PED_INJURED(iLocal_939))
			{
				if (!func_28() && !bLocal_982)
				{
					...
					else if (!bLocal_1006 && IS_PED_INJURED(iLocal_939))
					{
						iVar0 = func_101();
						func_100(iVar0);
					}
			...
			if (func_58(&iLocal_1087))
			{
				if ((func_52(&iLocal_1087) > fLocal_1048 && func_98()) || IS_PED_SHOOTING(IS_PED_SHOOTING()))
				{
					func_3();
					if (!iLocal_959)
					{
...
int func_98()
{
	...
	while (iVar0 < 3)
	{
		if (DOES_ENTITY_EXIST(iLocal_941[iVar0]) && !DOES_ENTITY_EXIST(iLocal_941[iVar0], 0))
		{
			SET_PED_RESET_FLAG(iLocal_941[iVar0], 85, true);
			if (_CAN_PED_SEE_PED(iLocal_941[iVar0], _CAN_PED_SEE_PED()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (DOES_ENTITY_EXIST(iLocal_942[iVar0]) && !DOES_ENTITY_EXIST(iLocal_942[iVar0], 0))
		{
			SET_PED_RESET_FLAG(iLocal_942[iVar0], 85, true);
			if (_CAN_PED_SEE_PED(iLocal_942[iVar0], _CAN_PED_SEE_PED()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (DOES_ENTITY_EXIST(iLocal_940[iVar0]) && !DOES_ENTITY_EXIST(iLocal_940[iVar0], 0))
		{
			SET_PED_RESET_FLAG(iLocal_940[iVar0], 85, true);
			if (_CAN_PED_SEE_PED(iLocal_940[iVar0], _CAN_PED_SEE_PED()))
			{
				return 1;
			}
		}
...
void func_100(int iParam0)
{
	if (!bLocal_1006)
	{
		if (DOES_ENTITY_EXIST(iLocal_939) && DOES_ENTITY_EXIST(iLocal_939))
		{
			if (!func_28())
			{
				if ((DOES_ENTITY_EXIST(iParam0) && !DOES_ENTITY_EXIST(iParam0)) && func_29(iParam0, 1) < 75f)
				{
					func_34(iParam0, 3, "OJAvaGUARD");
...
int func_101()
{
	...
	while (iVar1 < 3)
	{
		if (DOES_ENTITY_EXIST(iLocal_941[iVar1]) && !DOES_ENTITY_EXIST(iLocal_941[iVar1]))
		{
	...
	if (iVar0 == 0)
	{
		...
		while (iVar1 < 2)
		{
			if (DOES_ENTITY_EXIST(iLocal_942[iVar1]) && !DOES_ENTITY_EXIST(iLocal_942[iVar1]))
			{
	...
	if (iVar0 == 0)
	{
		...
		while (iVar1 < 2)
		{
			if (DOES_ENTITY_EXIST(iLocal_940[iVar1]) && !DOES_ENTITY_EXIST(iLocal_940[iVar1]))
			{
...
int func_103(int iParam0)
{
	...
	if (!iLocal_959)
	{
		...
		if (IS_PED_ARMED(iLocal_938, 4))
		{
			if (IS_PED_SHOOTING(iLocal_938))
			{
				fVar1 = func_32(PLAYER_PED_ID(), -1230.599f, -196.5408f, 38.1528f, 1);
				GET_CURRENT_PED_WEAPON(iLocal_938, &iVar2, 1);
		...
		if ((func_107(iLocal_1065) || func_106(iLocal_1065)) || (DOES_ENTITY_EXIST(iLocal_1065) && DOES_ENTITY_EXIST(iLocal_1065, iLocal_938, 1)))
		{
			return 1;
		}
		if (func_107(iLocal_1066) || (DOES_ENTITY_EXIST(iLocal_1066) && DOES_ENTITY_EXIST(iLocal_1066, iLocal_938, 1)))
		{
			return 1;
		}
		if (DOES_ENTITY_EXIST(iLocal_1065) && !DOES_ENTITY_EXIST(iLocal_1065, 0))
		{
			if (IS_PED_IN_VEHICLE(iLocal_938, iLocal_1065, 0))
			{
				SET_VEHICLE_ALARM(iLocal_1065, 1);
				START_VEHICLE_ALARM(iLocal_1065);
				return 1;
			}
		}
		if (DOES_ENTITY_EXIST(iLocal_1065))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				if (IS_PED_IN_ANY_VEHICLE(iLocal_938, 0))
				{
					iVar0 = GET_VEHICLE_PED_IS_IN(iLocal_938, 0);
					if (IS_ENTITY_TOUCHING_ENTITY(iVar0, iLocal_1065) || (bLocal_969 && IS_ENTITY_TOUCHING_ENTITY(iVar0, iLocal_1065)))
					{
						*iParam0 = 4;
						return 1;
					}
		...
		if (iLocal_931 < 11)
		{
			if (IS_EXPLOSION_IN_SPHERE(-1, vLocal_1063, fLocal_1064))
			{
				return 1;
			}
		}
		else if (IS_EXPLOSION_IN_SPHERE(-1, vLocal_1063, fLocal_1064))
		{
			if (func_104())
			{
				iLocal_1013 = 1;
...
int func_104()
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1272.181f, -241.2545f, 62.90406f, -1300.203f, -201.3968f, 40.40408f, 44.5f, 0, false, 0) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1270.125f, -253.9321f, 62.90407f, -1311.414f, -193.6588f, 38.23291f, 44.5f, 0, false, 0))
	{
		return 1;
	}
	return 0;
...
int func_105()
{
	...
	if (GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1))
	{
		if (iVar0 == joaat("weapon_stickybomb"))
		{
			...
			{
				if ((IS_PED_ON_FOOT(IS_PED_ON_FOOT()) && IS_PED_ON_FOOT(0, 24)) || (IS_PED_ON_FOOT(IS_PED_ON_FOOT(), 0) && IS_PED_ON_FOOT(0, 69)))
				{
					return 1;
				}
			}
...
int func_106(int iParam0)
{
	if (DOES_ENTITY_EXIST(iParam0))
	{
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (GET_VEHICLE_DOOR_LOCK_STATUS(iParam0) == 3 && GET_VEHICLE_DOOR_LOCK_STATUS(iLocal_938) == iParam0)
			{
				return 1;
			}
		}
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1))
				{
					if (iVar0 == joaat("weapon_stickybomb"))
					{
						if (func_30(PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
							if (GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(), &iVar1))
							{
								if ((IS_ENTITY_A_VEHICLE(iVar1) && IS_ENTITY_A_VEHICLE(iVar1) == iParam0) || (IS_ENTITY_A_VEHICLE(iVar1) && IS_ENTITY_A_VEHICLE(iVar1) == IS_ENTITY_A_VEHICLE(iParam0, -1, 0)))
								{
									if ((IS_PED_ON_FOOT(IS_PED_ON_FOOT()) && IS_PED_ON_FOOT(0, 24)) || (IS_PED_ON_FOOT(IS_PED_ON_FOOT(), 0) && IS_PED_ON_FOOT(0, 69)))
									{
										return 1;
...
int func_108(int iParam0)
{
	if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
	{
		if (HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(), iLocal_1065, joaat("weapon_stickybomb"), -1))
		{
...
void func_109()
{
	...
	while (iVar0 < 3)
	{
		if (DOES_ENTITY_EXIST(iLocal_941[iVar0]))
		{
	...
	while (iVar0 < 2)
	{
		if (DOES_ENTITY_EXIST(iLocal_942[iVar0]))
		{
			if (iLocal_959 && !bLocal_992)
			{
	...
	while (iVar0 < 2)
	{
		if (DOES_ENTITY_EXIST(iLocal_940[iVar0]))
		{
			if (iLocal_959 && !bLocal_992)
			{
			...
			if (!IS_PED_INJURED(iLocal_940[iVar0]))
			{
				...
				{
					SET_PED_RESET_FLAG(iLocal_940[iVar0], 128, true);
				}
			}
		}
		iVar0++;
	...
	if (iLocal_959)
	{
		if (!IS_ENTITY_DEAD(iLocal_939, 0))
		{
			SET_PED_RESET_FLAG(iLocal_939, 120, true);
		}
	}
}
...
void func_110(int iParam0)
{
	...
	switch (iLocal_934[iParam0])
	{
		...
		case 1:
			if (IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
			{
				if (func_134())
				{
					if (!IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1066))
					{
						if (GET_PED_IN_VEHICLE_SEAT(iLocal_1066, -1, 0) == iLocal_942[iParam0])
						{
							TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_942[iParam0], iLocal_1066, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
						}
					}
		...
		case 2:
			if (IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
			{
				if (!IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1066))
				{
					vVar1 = { GET_ENTITY_COORDS(iLocal_1066, true) };
					fVar2 = GET_ENTITY_HEADING(iLocal_1066);
					iLocal_972 = 0;
		...
		case 3:
			if (IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
			{
				if (!IS_ENTITY_DEAD(iLocal_942[iParam0], 0))
				{
					if (IS_PED_IN_VEHICLE(iLocal_942[iParam0], iLocal_1066, 0) && IS_PED_IN_VEHICLE(iLocal_1065, 0))
					{
						if (!iLocal_959)
						{
							if (GET_PED_IN_VEHICLE_SEAT(iLocal_1066, -1, 0) == iLocal_942[iParam0])
							{
								if (GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], -1273030092) != 1)
								{
									TASK_VEHICLE_ESCORT(iLocal_942[iParam0], iLocal_1066, iLocal_1065, -1, 45f, 786981, 10f, -1, 10f);
								}
							}
						}
						else if (GET_PED_IN_VEHICLE_SEAT(iLocal_1066, -1, 0) == iLocal_942[iParam0])
						{
							if (!iLocal_973)
							{
								if (IS_ENTITY_DEAD(iLocal_939, 0))
								{
									if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
									{
										TASK_COMBAT_PED(iVar0, TASK_COMBAT_PED(), 0, 16);
									}
									else
									{
								...
								{
									TASK_VEHICLE_ESCORT(iLocal_942[iParam0], iLocal_1066, iLocal_1065, -1, 45f, 786981, 10f, -1, 10f);
									ADD_VEHICLE_SUBTASK_ATTACK_PED(iVar0, ADD_VEHICLE_SUBTASK_ATTACK_PED());
									iLocal_973 = 1;
								}
							}
						}
						...
						{
							if (GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], 780511057) != 1)
							{
								if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
								{
									if (GET_ENTITY_SPEED(iLocal_1066) < 5f)
									{
										iLocal_934[iParam0] = 8;
									}
								}
						...
						else if (GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], 780511057) != 1)
						{
							TASK_COMBAT_PED(iVar0, TASK_COMBAT_PED(), 0, 16);
						}
					}
		...
		case 5:
			if (!func_99(iLocal_938))
			{
				if (func_52(&iLocal_1081) >= 27f || IS_PLAYER_WANTED_LEVEL_GREATER(IS_PLAYER_WANTED_LEVEL_GREATER(), 0))
				{
					if (!IS_PED_INJURED(iVar0))
					{
						if (IS_ENTITY_AT_ENTITY(iLocal_938, iVar0, 5f, 5f, 3f, 0, 1, 0))
						{
		...
		case 6:
			if (bLocal_984)
			{
				OPEN_SEQUENCE_TASK(&iLocal_1072);
				TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				TASK_LOOK_AT_COORD(0, func_128(), TASK_LOOK_AT_COORD(1000, 1500), 2048, 4);
				TASK_LOOK_AT_COORD(0, func_128(), TASK_LOOK_AT_COORD(2000, 2500), 2048, 4);
				TASK_GO_TO_ENTITY(0, TASK_GO_TO_ENTITY(), TASK_GO_TO_ENTITY(10000, 11000), 30f, 1f, 1073741824, 0);
				TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				CLOSE_SEQUENCE_TASK(iLocal_1072);
				if (!IS_PED_INJURED(iLocal_942[iParam0]))
				{
					TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], iLocal_1072);
				}
				CLEAR_SEQUENCE_TASK(&iLocal_1072);
			}
			else
			{
				OPEN_SEQUENCE_TASK(&iLocal_1072);
				TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				TASK_AIM_GUN_AT_COORD(0, func_128(), TASK_AIM_GUN_AT_COORD(3000, 3500), 1, 0);
				TASK_AIM_GUN_AT_COORD(0, func_128(), TASK_AIM_GUN_AT_COORD(3000, 3500), 0, 0);
				TASK_AIM_GUN_AT_COORD(0, func_128(), TASK_AIM_GUN_AT_COORD(3000, 3500), 0, 0);
				TASK_AIM_GUN_AT_COORD(0, func_128(), TASK_AIM_GUN_AT_COORD(3000, 3500), 0, 0);
				TASK_AIM_GUN_AT_COORD(0, func_128(), -1, 0, 0);
				CLOSE_SEQUENCE_TASK(iLocal_1072);
				if (!IS_PED_INJURED(iLocal_942[iParam0]))
				{
					TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], iLocal_1072);
		...
		case 7:
			if (!IS_PED_INJURED(iLocal_942[iParam0]))
			{
				if (GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], 1435919172) != 1)
				{
					TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_942[iParam0], iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
	...
	if (!iLocal_959)
	{
		...
		else if (func_118(iVar0, iLocal_1066, &Local_320, &iLocal_325, 0, 0, 0, 1, 1) || func_117(iLocal_1066))
		{
			...
			if (iVar3 != 0)
			{
				func_116(GET_ENTITY_COORDS(iVar3, true), 1097859072, 1116471296);
			}
			if (!func_115())
			{
				iLocal_959 = 1;
	...
	{
		if (IS_PED_IN_VEHICLE(iVar0, iLocal_1066, 0))
		{
			if (((!IS_VEHICLE_DRIVEABLE(iLocal_1066, 0) || !IS_VEHICLE_DRIVEABLE(iLocal_1065, 0)) || iLocal_971) || !bLocal_962)
			{
...
int func_114(int iParam0, float fParam1)
{
	if (!iLocal_959)
	{
		if (!func_99(iLocal_938))
		{
			if (DOES_ENTITY_EXIST(iParam0))
			{
				if (!IS_PED_INJURED(iParam0))
				{
					...
					{
						if (IS_PED_FACING_PED(iParam0, iLocal_938, 120f))
						{
							if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_938, 17))
							{
								if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1251.791f, -147.043f, 42.679f, -1197.245f, -212.232f, 50.679f, 35f, 1, true, 0) && !IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1259.282f, -204.172f, -60.654f, -1304.335f, -235.719f, 60.654f, 85f, 1, true, 0))
								{
									return 1;
								}
							}
		...
		else if (DOES_ENTITY_EXIST(iParam0))
		{
			if (!IS_PED_INJURED(iParam0))
			{
				if (IS_ENTITY_AT_ENTITY(iLocal_938, iParam0, 5f, 5f, 1f, 0, 1, 0))
				{
					if (IS_PED_FACING_PED(iParam0, iLocal_938, 120f))
					{
						if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_938, 17))
...
void func_116(vector3 vParam0, float fParam1, float fParam2)
{
	...
	if (IS_ENTITY_DEAD(iLocal_1065, 0) || iLocal_1013)
	{
		bLocal_982 = true;
	}
	if (DOES_ENTITY_EXIST(iLocal_939))
	{
		if (((HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_939, joaat("weapon_sniperrifle"), 0) || HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_939, joaat("weapon_heavysniper"), 0)) || HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_939, joaat("weapon_remotesniper"), 0)) || HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_939, joaat("weapon_marksmanrifle"), 0))
		{
			iLocal_981 = 1;
			iLocal_932 = 1;
		}
	...
	{
		if (!IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065))
		{
			fParam1 = (fParam1 * 2f);
			iVar0 = 1;
		}
	...
	if (!iLocal_959)
	{
		...
		{
			fVar1 = func_32(PLAYER_PED_ID(), vParam0, 1);
			if (fVar1 > fParam1)
			{
				iLocal_983 = 1;
				if (fVar1 > fParam2)
			...
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					...
					if (DOES_ENTITY_EXIST(iVar0) && DOES_ENTITY_EXIST(iVar0, 0))
					{
						...
						if (fVar1 > 7f)
						{
							if (IS_ENTITY_TOUCHING_ENTITY(iVar0, iParam0) || IS_ENTITY_TOUCHING_ENTITY(iVar0, iParam0, 1))
							{
								return 1;
							}
						}
...
int func_119(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_316)
		{
			iLocal_317 = GET_ENTITY_HEALTH(iParam0);
			bLocal_316 = true;
		}
		iLocal_318 = GET_ENTITY_HEALTH(iParam0);
	...
	else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
	{
		return 1;
	}
	if (!bParam3)
	...
	if (bParam4)
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			...
			{
				if (GET_PEDS_JACKER(iParam0) == GET_PEDS_JACKER())
				{
					return 1;
				}
			}
	...
	if (bParam5)
	{
		if (IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT()))
		{
			if (IS_ENTITY_AT_COORD(iParam0, IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), true), 10f, 10f, 10f, false, true, 0))
			{
				if (HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED()))
				{
					return 1;
				}
			}
	...
	if (IS_PED_PERFORMING_STEALTH_KILL(IS_PED_PERFORMING_STEALTH_KILL()))
	{
	...
	if (func_120(PLAYER_PED_ID(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (IS_PED_RAGDOLL(iParam0) && func_29(iParam0, 1) < 1.5f)
		{
			return 1;
		}
		else if (IS_PED_IN_ANY_VEHICLE(iParam0, 0))
		{
			if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), IS_ENTITY_TOUCHING_ENTITY(iParam0, 0)))
			{
				return 1;
			}
		}
		else if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), iParam0))
		{
			return 1;
		}
		if (!IS_ENTITY_DEAD(iParam1, 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam1, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
			{
				return 1;
			}
		}
...
int func_121(int iParam0, int iParam1, var uParam2)
{
	...
	{
		if (IS_PED_SHOOTING(iParam0) && !IS_PED_SHOOTING(iParam0))
		{
			if (IS_ENTITY_AT_COORD(iParam1, IS_ENTITY_AT_COORD(iParam0, true), IntToFloat(uParam2->f_4), IntToFloat(uParam2->f_4), IntToFloat(uParam2->f_4), false, true, 0))
			{
				return 1;
			}
		}
...
int func_122(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (!IS_ENTITY_DEAD(iParam1, 0))
	{
		vVar0 = { GET_ENTITY_COORDS(iParam1, true) };
	}
	...
	if (IS_PED_ARMED(iParam0, 2))
	{
		if (IS_PED_SHOOTING(iParam0))
		{
			if (IS_ENTITY_AT_COORD(iParam1, IS_ENTITY_AT_COORD(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
			{
				if (IS_PED_FACING_PED(IS_PED_FACING_PED(iParam1), iParam0, 120f) && IS_PED_FACING_PED(iParam1, iParam0, 17))
				{
					return 1;
				}
			}
		...
		{
			if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(iParam1), 0))
			{
				iVar1 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(iParam1), 0);
			}
			if (IS_PED_PLANTING_BOMB(iParam0) || func_107(iVar1))
			{
				if (IS_ENTITY_AT_COORD(iParam1, IS_ENTITY_AT_COORD(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (IS_PED_FACING_PED(IS_PED_FACING_PED(iParam1), iParam0, 120f) && IS_PED_FACING_PED(iParam1, iParam0, 17))
...
int func_123(int iParam0, var uParam1)
{
	if (!IS_ENTITY_DEAD(iParam0, 0))
	{
		if (IS_PED_ARMED(IS_PED_ARMED(), 6))
		{
			...
			{
				if (IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 90f))
				{
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
				if (func_30(iParam1, iParam0, 0) > fParam2 && func_29(iParam1, 1) < fParam3)
				{
					...
					{
						TASK_VEHICLE_MISSION(iParam1, iParam0, TASK_VEHICLE_MISSION(TASK_VEHICLE_MISSION(), 0), 6, 35f, 786469, -1f, -1f, 1);
						ADD_VEHICLE_SUBTASK_ATTACK_PED(iParam1, ADD_VEHICLE_SUBTASK_ATTACK_PED());
					}
				}
				else if (!IS_PED_IN_VEHICLE(iParam1, iParam0, 0))
				{
					...
					{
						TASK_COMBAT_PED(iParam1, TASK_COMBAT_PED(), 0, 16);
					}
				}
			}
			else if (IS_PED_IN_VEHICLE(iParam1, iParam0, 0))
			{
				if (func_29(iParam1, 1) > fParam4)
				{
					...
					{
						TASK_VEHICLE_MISSION_PED_TARGET(iParam1, iParam0, TASK_VEHICLE_MISSION_PED_TARGET(), 6, 35f, 786469, -1f, -1f, 1);
						ADD_VEHICLE_SUBTASK_ATTACK_PED(iParam1, ADD_VEHICLE_SUBTASK_ATTACK_PED());
					}
				}
...
void func_126(int iParam0)
{
	...
	if (!IS_PED_INJURED(iLocal_938) && !IS_PED_INJURED(iParam0))
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
		...
		TASK_AIM_GUN_AT_ENTITY(0, iLocal_938, -1, 0);
...
{
	if (!IS_ENTITY_DEAD(iLocal_938, 0))
	{
		if (!IS_PED_IN_ANY_VEHICLE(iLocal_938, 0))
		{
			if (!IS_ENTITY_DEAD(iParam0, 0))
			...
			OPEN_SEQUENCE_TASK(&iLocal_1072);
			TASK_LEAVE_ANY_VEHICLE(0, 0, 256);
			TASK_COMBAT_PED(0, iLocal_938, 0, 16);
			CLOSE_SEQUENCE_TASK(iLocal_1072);
			if (!IS_ENTITY_DEAD(iParam0, 0))
			{
				TASK_PERFORM_SEQUENCE(iParam0, iLocal_1072);
			}
			CLEAR_SEQUENCE_TASK(&iLocal_1072);
		}
		else if (!IS_PED_INJURED(iParam0))
		{
			if (GET_SCRIPT_TASK_STATUS(iParam0, 780511057) != 1)
			{
				...
				TASK_COMBAT_PED(iParam0, iLocal_938, 0, 16);
			}
		}
	}
}
...
void func_129(int iParam0, vector3 vParam1)
{
	if (!iLocal_959)
	{
		if (!IS_PED_INJURED(iParam0))
		{
			if (IS_ENTITY_AT_ENTITY(iLocal_938, iParam0, vParam1, 0, 1, 0))
			{
				if (IS_PED_FACING_PED(iParam0, iLocal_938, 160f))
				{
					if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_938, 17))
					{
						TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
						iLocal_937 = 5;
						iLocal_959 = 1;
					}
				}
		...
		if (!IS_PED_IN_ANY_VEHICLE(*iParam0, 0))
		{
			if (!iLocal_961)
			{
				if (*iParam0 == iLocal_943)
				{
					CLEAR_SEQUENCE_TASK(&iVar0);
					OPEN_SEQUENCE_TASK(&iVar0);
					TASK_GO_TO_ENTITY(0, iLocal_938, 20000, 2f, 1f, 1073741824, 0);
					TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_938, -1);
					CLOSE_SEQUENCE_TASK(iVar0);
					TASK_PERFORM_SEQUENCE(*iParam0, iVar0);
					CLEAR_SEQUENCE_TASK(&iVar0);
					iLocal_961 = 1;
				...
				{
					TASK_TURN_PED_TO_FACE_ENTITY(*iParam0, iLocal_938, -1);
				}
			}
...
int func_132()
{
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		if (!IS_ENTITY_DEAD(iLocal_1065, 0))
		{
			vVar1 = { GET_ENTITY_COORDS(iLocal_1065, true) };
		}
...
void func_133(int iParam0)
{
	...
	if (!IS_ENTITY_DEAD(iLocal_942[iParam0], 0))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
		{
			if (!IS_PED_IN_VEHICLE(iLocal_942[iParam0], iLocal_1066, 0))
			{
				if (GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], -1794415470) != 1)
				{
					TASK_ENTER_VEHICLE(iLocal_942[iParam0], iLocal_1066, 20000, iVar0, 2f, 1, 0);
				}
			}
		}
	}
...
int func_134()
{
	if (!IS_PED_INJURED(iLocal_942[0]) && !IS_PED_INJURED(iLocal_942[1]))
	{
		if (IS_PED_IN_VEHICLE(iLocal_942[0], iLocal_1066, 0) && IS_PED_IN_VEHICLE(iLocal_942[1], iLocal_1066, 0))
		{
			return 1;
		}
	}
...
void func_135(vector3 vParam0, vector3 vParam1, float fParam2)
{
	if (!iLocal_959)
	{
		if (IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vParam0, vParam1, fParam2, joaat("weapon_stickybomb"), 0))
		{
			iLocal_959 = 1;
		}
	}
...
void func_136(int iParam0)
{
	...
	switch (iLocal_933[iParam0])
	{
		case 0:
			if (!IS_PED_INJURED(iVar0))
			{
				CLEAR_SEQUENCE_TASK(&iLocal_1072);
				OPEN_SEQUENCE_TASK(&iLocal_1072);
				TASK_GO_TO_COORD_ANY_MEANS(0, vLocal_1054[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
				TASK_ACHIEVE_HEADING(0, fLocal_1041[iParam0], 0);
				CLOSE_SEQUENCE_TASK(iLocal_1072);
				TASK_PERFORM_SEQUENCE(iVar0, iLocal_1072);
				CLEAR_SEQUENCE_TASK(&iLocal_1072);
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				if (!IS_ENTITY_DEAD(iVar0, 0))
				{
					if (!bLocal_994)
					{
						...
						{
							if (IS_ENTITY_AT_COORD(iVar0, vLocal_1054[iParam0 /*3*/], 3f, 3f, 3f, false, true, 0))
							{
		...
		case 3:
			...
			else if (func_52(&iLocal_1081) > fLocal_1042[iParam0] || IS_PLAYER_WANTED_LEVEL_GREATER(IS_PLAYER_WANTED_LEVEL_GREATER(), 0))
			{
				func_130(&iVar0);
				iLocal_933[iParam0] = 2;
			}
		...
		case 4:
			...
			if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				if (!IS_PED_INJURED(iVar0))
				{
					if (iParam0 == 0)
					{
						TASK_LOOK_AT_ENTITY(iLocal_941[0], iLocal_941[1], -1, 0, 2);
						if (!IS_PED_IN_VEHICLE(iVar0, iLocal_1065, 0))
						{
							TASK_ENTER_VEHICLE(iVar0, iLocal_1065, 30000, -1, 1f, 1, 0);
						}
					}
					else if (iParam0 == 1)
					{
						TASK_LOOK_AT_ENTITY(iLocal_941[1], iLocal_941[0], -1, 0, 2);
						if (!IS_PED_IN_VEHICLE(iVar0, iLocal_1065, 0))
						{
							TASK_ENTER_VEHICLE(iVar0, iLocal_1065, 30000, 0, 1f, 1, 0);
						}
					}
					else if (iParam0 == 2)
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
						{
							if (!IS_PED_IN_VEHICLE(iVar0, iLocal_1066, 0))
							{
								TASK_ENTER_VEHICLE(iVar0, iLocal_1066, 30000, 1, 1f, 1, 0);
							}
						}
					}
				}
		...
		case 5:
			...
			if (!IS_ENTITY_DEAD(iVar0, 0))
			{
				if (GET_SCRIPT_TASK_STATUS(iVar0, 150319005) != 1)
				{
					if (iParam0 == 0)
					{
						TASK_LOOK_AT_ENTITY(iLocal_941[iParam0], iLocal_941[1], -1, 2048, 4);
					}
					else if (iParam0 == 1)
					{
						TASK_LOOK_AT_ENTITY(iLocal_941[iParam0], iLocal_941[0], -1, 2048, 4);
					}
				}
			}
			if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
					...
					if (iLocal_959)
					{
						if (!IS_PED_INJURED(iVar0))
						{
							if (GET_SCRIPT_TASK_STATUS(iVar0, 780511057) != 1)
							{
								...
								TASK_COMBAT_PED(iVar0, iLocal_938, 0, 16);
							}
						}
					}
				}
		...
		case 6:
			if (!iLocal_959)
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				{
					if (GET_PED_IN_VEHICLE_SEAT(iLocal_1065, -1, 0) == iVar0)
					{
						if (!IS_PED_INJURED(iVar0))
						{
							SET_VEHICLE_ENGINE_ON(iLocal_1065, true, true, 0);
							if (func_138())
							{
								TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1065, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
							}
							else
							{
								TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1065, "OJASva_101", 181, 0, 0, -1, -1f, 0, 1073741824);
							}
						}
					}
		...
		case 7:
			if (iLocal_959)
			{
				if ((IS_VEHICLE_DRIVEABLE(iLocal_1065, 0) && IS_VEHICLE_DRIVEABLE(iLocal_1065, -1, 0) == iVar0) && IS_VEHICLE_DRIVEABLE(iLocal_1065, 1, 0) == iLocal_939)
				{
					if (!IS_PED_INJURED(iVar0))
					{
						if (bLocal_974 || (iLocal_988 && !IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065)))
						{
							...
							if (!IS_PED_INJURED(IS_PED_INJURED()))
							{
								if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
								{
									...
									{
										TASK_VEHICLE_MISSION(iVar0, iLocal_1065, TASK_VEHICLE_MISSION(TASK_VEHICLE_MISSION(), 0), 8, 35f, 786469, -1f, -1f, 1);
									}
								}
								else if (GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
								{
									TASK_VEHICLE_MISSION_PED_TARGET(iVar0, iLocal_1065, TASK_VEHICLE_MISSION_PED_TARGET(), 8, 35f, 786469, -1f, -1f, 1);
								}
							}
						}
					}
			...
			else if (bLocal_974 || (iLocal_988 && !IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065)))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				{
					if (GET_PED_IN_VEHICLE_SEAT(iLocal_1065, -1, 0) == iVar0)
					{
						if (!IS_ENTITY_DEAD(iVar0, 0))
						{
							if (GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
							{
								TASK_VEHICLE_MISSION_COORS_TARGET(iVar0, iLocal_1065, vLocal_1057, 8, 25f, 786603, -1f, -1f, 1);
							}
						}
					}
				}
		...
		case 8:
			if (bLocal_984)
			{
				...
				TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				TASK_LOOK_AT_COORD(0, func_128(), TASK_LOOK_AT_COORD(1000, 1500), 2048, 4);
				TASK_GO_TO_ENTITY(0, TASK_GO_TO_ENTITY(), TASK_GO_TO_ENTITY(15000, 16000), 30f, 1f, 1073741824, 0);
				TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				CLOSE_SEQUENCE_TASK(iLocal_1072);
				if (!IS_ENTITY_DEAD(iLocal_941[iParam0], 0))
				{
					TASK_PERFORM_SEQUENCE(iLocal_941[iParam0], iLocal_1072);
				}
				CLEAR_SEQUENCE_TASK(&iLocal_1072);
			}
			else
		...
		case 9:
			if (!IS_PED_INJURED(iLocal_941[iParam0]))
			{
				if (GET_SCRIPT_TASK_STATUS(iLocal_941[iParam0], 1435919172) != 1)
				{
					TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_941[iParam0], iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
	...
	if (!iLocal_959)
	{
		...
		else if (func_137(iVar0))
		{
			...
			if (iVar2 != 0)
			{
				func_116(GET_ENTITY_COORDS(iVar2, true), 1097859072, 1116471296);
			}
			if (!func_115())
			{
				iLocal_959 = 1;
...
int func_137(int iParam0)
{
	...
	if (!iLocal_959)
	{
		if (DOES_ENTITY_EXIST(iParam0))
		{
			...
			if (func_118(iParam0, iVar0, &Local_320, &iLocal_325, 0, 0, 0, 1, 1) || (IS_PED_RAGDOLL(iParam0) && func_29(iParam0, 1) < 1.5f))
			{
				return 1;
			}
		}
...
int func_138()
{
	...
	iLocal_1032 = GET_PED_NEARBY_VEHICLES(GET_PED_NEARBY_VEHICLES(), &iVar1);
	iLocal_1032 = iLocal_1032;
	iLocal_1032 = iVar1;
	iVar0 = 0;
	while (iVar0 < iVar1)
	{
		if (DOES_ENTITY_EXIST(iVar1[iVar0]) && !DOES_ENTITY_EXIST(iVar1[iVar0], 0))
		{
...
int func_140()
{
	if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
	{
		if (!IS_PED_INJURED(iLocal_939))
		{
			if (!iLocal_959)
			{
				if (IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0) && func_141())
				{
					return 1;
				}
			}
			else if (IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
			{
				return 1;
			}
		}
...
int func_141()
{
	...
	while (iVar0 <= 1)
	{
		if (!IS_PED_INJURED(iLocal_940[iVar0]))
		{
			if (!IS_PED_IN_ANY_VEHICLE(iLocal_940[iVar0], 0))
			{
				iVar1 = 0;
			}
		}
	...
	switch (iLocal_1028)
	{
		case 0:
			if (!IS_ENTITY_DEAD(iParam0, 0))
			{
				...
				{
					TASK_AIM_GUN_AT_ENTITY(iParam0, TASK_AIM_GUN_AT_ENTITY(), -1, 0);
				}
				func_34(iParam0, 3, "OJAvaGUARD");
...
void func_143(int iParam0)
{
	if (!IS_PED_INJURED(iParam0))
	{
		if (func_29(iParam0, 1) < 5f)
		{
			...
			{
				TASK_AIM_GUN_AT_ENTITY(iParam0, iLocal_938, -1, 0);
			}
		}
...
void func_145(int iParam0, var uParam1)
{
	...
	if (iVar0 == 0)
	{
		TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_a", 8f, -8f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 1)
	{
		TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_b", 8f, -8f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 2)
	{
		TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_fold_arms", 8f, -8f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 3)
	{
		TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_look", 8f, -8f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 1, 0, 0);
	}
	*uParam1 = iVar0;
}
...
void func_147(int iParam0)
{
	...
	if (!DOES_ENTITY_EXIST(iLocal_940[iParam0]))
	{
		return;
	}
	switch (iLocal_936[iParam0])
	{
		case 0:
			if (!IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (!IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
				{
					if (!IS_PED_INJURED(iLocal_940[iParam0]))
					{
						if (iParam0 == 0)
						{
							TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_940[iParam0], iLocal_939, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
						}
						else if (iParam0 == 1)
						{
							if (IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
							{
								...
								TASK_ENTER_VEHICLE(0, iLocal_1066, 30000, 2, 1f, 1, 0);
								CLOSE_SEQUENCE_TASK(iVar2);
								TASK_PERFORM_SEQUENCE(iLocal_940[iParam0], iVar2);
		...
		case 1:
			...
			if (!IS_ENTITY_DEAD(iLocal_940[iParam0], 0))
			{
				if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if (!IS_ENTITY_DEAD(iLocal_940[iParam0], 0))
					{
						if (!IS_PED_IN_VEHICLE(iLocal_940[iParam0], iVar0, 0))
						{
							if (IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
							{
								if (GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], -1794415470) != 1)
								{
									TASK_ENTER_VEHICLE(iLocal_940[iParam0], iVar0, 30000, iVar1, 1f, 1, 0);
								}
							}
						}
						else
		...
		case 2:
			...
			if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
			{
				if (!IS_ENTITY_DEAD(iLocal_940[iParam0], 0))
				{
					if (IS_PED_IN_VEHICLE(iLocal_940[iParam0], iVar0, 0) && IS_PED_IN_VEHICLE(iLocal_1065, 0))
					{
						if (iLocal_959)
						{
							if (!bLocal_989)
							{
								if (GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], 780511057) != 1)
								{
									if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
									{
									...
									TASK_COMBAT_PED(iLocal_940[iParam0], TASK_COMBAT_PED(), 0, 16);
								}
							}
							else if (GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], 780511057) != 1)
							{
								TASK_COMBAT_PED(iLocal_940[iParam0], TASK_COMBAT_PED(), 0, 16);
							}
						}
		...
		case 3:
			if (!IS_PED_INJURED(iLocal_940[iParam0]))
			{
				if (IS_PED_USING_ANY_SCENARIO(iLocal_940[iParam0]))
				{
					_0xF1C03A5352243A30(iLocal_940[iParam0]);
				}
			}
			if (bLocal_984)
			{
				...
				TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				CLOSE_SEQUENCE_TASK(iLocal_1072);
				TASK_PERFORM_SEQUENCE(iLocal_940[iParam0], iLocal_1072);
				CLEAR_SEQUENCE_TASK(&iLocal_1072);
			}
			else if (!IS_PED_INJURED(iLocal_940[iParam0]))
			{
				SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_940[iParam0], vLocal_1062, 15f, 0, 0);
				SET_PED_COMBAT_MOVEMENT(iLocal_940[iParam0], 1);
				SET_PED_COMBAT_ATTRIBUTES(iLocal_940[iParam0], 0, true);
				SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_940[iParam0], 2f);
				if (!iLocal_956 && !IS_PED_IN_ANY_VEHICLE(iLocal_940[iParam0], 0))
				{
					OPEN_SEQUENCE_TASK(&iLocal_1072);
					if (IS_PED_INJURED(iLocal_939))
					{
						TASK_PLAY_ANIM(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1250, 0, 0, 0, 0, 0);
						TASK_AIM_GUN_AT_COORD(0, func_128(), 3000, 0, 1);
						TASK_AIM_GUN_AT_ENTITY(0, TASK_AIM_GUN_AT_ENTITY(), -1, 0);
					}
					else
					{
						TASK_PLAY_ANIM(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 700, 0, 0, 0, 0, 0);
						TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_939, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
					}
					CLOSE_SEQUENCE_TASK(iLocal_1072);
					iLocal_956 = 1;
				}
				else
				{
					if (DOES_ENTITY_EXIST(iLocal_1065) && DOES_ENTITY_EXIST(iLocal_1065, 0))
					{
						vVar4 = { GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_1065, GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_1065, "wheel_lr")) };
						vVar5 = { GET_ENTITY_COORDS(iLocal_1065, true) };
						vVar5 = { vVar4 - vVar5 };
						_0xE4723DB6E736CCFF(iLocal_940[iParam0], iLocal_1065, vVar5, 1.5f, 0);
					}
					OPEN_SEQUENCE_TASK(&iLocal_1072);
					TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					if (IS_PED_INJURED(iLocal_939) && !func_50(func_148(), vVar4, 0))
					{
						TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar4, func_128(), 2f, false, 0.5f, 4f, 1, 0, 0, -957453492);
						TASK_PUT_PED_DIRECTLY_INTO_COVER(0, vVar4, -1, false, 0.25f, false, false, 0, 1);
					}
					else
					{
						TASK_AIM_GUN_AT_COORD(0, func_128(), 1500, 1, 0);
						if (!IS_ENTITY_DEAD(iLocal_939, 0))
						{
							TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_939, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
						}
					}
					CLOSE_SEQUENCE_TASK(iLocal_1072);
				}
		...
		case 4:
			if (!IS_ENTITY_DEAD(iLocal_940[iParam0], 0))
			{
				if (IS_ENTITY_PLAYING_ANIM(iLocal_940[iParam0], "oddjobs@assassinate@hotel@", "enter", 3))
				{
					fVar3 = GET_ENTITY_ANIM_CURRENT_TIME(iLocal_940[iParam0], "oddjobs@assassinate@hotel@", "enter");
					if (fVar3 < 0.5f)
					{
						SET_ENTITY_ANIM_SPEED(iLocal_940[iParam0], "oddjobs@assassinate@hotel@", "enter", 3.5f);
					}
					else
					{
						SET_ENTITY_ANIM_SPEED(iLocal_940[iParam0], "oddjobs@assassinate@hotel@", "enter", 1f);
					}
				}
			}
			break;
		...
		case 5:
			...
			if (!IS_PED_INJURED(iLocal_939))
			{
				if (!IS_PED_INJURED(iLocal_940[iParam0]))
				{
					if (IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
					{
						TASK_COMBAT_PED(iLocal_940[iParam0], iLocal_938, 0, 16);
					}
					else
					{
						TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_940[iParam0], iLocal_939, TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(), 3f, 1, 0.005f, 1082130432, 1, 0, -957453492);
					}
				}
	...
	else if (iLocal_936[iParam0] < 5)
	{
		if (!IS_PED_INJURED(iLocal_940[iParam0]))
		{
			...
			TASK_CLEAR_DEFENSIVE_AREA(iLocal_940[iParam0]);
			SET_PED_COMBAT_MOVEMENT(iLocal_940[iParam0], 2);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_940[iParam0], 13, true);
		}
		iLocal_936[iParam0] = 5;
	}
}
...
void func_150()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_939))
	{
		vLocal_1062 = { GET_ENTITY_COORDS(iLocal_939, false) };
	}
	switch (iLocal_935)
	{
		case 0:
			if (!IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0) && !IS_VEHICLE_DRIVEABLE(iLocal_941[0], 0))
				{
					if (!IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
					{
						if (GET_SCRIPT_TASK_STATUS(iLocal_939, -1794415470) != 1)
						{
							if (!iLocal_959 && !iLocal_983)
							{
								TASK_ENTER_VEHICLE(iLocal_939, iLocal_1065, 30000, 1, 1f, 1, 0);
							}
							else
							{
								TASK_ENTER_VEHICLE(iLocal_939, iLocal_1065, 30000, 1, 2f, 1, 0);
							}
		...
		case 1:
			...
			if (!iLocal_1004)
			{
				if (func_152())
				{
					if (func_30(iLocal_939, PLAYER_PED_ID(), 1) <= 5f && !func_28())
					{
						if (func_36(25f, 1) == 0)
						{
							if (func_151())
		...
		case 4:
			if (!IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
				{
					if (GET_SCRIPT_TASK_STATUS(iLocal_939, -828834893) != 1)
					{
						TASK_LEAVE_ANY_VEHICLE(iLocal_939, 0, 256);
					}
				}
				else if (!bLocal_989)
				{
					SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_939, 2f);
					CLEAR_SEQUENCE_TASK(&iVar0);
					OPEN_SEQUENCE_TASK(&iVar0);
					TASK_PLAY_ANIM(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1000, 0, 0, 0, 0, 0);
					TASK_SMART_FLEE_PED(0, iLocal_938, 200f, -1, 0, 0);
					CLOSE_SEQUENCE_TASK(iVar0);
					if (!IS_ENTITY_DEAD(iLocal_939, 0))
					{
						TASK_PERFORM_SEQUENCE(iLocal_939, iVar0);
					}
					CLEAR_SEQUENCE_TASK(&iVar0);
					bLocal_989 = true;
				}
				else if (GET_SCRIPT_TASK_STATUS(iLocal_939, 1435919172) != 1)
				{
					TASK_SMART_FLEE_PED(iLocal_939, iLocal_938, 200f, -1, 0, 0);
				}
				if (!iLocal_1004)
				{
					if (!func_28() && !IS_MESSAGE_BEING_DISPLAYED())
					{
	...
	if (!iLocal_959)
	{
		...
		else if (func_137(iLocal_939) || iLocal_1013)
		{
			...
			if (iVar1 != 0)
			{
				func_116(GET_ENTITY_COORDS(iVar1, true), 1097859072, 1116471296);
			}
			if (!func_115())
			{
				iLocal_959 = 1;
...
int func_152()
{
	...
	if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
	{
		iVar0 = GET_PED_IN_VEHICLE_SEAT(iLocal_1065, -1, 0);
		if (iVar0 == 0 || (iVar0 != 0 && IS_PED_INJURED(iVar0)))
		{
			iVar0 = GET_PED_IN_VEHICLE_SEAT(iLocal_1065, 0, 0);
			if (iVar0 == 0 || (iVar0 != 0 && IS_PED_INJURED(iVar0)))
			{
				iVar0 = GET_PED_IN_VEHICLE_SEAT(iLocal_1065, 2, 0);
				if (iVar0 == 0 || (iVar0 != 0 && IS_PED_INJURED(iVar0)))
				{
					return 1;
				}
...
void func_156()
{
	...
	switch (iLocal_1035)
	{
		...
		case 1:
			...
			if (func_240(&uLocal_342, 1, 0) && _0x6F259F82D873B8B8())
			{
...
void func_166(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_168() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_168() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_167(iParam0));
...
bool func_174(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_168() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_203(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_209(uParam0->f_1, 256) || (func_209(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_209(uParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_211(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (!uParam0->f_563)
	{
		switch (func_21(GET_PLAYER_PED(GET_PLAYER_PED())))
		{
			case 1:
...
void func_212(var uParam0, bool bParam1)
{
	...
	func_208(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, true));
	func_207("ES_HELP");
	if (IS_PC_VERSION())
	{
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
	...
	if (bParam1)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		func_208(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, true));
		func_207("ES_XPAND");
		if (IS_PC_VERSION())
		{
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
...
void func_214(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_229();
		DRAW_RECT(0.5f, (fVar1 - (func_232((2f - 0.5f)) - 0.001388889f)), fVar6, func_227(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_213((fVar11 / (0.6f * func_232(25f))), 0f, 1f);
					func_229();
					DRAW_RECT(0.5f, (fVar1 + func_232((2f * 0.5f))), fVar6, func_227(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_232((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_232((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					END_TEXT_COMMAND_DISPLAY_TEXT(fVar20, (fVar1 + func_232((2f * 2f))), 0);
					break;
...
void func_224(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	SET_TEXT_JUSTIFICATION(1);
	SET_TEXT_SCALE(1f, func_226(14f));
	SET_TEXT_CENTRE(0);
	SET_TEXT_FONT(0);
	func_229();
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			DRAW_SPRITE("CommonMenu", func_220(7, 0), (fParam4 - 0.006f), ((fParam2 + func_232(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_217(5, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_220(5, 0), (fParam4 - 0.006f), ((fParam2 + func_232(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_217(6, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_220(6, 0), (fParam4 - 0.006f), ((fParam2 + func_232(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_225(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)
{
	...
	switch (iParam5)
	{
		case 4:
		case 5:
			SET_TEXT_SCALE(1f, func_226(18f));
			SET_TEXT_FONT(4);
			if (iParam0 < 0)
			{
...
void func_241(var uParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	func_208(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, true));
	func_207("ES_HELP_TU");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
	func_208(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, true));
	func_207("ES_HELP_TD");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
	func_208(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, true));
	func_207("ES_HELP_AB");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	END_SCALEFORM_MOVIE_METHOD();
...
void func_242(var uParam0)
{
	...
	fVar0 = 0f;
	SET_TEXT_JUSTIFICATION(0);
	SET_TEXT_SCALE(1f, func_226(16f));
	if (uParam0->f_31 == 0)
	{
		if (uParam0->f_29)
		{
...
void func_244()
{
	...
	if (!iLocal_331)
	{
		...
		else
		{
			...
			if (!IS_STRING_NULL_OR_EMPTY(&(Local_919.f_18)))
			{
				if (bLocal_329)
				{
	...
	if (!bLocal_1000)
	{
		if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
				...
				if (DOES_ENTITY_EXIST(iVar0) && !DOES_ENTITY_EXIST(iVar0, 0))
				{
					if (GET_IS_VEHICLE_ENGINE_RUNNING(iVar0))
					{
...
void func_253()
{
	...
	switch (iLocal_1018)
	{
		...
		case 1:
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				fVar0 = func_32(PLAYER_PED_ID(), vLocal_1060, 1);
	...
	while (iVar0 < 2)
	{
		if (DOES_ENTITY_EXIST(iLocal_940[iVar0]))
		{
			if (!IS_PED_INJURED(iLocal_940[iVar0]))
			{
				...
				CLEAR_PED_TASKS(iLocal_940[iVar0]);
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_940[iVar0]));
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 3)
	{
		if (DOES_ENTITY_EXIST(iLocal_941[iVar0]))
		{
			if (!IS_PED_INJURED(iLocal_941[iVar0]))
			{
				...
				CLEAR_PED_TASKS(iLocal_941[iVar0]);
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_941[iVar0]));
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 2)
	{
		if (DOES_ENTITY_EXIST(iLocal_942[iVar0]))
		{
			if (!IS_PED_INJURED(iLocal_942[iVar0]))
			{
				...
				CLEAR_PED_TASKS(iLocal_942[iVar0]);
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_942[iVar0]));
			}
		}
		iVar0++;
	}
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1073);
}
...
void func_259()
{
	...
	switch (iLocal_1018)
	{
		case 0:
			...
			else if (!IS_PLAYER_WANTED_LEVEL_GREATER(IS_PLAYER_WANTED_LEVEL_GREATER(), 0) && func_36(125f, 1) == 0)
			{
				iLocal_1018++;
			}
			break;
		...
		case 1:
			if (!IS_PLAYER_WANTED_LEVEL_GREATER(IS_PLAYER_WANTED_LEVEL_GREATER(), 0) && func_36(125f, 1) == 0)
			{
				func_252();
				func_255();
				func_261(1);
...
void func_260()
{
	if (DOES_ENTITY_EXIST(iLocal_1065))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
		{
			SET_VEHICLE_DOORS_LOCKED(iLocal_1065, 1);
		}
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1065);
	}
	if (DOES_ENTITY_EXIST(iLocal_1066))
	{
		if (!IS_ENTITY_DEAD(iLocal_1066, 0))
		{
			if ((IS_ENTITY_ON_SCREEN(iLocal_1066) && !IS_ENTITY_ON_SCREEN(iLocal_1066)) && !IS_ENTITY_ON_SCREEN())
			{
				SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1066);
			}
			else
			{
				if (DOES_ENTITY_EXIST(iLocal_942[0]) && !DOES_ENTITY_EXIST(iLocal_942[0], 0))
				{
					if (!IS_ENTITY_DEAD(iLocal_1066, 0))
					{
						if (IS_PED_IN_VEHICLE(iLocal_942[0], iLocal_1066, 0))
						{
							CLEAR_PED_TASKS_IMMEDIATELY(iLocal_942[0]);
						}
					}
				}
				if (DOES_ENTITY_EXIST(iLocal_942[1]) && !DOES_ENTITY_EXIST(iLocal_942[1], 0))
				{
					if (!IS_ENTITY_DEAD(iLocal_1066, 0))
					{
						if (IS_PED_IN_VEHICLE(iLocal_942[1], iLocal_1066, 0))
						{
							CLEAR_PED_TASKS_IMMEDIATELY(iLocal_942[1]);
						}
					}
				}
				if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
				{
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_1066, 0))
					{
	...
	if (DOES_ENTITY_EXIST(iLocal_1069[0]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(iLocal_1069[0]));
	}
	if (DOES_ENTITY_EXIST(iLocal_1069[1]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(iLocal_1069[1]));
	}
	if (DOES_ENTITY_EXIST(iLocal_1070) && !DOES_ENTITY_EXIST(iLocal_1070, 0))
	{
		if (IS_ENTITY_A_MISSION_ENTITY(iLocal_1070) && IS_ENTITY_A_MISSION_ENTITY(iLocal_1070, 1))
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1070);
		}
	}
}
...
void func_261(bool bParam0)
{
	...
	if (bParam0)
	{
		if (DOES_BLIP_EXIST(iLocal_950))
		{
			REMOVE_BLIP(&iLocal_950);
		}
	}
	iVar0 = 0;
	while (iVar0 < 3)
	{
		if (DOES_BLIP_EXIST(uLocal_951[iVar0]))
		{
			REMOVE_BLIP(&(uLocal_951[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		if (DOES_BLIP_EXIST(uLocal_952[iVar0]))
		{
			REMOVE_BLIP(&(uLocal_952[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_262()
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_1058, vLocal_1059, fLocal_1047, 1, false, 0))
	{
		bLocal_977 = true;
	}
	else
...
void func_264()
{
	if (!bLocal_974)
	{
		if (DOES_ENTITY_EXIST(iLocal_1065))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				SET_VEHICLE_DOORS_LOCKED(iLocal_1065, 3);
	...
	switch (iLocal_1018)
	{
		case 0:
			if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				if (func_140())
				{
					if (!IS_PED_INJURED(iLocal_941[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
						{
							if (IS_PED_IN_VEHICLE(iLocal_941[0], iLocal_1065, 0))
							{
								bLocal_970 = true;
								func_263();
								iLocal_931 = 13;
...
void func_271()
{
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1075);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1076);
}
...
void func_275()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_939) && !DOES_ENTITY_EXIST(iLocal_939, 0))
	{
		vVar1 = { GET_ENTITY_COORDS(iLocal_939, true) };
		fVar2 = GET_ENTITY_HEADING(iLocal_939);
	}
	vVar0[0 /*3*/] = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar1, fVar2, 1f, -1f, 0f) };
	vVar0[1 /*3*/] = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar1, fVar2, -1f, -1f, 0f) };
	iVar3 = 0;
	while (iVar3 < 2)
	{
		if (iVar3 == 0)
		{
			iLocal_940[iVar3] = CREATE_PED(26, iLocal_1075, vVar0[0 /*3*/], vVar0[0 /*3*/].f_1, 38.3253f, uLocal_1046[iLocal_1022], 1, true);
		}
		else
		{
			iLocal_940[iVar3] = CREATE_PED(26, iLocal_1076, vVar0[1 /*3*/], vVar0[1 /*3*/].f_1, 38.3253f, uLocal_1046[iLocal_1022], 1, true);
		}
		SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_940[iVar3], true, 1);
		SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_940[iVar3]);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_940[iVar3], 3, false);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_940[iVar3], 23, true);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_940[iVar3], 30, false);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_940[iVar3], 13, true);
		SET_PED_TARGET_LOSS_RESPONSE(iLocal_940[iVar3], 2);
		SET_PED_KEEP_TASK(iLocal_940[iVar3], true);
		func_276(iLocal_940[iVar3], 1);
		SET_PED_TO_LOAD_COVER(iLocal_940[iVar3], 1);
		iVar3++;
	}
}
...
void func_276(int iParam0, bool bParam1)
{
	...
	SET_PED_RELATIONSHIP_GROUP_HASH(iParam0, iLocal_1080);
}

void func_277()
{
	func_279();
	iLocal_1022 = GET_RANDOM_INT_IN_RANGE(0, iLocal_1020);
	iLocal_939 = CREATE_PED(26, iLocal_1073, vLocal_1053[iLocal_1022 /*3*/], uLocal_1046[iLocal_1022], 1, true);
	SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_939, true, 1);
...
int func_278(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (IS_ENTITY_A_VEHICLE(iParam0))
	{
		SET_BLIP_SCALE(iVar0, func_206(SET_BLIP_SCALE(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(iVar0, func_206(SET_BLIP_SCALE(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	else if (IS_ENTITY_AN_OBJECT(iParam0))
	{
...
void func_279()
{
	...
	while (iVar0 < 3)
	{
		if (!IS_SPHERE_VISIBLE(vLocal_1052[iVar0 /*3*/], 5f) && !func_283(iVar0, 6f))
		{
...
{
	return func_32(GET_PLAYER_PED(GET_PLAYER_PED()), vParam0, bParam1);
}

int func_282()
{
	if (func_32(PLAYER_PED_ID(), -1237.566f, -156.8824f, 39.41317f, 1) < 13f)
	{
		return 1;
	}
	return 0;
...
{
	if (IS_ANY_VEHICLE_NEAR_POINT(vLocal_1052[iParam0 /*3*/], fParam1))
	{
		return 1;
	}
	return 0;
...
int func_285()
{
	...
	REQUEST_MODEL(iLocal_1073);
	if (HAS_MODEL_LOADED(iLocal_1073))
	{
		iVar0 = 1;
	}
	else
...
int func_286()
{
	if (((DOES_ENTITY_EXIST(iLocal_941[0]) && DOES_ENTITY_EXIST(iLocal_941[1])) && !DOES_ENTITY_EXIST(iLocal_941[0])) && !DOES_ENTITY_EXIST(iLocal_941[1]))
	{
		if (IS_PED_IN_VEHICLE(iLocal_941[0], iLocal_1065, 0) && IS_PED_IN_VEHICLE(iLocal_941[1], iLocal_1065, 0))
		{
			return 1;
		}
	}
...
void func_288()
{
	switch (iLocal_1018)
	{
		case 0:
			...
			if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				SET_VEHICLE_ENGINE_ON(iLocal_1065, false, true, 0);
			}
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
...
int func_291(var uParam0)
{
	...
	*uParam0 = GET_CLOSEST_VEHICLE(-1221.954f, -210.746f, 38.638f, 27f, 0, 4);
	...
	{
		if (DOES_ENTITY_EXIST(*uParam0) && !DOES_ENTITY_EXIST(*uParam0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(*uParam0, -1, 0) == 0)
			{
				vVar0 = { GET_ENTITY_COORDS(*uParam0, true) };
				vVar0 = { vVar0 };
				return 1;
			}
		}
	...
	if (iLocal_1070 != 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_1070) && !DOES_ENTITY_EXIST(iLocal_1070, 0))
		{
			...
			{
				vVar0 = { GET_ENTITY_COORDS(iLocal_1070, true) };
				return 1;
			}
		}
	}
...
void func_292()
{
	...
	while (iVar1 < 3)
	{
		if (!DOES_ENTITY_EXIST(iLocal_941[iVar1]))
		{
			if (iVar1 == 2)
			{
				iVar0 = iLocal_1076;
			...
			iLocal_941[iVar1] = CREATE_PED(26, iVar0, vLocal_1054[iVar1 /*3*/], fLocal_1041[iVar1], 1, true);
			if (iVar1 == 0)
			{
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 0, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 3, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 4, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 8, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 11, 0, 0, 0);
			}
			else if (iVar1 == 1)
			{
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 0, 1, 2, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 3, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 4, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 8, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 11, 0, 2, 0);
			}
			else if (iVar1 == 2)
			{
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 0, 1, 2, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 3, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 4, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 8, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_941[iVar1], 11, 1, 1, 0);
			}
		}
		if (!IS_PED_INJURED(iLocal_941[iVar1]))
		{
			SET_PED_CAN_BE_TARGETTED(iLocal_941[iVar1], false);
			SET_PED_KEEP_TASK(iLocal_941[iVar1], true);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_941[iVar1], 23, true);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_941[iVar1], 30, false);
			SET_PED_TARGET_LOSS_RESPONSE(iLocal_941[iVar1], 2);
			SET_PED_CONFIG_FLAG(iLocal_941[iVar1], 104, true);
...
void func_293()
{
	func_295();
	func_294();
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1077);
}
...
void func_294()
{
	...
	while (iVar0 < 2)
	{
		if (!DOES_ENTITY_EXIST(iLocal_942[iVar0]))
		{
			if (iVar0 == 0)
			{
				iLocal_942[iVar0] = CREATE_PED_INSIDE_VEHICLE(iLocal_1066, 26, iLocal_1075, -1, 1, true);
			}
			else if (iVar0 == 1)
			{
				iLocal_942[iVar0] = CREATE_PED_INSIDE_VEHICLE(iLocal_1066, 26, iLocal_1076, 0, 1, true);
			}
			func_276(iLocal_942[iVar0], 1);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iVar0], 3, false);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iVar0], 23, true);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iVar0], 30, false);
			SET_PED_TARGET_LOSS_RESPONSE(iLocal_942[iVar0], 2);
			SET_PED_KEEP_TASK(iLocal_942[iVar0], true);
		}
		iVar0++;
	}
}
...
void func_295()
{
	if (!DOES_ENTITY_EXIST(iLocal_1066))
	{
		iLocal_1066 = CREATE_VEHICLE(iLocal_1077, vLocal_1055, fLocal_1043, true, true, false);
		SET_VEHICLE_COLOUR_COMBINATION(iLocal_1066, 0);
	}
}
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_303(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_306(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_310(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_377(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_370(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_312(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_312(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_18();
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		func_330(PLAYER_PED_ID());
		func_323(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_322())
		{
			func_318(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_323(int iParam0, bool bParam1)
{
	...
	iVar0 = func_21(iParam0);
	if (func_20(iVar0) && !IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER_PED_ID())
		{
...
void func_324(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_329(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_326(Var7.f_1)) && iVar9 < 51)
			{
...
int func_334(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_356())
		{
			*uParam0 = func_340(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_336(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_338() == 0)
		{
			return IS_BIT_SET(func_175(func_337(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_340(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_355(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_341(iVar0, 0), true);
...
var func_357()
{
	...
	func_360(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_359(&uVar0, GET_CLOCK_MONTH());
	func_358(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_363(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_379()
{
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		if (DOES_ENTITY_EXIST(iVar0))
		{
			if (IS_ENTITY_IN_ANGLED_AREA(iVar0, -1214.517f, -158.91f, -39.165f, -1243.589f, -238.784f, 39.165f, 15f, 0, false, 0) && !IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), iVar0, 0))
			{
...
void func_380()
{
	...
	{
		case 0:
			if (func_411(1084227584, 1) || (bLocal_976 && _0x7D41E9D2D17C5B2D(iLocal_955)))
			{
				func_410(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, vLocal_1413, fLocal_1414, 1, 1, 1, 0, 0);
				CLEAR_AREA_OF_VEHICLES(-1220.57f, -185.96f, 38.4f, 50f, 0, 0, 0, 0, false, 0);
				...
				if (!IS_ENTITY_DEAD(iLocal_1065, 0))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
					{
						START_PLAYBACK_RECORDED_VEHICLE(iLocal_1065, 107, "ASSOJva", 1);
						SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(iLocal_1065, 2500f);
					}
				}
				if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
					{
						SET_VEH_RADIO_STATION(SET_VEH_RADIO_STATION(SET_VEH_RADIO_STATION(), 0), "OFF");
					}
				}
				iLocal_1018++;
			}
			else if (_0x7D41E9D2D17C5B2D(iLocal_955))
			{
			}
			break;
...
int func_381()
{
	...
	switch (iLocal_1019)
	{
		case 0:
			func_407(0, 0, 1);
			func_406();
			SHAKE_CAM(iLocal_1078, "HAND_SHAKE", 0.2f);
			SHAKE_CAM(iLocal_1079, "HAND_SHAKE", 0.2f);
			SET_CAM_ACTIVE_WITH_INTERP(iLocal_1079, iLocal_1078, 6000, 0, 0);
		...
		case 1:
			if (!IS_ENTITY_DEAD(iLocal_1065, 0))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				{
					if (timera() > 6000)
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065))
						{
							STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_1065);
						}
						START_PLAYBACK_RECORDED_VEHICLE(iLocal_1065, 102, "ASSOJva", 1);
						SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(iLocal_1065, 4500f);
						_0x1F2E4E06DEA8992B(iLocal_1065, 1);
						func_258("ASS_VA_SNIPE2", 7500, 1);
						SET_CAM_PARAMS(iLocal_1078, -1218.861f, -191.0496f, 38.83616f, 3.519839f, -0.000706f, 42.27108f, 38f, 0, 1, 1, 2);
						SET_CAM_NEAR_DOF(iLocal_1078, 0.5f);
						SET_CAM_FAR_DOF(iLocal_1078, 7f);
						SHAKE_CAM(iLocal_1078, "HAND_SHAKE", 0.2f);
						SET_CAM_PARAMS(iLocal_1079, -1218.91f, -190.8791f, 38.84585f, 3.519839f, -0.000706f, 43.33815f, 38f, 0, 1, 1, 2);
						SET_CAM_NEAR_DOF(iLocal_1079, 0.7f);
						SET_CAM_FAR_DOF(iLocal_1079, 10f);
						SHAKE_CAM(iLocal_1079, "HAND_SHAKE", 0.2f);
						SET_CAM_ACTIVE_WITH_INTERP(iLocal_1079, iLocal_1078, 2000, 3, 3);
						iLocal_1019++;
					}
				}
			}
		...
		case 2:
			if (!IS_ENTITY_DEAD(iLocal_1065, 0))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				{
					if (GET_TIME_POSITION_IN_RECORDING(iLocal_1065) >= 7000f)
					{
						PAUSE_PLAYBACK_RECORDED_VEHICLE(iLocal_1065);
						iLocal_1017 = 0;
						while (iLocal_1017 < 3)
						{
							if (!IS_ENTITY_DEAD(iLocal_941[iLocal_1017], 0))
							{
								if (iLocal_1017 == 0)
								{
									iVar0 = 1250;
								...
								if (GET_SCRIPT_TASK_STATUS(iLocal_941[iLocal_1017], 242628503) != 1)
								{
									CLEAR_SEQUENCE_TASK(&iLocal_1072);
									OPEN_SEQUENCE_TASK(&iLocal_1072);
									TASK_LEAVE_ANY_VEHICLE(0, iVar0, 0);
									TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_1052[iLocal_1017 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
									CLOSE_SEQUENCE_TASK(iLocal_1072);
									TASK_PERFORM_SEQUENCE(iLocal_941[iLocal_1017], iLocal_1072);
									CLEAR_SEQUENCE_TASK(&iLocal_1072);
								}
							}
							iLocal_1017++;
		...
		case 3:
			if (timera() >= 2000)
			{
				...
				{
					SET_CAM_PARAMS(iLocal_1078, -1265.549f, -213.4919f, 43.0913f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					SHAKE_CAM(iLocal_1078, "HAND_SHAKE", 0.2f);
					SET_CAM_PARAMS(iLocal_1079, -1266.063f, -213.922f, 43.0918f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
					SHAKE_CAM(iLocal_1079, "HAND_SHAKE", 0.2f);
					SET_CAM_ACTIVE_WITH_INTERP(iLocal_1079, iLocal_1078, 4000, 3, 3);
					iLocal_1037 = 4000;
				}
				else
				{
					SET_CAM_PARAMS(iLocal_1078, -1266.193f, -215.217f, 43.2442f, -3.1088f, 0.0498f, -48.5594f, 38f, 0, 1, 1, 2);
					SHAKE_CAM(iLocal_1078, "HAND_SHAKE", 0.2f);
					SET_CAM_PARAMS(iLocal_1079, -1267.53f, -215.7824f, 43.1067f, -9.2365f, 0.0498f, -48.3561f, 38f, 0, 1, 1, 2);
					SHAKE_CAM(iLocal_1079, "HAND_SHAKE", 0.2f);
					SET_CAM_ACTIVE_WITH_INTERP(iLocal_1079, iLocal_1078, 4000, 3, 3);
					iLocal_1037 = 4000;
				}
		...
		case 4:
			...
			if (timera() >= iLocal_1037)
			{
				...
				SET_VEHICLE_DOOR_SHUT(iLocal_1065, 1, 1);
				SET_VEHICLE_DOOR_SHUT(iLocal_1065, 0, 1);
				SET_VEHICLE_DOOR_SHUT(iLocal_1065, 2, 1);
				CLEAR_HELP(1);
				if (GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{
...
void func_382(bool bParam0)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
	{
		...
		REMOVE_VEHICLE_RECORDING(102, "ASSOJva");
		REMOVE_VEHICLE_RECORDING(107, "ASSOJva");
		SET_ENTITY_COORDS(iLocal_1065, vLocal_1057, 1, false, 0, 1);
		SET_ENTITY_HEADING(iLocal_1065, fLocal_1040);
		SET_VEHICLE_DOOR_SHUT(iLocal_1065, 0, 1);
		SET_VEHICLE_DOOR_SHUT(iLocal_1065, 1, 1);
		SET_VEHICLE_DOOR_SHUT(iLocal_1065, 2, 1);
		SET_VEHICLE_DOOR_SHUT(iLocal_1065, 2, 1);
...
{
	if (func_385() && GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
void func_388(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_392(IS_PED_INJURED())) && !func_390(IS_PED_INJURED(), 0)) && !func_389()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_392(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_396()
{
	...
	{
		CLEAR_PED_TASKS_IMMEDIATELY(CLEAR_PED_TASKS_IMMEDIATELY());
		SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -1266.173f, -214.0011f, 41.4459f, 1, false, 0, 1);
		SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 310.0126f);
	}
}
...
void func_405()
{
	...
	{
		CLEAR_PED_TASKS_IMMEDIATELY(CLEAR_PED_TASKS_IMMEDIATELY());
		SET_ENTITY_COORDS(SET_ENTITY_COORDS(), vLocal_1061, 1, false, 0, 1);
		SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 299.4985f);
	}
	if (DOES_ENTITY_EXIST(iLocal_1068))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_1068, 0))
		{
			SET_VEHICLE_ENGINE_ON(iLocal_1068, false, true, 0);
			SET_ENTITY_COORDS(iLocal_1068, -1251.873f, -256.7999f, 38.2695f, 1, false, 0, 1);
			SET_ENTITY_HEADING(iLocal_1068, 296.7603f);
			SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1068, 1084227584);
		}
	}
}
...
void func_408()
{
	if (DOES_ENTITY_EXIST(iLocal_1065))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
		{
			...
			while (iLocal_1017 < 3)
			{
				if (!DOES_ENTITY_EXIST(iLocal_941[iLocal_1017]))
				{
					if (iLocal_1017 == 0)
					{
						iLocal_941[iLocal_1017] = CREATE_PED_INSIDE_VEHICLE(iLocal_1065, 26, iLocal_1075, -1, 1, true);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 0, 0, 2, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 3, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 4, 0, 1, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 8, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 11, 0, 0, 0);
					}
					else if (iLocal_1017 == 1)
					{
						iLocal_941[iLocal_1017] = CREATE_PED_INSIDE_VEHICLE(iLocal_1065, 26, iLocal_1075, 0, 1, true);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 0, 1, 2, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 3, 0, 1, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 4, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 8, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 11, 0, 2, 0);
					}
					else if (iLocal_1017 == 2)
					{
						iLocal_941[iLocal_1017] = CREATE_PED_INSIDE_VEHICLE(iLocal_1065, 26, iLocal_1076, 1, 1, true);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 0, 1, 2, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 3, 0, 2, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 4, 0, 1, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 8, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(iLocal_941[iLocal_1017], 11, 1, 1, 0);
					}
				}
				iLocal_1017++;
			}
...
void func_409()
{
	if (!DOES_ENTITY_EXIST(iLocal_1065))
	{
		iLocal_1065 = CREATE_VEHICLE(iLocal_1074, vLocal_1056, fLocal_1039, true, true, false);
		SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1074);
		_0x2B6747FAA9DB9D6B(iLocal_1065, 1);
		SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1065, true, 1);
		SET_VEHICLE_PROVIDES_COVER(iLocal_1065, 1);
	}
}
...
int func_411(float fParam0, int iParam1)
{
	...
	if (((IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) && func_412(IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0), fParam0, 1, 1056964608, 0, 1, 0)) && !IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE())) || !IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
...
void func_414()
{
	...
	switch (iLocal_1018)
	{
		...
		case 1:
			func_427();
			if (!DOES_ENTITY_EXIST(iLocal_1070))
			{
				if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
					{
						...
						{
							iLocal_1070 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
							if (DOES_ENTITY_EXIST(iLocal_1070) && !DOES_ENTITY_EXIST(iLocal_1070, 0))
							{
								func_296(iLocal_1070);
							}
			...
			if (!IS_PLAYER_WANTED_LEVEL_GREATER(IS_PLAYER_WANTED_LEVEL_GREATER(), 0))
			{
				if (!func_424())
				{
					if (!DOES_BLIP_EXIST(iLocal_949))
					{
						iLocal_949 = func_423(vLocal_1061, 1);
						SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_949, "ASS_VA_DESTBLIP");
				...
				else if (_0x7D41E9D2D17C5B2D(iLocal_955) && func_420())
				{
					func_419();
					func_263();
					iLocal_931 = 8;
...
void func_415()
{
	if (!iLocal_957)
	{
		...
		{
			func_417();
			iLocal_955 = _0x1F3F018BC3AFA77C(-1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 80f, 12, 127);
			iLocal_957 = 1;
		}
	}
	else if (func_281(vLocal_1061, 1) > 120f)
	{
		if (_0x07C313F94746702C(iLocal_955))
		{
			_0x1EE7D8DF4425F053(iLocal_955);
			func_271();
			iLocal_957 = 0;
		}
	}
	else if (!_0x07C313F94746702C(iLocal_955))
	{
		if (!func_416())
		{
			iLocal_957 = 0;
...
int func_416()
{
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		if (IS_VEHICLE_MODEL(IS_VEHICLE_MODEL(IS_VEHICLE_MODEL(), 0), joaat("taxi")))
		{
			if (GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(), 0), -1, 0) != GET_PED_IN_VEHICLE_SEAT())
			{
				return 1;
			}
		}
...
void func_417()
{
	REQUEST_MODEL(iLocal_1075);
	REQUEST_MODEL(iLocal_1076);
}
...
int func_420()
{
	...
	func_417();
	if (HAS_MODEL_LOADED(iLocal_1075) && HAS_MODEL_LOADED(iLocal_1076))
	{
		iVar0 = 1;
	}
	else
...
int func_424()
{
	...
	if (func_425())
	{
		if (IS_ENTITY_AT_COORD(iLocal_938, vLocal_1061, 25f, 25f, 90f, true, true, 0))
		{
			iVar1 = 1;
		}
	}
	if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
	{
		if ((fVar0 < 2f || IS_ENTITY_AT_COORD(iLocal_938, vLocal_1061, 2f, 2f, 2f, true, true, 0)) || iVar1)
		{
			if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1141.085f, -192.66f, 75.756f, -1246.085f, -192.66f, 100.756f, 115f, 0, true, 0))
			{
				if (func_425() && iVar1)
				{
					return 1;
				}
				else if (!IS_ENTITY_IN_AIR(IS_ENTITY_IN_AIR()))
				{
					return 1;
				}
			}
...
int func_425()
{
	...
	if (IS_PED_IN_ANY_PLANE(IS_PED_IN_ANY_PLANE()) || IS_PED_IN_ANY_PLANE(IS_PED_IN_ANY_PLANE()))
	{
		iLocal_1068 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
		iVar0 = GET_ENTITY_MODEL(iLocal_1068);
...
void func_426()
{
	...
	switch (iLocal_1025)
	{
		case 0:
			...
			if ((((((HAS_MODEL_LOADED(joaat("a_m_m_bevhills_01")) && HAS_MODEL_LOADED(joaat("a_f_m_bevhills_01"))) && HAS_MODEL_LOADED(joaat("a_f_m_bevhills_02"))) && HAS_MODEL_LOADED(joaat("taxi"))) && HAS_MODEL_LOADED(joaat("a_m_y_hipster_01"))) && HAS_MODEL_LOADED("oddjobs@assassinate@hotel@")) && HAS_MODEL_LOADED("OJAS_HotelTaxi01"))
			{
				iLocal_1025++;
			}
			break;
		...
		case 1:
			Local_1427[0] = CREATE_PED(4, joaat("a_f_m_bevhills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, 1, true);
			Local_1427[1] = CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1427[0], true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1427[1], true);
			OPEN_SEQUENCE_TASK(&iVar0);
			TASK_LOOK_AT_ENTITY(0, Local_1427[1], -1, 0, 2);
			TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_TOURIST_MOBILE", -1220.679f, -203.2689f, 38.3251f, 321.2841f, 0, 0, 1);
			CLOSE_SEQUENCE_TASK(iVar0);
			if (!IS_ENTITY_DEAD(Local_1427[0], 0))
			{
				TASK_PERFORM_SEQUENCE(Local_1427[0], iVar0);
			}
			CLEAR_SEQUENCE_TASK(&iVar0);
			OPEN_SEQUENCE_TASK(&iVar0);
			TASK_LOOK_AT_ENTITY(0, Local_1427[0], -1, 0, 2);
			TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_TOURIST_MAP", -1219.596f, -201.3663f, 38.3251f, 110.7199f, 0, 0, 1);
			CLOSE_SEQUENCE_TASK(iVar0);
			if (!IS_ENTITY_DEAD(Local_1427[1], 0))
			{
				TASK_PERFORM_SEQUENCE(Local_1427[1], iVar0);
			}
			CLEAR_SEQUENCE_TASK(&iVar0);
			Local_1427.f_4 = CREATE_VEHICLE(joaat("taxi"), -1221.73f, -199.0665f, 38.1751f, 152.5038f, true, true, false);
			SET_VEHICLE_ON_GROUND_PROPERLY(Local_1427.f_4, 1084227584);
			Local_1427.f_3 = CREATE_PED_INSIDE_VEHICLE(Local_1427.f_4, 4, joaat("a_m_y_hipster_01"), -1, 1, true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1427.f_3, true);
			TASK_LOOK_AT_ENTITY(Local_1427.f_3, Local_1427[0], -1, 0, 2);
			Local_1427.f_8[0] = CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, 1, true);
			Local_1427.f_8[1] = CREATE_PED(4, joaat("a_m_y_hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, 1, true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1427.f_8[0], true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1427.f_8[1], true);
			TASK_PLAY_ANIM(Local_1427.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0, 0, 0, 0);
			TASK_PLAY_ANIM(Local_1427.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0, 0, 0, 0);
			Local_1427.f_5[0] = CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, 1, true);
			Local_1427.f_5[1] = CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, 1, true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1427.f_5[0], true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1427.f_5[1], true);
			TASK_PLAY_ANIM(Local_1427.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			TASK_PLAY_ANIM(Local_1427.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			Local_1427.f_11 = 1;
...
void func_427()
{
	...
	if (iLocal_1011)
	{
		if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			fLocal_1049 = vdist(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), vLocal_1061);
			iLocal_1011 = 0;
		}
	}
...
void func_429()
{
	...
	{
		func_434();
		if (!IS_PED_INJURED(iLocal_944))
		{
			fVar1 = func_29(iLocal_944, 1);
			SET_PED_CAN_PLAY_AMBIENT_ANIMS(iLocal_944, 0);
			SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_944, 0);
			SET_PED_CAN_BE_TARGETTED(iLocal_944, false);
			_SET_PED_RAGDOLL_BLOCKING_FLAGS(iLocal_944, 16);
			SET_PED_CONFIG_FLAG(iLocal_944, 208, true);
			if (fVar1 < 5f)
			{
			...
			{
				if (IS_ENTITY_OCCLUDED(iLocal_944) || !IS_ENTITY_OCCLUDED(iLocal_944))
				{
					func_430();
				}
			}
			switch (iLocal_1016)
			{
				case 0:
					if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
					{
						if ((IS_PED_SHOOTING(IS_PED_SHOOTING()) || (IS_PED_SHOOTING(iLocal_944) && IS_PED_SHOOTING(iLocal_944, IS_PED_SHOOTING(), 1))) || IS_PED_SHOOTING(iLocal_1426, IS_PED_SHOOTING(), 1))
						{
							if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1426, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
							{
							}
							SET_PED_MOVEMENT_CLIPSET(iLocal_944, "move_lester_CaneUp", 1048576000);
							TASK_PLAY_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
							iLocal_1016 = 1;
						}
					}
					break;
				...
				case 1:
					if (IS_ENTITY_PLAYING_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						if (GET_ENTITY_ANIM_CURRENT_TIME(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup") >= 0.376f)
						{
							OPEN_SEQUENCE_TASK(&iVar0);
							...
							TASK_WANDER_STANDARD(0, TASK_WANDER_STANDARD(iLocal_944), 0);
							CLOSE_SEQUENCE_TASK(iVar0);
							TASK_PERFORM_SEQUENCE(iLocal_944, iVar0);
							CLEAR_SEQUENCE_TASK(&iVar0);
							FORCE_PED_MOTION_STATE(iLocal_944, -668482597, false, 0, 0);
							iLocal_1016 = 2;
						}
					}
					break;
...
void func_434()
{
	if (DOES_ENTITY_EXIST(iLocal_944))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_944, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
		{
			func_37(9);
		}
	}
...
void func_435()
{
	...
	if (!IS_BIT_SET(Global_98669.f_20, 13))
	{
		func_518();
	}
	func_436(0, -1, 1);
...
void func_441()
{
	iLocal_1069[0] = CREATE_VEHICLE(iLocal_1077, -1270.045f, -251.4953f, 41.4459f, 214.63f, true, true, false);
	iLocal_1069[1] = CREATE_VEHICLE(iLocal_1077, -1265.199f, -218.4823f, 45.9981f, 127.85f, true, true, false);
}

void func_442()
{
	iLocal_1078 = CREATE_CAMERA_WITH_PARAMS(26379945, -1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
	iLocal_1079 = CREATE_CAMERA_WITH_PARAMS(26379945, -1243.588f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
}
...
int func_443()
{
	...
	iVar0 = 0;
	if (((((((((HAS_MODEL_LOADED(iLocal_1074) && HAS_MODEL_LOADED(iLocal_1077)) && HAS_MODEL_LOADED(102, "ASSOJva")) && HAS_MODEL_LOADED(107, "ASSOJva")) && HAS_MODEL_LOADED("OJASva_101")) && HAS_MODEL_LOADED("OJASva_101a")) && HAS_MODEL_LOADED("OJASva_104")) && HAS_MODEL_LOADED("ODDJOBS@ASSASSINATE@GUARD")) && HAS_MODEL_LOADED("oddjobs@assassinate@hotel@")) && HAS_MODEL_LOADED(3))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_444()
{
	REQUEST_MODEL(iLocal_1074);
	REQUEST_MODEL(iLocal_1077);
...
void func_445(bool bParam0)
{
	...
	else
	{
		...
		SET_ROADS_BACK_TO_ORIGINAL(-1349.176f, -39.0123f, -100.7554f, -1173.215f, -297.7677f, 100.8606f, true);
	}
}
...
void func_446()
{
	...
	ADD_RELATIONSHIP_GROUP("Guards", &iLocal_1080);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_1080);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1080, -1533126372);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_1080, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_1080);
	...
	iLocal_953 = ADD_SCENARIO_BLOCKING_AREA(vVar0 - Vector(15f, 15f, 15f), vVar0 + Vector(15f, 15f, 15f), 0, 1, 1, 1);
	iLocal_954 = ADD_SCENARIO_BLOCKING_AREA(vVar1 - Vector(45f, 35f, 35f), vVar1 + Vector(45f, 35f, 35f), 0, 1, 1, 1);
}
...
void func_448()
{
	...
	while (iLocal_1017 <= 4)
	{
		fLocal_1042[iLocal_1017] = GET_RANDOM_FLOAT_IN_RANGE(0f, 2f);
		iLocal_1017++;
	}
	fLocal_327 = 7000f;
	fLocal_328 = 2000f;
...
void func_449()
{
	switch (iLocal_1018)
	{
		case 0:
			...
			SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 0, 0);
			SET_PLAYER_WANTED_LEVEL_NOW(SET_PLAYER_WANTED_LEVEL_NOW(), 0);
			if ((((HAS_MODEL_LOADED(joaat("ig_lestercrest")) && HAS_MODEL_LOADED(joaat("prop_cs_walking_stick"))) && HAS_MODEL_LOADED("oddjobs@assassinate@hotel@leadin")) && HAS_MODEL_LOADED("oddjobs@assassinate@hotel@leaning@")) && HAS_MODEL_LOADED("move_lester_CaneUp"))
			{
				iLocal_1018++;
			}
			break;
		...
		case 1:
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				...
				SET_ENTITY_COORDS(SET_ENTITY_COORDS(), vLocal_1415, 1, false, 0, 1);
				SET_ENTITY_HEADING(SET_ENTITY_HEADING(), fLocal_1416);
				_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
				TASK_PLAY_ANIM(TASK_PLAY_ANIM(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 1000f, -4f, -1, 513, 0, 0, 0, 0);
				if (!DOES_CAM_EXIST(iLocal_1417))
				{
					iLocal_1417 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1419, vLocal_1420, 42.2032f, 1, 2);
					SHAKE_CAM(iLocal_1417, "HAND_SHAKE", 0.3f);
				}
				if (!DOES_CAM_EXIST(iLocal_1418))
				{
					iLocal_1418 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1421, vLocal_1422, 42.2032f, 0, 2);
					SET_CAM_ACTIVE_WITH_INTERP(iLocal_1418, iLocal_1417, 5000, 1, 1);
					SHAKE_CAM(iLocal_1417, "HAND_SHAKE", 0.3f);
				}
				RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
				if (func_46(0))
		...
		case 2:
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				if (IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 3))
				{
		...
		case 4:
			...
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), "Franklin", 0, 0, 0);
			}
			REGISTER_ENTITY_FOR_CUTSCENE(iLocal_944, "Lester", 2, joaat("ig_lestercrest"), 0);
		...
		case 6:
			...
			if (!DOES_ENTITY_EXIST(iLocal_944))
			{
				if (DOES_CUTSCENE_ENTITY_EXIST("Lester", 0))
				{
					...
					{
						iLocal_944 = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_PED_INDEX_FROM_ENTITY_INDEX("Lester", 0));
					}
				}
			}
			if (!DOES_ENTITY_EXIST(iLocal_945))
			{
				if (DOES_CUTSCENE_ENTITY_EXIST("WalkingStick_Lester", 0))
				{
					if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST("WalkingStick_Lester", 0)))
					{
						iLocal_945 = GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("WalkingStick_Lester", 0);
					}
				}
			}
			SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			...
			if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST("Lester", 0)))
			{
				...
				{
					if (DOES_ENTITY_EXIST(iLocal_944) && !DOES_ENTITY_EXIST(iLocal_944))
					{
						SET_ENTITY_COORDS(iLocal_944, -1509.458f, -948.195f, 7.75f, 1, false, 0, 1);
						SET_ENTITY_HEADING(iLocal_944, -11f);
						TASK_PLAY_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
						_0x2208438012482A1A(iLocal_944, 0, 0);
					}
				}
			}
			if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST("Lester", 0)))
			{
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("WalkingStick_Lester", 0))
				{
					if (DOES_ENTITY_EXIST(iLocal_944) && !DOES_ENTITY_EXIST(iLocal_944))
					{
						ATTACH_ENTITY_TO_ENTITY(iLocal_945, iLocal_944, ATTACH_ENTITY_TO_ENTITY(iLocal_944, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					}
				}
			}
			if (HAS_CUTSCENE_FINISHED() && !HAS_CUTSCENE_FINISHED())
			{
				...
				if (!IS_PED_INJURED(iLocal_944))
				{
					SET_ENTITY_PROOFS(iLocal_944, false, false, false, false, false, false, 0, false);
					SET_PED_CAN_RAGDOLL(iLocal_944, 1);
				}
				SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
				if (IS_SCREEN_FADED_OUT())
...
void func_451()
{
	if (!DOES_ENTITY_EXIST(iLocal_1426))
	{
		iLocal_1426 = GET_CLOSEST_OBJECT_OF_TYPE(-1510.103f, -947.7194f, 8.2332f, 5f, -403891623, 1, 0, 1);
	}
}
				...
				if (DOES_ENTITY_EXIST(iVar0))
				{
					if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
					{
						if ((iVar0 != iLocal_1071[0] && iVar0 != iLocal_1071[1]) && iVar0 != iLocal_1071[2])
						{
							...
							SET_ENTITY_AS_MISSION_ENTITY(iLocal_1071[iLocal_1036 + 1], true, 0);
							_0x02398B627547189C(iLocal_1071[iLocal_1036 + 1], 0);
							iLocal_1036++;
						}
					}
				}
	...
	if (Local_1427.f_11)
	{
		if (!bLocal_994)
		{
			if (iLocal_931 < 10)
			{
				...
				{
					iVar0 = func_36(1116471296, 1);
					if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(iVar0, 0))
					{
...
void func_457(int iParam0, bool bParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		if ((bParam1 && GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1) || !bParam1)
		{
			OPEN_SEQUENCE_TASK(&iVar0);
...
void func_458()
{
	...
	switch (iLocal_1026)
	{
		case 0:
			...
			{
				if (!IS_ENTITY_DEAD(Local_1427[0], 0) && !IS_ENTITY_DEAD(Local_1427[1], 0))
				{
					TASK_LOOK_AT_ENTITY(Local_1427[0], Local_1427[1], -1, 0, 2);
					TASK_LOOK_AT_ENTITY(Local_1427[1], Local_1427[0], -1, 0, 2);
				}
				if (((DOES_ENTITY_EXIST(Local_1427[1]) && DOES_ENTITY_EXIST(Local_1427.f_4)) && !DOES_ENTITY_EXIST(Local_1427[1])) && DOES_ENTITY_EXIST(Local_1427.f_4, 0))
				{
					CLEAR_PED_TASKS(Local_1427[1]);
					TASK_ENTER_VEHICLE(Local_1427[1], Local_1427.f_4, 20000, 2, 1f, 1, 0);
				}
		...
		case 1:
			if (!iLocal_999)
			{
				if (func_58(&iLocal_1096))
				{
					...
					{
						if (((DOES_ENTITY_EXIST(Local_1427[0]) && DOES_ENTITY_EXIST(Local_1427.f_4)) && !DOES_ENTITY_EXIST(Local_1427[0])) && DOES_ENTITY_EXIST(Local_1427.f_4, 0))
						{
							if (GET_SCRIPT_TASK_STATUS(Local_1427[0], -1794415470) != 1)
							{
								CLEAR_PED_TASKS(Local_1427[0]);
								TASK_ENTER_VEHICLE(Local_1427[0], Local_1427.f_4, 20000, 1, 1f, 1, 0);
								iLocal_999 = 1;
							}
						}
					}
			...
			if (!IS_PED_INJURED(Local_1427[0]) && !IS_PED_INJURED(Local_1427[1]))
			{
				if (IS_PED_IN_VEHICLE(Local_1427[0], Local_1427.f_4, 0) && IS_PED_IN_VEHICLE(Local_1427[1], Local_1427.f_4, 0))
				{
					if (!IS_ENTITY_DEAD(Local_1427.f_3, 0) && !IS_ENTITY_DEAD(Local_1427.f_4, 0))
					{
						TASK_CLEAR_LOOK_AT(Local_1427.f_3);
						func_56(&iLocal_1096);
					}
					iLocal_1026++;
				}
		...
		case 2:
			if (func_58(&iLocal_1096))
			{
				if (func_52(&iLocal_1096) > 3f)
				{
					if (!IS_PED_INJURED(Local_1427.f_3) && IS_PED_INJURED(Local_1427.f_4, 0))
					{
						TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1427.f_3, Local_1427.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
						iLocal_1026++;
					}
				}
			}
		...
		case 3:
			if (!IS_ENTITY_DEAD(Local_1427.f_3, 0) && !IS_ENTITY_DEAD(Local_1427.f_4, 0))
			{
				if (!IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_1427.f_4) || iLocal_1002)
				{
					TASK_VEHICLE_DRIVE_WANDER(Local_1427.f_3, Local_1427.f_4, 10f, 786603);
					iLocal_1026++;
				}
			}
			break;
		...
		case 4:
			if (iLocal_1002)
			{
				if (!IS_PED_INJURED(iLocal_942[0]))
				{
					iVar0 = iLocal_942[0];
				}
				else
...
void func_459()
{
	if ((DOES_ENTITY_EXIST(Local_1427.f_3) && !DOES_ENTITY_EXIST(Local_1427.f_3, 0)) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		TASK_SMART_FLEE_PED(Local_1427.f_3, TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
	}
	if ((DOES_ENTITY_EXIST(Local_1427[0]) && !DOES_ENTITY_EXIST(Local_1427[0], 0)) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		TASK_SMART_FLEE_PED(Local_1427[0], TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
		SET_PED_FLEE_ATTRIBUTES(Local_1427[0], 2, false);
	}
	if ((DOES_ENTITY_EXIST(Local_1427[1]) && !DOES_ENTITY_EXIST(Local_1427[1], 0)) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		TASK_SMART_FLEE_PED(Local_1427[1], TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
		SET_PED_FLEE_ATTRIBUTES(Local_1427[1], 2, false);
	}
	if ((DOES_ENTITY_EXIST(Local_1427.f_8[0]) && !DOES_ENTITY_EXIST(Local_1427.f_8[0], 0)) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		TASK_SMART_FLEE_PED(Local_1427.f_8[0], TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
	}
	if ((DOES_ENTITY_EXIST(Local_1427.f_8[1]) && !DOES_ENTITY_EXIST(Local_1427.f_8[1], 0)) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		TASK_SMART_FLEE_PED(Local_1427.f_8[1], TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
	}
	if ((DOES_ENTITY_EXIST(Local_1427.f_5[0]) && !DOES_ENTITY_EXIST(Local_1427.f_5[0], 0)) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		TASK_SMART_FLEE_PED(Local_1427.f_5[0], TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
	}
	if ((DOES_ENTITY_EXIST(Local_1427.f_5[1]) && !DOES_ENTITY_EXIST(Local_1427.f_5[1], 0)) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		TASK_SMART_FLEE_PED(Local_1427.f_5[1], TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
	}
}

int func_460()
{
	if (!IS_ENTITY_DEAD(Local_1427.f_3, 0))
	{
		if (IS_PED_BEING_JACKED(Local_1427.f_3))
		{
			if (GET_PEDS_JACKER(Local_1427.f_3) == GET_PEDS_JACKER())
			{
				return 1;
			}
		}
	}
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(Local_1427.f_4, 0))
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_1427.f_4, 0))
		{
			return 1;
		}
	}
	...
	if (func_514(uParam0))
	{
		...
		if (func_513(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_491(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_316(iParam0, 0, 0)) || func_316(iParam0, 1, 0)) || func_316(iParam0, 2, 0)) || func_301(iParam0) != 145) || func_481(iParam0)) || func_480(iParam0)) || func_479(iParam0)) || func_478(iParam0)) || !func_468(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_480(iParam0))
		{
		}
...
int func_491(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_493(iParam0, uVar1[iVar3], 1) && func_492(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_50(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_495(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_303(iParam0, iParam1))
				{
...
void func_496(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_306(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_306(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_306(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_504(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_503())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_306(iVar2 + 1)))
				{
...
int func_497(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_501(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_500(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_500(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_499(iParam0);
	if (func_498(*iParam0))
	{
...
void func_526()
{
	...
	if (DOES_ENTITY_EXIST(Global_95196.f_28[0]))
	{
		...
		SET_OBJECT_AS_NO_LONGER_NEEDED(&(Global_95196.f_28[0]));
	}
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_953, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_954, 0);
	func_518();
	func_92(&uLocal_1277, 0, 0);
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
	{
		func_528(PLAYER_PED_ID(), 1);
		SET_PED_USING_ACTION_MODE(SET_PED_USING_ACTION_MODE(), false, -1, 0);
	}
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	CLEAR_PED_NON_CREATION_AREA();
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_1075, false);
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_1076, false);
	func_527();
...
void func_527()
{
	...
	while (iVar0 < 3)
	{
		if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
		{
			...
			{
				SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -1223.185f, -185.4723f, 38.1753f, 1, false, 0, 1);
				SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 119.5633f);
			}
		}
		iVar0++;
	}
