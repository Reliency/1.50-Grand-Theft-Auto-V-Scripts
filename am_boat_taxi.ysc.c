...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (NETWORK_END_TUTORIAL_SESSION() != bLocal_960)
		{
			func_148();
		}
		switch (func_135(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_134() == 1)
				{
					func_133();
					func_132();
					vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/] = 1;
				}
				else if (func_134() == 4)
				{
					vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/] = 3;
				}
				break;
			...
			case 1:
				...
				{
					if (!IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(Local_95.f_2), true), 200f, 200f, 200f, false, true, 0))
					{
						vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/] = 4;
					}
				}
				break;
				...
				case 0:
					if (func_68(&(Local_95.f_16), 10000, 0))
					{
						if (!IS_BIT_SET(Local_95, 12))
						{
							...
							Local_95.f_10 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false) + Vector(0f, 5f, 0f) };
...
int func_2()
{
	...
	if (Local_95.f_21 >= 0 || Local_95.f_21 <= 3)
	{
		if (NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
		{
			if (!func_72(Local_95.f_2))
			{
				if (NETWORK_GET_DESTROYER_OF_NETWORK_ID(Local_95.f_2, &uVar0) == NETWORK_GET_DESTROYER_OF_NETWORK_ID())
				{
					func_5(1, 600000);
				}
				return 1;
		...
		if (NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3))
		{
			...
			{
				if (NETWORK_GET_DESTROYER_OF_NETWORK_ID(Local_95.f_3, &uVar1) == NETWORK_GET_DESTROYER_OF_NETWORK_ID())
				{
					func_5(1, 600000);
				}
				return 1;
...
void func_30()
{
	...
	if (Local_95.f_20 != 7)
	{
		...
		else if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(Local_95.f_3), IS_PED_IN_VEHICLE(Local_95.f_2), 0))
		{
			Local_95.f_20 = 7;
		}
	}
	if (!func_4(Local_95.f_3) && func_72(Local_95.f_2))
	{
		if (Local_95.f_20 != 1)
		{
			if (GET_ENTITY_HEALTH(GET_ENTITY_HEALTH(Local_95.f_2)) <= 600 || GET_ENTITY_HEALTH(GET_ENTITY_HEALTH(Local_95.f_3)) <= 150)
			{
				Local_95.f_20 = 1;
			}
		}
		switch (Local_95.f_20)
		{
			case 2:
				...
				else if (!IS_BIT_SET(Local_95, 7) && IS_BIT_SET(IS_BIT_SET(Local_95.f_3), IS_BIT_SET(), 10f, 10f, 10f, 0, 1, 0))
				{
					Local_95.f_20 = 3;
				}
				break;
			...
			case 4:
				SET_BIT(&iLocal_97, 8);
				if (GET_VEHICLE_NUMBER_OF_PASSENGERS(GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2)) <= 0)
				{
					Local_95.f_20 = 3;
					CLEAR_BIT(&iLocal_97, 8);
				}
				else if (!IS_BIT_SET(Local_95, 7) && IS_BIT_SET(IS_BIT_SET(Local_95.f_3), Local_95.f_7, 10f, 10f, 10f, false, true, 0))
				{
					Local_95.f_20 = 5;
				}
				break;
			...
			case 5:
				if ((GET_VEHICLE_NUMBER_OF_PASSENGERS(GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2)) <= 0 && !GET_VEHICLE_NUMBER_OF_PASSENGERS(GET_VEHICLE_NUMBER_OF_PASSENGERS(), GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2))) && func_31(GET_VEHICLE_NUMBER_OF_PASSENGERS(), GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2), 1) >= 10f)
				{
					Local_95.f_20 = 6;
				}
				break;
			...
			case 3:
				if (GET_VEHICLE_NUMBER_OF_PASSENGERS(GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2)) >= 1)
				{
					Local_95.f_20 = 4;
				}
				break;
			...
			case 6:
				if ((GET_VEHICLE_NUMBER_OF_PASSENGERS(GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2)) <= 0 && !GET_VEHICLE_NUMBER_OF_PASSENGERS(GET_VEHICLE_NUMBER_OF_PASSENGERS(), GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2))) && func_31(GET_VEHICLE_NUMBER_OF_PASSENGERS(), GET_VEHICLE_NUMBER_OF_PASSENGERS(Local_95.f_2), 1) >= 10f)
				{
					if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), 242628503) == 1)
					{
						Local_95.f_20 = 7;
					}
				}
			...
			case 1:
				if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), 242628503) == 1 && func_31(GET_SCRIPT_TASK_STATUS(), GET_SCRIPT_TASK_STATUS(Local_95.f_3), 1) >= 10f)
				{
					Local_95.f_20 = 7;
				}
				break;
...
void func_32()
{
	...
	{
		case 0:
			if (IS_BIT_SET(Local_95, 8) || IS_BIT_SET(IS_BIT_SET(Local_95.f_2)) > 0)
			{
				Local_95.f_21 = 1;
			}
			break;
		...
		if (NETWORK_IS_PARTICIPANT_ACTIVE(NETWORK_IS_PARTICIPANT_ACTIVE(iVar0)))
		{
			...
			if (func_3(iVar1, 1, 1))
			{
				if (func_72(Local_95.f_2))
				{
					...
					{
						if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(Local_95.f_2), Local_95.f_10, (10f * 1.5f), (10f * 1.5f), (10f * 1.5f), false, true, 0))
						{
							SET_BIT(&Local_95, 8);
						}
					}
					if (!IS_BIT_SET(Local_95, 7) || IS_BIT_SET(Local_95, 11))
					{
						...
						{
							if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(Local_95.f_2), Local_95.f_7, (10f * 1.5f), (10f * 1.5f), (10f * 1.5f), false, true, 0))
							{
								SET_BIT(&Local_95, 10);
							}
						}
					...
					{
						if (IS_BIT_SET(vLocal_96[iVar0 /*3*/].f_1, 6))
						{
							SET_BIT(&Local_95, 9);
							CLEAR_BIT(&(vLocal_96[iVar0 /*3*/].f_1), 6);
						}
					}
					if (Local_95.f_20 != 3)
					{
						if (IS_BIT_SET(vLocal_96[iVar0 /*3*/].f_1, 5))
						{
							Local_95.f_20 = 3;
							CLEAR_BIT(&(vLocal_96[iVar0 /*3*/].f_1), 5);
						}
					}
				}
			}
...
void func_34()
{
	...
	if ((Local_95.f_21 <= 2 || Local_95.f_20 == 2) || Local_95.f_20 == 3)
	{
		...
		if ((!GET_WATER_HEIGHT_NO_WAVES(vVar0, &uVar1) || func_36()) || func_35())
		{
			Local_95.f_1 = 4;
		}
	}
...
int func_35()
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 2631.833f, 4526.624f, -10f, -380.1435f, 3906.702f, 78.484f, 1200f, 0, true, 0))
	{
		return 1;
	}
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1731.902f, -123.8468f, 137.2596f, 2079.203f, 798.3421f, 249.3267f, 600f, 0, true, 0))
	{
		return 1;
	}
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 252.5025f, 855.094f, 148.1213f, -393.3539f, 695.785f, 272.1867f, 500f, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_36()
{
	...
	while (iVar0 < 21)
	{
		if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), func_37(iVar0), 50f, 50f, 50f, false, true, 0))
		{
			return 1;
		}
		iVar0++;
...
int func_39()
{
	if ((!NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3) && func_64(joaat("s_m_y_blackops_01"))) && NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		if (func_72(Local_95.f_2))
		{
			...
			{
				SET_PED_COMPONENT_VARIATION(SET_PED_COMPONENT_VARIATION(Local_95.f_3), 0, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(SET_PED_COMPONENT_VARIATION(Local_95.f_3), 2, 1, 0, 0);
				SET_PED_COMPONENT_VARIATION(SET_PED_COMPONENT_VARIATION(Local_95.f_3), 3, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(SET_PED_COMPONENT_VARIATION(Local_95.f_3), 4, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(SET_PED_COMPONENT_VARIATION(Local_95.f_3), 8, 1, 0, 0);
				SET_PED_COMPONENT_VARIATION(SET_PED_COMPONENT_VARIATION(Local_95.f_3), 9, 0, 0, 0);
				if (Global_1590446[PLAYER_ID() /*871*/] != 0)
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(SET_PED_RELATIONSHIP_GROUP_HASH(Local_95.f_3), Global_1574997);
				}
				else
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(SET_PED_RELATIONSHIP_GROUP_HASH(Local_95.f_3), Global_1574680[2 /*94*/][2 /*31*/][2 /*10*/][2 /*3*/][0]);
				}
				SET_PED_KEEP_TASK(SET_PED_KEEP_TASK(Local_95.f_3), true);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_95.f_3), true);
				SET_ENTITY_HEALTH(SET_ENTITY_HEALTH(Local_95.f_3), round((200f * Global_262145.f_154)), 0);
				SET_PED_CAN_BE_DRAGGED_OUT(SET_PED_CAN_BE_DRAGGED_OUT(Local_95.f_3), 0);
				SET_PED_CONFIG_FLAG(SET_PED_CONFIG_FLAG(Local_95.f_3), 255, true);
			}
		}
	}
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3))
...
int func_41()
{
	...
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		...
		{
			if (!IS_BIT_SET(iLocal_97, 10))
			{
				func_61(&vLocal_793, &fLocal_794);
				if (TEST_PROBE_AGAINST_WATER(vLocal_793 + Vector(2f, 0f, 0f), vLocal_793 - Vector(10f, 0f, 0f), &vLocal_793))
				{
					if (func_45(vLocal_793, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
					{
						vVar2 = { vLocal_793 + Vector(12f, 0f, 0f) };
						iLocal_791 = START_SHAPE_TEST_BOX(vVar2, 10f, 10f, 25f, 0f, 0f, -1f, 2, 1, 0, 4);
						if (iLocal_791 == 0)
						{
							return 0;
						}
						...
						{
							SET_BIT(&iLocal_97, 10);
						}
					}
				}
			}
			else if (GET_SHAPE_TEST_RESULT(iLocal_791, &iLocal_792, &uVar0, &uVar0, &uVar1) == 2)
			{
				iLocal_791 = 0;
				if (iLocal_792 == 0)
				{
					...
					{
						_0x9737A37136F07E75(_0x9737A37136F07E75(Local_95.f_2), 1);
						SET_VEHICLE_ENGINE_ON(SET_VEHICLE_ENGINE_ON(Local_95.f_2), true, true, 0);
						SET_VEHICLE_FORWARD_SPEED(SET_VEHICLE_FORWARD_SPEED(Local_95.f_2), 12f);
						_0x25367DE49D64CF16(_0x25367DE49D64CF16(Local_95.f_2), 1);
						_SET_ENTITY_SOMETHING(_SET_ENTITY_SOMETHING(Local_95.f_2), false);
					}
				}
				else
				{
					iLocal_792 = 0;
					CLEAR_BIT(&iLocal_97, 10);
				}
			}
			else if (GET_SHAPE_TEST_RESULT(iLocal_791, &iLocal_792, &uVar0, &uVar0, &uVar1) == 0)
			{
				iLocal_791 = 0;
				CLEAR_BIT(&iLocal_97, 10);
			}
...
void func_43(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (func_44(PLAYER_ID(), vParam0, iParam2) > -1)
	{
...
int func_46(vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	...
	if (iParam2 && !bParam5)
	{
		if (func_3(PLAYER_ID(), 1, 1))
		{
			if (!IS_SCREEN_FADED_OUT())
			{
				...
				if (GET_DISTANCE_BETWEEN_COORDS(func_50(GET_DISTANCE_BETWEEN_COORDS()), vParam0, true) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_3(iVar1, 1, 1))
		{
			if (!func_48(iVar1, 0) && _0x3B39236746714134(_0x3B39236746714134(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER_ID()))
				{
					if ((func_47(iVar1) || !bParam8) && !Global_2424073[iVar1 /*421*/].f_259)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_50(iVar1), vParam0, true) <= (fVar2 + fParam1))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_3(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!IS_PED_INJURED(IS_PED_INJURED(iVar1)) && func_47(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && GET_PLAYER_TEAM(GET_PLAYER_TEAM()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(GET_PLAYER_TEAM()) == -1)
						{
							...
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_51(iVar1), vParam0, true) < fParam1)
								{
									return 1;
								}
							}
...
Vector3 func_62(vector3 vParam0, float fParam1, float fParam2, float fParam3)
{
	...
	fVar1 = (fParam3 / 2f);
	vVar0 = { func_63(vVar0, GET_RANDOM_FLOAT_IN_RANGE(fParam1, fParam2)) };
...
Vector3 func_65(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			while (iVar0 <= 4)
			{
				fVar3 = GET_DISTANCE_BETWEEN_COORDS(Local_95.f_10, func_37(iVar0), true);
				if (fVar3 < fVar4)
				{
					iVar1 = iVar0;
					fVar4 = fVar3;
...
void func_74()
{
	if (func_3(PLAYER_ID(), 1, 1))
	{
		if (Local_95.f_21 == 5)
		{
			vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 5;
		}
		switch (vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2)
		{
			case 0:
				func_97();
				if (Local_95.f_21 > 0)
				{
					vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 1;
				}
				break;
			...
			case 1:
				...
				{
					func_132();
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), IS_PED_IN_VEHICLE(Local_95.f_2), 0))
					{
						func_96();
						vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 3;
						CLEAR_PED_TASKS(CLEAR_PED_TASKS());
						CLEAR_BIT(&(vLocal_96[CLEAR_BIT() /*3*/].f_1), 0);
					}
				}
				break;
			...
			case 2:
				if (func_72(Local_95.f_2))
				{
					...
					{
						vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 3;
						CLEAR_BIT(&(vLocal_96[CLEAR_BIT() /*3*/].f_1), 5);
						SET_BIT(&(vLocal_96[SET_BIT() /*3*/].f_1), 6);
						if (Local_95.f_21 >= 4)
						{
							vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 4;
						}
					}
					else
					{
			...
			case 4:
				if (func_72(Local_95.f_2))
				{
					...
					{
						if (GET_ENTITY_SPEED(GET_ENTITY_SPEED(Local_95.f_2)) < 3f)
						{
							TASK_LEAVE_ANY_VEHICLE(TASK_LEAVE_ANY_VEHICLE(), 0, 0);
							SET_BIT(&iLocal_97, 3);
						}
					}
					if ((!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), IS_PED_IN_VEHICLE(Local_95.f_2), 0) && !IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), IS_PED_IN_VEHICLE(Local_95.f_2))) && func_31(IS_PED_IN_VEHICLE(), IS_PED_IN_VEHICLE(Local_95.f_2), 1) >= 10f)
					{
						vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 5;
					}
				}
...
void func_75()
{
	...
	if (HAS_SCALEFORM_MOVIE_LOADED(iLocal_103))
	{
		if (func_90(1, 1))
		{
			if (((vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1 || vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 2) || vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 3) || vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 4)
			{
				iVar0 = 1;
				Var1 = { func_89() };
				func_87(&uLocal_104);
				if (vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1)
				{
					if (func_72(Local_95.f_2))
					{
						if ((IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY(), IS_ENTITY_AT_ENTITY(Local_95.f_2), 10f, 10f, 3f, 0, 1, 0) && !IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY(), 0)) && !func_86(IS_ENTITY_AT_ENTITY(Local_95.f_2), 0))
						{
							func_85(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 23, true), "BTX_ENTER", &uLocal_104, 0);
						}
					}
				}
				else
	...
	{
		iLocal_103 = 0x67D02A194A2FC2BD("instructional_buttons");
	}
}
			...
			while (iVar0 < uParam2->f_680)
			{
				if (IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					else
					{
						...
						func_80(_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
...
void func_96()
{
	if (DOES_BLIP_EXIST(iLocal_99))
	{
		REMOVE_BLIP(&iLocal_99);
	}
}
...
void func_100()
{
	if (!func_4(Local_95.f_3) && func_72(Local_95.f_2))
	{
		if (NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_3) || (!NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_3) && NETWORK_HAS_CONTROL_OF_NETWORK_ID()))
		{
			func_130();
			func_104();
			if (func_103(Local_95.f_3))
			{
				SET_PED_RESET_FLAG(SET_PED_RESET_FLAG(Local_95.f_3), 323, true);
			}
			switch (Local_95.f_20)
			{
				case 0:
				...
				case 2:
					if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), -1273030092) != 1 && GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), -1273030092) != 0)
					{
						TASK_BOAT_MISSION(TASK_BOAT_MISSION(Local_95.f_3), TASK_BOAT_MISSION(Local_95.f_2), 0, TASK_BOAT_MISSION(), 0f, 0f, 0f, 4, 12f, 786469, 10f, 1071);
					}
					break;
				
				case 4:
					func_102(GET_ENTITY_COORDS(GET_ENTITY_COORDS(Local_95.f_2), false), Local_95.f_7);
					_0x07FB139B592FA687(fLocal_966, fLocal_968, fLocal_967, fLocal_969);
					if (_0xF7B79A50B905A30D(fLocal_966, fLocal_968, fLocal_967, fLocal_969))
					{
						if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), 242628503) != 1 && GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), 242628503) != 0)
						{
							TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(Local_95.f_3), iLocal_102);
						}
					}
					break;
				...
				case 5:
					if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), -1273030092) != 1 && GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(Local_95.f_3), -1273030092) != 0)
					{
						TASK_VEHICLE_MISSION_COORS_TARGET(TASK_VEHICLE_MISSION_COORS_TARGET(Local_95.f_3), TASK_VEHICLE_MISSION_COORS_TARGET(Local_95.f_2), TASK_VEHICLE_MISSION_COORS_TARGET(TASK_VEHICLE_MISSION_COORS_TARGET(Local_95.f_2), true), 5, 5f, 1076625579, 2f, 1f, 1);
					}
					break;
				...
				case 1:
					if (!IS_BIT_SET(vLocal_96[IS_BIT_SET() /*3*/].f_1, 7))
					{
						if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), IS_PED_IN_VEHICLE(Local_95.f_2), 0) || IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), IS_PED_IN_VEHICLE(Local_95.f_2)))
						{
							SET_PED_DIES_IN_WATER(SET_PED_DIES_IN_WATER(Local_95.f_3), 0);
							SET_PED_DIES_INSTANTLY_IN_WATER(SET_PED_DIES_INSTANTLY_IN_WATER(Local_95.f_3), 0);
							SET_PED_FLEE_ATTRIBUTES(SET_PED_FLEE_ATTRIBUTES(Local_95.f_3), 2, false);
							TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(Local_95.f_3), iLocal_100);
						}
						else
						{
							SET_PED_DIES_IN_WATER(SET_PED_DIES_IN_WATER(Local_95.f_3), 0);
							SET_PED_DIES_INSTANTLY_IN_WATER(SET_PED_DIES_INSTANTLY_IN_WATER(Local_95.f_3), 0);
							SET_PED_FLEE_ATTRIBUTES(SET_PED_FLEE_ATTRIBUTES(Local_95.f_3), 2, true);
							TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(Local_95.f_3), iLocal_101);
						}
						SET_BIT(&(vLocal_96[SET_BIT() /*3*/].f_1), 7);
					}
					break;
...
void func_104()
{
	...
	{
		if (IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY(), IS_ENTITY_AT_ENTITY(Local_95.f_3), 15f, 15f, 15f, 0, 1, 0))
		{
			func_129(&uLocal_795, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			if (func_108(&uLocal_795, "FMAMBAU", "FMA_BPDA", 12, 0, 0, 1))
			{
				TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(Local_95.f_3), TASK_LOOK_AT_ENTITY(), 5000, 0, 2);
				SET_BIT(&iLocal_97, 4);
			}
		}
	}
	if (!IS_BIT_SET(iLocal_97, 6))
	{
		if (Local_95.f_20 == 4)
		{
			func_129(&uLocal_795, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
	...
	{
		if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), Local_95.f_7, (10f * 2f), (10f * 2f), (10f * 2f), false, true, 0))
		{
			func_129(&uLocal_795, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
				...
				if (!IS_BIT_SET(iLocal_98, iVar0))
				{
					...
					if (!IS_STRING_NULL_OR_EMPTY(&Var1))
					{
						...
						if (func_108(&uLocal_795, "FMAMBAU", &Var1, 12, 0, 0, 1))
						{
							...
							SET_BIT(&iLocal_98, iVar0);
							TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(Local_95.f_3), TASK_LOOK_AT_ENTITY(), 5000, 0, 2);
							iLocal_963 = (GET_RANDOM_INT_IN_RANGE(20000, 30001) + iVar0 * 500);
						}
					}
				}
			}
	...
	if (!func_4(Local_95.f_3))
	{
		if (func_72(Local_95.f_2))
		{
			if (!IS_AMBIENT_SPEECH_PLAYING(IS_AMBIENT_SPEECH_PLAYING(Local_95.f_3)) && !IS_AMBIENT_SPEECH_PLAYING(IS_AMBIENT_SPEECH_PLAYING(Local_95.f_3)))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_95.f_2), HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_95.f_3), HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
				{
					...
					CLEAR_ENTITY_LAST_DAMAGE_ENTITY(CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_95.f_2));
					CLEAR_ENTITY_LAST_DAMAGE_ENTITY(CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_95.f_3));
				}
			}
			else
			{
...
{
	_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_106(iParam2), 1);
}
...
void func_120()
{
	...
	{
		if (func_123(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_130()
{
	...
	if (func_3(PLAYER_ID(), 1, 1))
	{
		if (IS_PED_SITTING_IN_VEHICLE(IS_PED_SITTING_IN_VEHICLE(), IS_PED_SITTING_IN_VEHICLE(Local_95.f_2)) && !func_131(IS_PED_SITTING_IN_VEHICLE(), IS_PED_SITTING_IN_VEHICLE(Local_95.f_2), -1))
		{
...
void func_132()
{
	if (!DOES_BLIP_EXIST(iLocal_99))
	{
		if (func_72(Local_95.f_2))
		{
			iLocal_99 = ADD_BLIP_FOR_ENTITY(ADD_BLIP_FOR_ENTITY(Local_95.f_2));
			SET_BLIP_SPRITE(iLocal_99, 356);
			SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_99, "BTX_BLIP");
			SET_BLIP_FLASHES(iLocal_99, true);
			SET_BLIP_CATEGORY(iLocal_99, 6);
		}
	}
}
...
void func_133()
{
	if (func_72(Local_95.f_2))
	{
		...
		TASK_BOAT_MISSION(0, TASK_BOAT_MISSION(Local_95.f_2), 0, 0, Local_95.f_7, 4, 12f, 786469, 10f, 1071);
		CLOSE_SEQUENCE_TASK(iLocal_102);
		OPEN_SEQUENCE_TASK(&iLocal_101);
		TASK_VEHICLE_MISSION_COORS_TARGET(0, TASK_VEHICLE_MISSION_COORS_TARGET(Local_95.f_2), Local_95.f_13, 4, 12f, 786469, 0f, 0f, 1);
		TASK_VEHICLE_DRIVE_WANDER(0, TASK_VEHICLE_DRIVE_WANDER(Local_95.f_2), 12f, 786469);
		CLOSE_SEQUENCE_TASK(iLocal_101);
		OPEN_SEQUENCE_TASK(&iLocal_100);
		...
		CLOSE_SEQUENCE_TASK(iLocal_100);
	}
}
...
int func_136()
{
	...
	if (func_137() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_137()) == 0)
		{
			return 1;
		}
	}
...
void func_148()
{
	...
	func_150();
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_103);
	func_149();
}
...
void func_150()
{
	CLEAR_SEQUENCE_TASK(&iLocal_100);
...
int func_153(struct<21> Param0)
{
	...
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_96, 97);
	if (!func_154())
	{
		return 0;
	}
	...
	SET_BIT(&iLocal_97, 8);
	bLocal_960 = NETWORK_END_TUTORIAL_SESSION();
	vLocal_96[PARTICIPANT_ID_TO_INT() /*3*/] = 0;
	return 1;
}
