...
void __EntryFunction__()
{
	...
	func_395();
	func_381();
	iLocal_264 = ADD_SCENARIO_BLOCKING_AREA(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_380(27, 0);
	if (func_379())
	{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_150, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				CLEAR_AREA(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, false);
				func_2();
				func_396();
			}
			break;
...
void func_2()
{
	...
	REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_290);
	func_5(&Local_290);
	func_4(&iLocal_262);
	iVar0 = 0;
	while (iVar0 <= 2)
...
void func_23()
{
	...
	{
		if (func_27(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_35()
{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			if (iLocal_45 == 2)
			{
				if (func_12(&uLocal_150, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
				{
		...
		case 3:
			if (func_7(Local_290))
			{
				if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_290, 0))
				{
					SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), Local_290, -1);
				}
				else
				{
...
void func_39(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_44(IS_PED_INJURED())) && !func_41(IS_PED_INJURED(), 0)) && !func_40()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_44(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
	...
	if ((iParam3 == 1 || iParam3 == 2) || iParam3 == 3)
	{
		if (iParam4 == 0)
		{
			...
			else
			{
				...
				{
					fVar0 = (fParam10 / 2f);
					if (func_63(PLAYER_PED_ID(), vParam1, fVar0))
					{
						*iParam5 = 0;
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, vLocal_265, 0))
			{
				...
				{
					iLocal_271 = ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
					if (GET_BLIP_FROM_ENTITY(Local_290) != 0)
					{
						iVar0 = GET_BLIP_FROM_ENTITY(Local_290);
...
void func_72()
{
	...
	iLocal_467 = 1;
	func_380(27, 0);
	_SET_DOOR_ACCELERATION_LIMIT(Global_40519[13 /*31*/], 4, true, false);
	iLocal_468 = 0;
}
...
void func_73()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			CLEAR_BIT(&(Local_289[iVar1 /*22*/].f_15), iVar0);
			iVar0++;
		}
	...
	switch (iParam0)
	{
		...
		case 2:
			if (func_7(Global_95196[0]))
			{
				...
				if (func_7(Local_290))
				{
					if (!DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(Local_290))
					{
						ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_290);
					}
					_SET_VEHICLE_DOOR_CAN_BREAK(Local_290, 2, false);
					_SET_VEHICLE_DOOR_CAN_BREAK(Local_290, 3, false);
					func_89(Local_290, 0);
					SET_VEHICLE_HAS_STRONG_AXLES(Local_290, true);
					SET_VEHICLE_DOORS_LOCKED(Local_290, 1);
					return 1;
				}
			}
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				...
				{
					if (!IS_PED_DEAD_OR_DYING(Global_95196.f_9[iVar0], 1))
					{
						SET_ENTITY_AS_MISSION_ENTITY(Global_95196.f_9[iVar0], true, 1);
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				...
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_95196[iVar3], true, 1);
		...
		case 5:
			if (func_83(&iLocal_262, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_290))
				{
					ATTACH_ENTITY_TO_ENTITY(iLocal_262, Local_290, 0, 0f, -1.85f, 0.05f, ATTACH_ENTITY_TO_ENTITY(Local_290, 2), 0, 0, 0, 0, 2, 1);
					if (IS_ENTITY_ATTACHED_TO_ENTITY(Local_290, iLocal_262))
					{
						return 1;
					}
				}
...
void func_91(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, vector3 vParam5, int iParam6, bool bParam7, float fParam8)
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), *iParam0, 0) && !func_97(*iParam0)) && !func_96(*iParam0))
				{
					func_34(iParam4);
...
int func_96(int iParam0)
{
	...
	if ((func_377(PLAYER_PED_ID()) && PLAYER_PED_ID(PLAYER_PED_ID(), 0)) && func_7(iParam0))
	{
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, 0), vLocal_266, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_43[iParam0] = 3;
			break;
		
		case 3:
			if (!func_111(iParam0, iParam1) || func_63(PLAYER_PED_ID(), vLocal_266, 2f))
			{
				iLocal_43[iParam0] = 4;
			}
			break;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((DOES_ENTITY_EXIST(Local_290) && DOES_ENTITY_EXIST(Local_290, 0)) && !DOES_ENTITY_EXIST(Local_290, vLocal_266, 2f, 2f, 2f, false, true, 0))
		{
			if ((!IS_PED_INJURED(IS_PED_INJURED()) && IS_PED_INJURED(IS_PED_INJURED(), Local_290, 0)) && IS_PED_INJURED(IS_PED_INJURED()) == 0)
			{
				if (IS_PED_IN_VEHICLE(iParam1, Local_290, 0) && IS_PED_IN_VEHICLE(Local_290, -1, 0) == iParam1)
				{
					iLocal_44[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if (IS_ENTITY_IN_ANGLED_AREA(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, true, 0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, true, 0))
		{
			iLocal_470 = 0;
			iLocal_44[iParam0] = 1;
			return 1;
		}
		else if (IS_ENTITY_IN_ANGLED_AREA(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, true, 0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, true, 0))
		{
			iLocal_470 = 1;
			iLocal_44[iParam0] = 1;
			return 1;
...
void func_118()
{
	...
	if (!bLocal_28)
	{
		...
		{
			_SWITCH_CRIME_TYPE(_SWITCH_CRIME_TYPE(), 38);
			_SWITCH_CRIME_TYPE(_SWITCH_CRIME_TYPE(), 30);
			bLocal_274 = false;
		}
		if (iLocal_40 == 2)
		{
			if (!iLocal_286)
			{
				if (!func_63(PLAYER_PED_ID(), Local_290.f_1, 180f))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
...
void func_119()
{
	...
	{
		if (DOES_ENTITY_EXIST(Local_289[iVar0 /*22*/]) && !DOES_ENTITY_EXIST(Local_289[iVar0 /*22*/]))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_289[iVar0 /*22*/], HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
			{
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_289[iVar0 /*22*/]);
				if (((IS_PED_CURRENT_WEAPON_SILENCED(IS_PED_CURRENT_WEAPON_SILENCED()) || IS_PED_CURRENT_WEAPON_SILENCED(Local_289[iVar0 /*22*/])) || IS_PED_CURRENT_WEAPON_SILENCED(Local_289[iVar0 /*22*/])) || IS_PED_CURRENT_WEAPON_SILENCED(Local_289[iVar0 /*22*/]))
				{
					if (!bLocal_274)
					{
						_SWITCH_CRIME_TYPE(_SWITCH_CRIME_TYPE(), 41);
						_SWITCH_CRIME_TYPE(_SWITCH_CRIME_TYPE(), 33);
...
void func_120(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_20)
	{
		case 1:
			...
			{
				if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(1000, 1500)
				{
					if (!func_78(Local_289[iParam0 /*22*/], -875674219))
					{
						_0xF1C03A5352243A30(Local_289[iParam0 /*22*/]);
						TASK_TURN_PED_TO_FACE_ENTITY(Local_289[iParam0 /*22*/], TASK_TURN_PED_TO_FACE_ENTITY(), 0);
					}
		...
		case 2:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(5000, 6000)
			{
				if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 2))
				{
					func_127(iParam0);
					func_125();
					return;
		...
		case 3:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(2500, 3000)
			{
				if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 8))
				{
					Local_289[iParam0 /*22*/].f_17 = 1;
				}
				else
		...
		case 4:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(2500, 3000)
			{
				if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 8))
				{
					...
					else if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 9) && !bLocal_272)
					{
						func_127(iParam0);
						func_125();
						return;
		...
		case 6:
			...
			{
				if (!IS_PED_BEING_STUNNED(Local_289[iParam0 /*22*/], 0) && !IS_PED_BEING_STUNNED(Local_289[iParam0 /*22*/]))
				{
					Local_289[iParam0 /*22*/].f_14 = GET_GAME_TIMER();
					func_127(iParam0);
				}
		...
		case 5:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(1000, 3000)
			{
				func_125();
				return;
			}
		...
		case 7:
			if ((GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > 350)
			{
				...
				else
				{
					if (iLocal_465 != -1)
					{
						...
						else if ((IS_PED_SHOOTING(IS_PED_SHOOTING()) || IS_PED_SHOOTING(IS_PED_SHOOTING())) || IS_PED_SHOOTING(IS_PED_SHOOTING()))
						{
							func_123(2);
						}
						else if (GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(), &iVar1))
						{
					...
					if ((func_78(Local_289[iParam0 /*22*/], -2128726980) || func_78(Local_289[iParam0 /*22*/], -982327190)) && GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) < 2)
					{
						if (!func_78(Local_289[iParam0 /*22*/], 1392476864))
						{
							TASK_ARREST_PED(Local_289[iParam0 /*22*/], TASK_ARREST_PED());
						}
					}
				}
			}
			if (!iLocal_463)
			{
				if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 1) && IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
void func_123(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), iParam0, 0);
		SET_PLAYER_WANTED_LEVEL_NOW(SET_PLAYER_WANTED_LEVEL_NOW(), 0);
	}
}
...
int func_124(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 14)
	{
		if (iVar0 != iParam1)
		{
			if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, iVar0))
			{
				return 0;
			}
		}
...
void func_128(int iParam0)
{
	...
	if ((iLocal_40 != 2 && !iLocal_464) && !IS_ENTITY_DEAD(Local_289[iParam0 /*22*/], 0))
	{
		if (func_133(iParam0) && func_131(Local_289[iParam0 /*22*/], 30f))
		{
			...
			if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 3))
			{
				iLocal_464 = 1;
			}
			else if (!func_124(iParam0, 15) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, true, 0))
			{
				func_129();
				iLocal_461 = 0;
				if (iParam0 == 2)
				...
				{
					_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_289[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_464 = 1;
			}
		}
...
int func_131(int iParam0, float fParam1)
{
	...
	if (func_377(PLAYER_PED_ID()) && func_377(iParam0))
	{
...
void func_135()
{
	if (func_12(&uLocal_46, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
	{
		if (!func_103())
		{
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_289[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || IS_EXPLOSION_IN_SPHERE(-1, IS_EXPLOSION_IN_SPHERE(Local_289[iParam0 /*22*/], true), 100f))
		{
			if ((!IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/]) && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/])) && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/]))
			{
				func_125();
			}
			else if (!bLocal_274)
			{
				_SWITCH_CRIME_TYPE(_SWITCH_CRIME_TYPE(), 41);
				_SWITCH_CRIME_TYPE(_SWITCH_CRIME_TYPE(), 33);
				_SWITCH_CRIME_TYPE(_SWITCH_CRIME_TYPE(), 12);
				SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 0, 0);
				SET_PLAYER_WANTED_LEVEL_NOW(SET_PLAYER_WANTED_LEVEL_NOW(), 0);
			}
		}
...
int func_155(int iParam0, float fParam1)
{
	...
	if (func_6(PLAYER_PED_ID()) && func_6(iParam0))
	{
		if (func_166(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 6))
			{
				fVar0 = 40f;
...
int func_161(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_163(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_163(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_171(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_163(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), IS_ENTITY_AT_COORD(Local_289[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), 6))
	{
		return 1;
	}
	return 0;
...
void func_174(int iParam0)
{
	...
	{
		if (((!bLocal_272 && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/])) && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/])) && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/]))
		{
			func_175(iParam0);
		}
	}
...
void func_177(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		else if (iParam1 == 3)
		{
			...
			{
				if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		else if (iParam1 == 5)
		{
			if (Local_289[func_150(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_289[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 12))
		{
			return;
		}
	}
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		else if (iParam1 == 5)
		{
			if (Local_289[iParam0 /*22*/].f_19 != 5)
			{
				...
				_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_289[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
...
void func_184(int iParam0)
{
	...
	{
		fVar0 = GET_PLAYER_CURRENT_STEALTH_NOISE(GET_PLAYER_CURRENT_STEALTH_NOISE());
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_282)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, true, 0))
				{
					...
					else if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_289[iParam0 /*22*/].f_16) && !IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10)) && !IS_BIT_SET(IS_BIT_SET(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, true, 0)) && IS_BIT_SET(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0))
						{
							func_186(iParam0, 11);
							return;
						}
				...
				if (((IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0)) && !IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/].f_15, 10)) && !IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_289[iParam0 /*22*/].f_16) && !IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, true, 0))
					{
						func_186(iParam0, 11);
					}
				}
		...
		else if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, true, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, true, 0))
		{
...
{
	if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, iParam1))
	{
		CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), iParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_186(int iParam0, int iParam1)
{
	if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, iParam1))
	{
		SET_BIT(&(Local_289[iParam0 /*22*/].f_15), iParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_187(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_153(Local_289[iParam0 /*22*/], PLAYER_PED_ID(), 5f, 1) && !PLAYER_PED_ID(Local_289[iParam0 /*22*/])) && !PLAYER_PED_ID(Local_289[iParam0 /*22*/])) && !PLAYER_PED_ID(Local_289[iParam0 /*22*/]))
		{
...
int func_188(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), IS_ENTITY_AT_COORD(Local_289[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, false, true, 0))
		{
			return 1;
		}
	}
...
{
	if (IS_ENTITY_TOUCHING_ENTITY(Local_289[iParam0 /*22*/], IS_ENTITY_TOUCHING_ENTITY()))
	{
...
void func_190(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_289[iParam0 /*22*/].f_16)
			{
				if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 12))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, true, 0))
					{
						iLocal_282 = 1;
						iLocal_281 = GET_GAME_TIMER();
						if (iVar0 == 4)
			...
			else if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, true, 0) || IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), Local_255[3 /*7*/], Local_255[3 /*7*/].f_3, Local_255[3 /*7*/].f_6, 0, true, 0))
	{
		func_193(iParam0, 3);
	}
	else
		...
		case 4:
			if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
				...
				if (func_7(iVar0))
				{
					...
					if (!IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_255[4 /*7*/], Local_255[4 /*7*/].f_3, Local_255[4 /*7*/].f_6, 0, true, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
					else if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 7))
					{
						func_186(iParam0, 7);
					}
				}
...
void func_193(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 6) && !IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 1)) && !IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 9))
			{
				if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10))
				{
					func_186(iParam0, 10);
				}
			}
		...
		case 2:
			if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 1))
			{
				if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 6))
				{
					func_186(iParam0, 6);
				}
			}
		...
		case 3:
			if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 14))
			{
				func_186(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 8))
			{
				if (IS_PED_IN_ANY_POLICE_VEHICLE(IS_PED_IN_ANY_POLICE_VEHICLE()))
				{
		...
		case 5:
			if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 4))
			{
				if ((!IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/]) && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/])) && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/]))
				{
					func_186(iParam0, 4);
...
void func_198(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_19)
	{
		case 1:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(2500, 3000)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, true, 0))
				{
					func_127(iParam0);
					func_125();
					return;
				...
				{
					if ((IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 13) && (IS_BIT_SET() - iLocal_276) > 2500) && !iLocal_466)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
		...
		case 2:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(1500, 2000)
			{
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 7:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_GAME_TIMER(2500, 3000)
			{
				fVar1 = GET_PLAYER_CURRENT_STEALTH_NOISE(GET_PLAYER_CURRENT_STEALTH_NOISE());
				if (((fVar1 < 12f && !Local_289[iParam0 /*22*/].f_16) && !IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10)) && !func_78(Local_289[iParam0 /*22*/], -875674219))
				{
...
void func_201(int iParam0)
{
	...
	if (!iLocal_466)
	{
		bVar0 = GET_PED_STEALTH_MOVEMENT(GET_PED_STEALTH_MOVEMENT());
		if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 13))
		{
			if (IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10))
			{
				if (Local_289[iParam0 /*22*/].f_16)
		...
		else if (func_133(iParam0))
		{
			if (bVar0)
			{
				...
				{
					if (!IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10) && !IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 6))
					{
						CLEAR_BIT(&(Local_289[iParam0 /*22*/].f_15), 13);
					}
				}
...
void func_202(int iParam0)
{
	...
	bVar0 = IS_PED_ARMED(IS_PED_ARMED(), 4);
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_289[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || IS_EXPLOSION_IN_SPHERE(-1, IS_EXPLOSION_IN_SPHERE(Local_289[iParam0 /*22*/], true), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	...
	if (func_377(Local_289[iParam0 /*22*/]))
	{
		...
		if (IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY(), Local_289[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0))
		{
			if (IS_PLAYER_FREE_AIMING_AT_ENTITY(IS_PLAYER_FREE_AIMING_AT_ENTITY(), Local_289[iParam0 /*22*/]) || IS_PLAYER_FREE_AIMING_AT_ENTITY(IS_PLAYER_FREE_AIMING_AT_ENTITY(), Local_289[iParam0 /*22*/]))
			{
				if (Local_289[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_205()
{
	...
	{
		if ((((func_377(Local_289[0 /*22*/]) && func_377(Local_289[1 /*22*/])) && func_12(&uLocal_46, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true))) && func_63(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f)) && func_63(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_377(Local_289[2 /*22*/]) && func_12(&uLocal_98, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true))) && func_63(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f))
		{
			if (!IS_BIT_SET(Local_289[2 /*22*/].f_15, 2) && !IS_BIT_SET(Local_289[2 /*22*/].f_15, 4))
			{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, bLocal_28))
			{
				...
				if (_DOES_DOOR_EXIST(Global_40519[13 /*31*/]))
				{
					_0x06C0023BED16DD6B(Global_40519[13 /*31*/], 1);
				}
				iLocal_479 = 0;
		...
		case 1:
			if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) < 3)
			{
				if (func_377(Local_289[2 /*22*/]))
				{
					...
					{
						if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, true, 2) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA()))
						{
			...
			if ((IS_PED_CLIMBING(IS_PED_CLIMBING()) && iLocal_479 == 0) && func_132(Local_290, IS_PED_CLIMBING(), 1) < 100f)
			{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, 0))
			{
				...
				CLEAR_AREA_OF_PEDS(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				CLEAR_AREA_OF_PEDS(Local_289[0 /*22*/].f_1, 5f, 0);
				if (func_273(PLAYER_PED_ID(), 12, 4) || func_273(PLAYER_PED_ID(), 12, 3))
				{
					bLocal_272 = true;
				}
				func_224();
...
void func_224()
{
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			func_225(iVar0, GET_ENTITY_COORDS(iVar0, true), GET_ENTITY_COORDS(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_243(iParam0, 0, 0)) || func_243(iParam0, 1, 0)) || func_243(iParam0, 2, 0)) || func_266(iParam0) != 145) || func_242(iParam0)) || func_241(iParam0)) || func_240(iParam0)) || func_239(iParam0)) || !func_229(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_241(iParam0))
		{
		}
...
var func_246()
{
	...
	func_256(&uVar0, GET_CLOCK_SECONDS());
	func_255(&uVar0, GET_CLOCK_MINUTES());
	func_254(&uVar0, GET_CLOCK_HOURS());
	func_249(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_248(&uVar0, GET_CLOCK_MONTH());
	func_247(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_252(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_274(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_274(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_279(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_279(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_279(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_279(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_274(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_274(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_296(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_296(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_274(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_363()
{
	...
	{
		_SET_DOOR_ACCELERATION_LIMIT(iLocal_269, 0, true, true);
	}
	else
	{
		_SET_DOOR_ACCELERATION_LIMIT(iLocal_269, 1, true, true);
	}
}
...
void func_364()
{
	if (bLocal_274)
	{
		if (IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || IS_COP_PED_IN_AREA_3D(IS_COP_PED_IN_AREA_3D(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, true, 0))
		{
			if (func_12(&uLocal_150, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
			{
	...
	else if (IS_PED_IN_ANY_POLICE_VEHICLE(IS_PED_IN_ANY_POLICE_VEHICLE()) || iLocal_42 == 1)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, true, 0) || IS_ENTITY_IN_ANGLED_AREA(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_366(Global_40519[13 /*31*/], &fLocal_270);
		}
		else
...
void func_365(int iParam0, float fParam1)
{
	if (_DOES_DOOR_EXIST(iParam0))
	{
		if (*fParam1 != 0f)
		{
			...
			_SET_DOOR_AJAR_ANGLE(iParam0, *fParam1, true, true);
			*fParam1 = (*fParam1 - (0.2f * timestep()));
			if (*fParam1 <= 0f)
			{
				_SET_DOOR_ACCELERATION_LIMIT(iParam0, 1, true, false);
...
void func_371()
{
	...
	{
		if (!func_63(PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 100f) && !bLocal_287)
		{
			func_373("PR_AREAWARN", &bLocal_287);
		}
		else if (!func_63(PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 170f) && bLocal_287)
		{
			func_372(3);
		}
	}
...
void func_374()
{
	...
	else
	{
		...
		if (iLocal_40 == 2 || iLocal_40 == 3)
		{
			if (!func_153(PLAYER_PED_ID(), Local_290, 50f, 1) && !bLocal_288)
			{
				func_373("PR_VANWARN", &bLocal_288);
			}
			else if (!func_153(PLAYER_PED_ID(), Local_290, 100f, 1) && bLocal_288)
			{
				func_372(4);
			}
		}
...
void func_375()
{
	if (IS_VEHICLE_STUCK_ON_ROOF(Local_290))
	{
		if (iLocal_268)
		{
...
void func_385()
{
	...
	if (!_DOES_DOOR_EXIST(iLocal_269))
	{
		ADD_DOOR_TO_SYSTEM(iLocal_269, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, true, 0);
	}
	_SET_DOOR_ACCELERATION_LIMIT(Global_40519[13 /*31*/], 1, true, false);
	_SET_DOOR_ACCELERATION_LIMIT(iLocal_269, 1, true, false);
}
...
void func_391()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar2 <= (15 - 1))
		{
			CLEAR_BIT(&(Local_289[iVar1 /*22*/].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
...
void func_396()
{
	...
	if (_DOES_DOOR_EXIST(Global_40519[13 /*31*/]))
	{
		_0x06C0023BED16DD6B(Global_40519[13 /*31*/], 0);
	}
	_SET_DOOR_AJAR_ANGLE(Global_40519[13 /*31*/], 0f, true, true);
	_SET_DOOR_ACCELERATION_LIMIT(Global_40519[13 /*31*/], 4, true, true);
	_SET_DOOR_ACCELERATION_LIMIT(iLocal_269, 0, true, false);
	REMOVE_DOOR_FROM_SYSTEM(iLocal_269);
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_264, 0);
	func_55();
	SET_MAX_WANTED_LEVEL(5);
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_406();
...
void func_397(bool bParam0)
{
	...
	if (bParam0)
	{
		if (DOES_ENTITY_EXIST(Local_290))
		{
			if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
			{
				if (!IS_PED_INJURED(IS_PED_INJURED()))
