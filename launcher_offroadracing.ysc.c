...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH()) > 1 && !func_142(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (GET_GROUND_Z_FOR_3D_COORD(ScriptParam_274.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
		...
		if (DOES_ENTITY_EXIST(iLocal_53) && !DOES_ENTITY_EXIST(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_114(3) && !Global_98703)
						{
							...
							{
								if ((!func_142(uLocal_58, 1) || !DOES_ENTITY_EXIST(func_113())) && !Global_98703)
								{
									func_135(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_92(iLocal_54))
								{
									...
									else if (!func_142(uLocal_58, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_90(&iLocal_60);
				...
				case 6:
					...
					if (func_142(uLocal_58, 2097152))
					{
						if (!func_114(3) && !IS_THREAD_ACTIVE(iLocal_50))
						{
							func_135(10);
						}
					}
					...
					{
						PLAYSTATS_ODDJOB_DONE(round((func_23(&iLocal_71) * 1000f)), iLocal_63, 0);
						func_22(&iLocal_71);
						...
						if (iLocal_63 != -1)
						{
							if (func_142(Global_110211, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_30(iLocal_63), 0, Global_98706, 0);
...
float func_23(int iParam0)
{
	if (func_26(iParam0))
	{
		...
		{
			return (func_24(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_24(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
int func_36()
{
	...
	ANIMPOSTFX_PLAY("SwitchSceneNeutral", 0, 1);
	wait(400);
...
void func_50()
{
	...
	fVar0 = vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), vLocal_81);
	if (fVar0 < 62500f)
	{
		func_80();
		func_77();
...
void func_54()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_95) && !DOES_ENTITY_EXIST(iLocal_95, 0))
	{
	...
	if (func_23(&iLocal_90) >= 8f)
	{
		...
		if (iVar0 > 0 && iVar0 <= 3)
		{
			if (IS_ENTITY_DEAD(Local_267[(iVar0 - 1) /*14*/], 0))
			{
				return;
			}
			switch (iVar0)
...
void func_76()
{
	...
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()) && !IS_PLAYER_PLAYING(Local_267.f_83, 0))
	{
		...
		SET_GAMEPLAY_ENTITY_HINT(Local_267.f_83, 0f, 0f, 0.75f, 1, 2000, 2000, 2000, 0);
	}
}
...
void func_77()
{
	...
	if (!IS_ENTITY_DEAD(iLocal_95, 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
	{
		switch (iLocal_266)
		{
			case 0:
				if (vdist2(GET_ENTITY_COORDS(iLocal_95, true), GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)) < 64f && !GET_ENTITY_COORDS(GET_ENTITY_COORDS(), 0))
				{
					iLocal_99 = 0;
					iLocal_100 = 0;
					iLocal_266 = 1;
			...
			case 2:
				if ((GET_SCRIPT_TASK_STATUS(iLocal_95, 242628503) != 1 || GET_SCRIPT_TASK_STATUS(iLocal_95, GET_SCRIPT_TASK_STATUS(), 20f)) && !GET_SCRIPT_TASK_STATUS())
				{
					TASK_TURN_PED_TO_FACE_ENTITY(iLocal_95, TASK_TURN_PED_TO_FACE_ENTITY(), -1);
					if (!iLocal_100)
					{
			...
			case 3:
				...
				{
					func_33(&iLocal_87);
					TASK_PLAY_ANIM(iLocal_95, "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
					iLocal_266 = 4;
				}
				break;
			
			case 4:
				if (vdist2(GET_ENTITY_COORDS(iLocal_95, true), GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)) > 225f)
				{
					OPEN_SEQUENCE_TASK(&iVar2);
					TASK_ACHIEVE_HEADING(0, Local_267.f_83.f_9, 1000);
					TASK_PLAY_ANIM(0, Local_267.f_83.f_12, Local_267.f_83.f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_79(iParam3), 0);
}
...
void func_80()
{
	...
	while (iVar2 < 5)
	{
		...
		{
			if (func_85(Local_267[iVar2 /*14*/], 1, 0, 0, 0) || IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_267[iVar2 /*14*/].f_1, 1))
			{
				func_83();
				func_82(iLocal_69);
			...
			if (!IS_PED_INJURED(Local_267[iVar2 /*14*/]))
			{
				if (func_26(&(vLocal_83[iVar2 /*3*/])))
				{
					...
					{
						if (IS_VEHICLE_DRIVEABLE(Local_267[iVar2 /*14*/].f_1, 0) && IS_VEHICLE_DRIVEABLE(Local_267[iVar2 /*14*/], Local_267[iVar2 /*14*/].f_1, 0))
						{
			...
			if (!IS_ENTITY_DEAD(Local_267[iVar2 /*14*/], 0))
			{
				if ((IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), Local_267[iVar2 /*14*/]) && !IS_ENTITY_TOUCHING_ENTITY(Local_267[iVar2 /*14*/])) && !IS_ENTITY_TOUCHING_ENTITY(Local_267[iVar2 /*14*/]))
				{
				...
				else if (Local_267[iVar2 /*14*/].f_11)
				{
					...
					TASK_PLAY_ANIM(0, Local_267[iVar2 /*14*/].f_12, Local_267[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(iVar3);
					TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], iVar3);
					CLEAR_SEQUENCE_TASK(&iVar3);
					Local_267[iVar2 /*14*/].f_11 = 0;
				}
				if (IS_PED_RAGDOLL(Local_267[iVar2 /*14*/]) || IS_PED_RAGDOLL(Local_267[iVar2 /*14*/]))
				{
					if (!Local_267[iVar2 /*14*/].f_10 && (IS_PED_RAGDOLL(Local_267[iVar2 /*14*/]) || IS_PED_RAGDOLL(Local_267[iVar2 /*14*/])))
					{
						Local_267.f_101++;
					}
				...
				else if (Local_267[iVar2 /*14*/].f_10)
				{
					...
					TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_81(), 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_ACHIEVE_HEADING(0, Local_267[iVar2 /*14*/].f_9, 1000);
					TASK_PLAY_ANIM(0, Local_267[iVar2 /*14*/].f_12, Local_267[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(iVar3);
					TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], iVar3);
	...
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_267.f_83.f_1, 0))
		{
		...
		if (!IS_PED_INJURED(Local_267.f_83))
		{
			if (func_26(&iLocal_84))
			{
				...
				{
					if (IS_VEHICLE_DRIVEABLE(Local_267.f_83.f_1, 0) && IS_VEHICLE_DRIVEABLE(Local_267.f_83, Local_267.f_83.f_1, 0))
					{
						iVar0 = GET_RANDOM_INT_IN_RANGE(250, 500);
						iVar1 = GET_RANDOM_INT_IN_RANGE(250, 500);
						OPEN_SEQUENCE_TASK(&iVar3);
		...
		if (!IS_ENTITY_DEAD(Local_267.f_83, 0))
		{
			if ((IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), Local_267.f_83) && !IS_ENTITY_TOUCHING_ENTITY(Local_267.f_83)) && !IS_ENTITY_TOUCHING_ENTITY(Local_267.f_83))
			{
			...
			if (IS_PED_RAGDOLL(Local_267.f_83) || IS_PED_RAGDOLL(Local_267.f_83))
			{
			...
			else if (Local_267.f_83.f_10)
			{
				...
				TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_81(), 8f, -8f, -1, 0, 0, 0, 0, 0);
				TASK_ACHIEVE_HEADING(0, Local_267.f_83.f_9, 1000);
				TASK_PLAY_ANIM(0, Local_267.f_83.f_12, Local_267.f_83.f_13, 8f, -8f, -1, 0, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(iVar3);
				TASK_PERFORM_SEQUENCE(Local_267.f_83, iVar3);
				CLEAR_SEQUENCE_TASK(&iVar3);
				iLocal_266 = 4;
...
void func_83()
{
	...
	GET_PED_NEARBY_PEDS(GET_PED_NEARBY_PEDS(), &iVar0, -1);
	iVar2 = 0;
	iVar2 = 0;
	while (iVar2 < iVar0)
	{
		if (DOES_ENTITY_EXIST(iVar0[iVar2]) && !DOES_ENTITY_EXIST(iVar0[iVar2]))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 4))
			{
				TASK_SMART_FLEE_PED(iVar0[iVar2], TASK_SMART_FLEE_PED(), 100f, -1, 0, 0);
			}
			else
			{
				OPEN_SEQUENCE_TASK(&iVar1);
				TASK_TURN_PED_TO_FACE_ENTITY(0, TASK_TURN_PED_TO_FACE_ENTITY(), TASK_TURN_PED_TO_FACE_ENTITY(300, 900));
				TASK_COMBAT_PED(0, TASK_COMBAT_PED(), 0, 0);
				CLOSE_SEQUENCE_TASK(iVar1);
...
{
	return func_87(GET_PLAYER_PED(GET_PLAYER_PED()), iParam0, bParam1);
}
...
{
	if (DOES_ENTITY_EXIST(iParam0) && DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), iParam0, 0))
	{
		return 0;
	}
	else
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_111()) || Global_110607) || Global_30738) || func_110()) || func_96(8, -1)) || func_109()) || func_108()) || func_107()) || func_98()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_111()) || Global_30738) || func_110()) || func_96(8, -1)) || func_107()) || func_109()) || func_108()) || func_98()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_111()) || Global_110607) || Global_30738) || func_110()) || func_96(8, -1)) || func_109()) || func_108()) || func_98()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_111() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_96(8, -1)) || func_98()) || func_106()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_111()) || Global_30738) || func_110()) || func_96(8, -1)) || func_108()) || func_107()) || func_98()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_111()) || func_108()) || Global_110607) || Global_30738) || func_110()) || Global_42561) || func_96(8, -1)) || func_107()) || func_106()) || func_98()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_111()) || Global_110607) || Global_30738) || func_110()) || func_96(8, -1)) || func_107()) || func_106()) || func_109()) || func_108()) || func_98())
						{
							return 0;
						}
						break;
...
void func_117()
{
	...
	iVar0 = GET_CLOCK_HOURS();
	if ((iVar0 <= iLocal_79 && iVar0 >= iLocal_80) || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) != 0)
	{
		return;
	}
	if (bLocal_96)
...
void func_118()
{
	...
	if (fLocal_74 > 9f)
	{
		...
		while (iVar5 < Local_267)
		{
			...
			{
				Local_267[iVar5 /*14*/].f_1 = CREATE_VEHICLE(func_122(0), Local_267[iVar5 /*14*/].f_2, Local_267[iVar5 /*14*/].f_5, true, true, false);
				SET_VEHICLE_ON_GROUND_PROPERLY(Local_267[iVar5 /*14*/].f_1, 1084227584);
				SET_VEHICLE_HAS_STRONG_AXLES(Local_267[iVar5 /*14*/].f_1, true);
				if (func_123(Local_267[iVar5 /*14*/].f_6))
				{
					Local_267[iVar5 /*14*/] = CREATE_PED_INSIDE_VEHICLE(Local_267[iVar5 /*14*/].f_1, 4, func_121(), -1, 1, true);
					SET_VEHICLE_ENGINE_ON(Local_267[iVar5 /*14*/].f_1, true, false, 0);
				}
				else
				{
					Local_267[iVar5 /*14*/] = CREATE_PED(4, func_121(), Local_267[iVar5 /*14*/].f_6, Local_267[iVar5 /*14*/].f_9, 1, true);
					iVar1 = iVar5;
					switch (iVar1)
					{
						case 0:
					...
					TASK_PAUSE(0, TASK_PAUSE(100, 500));
					TASK_PLAY_ANIM(0, sVar3, sVar4, 8f, -8f, -1, 8193, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
					CLOSE_SEQUENCE_TASK(iVar0);
					TASK_PERFORM_SEQUENCE(Local_267[iVar5 /*14*/], iVar0);
					CLEAR_SEQUENCE_TASK(&iVar0);
				}
				SET_PED_HELMET(Local_267[iVar5 /*14*/], 1);
				GIVE_PED_HELMET(Local_267[iVar5 /*14*/], 1, 4096, -1);
			}
			iVar5++;
		}
		Local_267.f_83.f_1 = CREATE_VEHICLE(func_122(1), Local_267.f_83.f_2, Local_267.f_83.f_5, true, true, false);
		SET_VEHICLE_ON_GROUND_PROPERLY(Local_267.f_83.f_1, 1084227584);
		SET_VEHICLE_HAS_STRONG_AXLES(Local_267.f_83.f_1, true);
		if (func_123(Local_267.f_83.f_6))
		{
			Local_267.f_83 = CREATE_PED_INSIDE_VEHICLE(Local_267.f_83.f_1, 4, func_121(), -1, 1, true);
			SET_VEHICLE_ENGINE_ON(Local_267.f_83.f_1, true, false, 0);
		}
		else
		{
			Local_267.f_83 = CREATE_PED(4, func_121(), Local_267.f_83.f_6, Local_267.f_83.f_9, 1, true);
			...
			OPEN_SEQUENCE_TASK(&iVar0);
			TASK_STAND_STILL(0, func_120((TASK_STAND_STILL(0, 65535) % 1000), 1, 1000));
			TASK_PLAY_ANIM(0, "amb@world_human_aa_smoke@male@idle_a", sVar4, 8f, -8f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
			CLOSE_SEQUENCE_TASK(iVar0);
	...
	if (!IS_ENTITY_DEAD(Local_267[0 /*14*/], 0))
	{
		func_119(&uLocal_101, 1, Local_267[0 /*14*/], "MALE1", 0, 1);
	}
	if (!IS_ENTITY_DEAD(Local_267[1 /*14*/], 0))
	{
		func_119(&uLocal_101, 2, Local_267[1 /*14*/], "MALE2", 0, 1);
	}
	if (!IS_ENTITY_DEAD(Local_267[2 /*14*/], 0))
	{
...
void func_127()
{
	switch (iLocal_82)
	{
		case 0:
			...
			CLEAR_AREA_OF_VEHICLES(-227.43f, 3888.9f, 36.41f, 50f, 1, 0, 0, 0, false, 0);
...
void func_143()
{
	...
	if (!func_115(func_146(iLocal_82)) && IS_SCREEN_FADED_IN())
	{
		if (iLocal_69 != 263)
		{
...
bool func_144(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		return IS_BIT_SET(Global_31111[iVar0 /*23*/].f_11, 15);
	}
	return IS_BIT_SET(Global_31111[iVar0 /*23*/].f_11, 0);
}
