				...
				if (iVar1 == 1)
				{
					if (iVar2 == 0)
					{
						if (_0x3BAB9A4E4F2FF5C7())
						{
							...
							_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_COLUMN_FOCUS");
...
void func_1()
{
	_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT_EMPTY");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
	END_SCALEFORM_MOVIE_METHOD();
}
...
void func_2(var uParam0, var uParam1, var uParam2)
{
	...
	if ((IS_CONTROL_PRESSED(2, 187) || func_12(187, &(Global_1373500.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		SET_BIT(&(uParam0->f_464), 0);
	}
	if ((IS_CONTROL_PRESSED(2, 188) || func_12(188, &(Global_1373500.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		SET_BIT(&(uParam0->f_464), 1);
	}
	if (((IS_CONTROL_PRESSED(2, 189) || IS_CONTROL_PRESSED(2, 241)) || func_12(189, &(Global_1373500.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		SET_BIT(&(uParam0->f_464), 2);
	}
	if (((IS_CONTROL_PRESSED(2, 190) || IS_CONTROL_PRESSED(2, 242)) || func_12(190, &(Global_1373500.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
...
{
	_0xC78E239AC5B2DDB9(bParam0, 6, 0);
}
	...
	if (*uParam0 == 0)
	{
		...
		while (iVar0 <= 15)
		{
			if (uParam0->f_1[iVar0] == 1)
			{
				...
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_309[iVar0]);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
				if (uParam0->f_378)
				{
				...
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_292[iVar0]);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_343[iVar0]);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_360[iVar0]);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(-1);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(-1);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(-1);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_326[iVar0]);
				END_SCALEFORM_MOVIE_METHOD();
			}
			*uParam0 = 1;
			iVar0++;
...
void func_17(var uParam0, int iParam1)
{
	...
	if (uParam0->f_381 == 0)
	{
		if (uParam0->f_380 != -1)
		{
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_380);
			END_SCALEFORM_MOVIE_METHOD();
			uParam0->f_380 = -1;
			uParam0->f_381 = 1;
		}
...
{
	if (_BEGIN_SCALEFORM_MOVIE_METHOD_N("DISPLAY_DATA_SLOT"))
	{
		...
		if (func_39(uParam0))
		{
			...
			while (iVar0 <= 11)
			{
				...
				if (uParam0->f_1[iVar0] == 1)
				{
					...
					_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_428[iVar0]);
					_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar1);
					if (func_37(&Var3))
					{
...
void func_30(var uParam0, int iParam1)
{
	...
	if (uParam0->f_458 == 0)
	{
		_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_COLUMN_HIGHLIGHT");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_455);
		END_SCALEFORM_MOVIE_METHOD();
		uParam0->f_455 = -1;
		uParam0->f_458 = 1;
	}
	...
	else
	{
		switch (iParam0)
		{
			case 17:
				...
				while (iVar0 < 28)
				{
					if (IS_BIT_SET(iVar13, iVar0))
					{
						iVar11++;
					}
					iVar0++;
				}
				if (IS_BIT_SET(iVar13, 9))
				{
					iVar11 = (iVar11 - 1);
				}
				if (IS_BIT_SET(iVar13, 26))
				{
					iVar11 = (iVar11 - 1);
				}
				if (iVar11 < 0)
