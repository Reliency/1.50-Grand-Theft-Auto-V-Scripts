...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_141.f_1 = _0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216, 0, 1.12f);
				NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_141.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1148846080, 0);
				NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_141.f_1);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar9 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iVar9))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(iVar9) >= 1f)
				{
					...
					func_49(uParam0, &sVar1);
					uParam0->f_141.f_1 = _0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216, 0, 1.12f);
					NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_141.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1148846080, 0);
					NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 8:
			iVar10 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_141.f_4 == 6)
	{
		...
		fVar1 = vmag(vVar0);
		if ((uParam0->f_141.f_4 == 6 && !HAS_ANIM_EVENT_FIRED(HAS_ANIM_EVENT_FIRED(), -1322051853)) && !func_32(&(uParam0->f_141), 12))
		{
...
void func_30(var uParam0)
{
	...
	uParam0->f_141.f_1 = _0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216, 0, 1.12f);
	func_50(uParam0, &sVar0);
	NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_141.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_141.f_1);
	func_7(&(uParam0->f_141.f_5));
	func_65(uParam0, 8);
}
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((DOES_ENTITY_EXIST(uVar0[iVar1]) && !DOES_ENTITY_EXIST(uVar0[iVar1])) && DOES_ENTITY_EXIST(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_141.f_2 /*14*/]) || vdist2(DOES_ENTITY_EXIST(uVar0[iVar1], false), (uParam0[uParam0->f_141.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_141.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_141), 1, IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0));
	func_70(&(uParam0->f_141), 3, IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1));
	func_70(&(uParam0->f_141), 0, func_45(0));
	func_70(&(uParam0->f_141), 2, IS_PED_RUNNING(IS_PED_RUNNING()));
}
...
int func_84()
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1502.824f, -3006.31f, -80.557f, -1513.824f, -3006.31f, -84.557f, 9.5f, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_85()
{
	if (Global_2424073[PLAYER_ID() /*421*/].f_309.f_8 != func_19())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2424073[NETWORK_IS_SCRIPT_ACTIVE() /*421*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
