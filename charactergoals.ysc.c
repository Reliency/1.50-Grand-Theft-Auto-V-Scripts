...
void func_5(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_7() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_7() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_13(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_7() /*10828*/].f_6168.f_10, iParam0);
}
