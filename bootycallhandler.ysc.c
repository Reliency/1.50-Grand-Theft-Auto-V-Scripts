	...
	switch (Global_110554)
	{
		case 0:
			if (!Global_110554.f_27)
			{
				...
				{
					iVar0 = iVar1;
					if (func_66(func_67(iVar0)) && (Global_110554.f_15[iVar1] + 120000) < GET_GAME_TIMER())
					{
						if (func_64(iVar0))
						{
							func_63(iVar0, 0);
						...
						else
						{
							...
							else if (((GET_GAME_TIMER() >= Global_110554.f_4[iVar1] && func_51()) && func_50(iVar0)) && func_49(iVar0) >= func_48(iVar0))
							{
...
void func_29(int iParam0, int iParam1)
{
	if (iParam1 > -1)
	{
		Global_110554.f_4[iParam0] = (GET_GAME_TIMER() + iParam1);
	}
	else
	{
		Global_110554.f_4[iParam0] = (GET_GAME_TIMER() + GET_GAME_TIMER(1200000, 2100000));
	}
}
...
void func_68()
{
	...
	switch (Global_110554)
	{
		case 0:
			...
			{
				if (GET_GAME_TIMER() >= Global_110554.f_3)
				{
...
int func_76()
{
	...
	while (iVar0 < 10)
	{
		if (Global_111560.f_243[func_47() /*53*/].f_2[iVar0 /*5*/].f_4 && GET_GAME_TIMER() >= Global_110554.f_4[iVar0])
		{
			iVar2[iVar1] = iVar0;
			iVar1++;
		}
...
void func_79()
{
	...
	{
		if (Global_110554.f_3 < (GET_GAME_TIMER() + 120000))
		{
			func_82(1800000);
		}
...
void func_82(int iParam0)
{
	if (iParam0 != -1)
	{
		Global_110554.f_3 = (GET_GAME_TIMER() + iParam0);
	}
	else
	{
		Global_110554.f_3 = (GET_GAME_TIMER() + GET_GAME_TIMER(21600000, 25200000));
	}
}
