...
void __EntryFunction__()
{
	...
	func_231(&Var0);
	iLocal_52 = ADD_SCENARIO_BLOCKING_AREA(vVar1 - Vector(20f, 20f, 20f), vVar1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		...
		if (func_169(&Var0, 0))
		{
			if (Var0 == 35)
			{
				if (iLocal_53 == 0)
				{
					...
					{
						ADD_DOOR_TO_SYSTEM(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, true, 0);
					}
					if (_DOES_DOOR_EXIST(1736361794))
					{
						_SET_DOOR_AJAR_ANGLE(1736361794, 0f, true, false);
						_SET_DOOR_ACCELERATION_LIMIT(1736361794, 1, true, false);
						iLocal_53 = 1;
					}
				}
			}
