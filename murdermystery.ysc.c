...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 6:
			if (!func_34(3))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -580.8914f, 2033.12f, 130.5113f, -578.4783f, 2035.029f, 127.5615f, 0.75f, 0, true, 0))
				{
					func_33(3, 1);
				}
			}
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0))
			{
				if (func_34(3))
				{
			...
			if (!func_34(2))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0) || IS_ENTITY_IN_ANGLED_AREA())
				{
					CREATE_MODEL_HIDE(vLocal_58, 200f, -1241212535, 0);
					func_33(2, 1);
				}
			}
			if (func_73() && !func_72())
			...
			if (func_34(1))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -594.9976f, 2089.005f, 130.3449f, -597.1125f, 2088.365f, 133.3035f, 1f, 0, true, 0))
				{
...
bool func_22(int iParam0)
{
	...
	iVar1 = GET_BITS_IN_RANGE(Global_111560.f_10044.f_133, 0, (iVar0 - 1));
...
void func_33(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		SET_BIT(&iLocal_78, iParam0);
	}
	else
	{
		CLEAR_BIT(&iLocal_78, iParam0);
	}
}

bool func_34(int iParam0)
{
	return IS_BIT_SET(iLocal_78, iParam0);
}
...
void func_35()
{
	...
	switch (iLocal_60)
	{
		case 0:
			if (!GET_MISSION_FLAG())
			{
				if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), vLocal_51, vLocal_57, true, true, 0))
				{
					if (func_62())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), vLocal_52, vLocal_57, true, true, 0))
				{
					func_54(0);
					iLocal_60 = 3;
					func_61(0, 800);
		...
		case 2:
			...
			{
				func_45(24, 0);
				func_44(PLAYER_PED_ID(), vLocal_55, fLocal_56);
				...
				NEW_LOAD_SCENE_START_SPHERE(vLocal_55, 20f, 0);
				func_39(24, &iLocal_59);
				_LOAD_INTERIOR(iLocal_59);
				iLocal_72 = (GET_GAME_TIMER() + 40000);
				while ((!IS_NEW_LOAD_SCENE_LOADED() || !IS_NEW_LOAD_SCENE_LOADED(iLocal_59)) && iLocal_72 > IS_NEW_LOAD_SCENE_LOADED())
				{
					wait(0);
				}
				NEW_LOAD_SCENE_STOP();
				if (iLocal_72 <= GET_GAME_TIMER())
				{
					...
					func_44(PLAYER_PED_ID(), vLocal_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
...
void func_49()
{
	...
	{
		case 0:
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				func_53(sLocal_76);
				iLocal_61++;
			}
		...
		case 1:
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				...
				{
					TASK_LOOK_AT_COORD(TASK_LOOK_AT_COORD(), -1007.995f, -476.8016f, 49.9117f, -1, 0, 2);
				}
				if (IS_CONTROL_JUST_PRESSED(2, 51))
				{
					func_51(0);
					TASK_FOLLOW_NAV_MESH_TO_COORD(TASK_FOLLOW_NAV_MESH_TO_COORD(), -1007.351f, -477.5197f, 49.0282f, 1f, -1, 0.5f, 0, 30.4025f);
					func_53(sLocal_77);
					DISPLAY_RADAR(false);
...
int func_63()
{
	...
	if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_70(0))
...
int func_65()
{
	...
	if (Global_30886)
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
			{
				if (!IS_PED_INJURED(IS_PED_INJURED(iVar0, 0, 0)))
				{
					return 1;
				}
			}
...
void func_68(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		SET_BIT(&(Global_111560.f_10044.f_133), iParam0);
		if (!bParam2)
		{
	...
	{
		CLEAR_BIT(&(Global_111560.f_10044.f_133), iParam0);
	}
}
...
bool func_71()
{
	return GET_ENTITY_MODEL(GET_ENTITY_MODEL()) == joaat("player_zero");
}
...
int func_72()
{
	if (func_67(PLAYER_PED_ID()))
	{
		return IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0);
	}
	return 0;
}
...
bool func_73()
{
	return vdist2(func_75(iLocal_71), vLocal_70) < func_74(iLocal_71);
}
...
{
	return IS_BIT_SET(Global_111560.f_10044.f_133, iParam0);
}
...
bool func_79()
{
	return vdist2(func_81(iLocal_71), vLocal_70) < func_80(iLocal_71);
}
...
void func_82()
{
	if (func_67(PLAYER_PED_ID()))
	{
		vLocal_70 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false) };
	}
}
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 4:
			func_86(-671910391);
			func_85(sLocal_74);
			iLocal_66 = CREATE_PED(26, -671910391, func_75(4), 184.5548f, 1, true);
			SET_MODEL_AS_NO_LONGER_NEEDED(-671910391);
			TASK_PLAY_ANIM(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			...
			SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_66, 1862763509);
			break;
		
		case 5:
			iLocal_63 = 731806707;
			ADD_DOOR_TO_SYSTEM(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, true, 0);
			_SET_DOOR_ACCELERATION_LIMIT(iLocal_63, 1, true, false);
			iLocal_62 = CREATE_CAMERA_WITH_PARAMS(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_86(732742363);
			iLocal_64 = CREATE_PED(26, 732742363, func_75(6), 22.9631f, 1, true);
			...
			SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_64, 1862763509);
			iLocal_65 = CREATE_OBJECT_NO_OFFSET(130556722, -543.71f, 1986.2f, 126.05f, true, true, false);
			break;
	}
}
...
void func_87(int iParam0, vector3 vParam1, float fParam2)
{
	*iParam0 = CREATE_TRACKED_POINT();
	...
	{
		SET_TRACKED_POINT_INFO(*iParam0, vParam1, fParam2);
	}
}
...
void func_91()
{
	switch (iLocal_71)
	{
		...
		case 5:
			if (_DOES_DOOR_EXIST(iLocal_63))
			{
				REMOVE_DOOR_FROM_SYSTEM(iLocal_63);
			}
			if (DOES_CAM_EXIST(iLocal_62))
			{
				DESTROY_CAM(iLocal_62, 0);
			}
			if (func_34(4))
			{
				DO_SCREEN_FADE_IN(0);
		...
		case 6:
			...
			if (func_34(2))
			{
				REMOVE_MODEL_HIDE(vLocal_58, 200f, -1241212535, false);
			}
			break;
	}
}
