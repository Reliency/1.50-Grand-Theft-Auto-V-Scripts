		...
		if (iLocal_241 != -1)
		{
			if (!func_220())
			{
				*iParam0 = func_219(iLocal_241);
				...
				SET_BIT(&(Global_111560.f_18569[*iParam0 /*6*/]), 2);
				CLEAR_BIT(&(Global_111560.f_18569[*iParam0 /*6*/]), 3);
...
void func_62(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_67(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_64(Var7.f_1)) && iVar9 < 51)
			{
...
int func_73(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_96())
		{
			*uParam0 = func_79(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_75(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_77() == 0)
		{
			return IS_BIT_SET(func_52(func_76(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_79(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_95(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_80(iVar0, 0), true);
...
void func_109(char* sParam0, int iParam1, int iParam2)
{
	...
	PLAYSTATS_MISSION_STARTED(sParam0, iParam1, iParam2, func_217(0));
}
...
void func_135(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_139(IS_PED_INJURED())) && !func_137(IS_PED_INJURED(), 0)) && !func_136()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_139(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
int func_148(var uParam0, bool bParam1)
{
	...
	if (Var0.f_4 != 17)
	{
		if (!IS_BIT_SET(Var0.f_26, func_227()))
		{
...
void func_149(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_128(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_151(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_150(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_151(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_150(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_72(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_157(PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_161(int iParam0, float fParam1)
{
	...
	if (func_128(PLAYER_PED_ID()) && func_128(iParam0))
	{
		if (func_172(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
{
	return func_163(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_167(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_169(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_169(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_176(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_169(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_186()
{
	return func_187(GET_THIS_SCRIPT_NAME(), 0);
}
...
void func_192()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_193(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
bool func_220()
{
	...
	else if ((func_223(0) || IS_PLAYER_SWITCH_IN_PROGRESS()) || func_222())
	{
		if (func_2("RAMP_HELP_TRIG"))
		{
			if (func_223(0))
...
int func_226(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		if (GET_DISTANCE_BETWEEN_COORDS(vVar2, vVar1, true) <= fParam0 && GET_DISTANCE_BETWEEN_COORDS((vVar2.z - vVar1.z)) < 1.5f)
		{
			return iVar0;
		}
		iVar0++;
...
void func_228(int iParam0, vector3 vParam1)
{
	...
	while (true)
	{
		...
		if (*iParam0 == 52 || *iParam0 == 53)
		{
			...
			{
				if (IS_EXPLOSION_IN_SPHERE(-1, IS_EXPLOSION_IN_SPHERE(iParam0->f_28[0], true), 5.1f))
				{
					if (*iParam0 == 52)
					{
						iVar2 = 0;
						...
						{
							if (DOES_ENTITY_EXIST(iParam0->f_41[iVar2]))
							{
								if ((func_128(iParam0->f_28[0]) && IS_ENTITY_ATTACHED_TO_ENTITY(iParam0->f_41[iVar2], iParam0->f_28[0])) || (func_128(iParam0->f_28[1]) && IS_ENTITY_ATTACHED_TO_ENTITY(iParam0->f_41[iVar2], iParam0->f_28[1])))
								{
									DELETE_OBJECT(&(iParam0->f_41[iVar2]));
								}
							}
							iVar2++;
						}
					...
					if (func_128(iParam0->f_28[1]))
					{
						...
						APPLY_DAMAGE_TO_PED(iParam0->f_28[1], 1000, 1, 0);
					}
			...
			if (func_128(iParam0->f_28[1]))
			{
				if (IS_EXPLOSION_IN_SPHERE(-1, IS_EXPLOSION_IN_SPHERE(iParam0->f_28[1], true), 5.1f))
				{
					if (*iParam0 == 52)
					{
						iVar2 = 0;
		...
		vLocal_249 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
...
void func_229(int iParam0)
{
	...
	switch (iLocal_70)
	{
		...
		case 1:
			if (func_128(iParam0->f_28[0]))
			{
				if (func_244(iParam0->f_28[0], PLAYER_PED_ID(), 1) < 30f && PLAYER_PED_ID(iParam0->f_28[0]))
				{
		...
		case 2:
			iLocal_71[0] = CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
			if (func_128(iParam0->f_28[0]))
			{
				func_230(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_1", 7, 0, 0);
				TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513, 0, 1148846080, 0);
			}
			SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_71[0], false);
			_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_71[0], true);
			iLocal_70++;
			break;
		...
		case 4:
			iLocal_71[1] = CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
			if (func_128(iParam0->f_28[0]))
			{
				func_230(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_2", 7, 0, 0);
				TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[1], sVar0, "hipster_self_hating_hipster", 8f, -8f, 513, 0, 1148846080, 0);
			}
			SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_71[1], false);
			_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_71[1], true);
			iLocal_70++;
			break;
		...
		case 6:
			iLocal_71[2] = CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
			if (func_128(iParam0->f_28[0]))
			{
				TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_71[2], sVar0, "hipster_idle", 8f, -8f, 513, 0, 1148846080, 0);
			}
			SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_71[2], true);
			_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_71[2], false);
			iLocal_70++;
			break;
...
int func_245(int iParam0)
{
	...
	if (iLocal_69 < 0)
	{
		if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), GET_ENTITY_COORDS(iParam0->f_28[1], true)) < 25f)
		{
			return 1;
		}
		switch (*iParam0)
		{
			case 52:
				...
				TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), iParam0->f_28[0], -1, 0, 2);
			...
			case 55:
				...
				TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), iParam0->f_28[1], -1, 0, 2);
				GET_IS_MULTIPLAYER_BRIEF(1);
		...
		case 1:
			if (func_128(uParam0->f_28[0]))
			{
				if (!func_147())
				{
					...
					{
						iLocal_238 = CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
						TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_238, "misstrvram_2", "hipster_cunts_in_america", 8f, -8f, 513, 0, 1148846080, 0);
						SET_GAMEPLAY_ENTITY_HINT(uParam0->f_28[0], 0f, 0f, 0.5f, 1, -1, 2500, 2000, 0);
						TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), uParam0->f_28[0], -1, 0, 2);
						GET_IS_MULTIPLAYER_BRIEF(1);
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					if (func_128(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0)))
					{
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_222()) || Global_110607) || Global_30738) || func_260()) || func_241(8, -1)) || func_96()) || func_259()) || func_258()) || func_257()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_222()) || Global_30738) || func_260()) || func_241(8, -1)) || func_258()) || func_96()) || func_259()) || func_257()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_222()) || Global_110607) || Global_30738) || func_260()) || func_241(8, -1)) || func_96()) || func_259()) || func_257()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_222() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_241(8, -1)) || func_257()) || func_256()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_222()) || Global_30738) || func_260()) || func_241(8, -1)) || func_259()) || func_258()) || func_257()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_222()) || func_259()) || Global_110607) || Global_30738) || func_260()) || Global_42561) || func_241(8, -1)) || func_258()) || func_256()) || func_257()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_222()) || Global_110607) || Global_30738) || func_260()) || func_241(8, -1)) || func_258()) || func_256()) || func_96()) || func_259()) || func_257())
						{
							return 0;
						}
						break;
...
void func_262(int iParam0, char* sParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_266(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_265(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_266(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_268(iParam0);
				}
			}
...
int func_273(var uParam0)
{
	...
	{
		if (_0x5407B7288D0478B7(_0x5407B7288D0478B7()) > 0)
		{
			return 1;
		}
	}
...
void func_275(var uParam0)
{
	...
	while ((!HAS_MODEL_LOADED(iVar1) || !HAS_MODEL_LOADED(iVar2)) || !HAS_MODEL_LOADED(sVar0))
	{
		wait(0);
	}
	...
	else
	{
		...
		SET_ENTITY_HEADING(uParam0->f_41[0], func_331(-0.5f));
...
int func_276(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	while (GET_GAME_TIMER() < iVar2)
	{
		...
		{
			*iParam0 = CREATE_WEAPON_OBJECT(iParam1, -1, vParam2, 1, 1065353216, 0, 0, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(iVar0);
			if (func_330(&uVar1, iParam1, joaat("gun_root")))
			{
				if (HAS_WEAPON_GOT_WEAPON_COMPONENT(*iParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 0)))
				{
					REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(*iParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 0));
				}
				else if (HAS_WEAPON_GOT_WEAPON_COMPONENT(*iParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 1)))
				{
					REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(*iParam0, func_277(&uVar1, iParam1, joaat("gun_root"), 1));
				}
			}
			if (DOES_ENTITY_EXIST(*iParam0))
			{
...
int func_279(int iParam0, int iParam1)
{
		...
		switch (iParam0)
		{
			...
			case joaat("weapon_bullpupshotgun"):
				switch (iParam1)
				{
					case joaat("component_at_ar_afgrip"):
						iVar0 = 4100;
						iVar0 = floor((to_float(iVar0) * Global_262145.f_14610));
						break;
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_312())
	{
		StringCopy(&Var11, func_310(iParam1, iParam0), 16);
		func_306(&sVar10, Var11, GET_ENTITY_MODEL(GET_ENTITY_MODEL()), 3, 1, func_308(iParam0), func_307(iParam0), -1, 0, 0);
		if (_NETWORK_SHOP_DOES_ITEM_EXIST(&sVar10))
		{
			iVar0 = _NETWORK_SHOP_GET_PRICE(_NETWORK_SHOP_GET_PRICE(&sVar10), 1671640801, 1);
		}
	}
	if (iVar0 > 0)
	{
...
int func_312()
{
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_313())
	{
		return 1;
	}
	return 0;
...
bool func_319(int iParam0, int iParam1, int iParam2)
{
	...
	return IS_BIT_SET(iVar0, func_320(iVar1));
}
...
void func_338(var uParam0)
{
	...
	while (!HAS_MODEL_LOADED(iVar0) || !HAS_MODEL_LOADED(sVar1))
	{
		wait(0);
	}
...
void func_339(var uParam0)
{
	...
	while ((!HAS_MODEL_LOADED(iVar0) || !HAS_MODEL_LOADED(joaat("weapon_microsmg"))) || !HAS_MODEL_LOADED(sVar1))
	{
		wait(0);
	}
...
void func_342(var uParam0)
{
	...
	func_346(&uLocal_68);
	while ((((!HAS_MODEL_LOADED(iVar0) || !HAS_MODEL_LOADED(iVar1)) || !HAS_MODEL_LOADED(iVar2)) || !HAS_MODEL_LOADED(sVar3)) || !func_345(&uLocal_68))
	{
		wait(0);
	}
	...
	ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[0], ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], iVar4), vVar6, vVar5, 1, 0, 0, 0, 2, 1);
	func_343(&uLocal_68, 0, 3);
	if (!IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		uParam0->f_59 = CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
		if (func_128(uParam0->f_28[0]))
		{
...
void func_343(var uParam0, bool bParam1, int iParam2)
{
	...
	if (HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		...
		DRAW_SCALEFORM_MOVIE(*uParam0, Global_19406, Global_19407, Global_19408, Global_19409, 255, 255, 255, 255, 0);
	}
}
...
{
	*uParam0 = 0x67D02A194A2FC2BD(func_347());
}
...
void func_349(var uParam0)
{
	...
	REQUEST_ANIM_DICT(sVar1);
	REQUEST_WEAPON_ASSET(joaat("weapon_assaultrifle"), 31, 0);
	while ((((!HAS_MODEL_LOADED(iVar5) || !HAS_MODEL_LOADED(iVar6)) || !HAS_MODEL_LOADED(iVar7)) || !HAS_MODEL_LOADED(sVar1)) || !HAS_MODEL_LOADED(joaat("weapon_assaultrifle")))
	{
		wait(0);
	}
	...
	if (func_128(uParam0->f_28[0]))
	{
		...
		SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 10, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 11, 0, 0, 0);
		vVar0 = { GET_PED_BONE_COORDS(uParam0->f_28[0], iVar2, 0f, 0f, 0f) };
		SET_PED_NAME_DEBUG(uParam0->f_28[0], "RAMP:PED 0");
		func_344(&(uParam0->f_41[1]), iVar7, vVar0, 0f);
		ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[0], ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], iVar2), vVar4, vVar3, 1, 1, 0, 0, 2, 1);
	...
	if (func_128(uParam0->f_28[1]))
	{
		...
		SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 10, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 11, 0, 0, 0);
		vVar0 = { GET_PED_BONE_COORDS(uParam0->f_28[1], iVar2, 0f, 0f, 0f) };
		SET_PED_NAME_DEBUG(uParam0->f_28[1], "RAMP:PED 1");
		func_344(&(uParam0->f_41[2]), iVar7, vVar0, 0f);
		ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[2], uParam0->f_28[1], ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[1], iVar2), vVar4, vVar3, 1, 1, 0, 0, 2, 1);
	...
	if (!IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		uParam0->f_59 = CREATE_SYNCHRONIZED_SCENE(910.13f, 3643.74f, 31.69f, 0f, 0f, func_331(-0.26f), 2);
		if (func_128(uParam0->f_28[0]))
		{
			TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uParam0->f_59, sVar1, "redneck_idle_a", 8f, -8f, 513, 0, 1148846080, 0);
		}
		if (func_128(uParam0->f_28[1]))
		{
			TASK_SYNCHRONIZED_SCENE(uParam0->f_28[1], uParam0->f_59, sVar1, "redneck_idle_b", 8f, -8f, 513, 0, 1148846080, 0);
		}
		SET_SYNCHRONIZED_SCENE_LOOPED(uParam0->f_59, true);
	}
...
void func_356(int iParam0, bool bParam1)
{
	...
	if (iLocal_250 != 0)
	{
		...
		{
			REMOVE_SCENARIO_BLOCKING_AREA(iLocal_250, 0);
		}
	}
	if (IS_GAMEPLAY_HINT_ACTIVE())
	{
