...
void func_1()
{
	...
	if (iLocal_28 == 2)
	{
		...
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
...
void func_29()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (DOES_ENTITY_EXIST(iLocal_34))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
				{
					TASK_LEAVE_VEHICLE(TASK_LEAVE_VEHICLE(), iLocal_34, 0);
				}
			}
		}
		iLocal_76 = 1;
	...
	if (iLocal_54 == 1)
	{
		if (DOES_ENTITY_EXIST(iLocal_34))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 1))
				{
					SET_VEHICLE_DOOR_SHUT(iLocal_34, 0, 0);
					SET_VEHICLE_DOOR_SHUT(iLocal_34, 1, 0);
					SET_VEHICLE_DOORS_LOCKED(iLocal_34, 2);
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_34, 0);
...
void func_35()
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_39, 0))
				{
					SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), iLocal_39, -1);
				}
			}
			else
			{
				SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -1565.084f, 2780.813f, 16.4022f, 1, false, 0, 1);
				SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 53.6086f);
			}
			break;
			...
			if (func_20() == 2)
			{
				if (DOES_ENTITY_EXIST(iLocal_34))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
					{
						if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
						{
							SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), iLocal_34, -1);
						}
						FREEZE_ENTITY_POSITION(iLocal_34, false);
					}
				}
	...
	switch (iLocal_28)
	{
		case 2:
			...
			if (func_272())
			{
				if (func_108())
				{
					if (!IS_THIS_MODEL_A_HELI(func_107()) && !IS_THIS_MODEL_A_HELI(func_107()))
					{
						func_105();
						while (!func_104())
						{
			...
			if (!DOES_ENTITY_EXIST(iLocal_34))
			{
				CLEAR_AREA(vLocal_118, 10f, 1, 0, 0, false);
				iLocal_34 = CREATE_VEHICLE(joaat("cargobob"), vLocal_118, fLocal_122, true, true, false);
				SET_VEHICLE_CAN_BE_TARGETTED(iLocal_34, 0);
				FREEZE_ENTITY_POSITION(iLocal_34, true);
			...
			if (!DOES_ENTITY_EXIST(iLocal_35[0]))
			{
				if (HAS_MODEL_LOADED(joaat("buzzard")))
				{
					...
					SET_VEHICLE_CAN_BE_TARGETTED(iLocal_35[0], 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_35[0], 1084227584);
					_DYNAMIC_MIXER_RELATED_FN(iLocal_35[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("buzzard"));
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_35[0], 0);
				}
			}
			if (func_272())
			{
				if (!DOES_ENTITY_EXIST(iLocal_39))
				{
					if (func_108())
					{
						if (!IS_THIS_MODEL_A_HELI(func_107()) && !IS_THIS_MODEL_A_HELI(func_107()))
						{
							...
							SET_MODEL_AS_NO_LONGER_NEEDED(func_107());
		...
		case 3:
			...
			{
				iLocal_31[0] = CREATE_PED_INSIDE_VEHICLE(iLocal_35[0], 26, joaat("s_m_m_pilot_02"), -1, 1, true);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_m_pilot_02"));
			}
			else if (!IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
			{
		...
		case 4:
			...
			if (!DOES_ENTITY_EXIST(iLocal_34))
			{
				...
				SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
				SET_VEHICLE_STRONG(iLocal_34, true);
				SET_VEHICLE_ENGINE_ON(iLocal_34, true, true, 0);
				SET_HELI_BLADES_FULL_SPEED(iLocal_34);
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_8(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_100()
{
	if (iLocal_80 == 0)
	{
		if (HAS_MODEL_LOADED(joaat("s_m_y_marine_01")) && HAS_MODEL_LOADED(joaat("s_m_m_pilot_02")))
		{
			...
			{
				iLocal_32[0] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1590.523f, 2796.302f, 15.9184f, 247.0896f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[1]))
			{
				iLocal_32[1] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2303.8f, 3387.99f, 30.034f, 58.5763f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[2]))
			{
				iLocal_32[2] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1697.329f, 2909.941f, 31.9506f, 245.656f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[3]))
			{
				iLocal_32[3] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1696.369f, 2905.772f, 31.9454f, 6.3714f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[4]))
			{
				iLocal_32[4] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1843.707f, 2821.611f, 31.8528f, 271.6265f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[5]))
			{
				iLocal_32[5] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2006.877f, 2955.101f, 31.8103f, 332.0101f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[6]))
			{
				iLocal_32[6] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2010.022f, 2956.805f, 31.8103f, 288.1283f, 1, true);
			}
			if (iLocal_28 != 3)
			{
				if (!DOES_ENTITY_EXIST(iLocal_32[7]))
				{
					iLocal_32[7] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2140.213f, 3034.609f, 31.81f, 302.4493f, 1, true);
				}
				if (!DOES_ENTITY_EXIST(iLocal_32[8]))
				{
					iLocal_32[8] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2136.053f, 3031.494f, 31.81f, 38.6856f, 1, true);
				}
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[9]))
			{
				iLocal_32[9] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2035.429f, 3058.876f, 31.8103f, 169.8222f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[10]))
			{
				iLocal_32[10] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2146.467f, 3160.749f, 31.8106f, 356.4766f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[11]))
			{
				iLocal_32[11] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2280.087f, 3172.423f, 31.8103f, 353.663f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_32[12]))
			{
				iLocal_32[12] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2277.376f, 3177.8f, 31.8103f, 175.0685f, 1, true);
			}
			if (!DOES_ENTITY_EXIST(iLocal_31[0]))
			{
...
void func_116()
{
	if (!func_36())
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 1738.131f, 3283.38f, 40.1261f, 1, false, 0, 1);
			SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 25.3545f);
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_31[0]))
	{
	...
	if (DOES_ENTITY_EXIST(iLocal_35[0]))
	{
		_0x18EB48CFC41F2EA0(iLocal_35[0], 0);
	}
	...
	{
		if (!DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95196[0], 1))
		{
	...
	{
		if (!DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95196[1], 1))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_95196[1], true, 1);
		}
		DELETE_VEHICLE(&(Global_95196[1]));
	}
	if (DOES_ENTITY_EXIST(Global_95196[2]))
	{
		if (!DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95196[2], 1))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_95196[2], true, 1);
		}
		DELETE_VEHICLE(&(Global_95196[2]));
	}
	if (DOES_ENTITY_EXIST(iLocal_36[0]))
	{
			...
			if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
			{
				...
				if (iLocal_28 == 4)
				{
					...
					if (iLocal_78 == 0)
					{
						...
						{
							if (!func_125() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
...
int func_121(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(iVar0, func_122(SET_BLIP_SCALE(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(iVar0, func_122(SET_BLIP_SCALE(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_115 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_34))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
				{
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
					{
						if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), vLocal_118, true) > 800f)
						{
						...
						if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), vLocal_118, true) > 800f)
						{
							if (iLocal_111 == 0 && iLocal_78 == 1)
							{
								if (!IS_MESSAGE_BEING_DISPLAYED())
								{
									if (!func_125() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
									{
										func_149(&uLocal_198, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		if (DOES_ENTITY_EXIST(iLocal_34))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
				{
					if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), vLocal_119, 2f, 2f, 2f, true, true, 0))
					{
					}
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
						if (!IS_ENTITY_IN_AIR(iLocal_34) && IS_ENTITY_IN_AIR(iLocal_34))
						{
							func_128(1, 600);
...
void func_150(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_223(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
...
{
	func_152(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_182(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_184() == 0)
		{
			return IS_BIT_SET(func_162(func_183(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
var func_203()
{
	...
	func_206(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_205(&uVar0, GET_CLOCK_MONTH());
	func_204(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_209(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_228()
{
	if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), vLocal_119, true) < 500f)
	{
		if (iLocal_89 == 0)
		{
			if (!DOES_ENTITY_EXIST(iLocal_36[0]))
	...
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), vLocal_119, true) > 550f)
		{
			if (DOES_ENTITY_EXIST(iLocal_36[0]))
			{
				DELETE_VEHICLE(&(iLocal_36[0]));
...
void func_229()
{
	if (iLocal_54 > 0)
	{
		...
		{
			SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 4, 0);
			SET_PLAYER_WANTED_LEVEL_NOW(SET_PLAYER_WANTED_LEVEL_NOW(), 0);
		}
		func_234();
		func_233();
	...
	if (iLocal_54 == 1)
	{
		if (iLocal_83[0] == 1)
		{
			...
			if (DOES_ENTITY_EXIST(iLocal_34))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(iLocal_34, 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
						if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
						{
							SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 0, 0);
...
void func_233()
{
	iLocal_37 = GET_CLOSEST_VEHICLE(GET_CLOSEST_VEHICLE(GET_CLOSEST_VEHICLE(), true), 300f, joaat("lazer"), 4);
	iLocal_38 = GET_CLOSEST_VEHICLE(GET_CLOSEST_VEHICLE(GET_CLOSEST_VEHICLE(), true), 300f, joaat("lazer"), 16386);
	if (DOES_ENTITY_EXIST(iLocal_37) && DOES_ENTITY_EXIST(iLocal_37))
	{
		if (!DOES_BLIP_EXIST(iLocal_48))
		{
	...
	if (DOES_ENTITY_EXIST(iLocal_38) && DOES_ENTITY_EXIST(iLocal_38))
	{
	...
	if (iLocal_28 == 3)
	{
		if (DOES_ENTITY_EXIST(iLocal_34))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
				{
					vLocal_121 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
					if (DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!IS_PED_INJURED(iLocal_31[0]))
								{
									...
									{
										if (GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -75.8f, -819.9f, 326f, true) > 1600f && GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -2159f, 3067f, 33f, true) < 1000f)
										{
											if (vLocal_121.z > 70f)
											{
												if (iLocal_30 != 2)
										...
										{
											if (GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -75.8f, -819.9f, 326f, true) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
											...
											if (GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -2159f, 3067f, 33f, true) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_90[0] = 1;
				...
				else if (GET_DISTANCE_BETWEEN_COORDS(vLocal_121, -75.8f, -819.9f, 326f, true) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_90[0] = 1;
				...
				if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
				{
					if (DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!IS_PED_INJURED(iLocal_31[0]))
						{
							...
							{
								vLocal_120 = { GET_ENTITY_COORDS(iLocal_35[0], true) };
								CLEAR_PED_TASKS(iLocal_31[0]);
								SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_31[0], vLocal_120, 10f, 0, 0);
				...
				if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
				{
					if (DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!IS_PED_INJURED(iLocal_31[0]))
						{
							...
							if (!IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
							{
								TASK_ENTER_VEHICLE(0, iLocal_35[0], 20000, -1, 2f, 1, 0);
							}
							TASK_HELI_MISSION(0, iLocal_35[0], 0, 0, vLocal_120.x, vLocal_120.y, (vLocal_120.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1f, 0);
							TASK_HELI_MISSION(0, iLocal_35[0], 0, TASK_HELI_MISSION(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1f, 0);
				...
				if (DOES_ENTITY_EXIST(iLocal_31[0]))
				{
					if (!IS_PED_INJURED(iLocal_31[0]))
					{
						if (IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_35[0], 0))
						{
							...
							else if (GET_GAME_TIMER() > iLocal_67 + 10000 && !GET_GAME_TIMER(GET_GAME_TIMER(), iLocal_34, 0))
							{
								if (iLocal_104 == 0)
								{
									SET_PED_ACCURACY(iLocal_31[0], 100);
					...
					if (DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!IS_PED_INJURED(iLocal_31[0]))
								{
									TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, TASK_HELI_MISSION(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!IS_PED_INJURED(iLocal_31[0]))
								{
									TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, TASK_HELI_MISSION(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!IS_PED_INJURED(iLocal_31[0]))
								{
									TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, TASK_HELI_MISSION(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
					...
					if (DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!IS_PED_INJURED(iLocal_31[0]))
								{
									TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, 0, TASK_HELI_MISSION(iLocal_35[0], 20f, 0f, 0f), 4, 10f, 10f, TASK_HELI_MISSION(iLocal_35[0]), round(TASK_HELI_MISSION(iLocal_35[0], TASK_HELI_MISSION(iLocal_35[0], true), 1, 1)), 100, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
						...
						if (DOES_ENTITY_EXIST(iLocal_35[0]))
						{
							if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
							{
								if (DOES_ENTITY_EXIST(iLocal_31[0]))
								{
									if (!IS_PED_INJURED(iLocal_31[0]))
									{
										TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, TASK_HELI_MISSION(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1f, 0);
										iLocal_102 = 1;
									}
								}
							}
					...
					if (DOES_ENTITY_EXIST(iLocal_35[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_35[0], 0))
						{
							if (DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!IS_PED_INJURED(iLocal_31[0]))
								{
									TASK_HELI_MISSION(iLocal_31[0], iLocal_35[0], 0, TASK_HELI_MISSION(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1f, 0);
									iLocal_90[0] = 0;
								}
							}
						}
...
void func_235()
{
	if (iLocal_85 == 0)
	{
		if ((((func_236(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 3, 0, 0) || GET_ENTITY_COORDS(GET_ENTITY_COORDS(), -1601.514f, 2794.148f, 14.84222f, -1587.692f, 2806.101f, 20.29557f, 16f, 0, true, 0)) || GET_ENTITY_COORDS(GET_ENTITY_COORDS(), -1598.278f, 2803.98f, 17.01772f, -1665.98f, 2895.398f, 34.58953f, 14.5f, 0, true, 0)) || GET_ENTITY_COORDS(GET_ENTITY_COORDS(), -1648.554f, 2873.74f, 24.85017f, -1673.864f, 2889.698f, 38.18856f, 14.5f, 0, true, 0)) || GET_ENTITY_COORDS(GET_ENTITY_COORDS(), -1647.446f, 2873.969f, 24.82373f, -1667.316f, 2914.302f, 39.39478f, 14.5f, 0, true, 0))
		{
			iLocal_85 = 1;
		}
	}
				...
				if (DOES_ENTITY_EXIST(iLocal_32[iLocal_55]))
				{
					if (!IS_PED_INJURED(iLocal_32[iLocal_55]))
					{
						if (DOES_ENTITY_EXIST(iLocal_34))
						{
							if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
							{
								if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0) || iLocal_87 == 1)
								{
									if (func_2(PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) < 39f)
									{
										if (iLocal_91[iLocal_55] == 0)
										{
											...
											SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_32[iLocal_55], SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_32[iLocal_55], true), 50f, 0, 0);
											TASK_COMBAT_PED(iLocal_32[iLocal_55], TASK_COMBAT_PED(), 0, 16);
									...
									else if (iLocal_92[iLocal_55] == 0)
									{
										CLEAR_PED_TASKS(iLocal_32[iLocal_55]);
										OPEN_SEQUENCE_TASK(&iLocal_367);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_34, true), 2f, -1, 20f, 0, 1193033728);
								...
								else
								{
									...
									if (func_2(PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) > 41f && func_2(PLAYER_PED_ID(), iLocal_32[iLocal_55], 1) < 400f)
									{
										if (iLocal_94[iLocal_55] == 0)
										{
											...
											if (iLocal_74 == 0)
											{
												TASK_GO_TO_ENTITY(0, TASK_GO_TO_ENTITY(), -1, 25f, 2f, 1073741824, 0);
											}
											else if (iLocal_74 == 1)
											{
											...
											{
												TASK_GO_TO_ENTITY(0, TASK_GO_TO_ENTITY(), -1, 25f, 3f, 1073741824, 0);
											}
											else if (iLocal_74 == 3)
											{
												TASK_STAND_STILL(0, 500);
					...
					if (!IS_PED_INJURED(iLocal_32[iLocal_72]))
					{
						if (func_2(iLocal_32[iLocal_72], PLAYER_PED_ID(), 1) < 25f)
						{
							if (iLocal_101[iLocal_72] == 0)
							{
								...
								TASK_AIM_GUN_AT_ENTITY(iLocal_32[iLocal_72], TASK_AIM_GUN_AT_ENTITY(), -1, 0);
...
void func_237()
{
	...
	if (iLocal_54 == 0)
	{
		...
		if (!DOES_ENTITY_EXIST(iLocal_34))
		{
			if (DOES_ENTITY_EXIST(Global_95196[0]))
			{
				if (IS_VEHICLE_DRIVEABLE(Global_95196[0], 0))
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_95196[0], true, 1);
		...
		if (!DOES_ENTITY_EXIST(iLocal_35[0]))
		{
			if (DOES_ENTITY_EXIST(Global_95196[1]))
			{
				if (IS_VEHICLE_DRIVEABLE(Global_95196[1], 0))
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_95196[1], true, 1);
		...
		if (DOES_ENTITY_EXIST(Global_95196[2]))
		{
			if (IS_VEHICLE_DRIVEABLE(Global_95196[2], 0))
			{
				if (IS_THIS_MODEL_A_HELI(IS_THIS_MODEL_A_HELI(Global_95196[2])))
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_95196[2], true, 1);
					func_245(1734.799f, 3234.833f, 40.7041f, 321.0399f, 0, 145);
				}
				if (((IS_THIS_MODEL_A_CAR(IS_THIS_MODEL_A_CAR(Global_95196[2])) || IS_THIS_MODEL_A_CAR(IS_THIS_MODEL_A_CAR(Global_95196[2]))) || IS_THIS_MODEL_A_CAR(IS_THIS_MODEL_A_CAR(Global_95196[2]))) || IS_THIS_MODEL_A_CAR(IS_THIS_MODEL_A_CAR(Global_95196[2])))
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_95196[2], true, 1);
				...
				while (iLocal_63 <= 12)
				{
					if (DOES_ENTITY_EXIST(iLocal_32[iLocal_63]))
					{
						if (!IS_PED_INJURED(iLocal_32[iLocal_63]))
						{
							...
							{
								if (_CAN_PED_SEE_PED(iLocal_32[iLocal_63], _CAN_PED_SEE_PED()))
								{
									...
									if (iLocal_114 == 0)
									{
										if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) && !func_242(0))
										{
											if (func_241(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
											{
									...
									else if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) && !func_242(0))
									{
										if (func_241(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
										{
...
{
	CLEAR_BIT(&Global_94554, iParam0);
}
	...
	if (DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_254(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_251(GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_255()
{
	if (iLocal_54 == 0)
	{
		...
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_44, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, -472287501, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_44, -472287501);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, -472287501, iLocal_44);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, iLocal_44);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_44, -1533126372);
...
void func_256()
{
	...
	SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 1747.04f, 3267.456f, 40.246f, 1, false, 0, 1);
	SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 229.0887f);
	if (DOES_ENTITY_EXIST(iLocal_34))
	{
		DELETE_VEHICLE(&iLocal_34);
	}
	if (!DOES_ENTITY_EXIST(iLocal_34))
	{
		...
		SET_VEHICLE_DOOR_SHUT(iLocal_34, 0, 1);
		SET_VEHICLE_DOOR_SHUT(iLocal_34, 1, 1);
		SET_VEHICLE_DOORS_LOCKED(iLocal_34, 2);
		SET_VEHICLE_STRONG(iLocal_34, true);
		FREEZE_ENTITY_POSITION(iLocal_34, true);
		SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_34, false);
	...
	if (DOES_ENTITY_EXIST(iLocal_34))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_34, 0))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_34, 0))
				{
					if (IS_PED_SITTING_IN_VEHICLE(IS_PED_SITTING_IN_VEHICLE(), iLocal_34))
					{
						if (func_262(PLAYER_PED_ID(), iLocal_34) == -1)
						{
...
void func_263()
{
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		{
			if (func_236(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 3, 200, 0) || iLocal_86 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) != 0 && GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL(), true), vLocal_118, true) > 1000f)
			{
				SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 0, 0);
				SET_PLAYER_WANTED_LEVEL_NOW(SET_PLAYER_WANTED_LEVEL_NOW(), 0);
			}
	...
	if (iLocal_98 == 0)
	{
		...
		while (iLocal_64 <= 12)
		{
			if (DOES_ENTITY_EXIST(iLocal_32[iLocal_64]))
			{
				...
				{
					if (_CAN_PED_SEE_PED(iLocal_32[iLocal_64], _CAN_PED_SEE_PED()))
					{
					...
					if (iLocal_99 == 0 && iLocal_100 == 0)
					{
						if (!func_125())
						{
							if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_MESSAGE_BEING_DISPLAYED())
							{
								...
								{
									if (_CAN_PED_SEE_PED(iLocal_32[iLocal_71], _CAN_PED_SEE_PED()))
									{
										if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) && !func_242(0))
										{
											if (func_241(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
							...
							if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_MESSAGE_BEING_DISPLAYED())
							{
								if (func_2(PLAYER_PED_ID(), iLocal_32[iLocal_71], 1) < 25f)
								{
									if (_CAN_PED_SEE_PED(iLocal_32[iLocal_71], _CAN_PED_SEE_PED()))
									{
										if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
										{
											if (func_241(PLAYER_PED_ID()) == joaat("weapon_unarmed") || func_242(0))
											{
												if (DOES_ENTITY_EXIST(iLocal_32[0]))
												{
													if (!IS_PED_INJURED(iLocal_32[0]))
...
{
	_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_267(iParam2), 1);
}
...
int func_268()
{
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		GET_CLOSEST_PED(GET_CLOSEST_PED(GET_CLOSEST_PED(), true), 30f, 0, 1, &iVar0, 0, 1, -1);
	}
	iLocal_58 = 0;
	while (iLocal_58 <= 9)
	{
...
void func_273()
{
	...
	iLocal_50 = ADD_SCENARIO_BLOCKING_AREA(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, 0, 1, 1, 1);
	iLocal_52 = ADD_SCENARIO_BLOCKING_AREA(-2168.3f, 3223.6f, 52.8f, -2156.2f, 3205f, 29f, 0, 1, 1, 1);
...
void func_275()
{
	...
	_0x0A436B8643716D14();
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_50, 0);
