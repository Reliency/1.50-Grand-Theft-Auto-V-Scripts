...
void func_5()
{
	...
	{
		SET_PED_RESET_FLAG(SET_PED_RESET_FLAG(), 334, true);
	}
...
void func_20()
{
	...
	{
		func_6(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_44(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_87(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_87(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_87(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_87(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_87(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_87(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_78(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_87(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_87(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_87(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_64(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_87(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_87(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_65(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_65(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_65(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_65(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_98(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_98(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_87(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_160(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_87(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_87(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_167()
{
	...
	{
		if (func_162(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_178()
{
	...
	{
		func_167();
		_0xBF59707B3E5ED531(func_179(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_215()
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			func_242(PLAYER_PED_ID(), vLocal_256, 201.2074f, 0, 1);
			if (!IS_NEW_LOAD_SCENE_ACTIVE())
			{
				NEW_LOAD_SCENE_START_SPHERE(vLocal_256, 100f, 1);
			}
			...
			if (func_214(iLocal_85))
			{
				...
				SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_85, 1862763509);
				...
				if (func_214(iLocal_88))
				{
					...
					SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_88, 1084227584);
					...
					SET_VEHICLE_ENGINE_ON(iLocal_88, true, true, 0);
				}
			}
			if (func_214(PLAYER_PED_ID()))
			{
				TASK_PLAY_ANIM(TASK_PLAY_ANIM(), sLocal_90, "back_armsdown", 1000f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 1:
			if (IS_NEW_LOAD_SCENE_ACTIVE())
			{
				...
				{
					NEW_LOAD_SCENE_STOP();
					iLocal_264 = CREATE_CAMERA_WITH_PARAMS(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
					SET_CAM_ACTIVE(iLocal_264, true);
					iLocal_265 = CREATE_CAMERA_WITH_PARAMS(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
					...
					if (func_240(iLocal_85, iLocal_88, -1))
					{
						if (iLocal_263)
						{
							...
							else if (!func_222())
							{
								...
								func_218(PLAYER_PED_ID(), 30000, 0);
						...
						else if (func_214(PLAYER_PED_ID()))
						{
							if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(), -2017877118) == 1)
							{
								SET_PED_TO_RAGDOLL(SET_PED_TO_RAGDOLL(), 16000, 16000, 0, 1, 1, 0);
								APPLY_FORCE_TO_ENTITY(APPLY_FORCE_TO_ENTITY(), 2, 0f, -5f, 2f, 0f, 0.5f, 0f, 3, 1, 1, 1, 0, 1);
								iLocal_263 = 1;
								wait(1000);
								settimera(0);
								func_217(2000, 0);
...
void func_243()
{
	if (!DOES_ENTITY_EXIST(iLocal_85))
	{
		iLocal_85 = CREATE_PED(26, iLocal_86, vLocal_257, 0f, 1, true);
	}
	if (func_214(iLocal_85))
	{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			if (func_281(1, 1093140480, 0))
			{
				...
				CLEAR_AREA_OF_VEHICLES(-1630.38f, 4200.79f, 83.01f, 70f, 0, 0, 0, 0, false, 0);
				iLocal_83 = 1;
			}
			break;
...
void func_268(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_269(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_281(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_286(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_285(PLAYER_PED_ID(), -828834893))
				{
...
void func_289()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_286(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_292()
{
	...
	while (((!HAS_ANIM_DICT_LOADED(sLocal_90) || !HAS_ANIM_DICT_LOADED(0)) || !HAS_ANIM_DICT_LOADED(iLocal_87)) || !HAS_ANIM_DICT_LOADED(iLocal_86))
	{
		wait(0);
	}
	SET_WANTED_LEVEL_MULTIPLIER(0.1f);
	_0xF92099527DB8E2A7(128, 0);
	func_241(&uLocal_91, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	if (func_214(PLAYER_PED_ID()))
	{
...
void func_293(int iParam0, bool bParam1)
{
	...
	if (func_164(iVar0) && !IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER_PED_ID())
		{
...
void func_294(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_299(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_296(Var7.f_1)) && iVar9 < 51)
			{
...
int func_311(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_249(0)) || func_312(1))
			{
			}
			else
			{
...
void func_323()
{
	...
	if (func_347())
	{
		...
		if (func_214(PLAYER_PED_ID()))
		{
			...
			func_334(PLAYER_PED_ID(), 1, 0);
		}
		if (func_214(GET_PLAYERS_LAST_VEHICLE()))
		{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar15)
			{
				...
				{
					if (!_IS_DLC_DATA_EMPTY(Var9) && !func_296(Var9.f_1))
					{
						if (iVar7 == 0)
						{
...
bool func_341(int iParam0)
{
	...
	if (iParam0 == -61829581)
	{
		if (NETWORK_IS_GAME_IN_PROGRESS() && func_344())
		{
			return 1;
		}
		else
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_railgun"):
			if (!func_342() || NETWORK_IS_GAME_IN_PROGRESS())
			{
				return 0;
			}
			break;
	...
	while (iVar0 < GET_NUM_DLC_WEAPONS())
	{
		if (GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (_IS_DLC_DATA_EMPTY(Var1) || func_296(Var1.f_1))
				{
					return 0;
				}
			}
...
void func_348(bool bParam0)
{
	...
	if (!func_363())
	{
		...
		{
			func_172(iVar0, 1, 0);
			func_349(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_350(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_356())
	{
		...
		{
			iVar2 = func_351(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
