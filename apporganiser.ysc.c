	...
	while (bVar2)
	{
		...
		if (!iVar3 == iVar4)
		{
			if (!iVar3 == 0)
			{
				...
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(5);
				_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar5);
...
void func_8()
{
	...
	if (!Global_95785)
	{
		Global_95969 = GET_CLOCK_MONTH();
		Global_95968 = GET_CLOCK_DAY_OF_MONTH();
		Global_95967 = GET_CLOCK_HOURS();
		Global_95785 = 1;
		Global_95790 = GET_CLOCK_DAY_OF_WEEK();
		Global_95789 = GET_CLOCK_HOURS();
		func_12();
		return;
	}
