...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER_ID())) || PLAYER_ID(PLAYER_ID(), 1)) || PLAYER_ID(PLAYER_ID(), 0)) || PLAYER_ID(PLAYER_ID())) || PLAYER_ID(PLAYER_ID())) || PLAYER_ID(PLAYER_ID())) || PLAYER_ID(PLAYER_ID())) || PLAYER_ID(Global_1676879.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
					if (func_51(uParam0))
					{
				...
				else if (IS_CONTROL_JUST_PRESSED(0, 51))
				{
					...
					{
						SET_BIT(&(Global_2424073[SET_BIT() /*421*/].f_309.f_4), 15);
						func_36(157);
					}
				}
			}
		...
		case 4:
			...
			if (uParam0->f_1.f_1 == 3)
			{
				if (_0xEE778F8C7E1142E2(0) == 4)
				{
					...
					{
						_SET_CAM_PERSPECTIVE(0, 1);
						func_32(&(uParam0->f_7), 13);
					}
				}
			}
			DISABLE_CONTROL_ACTION(0, 0, 1);
			vVar2 = { GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0, 2) };
			vVar3 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			iVar4 = vVar3.z;
			fVar5 = 0.05f;
		...
		case 5:
			...
			vVar7 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar8 = vVar7.z;
			if ((iVar6 != 1 && iVar6 != 0) || func_16(GET_ENTITY_HEADING(GET_ENTITY_HEADING()), fVar8, 5f))
			{
				if (uParam0->f_1.f_1 == 3)
				{
					if (_0xEE778F8C7E1142E2(0) == 4)
				...
				DISABLE_CONTROL_ACTION(0, 0, 1);
				uParam0->f_8 = _0x77758139EC9B66C7(func_31(uParam0), func_30(uParam0), 2, true, false, 1065353216, 0, 1.12f);
				NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_8, &sVar0, &sVar1, 2f, -1000f, 9, 0, 1148846080, 0);
				NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_8);
		...
		case 6:
			...
			func_17(uParam0);
			func_8(uParam0);
			iVar9 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
			if (func_33(&(uParam0->f_7), 13))
			{
				DISABLE_CONTROL_ACTION(0, 0, 1);
			}
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iVar9))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(iVar9) >= 1f)
				{
					...
					func_34(uParam0, &sVar1);
					uParam0->f_8 = _0x77758139EC9B66C7(func_31(uParam0), func_30(uParam0), 2, true, false, 1065353216, 0, 1.12f);
					NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_8, &sVar0, &sVar1, 4f, -1.5f, 9, 0, 1148846080, 0);
					NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_8);
					func_32(&(uParam0->f_7), 8);
		...
		case 8:
			iVar10 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
			...
			if (iVar11 == 0 || iVar11 == 1)
			{
				...
				{
					if ((GET_SYNCHRONIZED_SCENE_PHASE(iVar10) >= 0.7f || GET_SYNCHRONIZED_SCENE_PHASE(GET_SYNCHRONIZED_SCENE_PHASE(), GET_SYNCHRONIZED_SCENE_PHASE("BREAKOUT_FINISH"))) || GET_SYNCHRONIZED_SCENE_PHASE(GET_SYNCHRONIZED_SCENE_PHASE(), GET_SYNCHRONIZED_SCENE_PHASE("BREAK_OUT")))
					{
						NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_8);
						func_29(-1);
						func_42(uParam0);
...
void func_8(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		fVar1 = vmag(vVar0);
		if ((uParam0->f_13 == 6 && !HAS_ANIM_EVENT_FIRED(HAS_ANIM_EVENT_FIRED(), HAS_ANIM_EVENT_FIRED("BLOCK_INTERRUPT"))) && !func_33(&(uParam0->f_7), 12))
		{
		...
		if (HAS_ANIM_EVENT_FIRED(HAS_ANIM_EVENT_FIRED(), HAS_ANIM_EVENT_FIRED("BLOCK_INTERRUPT")))
		{
			func_42(uParam0);
		}
...
void func_14(var uParam0)
{
	...
	uParam0->f_8 = _0x77758139EC9B66C7(func_31(uParam0), func_30(uParam0), 2, true, false, 1065353216, 0, 1.12f);
	func_35(uParam0, &sVar0);
	NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_8, &sVar0, "exit", 4f, -4f, 9, 0, 1148846080, 0);
	NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_8);
	func_43(&(uParam0->f_6));
	func_59(uParam0, 8);
}
...
int func_50(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((DOES_ENTITY_EXIST(uVar0[iVar1]) && !DOES_ENTITY_EXIST(uVar0[iVar1])) && DOES_ENTITY_EXIST(uVar0[iVar1])) && func_57(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar1++;
...
int func_56(int iParam0, vector3 vParam1, int iParam2)
{
	if (DOES_ENTITY_EXIST(iParam0))
	{
		...
		{
			if (func_16(GET_ENTITY_HEADING(iParam0), (vParam1.z - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_16(GET_ENTITY_HEADING(iParam0), vParam1.z, 45f))
		{
			return 1;
		}
	}
...
{
	return IS_ENTITY_IN_ANGLED_AREA(iParam0, uParam1->f_6.f_1, uParam1->f_6.f_4, uParam1->f_6, 0, true, 0);
}
...
void func_61(var uParam0)
{
	...
	else if (uParam0->f_13 > 4)
	{
		...
		SET_PED_CAPSULE(SET_PED_CAPSULE(), func_62());
...
void func_63(var uParam0)
{
	...
	func_64(&(uParam0->f_7), 1, IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0));
	func_64(&(uParam0->f_7), 3, IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1));
	func_64(&(uParam0->f_7), 0, func_27(0));
	func_64(&(uParam0->f_7), 2, IS_PED_RUNNING(IS_PED_RUNNING()));
}
...
int func_66()
{
	...
	if (func_82(PLAYER_ID()) && PLAYER_ID())
	{
		return 1;
	}
	if (func_80() != 0)
...
int func_69()
{
	...
	if (func_70() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_70()) == 0)
		{
			return 1;
		}
	}
...
void func_89(var uParam0)
{
	...
	{
		func_29(-1);
		iVar0 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
		if (IS_SYNCHRONIZED_SCENE_RUNNING(iVar0))
		{
			NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_8);
		}
		func_90(PLAYER_ID(), 1, 0, 0);
	}
	CLEAR_BIT(&(Global_2424073[CLEAR_BIT() /*421*/].f_309.f_4), 15);
}
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (NETWORK_IS_PLAYER_ACTIVE(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_99(PLAYER_ID(), 0) && !func_98()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_94(iVar26) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
...
void func_103()
{
	NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, func_114());
	func_112(0, -1, 0);
	func_111();
	func_104();
	if (NETWORK_IS_GAME_IN_PROGRESS())
