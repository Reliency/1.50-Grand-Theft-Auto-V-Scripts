...
void __EntryFunction__()
{
	...
	{
		if (!IS_ENTITY_DEAD(Local_79.f_35[0], 0))
		{
	...
	else if (func_416(0))
	{
		...
		{
			SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 113.9f);
...
void func_1()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, true, 0))
			{
				iLocal_95 = 2;
			}
			else
...
int func_2()
{
	if (func_415(iLocal_114) && func_415(Local_97.f_4))
	{
		if (func_3())
		{
			if (DOES_CARGOBOB_HAVE_PICK_UP_ROPE(iLocal_114) && DOES_CARGOBOB_HAVE_PICK_UP_ROPE(iLocal_114, Local_97.f_4))
			{
				bLocal_110 = true;
				return 1;
			}
...
int func_4()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_114) && DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), iLocal_114, 0))
	{
		return 1;
	}
	else if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		if (func_415(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_120 <= 7)
				{
					if (func_415(Local_117[iLocal_120 /*7*/].f_4) && IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_117[iLocal_120 /*7*/].f_4, 0))
					{
						bVar2 = true;
...
void func_5(bool bParam0)
{
	...
	else
	{
		...
		while (iLocal_120 <= 7)
		{
			...
			{
				if (!func_9(PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 175f) && func_8(PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/].f_4, 1) > 175f)
				{
					func_6(&(Local_117[iLocal_120 /*7*/].f_4));
				}
			}
			else if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 100f))
			{
				...
				SET_VEHICLE_ON_GROUND_PROPERLY(Local_117[iLocal_120 /*7*/].f_4, 1084227584);
...
void func_17()
{
	if (!iLocal_298)
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_97.f_4, 0))
		{
			iLocal_298 = 1;
			bLocal_297 = false;
			iLocal_294 = 0;
		...
		else if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_97.f_4, 1))
		{
			func_18();
		}
	}
			...
			switch (iLocal_294)
			{
				case 0:
					...
					else
					{
						...
						if (REQUEST_SCRIPT_AUDIO_BANK("BARRY3C_IGNITION_FAIL", false, -1) && REQUEST_SCRIPT_AUDIO_BANK(sLocal_299))
						{
							if (GET_PED_IN_VEHICLE_SEAT(Local_97.f_4, -1, 0) == GET_PED_IN_VEHICLE_SEAT())
							{
								iLocal_294 = 1;
							}
						}
				...
				case 2:
					...
					TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(iLocal_300);
					CLEAR_PED_TASKS(CLEAR_PED_TASKS());
					TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(), iLocal_300);
				...
				case 7:
					if (GET_GAME_TIMER() > iLocal_291 && !GET_GAME_TIMER(GET_GAME_TIMER(), 2))
					{
						CLEAR_PED_TASKS(CLEAR_PED_TASKS());
						TASK_LEAVE_VEHICLE(TASK_LEAVE_VEHICLE(), Local_97.f_4, 0);
						SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), true, 0);
					}
					break;
				}
...
void func_19()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, false, 0) && !IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4))
			{
				vVar0 = { GET_ENTITY_COORDS(Local_97.f_4, true) };
				if (vVar0.z < 6.7f)
				{
					iLocal_94 = 12;
					iLocal_95 = 0;
		...
		case 2:
			...
			if (func_4())
			{
				if (func_2())
				{
					...
					else if (IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, true, 0))
					{
						iLocal_94 = 6;
					}
					else
...
void func_49()
{
	...
	switch (iLocal_95)
	{
		...
		case 2:
			CLEAR_PRINTS();
			if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_114, 0))
			{
				iLocal_94 = 8;
			}
			else if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_114, Local_97.f_4))
...
{
	CLEAR_THIS_PRINT(vLocal_308[iParam0 /*3*/].f_2);
}
...
void func_51()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, true, 0))
			{
				if (!func_248(PLAYER_PED_ID(), Local_97.f_4, 150f, 1) && !func_15())
				{
					iLocal_95 = 2;
				}
...
void func_56()
{
	...
	{
		func_58(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_81(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_124(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_124(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_115(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_124(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_101(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_102(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_102(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_102(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_102(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_124(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_196(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_124(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_124(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_209()
{
	...
	{
		func_34();
		_0xBF59707B3E5ED531(func_210(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
int func_244()
{
	return func_245(GET_THIS_SCRIPT_NAME(), 0);
}
...
void func_247(bool bParam0)
{
	if (bParam0)
	{
		...
		_0x2B6747FAA9DB9D6B(Local_97.f_4, 1);
	}
	else
	{
		SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_97.f_4, true, 0);
		_0x2B6747FAA9DB9D6B(Local_97.f_4, 0);
	}
}
...
void func_250(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_245(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_252(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_252(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_33();
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		func_282(PLAYER_PED_ID());
		func_275(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_274())
		{
			func_270(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_261(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_264(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_276(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_281(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_278(Var7.f_1)) && iVar9 < 51)
			{
...
int func_287(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_308())
		{
			*uParam0 = func_292(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_289(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_57() == 0)
		{
			return IS_BIT_SET(func_119(func_290(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_292(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_307(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_293(iVar0, 0), true);
...
var func_309()
{
	...
	func_319(&uVar0, GET_CLOCK_SECONDS());
	func_318(&uVar0, GET_CLOCK_MINUTES());
	func_317(&uVar0, GET_CLOCK_HOURS());
	func_312(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_311(&uVar0, GET_CLOCK_MONTH());
	func_310(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_315(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_327()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_114, 0))
			{
				iLocal_95 = 2;
			}
			else if (func_2())
			{
				...
				else if (!IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, true, 0))
				{
					iLocal_94 = 10;
					iLocal_95 = 0;
				}
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (!func_2())
			{
				if (func_3())
				{
					if (IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, false, 0))
					{
			...
			else if (IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 1, true, 0))
			{
				iLocal_95 = 2;
			}
			else if (iLocal_309)
		...
		case 2:
			...
			{
				if (func_3() && IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, false, 0))
				{
					if (!IS_ENTITY_IN_AIR(Local_97.f_4))
					{
						vVar0 = { GET_ENTITY_COORDS(Local_97.f_4, true) };
...
void func_333()
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (((!iLocal_289 && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -458.11f, -1725.3f, 17.67f, -456.71f, -1701.81f, 22f, 17.5f, 0, true, 0)) && !func_2()) && !func_3())
			{
				func_330("B3CTTHB", -1);
				iLocal_289 = 1;
			}
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (iLocal_118)
			{
				...
				else if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -417.58f, -1723.81f, 15.42f, -473.6f, -1705.96f, 26.95f, 49f, 0, true, 0))
				{
					iLocal_95 = 2;
				}
				else if (func_2())
...
int func_338()
{
	...
	while (iLocal_120 <= 7)
	{
		if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 8f))
		{
			return 1;
		}
		iLocal_120++;
	...
	if (DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_367(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_364(GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_268(iParam0, 0, 0)) || func_268(iParam0, 1, 0)) || func_268(iParam0, 2, 0)) || func_259(iParam0) != 145) || func_358(iParam0)) || func_357(iParam0)) || func_356(iParam0)) || func_355(iParam0)) || !func_345(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_357(iParam0))
		{
		}
	...
	switch (iLocal_95)
	{
		case 0:
			...
			if (func_4())
			{
				...
				func_335(3);
				func_335(4);
				_0x51BB2D88D31A914B(Local_97.f_4, false);
				_0x192547247864DFDD(Local_97.f_4, false);
				if (func_2())
				{
					iLocal_95 = 0;
					iLocal_94 = 5;
		...
		case 1:
			...
			switch (iLocal_294)
			{
				...
				case 2:
					if (GET_PED_IN_VEHICLE_SEAT(Local_97.f_4, -1, 0) == GET_PED_IN_VEHICLE_SEAT() && GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(), Local_97.f_4))
					{
						if (iLocal_295 == 3)
						{
							OPEN_SEQUENCE_TASK(&iLocal_300);
							TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
							TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0, 0, 0, 0);
							TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
							CLOSE_SEQUENCE_TASK(iLocal_300);
							TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(), iLocal_300);
							CLEAR_SEQUENCE_TASK(&iLocal_300);
						...
						else if (iLocal_295 == 2)
						{
							if (func_21(&uLocal_121, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								OPEN_SEQUENCE_TASK(&iLocal_300);
								TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
								TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_295 * 250), 9, 0, 0, 0, 0);
								TASK_PLAY_ANIM(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
								CLOSE_SEQUENCE_TASK(iLocal_300);
								TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(), iLocal_300);
								CLEAR_SEQUENCE_TASK(&iLocal_300);
				...
				case 4:
					if (GET_GAME_TIMER() > iLocal_291)
					{
						...
						else
						{
							...
							if (iLocal_295 == 4)
							{
								TASK_PLAY_ANIM(TASK_PLAY_ANIM(), sLocal_299, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0, 0, 0, 0);
				...
				case 5:
					if (GET_GAME_TIMER() > iLocal_291)
					{
						START_VEHICLE_HORN(Local_97.f_4, 500, START_VEHICLE_HORN("NORMAL"), 0);
						iLocal_291 = GET_GAME_TIMER() + 2000;
						iLocal_294 = 8;
					}
					break;
				...
				case 6:
					if (IS_PED_SITTING_IN_VEHICLE(IS_PED_SITTING_IN_VEHICLE(), Local_97.f_4))
					{
						if (!func_15())
						{
...
void func_372(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!IS_SCRIPTED_CONVERSATION_ONGOING() && func_373(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
int func_378()
{
	...
	{
		if (IS_ENTITY_DEAD(Local_97.f_4, 0))
		{
	...
	if (DOES_ENTITY_EXIST(iLocal_114))
	{
		if (IS_ENTITY_DEAD(iLocal_114, 0) && iLocal_307 == 0)
		{
			if (func_3())
			{
...
void func_379()
{
	switch (iLocal_95)
	{
		...
		case 1:
			if (func_395())
			{
				if ((func_415(Local_97.f_4) && func_415(iLocal_114)) && IS_ENTITY_ATTACHED_TO_ENTITY(Local_97.f_4, iLocal_114))
				{
...
{
	if (((!func_412(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_411(0)) || func_410(1))
			{
			}
			else
			{
...
void func_420(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	iLocal_114 = CREATE_VEHICLE(iLocal_115, vParam0, fParam1, true, true, false);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_115);
	SET_VEHICLE_COLOUR_COMBINATION(iLocal_114, iLocal_116);
	SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_114, 1084227584);
	if (bParam2)
	{
		func_421(PLAYER_PED_ID(), iLocal_114, -1);
	}
	_0x51BB2D88D31A914B(iLocal_114, false);
	_0x192547247864DFDD(iLocal_114, false);
	SET_VEHICLE_HAS_STRONG_AXLES(iLocal_114, true);
	if (!IS_ENTITY_DEAD(iLocal_114, 0))
	{
		ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_114);
		iLocal_102 = 1;
	}
...
void func_423(vector3 vParam0, float fParam1)
{
	...
	func_246(&iLocal_106);
	func_6(&(Local_97.f_4));
	Local_97.f_4 = CREATE_VEHICLE(Local_97.f_5, vParam0, fParam1, true, true, false);
	SET_MODEL_AS_NO_LONGER_NEEDED(Local_97.f_5);
	SET_VEHICLE_ON_GROUND_PROPERLY(Local_97.f_4, 1084227584);
	_0x51BB2D88D31A914B(Local_97.f_4, false);
	_0x192547247864DFDD(Local_97.f_4, false);
	...
	iLocal_106 = CREATE_OBJECT(iLocal_109, vParam0 + vLocal_107, true, true, false);
	ATTACH_ENTITY_TO_ENTITY(iLocal_106, Local_97.f_4, 0, vLocal_107, vLocal_108, 0, 0, 0, 0, 2, 1);
}
...
void func_438(bool bParam0)
{
	...
	else if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_97.f_4, 0))
	{
		SET_ENTITY_COORDS(SET_ENTITY_COORDS(), Local_97, 1, false, 0, 1);
	}
	func_425();
	func_424();
	func_47(&iLocal_96);
	...
	if (bParam0)
	{
		...
		{
			_SET_TOW_TRUCK_CRANE_HEIGHT(iLocal_114, 0f);
		}
		while (!HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			wait(0);
...
void func_441(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_445(IS_PED_INJURED())) && !func_443(IS_PED_INJURED(), 0)) && !func_442()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_445(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_449(bool bParam0)
{
	...
	else
	{
		...
		func_423(Local_97, Local_97.f_3);
		SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), Local_97.f_4, -1);
	}
}
...
void func_452()
{
	...
	iLocal_80 = func_465();
	iLocal_113[0] = ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	iLocal_113[1] = ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
	...
	if (func_415(PLAYER_PED_ID()))
	{
		func_463(&uLocal_121, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
...
void func_469()
{
	...
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_381(&Local_79, 1, 0, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_80, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_113[0], 0);
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_113[1], 0);
...
void func_471(bool bParam0)
{
	...
	if (!func_485())
	{
		...
		{
			func_203(iVar0, 1, 0);
			func_472(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_473(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_476())
	{
		...
		{
			iVar2 = func_320(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
