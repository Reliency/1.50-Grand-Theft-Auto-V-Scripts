...
void __EntryFunction__()
{
	...
	CLEAR_AREA(vVar1, 3f, 1, 0, 0, false);
	while (true)
	{
		wait(0);
		if (!func_197(&Var0, 1))
		...
		if (Var0 == 25)
		{
			...
			{
				SET_PED_MAX_MOVE_BLEND_RATIO(SET_PED_MAX_MOVE_BLEND_RATIO(), 3f);
			}
		}
		if (func_169(&Var0, 0) && ABSF((vVar1.z - vVar3.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (PLAYER_PED_ID() - iParam0->f_60) > iParam6) && func_188(PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_199(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_199(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_209(int iParam0, float fParam1)
{
	...
	{
		if (func_220(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_217(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_224(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_217(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_243(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmhunting2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				iLocal_58 = CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, vLocal_57, 0, 1065353216, 0, 0, 1);
		...
		case 3:
			...
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vLocal_57, 1f, iLocal_54, 0))
			{
				SET_ENTITY_ROTATION(iLocal_58, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_244(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_243(&iVar0) || !func_245(&(uParam0->f_48))) || !HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
