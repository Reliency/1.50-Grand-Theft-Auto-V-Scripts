...
void func_10()
{
	...
	if (Global_19464 == 0)
	{
		if (func_9(2, Global_19455, 0))
		{
			...
			iLocal_30 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			while (!_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_30))
			{
				wait(0);
			}
			iVar0 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_30);
...
void func_15()
{
	if (Global_19464 == 0)
	{
		if (func_9(2, Global_19455, 0))
		{
			...
			iLocal_29 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_30);
			if (Global_19486.f_1 > 3)
			{
				Global_19486.f_1 = 8;
				if (iLocal_29 == 0)
...
void func_16()
{
	...
	else
	{
		...
		{
			func_7(Global_19467, "SET_DATA_SLOT", to_float(18), to_float(iVar0), to_float(0), -1f, -1f, &(Global_93491[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_21++;
...
void func_20()
{
	...
	while (iVar0 < 63)
	{
		if ((IS_BIT_SET(Global_111560.f_18569[iVar0 /*6*/], 0) && IS_BIT_SET(Global_111560.f_18569[iVar0 /*6*/], 1)) && !IS_BIT_SET(Global_111560.f_18569[iVar0 /*6*/], 3))
		{
			if (Global_93700 < 52)
			{
	...
	while (iVar0 < 20)
	{
		if (IS_BIT_SET(Global_111560.f_9080.f_99.f_219[0], iVar0))
		{
			if (Global_93700 < 52)
			{
