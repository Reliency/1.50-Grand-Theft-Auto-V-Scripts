...
void __EntryFunction__()
{
	...
	if (func_75(PLAYER_PED_ID()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((GET_MISSION_FLAG() == 0 && func_70() == 0) && func_69(GET_MISSION_FLAG(), vLocal_64, fLocal_65));
			func_67();
		}
	}
	func_66(65, 0);
	...
	while (true)
	{
		...
		vLocal_244 = { GET_ENTITY_FORWARD_VECTOR(GET_ENTITY_FORWARD_VECTOR()) };
		if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
		{
			func_63(&uLocal_233);
			func_3(&uLocal_234);
			if (func_2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 7, 0, 0))
			{
				func_66(65, 1);
				func_1(30);
				func_77();
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
				...
				fVar1 = ACOS(func_56(vLocal_244, 0.73f, 0.683f, -0.013f));
				if (ABSF(fVar1) < 25f)
				{
		...
		case 4:
			if (!IS_SCRIPTED_SPEECH_PLAYING(IS_SCRIPTED_SPEECH_PLAYING()) && !IS_SCRIPTED_SPEECH_PLAYING())
			{
...
{
	iParam0->f_1 = CREATE_VEHICLE(joaat("akuma"), vParam1, fParam2, true, true, false);
	if (func_75(iParam0->f_1))
	{
		...
		SET_VEHICLE_ENGINE_ON(iParam0->f_1, false, true, 0);
		*iParam0 = CREATE_PED_INSIDE_VEHICLE(iParam0->f_1, 26, CREATE_PED_INSIDE_VEHICLE(CREATE_PED_INSIDE_VEHICLE()), -1, 1, true);
		if (func_75(*iParam0))
		{
...
int func_14(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_15(GET_ENTITY_MODEL(GET_ENTITY_MODEL(), 1)));
				switch (iVar0)
				{
...
void func_16(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[26 /*34*/].f_6) == 0)
			{
				Global_111560.f_7256[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_111560.f_7256[iParam0], true, true);
			}
...
int func_57(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	...
	if (IS_ENTITY_IN_ANGLED_AREA(iParam0, vParam1, vParam2, fParam3, 0, true, 0))
	{
		return 1;
	}
	...
	GET_MODEL_DIMENSIONS(GET_MODEL_DIMENSIONS(iParam0), &Var1, &Var2);
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1, Var2.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, Var2.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var2, Var2.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1, Var1.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, Var1.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var2, Var1.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam2, fParam3, 0, true))
	{
		return 1;
	}
...
void func_63(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				iVar2 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
				fVar1 = ACOS(func_56(vLocal_244, -0.37f, -0.927f, -0.053f));
				if (ABSF(fVar1) < 45f)
				{
...
{
	func_66(65, 0);
	SET_ROADS_IN_ANGLED_AREA(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, 0, false, 1);
	func_6(135, iParam0);
	func_6(136, iParam0);
	SET_ROADS_IN_ANGLED_AREA(-1039.504f, -477.7876f, 35.32967f, -1062.444f, -469.5685f, 40.62086f, 13f, 0, false, 1);
	func_6(137, iParam0);
...
void func_67()
{
	...
	if (!func_69(PLAYER_PED_ID(), vLocal_64, (fLocal_65 + 30f)))
	{
		func_77();
	}
	wait(0);
...
void func_71()
{
	...
	{
		if (func_73(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
