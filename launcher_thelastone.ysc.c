...
int func_184(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && (PLAYER_PED_ID() - uParam0->f_60) > iParam6) && func_190(PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_185(sParam3))
		{
			...
			{
				if (func_190(PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_144();
				}
			}
...
void func_191(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)
{
	...
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_190(PLAYER_PED_ID(), vParam3, 1) <= 100f)
				{
					func_194(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_190(PLAYER_PED_ID(), vParam4, 1);
					fVar1 = func_190(PLAYER_PED_ID(), vParam5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								REMOVE_CUTSCENE();
								_REQUEST_CUTSCENE_EX(sParam2, 5, 8);
								func_192(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							REMOVE_CUTSCENE();
							_REQUEST_CUTSCENE_EX(sParam2, 6, 8);
							func_192(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_190(PLAYER_PED_ID(), vParam3, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_201(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_202(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_201(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_238(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (((!func_241(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmlastone1")) || !HAS_ANIM_DICT_LOADED(joaat("weapon_pumpshotgun"))) || !HAS_ANIM_DICT_LOADED(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = CREATE_PED(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
