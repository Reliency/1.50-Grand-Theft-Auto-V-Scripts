...
void __EntryFunction__()
{
	...
	{
		func_312();
		if (func_302() || !func_301(PLAYER_ID(), 0, 1))
		{
			func_299();
		}
		switch (func_298(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_297() == 2)
				{
					iLocal_172[PARTICIPANT_ID_TO_INT()] = 2;
				}
				else if (func_297() == 6)
				{
					iLocal_172[PARTICIPANT_ID_TO_INT()] = 5;
				}
				break;
			...
			case 2:
				if (func_297() == 2)
				{
					...
					{
						if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 4))
						{
							func_33(1);
							func_32(0);
							func_25();
			...
			case 5:
				...
				{
					iLocal_172[PARTICIPANT_ID_TO_INT()] = 6;
				}
				break;
		...
		switch (Local_97.f_5.f_2)
		{
				...
				if (IS_BIT_SET(Local_97.f_5.f_3, 1))
				{
					if (IS_BIT_SET(Local_97.f_5.f_3, 0))
					{
						if (!func_20(&(Local_97.f_5)) || func_19(&(Local_97.f_5), 5000, 0))
						{
							...
							{
								if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 0))
								{
									SET_BIT(&(Local_97.f_5.f_73), iVar1);
									Local_97.f_5.f_72++;
									if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 6))
									{
										Local_97.f_5.f_5[iVar0] = -1;
									}
								}
			...
			case 1:
				...
				if (IS_BIT_SET(Local_97.f_5.f_73, iVar0))
				{
					...
					{
						if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 8))
						{
							if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 0))
							{
					...
					if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 0))
					{
						if (func_301(iVar0, 1, 1))
						{
							if (Local_97.f_5.f_38[iVar0] == -1)
							{
								...
								if (iVar3 > -1)
								{
									if (IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 0))
									{
										if (Local_97.f_5.f_38[iVar0] == -1)
										{
										...
										else if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 3))
										{
											Local_97.f_5.f_38[iVar0] = Local_97.f_5.f_38[iVar3];
										}
										else if (!IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 3))
										{
...
void func_3()
{
	...
	Var0 = -335191407;
	Var0.f_1 = PLAYER_ID();
	TRIGGER_SCRIPT_EVENT(1, &Var0, 2, func_4(1, 1));
}
								...
								if (Global_2423902.f_87[iVar12] == 0)
								{
									if (!IS_BIT_SET(*iParam1, iVar1))
									{
										if (!IS_PED_INJURED(iVar9))
										{
											...
											{
												vVar7 = { func_10(iVar1) };
												fVar4 = vdist2(GET_ENTITY_COORDS(iVar9, true), vVar7);
												if (fVar4 > fVar6)
												{
													fVar5 = vdist2(GET_ENTITY_COORDS(iVar11, true), vVar7);
													if (fVar5 > fVar6)
													{
														iVar2 = iVar1;
														bVar0 = true;
														SET_BIT(iParam1, iVar1);
													}
												}
											}
										}
...
int func_12(int iParam0)
{
	...
	if (iVar0 != -1)
	{
		if (IS_BIT_SET(Global_2423902.f_64, iVar0))
		{
			if (!IS_BIT_SET(Global_2423902.f_62, iVar0))
			{
				return 1;
			}
		}
...
int func_13(int iParam0)
{
	...
	while (iVar1 <= 31)
	{
		...
		if (Local_97.f_5.f_38[iVar1] == iParam0)
		{
			...
			{
				if (!IS_BIT_SET(Global_1590446[iVar1 /*871*/].f_146, 4))
				{
					if (IS_BIT_SET(Global_1590446[iVar1 /*871*/].f_146, 3))
					{
						iVar0 = 1;
					}
				}
...
{
	return IS_BIT_SET(Local_97.f_2, iParam0);
}
		...
		if (iVar1 == -1)
		{
			if (iVar0 != iParam0)
			{
				if (IS_BIT_SET(*uParam1, iVar0))
				{
					if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 0))
					{
						if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 3))
						{
							if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 2))
							{
								if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 8))
								{
									if (Local_97.f_5.f_5[iVar0] == -1)
...
void func_21()
{
	...
	if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		{
			if (!IS_BIT_SET(Global_1590446[iLocal_171 /*871*/].f_146, 4))
			{
				CLEAR_BIT(&iLocal_197, 1);
			}
		}
		if (IS_BIT_SET(Global_1590446[iLocal_171 /*871*/].f_146, 0))
		{
			if (func_301(iVar1, 0, 1))
			{
				if (iVar2 > -1)
		...
		{
			if (IS_BIT_SET(Global_1590446[iLocal_171 /*871*/].f_146, 12))
			{
				if (Local_97.f_5.f_5[iLocal_171] != -1)
				{
					Local_97.f_5.f_5[iLocal_171] = -1;
...
void func_32(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 0))
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 0);
		}
	}
	else if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 0))
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 0);
	}
}
...
void func_33(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 4))
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 4);
		}
	}
	else if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 4))
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 4);
	}
}
...
int func_34(var uParam0)
{
	...
	if (*uParam0 > 0)
	{
		...
		if (!IS_BIT_SET(uParam0->f_1, 2))
		{
			...
			{
				if ((func_293(PLAYER_ID(), 1, 0) || func_292()) || func_291() != 0)
				{
					func_289(uParam0);
				...
				if (!func_293(PLAYER_ID(), 1, 0))
				{
					if (!func_292())
					{
						if (func_291() == 0)
						{
							...
							CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 2);
							if (*uParam0 > 1)
							{
								*uParam0 = 1;
							}
		...
		iVar3 = PLAYER_ID();
		if (!IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 5))
		{
			if (func_293(PLAYER_ID(), 1, 0) || func_292())
			{
				SET_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 5);
				*uParam0 = 0;
				func_32(0);
				func_288(0);
				func_24(8, 0);
		...
		if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 9))
		{
	...
	switch (*uParam0)
	{
		case 0:
			iVar3 = PLAYER_ID();
			if (!IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 13))
			{
				if (IS_BIT_SET(Global_2531497.f_1726, 6) || IS_BIT_SET(Global_2531497.f_1728, 31))
				{
					if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 0))
					{
						if (!func_286())
									...
									if (func_291() == 0)
									{
										if (func_164())
										{
											if (func_147(uParam0))
											{
												...
												if (IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 5))
												{
													CLEAR_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 5);
												}
											}
										}
									}
				...
				if (IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 0))
				{
					...
					if (IS_BIT_SET(Global_1653897, 1))
					{
						iVar3 = PLAYER_ID();
			...
			else
			{
				if (IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 0))
				{
					CLEAR_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 0);
					CLEAR_BIT(&(uParam0->f_1), 0);
					CLEAR_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 2);
					CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 16);
					func_32(0);
				}
				if (IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 12))
				{
					if (Local_97.f_5.f_38[iVar3] == -1 && Local_97.f_5.f_5[iVar3] == -1)
					{
						CLEAR_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 12);
					}
				}
				...
				{
					CLEAR_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 13);
					func_18(&(uParam0->f_6));
				}
			}
			break;
		...
		case 1:
			...
			{
				if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 16))
				{
					CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 16);
				}
				...
				if (iVar0 > -1 && func_141(iVar0, 1))
				{
					...
					if (NETWORK_IS_PLAYER_ACTIVE(iVar4))
					{
						...
						{
							if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 4) && !IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 5))
							{
			...
			else
			{
				...
				if (!IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 2))
				{
					if (!IS_PED_INJURED(IS_PED_INJURED()))
					{
						if ((vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), func_10(iVar1)) < (15f * 15f) || (iVar0 == -1 && func_139(25f))) || func_138(1101004800, 1117126656))
						{
							if (DOES_BLIP_EXIST(uParam0->f_4))
							{
							...
							SET_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 2);
						}
					}
				}
				else
				{
					if (!IS_PED_INJURED(IS_PED_INJURED()))
					{
						if (!IS_BIT_SET(uParam0->f_1, 2))
						{
							if ((!IS_BIT_SET(iLocal_197, 18) && vdist2(IS_BIT_SET(IS_BIT_SET(), true), func_10(iVar1)) > (35f * 35f)) || (IS_BIT_SET(iLocal_197, 18) && vdist2(IS_BIT_SET(IS_BIT_SET(), true), func_10(iVar1)) > (90f * 90f)))
							{
								CLEAR_BIT(&(uParam0->f_1), 0);
								CLEAR_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 2);
								CLEAR_BIT(&iLocal_197, 18);
							}
						}
					}
					if (IS_BIT_SET(Global_1653897, 15))
					{
			...
			if (iVar0 > -1 && func_141(iVar0, 1))
			{
					...
					if (!IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 2))
					{
						if (!IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 12))
						{
							if (func_20(&(uParam0->f_10)))
							{
								...
								{
									SET_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 12);
									SET_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 13);
									if (DOES_BLIP_EXIST(uParam0->f_4))
									{
										REMOVE_BLIP(&(uParam0->f_4));
									}
								...
								else if (!IS_BIT_SET(uParam0->f_1, 2))
								{
									if (!IS_BIT_SET(uParam0->f_1, 12))
									{
										...
										else if (!IS_BIT_SET(iLocal_197, 11))
										{
											if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 2))
											{
				...
				if (!IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 12))
				{
					if (IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 2) && IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 2))
					{
						CLEAR_BIT(&(uParam0->f_1), 12);
						CLEAR_BIT(&iLocal_197, 11);
					...
					else if (IS_BIT_SET(Global_1590446[iVar3 /*871*/].f_146, 2))
					{
						if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 2))
						{
							func_116();
					...
					if (!func_111())
					{
						if (iVar0 > -1 && func_141(iVar0, 1))
						{
							...
							if (NETWORK_IS_PLAYER_ACTIVE(iVar4))
							{
								if (func_301(iVar4, 1, 1))
								{
									if (!IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 16))
									{
										Var5 = { func_136(iVar4) };
										if (NETWORK_IS_FRIEND(&Var5))
										{
						...
						if (!IS_BIT_SET(uParam0->f_1, 3) && !IS_BIT_SET(uParam0->f_1, 14))
						{
							...
							SET_BIT(&(uParam0->f_1), 3);
							SET_BIT(&(Global_1590446[iVar3 /*871*/].f_146), 8);
						}
					}
				}
				else
...
void func_85(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 17))
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 17);
		}
	}
	else if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 17))
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 17);
	}
}
...
int func_86(var uParam0)
{
	...
	iVar0 = Local_97.f_5.f_5[PLAYER_ID()];
	if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 2))
	{
		if (func_144(1167, -1, 0) > iLocal_363)
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 10);
			if (iVar0 > -1)
			{
				iVar1 = iVar0;
				if (NETWORK_IS_PLAYER_ACTIVE(iVar1))
	...
	if ((IS_BIT_SET(uParam0->f_1, 7) && !IS_BIT_SET(uParam0->f_1, 10)) && !IS_BIT_SET(uParam0->f_1, 9))
	{
		...
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 11);
			return 1;
		}
	}
	return 0;
...
int func_87()
{
	...
	if (iVar0 > -1)
	{
		if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 11))
		{
			return 1;
		}
	}
...
int func_88()
{
	...
	if (iVar0 > -1)
	{
		if (IS_BIT_SET(Global_1590446[iVar0 /*871*/].f_146, 10))
		{
			return 1;
		}
	}
				...
				if (!IS_PAUSE_MENU_ACTIVE())
				{
					if (func_94())
					{
						if (func_139(1089470464))
						{
							...
							else if (!IS_BIT_SET(iLocal_197, 7) || IS_BIT_SET(0, 37))
							{
...
int func_94()
{
	if (((((((((((((((!func_301(PLAYER_ID(), 1, 1) || PLAYER_ID(PLAYER_ID())) || !PLAYER_ID(PLAYER_ID())) || func_100(8, -1)) || func_100(15, -1)) || func_99()) || func_100(3, -1)) || PLAYER_ID()) || func_293(PLAYER_ID(), 1, 0)) || func_292()) || func_98()) || func_97()) || func_96()) || PLAYER_ID()) || PLAYER_ID()) || func_95())
	{
		return 0;
	}
	return 1;
...
bool func_95()
{
	return IS_BIT_SET(Global_2531497.f_1732, 12);
}
...
void func_101(var uParam0)
{
	...
	if (!IS_BIT_SET(uParam0->f_1, 7))
	{
		if (!func_109())
		{
			...
			{
				if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 2) && ((IS_BIT_SET(joaat("am_hold_up")) == 0 && !IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 16)) && !func_108()))
				{
				...
				{
					if ((!func_111() && !IS_BIT_SET(uParam0->f_1, 8)) && IS_BIT_SET(joaat("am_hold_up")) == 0)
					{
						SET_BIT(&(uParam0->f_1), 9);
						SET_BIT(&(uParam0->f_1), 7);
					}
...
void func_102(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_2531497.f_1732, 21))
		{
			SET_BIT(&(Global_2531497.f_1732), 21);
		}
	}
	else if (IS_BIT_SET(Global_2531497.f_1732, 21))
	{
		CLEAR_BIT(&(Global_2531497.f_1732), 21);
	}
}
...
int func_109()
{
	...
	iVar0 = Local_97.f_5.f_38[PLAYER_ID()];
	iVar1 = func_11(iVar0);
	if (IS_BIT_SET(Global_2423902.f_65, iVar1))
	{
		return 1;
	}
	if (iVar0 > -1)
...
void func_110(var uParam0)
{
	...
	if (!IS_BIT_SET(uParam0->f_1, 1) && !IS_BIT_SET(Global_1590446[iVar1 /*871*/].f_146, 8))
	{
		if (iVar0 > -1)
		{
			if (IS_BIT_SET(Global_1590446[iVar1 /*871*/].f_146, 6))
			{
				CLEAR_BIT(&(Global_1590446[iVar1 /*871*/].f_146), 6);
			}
			if (!func_141(iVar0, 1))
			{
				CLEAR_BIT(&(uParam0->f_1), 0);
	...
	else
	{
		if (*uParam0 < 3)
		{
			if (!IS_BIT_SET(Global_1590446[iVar1 /*871*/].f_146, 6))
			{
				SET_BIT(&(Global_1590446[iVar1 /*871*/].f_146), 6);
			}
		}
		else if (IS_BIT_SET(Global_1590446[iVar1 /*871*/].f_146, 6))
		{
			CLEAR_BIT(&(Global_1590446[iVar1 /*871*/].f_146), 6);
		}
		if (iVar0 > -1)
...
int func_111()
{
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (!func_90(vVar1, 0f, 0f, 0f, 0))
		{
			iVar0 = GET_INTERIOR_FROM_ENTITY(GET_INTERIOR_FROM_ENTITY());
			if (iVar0 != 0)
			{
				if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), vVar1, true) < 25f)
				{
					return 1;
				}
			}
...
void func_112(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_20(&iParam1))
	{
		iVar0 = (iParam0 - IS_TIME_EQUAL_TO(IS_TIME_EQUAL_TO(), iParam1));
		if (iVar0 >= 0)
		{
...
{
	return DOES_BLIP_EXIST(Global_2416074[iParam0]);
}
...
int func_125(int iParam0, bool bParam1)
{
	...
	if (iParam0 > -1)
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iVar0))
		{
			if (func_301(iVar0, 0, 1))
			{
				SET_PED_CAN_BE_TARGETTED_BY_PLAYER(SET_PED_CAN_BE_TARGETTED_BY_PLAYER(), iVar0, bParam1);
				return 1;
			}
		}
	}
...
void func_126(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 7))
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 7);
		}
	}
	else if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 7))
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 7);
	}
}
				...
				if (NETWORK_IS_PLAYER_ACTIVE(iVar3))
				{
					if (func_301(iVar3, 0, 1))
					{
						...
						if (!IS_PED_INJURED(iVar4))
						{
							...
							{
								if (GET_VEHICLE_PED_IS_IN(iVar4, 0) == iVar2)
								{
									return 1;
								}
							}
...
int func_138(float fParam0, float fParam1)
{
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (IS_PED_SITTING_IN_ANY_VEHICLE(IS_PED_SITTING_IN_ANY_VEHICLE()))
		{
			if (GET_ENTITY_SPEED(GET_ENTITY_SPEED(GET_ENTITY_SPEED(), 0)) > fParam0)
			{
				if (func_139(fParam1))
				{
					if (!IS_BIT_SET(iLocal_197, 18))
					{
						SET_BIT(&iLocal_197, 18);
					}
					return 1;
				}
			}
...
int func_139(float fParam0)
{
	...
	if (iVar0 > -1)
	{
		...
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			if (vdist2(vVar2, vVar1) < (fParam0 * fParam0))
			{
				return 1;
			}
		}
...
int func_141(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 4))
		{
			return 0;
		}
	}
	if (IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 8))
	{
		return 0;
	}
	if (IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 5))
	{
		return 0;
	}
	if (IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 12))
	{
		return 0;
	}
	return 1;
...
void func_142()
{
	if (!IS_BIT_SET(iLocal_197, 16))
	{
		if (func_117(0, 1, 1, 1))
		{
			func_146("FM_IHELP_INV", 10000);
			SET_BIT(&iLocal_197, 16);
		}
	}
	if (!IS_BIT_SET(iLocal_197, 6))
	{
		if (IS_BIT_SET(iLocal_197, 13))
		{
		...
		case 0:
			...
			else if (func_19(&(uParam0->f_14), 7000, 0))
			{
				if (func_162())
				{
					...
					else if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 16))
					{
						func_140("FM_IHELP_LCP", 0);
						SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 16);
		...
		case 1:
			...
			else if (func_162())
			{
				if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
				{
					...
					if ((!func_20(&uLocal_364) || func_19(&uLocal_364, 20000, 0)) || IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 16))
					{
						if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 16))
						{
							CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 16);
...
void func_151(int iParam0)
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		Global_2394180[iParam0 /*46*/].f_38 = 0xBA7F0B77D80A4EB7();
	}
}
...
void func_155(int iParam0, int iParam1, bool bParam2, char* sParam3, char* sParam4, var uParam5, int iParam6, int iParam7, int iParam8, var uParam9, var uParam10)
{
	...
	Global_2394180[iVar4 /*46*/].f_38 = 0xBA7F0B77D80A4EB7();
...
void func_156()
{
	Global_1383933 = HAS_NETWORK_TIME_STARTED(HAS_NETWORK_TIME_STARTED(), 30000);
}
...
int func_157()
{
	...
	StringCopy(&cVar0, "", 24);
	cVar0 = { func_159() };
	if (IS_STRING_NULL_OR_EMPTY(&cVar0) || IS_STRING_NULL_OR_EMPTY(".", &cVar0))
	{
		return -1;
	}
	iVar1 = 0;
...
struct<6> func_159()
{
	...
	if (IS_STRING_NULL_OR_EMPTY(&(Global_1668601.f_10)))
	{
		...
		else
		{
			...
			while (iVar1 < 1218)
			{
				if ((Global_794709.f_4[iVar1 /*88*/].f_65 == 0 && Global_794709.f_4[iVar1 /*88*/].f_68 == 1) && IS_BIT_SET(Global_794709.f_4[iVar1 /*88*/].f_76, 13))
				{
...
bool func_164()
{
	...
	if (!IS_BIT_SET(iLocal_197, 2))
	{
		...
		else if (!IS_BIT_SET(iLocal_197, 9))
		{
			...
			{
				if (!IS_BIT_SET(iLocal_197, 5) || (IS_BIT_SET(iLocal_197, 5) && func_19(&uLocal_193, 60000, 0)))
				{
					if (func_280())
					{
	...
	return IS_BIT_SET(iLocal_197, 2);
}
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (Global_2458994)
							{
								if (iVar1 == 14)
								{
									func_188(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(Global_21868), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_7925[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_188(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(Global_21873), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76577)
								{
									...
									func_188(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19486)
									...
									func_188(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7363[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_188(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_188(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_7925[iVar0] = 1;
						}
					}
...
void func_200()
{
	...
	{
		if (func_203(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
			iVar0 = func_202(PLAYER_PED_ID());
...
void func_267(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 28);
	}
	else
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 28);
	}
}
		...
		while (iVar0 < 32)
		{
			...
			if (func_301(iVar1, 1, 1))
			{
				if (iVar1 != PLAYER_ID())
				{
					if (func_285(iVar1))
					{
						if (vdist2(vVar2, GET_ENTITY_COORDS(GET_ENTITY_COORDS(iVar1), true)) < (fParam0 * fParam0))
						{
							return 1;
						}
					}
...
{
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 28);
}
...
void func_287()
{
	...
	TRIGGER_SCRIPT_EVENT(1, &vVar0, 3, func_4(1, 1));
}
...
void func_288(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 3))
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 3);
		}
	}
	else if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_146, 3))
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 3);
	}
}
...
int func_302()
{
	...
	if (func_303() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_303()) == 0)
		{
			return 1;
		}
	}
...
void func_313(struct<21> Param0)
{
	...
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&iLocal_172, 33);
	SET_THIS_SCRIPT_CAN_BE_PAUSED(0);
	if (!func_314())
	{
		func_299();
	}
	CLEAR_BIT(&Global_1653897, 1);
	CLEAR_BIT(&Global_1653897, 15);
	CLEAR_BIT(&Global_1653897, 14);
	func_24(8, 1);
	if (!func_285(PLAYER_ID()))
	{
		func_267(1);
