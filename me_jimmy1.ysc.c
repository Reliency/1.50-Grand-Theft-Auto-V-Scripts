...
void __EntryFunction__()
{
	...
	iLocal_59 = 49;
	iLocal_60 = 64;
	iLocal_65 = _0x4A9923385BDB9DAD();
	iLocal_66 = _GET_BLIP_INFO_ID_ITERATOR();
...
void func_3()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_299) && DOES_ENTITY_EXIST(iLocal_299))
	{
		func_2(2);
	}
	else if (func_42(iLocal_299) && func_42(PLAYER_PED_ID()))
	{
		if (IS_EXPLOSION_IN_SPHERE(-1, IS_EXPLOSION_IN_SPHERE(iLocal_299, true), 2f) && !IS_EXPLOSION_IN_SPHERE(13, IS_EXPLOSION_IN_SPHERE(iLocal_299, true), 2f))
		{
			SET_PED_CAN_RAGDOLL(iLocal_299, 1);
			SET_PED_TO_RAGDOLL(iLocal_299, 500, 1000, 0, 0, 0, 0);
			SET_ENTITY_HEALTH(iLocal_299, 99, 0);
			SET_ENTITY_COLLISION(iLocal_299, true, 0);
			func_2(2);
		}
		else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_299, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
		{
			if (HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_299, 0, 2) || HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_299))
			{
				REMOVE_PED_FROM_GROUP(iLocal_299);
				OPEN_SEQUENCE_TASK(&iVar0);
				if (IS_PED_IN_ANY_VEHICLE(iLocal_299, 0))
				{
		...
		{
			if (func_41(iLocal_304) && (((((IS_PED_IN_VEHICLE(iLocal_299, iLocal_304, 0) || IS_PED_IN_VEHICLE(iLocal_299, sLocal_232, "back", 2)) || IS_PED_IN_VEHICLE(iLocal_299, sLocal_232, "base", 2)) || IS_PED_IN_VEHICLE(iLocal_299, sLocal_232, "enter_back", 2)) || IS_PED_IN_VEHICLE(iLocal_299, sLocal_232, "enter_backseat", 2)) || IS_PED_IN_VEHICLE(iLocal_299, sLocal_232, "exit_back", 2)))
			{
			...
			if (((IS_PLAYER_FREE_AIMING(IS_PLAYER_FREE_AIMING()) && func_40(IS_PLAYER_FREE_AIMING(), iLocal_299, 50f, 1)) && func_39(iLocal_299, 1126825984)) && func_30(IS_PLAYER_FREE_AIMING(), iLocal_299, 90f, 1, 250, 7))
			{
				...
				{
					TASK_HANDS_UP(iLocal_299, -1, 0, -1, 0);
				}
			}
...
int func_34(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_36(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_36(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_46(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		else if (func_42(iLocal_299) && IS_ENTITY_AT_COORD(iLocal_299, vLocal_291, 50f, 50f, 50f, false, true, 0))
		{
			func_50(iLocal_299);
		}
		else
	...
	{
		_0x18EB48CFC41F2EA0(iLocal_304, 0);
	}
	if (bParam0)
	{
		func_48(&iLocal_304);
	...
	if (func_42(PLAYER_PED_ID()) && func_42(iLocal_299))
	{
		...
		switch (iLocal_296)
		{
			case 0:
				...
				TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), iLocal_299, -1, 2050, 4);
				if (func_49(iVar0))
				{
				...
				{
					TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), iLocal_299, 0);
					...
					TASK_TURN_PED_TO_FACE_ENTITY(0, TASK_TURN_PED_TO_FACE_ENTITY(), 10000);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_250, 1f, 20000, 1048576000, 0, 1193033728);
				...
				iLocal_334 = -1;
				bLocal_252 = false;
				if ((((IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1) && !IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE())) || (IS_PED_IN_ANY_VEHICLE(iLocal_299, 1) && !IS_PED_IN_ANY_VEHICLE(iLocal_299))) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE())) || IS_PED_IN_ANY_VEHICLE(iLocal_299))
				{
					func_86(500, 1);
					wait(1000);
					SET_ENTITY_COORDS_NO_OFFSET(SET_ENTITY_COORDS_NO_OFFSET(), -1374.11f, 363.81f, 64.25f, 0, 0, 1);
					SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 117.46f);
					if (func_42(iLocal_299))
					{
						SET_ENTITY_COORDS_NO_OFFSET(iLocal_299, -1375.82f, 362.3f, 64.17f, 0, 0, 1);
			...
			case 1:
				...
				if (!func_27())
				{
					if (((func_49(iLocal_304) && func_42(iLocal_299)) && IS_PED_IN_VEHICLE(iLocal_299, iLocal_304, 0)) && IS_PED_IN_VEHICLE(iLocal_304, 0, 0))
					{
			...
			case 3:
				...
				if (((!func_27() && func_82(iLocal_299, vLocal_250, 4f)) || bLocal_252) || GET_GAME_TIMER() > iLocal_251)
				{
					if (bLocal_252)
					{
						if (func_27())
...
void func_73(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_78(IS_PED_INJURED())) && !func_75(IS_PED_INJURED(), 0)) && !func_74()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_78(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_89(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_90(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_101(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_101(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_101(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_133(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_112(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_101(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_101(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_113(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_113(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_113(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_113(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_144(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_144(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_101(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_205(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_101(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_101(iParam1)))
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_296)
		{
			case 0:
				...
				else
				{
					...
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, TASK_FOLLOW_NAV_MESH_TO_COORD(TASK_FOLLOW_NAV_MESH_TO_COORD(), true), 2f, 20000, 1048576000, 0, 1193033728);
					TASK_TURN_PED_TO_FACE_ENTITY(0, TASK_TURN_PED_TO_FACE_ENTITY(), 10000);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_249, 1f, 20000, 1048576000, 0, 1193033728);
					CLOSE_SEQUENCE_TASK(iVar1);
					TASK_PERFORM_SEQUENCE(iLocal_299, iVar1);
					CLEAR_SEQUENCE_TASK(&iVar1);
				}
			...
			case 3:
				...
				if (((!func_27() && (func_82(iLocal_299, vLocal_247, 2f) || func_82(iLocal_299, vLocal_248, 2f))) || bLocal_252) || GET_GAME_TIMER() > iLocal_251)
				{
					if (bLocal_252)
					{
						if (func_27())
						...
						{
							CLEAR_PED_TASKS(iLocal_299);
							SET_ENTITY_COORDS(iLocal_299, vLocal_249, 1, false, 0, 1);
...
void func_221()
{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			func_234(&uLocal_336);
			if (func_42(iLocal_299) && !IS_PED_GROUP_MEMBER(iLocal_299, func_233()))
			{
				SET_PED_AS_GROUP_MEMBER(iLocal_299, func_233());
				SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_299, 0);
				SET_PED_NEVER_LEAVES_GROUP(iLocal_299, 1);
				SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_299, 0);
			}
			iLocal_296 = 1;
			break;
		...
		case 1:
			if (func_42(PLAYER_PED_ID()) && func_42(iLocal_299))
			{
				...
				if (func_225(PLAYER_PED_ID(), iLocal_299) > 15f)
				{
					func_28();
					iLocal_296 = 0;
					iLocal_295 = 4;
	...
	if (func_42(iLocal_299) && func_49(iLocal_304))
	{
		switch (iLocal_234)
		{
			...
			case 2:
				...
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
				TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_266 = 0;
				iLocal_267 = -1;
				iLocal_234 = 12;
				break;
			...
			case 4:
				...
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
				TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 5;
				break;
			...
			case 5:
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
						ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
						TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 6;
					}
				}
				break;
			...
			case 7:
				...
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
				TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "exit_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
			...
			case 8:
				...
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
				TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 9;
				break;
			...
			case 9:
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
						ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
						TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 10;
					}
				}
				break;
			...
			case 11:
				...
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
				TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "exit_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				if (iLocal_237 || !IS_VEHICLE_WINDOW_INTACT(iLocal_304, 7))
				{
					iLocal_234 = 13;
				}
			...
			case 12:
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
						ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
						TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 3;
					}
				}
				break;
			...
			case 14:
				...
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
				TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "exit_back", 4f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 15;
				break;
			...
			case 15:
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.95f)
					{
						...
						TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "enter_backseat", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 16;
					}
				}
				else
			...
			case 16:
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					...
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_299, -4f, 1);
			...
			case 17:
				if (IS_PED_IN_VEHICLE(iLocal_299, iLocal_304, 0) && iLocal_237)
				{
...
int func_224()
{
	...
	{
		vVar0 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_304, GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(), true)) };
		if (vVar0.y < -1f)
		{
			return 1;
		}
...
void func_227()
{
	...
	if (func_42(iLocal_299))
	{
		if (IS_PED_IN_ANY_VEHICLE(iLocal_299, 0))
		{
			iVar0 = GET_VEHICLE_PED_IS_IN(iLocal_299, 0);
			if (DOES_ENTITY_EXIST(iVar0))
			{
				if (!IS_VEHICLE_DRIVEABLE(iVar0, 0) && IS_VEHICLE_DRIVEABLE(iVar0))
				{
...
void func_228()
{
	if ((iLocal_278 < 3 && GET_GAME_TIMER() > iLocal_275) && (func_231() || func_230()))
	{
...
int func_230()
{
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) || IS_PED_IN_ANY_VEHICLE(iLocal_299, 0))
	{
		return 0;
	}
	return 1;
...
int func_231()
{
	...
	{
		iVar0 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
		if (func_49(iVar0) && IS_PED_IN_VEHICLE(iLocal_299, iVar0, 0))
		{
			return 1;
		}
	}
...
void func_232()
{
	...
	if ((iLocal_270 < 6 && GET_GAME_TIMER() > iLocal_268) && func_231())
	{
...
void func_236(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!IS_SCRIPTED_CONVERSATION_ONGOING() && func_237(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_242()
{
	...
	switch (iLocal_296)
	{
		...
		case 1:
			...
			if (func_42(PLAYER_PED_ID()) && func_42(iLocal_299))
			{
				if (func_225(PLAYER_PED_ID(), iLocal_299) < 5f)
				{
...
void func_243()
{
	if (func_42(PLAYER_PED_ID()) && func_42(iLocal_299))
	{
		if (func_225(PLAYER_PED_ID(), iLocal_299) > fLocal_293)
		{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			if (func_336() == 1)
			{
				...
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_292 - Vector(10f, 10f, 10f), vLocal_292 + Vector(10f, 10f, 10f), false, 1);
				CLEAR_AREA_OF_VEHICLES(vLocal_292, 10f, 0, 0, 0, 0, false, 0);
			}
			else
			{
			...
			if (func_42(iLocal_299) && !IS_PED_GROUP_MEMBER(iLocal_299, func_233()))
			{
				...
				SET_PED_NEVER_LEAVES_GROUP(iLocal_299, 1);
				SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_299, 0);
				SET_ENTITY_PROOFS(iLocal_299, true, false, false, false, true, false, 0, false);
				SET_PED_CAN_RAGDOLL(iLocal_299, 1);
			}
...
void func_247()
{
	...
	if (func_42(PLAYER_PED_ID()) && PLAYER_PED_ID() > iLocal_287)
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			iVar0 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
...
void func_248()
{
	...
	{
		if ((!func_27() && func_229()) && IS_PED_SHOOTING(IS_PED_SHOOTING()))
		{
...
void func_249()
{
	...
	{
		if (func_225(PLAYER_PED_ID(), iLocal_301[0]) < 30f)
		{
			if (!func_27() && func_229())
			{
...
void func_250()
{
	...
	if ((iLocal_274 < 3 && GET_GAME_TIMER() > iLocal_271) && (func_231() || func_230()))
	{
...
void func_251()
{
	...
	{
		if (((!func_27() && func_229()) && func_231()) && GET_GAME_TIMER() > iLocal_263)
		{
...
void func_252()
{
	if (((((iLocal_288 && DOES_ENTITY_EXIST(iLocal_301[0])) && DOES_ENTITY_EXIST(iLocal_301[1])) && DOES_ENTITY_EXIST(iLocal_301[2])) && func_42(iLocal_299)) && !DOES_ENTITY_EXIST())
	{
...
void func_253(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_332(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_325(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_255(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_278(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_280(Var7.f_1)) && iVar9 < 51)
			{
...
int func_289(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_311())
		{
			*uParam0 = func_295(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_291(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_293() == 0)
		{
			return IS_BIT_SET(func_137(func_292(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_295(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_310(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_296(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_318(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_339()
{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			{
				SET_ENTITY_VISIBLE(iLocal_304, true, 0);
				SET_VEHICLE_HAS_STRONG_AXLES(iLocal_304, true);
				iVar0 = 0;
				iVar0 = 0;
				while (iVar0 < 3)
				{
					SET_ENTITY_VISIBLE(iLocal_301[iVar0], true, 0);
					iVar0++;
				}
				SET_ENTITY_VISIBLE(iLocal_299, true, 0);
				SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_299, 1);
		...
		case 1:
			...
			if (func_49(iLocal_304) && DOES_ENTITY_EXIST(iLocal_301[0]))
			{
				...
				if ((((((((((GET_ENTITY_HEALTH(iLocal_304) < 850 || func_352()) || func_350()) || func_349(iLocal_304, &uLocal_331, &uLocal_333, &uLocal_330, &fLocal_332, 6, 1082130432)) || GET_ENTITY_HEALTH(iLocal_304) < 50f) || GET_ENTITY_HEALTH(iLocal_304) < 50f) || (func_42(iLocal_301[0]) && !GET_ENTITY_HEALTH(iLocal_301[0], iLocal_304, 0))) || GET_ENTITY_HEALTH(iLocal_304, 2, 5000)) || GET_ENTITY_HEALTH(iLocal_304, 3, 5000)) || GET_ENTITY_HEALTH(iLocal_304, 0, 5000)) || GET_ENTITY_HEALTH(iLocal_304, 1, 5000))
				{
					if (IS_MOBILE_PHONE_CALL_ONGOING())
					{
						func_207();
					...
					BRING_VEHICLE_TO_HALT(iLocal_304, 20f, 1, 0);
				...
				if (IS_VEHICLE_STOPPED(iLocal_304))
				{
					...
					while (iVar2 < 3)
					{
						if (func_42(iLocal_301[iVar2]))
						{
							...
							if (IS_PED_IN_VEHICLE(iLocal_301[iVar2], iLocal_304, 0))
							{
					...
					{
						if (func_225(PLAYER_PED_ID(), iLocal_299) > (5f + 1f))
						{
							iLocal_298 = func_244(iLocal_299, 1, 1, 5);
					...
					else if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_304, 0))
					{
						iLocal_237 = 1;
						if (IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS"))
						{
		...
		case 3:
			...
			{
				if (iLocal_321 && func_225(PLAYER_PED_ID(), iLocal_299) > fLocal_294)
				{
				...
				else if (func_226(PLAYER_PED_ID(), iLocal_304, 1) < (5f - 1f))
				{
					iLocal_237 = 1;
					func_341();
				}
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_347(iParam3), 0);
}
...
int func_349(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		vVar1 = { func_36(GET_ENTITY_COORDS(iVar0, true) - GET_ENTITY_COORDS(iParam0, true)) };
...
int func_350()
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) && func_49(iLocal_304))
	{
		iVar0 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
		if (func_49(iVar0))
		{
...
int func_352()
{
	...
	{
		iVar0 = 0;
		if (IS_VEHICLE_TYRE_BURST(iLocal_304, 0, 0))
		{
			iVar0++;
		}
		if (IS_VEHICLE_TYRE_BURST(iLocal_304, 1, 0))
		{
			iVar0++;
		}
		if (IS_VEHICLE_TYRE_BURST(iLocal_304, 4, 0))
		{
			iVar0++;
		}
		if (IS_VEHICLE_TYRE_BURST(iLocal_304, 5, 0))
		{
			iVar0++;
		}
		if (iVar0 > 2)
...
void func_355(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_378(iParam1) && IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_359(char* sParam0)
{
	if (!func_360(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_344(sParam0)) || func_344("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_360(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_367() || func_366(Global_4456448.f_190930)) || func_365())
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			if (((_0xE33FFA906CE74880(iVar0, iVar1) || (_0xE33FFA906CE74880(iVar0) == 562680400 && iVar1 != -1)) || (_0xE33FFA906CE74880(iVar0) == 1181327175 && iVar1 != -1)) || (((_0xE33FFA906CE74880(iVar0) == -1693015116 && iVar1 == 0) && func_363(iVar0, 10)) && _0xE33FFA906CE74880(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_361(int iParam0)
{
	if (iParam0 != func_10())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_362(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_373(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_376(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1) || func_374(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_381()
{
	if (iLocal_256 > 0 && GET_GAME_TIMER() > iLocal_256)
	{
		if (func_42(PLAYER_PED_ID()) && func_42(iLocal_299))
		{
			if ((func_225(PLAYER_PED_ID(), iLocal_299) < 50f && !func_27()) && !func_382("MEJ1_02", 0, 0))
			{
				if (iLocal_259)
				{
...
void func_383()
{
	...
	if ((func_42(PLAYER_PED_ID()) && func_42(iLocal_301[0])) && func_49(iLocal_304))
	{
		if (iLocal_254 == -1 && iLocal_255 == -1)
		{
			if (!bLocal_257)
			{
				bLocal_257 = IS_ENTITY_TOUCHING_ENTITY(iLocal_304, IS_ENTITY_TOUCHING_ENTITY());
			}
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_304, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) || bLocal_257)
			{
				func_207();
				func_28();
				if (func_4(&uLocal_67, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					TASK_VEHICLE_MISSION_PED_TARGET(iLocal_301[0], iLocal_304, TASK_VEHICLE_MISSION_PED_TARGET(), 8, 25f, 786468, 100f, 1f, 1);
					_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_234 = 2;
					fLocal_293 = 200f;
					fLocal_294 = 500f;
			...
			else if (func_225(PLAYER_PED_ID(), iLocal_301[0]) < 50f && !PLAYER_PED_ID(iLocal_304))
			{
		...
		else if (((iLocal_254 < 8 && func_225(PLAYER_PED_ID(), iLocal_301[0]) < 50f) && !func_27()) && !func_382("MEJ1_02", 0, 0))
		{
...
void func_385()
{
	...
	if (HAS_ANIM_DICT_LOADED("missfam3"))
	{
		...
		{
			vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_304, 0f, -20f, 0f) };
			if (func_388(PLAYER_PED_ID(), vVar0, 20f))
			{
...
void func_386(int iParam0, int iParam1, int iParam2)
{
	...
	if (DOES_ENTITY_EXIST(iParam0))
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			...
			{
				iVar5 = GET_VEHICLE_PED_IS_IN(iParam0, 0);
				if (func_49(iVar5))
				{
...
void func_392()
{
	...
	switch (iLocal_296)
	{
		...
		case 1:
			if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), vLocal_290, true) < 1400f)
			{
				iLocal_296 = 2;
			}
			break;
		...
		case 2:
			...
			{
				if (func_388(PLAYER_PED_ID(), vLocal_290, 150f) || func_384(&uLocal_67, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_296 = 3;
				}
			}
...
int func_393()
{
	...
	{
		if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_308, vLocal_309, fLocal_316, 0, true, 0) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_310, vLocal_311, fLocal_317, 0, true, 0))
		{
			SET_ENTITY_COORDS(iLocal_304, vLocal_306, 1, false, 0, 1);
			SET_ENTITY_HEADING(iLocal_304, fLocal_307);
			return 1;
		}
		else if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_312, vLocal_313, fLocal_316, 0, true, 0) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_314, vLocal_315, fLocal_317, 0, true, 0))
		{
			SET_ENTITY_COORDS(iLocal_304, vLocal_306, 1, false, 0, 1);
			SET_ENTITY_HEADING(iLocal_304, fLocal_307);
			return 1;
...
void func_394()
{
	...
	if (func_49(iLocal_304))
	{
		...
		while (iVar0 < 3)
		{
			if (!func_42(iLocal_301[iVar0]))
			{
				...
				{
					iLocal_301[iVar0] = CREATE_PED_INSIDE_VEHICLE(iLocal_304, 4, iLocal_303, iLocal_302[iVar0], 1, true);
					...
					SET_ENTITY_VISIBLE(iLocal_301[iVar0], false, 0);
		...
		if (!func_42(iLocal_299))
		{
			if (HAS_MODEL_LOADED(func_52(14)) && HAS_MODEL_LOADED(sLocal_232))
			{
				func_395(&iLocal_299, vLocal_306, fLocal_307, 1);
				SET_ENTITY_VISIBLE(iLocal_299, false, 0);
				...
				SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_299, 1);
				SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_299, 1);
				SET_PED_HELMET(iLocal_299, 0);
				SET_ENTITY_PROOFS(iLocal_299, true, false, false, true, true, false, 0, false);
				SET_PED_CAN_RAGDOLL(iLocal_299, 0);
				SET_PED_RESET_FLAG(iLocal_299, 249, true);
				SET_PED_RESET_FLAG(iLocal_299, 248, true);
				SET_PED_RESET_FLAG(iLocal_299, 124, true);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_299, true);
				SET_PED_DIES_IN_WATER(iLocal_299, 1);
				SET_PED_DIES_IN_SINKING_VEHICLE(iLocal_299, 1);
				func_348(&uLocal_67, 3, iLocal_299, "JIMMY", 1, 1);
				SET_PED_RELATIONSHIP_GROUP_HASH(SET_PED_RELATIONSHIP_GROUP_HASH(), iLocal_300);
				SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_299, iLocal_300);
				SET_ENTITY_COLLISION(iLocal_299, false, 0);
				iLocal_233 = CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
				SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_233, true);
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
				ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_304, sLocal_235));
				TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, sLocal_232, "base", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 0;
			}
		}
	}
	...
	{
		iLocal_304 = CREATE_VEHICLE(iLocal_305, vLocal_306, fLocal_307, true, true, false);
		SET_VEHICLE_COLOURS(iLocal_304, 22, 22);
		SET_VEHICLE_EXTRA_COLOURS(iLocal_304, 0, 8);
		SET_ENTITY_VISIBLE(iLocal_304, false, 0);
		...
		iLocal_266 = 0;
		iLocal_267 = -1;
		_DYNAMIC_MIXER_RELATED_FN(iLocal_304, "M_E_JIMMY_ENEMY_VEHICLE_GROUP", 0);
	}
}
...
void func_400()
{
	...
	if (HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_42(PLAYER_PED_ID()))
		{
			func_348(&uLocal_67, 0, PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		func_348(&uLocal_67, 4, 0, "JIMMY", 0, 1);
		if (func_42(PLAYER_PED_ID()))
		{
			iLocal_300 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
		}
		func_514(1);
		_SET_UNK_MAP_FLAG(2);
		...
		if (func_396())
		{
			...
			switch (iVar3)
			{
				...
				case 3:
					func_401(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 1112014848, 12, 5000, 0, 0);
...
void func_409(bool bParam0)
{
	...
	if (func_42(PLAYER_PED_ID()) && func_42(iLocal_299))
	{
		...
		if (bParam0)
		{
			if ((func_49(iLocal_304) && IS_VEHICLE_SEAT_FREE(iLocal_304, -1, 0)) && IS_VEHICLE_SEAT_FREE(iLocal_304, 0, 0))
			{
				SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), iLocal_304, -1);
				SET_PED_INTO_VEHICLE(iLocal_299, iLocal_304, 0);
				SET_VEHICLE_ENGINE_ON(iLocal_304, true, true, 0);
			}
		}
		else
		{
			...
			if ((func_49(iVar1) && IS_VEHICLE_SEAT_FREE(iVar1, 0, 0)) && func_42(iLocal_299))
			{
...
void func_417()
{
	...
	if (func_42(PLAYER_PED_ID()))
	{
		...
		if (func_49(iVar0))
		{
			SET_VEHICLE_ENGINE_ON(iVar0, true, true, 0);
		}
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
		SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 0, 0);
...
void func_438(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_18(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_442(*iParam1, 0, &uVar0))
		{
...
int func_442(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	bVar1 = false;
	if (func_449(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_447(iParam0)) && !bVar1) && !(func_446(IS_BIG_VEHICLE(iParam0)) && func_444(IS_BIG_VEHICLE())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_443(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_468(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_449(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_215(iParam0, 0, 0)) || func_215(iParam0, 1, 0)) || func_215(iParam0, 2, 0)) || func_262(iParam0) != 145) || func_475(iParam0)) || func_474(iParam0)) || func_443(iParam0)) || func_473(iParam0)) || !func_472(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_474(iParam0))
		{
		}
...
int func_479(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_464(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_482(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_484(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_264(iParam0, iParam1))
				{
...
int func_497(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_498(iParam0, uVar1[iVar3], 1) && func_424(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_288(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_499(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_267(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_267(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_267(iVar1 + 1));
			}
		}
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_267(iVar2 + 1)))
				{
...
void func_515(bool bParam0)
{
	...
	SET_WIDESCREEN_BORDERS(false, 0);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_292 - Vector(10f, 10f, 10f), vLocal_292 + Vector(10f, 10f, 10f), true, 1);
	func_514(0);
