...
void func_2()
{
	...
	{
		if (IS_BIT_SET(Global_2531497.f_2225.f_18, 1))
		{
			func_127(41, 1);
		}
	}
...
int func_20(int iParam0, int iParam1)
{
	...
	while (func_21(&Var7, iParam1, iVar6, 0))
	{
		...
		if (HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iParam1, Var7))
		{
			if (Var7.f_4 == joaat("WAPClip"))
			{
				iVar5 = Var7.f_6;
	...
	if (GET_WEAPON_TINT_COUNT(iParam1) > 0 && GET_WEAPON_TINT_COUNT(iParam0, iParam1) == 0)
	{
		return 0;
	}
	return 1;
...
int func_22(int iParam0, int iParam1)
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_67())
	{
		...
		func_61(&sVar10, Var11, GET_ENTITY_MODEL(GET_ENTITY_MODEL()), 3, 1, func_63(iParam0), func_62(iParam0), -1, 0, 0);
...
void func_57()
{
	...
	if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
	{
		if (func_59(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
int func_67()
{
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_68())
	{
		return 1;
	}
	return 0;
...
bool func_75(int iParam0, int iParam1, int iParam2)
{
	...
	return IS_BIT_SET(iVar0, func_76(iVar1));
}
...
void func_88(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_91(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_89(Var7.f_1)) && iVar9 < 51)
			{
...
float func_92(int iParam0)
{
	if (func_95(iParam0))
	{
		...
		{
			return (func_93(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
int func_114()
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() || Global_76577)
	{
		return 0;
	}
...
int func_119(bool bParam0)
{
	...
	{
		STAT_SET_INT(joaat("num_discipline_gold_earned"), iVar1, 1);
		func_133(17, iVar1);
	}
	if (bParam0)
	{
...
int func_122()
{
	...
	while (iVar0 < 4)
	{
		if (IS_BIT_SET(Global_111560.f_24971.f_1, iVar0))
		{
			return 1;
		}
		iVar0++;
...
int func_123()
{
	...
	while (iVar0 < 5)
	{
		if (IS_BIT_SET(Global_111560.f_24974.f_2, iVar0))
		{
			return 1;
		}
		iVar0++;
...
int func_145(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return !IS_BIT_SET(Global_89487[iParam0 /*34*/].f_15, 5);
			break;
...
void func_149()
{
	...
	if (IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), "creatures@shark@move", "attack_player", 3))
	{
		func_127(25, 1);
		return;
	}
	if (IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
	{
		iVar0 = GET_PED_SOURCE_OF_DEATH(GET_PED_SOURCE_OF_DEATH());
...
void func_151()
{
	switch (iLocal_55)
	{
		case 0:
			...
			if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) >= 3 && GET_PLAYER_WANTED_LEVEL() == 0)
			{
				if (func_156() == 2)
				{
					func_162(&iLocal_58);
		...
		case 1:
			if (func_155() || IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				return;
			}
...
void func_152(int iParam0)
{
	if (func_95(iParam0))
	{
		if (!func_94(iParam0))
		{
			iParam0->f_2 = (func_93(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
			SET_BIT(iParam0, 2);
		}
	}
}
...
int func_156()
{
	...
	iVar0 = 0;
	iVar1 = func_158(2);
	if (func_157(iVar1, 0) || IS_BIT_SET(Global_94550, 2))
	{
		iVar0++;
	}
	iVar1 = func_158(1);
	if (func_157(iVar1, 0) || IS_BIT_SET(Global_94550, 1))
	{
		iVar0++;
	}
	iVar1 = func_158(0);
	if (func_157(iVar1, 0) || IS_BIT_SET(Global_94550, 0))
	{
		iVar0++;
	}
	return iVar0;
...
{
	iParam0->f_1 = (func_93(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
