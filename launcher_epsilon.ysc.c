...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			func_392();
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 237.926f, 360.2992f, 103.6515f, 244.6899f, 357.8277f, 107.3224f, 4.75f, 0, true, 0))
			{
		...
		else if (Var0 == 11)
		{
			...
			{
				if (!IS_PED_FLEEING(Var0.f_28[0]) && !IS_PED_FLEEING(Var0.f_28[0]))
				{
				...
				if (func_371(Var0.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (HAS_ANIM_DICT_LOADED("rcmepsilonism3"))
					{
						...
						TASK_PLAY_ANIM(0, "rcmepsilonism3", "outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
					...
					{
						TASK_SMART_FLEE_PED(Var0.f_28[0], TASK_SMART_FLEE_PED(), 200f, -1, 0, 0);
					}
		...
		else if (Var0 == 12)
		{
			...
			func_370();
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
			{
				if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					if (!func_369(PLAYER_PED_ID(), 713668775))
					{
						SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 256);
						TASK_FOLLOW_NAV_MESH_TO_COORD(TASK_FOLLOW_NAV_MESH_TO_COORD(), 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
					}
				}
			}
			func_368();
...
void func_133(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_137(IS_PED_INJURED())) && !func_135(IS_PED_INJURED(), 0)) && !func_134()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_137(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_144()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_145(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_166(vector3 vParam0, bool bParam1)
{
	...
	SET_BLIP_SCALE(iVar0, func_167(SET_BLIP_SCALE(), 1f, 1f));
...
void func_178(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_180() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_180() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_179(iParam0));
...
bool func_184(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_180() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_218(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_218(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_218(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_250(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_218(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_218(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_218(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
int func_209(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_218(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_218(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_228(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_229(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_218(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_235(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_218(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_230(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_230(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_230(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_230(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_264(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_258(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_258(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_218(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_322(var uParam0, int iParam1)
{
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					...
					{
						if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_328(2))
							{
		...
		case 2:
			...
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_35[0], 0))
				{
					if (func_328(3))
					{
						func_325(uParam0->f_27, *uParam0);
		...
		case 1:
			if (DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				{
					if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(uParam0->f_35[0], true), true) < uParam0->f_15)
					{
						if (func_328(2))
						{
							if (func_326(uParam0->f_27))
		...
		case 3:
			if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), uParam0->f_17[0 /*3*/], true) < uParam0->f_15)
			{
				if (func_328(2))
				{
					if (func_326(uParam0->f_27))
		...
		case 4:
			if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], false, true, 0))
			{
				if (func_328(2))
				{
					if (func_326(uParam0->f_27))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					if (func_391(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0)))
					{
						...
						{
							if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(), 0), uParam0->f_35[0]))
							{
								if (func_328(3))
								{
									return 1;
						...
						{
							if (DOES_CARGOBOB_HAVE_PICK_UP_ROPE(DOES_CARGOBOB_HAVE_PICK_UP_ROPE(DOES_CARGOBOB_HAVE_PICK_UP_ROPE(), 0)) && DOES_CARGOBOB_HAVE_PICK_UP_ROPE(DOES_CARGOBOB_HAVE_PICK_UP_ROPE(DOES_CARGOBOB_HAVE_PICK_UP_ROPE(), 0), uParam0->f_35[0]))
							{
								if (func_328(3))
								{
									return 1;
			...
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), uParam0->f_17[0 /*3*/], uParam0->f_17[1 /*3*/], uParam0->f_24, 0, true, 0))
			{
				if (*uParam0 == 45)
				{
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_336()) || Global_110607) || Global_30738) || func_335()) || func_334(8, -1)) || func_93()) || func_333()) || func_332()) || func_331()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_336()) || Global_30738) || func_335()) || func_334(8, -1)) || func_332()) || func_93()) || func_333()) || func_331()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_336()) || Global_110607) || Global_30738) || func_335()) || func_334(8, -1)) || func_93()) || func_333()) || func_331()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_336() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_334(8, -1)) || func_331()) || func_330()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_336()) || Global_30738) || func_335()) || func_334(8, -1)) || func_333()) || func_332()) || func_331()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_336()) || func_333()) || Global_110607) || Global_30738) || func_335()) || Global_42561) || func_334(8, -1)) || func_332()) || func_330()) || func_331()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_336()) || Global_110607) || Global_30738) || func_335()) || func_334(8, -1)) || func_332()) || func_330()) || func_93()) || func_333()) || func_331())
						{
							return 0;
						}
						break;
...
void func_337(var uParam0, int iParam1)
{
	if (!*iParam1)
	{
		if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), uParam0->f_17[0 /*3*/], true) > 25f)
				{
...
void func_338(int iParam0, char* sParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_342(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_341(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_342(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_344(iParam0);
				}
			}
...
void func_347()
{
	switch (iLocal_57)
	{
		...
		case 1:
			if (func_342(PLAYER_PED_ID(), -726.45f, 33.33f, 43.23f, 1) < 9f)
			{
			...
			if (func_342(PLAYER_PED_ID(), -666.55f, 49.19f, 42.08f, 1) < 9f)
			{
	...
	if (func_391(iParam0->f_28[0]))
	{
		switch (iLocal_232)
		{
			case 0:
				...
				{
					TASK_PLAY_ANIM(iParam0->f_28[0], "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_232 = 1;
			...
			case 1:
				...
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0->f_28[0], vLocal_234[iLocal_233 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
			...
			case 4:
				if (IS_ENTITY_PLAYING_ANIM(iParam0->f_28[0], "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0->f_28[0], "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						...
						TASK_PLAY_ANIM(iParam0->f_28[0], "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						_0x2208438012482A1A(iParam0->f_28[0], 0, 0);
						iLocal_232 = 1;
...
int func_364(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_328(2))
	{
		if (!func_363())
		{
			if (((func_391(PLAYER_PED_ID()) && func_391(uParam0->f_28[0])) && (PLAYER_PED_ID() - uParam0->f_60) > iParam6) && func_342(PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_365(sParam3))
		{
			if (func_391(PLAYER_PED_ID()))
			{
				if (func_342(PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_362();
				}
			}
...
void func_368()
{
	switch (iLocal_57)
	{
		...
		case 1:
			if (func_342(PLAYER_PED_ID(), 1826.45f, 4699.58f, 38.15f, 1) <= 25f && iLocal_224 == 0)
			{
		...
		case 2:
			...
			else if (func_342(PLAYER_PED_ID(), 1826.45f, 4699.58f, 38.15f, 1) >= 28f)
			{
				func_362();
				iLocal_57 = 0;
			}
...
void func_370()
{
	...
	{
		PLAY_SOUND_FROM_COORD(iLocal_231, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", false, 0, 0);
...
int func_371(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_391(PLAYER_PED_ID()) && func_391(iParam0))
	{
		...
		if (!IS_PED_ARMED(IS_PED_ARMED(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT()))
			{
				...
				{
					return func_384(PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_372(int iParam0, float fParam1)
{
	...
	if (func_391(PLAYER_PED_ID()) && func_391(iParam0))
	{
		if (func_383(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 6))
			{
				fVar0 = 40f;
...
{
	return func_374(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_378(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_380(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_380(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_388(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_380(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_390(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_391(PLAYER_PED_ID()) && func_391(uParam0->f_28[0])) && !func_363()) && (PLAYER_PED_ID() - uParam0->f_60) > iParam6) && func_342(PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_432(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
		func_367(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_392()
{
	...
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 244.9669f, 374.6696f, 104.4579f, 239.6119f, 360.3045f, 107.7523f, 9.0625f, 0, true, 0))
	{
		Global_7361 = 1;
	}
	else
...
int func_398(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_399(GET_ENTITY_MODEL(GET_ENTITY_MODEL(), 1)));
				switch (iVar0)
				{
...
void func_400(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_401(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[26 /*34*/].f_6) == 0)
			{
				Global_111560.f_7256[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_111560.f_7256[iParam0], true, true);
			}
...
void func_409()
{
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_54, 1862763509);
	if (func_342(PLAYER_PED_ID(), -726.45f, 33.33f, 43.23f, 1) <= func_342(PLAYER_PED_ID(), -666.55f, 49.19f, 42.08f, 1))
	{
	...
	if (func_391(PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= (iParam0->f_28 - 1))
		{
			if (func_126(iParam0->f_28[iVar0]))
			{
				...
				TASK_COMBAT_PED(iParam0->f_28[iVar0], TASK_COMBAT_PED(), 0, 16);
...
void func_412(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_391(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_414(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_413(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_414(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_413(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_419(PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
void func_431()
{
	iLocal_228 = 0x67D02A194A2FC2BD("digiscanner");
	...
	LINK_NAMED_RENDERTARGET(LINK_NAMED_RENDERTARGET(joaat("weapon_digiscanner")));
	if (IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
...
int func_444(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_442(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (func_391(uParam0->f_28[0]) && func_126(PLAYER_PED_ID()))
			{
...
int func_445(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				if (func_446(&(uParam0->f_28[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_126(PLAYER_PED_ID()))
				{
...
int func_453(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar4 = true;
			CLEAR_AREA_OF_PEDS(vVar2, 35f, 0);
			if (!DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_446(&(uParam0->f_28[0]), 60, vVar2, fVar3, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					if (DOES_ENTITY_EXIST(uParam0->f_28[0]) && func_126(DOES_ENTITY_EXIST()))
					{
						iVar5 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
