...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (bLocal_73)
		{
			if (!func_10(PLAYER_PED_ID(), vLocal_72[0 /*3*/], (290f + 50f)))
			{
				if (!func_10(PLAYER_PED_ID(), vLocal_72[1 /*3*/], (290f + 50f)))
				{
					func_12();
				}
			}
			if (iLocal_71 != 0)
			{
				if (!func_10(PLAYER_PED_ID(), vLocal_72[0 /*3*/], (fLocal_78 + 50f)))
				{
					if (!func_10(PLAYER_PED_ID(), vLocal_72[1 /*3*/], (fLocal_78 + 50f)))
					{
		...
		switch (iLocal_71)
		{
			case 0:
				...
				{
					if (func_10(PLAYER_PED_ID(), vLocal_72[iVar0 /*3*/], fLocal_78))
					{
						iLocal_70 = iVar0;
						iLocal_71 = 1;
			...
			case 1:
				...
				while (iVar0 < vLocal_72.x)
				{
					if (func_10(PLAYER_PED_ID(), vLocal_72[iVar0 /*3*/], fLocal_75))
					{
						iLocal_70 = iVar0;
						iLocal_71 = 2;
					}
			...
			case 3:
				if (func_10(PLAYER_PED_ID(), vLocal_72[iLocal_70 /*3*/], fLocal_75))
				{
					...
					if (iLocal_69 >= iLocal_79)
					{
						...
						if (iLocal_70 == 0)
						{
							PLAY_SOUND_FROM_COORD(iLocal_80, "SPECIAL_EVIL_UFO_DEATH_RAY", vLocal_72[iLocal_70 /*3*/], 0, false, 0, 0);
						}
						else
						{
							PLAY_SOUND_FROM_COORD(iLocal_80, "SPECIAL_EVIL_UFO_DEATH_RAY_3", vLocal_72[iLocal_70 /*3*/], 0, false, 0, 0);
						}
						func_7();
						func_6();
					}
			...
			case 4:
				...
				if (!func_10(PLAYER_PED_ID(), vLocal_72[iLocal_70 /*3*/], fLocal_78))
				{
					func_1();
					iLocal_70 = -1;
					iLocal_71 = 0;
...
void func_1()
{
	...
	if (func_11(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			if (func_2(iVar0))
			{
				SET_VEHICLE_ENGINE_ON(iVar0, true, false, 0);
			}
		}
	}
}
...
void func_5()
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		if (func_2(iVar0))
		{
			SET_VEHICLE_ENGINE_ON(iVar0, false, false, 0);
			APPLY_FORCE_TO_ENTITY(iVar0, 2, 0f, 0f, -fLocal_74, 0f, 1f, 0f, 0, 0, 1, 1, 0, 1);
		}
	}
}
	...
	if (bLocal_92)
	{
		if (GET_GAME_TIMER() > iLocal_87)
		{
			...
			else
			{
				...
				PLAY_SOUND(iLocal_89, "ent_amb_elec_crackle", 0, 0, 0, 1);
	...
	if (bLocal_91)
	{
		if (GET_GAME_TIMER() > iLocal_88)
		{
			...
			else
			{
				...
				PLAY_SOUND(iLocal_90, "spl_stun_npc_master", 0, 0, 0, 1);
...
void func_8()
{
	...
	if (!func_10(PLAYER_PED_ID(), vLocal_72[iLocal_70 /*3*/], fLocal_76))
	{
		return;
	}
	vVar0 = { func_9(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) - vLocal_72[iLocal_70 /*3*/]) * Vector(fLocal_77, fLocal_77, fLocal_77) };
	APPLY_FORCE_TO_ENTITY(APPLY_FORCE_TO_ENTITY(), 2, vVar0, 0f, 0f, 0f, 0, 0, 1, 1, 0, 1);
}
