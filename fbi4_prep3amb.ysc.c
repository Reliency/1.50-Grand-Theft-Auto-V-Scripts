...
void func_175()
{
	if ((IS_BIT_SET(iLocal_49, 0) && Global_41396 == 15) && !func_207())
	{
		if (iLocal_38 == 0)
		{
			if (!IS_BIT_SET(iLocal_49, 1))
			{
				if (!func_76(PLAYER_PED_ID(), vLocal_50, 5f))
				{
					...
					{
						if ((func_249(PLAYER_PED_ID()) && !PLAYER_PED_ID(uLocal_47[0], 17)) && !PLAYER_PED_ID(uLocal_47[1], 18))
						{
...
int func_184()
{
	...
	while (iVar1 <= 4)
	{
		if (func_249(uVar0[iVar1]) && uVar0[iVar1] != PLAYER_PED_ID())
		{
...
int func_205()
{
	if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 855.7258f, -2344.491f, 29.33145f) <= 52900f)
	{
		if (func_13())
		{
			func_69(28);
	...
	else if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_13())
		{
			func_69(29);
...
int func_220(var uParam0)
{
	...
	if (func_249(PLAYER_PED_ID()) && PLAYER_PED_ID(PLAYER_PED_ID(), 0))
	{
		iVar0 = GET_PLAYERS_LAST_VEHICLE();
		if (func_85(iVar0))
		{
...
void func_222()
{
	...
	if (((((((Global_41396 == 15 && iLocal_37 != 3) && IS_BIT_SET(iLocal_49, 5)) && !func_207()) && Global_76574 == -1) && !func_232()) && !func_84(9)) || func_103(35))
	{
		func_231();
		func_229();
		switch (iLocal_39)
...
void func_223(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_226(func_89())) && !func_225())
			{
...
int func_245(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_96() == 0)
		{
			return IS_BIT_SET(func_246(func_248(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
