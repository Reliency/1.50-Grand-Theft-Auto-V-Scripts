...
void __EntryFunction__()
{
	...
	{
		iLocal_262 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
	}
...
void func_1()
{
	switch (iLocal_83)
	{
		case 0:
			...
			if (HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && HAS_ANIM_DICT_LOADED(joaat("p_amb_phone_01")))
			{
				if (!DOES_ENTITY_EXIST(iLocal_85))
				{
					...
					{
						SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, false, 0f, 0);
					}
					iLocal_85 = GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
				}
				iLocal_83 = 1;
			}
			break;
		...
		case 1:
			...
			if (!iLocal_94)
			{
				if (func_294(Local_81.f_28[0]) && DOES_ENTITY_EXIST(iLocal_85))
				{
					iLocal_87 = CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
					TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
					FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
					_0x2208438012482A1A(Local_81.f_28[0], 1, 0);
			...
			else if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_87))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_87) > 0.29f)
				{
					if (!iLocal_95)
					{
						func_231(&uLocal_97, 2, PLAYER_PED_ID(), "Trevor", 0, 1);
				...
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
					...
					if (DOES_ENTITY_EXIST(iLocal_85))
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, -8f, 1);
					}
					iLocal_96 = 1;
				}
				if (func_215(Local_81.f_28[0], PLAYER_PED_ID(), 1) > 17.5f)
				{
					if (func_293(Local_81.f_28[0]))
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(Local_81.f_28[0], -8f, 1);
						CLEAR_PED_TASKS(Local_81.f_28[0]);
					}
					if (DOES_ENTITY_EXIST(iLocal_85))
					{
				...
				if ((IS_PED_INJURED(Local_81.f_28[0]) || IS_PED_INJURED(Local_81.f_28[0])) || IS_PED_INJURED(-1, IS_PED_INJURED(Local_81.f_28[0], true), 5f))
				{
					if (func_293(Local_81.f_28[0]))
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(Local_81.f_28[0], -8f, 1);
		...
		case 2:
			...
			if (func_293(Local_81.f_28[0]))
			{
				if (iLocal_96 == 1)
				{
					...
					TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (iLocal_96 == 0)
				{
					FORCE_PED_MOTION_STATE(Local_81.f_28[0], -668482597, false, 0, 1);
				}
			}
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
			...
			if (iLocal_96 == 0)
			{
				_SET_DOOR_AJAR_ANGLE(904342475, 0f, true, true);
...
void func_235(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_239(IS_PED_INJURED())) && !func_237(IS_PED_INJURED(), 0)) && !func_236()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_239(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_244()
{
	...
	if (_0xB56BBBCC2955D9CB())
	{
		...
		if (func_293(Local_81.f_28[0]))
		{
			_0x2A56C06EBEF2B0D9("Josh", Local_81.f_28[0], 0);
		}
	}
	switch (iLocal_83)
	{
		case 0:
			if (func_260(1, 1093140480, 0))
			{
				...
				SET_ROADS_IN_ANGLED_AREA(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, false, 1);
				CLEAR_AREA_OF_VEHICLES(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, false, 0);
				CLEAR_AREA_OF_VEHICLES(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, false, 0);
				CLEAR_AREA_OF_VEHICLES(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, false, 0);
				CLEAR_AREA_OF_VEHICLES(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, false, 0);
				CLEAR_AREA_OF_VEHICLES(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, false, 0);
				CLEAR_ANGLED_AREA_OF_VEHICLES(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 0, 0, 0, 0);
				iVar0 = GET_PLAYERS_LAST_VEHICLE();
				if (func_259(iVar0))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, true, 0))
					{
				...
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
				{
					...
					SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, true, 90f, 0);
				}
		...
		case 1:
			...
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					func_245(PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					if (func_294(Local_81.f_28[0]) && DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						FORCE_PED_MOTION_STATE(Local_81.f_28[0], -1871534317, false, 1, 1);
						iLocal_94 = 1;
					}
				}
			}
			...
			if (WAS_CUTSCENE_SKIPPED())
			{
				...
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
				{
					...
					SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, true, 0f, 0);
				}
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0))
				{
					...
					SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_r"), -1101.62f, 290.36f, 64.76f, true, 0f, 0);
				}
			}
			if (!IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_94)
				{
					...
					if (func_294(Local_81.f_28[0]) && DOES_ENTITY_EXIST(iLocal_85))
					{
						...
						FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						_0x2208438012482A1A(Local_81.f_28[0], 0, 0);
						iLocal_94 = 1;
					}
				}
				iLocal_83 = 2;
...
void func_246(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_247(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_266(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_265(PLAYER_PED_ID(), -828834893))
				{
...
void func_268()
{
	...
	{
		case 0:
			if (!func_5(0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
			{
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_90)
				{
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_294(Local_81.f_28[0]) && DOES_ENTITY_EXIST(iLocal_85))
						{
							iLocal_86 = CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
							TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_86, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
							TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_81.f_28[0], -1, 0, 2);
							TASK_LOOK_AT_ENTITY(Local_81.f_28[0], TASK_LOOK_AT_ENTITY(), 4000, 2060, 2);
				...
				else if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_86))
				{
					...
					if (func_215(PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 2.5f)
					{
...
void func_270()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_266(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_290(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_275(0)) || func_289(1))
			{
			}
			else
			{
