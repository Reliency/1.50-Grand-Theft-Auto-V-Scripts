...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_85.f_1 = _0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
				NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_85.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
				NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_85.f_1);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iVar7))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(iVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_85.f_1 = _0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
					NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_85.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_85.f_1);
					func_25(&(uParam0->f_85), 8);
		...
		case 8:
			iVar8 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_85.f_4 == 6)
	{
		...
		fVar1 = vmag(vVar0);
		if ((uParam0->f_85.f_4 == 6 && !HAS_ANIM_EVENT_FIRED(HAS_ANIM_EVENT_FIRED(), -1322051853)) && !func_8(&(uParam0->f_85), 12))
		{
			if (fVar1 >= 0.35f)
			{
				func_23(uParam0);
...
void func_24(var uParam0)
{
	...
	uParam0->f_85.f_1 = _0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
	func_41(uParam0, &sVar0);
	NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_85.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_85.f_1);
	func_9(&(uParam0->f_85.f_5));
	func_52(uParam0, 8);
}
...
int func_47(var uParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(NETWORK_IS_PARTICIPANT_ACTIVE(iVar0)))
		{
			...
			if ((iVar1 != PLAYER_ID() && func_48(iVar1, 1, 1)) && func_50(PLAYER_ID(iVar1), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_85), 1, IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0));
	func_57(&(uParam0->f_85), 3, IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1));
	func_57(&(uParam0->f_85), 0, func_36(0));
	func_57(&(uParam0->f_85), 2, IS_PED_RUNNING(IS_PED_RUNNING()));
}
...
{
	return IS_ENTITY_IN_ANGLED_AREA(iParam0, 416.2457f, 4826.312f, -59.9997f, 376.9388f, 4827.659f, -56.95424f, 15f, 0, true, 0);
}
...
int func_73()
{
	if (Global_1590291 != func_60())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
