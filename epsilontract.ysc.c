...
void func_1()
{
	...
	if ((func_47(PLAYER_PED_ID()) && !func_46(14)) && !PLAYER_PED_ID())
	{
		if (iLocal_41 < 10)
		{
			if (iLocal_41 == 0)
			{
				if (!func_45(36) && (GET_GAME_TIMER() - iLocal_42) > iLocal_43)
				{
			...
			{
				if (HAS_PICKUP_BEEN_COLLECTED(Local_49[iLocal_41 /*11*/].f_1) || func_42(Local_49[iLocal_41 /*11*/].f_1))
				{
...
int func_4(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_111560.f_10044.f_108, func_10(func_11(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_17(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_18(_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_19(iParam1)), 0));
		}
		else
		{
			func_18(_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_19(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
...
void func_34(var uParam0, var uParam1)
{
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(*uParam0), true) >= 60f)
		{
			func_41(uParam0);
			*uParam0 = 0;
			*uParam1 = 0;
...
{
	if (func_36(PLAYER_PED_ID(), vParam0, 7f))
	{
		TASK_LOOK_AT_COORD(TASK_LOOK_AT_COORD(), vParam0, 100, 2048, 1);
	}
}
