...
void __EntryFunction__()
{
	...
	fLocal_707 = 0f;
	iLocal_715 = -1;
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH("appImportExport")) > 1)
	{
		func_400(1, 0);
	}
	iLocal_700 = 0x67D02A194A2FC2BD("IMPORT_EXPORT_WAREHOUSE");
	func_397(1);
	func_395(1);
	func_394();
	THEFEED_PAUSE();
	while (!HAS_SCALEFORM_MOVIE_LOADED(iLocal_700))
	{
		wait(0);
	}
	Global_75389 = 1;
	...
	{
		uLocal_694 = func_392(PLAYER_ID());
	}
	Global_1676849 = 0;
	func_380(PLAYER_ID(), 0, 0, 0);
	func_379();
	func_372();
	if (IS_PC_VERSION())
	{
	...
	if (func_369())
	{
		SET_BIT(&iLocal_693, 1);
	}
	if (func_368())
	{
		SET_BIT(&iLocal_693, 3);
	}
	func_365();
	...
	while (Global_75389)
	{
		...
		else if (!func_393(PLAYER_ID()) && !func_364())
		{
		...
		switch (iLocal_717)
		{
			case 0:
				func_351();
				if (!IS_BIT_SET(iLocal_693, 3))
				{
					func_346();
					func_323();
				}
				if (!IS_BIT_SET(iLocal_693, 1))
				{
					func_315();
				}
				if (!iLocal_689)
				...
				else if (func_250(PLAYER_ID()) && PLAYER_ID(PLAYER_ID()))
				{
					iLocal_717 = 1;
					if (IS_PC_VERSION())
					{
...
int func_1(int iParam0)
{
	if (iParam0 != func_3())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_2(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
void func_4()
{
	...
	bVar2 = func_242();
	CLEAR_BIT(&(Global_1676879.f_4), 5);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (bVar2)
	...
	if (func_68(iLocal_698, func_80(bVar2), bVar2))
	{
		...
		if (Global_73891)
		{
			...
			while (iVar0 < 4)
			{
				Global_1628955[PLAYER_ID() /*614*/].f_11.f_354[iVar0] = -1;
				iVar0++;
			}
		}
		else
...
void func_12(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		if (iVar1 != 0)
		{
			...
			func_27(iVar1);
			func_17(iVar1);
			iVar2 = (Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_1 - 1);
			if (iVar2 >= 0)
			{
				func_16(iVar2);
			}
...
void func_16(int iParam0)
{
	...
	{
		Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_1 = iParam0;
	}
}
...
void func_18()
{
	...
	while (iVar1 < 40)
	{
		...
		{
			if (!IS_BIT_SET(iVar3[(iVar2[iVar1] / 32)], (iVar2[iVar1] % 32)))
			{
...
void func_27(int iParam0)
{
	...
	while (iVar0 < 40)
	{
		if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_2[iVar0] == iParam0 || Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_2[iVar0] == (1000 + iParam0))
		{
			Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_2[iVar0] = 0;
		}
		else
		{
			iVar0++;
...
{
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_186[0] = uParam0;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_186[1] = uParam1;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_186[2] = uParam2;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_186[3] = uParam3;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_186.f_5 = uParam4;
}
...
int func_68(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1628955[PLAYER_ID() /*614*/].f_11.f_354[iVar0] = func_76(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		if (bVar2)
		{
			if (iVar4 >= 1)
			{
				...
				while (iVar0 < iParam1)
				{
					Global_1628955[PLAYER_ID() /*614*/].f_11.f_354[iVar0] = uVar7;
					iVar0++;
				}
				bVar3 = true;
			}
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1628955[PLAYER_ID() /*614*/].f_11.f_354[iVar0] = func_69(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam1 > 0)
	{
		...
		while (iVar7 < iParam1)
		{
			...
			if (fVar11 >= fVar0 && fVar12 >= fVar1)
			{
				...
				if (!IS_BIT_SET((*uParam2)[iVar8], iVar9))
				{
...
{
	return func_79(PLAYER_ID(), bParam0);
}
...
void func_81(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		if (iParam0 != func_3())
		{
			if (!IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_195, 19))
			{
				SET_BIT(&(Global_2424073[iParam0 /*421*/].f_195), 19);
			}
		}
	}
	else if (iParam0 != func_3())
	{
		if (IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_195, 19))
		{
			CLEAR_BIT(&(Global_2424073[iParam0 /*421*/].f_195), 19);
		}
	}
}
...
int func_82(bool bParam0, bool bParam1)
{
	...
	if (!func_241(PLAYER_ID(), 188, 0))
	{
		iLocal_691 = func_91(PLAYER_ID(), 188, 0);
		if (iLocal_691 == 16)
		{
			iLocal_691 = 19;
		}
	...
	if (bParam1)
	{
		...
		while (iVar0 < 4)
		{
			...
			if (iVar1 != func_3())
			{
				if (((!NETWORK_IS_PLAYER_CONNECTED(iVar1) || !func_2(iVar1, 1, 1)) || !func_393(iVar1)) || func_83(iVar1))
				{
...
int func_86()
{
	...
	while (iVar0 < 7)
	{
		if (Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0] != func_3())
		{
			if ((func_393(Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0]) && func_2(Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0], 1, 1)) && !func_83(Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0]))
			{
				iVar1++;
			}
		}
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_158(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		
		case 233:
			return func_151(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		...
		case 243:
			return func_135(iParam1, iParam2, INT_TO_PLAYERINDEX(iParam5), iParam4);
		
		case 158:
			return func_131(iParam1, iParam2, INT_TO_PLAYERINDEX(iParam5), iParam4);
...
int func_179(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_201(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
		
		case 233:
			return func_195(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_186(iParam1, iParam3, INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_180(iParam1, iParam3, INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
...
bool func_242()
{
	return Global_1628955[PLAYER_ID() /*614*/].f_11.f_353 != 2000;
}
...
bool func_244(int iParam0)
{
	...
	return IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_195, 19);
}
...
bool func_250(int iParam0)
{
	...
	return IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_195, 18);
}
...
void func_251()
{
	...
	if (iLocal_703 == 2000000)
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "GET_CURRENT_SELECTION");
			iLocal_701 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "GET_CURRENT_TAB_ID");
			iLocal_702 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			iLocal_703 = 1000000;
		}
	}
	if (iLocal_703 == 1000000 && (_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_701) && _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_702)))
	{
		iLocal_692 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_702);
		iVar0 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_701);
		bVar1 = true;
		bVar2 = true;
		iLocal_703 = iVar0;
		if (func_309(iVar0))
		...
		else if (func_300(iVar0))
		{
			...
			{
				func_296(1, 0);
				_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(iLocal_699), -1082130432, -1082130432, -1082130432, -1082130432);
				iLocal_699 = iVar3;
				func_292(iVar3);
			}
			else
		...
		if (bVar1)
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(iVar0), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (bVar2)
		{
			func_291(iLocal_692);
		...
		if (*iParam0 == 101)
		{
			if (iLocal_690)
			{
				...
				else
				{
					Var1 = { func_274(bVar0) };
					func_276();
					_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
...
int func_255(int iParam0, bool bParam1)
{
	...
	iVar0 = ceil((IntToFloat(func_260(iParam0)) * Global_262145.f_18935));
	iVar1 = 0;
	if (!bParam1)
	{
...
{
	return ceil((IntToFloat(iParam0) * Global_262145.f_18933));
}
...
int func_258(int iParam0, bool bParam1)
{
	...
	iVar0 = ceil((IntToFloat(func_260(iParam0)) * Global_262145.f_18934));
	iVar1 = 0;
	if (!bParam1)
	{
...
{
	return ceil((IntToFloat(iParam0) * Global_262145.f_18932));
}
	...
	if (bVar0 || iParam3 == 1)
	{
		...
		switch (iParam1)
		{
			...
			case 562680400:
				...
				if (!bParam2)
				{
					iVar1 = round((to_float(iVar1) * ((100f + to_float(Global_262145.f_20876)) / 100f)));
				}
				break;
...
int func_267(int iParam0)
{
	...
	if ((((((((((((((IS_THIS_MODEL_A_BOAT(iParam0) || IS_THIS_MODEL_A_BOAT(iParam0)) || IS_THIS_MODEL_A_BOAT(iParam0)) || IS_THIS_MODEL_A_BOAT(iParam0)) || IS_THIS_MODEL_A_BOAT(iParam0)) || IS_THIS_MODEL_A_BOAT(iParam0)) || IS_THIS_MODEL_A_BOAT(iParam0)) || iVar0 == 2) || iVar0 == 12) || iVar0 == 18) || iVar0 == 19) || iVar0 == 11) || iVar0 == 20) || iVar0 == 10) || iVar0 == 17)
	{
		return 0;
	}
	return 1;
...
int func_269(int iParam0)
{
	...
	if (iVar0 > 0 && !NETWORK_CAN_SPEND_MONEY(iVar0, false, true, 0, -1, 0))
	{
		return 0;
	}
	return 1;
...
void func_272()
{
	...
	bVar7 = true;
	bVar8 = true;
	if ((iVar3 > 0 && !NETWORK_CAN_SPEND_MONEY(iVar3, false, true, 0, -1, 0)) || func_271(0))
	{
		bVar6 = false;
	}
	if ((iVar4 > 0 && !NETWORK_CAN_SPEND_MONEY(iVar4, false, true, 0, -1, 0)) || func_271(1))
	{
		bVar7 = false;
	}
	if ((iVar5 > 0 && !NETWORK_CAN_SPEND_MONEY(iVar5, false, true, 0, -1, 0)) || func_271(2))
	{
		bVar8 = false;
	}
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "SHOW_BUYERS");
	...
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar6);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar7);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar8);
...
void func_273()
{
	...
	while (iVar0 >= 0)
	{
		if (iLocal_695[iVar0] != 0)
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(iLocal_695[iVar0]), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_695[iVar0] = 0;
		}
		else
		{
...
void func_276()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "HIDE_OVERLAY");
	END_SCALEFORM_MOVIE_METHOD();
	iLocal_716 = 0;
	if (iLocal_690)
	{
...
void func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, bool bParam9)
{
	...
	if (!iVar1 == 0)
	{
		TRIGGER_SCRIPT_EVENT(1, &Var0, 14, iVar1);
	}
}
...
void func_281(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_2424073[IS_BIT_SET() /*421*/].f_196, 6))
		{
			SET_BIT(&(Global_2424073[SET_BIT() /*421*/].f_196), 6);
		}
	}
	else if (IS_BIT_SET(Global_2424073[IS_BIT_SET() /*421*/].f_196, 6))
	{
		CLEAR_BIT(&(Global_2424073[CLEAR_BIT() /*421*/].f_196), 6);
	}
}
...
void func_282()
{
	...
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_353 = 2000;
}
...
void func_283(int iParam0)
{
	if (func_299(iParam0))
	{
		Global_1628955[PLAYER_ID() /*614*/].f_11.f_353 = iParam0;
	}
}
...
void func_284(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_2424073[IS_BIT_SET() /*421*/].f_195, 18))
		{
			SET_BIT(&(Global_2424073[SET_BIT() /*421*/].f_195), 18);
		}
	}
	else if (IS_BIT_SET(Global_2424073[IS_BIT_SET() /*421*/].f_195, 18))
	{
		CLEAR_BIT(&(Global_2424073[CLEAR_BIT() /*421*/].f_195), 18);
	}
}
...
void func_288(var uParam0)
{
	...
	while (iVar0 < iVar2)
	{
		if ((((Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0] != func_3() && func_2(Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0], 1, 1)) && !func_289(Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0])) && func_393(Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0])) && !func_83(Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0]))
		{
			(*uParam0)[iVar1] = Global_1628955[PLAYER_ID() /*614*/].f_11.f_11[iVar0];
			iVar1++;
		}
		else
		{
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "SHOW_OVERLAY");
	func_306(sParam0);
...
char* func_307()
{
	if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_1 > 1)
	{
		return "AH_COOLDOWN2";
	}
	return "AH_COOLDOWN";
...
void func_310()
{
	...
	if (IS_CONTROL_JUST_PRESSED(2, 205))
	{
		...
		{
			func_291(0);
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	...
	if (IS_CONTROL_JUST_PRESSED(2, 206))
	{
		...
		{
			func_291(1);
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	ENABLE_CONTROL_ACTION(2, 207, 1);
	if (IS_CONTROL_PRESSED(2, 207))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(207), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (IS_CONTROL_JUST_RELEASED(2, 207))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_RELEASE_EVENT", to_float(207), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 208, 1);
	if (IS_CONTROL_PRESSED(2, 208))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(208), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (IS_CONTROL_JUST_RELEASED(2, 208))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_RELEASE_EVENT", to_float(208), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_314();
	ENABLE_CONTROL_ACTION(2, 201, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 201))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_RELEASE_EVENT", to_float(237), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 238))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_RELEASE_EVENT", to_float(238), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_311(0, 1);
	}
	else
...
void func_311(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "SET_ANALOG_STICK_INPUT");
			iLocal_708 = iVar0;
			iLocal_709 = iVar1;
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_708);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_709);
	...
	if (bParam1)
	{
		...
		if (((iVar2 != 127 || iLocal_710 != 127) || iVar3 != 127) || iLocal_711 != 127)
		{
			...
			iLocal_711 = iVar3;
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(false);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_710);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_711);
...
void func_312()
{
	fLocal_704 = GET_DISABLED_CONTROL_NORMAL(2, 239);
	fLocal_705 = GET_DISABLED_CONTROL_NORMAL(2, 240);
	if (fLocal_704 != fLocal_706 || fLocal_705 != fLocal_707)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "SET_MOUSE_INPUT");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_704);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_705);
		END_SCALEFORM_MOVIE_METHOD();
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(237), -1082130432, -1082130432, -1082130432, -1082130432);
	}
...
void func_314()
{
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 187, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 187))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 189, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 189))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 190, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 190))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_700, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
}
...
void func_315()
{
	...
	if (!IS_BIT_SET(iLocal_693, 0) && !IS_BIT_SET(iLocal_693, 2))
	{
		if (func_320(16))
		{
			sVar0 = "IE_SEC_TUT7";
			iLocal_714 = 9000;
			SET_BIT(&Global_1676733, 16);
		...
		else if (func_320(22))
		{
			sVar0 = "IE_SEC_TUT12";
			iLocal_714 = 8000;
			SET_BIT(&Global_1676733, 22);
			func_317(&iLocal_712, &iLocal_713, 33);
		}
	}
	if (!IS_STRING_NULL_OR_EMPTY(sVar0) && !IS_STRING_NULL_OR_EMPTY(iLocal_693, 0))
	{
		func_316(sVar0, iLocal_714);
		SET_BIT(&iLocal_693, 0);
	}
	else if (IS_BIT_SET(iLocal_693, 0))
	{
...
int func_320(int iParam0)
{
	...
	{
		case 16:
			if ((!func_322(iLocal_712, iLocal_713, 18) && !IS_BIT_SET(Global_1676733, iVar0)) && !IS_BIT_SET(iLocal_693, 4))
			{
				return 1;
			}
			break;
		...
		case 17:
			if (((!func_322(iLocal_712, iLocal_713, 21) && !IS_BIT_SET(Global_1676733, iVar0)) && !IS_BIT_SET(iLocal_693, 5)) && iLocal_692 == 2)
			{
				return 1;
			}
			break;
		...
		case 18:
			if (((!func_322(iLocal_712, iLocal_713, 24) && !IS_BIT_SET(Global_1676733, iVar0)) && !IS_BIT_SET(iLocal_693, 5)) && iLocal_692 == 2)
			{
				return 1;
			}
			break;
		...
		case 19:
			if (((!func_322(iLocal_712, iLocal_713, 27) && !IS_BIT_SET(Global_1676733, iVar0)) && !IS_BIT_SET(iLocal_693, 6)) && iLocal_692 == 1)
			{
				return 1;
			}
			break;
		...
		case 20:
			if ((((!func_322(iLocal_712, iLocal_713, 30) && !IS_BIT_SET(Global_1676733, iVar0)) && !IS_BIT_SET(iLocal_693, 6)) && iLocal_692 == 1) && func_321())
			{
				return 1;
			}
			break;
		...
		case 21:
			if ((!func_322(iLocal_712, iLocal_713, 33) && !IS_BIT_SET(Global_1676733, iVar0)) && !func_308(8))
			{
				return 1;
			}
			break;
		...
		case 22:
			if (((!func_322(iLocal_712, iLocal_713, 36) && !IS_BIT_SET(Global_1676733, iVar0)) && !IS_BIT_SET(iLocal_693, 5)) && iLocal_692 == 2)
			{
				return 1;
			}
			break;
...
void func_336()
{
	...
	{
		if (func_339(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
			iVar0 = func_338(PLAYER_PED_ID());
...
void func_346()
{
	...
	if (!IS_BIT_SET(iLocal_693, 2) && !func_287())
	{
		...
		else if (iLocal_692 == 1 && !func_348(3816, -1, -1))
		{
			...
			iLocal_715 = 2;
			func_347(3816, 1, -1, 1);
			SET_BIT(&iLocal_693, 6);
		}
	}
	if (bVar0)
	{
		SET_BIT(&iLocal_693, 2);
	}
	else if (IS_BIT_SET(iLocal_693, 2))
	{
		if (!func_247(&uLocal_885))
		{
			func_246(&uLocal_885, 0, 0);
...
void func_351()
{
	...
	_SET_UI_LAYER(1);
	DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_700, 255, 255, 255, 255, 0);
	func_358();
	func_355(0);
	func_352(1);
}
...
void func_372()
{
	...
	while (iVar0 < 40)
	{
		iVar1 = Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_2[iVar0];
		if (iVar1 > 1000)
		{
			iVar1 = (iVar1 - 1000);
		}
	...
	{
		iVar2 = func_374(8);
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "SET_COOLDOWN");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar2);
		END_SCALEFORM_MOVIE_METHOD();
	}
	func_373();
...
void func_373()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "SHOW_EXPORT_SCREEN");
	END_SCALEFORM_MOVIE_METHOD();
}
...
int func_374(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		iVar0 = (Global_2509250 - ABSI(ABSI(ABSI(), Global_2509053.f_144)));
		iVar0 = (iVar0 / 1000);
	}
	else
	{
		iVar0 = (Global_262145.f_18830 - ABSI(ABSI(ABSI(), Global_2509053.f_146)));
		iVar0 = (iVar0 / 1000);
	}
	return iVar0;
}
...
void func_375(int iParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "UPDATE_COLLECTION");
...
void func_378(int iParam0, bool bParam1)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_700, "UPDATE_VEHICLE");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar0);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar1);
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (NETWORK_IS_PLAYER_ACTIVE(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_58(PLAYER_ID(), 0) && !func_388()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_384(iVar26) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
...
void func_400(int iParam0, bool bParam1)
{
	...
	func_395(0);
	func_248();
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_700);
	if (bParam1)
	{
		func_380(PLAYER_ID(), 1, 8388608, 0);
