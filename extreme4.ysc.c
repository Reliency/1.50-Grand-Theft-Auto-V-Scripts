...
void __EntryFunction__()
{
	...
	if (!func_335())
	{
		if ((func_317(Local_80.f_28[0]) && func_317(PLAYER_PED_ID())) && !func_316(PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
		{
			iLocal_305 = 1;
		}
	}
	while (true)
	{
		...
		{
			if (func_317(PLAYER_PED_ID()) && PLAYER_PED_ID(PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, true, 0))
			{
				if (func_317(Local_91))
				{
					if (func_316(PLAYER_PED_ID(), Local_91, 10f, 1))
					{
						func_297();
					}
				}
...
void func_8()
{
	switch (iLocal_85)
	{
		...
		case 1:
			...
			{
				if (!IS_ENTITY_DEAD(iLocal_102, 0))
				{
					if (func_316(PLAYER_PED_ID(), iLocal_102, 1f, 1))
					{
			...
			if (func_317(PLAYER_PED_ID()))
			{
				if (iLocal_297 == 0)
				{
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, true, 0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA()) == 2)
					{
						iLocal_297 = 1;
					}
				}
				if (func_228(Local_91))
				{
					if (timera() > 5000)
					{
						if ((GET_GAME_TIMER() > iLocal_292 + 25000 || GET_GAME_TIMER(GET_GAME_TIMER(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || GET_GAME_TIMER(GET_GAME_TIMER(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
						{
							iLocal_85 = 2;
						}
					}
				}
				else if ((GET_GAME_TIMER() > iLocal_292 + 25000 || GET_GAME_TIMER(GET_GAME_TIMER(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || GET_GAME_TIMER(GET_GAME_TIMER(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
				{
					iLocal_85 = 2;
				}
			}
		...
		case 2:
			if (((!IS_PED_FALLING(IS_PED_FALLING()) && !IS_PED_FALLING(IS_PED_FALLING())) && IS_PED_FALLING(IS_PED_FALLING()) < 2f) && !IS_PED_FALLING(IS_PED_FALLING()))
			{
...
void func_229()
{
	...
	while (GET_GAME_TIMER() < iLocal_296 + 11000 && !GET_GAME_TIMER())
	{
			...
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_293) == 1f)
				{
					if (func_317(Local_91))
					{
						...
						TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_294, false);
						...
						_0x2208438012482A1A(Local_91, 0, 0);
						DESTROY_CAM(iLocal_285, 0);
						iLocal_301 = 1;
					}
				}
			}
		...
		{
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) >= 0.2f)
			{
			...
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) == 1f)
			{
				if (func_317(Local_91))
				{
					...
					TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_295, true);
					...
					RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
					_0x2208438012482A1A(Local_91, 0, 0);
					DESTROY_CAM(iLocal_286, 0);
					iLocal_302 = 1;
				}
			}
		}
		else if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295) >= 0.323f)
		{
			if (!iLocal_298)
			{
			...
			{
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295) >= 0.44f)
				{
					iLocal_104 = START_PARTICLE_FX_LOOPED_AT_COORD("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, false);
	...
	if (func_317(Local_91))
	{
		if (iVar0 < 3)
		{
			SET_ENTITY_HEALTH(Local_91, 101, 0);
			vVar4 = { GET_ENTITY_COORDS(Local_91, true) };
			if (vVar4.z > 155f)
			{
				fVar5 = 155f;
			}
			...
			SET_ENTITY_COORDS(Local_91, 1657.046f, -17.4571f, fVar5, 1, false, 0, 1);
		}
	}
	_0x81CBAE94390F9F89();
	func_231(1, 1, 1, 1);
	...
	DISPLAY_HUD(true);
	DISPLAY_RADAR(true);
	SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), true, 128);
	SET_TIME_SCALE(1f);
	if (func_228(Local_91))
	{
		if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295))
		...
		CLEAR_PED_TASKS_IMMEDIATELY(Local_91);
		_0x2208438012482A1A(Local_91, 0, 0);
		SET_ENTITY_COORDS(Local_91, 1655.77f, -20.04f, 135.8f, 1, false, 0, 1);
		SET_ENTITY_HEALTH(Local_91, 0, 0);
	}
	func_230(&uLocal_106, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_232(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_236(IS_PED_INJURED())) && !func_234(IS_PED_INJURED(), 0)) && !func_233()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_236(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_245()
{
	...
	switch (iLocal_85)
	{
		case 0:
			iLocal_87 = 0;
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, true, 0))
			{
			...
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_305 || GET_GAME_TIMER() > iLocal_306 + 3000) || GET_GAME_TIMER(GET_GAME_TIMER(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						_0x48621C9FCA3EBD28(1);
						START_CUTSCENE(2048);
						if (func_317(Local_91))
						{
							REGISTER_ENTITY_FOR_CUTSCENE(Local_91, "Dom", 0, joaat("cs_dom"), 0);
						}
						wait(0);
						iLocal_305 = 0;
						...
						if (func_317(Local_91))
						{
							FREEZE_ENTITY_POSITION(Local_91, false);
						}
						if (DOES_ENTITY_EXIST(iLocal_103) && !DOES_ENTITY_EXIST(iLocal_103, 0))
						{
							SET_ENTITY_VISIBLE(iLocal_103, false, 0);
						}
						if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
						{
							iLocal_96 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
							iLocal_105 = GET_ENTITY_MODEL(iLocal_96);
							if (IS_THIS_MODEL_A_CAR(iLocal_105) == 1 || IS_THIS_MODEL_A_CAR(iLocal_105) == 1)
							{
						...
						iLocal_288 = ADD_SCENARIO_BLOCKING_AREA(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_85 = 1;
					}
				}
			}
					...
					if (!iLocal_90)
					{
						if (!IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
						{
							if (func_317(Local_91))
							{
								...
								TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_293, true);
								SET_CAM_ACTIVE(iLocal_285, true);
		...
		case 2:
			...
			if (DOES_ENTITY_EXIST(iLocal_103) && !DOES_ENTITY_EXIST(iLocal_103, 0))
			{
				SET_ENTITY_VISIBLE(iLocal_103, true, 0);
			}
			if (iLocal_87 == 0)
			{
...
void func_247(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_248(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_250(vector3 vParam0, float fParam1)
{
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		if (DOES_ENTITY_EXIST(iVar0))
		{
			...
			{
				SET_ENTITY_COORDS(iVar0, vParam0, 1, false, 0, 1);
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_264(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_263(PLAYER_PED_ID(), -828834893))
				{
...
void func_267()
{
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		{
			if (((((((IS_CONTROL_PRESSED(0, 30) || IS_CONTROL_PRESSED(0, 31)) || IS_CONTROL_PRESSED(0, 23)) || IS_CONTROL_PRESSED(0, 21)) || IS_CONTROL_PRESSED(0, 22)) || (func_279() && IS_CONTROL_PRESSED(0, 1))) || (func_279() && IS_CONTROL_PRESSED(0, 2))) || (func_279() && IS_CONTROL_PRESSED(0, 32)))
			{
	...
	switch (iLocal_85)
	{
		...
		case 1:
			...
			if (func_317(PLAYER_PED_ID()))
			{
				if (func_317(Local_91))
				{
					if (func_316(PLAYER_PED_ID(), Local_91, 100f, 1))
					{
						_REQUEST_CUTSCENE_EX("es_4_rcm_p2_concat", 6, 8);
						if (_0xB56BBBCC2955D9CB())
						{
					...
					if (IS_PED_RAGDOLL(Local_91))
					{
						SET_ENTITY_HEALTH(Local_91, 0, 0);
					}
					if (func_316(PLAYER_PED_ID(), Local_91, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_300)
							{
								if (func_316(PLAYER_PED_ID(), Local_91, 30f, 1) && !func_266())
								{
							...
							func_269();
							if (!IS_PED_HEADTRACKING_PED(IS_PED_HEADTRACKING_PED(), Local_91))
							{
								TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_91, -1, 0, 2);
							}
						}
					}
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, true, 0))
					{
						if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
						{
							iLocal_85 = 2;
		...
		case 2:
			...
			if (func_317(PLAYER_PED_ID()))
			{
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					BRING_VEHICLE_TO_HALT(BRING_VEHICLE_TO_HALT(BRING_VEHICLE_TO_HALT(), 0), 5f, 1, 0);
					wait(600);
					TASK_LEAVE_ANY_VEHICLE(TASK_LEAVE_ANY_VEHICLE(), 0, 0);
				}
			}
...
void func_268()
{
	if (func_317(Local_91))
	{
		if (GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			TASK_PERFORM_SEQUENCE(Local_91, iLocal_95);
		}
	}
}
...
void func_269()
{
	if (!func_266())
	{
		if (iLocal_290 < 5)
		{
			if (GET_GAME_TIMER() > (iLocal_291 + (8000 + GET_GAME_TIMER(0, 2000))))
			{
	...
	if (!func_266())
	{
		if ((REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
		{
			if (HAS_SOUND_FINISHED(iLocal_289))
			{
				PLAY_SOUND_FROM_ENTITY(iLocal_289, "DOM", Local_91, "EXTREME_04_SOUNDSET", false, 0);
			}
		}
	}
}
...
int func_271(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_228(PLAYER_PED_ID()) && func_228(iParam0))
	{
...
int func_274(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_258(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_258(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_280()
{
	...
	else
	{
		...
		TASK_FOLLOW_NAV_MESH_TO_COORD(TASK_FOLLOW_NAV_MESH_TO_COORD(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 1193033728);
		func_244(800, 0);
		iLocal_88 = 1;
		func_287(1, 1, 1);
	}
...
void func_281()
{
	...
	TASK_FOLLOW_NAV_MESH_TO_COORD(Local_80.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 1048576000, 0, 1193033728);
	SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", false);
	CLEAR_AREA_OF_VEHICLES(Local_91.f_1, 20f, 0, 0, 0, 0, false, 0);
	...
	{
		iLocal_100 = CREATE_OBJECT(1165008631, 1666.282f, -11.20408f, 172.7773f, true, true, false);
		SET_ENTITY_ROTATION(iLocal_100, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!DOES_ENTITY_EXIST(iLocal_101))
	{
		iLocal_101 = CREATE_OBJECT(1165008631, 1667.076f, -12.07778f, 173.2611f, true, true, false);
		SET_ENTITY_ROTATION(iLocal_101, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_317(Local_91))
	{
		if (GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			...
			SET_SEQUENCE_TO_REPEAT(iLocal_95, 1);
	...
	if (func_317(Local_91))
	{
		SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_91, 0);
		func_230(&uLocal_106, 4, Local_91, "DOM", 0, 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_91, SET_PED_RELATIONSHIP_GROUP_HASH(SET_PED_RELATIONSHIP_GROUP_HASH()));
	}
	if (!DOES_ENTITY_EXIST(iLocal_103))
	{
		iLocal_103 = CREATE_AMBIENT_PICKUP(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	SET_ENTITY_ROTATION(iLocal_103, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	PLAY_ENTITY_ANIM(iLocal_103, "Chute_Off_Bag", "skydive@parachute@", 4f, false, true, 0, 0.99f, 0);
	func_246(1);
}
...
void func_291()
{
	switch (iLocal_86)
	{
		...
		case 2:
			func_285(PLAYER_PED_ID(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			FORCE_PED_MOTION_STATE(FORCE_PED_MOTION_STATE(), -668482597, false, 1, 0);
			SET_PED_MIN_MOVE_BLEND_RATIO(SET_PED_MIN_MOVE_BLEND_RATIO(), 1f);
			TASK_FOLLOW_NAV_MESH_TO_COORD(TASK_FOLLOW_NAV_MESH_TO_COORD(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 1193033728);
			SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
...
void func_296()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_80.f_28[0])) && func_317(PLAYER_PED_ID())) && iLocal_305 == 1)
	{
		if (!IS_GAMEPLAY_HINT_ACTIVE())
		{
			SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 0);
			TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_80.f_28[0], -1, 0, 2);
			TASK_FOLLOW_TO_OFFSET_OF_ENTITY(TASK_FOLLOW_TO_OFFSET_OF_ENTITY(), Local_80.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
			GET_IS_MULTIPLAYER_BRIEF(1);
			SET_GAMEPLAY_ENTITY_HINT(Local_80.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
		...
		{
			if (func_316(PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
			{
...
void func_297()
{
	...
	if (iLocal_305)
	{
		if (!IS_GAMEPLAY_HINT_ACTIVE())
		{
			SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 0);
			TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_91, -1, 0, 2);
			TASK_FOLLOW_NAV_MESH_TO_COORD(TASK_FOLLOW_NAV_MESH_TO_COORD(), 1658.95f, -5.45f, 173.78f, 1f, -1, 0.25f, 0, -161.08f);
			GET_IS_MULTIPLAYER_BRIEF(1);
			SET_GAMEPLAY_ENTITY_HINT(Local_91, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			SET_GAMEPLAY_HINT_FOV(fVar0);
			_0xF8BDBF3D573049A1(fVar1);
			_0xD1F8363DFAD03848(fVar2);
			_0x5D7B620DAE436138(fVar3);
...
void func_298()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(Local_91, true), true);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
		...
		if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, true, 0))
		{
			sLocal_92 = "EXT4_F2";
			iLocal_84 = 4;
		}
...
{
	if (((!func_313(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_312(0)) || func_311(1))
			{
			}
			else
			{
...
void func_318()
{
	...
	if (!DOES_ENTITY_EXIST(iLocal_99))
	{
		...
		SET_ENTITY_ROTATION(iLocal_99, 90f, 0f, -63f, 2, 1);
		FREEZE_ENTITY_POSITION(iLocal_99, true);
		SET_ENTITY_VISIBLE(iLocal_99, false, 0);
	}
	func_322(1);
	if (!DOES_ENTITY_EXIST(Local_91))
	{
		func_319(&Local_91, 52, Local_91.f_1, Local_91.f_4, "Ext4-Dom", 1);
		FREEZE_ENTITY_POSITION(Local_91, true);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_91, true);
		REMOVE_ALL_PED_WEAPONS(Local_91, 1);
		SET_PED_COMPONENT_VARIATION(Local_91, 8, 2, 0, 0);
		DISABLE_PED_PAIN_AUDIO(Local_91, true);
		SET_PED_CONFIG_FLAG(Local_91, 137, true);
		SET_PED_CONFIG_FLAG(Local_91, 118, false);
		SET_PED_CONFIG_FLAG(Local_91, 208, true);
		SET_PED_MONEY(Local_91, 5000);
	}
	if (func_228(PLAYER_PED_ID()))
	{
		func_230(&uLocal_106, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_322(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		while ((((!HAS_MODEL_LOADED(Local_91.f_5) || !HAS_MODEL_LOADED(joaat("sanchez"))) || !HAS_MODEL_LOADED("rcmextreme4")) || !HAS_MODEL_LOADED("skydive@parachute@")) || !HAS_MODEL_LOADED())
		{
			wait(0);
		}
	}
...
void func_336(int iParam0)
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_288, 0);
...
int func_353(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_359())
	{
		...
		{
			iVar2 = func_354(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
