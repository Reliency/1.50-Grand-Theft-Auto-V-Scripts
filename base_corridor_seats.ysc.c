...
{
	return IS_ENTITY_IN_ANGLED_AREA(iParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, true, 0);
}
...
int func_73()
{
	if (Global_1590291 != func_60())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
