...
void __EntryFunction__()
{
	...
	func_515(25);
	func_514();
	func_513(&uLocal_89, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_14()
{
	...
	{
		func_16(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_59(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_82(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_93(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_93(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_82(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_155(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_162()
{
	...
	{
		if (func_157(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_173()
{
	...
	{
		func_162();
		_0xBF59707B3E5ED531(func_174(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_224()
{
	if (iLocal_274)
	{
		SET_PED_INFINITE_AMMO(SET_PED_INFINITE_AMMO(), 0, joaat("weapon_sniperrifle"));
		SET_PED_AMMO_BY_TYPE(SET_PED_AMMO_BY_TYPE(), 1285032059, iLocal_337);
	}
	else
	{
		SET_CURRENT_PED_WEAPON(SET_CURRENT_PED_WEAPON(), joaat("weapon_unarmed"), true);
		REMOVE_WEAPON_FROM_PED(REMOVE_WEAPON_FROM_PED(), joaat("weapon_sniperrifle"));
	}
	bLocal_285 = true;
}
...
void func_226(bool bParam0)
{
	if (func_308(iLocal_348))
	{
		if (bParam0)
		{
			if (DOES_GROUP_EXIST(func_227()))
			{
				if (!IS_PED_GROUP_MEMBER(iLocal_348, func_227()))
				{
					CLEAR_PED_TASKS(iLocal_348);
					SET_PED_AS_GROUP_MEMBER(iLocal_348, func_227());
					SET_PED_NEVER_LEAVES_GROUP(iLocal_348, 1);
					FREEZE_ENTITY_POSITION(iLocal_348, false);
				}
			}
		}
		else if (IS_PED_GROUP_MEMBER(iLocal_348, func_227()))
		{
			CLEAR_PED_TASKS(iLocal_348);
...
void func_231(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_209(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_233(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_233(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_221();
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		func_263(PLAYER_PED_ID());
		func_256(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_255())
		{
			func_251(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_242(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_245(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_256(int iParam0, bool bParam1)
{
	...
	iVar0 = func_156(iParam0);
	if (func_159(iVar0) && !IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER_PED_ID())
		{
...
void func_257(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_262(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_259(Var7.f_1)) && iVar9 < 51)
			{
...
int func_268(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_290())
		{
			*uParam0 = func_273(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_270(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_15() == 0)
		{
			return IS_BIT_SET(func_77(func_271(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_273(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_289(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_274(iVar0, 0), true);
...
void func_310()
{
	...
	if (iLocal_338 < 3)
	{
		if (!bLocal_294)
		{
			if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_365, vLocal_366, 20f, 0, true, 0))
			{
				func_321();
				if (iLocal_301[17])
				{
					if (!func_223() || GET_PROFILE_SETTING(203) == 0)
					{
						if (!iLocal_286)
						{
							if (iLocal_338 == 0)
...
void func_311()
{
	...
	while (iVar3 < 4)
	{
		if (WOULD_ENTITY_BE_OCCLUDED(iVar2[iVar3], vVar0[iVar3 /*3*/], 1))
		{
			iLocal_425[iVar3] = CREATE_VEHICLE(iVar2[iVar3], vVar0[iVar3 /*3*/], fVar1[iVar3], true, true, false);
		}
		iVar3++;
	}
		...
		while (iVar1 < 3)
		{
			if (((Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_260[iVar0 /*54*/].f_52 != 4) && Local_260[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_308(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						vLocal_421[iVar0 /*3*/] = { GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, true) };
						iLocal_303[iVar0] = 1;
						Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1 = 1;
						if (Local_260[iVar0 /*54*/][0 /*17*/].f_1 == 1)
						{
							if (!IS_ENTITY_DEAD(Local_260[iVar0 /*54*/][1 /*17*/].f_6, 0))
							{
								Local_260[iVar0 /*54*/][1 /*17*/].f_4 = 0;
								iLocal_329 = 1;
							}
							else if (!IS_ENTITY_DEAD(Local_260[iVar0 /*54*/][2 /*17*/].f_6, 0))
							{
				...
				else if (IS_BULLET_IN_AREA(IS_BULLET_IN_AREA(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, true), 2f, 0))
				{
					iLocal_277 = 0;
					iLocal_281 = 1;
					iLocal_330 = 0;
			...
			switch (Local_260[iVar0 /*54*/].f_52)
			{
				...
				case 4:
					...
					while (iLocal_330 < 3)
					{
						if ((DOES_ENTITY_EXIST(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0)) && !DOES_ENTITY_EXIST(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6))
						{
				...
				case 2:
					...
					while (iLocal_330 < 3)
					{
						...
						{
							if (DOES_ENTITY_EXIST(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 0))
							{
								TASK_GO_TO_COORD_ANY_MEANS(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, vLocal_421[iVar0 /*3*/], TASK_GO_TO_COORD_ANY_MEANS(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_323(int iParam0, int iParam1)
{
	...
	{
		if (!IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
		{
			_0x570389D1C3DE3C6B(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6);
		}
	...
	switch (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 = (GET_GAME_TIMER() + GET_GAME_TIMER(3000, 8000));
		...
		case 4:
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (GET_GAME_TIMER() > Local_260[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iVar0 /*17*/].f_6, 0))
						{
		...
		case 5:
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, TASK_FOLLOW_NAV_MESH_TO_COORD(0f, 359.9f));
					}
					else if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
					{
						TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && IS_ENTITY_AT_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_326(iParam0), false, false, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							...
							TASK_WANDER_IN_AREA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
		...
		case 12:
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_303[iParam0])
				{
					...
					{
						TASK_GO_TO_COORD_ANY_MEANS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_421[iParam0 /*3*/], TASK_GO_TO_COORD_ANY_MEANS(1f, 2.5f), 0, 0, 786603, -1082130432);
		...
		case 8:
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0))
				{
					TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
...
void func_327(int iParam0)
{
	...
	if (func_344())
	{
		...
		{
			iVar0 = GET_PED_INDEX_FROM_ENTITY_INDEX(func_342(iVar1));
			iVar2 = 0;
			while (iVar2 < 3)
			{
...
int func_331()
{
	...
	if (PLAYER_ID() == func_284())
	{
		return 0;
	}
	if (func_332(PLAYER_ID()))
	{
		return 0;
	}
...
{
	if ((((IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_365, vLocal_366, 20f, 0, true, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !IS_ENTITY_IN_ANGLED_AREA(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_286) && iLocal_338 < 3)
	{
...
void func_346(int iParam0, int iParam1)
{
	...
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = CREATE_PED(26, iLocal_341, vVar0, CREATE_PED(0f, 359.9f), 1, true);
		if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
...
void func_347(int iParam0, int iParam1)
{
	if (!func_308(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_300[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			...
			Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6 = CREATE_PED(26, iLocal_341, vLocal_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, true);
			if (DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				SET_ENTITY_HEALTH(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, true);
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER_PED_ID(), vLocal_377, fLocal_378, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
int func_361()
{
	if (DOES_ENTITY_EXIST(iLocal_348) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		if (!IS_ENTITY_AT_ENTITY(iLocal_348, IS_ENTITY_AT_ENTITY(), vLocal_367, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_363()
{
	...
	func_364();
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) || iLocal_301[16])
	{
		func_358();
		func_351();
		iLocal_254 = 15;
...
void func_364()
{
	...
	while (iVar0 < 5)
	{
		if (Local_259[iVar0 /*29*/].f_13 != 0)
		{
			...
			{
				if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_363, vLocal_364, 10f, 0, true, 0))
				{
					if (!bLocal_289)
					{
						if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
						{
							bLocal_289 = true;
							func_318(6);
						}
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				...
				if ((!IS_ANY_VEHICLE_NEAR_POINT(Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_319 < 3) && IS_ANY_VEHICLE_NEAR_POINT(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, 1))
				{
					...
					if (DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_28) && !DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_28, 0))
					{
						SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_259[iVar0 /*29*/].f_28, true);
						SET_VEHICLE_TYRES_CAN_BURST(Local_259[iVar0 /*29*/].f_28, true);
						Local_259[iVar0 /*29*/].f_7 = GET_RANDOM_INT_IN_RANGE(0, 5);
						Local_259[iVar0 /*29*/].f_12 = CREATE_PED_INSIDE_VEHICLE(Local_259[iVar0 /*29*/].f_28, 26, Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, true);
						if (DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_12))
						{
							...
							{
								ATTACH_ENTITY_TO_ENTITY(Local_259[iVar0 /*29*/].f_11, Local_259[iVar0 /*29*/].f_12, ATTACH_ENTITY_TO_ENTITY(Local_259[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								SET_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11, false, 0);
			...
			case 4:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					if (!IS_ENTITY_AT_COORD(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 10f, 10f, 10f, false, false, 0))
					{
						...
						{
							if (IS_BULLET_IN_AREA(IS_BULLET_IN_AREA(Local_259[iVar0 /*29*/].f_28, true), 5f, 1))
							{
								iLocal_282 = 1;
							}
						}
			...
			case 5:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					...
					{
						TASK_VEHICLE_PARK(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, vVar1, TASK_VEHICLE_PARK(Local_259[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_349())
					{
			...
			case 6:
				if ((func_230(Local_259[iVar0 /*29*/].f_28) && func_308(Local_259[iVar0 /*29*/].f_12)) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
				{
					if (IS_VEHICLE_STOPPED(Local_259[iVar0 /*29*/].f_28))
					{
						CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, true);
						if (!HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
			...
			case 7:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
				{
					if (!IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) || !Local_259[iVar0 /*29*/].f_2)
						{
					...
					else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
					{
						func_369(iVar0);
					}
				}
			...
			case 8:
				if ((func_308(Local_259[iVar0 /*29*/].f_12) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1)) && func_377(Local_259[iVar0 /*29*/].f_28))
				{
					vVar2 = { GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, true) };
					if (!IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0))
					{
						if (!HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vVar2, 3f, 1))
						{
							...
							CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, true);
							TASK_FOLLOW_NAV_MESH_TO_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_259[iVar0 /*29*/].f_6);
			...
			case 11:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
				{
					...
					if (!HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vVar2, 3f, 1))
					{
						...
						TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
						TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
						TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
						TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter_call", 8f, -8f, -1, 0, 0, 0, 0, 0);
			...
			case 12:
				if (func_308(Local_259[iVar0 /*29*/].f_12) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
				{
					...
					if (!HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) && !HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vVar2, 3f, 1))
					{
						...
						else if (IS_ENTITY_PLAYING_ANIM(Local_259[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !IS_ENTITY_PLAYING_ANIM(Local_259[iVar0 /*29*/].f_11))
						{
							SET_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11, true, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
				{
					if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(Local_259[iVar0 /*29*/].f_28, false), GET_DISTANCE_BETWEEN_COORDS(Local_259[iVar0 /*29*/].f_12, true), false) > 100f)
					{
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_12))
				{
					if (!IS_ENTITY_DEAD(Local_259[iVar0 /*29*/].f_12, 0))
					{
						SET_PED_KEEP_TASK(Local_259[iVar0 /*29*/].f_12, true);
					}
		...
		{
			if (GET_DISTANCE_BETWEEN_COORDS(vLocal_376, GET_DISTANCE_BETWEEN_COORDS(Local_259[iVar0 /*29*/].f_28, true), true) > 450f)
			{
				Local_259[iVar0 /*29*/].f_13 = 15;
			}
		}
...
Vector3 func_368(int iParam0)
{
	...
	if (func_377(iParam0))
	{
		vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 5f, 25f, 0f) };
		if (GET_CLOSEST_VEHICLE_NODE(vVar0, &vVar1, 1, 1077936128, 0))
		{
			if (_0x16F46FB18C8009E4(vVar1, 0, &vVar1))
			{
				if (!IS_ANY_VEHICLE_NEAR_POINT(vVar1, 2f) && !IS_ANY_VEHICLE_NEAR_POINT(vVar1, 2f, 0))
				{
					return vVar1;
				}
			}
...
void func_369(int iParam0)
{
	if (func_308(Local_259[iParam0 /*29*/].f_12))
	{
		...
		if (func_377(Local_259[iParam0 /*29*/].f_28))
		{
			if (IS_PED_IN_VEHICLE(Local_259[iParam0 /*29*/].f_12, Local_259[iParam0 /*29*/].f_28, 0))
			{
			...
			{
				TASK_SMART_FLEE_COORD(Local_259[iParam0 /*29*/].f_12, vLocal_358, 10000f, -1, 0, 0);
...
int func_372()
{
	...
	if (func_308(PLAYER_PED_ID()))
	{
		...
		if (func_308(iLocal_348))
		{
			vVar1 = { GET_ENTITY_COORDS(iLocal_348, true) };
			if (func_373(PLAYER_PED_ID(), iLocal_348, 0) <= 10f && PLAYER_PED_ID((vVar0.z - vVar1.z)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_374(int iParam0)
{
	...
	if (!IS_ENTITY_DEAD(Local_259[iParam0 /*29*/].f_28, 0))
	{
...
{
	if (DOES_ENTITY_EXIST(Local_259[iParam0 /*29*/].f_28) && !DOES_ENTITY_EXIST(Local_259[iParam0 /*29*/].f_28, 0))
	{
		if (IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 1, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 5, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { 2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 4, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, -3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
		}
		else if (IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 0, 0))
		{
			Local_259[iParam0 /*29*/].f_22 = { -2.5f, 3f, 0f };
			Local_259[iParam0 /*29*/].f_5 = -90f;
			return 1;
...
void func_378(int iParam0)
{
	...
	{
		if (IS_ENTITY_DEAD(Local_259[iParam0 /*29*/].f_12, 0) || !IS_ENTITY_DEAD(Local_259[iParam0 /*29*/].f_12, 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iParam0 /*29*/].f_12, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
			{
				func_369(iParam0);
			}
		}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_255 = 13;
				CLEAR_AREA_OF_VEHICLES(vLocal_376, 50f, 0, 0, 0, 0, false, 0);
				CLEAR_AREA_OF_VEHICLES(vLocal_374, 50f, 0, 0, 0, 0, false, 0);
				CLEAR_AREA_OF_VEHICLES(vLocal_375, 50f, 0, 0, 0, 0, false, 0);
				CLEAR_PED_TASKS_IMMEDIATELY(CLEAR_PED_TASKS_IMMEDIATELY());
				func_380();
				func_354();
				func_353();
				...
				if (!func_212())
				{
					func_229(PLAYER_PED_ID(), vLocal_358, fLocal_305, 0, 1);
					func_352();
				}
				iLocal_257 = 2;
			}
...
void func_389()
{
	...
	SET_FORCE_OBJECT_THIS_FRAME(vLocal_359, fLocal_315);
	SET_FORCE_OBJECT_THIS_FRAME(vLocal_360, fLocal_315);
	SET_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0f);
	SET_SCENARIO_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f, 0f);
	if (GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
	{
...
void func_390()
{
	if (!IS_PED_INJURED(iLocal_348) && !IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (!bLocal_283)
		{
			if (!IS_ENTITY_AT_ENTITY(iLocal_348, IS_ENTITY_AT_ENTITY(), vLocal_384, 0, 1, 0) || IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY()) != 0)
			{
		...
		else if (IS_ENTITY_AT_ENTITY(iLocal_348, IS_ENTITY_AT_ENTITY(), vLocal_385, 0, 1, 0) && IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY()) == 0)
		{
			if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0)))
			{
				bLocal_283 = false;
			}
		}
...
void func_393()
{
	...
	if (!iLocal_293)
	{
		if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), vLocal_357, 50f, 50f, 50f, false, true, 0))
		{
			func_395();
			iLocal_293 = 1;
		}
	...
	if (!bLocal_283)
	{
		if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), vLocal_357, 5f, 5f, 5f, false, true, 0) && func_394(1077936128, 1))
		{
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_374, vLocal_375, false, 1);
			func_8(&iLocal_262);
			func_385();
			func_2();
			func_351();
...
void func_395()
{
	ADD_SCENARIO_BLOCKING_AREA(vLocal_401, vLocal_402, 0, 1, 1, 1);
	SET_PED_NON_CREATION_AREA(vLocal_401, vLocal_402);
	CLEAR_AREA_OF_PEDS(vLocal_412, 5f, 0);
}
...
void func_397()
{
	...
	SET_FORCE_OBJECT_THIS_FRAME(vLocal_359, fLocal_315);
	SET_FORCE_OBJECT_THIS_FRAME(vLocal_360, fLocal_315);
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_361, vLocal_362, 7f, 1, true, 0))
	{
		if (iLocal_301[1])
		{
			iLocal_290 = 0;
...
void func_399()
{
	...
	SET_FORCE_OBJECT_THIS_FRAME(vLocal_359, fLocal_315);
	SET_FORCE_OBJECT_THIS_FRAME(vLocal_360, fLocal_315);
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_361, vLocal_362, 7f, 0, true, 0))
	{
		func_321();
		func_404();
		func_383();
		...
		if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) && (IS_PED_IN_ANY_VEHICLE(iLocal_348, vLocal_368, 2f, 2f, 2f, false, true, 0) || iLocal_338 >= 3))
		{
			if (!bLocal_294)
			{
				if (iLocal_338 >= 3)
				{
					if (!IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 2f, 2f, 2f, false, true, 0))
					{
						func_226(1);
					}
					iLocal_254 = 8;
...
int func_402(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(iVar0, func_403(SET_BLIP_SCALE(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(iVar0, func_403(SET_BLIP_SCALE(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
void func_405(int iParam0)
{
	if (DOES_ENTITY_EXIST(Local_258[iParam0 /*10*/]) && !Local_258[iParam0 /*10*/].f_7)
	{
		...
		if (Local_258[iParam0 /*10*/].f_5 < 100)
		{
			...
			_0xE7E4C198B0185900(Local_258[iParam0 /*10*/], 1, 0);
		}
	}
}
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER_PED_ID(), vLocal_356, fLocal_304, 0, 1);
				}
				func_8(&iLocal_262);
				func_228(1);
...
void func_407()
{
	CLEAR_AREA_OF_PEDS(vLocal_403, 3f, 0);
	SET_PED_NON_CREATION_AREA(vLocal_404, vLocal_405);
	CLEAR_AREA_OF_PEDS(vLocal_406, 3f, 0);
	SET_PED_NON_CREATION_AREA(vLocal_407, vLocal_408);
	CLEAR_AREA_OF_PEDS(vLocal_409, 3f, 0);
	SET_PED_NON_CREATION_AREA(vLocal_410, vLocal_411);
}
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			...
			if (DOES_ENTITY_EXIST(Local_258[iVar0 /*10*/]))
			{
				...
				SET_OBJECT_TARGETTABLE(Local_258[iVar0 /*10*/], 0);
				SET_ENTITY_HEALTH(Local_258[iVar0 /*10*/], 100, 0);
				SET_ENTITY_DYNAMIC(Local_258[iVar0 /*10*/], 1);
				Local_258[iVar0 /*10*/].f_7 = 0;
				Local_258[iVar0 /*10*/].f_8 = 0;
			}
			iVar0++;
		}
		if (((DOES_ENTITY_EXIST(Local_258[0 /*10*/]) && DOES_ENTITY_EXIST(Local_258[1 /*10*/])) && DOES_ENTITY_EXIST(Local_258[2 /*10*/])) && func_409())
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_340);
			iLocal_271 = 0;
			return 1;
...
void func_411()
{
	...
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_361, vLocal_362, 7f, 1, true, 0))
	{
		if (iLocal_301[1])
		{
			...
			_SET_DOOR_AJAR_ANGLE(1661506222, 0f, true, false);
			_SET_DOOR_ACCELERATION_LIMIT(1661506222, 0, true, true);
			iLocal_254 = 6;
		}
		func_404();
		if (bLocal_294)
	...
	else
	{
		...
		if (DOES_BLIP_EXIST(iLocal_263))
		{
			...
			{
				if (!IS_ENTITY_AT_ENTITY(iLocal_348, IS_ENTITY_AT_ENTITY(), vLocal_384, 0, 1, 0))
				{
					func_2();
					func_314(1, 0);
					func_319("HT_BKHTER");
			...
			else
			{
				...
				if (IS_ENTITY_AT_ENTITY(iLocal_348, IS_ENTITY_AT_ENTITY(), vLocal_385, 0, 1, 0))
				{
					func_314(1, 0);
					if (func_398("HT_BKHTER", 0, 0))
					{
	...
	switch (iLocal_257)
	{
		...
		case 1:
			if (IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_212())
				{
					func_229(PLAYER_PED_ID(), vLocal_380, fLocal_381, 0, 1);
					func_352();
				}
				func_228(1);
				CLEAR_AREA_OF_VEHICLES(vLocal_379, 2f, 0, 0, 0, 0, false, 0);
				func_7();
				iLocal_257 = 2;
			}
			break;
			...
			switch (iLocal_320)
			{
				case 0:
					if (func_440(1, 1093140480, 0))
					{
						...
						{
							REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), sLocal_354, 0, 0, 0);
						}
						if (func_230(iLocal_348))
						{
							REGISTER_ENTITY_FOR_CUTSCENE(iLocal_348, sLocal_355, 0, 0, 0);
							_0x2A56C06EBEF2B0D9(sLocal_355, _0x2A56C06EBEF2B0D9(), 0);
						...
						{
							SET_ENTITY_COORDS(iLocal_426, 1806.732f, 3934.353f, 33.3275f, 1, false, 0, 1);
				...
				case 1:
					...
					{
						GIVE_WEAPON_OBJECT_TO_PED(iLocal_347, GIVE_WEAPON_OBJECT_TO_PED());
					}
					...
					_SET_DOOR_AJAR_ANGLE(1661506222, -0.8f, true, false);
					_SET_DOOR_ACCELERATION_LIMIT(1661506222, 4, true, true);
					if (HAS_CUTSCENE_FINISHED())
					{
						_0x81CBAE94390F9F89();
						SET_PED_INFINITE_AMMO(SET_PED_INFINITE_AMMO(), 1, joaat("weapon_sniperrifle"));
						iLocal_320++;
					}
					break;
				
				case 2:
					if (WAS_CUTSCENE_SKIPPED() && WAS_CUTSCENE_SKIPPED())
					{
						func_229(iLocal_348, vLocal_373, fLocal_312, 0, 1);
						iLocal_255 = 3;
					}
...
{
	if ((GET_PROFILE_SETTING(203) != 0 && *uParam0 != 1) && GET_PROFILE_SETTING())
	{
		*uParam0 = 1;
	}
}
...
void func_416(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_420(IS_PED_INJURED())) && !func_418(IS_PED_INJURED(), 0)) && !func_417()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_420(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_424(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_426(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_436(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			if (HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				if (func_439(func_260(iVar2, iVar6)))
				{
					iVar7 = GET_WEAPON_COMPONENT_TYPE_MODEL(func_260(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_260(iVar2, iVar6) != 0)
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			if (HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_260(iVar2, iVar6)))
			{
				GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_260(iVar2, iVar6));
...
int func_440(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_443(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_376(PLAYER_PED_ID(), -828834893))
				{
...
void func_446()
{
	if (!IS_GAMEPLAY_HINT_ACTIVE() && func_373(IS_GAMEPLAY_HINT_ACTIVE(), iLocal_348, 1) > 3f)
	{
		...
		if (func_308(iLocal_348))
		{
			...
			SET_GAMEPLAY_ENTITY_HINT(iLocal_348, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
			SET_GAMEPLAY_HINT_FOV(fLocal_306);
			_0xF8BDBF3D573049A1(fLocal_307);
			_0xD1F8363DFAD03848(fLocal_308);
			_0x5D7B620DAE436138(fLocal_309);
			_0xC92717EF615B6704(fLocal_310);
			GET_IS_MULTIPLAYER_BRIEF(1);
		}
	}
	else if (func_308(iLocal_348) && func_308(PLAYER_PED_ID()))
	{
		if (GET_GAME_TIMER() > iLocal_325 || func_373(GET_GAME_TIMER(), iLocal_348, 1) <= 3f)
		{
			if (func_373(PLAYER_PED_ID(), iLocal_348, 1) <= 3f)
			{
			}
			iLocal_320 = 0;
			iLocal_257 = 0;
...
void func_447()
{
	...
	if (func_308(iLocal_348))
	{
		...
		SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_348, 0);
		...
		SET_PED_DIES_IN_WATER(iLocal_348, 0);
		SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_348);
		SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(iLocal_348, 1);
		SET_PED_CAN_BE_DRAGGED_OUT(iLocal_348, 0);
		SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, true);
		SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
		SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(iLocal_348, 1);
		SET_PED_GET_OUT_UPSIDE_DOWN_VEHICLE(iLocal_348, 1);
	}
	iLocal_257 = 0;
	if (func_528())
	{
...
void func_450()
{
	...
	{
		iLocal_274 = 1;
		iLocal_337 = GET_PED_AMMO_BY_TYPE(GET_PED_AMMO_BY_TYPE(), 1285032059);
	}
}
...
void func_456()
{
	if (GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
	{
		if ((IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_397, vLocal_398, 16f, 0, true, 0) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_399, vLocal_400, 19f, 0, true, 0)) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_401, vLocal_402, 19f, 0, true, 0))
		{
			if (!IS_PED_USING_ACTION_MODE(IS_PED_USING_ACTION_MODE()))
			{
				SET_PED_USING_ACTION_MODE(SET_PED_USING_ACTION_MODE(), true, -1, 0);
			}
		}
		else if (IS_PED_USING_ACTION_MODE(IS_PED_USING_ACTION_MODE()))
		{
	...
	if (func_308(PLAYER_PED_ID()))
	{
		...
		switch (iLocal_255)
		{
			...
			case 3:
				...
				SET_ENTITY_COORDS(iLocal_348, vLocal_373, 1, false, 0, 1);
			...
			case 2:
				if (func_308(iLocal_348))
				{
					if (func_488())
					{
						...
						REMOVE_WEAPON_FROM_PED(iLocal_348, joaat("weapon_sniperrifle"));
						TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_368, 1f, 60000, 0.25f, 512, Local_258[iLocal_335 /*10*/].f_6);
						SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
						iLocal_255 = 4;
					}
				}
			...
			case 4:
				...
				{
					if (IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 1.5f, 1.5f, 1.5f, false, true, 0))
					{
						CLEAR_PED_TASKS(iLocal_348);
						TASK_LOOK_AT_ENTITY(iLocal_348, TASK_LOOK_AT_ENTITY(), -1, 1024, 2);
						SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 1);
			...
			case 5:
				...
				{
					if (HAS_PED_GOT_WEAPON(iLocal_348, joaat("weapon_sniperrifle"), 0))
					{
						REMOVE_WEAPON_FROM_PED(iLocal_348, joaat("weapon_sniperrifle"));
					}
					if (func_488())
					{
						...
						{
							SET_ENTITY_VISIBLE(iLocal_346, false, 0);
						}
						func_354();
						func_353();
						func_8(&iLocal_263);
						CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
						SET_ENTITY_COORDS(iLocal_348, vLocal_368, 1, false, 0, 1);
			...
			case 6:
				...
				else if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_361, vLocal_362, 7f, 0, true, 0) && func_372())
				{
					if (func_485())
					{
						func_380();
			...
			case 12:
				if (func_371(&uLocal_89, cLocal_353, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_333 == -1)
					{
						iLocal_333 = ADD_NAVMESH_BLOCKING_OBJECT(vLocal_395, vLocal_396, 0f, 0, 7);
					}
					func_380();
					iLocal_301[9] = 1;
					func_226(0);
					...
					iLocal_328 = 0;
					TASK_LOOK_AT_ENTITY(iLocal_348, TASK_LOOK_AT_ENTITY(), -1, 1024, 2);
					TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_369, 1f, 60000, 0.25f, 512, fLocal_305);
					SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
					iLocal_255 = 14;
				}
				break;
			...
			case 13:
				if (!IS_PED_INJURED(iLocal_348))
				{
					if (func_488())
					{
						...
						CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
						SET_ENTITY_COORDS(iLocal_348, vLocal_369, 1, false, 0, 1);
			...
			case 14:
				if (GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7)
				{
					if (IS_ENTITY_AT_COORD(iLocal_348, vLocal_369, 1.25f, 1.25f, 2.5f, false, true, 0) && IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), vLocal_363, vLocal_364, 10f, 0, true, 0))
					{
						if (func_485())
						{
				...
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_363, vLocal_364, 10f, 0, true, 0))
				{
					...
					if (func_485())
					{
						...
						else if (iLocal_338 == 3)
						{
							...
							else if (!IS_PLAYER_FREE_AIMING(IS_PLAYER_FREE_AIMING()))
							{
			...
			case 16:
				if (func_477())
				{
					iLocal_331 = 0;
					func_458();
					TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[0 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
					SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 1);
					func_314(0, 0);
					iLocal_255 = 17;
				}
			...
			case 17:
				...
				if (!iLocal_301[15])
				{
					if (func_372())
					{
						if (!func_223())
						{
							if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), false), vLocal_358, true) > 10f)
							{
				...
				switch (iLocal_331)
				{
					case 0:
						...
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[1 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					...
					case 1:
						...
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[2 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					...
					case 2:
						...
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_420[3 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_331++;
						}
						break;
					...
					case 3:
						...
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_370, 1f, 60000, 0.25f, 512, fLocal_311);
							iLocal_331++;
						}
						break;
					
					case 4:
						if (GET_SCRIPT_TASK_STATUS(iLocal_348, 713668775) == 7 || (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) && GET_SCRIPT_TASK_STATUS(iLocal_348, vLocal_413, vLocal_414, 3.5f, 0, true, 0)))
						{
							SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
							iLocal_255 = 18;
						}
			...
			case 20:
				if (!IS_PED_INJURED(iLocal_348))
				{
					if (func_488())
					{
						...
						CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
						SET_ENTITY_COORDS(iLocal_348, vLocal_370, 1, false, 0, 1);
			...
			case 18:
				...
				{
					vVar0 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_413, vLocal_414, 3.5f, 0, true, 0) || vVar0.z > 41f)
					{
						if (func_371(&uLocal_89, cLocal_353, "HUNT_ROOF", 7, 0, 0, 0))
						{
							CLEAR_PED_TASKS(iLocal_348);
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_348, vLocal_372, 1f, 60000, 0.25f, 512, fLocal_313);
							iLocal_301[16] = 1;
							SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
							iLocal_255 = 21;
						}
					...
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iLocal_348, TASK_TURN_PED_TO_FACE_ENTITY(), -1);
					}
				}
				break;
			...
			case 23:
				if (func_477())
				{
					if (!func_223() && !func_313(PLAYER_PED_ID()))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iLocal_348, TASK_TURN_PED_TO_FACE_ENTITY(), -1);
						iLocal_301[20] = 1;
						iLocal_255 = 25;
			...
			case 24:
				...
				{
					CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
					SET_ENTITY_COORDS(iLocal_348, vLocal_417, 1, false, 0, 1);
					SET_ENTITY_HEADING(iLocal_348, fLocal_418);
					TASK_LOOK_AT_ENTITY(iLocal_348, TASK_LOOK_AT_ENTITY(), -1, 0, 2);
				...
				if (!func_223())
				{
					...
					else if (!func_223())
					{
						if (func_308(iLocal_348))
						{
							...
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_422, 1f, 60000, 0.25f, 0, 1193033728);
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_423, 1f, 60000, 0.25f, 0, 1193033728);
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_424, 1f, 60000, 0.25f, 0, 1193033728);
		...
		if (((iLocal_254 != 21 && !iLocal_301[20]) && iLocal_255 != 25) && iLocal_255 != 0)
		{
			if (!iLocal_280)
			{
				if (IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT()) || IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT()))
				{
				...
				if (((IS_ENTITY_DEAD(iLocal_348, 0) || IS_ENTITY_DEAD(iLocal_348, IS_ENTITY_DEAD(), 1)) || IS_ENTITY_DEAD(iLocal_348, 0, 2)) || IS_ENTITY_DEAD(-1, IS_ENTITY_DEAD(iLocal_348, false), 10f))
				{
					func_2();
					iLocal_324 = GET_GAME_TIMER() + 2400;
					iLocal_280 = 1;
			...
			else if (GET_GAME_TIMER() > iLocal_324)
			{
				...
				{
					if (!IS_ENTITY_DEAD(iLocal_348, 0))
					{
						CLEAR_PED_TASKS(iLocal_348);
						TASK_SMART_FLEE_PED(iLocal_348, TASK_SMART_FLEE_PED(), 100f, -1, 0, 0);
						SET_PED_KEEP_TASK(iLocal_348, true);
						func_318(2);
					}
					else
...
void func_459()
{
	...
	if (func_462())
	{
		...
		{
			if (DOES_ENTITY_EXIST(func_460(iVar1)))
			{
				iVar0 = GET_PED_INDEX_FROM_ENTITY_INDEX(func_460(iVar1));
				if (func_230(iVar0) || !func_230(iVar0))
				{
					if (IS_PED_MODEL(iVar0, iLocal_341))
					{
						if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iVar0, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
						{
...
void func_463()
{
	if (!IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && !IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		if (!iLocal_433)
		{
...
void func_464()
{
	if (!IS_PED_DEAD_OR_DYING(iLocal_348, 1) && !IS_PED_DEAD_OR_DYING(IS_PED_DEAD_OR_DYING(), 1))
	{
		if (IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (!iLocal_291)
...
void func_467()
{
	...
	if (func_308(PLAYER_PED_ID()) && func_308(iLocal_348))
	{
		if (IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_230(iLocal_426))
			{
				if (GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0) == iLocal_426 && GET_VEHICLE_PED_IS_IN(iLocal_348, 0) == iLocal_426)
				{
					if (!iLocal_431)
					{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		if (!iLocal_301[7])
		{
			if (!func_223())
			{
				if (func_372())
				{
					if (GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0) == iLocal_426)
					{
					...
					else if (ARE_ANY_VEHICLE_SEATS_FREE(ARE_ANY_VEHICLE_SEATS_FREE(ARE_ANY_VEHICLE_SEATS_FREE(), 0)))
					{
...
void func_471()
{
	if (!IS_PED_DEAD_OR_DYING(iLocal_348, 1) && !IS_PED_DEAD_OR_DYING(IS_PED_DEAD_OR_DYING(), 1))
	{
		if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_361, vLocal_362, 7f, 0, true, 0))
		{
			if (!IS_PED_IN_ANY_VEHICLE(iLocal_348, 0) && !IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
			{
				if (!iLocal_297)
				{
...
void func_475()
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_361, vLocal_362, 16f, 0, true, 0))
	{
...
void func_476()
{
	if (IS_PED_SITTING_IN_ANY_VEHICLE(IS_PED_SITTING_IN_ANY_VEHICLE()))
	{
		if (!iLocal_273)
		{
			iLocal_435 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
			if (!IS_PED_IN_ANY_VEHICLE(iLocal_348, 1))
			{
...
void func_478()
{
	...
	while (iVar0 < 3)
	{
		if (IS_BULLET_IN_AREA(Local_258[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_223())
			{
				if (!func_398("HT_SHDISH", 0, 0) || GET_PROFILE_SETTING(203) == 0)
				{
					if (!Local_258[iVar0 /*10*/].f_7)
					{
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_269)
						{
							if (!IS_ENTITY_AT_COORD(iLocal_348, vLocal_368, 1.5f, 1.5f, 1.5f, false, true, 0) || !IS_ENTITY_AT_COORD(iLocal_348, Local_258[iLocal_335 /*10*/].f_1, 30f))
							{
					...
					case 1:
						if (!IS_ENTITY_AT_COORD(iLocal_348, vLocal_369, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_482(iLocal_348, fLocal_305, 30f))
						{
							iLocal_328 = 1;
						}
						break;
					...
					case 2:
						if (!IS_ENTITY_AT_COORD(iLocal_348, vLocal_372, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_482(iLocal_348, fLocal_313, 30f))
						{
							iLocal_328 = 1;
						}
						break;
...
int func_485()
{
	if (func_308(PLAYER_PED_ID()))
	{
		if (GET_WEAPONTYPE_GROUP(func_486(GET_WEAPONTYPE_GROUP())) == -1212426201)
		{
			return 1;
		}
	}
...
void func_487(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!IS_SCRIPTED_CONVERSATION_ONGOING() && func_466(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
int func_488()
{
	if (DOES_ENTITY_EXIST(iLocal_346) && DOES_ENTITY_EXIST(iLocal_346, iLocal_348))
	{
		return 1;
	}
	if (!iLocal_265)
...
void func_491(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_308(iLocal_348) && func_308(PLAYER_PED_ID()))
	{
		if (func_462())
		{
			iVar1 = 0;
			while (iVar1 < func_461())
			{
				if (DOES_ENTITY_EXIST(func_460(iVar1)))
				{
					...
					{
						if ((!IS_ENTITY_A_MISSION_ENTITY(iVar0) && IS_ENTITY_A_MISSION_ENTITY(iVar0)) && IS_ENTITY_A_MISSION_ENTITY(iVar0))
						{
							if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iVar0, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
							{
								CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iVar0);
			...
			while (iVar1 < 5)
			{
				...
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar1 /*29*/].f_12, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
					{
...
void func_492()
{
	if (!IS_PED_INJURED(iLocal_348))
	{
		if (((IS_PROJECTILE_TYPE_IN_AREA(IS_PROJECTILE_TYPE_IN_AREA(iLocal_348, false) + Vector(2f, 2f, 2f), IS_PROJECTILE_TYPE_IN_AREA(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || IS_PROJECTILE_TYPE_IN_AREA(IS_PROJECTILE_TYPE_IN_AREA(iLocal_348, false) + Vector(2f, 2f, 2f), IS_PROJECTILE_TYPE_IN_AREA(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || IS_PROJECTILE_TYPE_IN_AREA(IS_PROJECTILE_TYPE_IN_AREA(iLocal_348, false) + Vector(2f, 2f, 2f), IS_PROJECTILE_TYPE_IN_AREA(iLocal_348, false) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || IS_PROJECTILE_TYPE_IN_AREA(-1, IS_PROJECTILE_TYPE_IN_AREA(iLocal_348, false), 10f))
		{
			CLEAR_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_261, 1862763509);
		}
		if (!iLocal_272)
		{
			if (func_494() || IS_PLAYER_FREE_AIMING_AT_ENTITY(IS_PLAYER_FREE_AIMING_AT_ENTITY(), iLocal_348))
			{
				if (func_223())
				{
					func_316();
...
int func_494()
{
	if (func_308(iLocal_348))
	{
		if (iLocal_255 != 25)
		{
			if ((!IS_PED_ARMED(IS_PED_ARMED(), 6) && IS_PED_ARMED(IS_PED_ARMED())) && func_373(iLocal_348, IS_PED_ARMED(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!IS_PED_ARMED(IS_PED_ARMED(), 6) && IS_PED_ARMED(IS_PED_ARMED())) && IS_PED_ARMED(IS_PED_ARMED(), iLocal_348, 30f)) && func_373(iLocal_348, IS_PED_ARMED(), 1) <= 2f)
		{
			return 1;
		}
	}
...
void func_495()
{
	if (!IS_PED_INJURED(iLocal_348))
	{
		if ((IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f) || iLocal_328 == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_346))
			{
				DELETE_OBJECT(&iLocal_346);
		...
		if (!DOES_ENTITY_EXIST(iLocal_346))
		{
			if (IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro", 3) && IS_ENTITY_PLAYING_ANIM(iLocal_348, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f)
			{
				iLocal_346 = CREATE_OBJECT(iLocal_342, CREATE_OBJECT(iLocal_348, true), false, false, false);
			}
		}
		else if (!IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_346, iLocal_348))
		{
			ATTACH_ENTITY_TO_ENTITY(iLocal_346, iLocal_348, ATTACH_ENTITY_TO_ENTITY(iLocal_348, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
{
	if (((!func_510(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_509(0)) || func_508(1))
			{
			}
			else
			{
...
void func_514()
{
	if (!iLocal_284)
	{
		...
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_261, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, iLocal_261);
...
int func_517(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 1:
			if ((!func_526(&iVar0) || !func_524(&(uParam0->f_48))) || !HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_77 = 2;
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				CLEAR_AREA_OF_VEHICLES(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, false, 0);
			}
			if (bVar2)
			{
				iLocal_77 = 3;
...
void func_529()
{
	...
	if (bLocal_264)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(iLocal_349, 0);
	}
	if (iLocal_293)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(iLocal_350, 0);
	}
...
int func_543(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_546())
	{
		...
		{
			iVar2 = func_302(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
