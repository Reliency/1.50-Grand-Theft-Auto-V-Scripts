...
void __EntryFunction__()
{
	...
	if (func_481(Local_53.f_35[0]))
	{
		...
		SET_VEHICLE_HAS_STRONG_AXLES(vLocal_54.x, true);
		SET_VEHICLE_DOORS_LOCKED(vLocal_54.x, 1);
	}
	if (func_479(PLAYER_PED_ID()))
	{
		iLocal_624 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
	}
	if (func_478(Local_53.f_28[0]))
	{
		Local_62 = Local_53.f_28[0];
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_62, true);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_62, iLocal_624);
		SET_PED_CONFIG_FLAG(Local_62, 132, true);
	}
	func_470();
...
void func_3(bool bParam0)
{
	if (bParam0)
	{
		...
		{
			if (IS_PED_IN_GROUP(Local_62))
			{
				REMOVE_PED_FROM_GROUP(Local_62);
			}
		}
	...
	else
	{
		...
		if (DOES_ENTITY_EXIST(vLocal_54.x))
		{
...
void func_23()
{
	switch (iLocal_70)
	{
		case 0:
			...
			{
				SET_VEHICLE_DOORS_LOCKED(Local_59, 1);
			}
			if (iLocal_127 != -1)
			{
		...
		case 1:
			...
			else
			{
				...
				if (func_239())
				{
					if (func_238(PLAYER_PED_ID(), vLocal_54.x, 1) > 300f && !PLAYER_PED_ID(vLocal_54.x))
					{
						OPEN_SEQUENCE_TASK(&iLocal_125);
						TASK_PLANE_MISSION(0, vLocal_54.x, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
						TASK_PLANE_MISSION(0, vLocal_54.x, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
						SET_SEQUENCE_TO_REPEAT(iLocal_125, 1);
						CLOSE_SEQUENCE_TASK(iLocal_125);
						TASK_PERFORM_SEQUENCE(Local_61, iLocal_125);
						CLEAR_SEQUENCE_TASK(&iLocal_125);
						iLocal_70 = 2;
					}
					if (((((!func_22() && !IS_PED_FLEEING(Local_61)) && !IS_PED_FLEEING(Local_61)) && !IS_PED_FLEEING(Local_61)) && !IS_PED_FLEEING(Local_61)) && !IS_PED_FLEEING(Local_61, 0))
					{
						if (func_238(Local_61, PLAYER_PED_ID(), 1) <= 2.3f)
						{
					...
					{
						case 0:
							if (IS_PED_SITTING_IN_VEHICLE(Local_61, vLocal_54.x))
							{
								iLocal_111++;
							}
							break;
						...
						case 1:
							if (!IS_PLAYBACK_GOING_ON_FOR_VEHICLE(vLocal_54.x))
							{
								if (HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff"))
								{
									START_PLAYBACK_RECORDED_VEHICLE(vLocal_54.x, 501, "Eps6_Takeoff", 1);
									_0x1F2E4E06DEA8992B(vLocal_54.x, 1);
							...
							else
							{
								...
								UNPAUSE_PLAYBACK_RECORDED_VEHICLE(vLocal_54.x);
								SET_HELI_BLADES_SPEED(vLocal_54.x, 1f);
								iLocal_111++;
								iLocal_112 = GET_GAME_TIMER();
							}
							break;
						...
						case 2:
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(vLocal_54.x))
							{
								...
								if (iLocal_113 == 0)
								{
									if ((GET_GAME_TIMER() - iLocal_112) > 23000)
									{
										...
										CONTROL_LANDING_GEAR(vLocal_54.x, 1);
										iLocal_113 = 1;
									}
								}
							}
							else
							{
								...
								{
									SET_VEHICLE_ENGINE_ON(vLocal_54.x, true, true, 0);
								}
								CLEAR_SEQUENCE_TASK(&iLocal_125);
								iLocal_111++;
							}
				...
				else
				{
					...
					iLocal_70 = 0;
					iLocal_69 = 6;
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 0))
					{
						bLocal_101 = true;
					}
					TRIGGER_MUSIC_EVENT("EPS_FAIL");
		...
		case 2:
			...
			if (!bLocal_80)
			{
				if (func_239())
				{
					if (GET_LANDING_GEAR_STATE(vLocal_54.x) != 4 || GET_LANDING_GEAR_STATE(vLocal_54.x) != 1)
					{
...
void func_30()
{
	...
	{
		func_25(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_97(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_97(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_97(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_88(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_97(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_73(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_74(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_108(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_108(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_97(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_170(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_97(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_97(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_177()
{
	...
	{
		if (func_172(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_188()
{
	...
	{
		func_177();
		_0xBF59707B3E5ED531(func_189(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
int func_239()
{
	if (func_481(vLocal_54.x))
	{
		if (GET_LANDING_GEAR_STATE(vLocal_54.x) == 5)
		{
			func_521("Detected plane landing gear is broken");
			return 0;
		}
		else if (IS_VEHICLE_STUCK_ON_ROOF(vLocal_54.x))
		{
			func_521("Detected plane is stuck on roof");
			return 0;
		}
		else if (GET_VEHICLE_ENGINE_HEALTH(vLocal_54.x) <= 0f)
		{
			func_521("Detected plane engine health is <= 0");
			return 0;
		}
		else if (IS_VEHICLE_STUCK_TIMER_UP(vLocal_54.x, 3, 30000))
		{
...
void func_240()
{
	...
	{
		if (func_244(Local_61, 0, 1116471296, 1126825984, 1, 0, 0, 0) || IS_BULLET_IN_AREA(IS_BULLET_IN_AREA(Local_61, true), 3f, 1))
		{
		...
		else if ((func_241(PLAYER_PED_ID(), Local_61, 1) || PLAYER_PED_ID(PLAYER_PED_ID(Local_61, true), 3f, 0)) || PLAYER_PED_ID(Local_61))
		{
			if (iLocal_69 != 5 && iLocal_69 != 3)
			{
				bLocal_101 = true;
		...
		else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_61, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
		{
			if (HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_61, 0, 2))
			{
				if (iLocal_69 != 5 && iLocal_69 != 3)
				{
					bLocal_101 = true;
...
{
	if (func_479(iParam0) && IS_PED_IN_ANY_VEHICLE(iParam0, 0))
	{
		if (func_479(iParam1))
		{
...
void func_242()
{
	if (func_478(Local_61))
	{
		CLEAR_PED_TASKS(Local_61);
		SET_PED_KEEP_TASK(Local_61, true);
		TASK_SMART_FLEE_PED(Local_61, TASK_SMART_FLEE_PED(), 100f, -1, 0, 0);
	}
}
...
int func_244(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_478(PLAYER_PED_ID()) && func_478(iParam0))
	{
		...
		if (!IS_PED_ARMED(IS_PED_ARMED(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT()))
			{
				...
				{
					return func_257(PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_245(int iParam0, float fParam1)
{
	...
	if (func_478(PLAYER_PED_ID()) && func_478(iParam0))
	{
		if (func_256(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 6))
			{
				fVar0 = 40f;
...
int func_251(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_253(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_253(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_261(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_253(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_266()
{
	if (func_239())
	{
		if (IS_PROJECTILE_TYPE_WITHIN_DISTANCE(IS_PROJECTILE_TYPE_WITHIN_DISTANCE(vLocal_54.x, false), joaat("weapon_stickybomb"), 10f, 0))
		{
...
void func_269()
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			while ((!HAS_MODEL_LOADED(iLocal_626) || !HAS_MODEL_LOADED(iLocal_625)) || !HAS_MODEL_LOADED("rcm_epsilonism4"))
			{
		...
		case 2:
			...
			if (func_239())
			{
				if (!func_268())
				{
					func_273(GET_ENTITY_COORDS(vLocal_54.x, true), 200f, 12, 5000, 0, 0);
				}
				if (func_239())
				{
					FREEZE_ENTITY_POSITION(vLocal_54.x, false);
					if (HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Eps6_LandingSkip"))
					{
						if (!IS_PLAYBACK_GOING_ON_FOR_VEHICLE(vLocal_54.x))
						{
							if (!func_268())
							{
								...
								START_PLAYBACK_RECORDED_VEHICLE(vLocal_54.x, 500, "Eps6_LandingSkip", 1);
							}
						}
					}
				}
		...
		case 3:
			...
			func_272(55);
			while (((!HAS_MODEL_LOADED(iLocal_625) || !HAS_MODEL_LOADED(Local_59.f_1)) || !HAS_MODEL_LOADED(Local_61.f_6)) || !func_271(55))
			{
		...
		case 4:
			...
			REQUEST_MODEL(Local_59.f_1);
			REQUEST_MODEL(vLocal_54.y);
			REQUEST_ANIM_DICT(Local_61.f_6);
			REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
			func_272(55);
			if (!func_268())
			{
				while (((((!HAS_MODEL_LOADED(Local_59.f_1) || !HAS_MODEL_LOADED()) || !HAS_MODEL_LOADED(vLocal_54.y)) || !HAS_MODEL_LOADED(Local_61.f_6)) || !HAS_MODEL_LOADED(501, "Eps6_Takeoff")) || !func_271(55))
				{
			...
			{
				while ((((!HAS_MODEL_LOADED(Local_59.f_1) || !HAS_MODEL_LOADED(vLocal_54.y)) || !HAS_MODEL_LOADED(Local_61.f_6)) || !HAS_MODEL_LOADED(501, "Eps6_Takeoff")) || !func_271(55))
				{
					func_521("WAITING FOR MS_ENDCUTSCENE RESOURCES");
					wait(0);
				}
			...
			if (iLocal_127 == -1)
			{
				iLocal_127 = ADD_NAVMESH_BLOCKING_OBJECT(1687.954f, 3277.727f, 40.25f, 6f, 6f, 6f, 0f, 0, 7);
...
void func_270()
{
	switch (iLocal_69)
	{
		...
		case 5:
			if (!func_481(Local_59))
			{
				Local_59 = CREATE_VEHICLE(Local_59.f_1, Local_59.f_3, Local_59.f_6, true, true, false);
				SET_VEHICLE_ON_GROUND_PROPERLY(Local_59, 1084227584);
				SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Local_59, 1);
				SET_VEHICLE_DIRT_LEVEL(Local_59, 13f);
				SET_VEHICLE_COLOURS(Local_59, 157, 157);
				SET_VEHICLE_EXTRA_COLOURS(Local_59, 157, 5);
			}
			break;
		...
		default:
			if (!func_481(Local_59))
			{
				...
				SET_VEHICLE_ON_GROUND_PROPERLY(Local_59, 1084227584);
				SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Local_59, 1);
				SET_VEHICLE_DOORS_LOCKED(Local_59, 3);
				SET_VEHICLE_DIRT_LEVEL(Local_59, 13f);
				SET_VEHICLE_COLOURS(Local_59, 157, 157);
				SET_VEHICLE_EXTRA_COLOURS(Local_59, 157, 5);
			}
...
int func_271(int iParam0)
{
	if (!func_174(iParam0))
	{
		return HAS_MODEL_LOADED(func_522(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_272(int iParam0)
{
	if (!func_174(iParam0))
	{
		REQUEST_MODEL(func_522(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_281()
{
	switch (iLocal_69)
	{
		case 0:
			if (func_478(Local_62))
			{
				SET_ENTITY_HEADING(Local_62, 254.1723f);
				SET_ENTITY_COORDS(Local_62, -2881.755f, 3188.125f, 10.1136f, 1, false, 0, 1);
				CLEAR_PED_TASKS(Local_62);
				func_282();
			}
			else
			{
				func_4(&Local_62);
				Local_62 = CREATE_PED(26, iLocal_626, -2881.755f, 3188.125f, 10.1136f, 254.1723f, 1, true);
				SET_PED_DEFAULT_COMPONENT_VARIATION(Local_62);
				func_282();
			}
			if (func_478(Local_62))
			{
				SET_PED_MAX_MOVE_BLEND_RATIO(Local_62, 0f);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_62, true);
				SET_PED_CONFIG_FLAG(Local_62, 167, true);
				STOP_PED_SPEAKING(Local_62, true);
				SET_PED_DIES_WHEN_INJURED(Local_62, true);
				SET_PED_CAN_BE_TARGETTED(Local_62, false);
				SET_PED_CONFIG_FLAG(Local_62, 185, true);
				SET_PED_CONFIG_FLAG(Local_62, 188, false);
				SET_PED_RELATIONSHIP_GROUP_HASH(Local_62, iLocal_624);
				SET_PED_CONFIG_FLAG(Local_62, 132, true);
		...
		case 1:
			...
			{
				SET_ENTITY_HEADING(Local_62, 254.1723f);
				SET_ENTITY_COORDS(Local_62, -2889.89f, 3198.69f, 10.11f, 1, false, 0, 1);
				CLEAR_PED_TASKS(Local_62);
			}
			else
			{
				func_4(&Local_62);
				Local_62 = CREATE_PED(26, iLocal_626, -2889.89f, 3198.69f, 10.11f, 254.1723f, 1, true);
				SET_PED_DEFAULT_COMPONENT_VARIATION(Local_62);
			}
			if (func_478(Local_62))
			{
...
void func_282()
{
	GIVE_WEAPON_TO_PED(Local_62, joaat("weapon_digiscanner"), 0, true, true);
	SET_PED_CAN_SWITCH_WEAPON(Local_62, false);
	STOP_PED_SPEAKING(Local_62, true);
	SET_PED_DIES_WHEN_INJURED(Local_62, true);
	SET_PED_CAN_BE_TARGETTED(Local_62, false);
	OPEN_SEQUENCE_TASK(&iLocal_125);
	TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, false, 0.5f, 4f, 1, 0, 0, -957453492);
	TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, false, 0.5f, 4f, 1, 0, 0, -957453492);
	TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, false, 0.5f, 4f, 1, 0, 0, -957453492);
	TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	SET_SEQUENCE_TO_REPEAT(iLocal_125, 1);
	CLOSE_SEQUENCE_TASK(iLocal_125);
	TASK_PERFORM_SEQUENCE(Local_62, iLocal_125);
}
...
void func_283()
{
	switch (iLocal_69)
	{
		case 0:
			if (DOES_ENTITY_EXIST(vLocal_54.x))
			{
				if (func_478(PLAYER_PED_ID()))
				{
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 0))
					{
						func_284(PLAYER_PED_ID(), -2882.42f, 3197.76f, 10.74f, 0, 0, 1);
					}
				}
				DELETE_VEHICLE(&vLocal_54);
			}
			vLocal_54.x = CREATE_VEHICLE(iLocal_625, -2892.93f, 3192.37f, 11.66f, -132.35f, false, false, false);
			SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
			ADD_VEHICLE_UPSIDEDOWN_CHECK(vLocal_54.x);
			SET_VEHICLE_COLOURS(vLocal_54.x, 157, 157);
			SET_VEHICLE_EXTRA_COLOURS(vLocal_54.x, 157, 5);
			SET_VEHICLE_LIVERY(vLocal_54.x, 3);
			SET_VEHICLE_ENGINE_CAN_DEGRADE(vLocal_54.x, false);
			SET_VEHICLE_HAS_STRONG_AXLES(vLocal_54.x, true);
			func_480(vLocal_54.x, 0);
		...
		case 2:
			...
			{
				SET_VEHICLE_DOORS_LOCKED(vLocal_54.x, 1);
				SET_ENTITY_HEADING(vLocal_54.x, 290.823f);
				SET_VEHICLE_ENGINE_ON(vLocal_54.x, true, true, 0);
				SET_VEHICLE_FORWARD_SPEED(vLocal_54.x, 75f);
				SET_VEHICLE_ENGINE_CAN_DEGRADE(vLocal_54.x, false);
				SET_VEHICLE_HAS_STRONG_AXLES(vLocal_54.x, true);
				CONTROL_LANDING_GEAR(vLocal_54.x, 3);
				FREEZE_ENTITY_POSITION(vLocal_54.x, true);
			}
			else
			{
				vLocal_54.x = CREATE_VEHICLE(iLocal_625, 595.7562f, 2926.42f, 173.2301f, 283.3833f, false, false, false);
				SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
				ADD_VEHICLE_UPSIDEDOWN_CHECK(vLocal_54.x);
				SET_VEHICLE_COLOURS(vLocal_54.x, 157, 157);
				SET_VEHICLE_EXTRA_COLOURS(vLocal_54.x, 157, 5);
				...
				if (!func_268())
				{
					SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), vLocal_54.x, -1);
				}
				CONTROL_LANDING_GEAR(vLocal_54.x, 3);
				FREEZE_ENTITY_POSITION(vLocal_54.x, true);
		...
		case 4:
			...
			if (func_481(vLocal_54.x))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(vLocal_54.x))
				{
					STOP_PLAYBACK_RECORDED_VEHICLE(vLocal_54.x);
				}
				func_5(&vLocal_54);
			}
			vLocal_54.x = CREATE_VEHICLE(vLocal_54.y, 1684.78f, 3255.58f, 41.78f, 284.26f, true, true, false);
			if (func_481(vLocal_54.x))
			{
				SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
				ADD_VEHICLE_UPSIDEDOWN_CHECK(vLocal_54.x);
				SET_VEHICLE_DOORS_LOCKED(vLocal_54.x, 3);
				SET_VEHICLE_COLOURS(vLocal_54.x, 157, 157);
				SET_VEHICLE_EXTRA_COLOURS(vLocal_54.x, 157, 5);
				SET_VEHICLE_LIVERY(vLocal_54.x, 3);
				SET_VEHICLE_ENGINE_CAN_DEGRADE(vLocal_54.x, false);
		...
		case 5:
			...
			if (!bLocal_80)
			{
				...
				vLocal_54.x = CREATE_VEHICLE(vLocal_54.y, 1674.91f, 3252.47f, 41.69f, 284.26f, true, true, false);
				if (func_481(vLocal_54.x))
				{
					SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
					ADD_VEHICLE_UPSIDEDOWN_CHECK(vLocal_54.x);
				...
				if (!IS_PLAYBACK_GOING_ON_FOR_VEHICLE(vLocal_54.x))
				{
					if (HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff"))
					{
						START_PLAYBACK_RECORDED_VEHICLE(vLocal_54.x, 501, "Eps6_Takeoff", 1);
						_0x1F2E4E06DEA8992B(vLocal_54.x, 1);
						PAUSE_PLAYBACK_RECORDED_VEHICLE(vLocal_54.x);
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(vLocal_54.y, true);
}
	...
	switch (iLocal_69)
	{
		...
		case 4:
			if (!func_478(Local_61))
			{
				...
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_61, true);
				SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_61, 0);
				SET_PED_CAN_BE_TARGETTED(Local_61, false);
				SET_PED_CONFIG_FLAG(Local_61, 185, true);
				SET_PED_PROP_INDEX(Local_61, 1, 0, 0, false);
				SET_PED_RELATIONSHIP_GROUP_HASH(Local_61, iLocal_624);
				SET_PED_CONFIG_FLAG(Local_61, 132, true);
				TASK_PLAY_ANIM(Local_61, Local_61.f_6, Local_61.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
			}
			else
			{
			...
			{
				iLocal_126 = CREATE_OBJECT(joaat("p_amb_phone_01"), CREATE_OBJECT(Local_61, true), true, true, false);
			}
			if (!IS_ENTITY_ATTACHED(iLocal_126))
			{
				ATTACH_ENTITY_TO_ENTITY(iLocal_126, Local_61, ATTACH_ENTITY_TO_ENTITY(Local_61, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
			}
			func_288(55);
			break;
			...
			if (!bLocal_80)
			{
				if (!func_478(Local_61))
				{
					...
					if (func_478(Local_61) && func_239())
					{
						...
						TASK_ENTER_VEHICLE(0, vLocal_54.x, 20000, -1, 2f, 1, 0);
						CLOSE_SEQUENCE_TASK(iLocal_125);
						TASK_PERFORM_SEQUENCE(Local_61, iLocal_125);
						CLEAR_SEQUENCE_TASK(&iLocal_125);
					}
					_0x2208438012482A1A(Local_61, 0, 0);
				}
				else
				{
					...
					_0x2208438012482A1A(Local_61, 1, 0);
				}
				func_286(&iLocal_126);
			}
			else
...
void func_288(int iParam0)
{
	if (!func_174(iParam0))
	{
		SET_MODEL_AS_NO_LONGER_NEEDED(func_522(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_292()
{
	switch (iLocal_69)
	{
		case 0:
			...
			if (!func_268())
			{
				func_284(PLAYER_PED_ID(), -2914.707f, 3234.639f, 9.7863f, 215.2149f, 0, 1);
			}
			break;
		...
		case 1:
			if (func_481(vLocal_54.x))
			{
				func_284(PLAYER_PED_ID(), -2892.93f, 3192.37f, 11.66f, 0, 0, 1);
				SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), vLocal_54.x, -1);
			}
			break;
		...
		case 2:
			if (!func_268())
			{
				if (func_478(PLAYER_PED_ID()) && func_481(vLocal_54.x))
				{
					if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 0))
					{
						SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), vLocal_54.x, -1);
					}
					SET_PED_COORDS_KEEP_VEHICLE(SET_PED_COORDS_KEEP_VEHICLE(), 376.0205f, 2886.552f, 171.3085f);
				}
			}
			break;
		...
		case 4:
			if (!func_268())
			{
				func_284(PLAYER_PED_ID(), 1681.54f, 3259.38f, 39.77f, 298.33f, 0, 1);
			}
			break;
		...
		case 5:
			if (!func_268())
			{
				func_284(PLAYER_PED_ID(), 1688.45f, 3277.15f, 40.08f, 131.1749f, 1, 1);
			}
			break;
	}
	SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
void func_293(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_365(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
...
{
	func_295(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_304(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_307(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_318(int iParam0, bool bParam1)
{
	...
	iVar0 = func_171(iParam0);
	if (func_174(iVar0) && !IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER_PED_ID())
		{
...
void func_319(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_324(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_321(Var7.f_1)) && iVar9 < 51)
			{
...
int func_331(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_31() == 0)
		{
			return IS_BIT_SET(func_92(func_332(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_368()
{
	switch (iLocal_70)
	{
		case 0:
			...
			{
				SET_ROADS_IN_ANGLED_AREA(1775.157f, 3373.425f, 37.24686f, 1893.735f, 3203.022f, 48.48723f, 96.5f, 0, false, 1);
				func_16(&(vLocal_54.f_2));
				if (func_239())
				{
					SET_ENTITY_COORDS(vLocal_54.x, 1674.91f, 3252.47f, 41.69f, 1, false, 0, 1);
					SET_ENTITY_HEADING(vLocal_54.x, 284.26f);
					SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
				}
				else
				{
				...
				if (func_478(Local_61))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_61, "Jimmy_Boston", 0, 0, 0);
				}
				if (func_478(PLAYER_PED_ID()))
				{
				...
				{
					REGISTER_ENTITY_FOR_CUTSCENE(vLocal_54.x, "ep_plane", 0, 0, 0);
				}
		...
		case 2:
			...
			{
				_0x1EE7D8DF4425F053(iLocal_124);
			}
...
void func_378()
{
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ep_plane", 0))
	{
		...
		if (func_239())
		{
			SET_ENTITY_COORDS(vLocal_54.x, 1684.78f, 3255.58f, 41.78f, 1, false, 0, 1);
			SET_ENTITY_HEADING(vLocal_54.x, 284.26f);
			SET_VEHICLE_ON_GROUND_PROPERLY(vLocal_54.x, 1084227584);
		}
		else
...
void func_379()
{
	if (func_478(Local_61))
	{
		if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			...
			FORCE_PED_MOTION_STATE(Local_61, -530524, false, 1, 0);
		}
	}
}
...
int func_380()
{
	if (func_478(PLAYER_PED_ID()))
	{
		...
		{
			FORCE_PED_MOTION_STATE(FORCE_PED_MOTION_STATE(), -1871534317, false, 1, 0);
			SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
			TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_61, -1, 0, 2);
...
void func_383(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_384(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_394(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_398(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_397(PLAYER_PED_ID(), -828834893))
				{
...
void func_400()
{
	switch (iLocal_70)
	{
		case 0:
			...
			REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
			while ((((!func_271(55) || !HAS_ANIM_DICT_LOADED(Local_61.f_6)) || !HAS_ANIM_DICT_LOADED(Local_59.f_1)) || !HAS_ANIM_DICT_LOADED(joaat("p_amb_phone_01"))) || !HAS_ANIM_DICT_LOADED(501, "Eps6_Takeoff"))
			{
				wait(0);
			}
			if (iLocal_79)
			...
			if (func_239())
			{
				SET_VEHICLE_ENGINE_ON(vLocal_54.x, false, false, 0);
			}
			if (!DOES_BLIP_EXIST(Local_61.f_1))
			{
				Local_61.f_1 = func_287(Local_61, 1, 1, 9);
			...
			if (_0xB56BBBCC2955D9CB())
			{
				...
				if (func_478(PLAYER_PED_ID()))
				{
					func_407("Michael", PLAYER_PED_ID(), 0, 2);
				}
				SET_CUTSCENE_PED_PROP_VARIATION("Jimmy_Boston", 1, 0, 0, 0);
			}
			if (iLocal_127 == -1)
		...
		case 1:
			...
			if (func_478(Local_61))
			{
				if (func_238(PLAYER_PED_ID(), Local_61, 1) < 100f)
				{
				...
				else if (func_238(PLAYER_PED_ID(), Local_61, 1) > 120f)
				{
					if (HAS_CUTSCENE_LOADED())
					{
			...
			if (func_239())
			{
				...
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					...
					if (func_401(PLAYER_PED_ID(), Local_61, 13f, 1))
					{
						if (!IS_VEHICLE_STOPPED(IS_VEHICLE_STOPPED(IS_VEHICLE_STOPPED(), 0)))
						{
							BRING_VEHICLE_TO_HALT(BRING_VEHICLE_TO_HALT(BRING_VEHICLE_TO_HALT(), 0), 2f, -1, 0);
						}
						else
						{
							TASK_LEAVE_ANY_VEHICLE(TASK_LEAVE_ANY_VEHICLE(), 0, 0);
							while (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
							{
								wait(0);
							}
							iLocal_70 = 2;
				...
				else if (func_401(PLAYER_PED_ID(), Local_61, 5f, 1))
				{
					if (func_478(PLAYER_PED_ID()) && func_478(Local_61))
					{
						vLocal_628 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
						vLocal_629 = { GET_ENTITY_COORDS(Local_61, true) };
						if (((vLocal_628.z - vLocal_629.z) < 1.5f && !IS_PED_FALLING(IS_PED_FALLING())) && !IS_PED_FALLING(IS_PED_FALLING()))
						{
							iLocal_70 = 2;
						}
					}
...
void func_402()
{
	if (func_238(PLAYER_PED_ID(), Local_61, 1) <= 15f)
	{
		if (!_0xBC9823AB80A3DCAC())
		{
			if (!_0x7D41E9D2D17C5B2D(iLocal_124))
			{
				func_521("Loading streamvol");
				iLocal_124 = _0x1F3F018BC3AFA77C(1684.85f, 3276.16f, 39.93f, func_403(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
			}
		}
	}
...
void func_404()
{
	...
	if (func_478(Local_61) && func_478(PLAYER_PED_ID()))
	{
		fVar0 = GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(Local_61, true), true);
	}
	if (fVar0 < 50f)
	{
		fLocal_118 = 100f;
	...
	if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(Local_61, true), true) > fLocal_118)
	{
		if (!iLocal_84)
		{
		...
		else if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(Local_61, true), true) > fLocal_119)
		{
			iLocal_128 = 2;
			iLocal_70 = 0;
			iLocal_69 = 6;
...
void func_406()
{
	if (func_478(Local_61))
	{
		if (func_238(PLAYER_PED_ID(), Local_61, 1) <= 15f)
		{
			if (!IS_PED_HEADTRACKING_PED(Local_61, IS_PED_HEADTRACKING_PED()))
			{
				func_521("Jimmy headlooking");
				TASK_LOOK_AT_ENTITY(Local_61, TASK_LOOK_AT_ENTITY(), -1, 2096, 2);
			}
		}
		else if (func_238(PLAYER_PED_ID(), Local_61, 1) <= 25f && func_22())
		{
			if (!IS_PED_HEADTRACKING_PED(Local_61, IS_PED_HEADTRACKING_PED()))
			{
		...
		else if (IS_PED_HEADTRACKING_PED(Local_61, IS_PED_HEADTRACKING_PED()) && !func_22())
		{
			func_521("Clear Jimmy headlook");
			TASK_CLEAR_LOOK_AT(Local_61);
		}
	}
	if (!func_22() && !IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_478(Local_61) && func_478(PLAYER_PED_ID()))
		{
			if (func_401(PLAYER_PED_ID(), Local_61, 25f, 1))
			{
	...
	switch (iLocal_70)
	{
			...
			if (func_239())
			{
				...
				if (iLocal_98 == 0)
				{
					if (func_421(vLocal_54.x, Local_60, 1) < 350f)
					{
						...
						if (((HAS_MODEL_LOADED(Local_59.f_1) && func_271(55)) && HAS_MODEL_LOADED(Local_61.f_6)) && HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
						{
							func_285();
							func_270();
							func_15(&uLocal_459, 3, Local_61, "JIMMYBOSTON", 0, 1);
				...
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 0))
				{
					...
					{
						if (IS_ENTITY_IN_ANGLED_AREA(vLocal_54.x, vLocal_121, vLocal_122, 33.25f, 0, true, 2))
						{
				...
				{
					if (!DOES_BLIP_EXIST(vLocal_54.z))
					{
					...
					func_16(&(Local_60.f_3));
					if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(vLocal_54.x, true), true) > 80f)
					{
						if (func_421(vLocal_54.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							...
							else if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(vLocal_54.x, true), true) > 150f)
							{
								if (func_414())
								{
									bLocal_101 = true;
						...
						else if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(vLocal_54.x, true), true) > 250f)
						{
							if (func_414())
							{
								bLocal_101 = true;
		...
		case 2:
			if (func_481(vLocal_54.x))
			{
				...
				{
					func_16(&(vLocal_54.f_2));
					if (GET_LANDING_GEAR_STATE(vLocal_54.x) == 0 || GET_LANDING_GEAR_STATE(vLocal_54.x) == 3)
					{
						if (!DOES_BLIP_EXIST(Local_61.f_1))
						{
							Local_61.f_1 = func_287(Local_61, 1, 1, 9);
						...
						if (func_413() && !IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 0))
						{
							func_521("*** Finishing Landing cleanup");
							func_412("*** Plane 'entity' health: ", GET_ENTITY_HEALTH(vLocal_54.x));
							func_411("*** Plane engine health: ", GET_VEHICLE_ENGINE_HEALTH(vLocal_54.x));
							func_411("*** Plane petrol tank health: ", GET_VEHICLE_PETROL_TANK_HEALTH(vLocal_54.x));
							if ((GET_ENTITY_HEALTH(vLocal_54.x) == 1000 && GET_ENTITY_HEALTH(vLocal_54.x) == 1000f) && GET_ENTITY_HEALTH(vLocal_54.x) == 1000f)
							{
								func_410(751);
							}
							func_16(&(Local_60.f_3));
					...
					if ((GET_LANDING_GEAR_STATE(vLocal_54.x) == 1 || GET_LANDING_GEAR_STATE(vLocal_54.x) == 4) || GET_LANDING_GEAR_STATE(vLocal_54.x) == 5)
					{
				...
				else
				{
					...
					SET_VEHICLE_ENGINE_ON(vLocal_54.x, true, false, 0);
					SET_VEHICLE_DOORS_LOCKED(vLocal_54.x, 1);
					iLocal_70 = 1;
				}
			}
...
int func_413()
{
	...
	if (func_239())
	{
		fVar0 = GET_ENTITY_SPEED(vLocal_54.x);
...
void func_418()
{
	if (func_478(Local_61))
	{
			...
			if (!bLocal_92)
			{
				if (!func_22())
				{
					if (func_222(&uLocal_459, "EPS6AUD", "EPS6_CLOSE", 9, 0, 0, 0))
					{
						...
						CLEAR_PED_TASKS(Local_61);
						TASK_LOOK_AT_ENTITY(Local_61, TASK_LOOK_AT_ENTITY(), 10000, 48, 2);
		...
		else if (!IS_ENTITY_PLAYING_ANIM(Local_61, Local_61.f_6, Local_61.f_7, 3))
		{
...
void func_422()
{
	if (func_239())
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 0))
		{
			if ((IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -2611.599f, 2953.922f, 10.79497f, -2698.713f, 2367.25f, -0.336048f, 3f, 0, true, 0) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1506.538f, 2717.231f, 15.28982f, -1377.953f, 2609.015f, 0.028772f, 3f, 0, true, 0)) || IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -395.9501f, 2960.714f, 23.47385f, -426.3539f, 2966.561f, 14.00403f, 3f, 0, true, 0))
			{
				if (!iLocal_627)
				{
					iLocal_627 = 1;
...
void func_423()
{
	...
	if (iLocal_69 >= 1)
	{
		...
		if (func_22())
		{
			...
			{
				if (func_421(PLAYER_PED_ID(), vVar0, 1) > 35f)
				{
					if (func_22())
					{
		...
		if (func_421(PLAYER_PED_ID(), vVar0, 1) > 450f)
		{
			func_7(&Local_62, 1, 0, 1);
		}
	}
	...
	switch (iLocal_73)
	{
		case 0:
			...
			else if (iLocal_74 == 1)
			{
				...
				{
					case 0:
						if (func_238(PLAYER_PED_ID(), Local_62, 1) < 50f)
						{
							if (!func_22())
							{
				...
				if (func_478(PLAYER_PED_ID()) && func_481(vLocal_54.x))
				{
					if (func_238(PLAYER_PED_ID(), Local_62, 1) < 10f || func_238(PLAYER_PED_ID(), vLocal_54.x, 1) < 10f)
					{
						if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, true, 0))
						{
							if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
							{
								func_264(2);
		...
		case 1:
			if (iLocal_74 == 0)
			{
				...
				{
					CLEAR_PED_TASKS(Local_62);
					TASK_TURN_PED_TO_FACE_ENTITY(Local_62, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
			...
			{
				if ((func_478(PLAYER_PED_ID()) && func_481(vLocal_54.x)) && func_479(Local_62))
				{
					if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
					{
						if (func_238(PLAYER_PED_ID(), Local_62, 1) < 15f || func_238(PLAYER_PED_ID(), vLocal_54.x, 1) < 10f)
						{
							if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, true, 0))
							{
								func_264(2);
			...
			if (iLocal_74 == 0)
			{
				if (func_478(Local_62))
				{
					...
					if (IS_MESSAGE_BEING_DISPLAYED())
					{
						...
						TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_62, -1, 0, 2);
						TASK_LOOK_AT_ENTITY(Local_62, TASK_LOOK_AT_ENTITY(), -1, 0, 2);
			...
			else if (iLocal_74 == 1)
			{
				...
				else if ((GET_GAME_TIMER() - iLocal_116) > 1000 || iLocal_116 == 0)
				{
					...
					if (func_415("EPS6_SPOT"))
					{
						...
						{
							if (func_429(Local_62, PLAYER_PED_ID()) > 10f)
							{
								func_20();
								bLocal_96 = true;
							}
				...
				{
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 1))
					{
						if (func_22())
						{
							func_20();
		...
		case 3:
			if (iLocal_74 == 0)
			{
				...
				if (iLocal_102 == 0)
				{
					...
					{
						CLEAR_PED_TASKS(Local_62);
						TASK_HANDS_UP(Local_62, -1, TASK_HANDS_UP(), -1, 1);
					}
					iLocal_107 = -1;
					iLocal_74 = 1;
				}
		...
		case 5:
			if (iLocal_74 == 0)
			{
				...
				TASK_TURN_PED_TO_FACE_ENTITY(Local_62, TASK_TURN_PED_TO_FACE_ENTITY(), -1);
				iLocal_74 = 1;
			}
			else if (iLocal_74 == 1)
			{
				if (iLocal_81 == 0)
				{
					if ((!IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !IS_MESSAGE_BEING_DISPLAYED(IS_MESSAGE_BEING_DISPLAYED(), vLocal_54.x, 1))
					{
						_0x293220DA1B46CEBC(3f, 10f, 1);
		...
		case 4:
			if (iLocal_74 == 0)
			{
				if (func_479(Local_62))
				{
					...
					{
						CLEAR_PED_TASKS(Local_62);
						TASK_CLEAR_LOOK_AT(Local_62);
						OPEN_SEQUENCE_TASK(&iLocal_125);
						TASK_LOOK_AT_ENTITY(0, TASK_LOOK_AT_ENTITY(), -1, 0, 2);
						TASK_PLAY_ANIM(0, "gestures@m@standing@casual", "gesture_bye_soft", 8f, -8f, -1, 0, 0, 0, 0, 0);
			...
			else if (iLocal_74 == 1)
			{
				if (iLocal_69 == 0)
				{
					if (iLocal_81 == 0)
					{
						if ((!func_415("EPS6_SPOT") && !IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 1)) && !IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE()))
						{
							func_426("EPS6_GETIN", 7500, 1);
...
void func_425()
{
	...
	if (func_479(Local_62))
	{
		...
		TASK_SMART_FLEE_PED(Local_62, TASK_SMART_FLEE_PED(), 500f, -1, 0, 0);
		func_16(&(Local_62.f_1));
	}
}
...
int func_431()
{
	if (func_239() && func_478(Local_62))
	{
		if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 1))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_54.x, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
			{
				func_521("Player damaged plane");
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(vLocal_54.x);
				return 1;
			}
		}
	}
...
void func_433()
{
	if (iLocal_73 == 2)
	{
		switch (iLocal_75)
		{
			...
			case 1:
				if (func_478(Local_62) && func_478(PLAYER_PED_ID()))
				{
					CLEAR_PED_TASKS(Local_62);
					vLocal_628 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
					OPEN_SEQUENCE_TASK(&iLocal_125);
					TASK_LOOK_AT_ENTITY(0, TASK_LOOK_AT_ENTITY(), -1, 0, 2);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_628, 1f, 20000, 1048576000, 0, 1193033728);
					CLOSE_SEQUENCE_TASK(iLocal_125);
					TASK_PERFORM_SEQUENCE(Local_62, iLocal_125);
					CLEAR_SEQUENCE_TASK(&iLocal_125);
					iLocal_75 = 2;
			...
			case 2:
				if (func_478(Local_62) && func_478(PLAYER_PED_ID()))
				{
					if (func_238(Local_62, PLAYER_PED_ID(), 1) < 5f || PLAYER_PED_ID(Local_62, 242628503) == 7)
					{
						CLEAR_PED_TASKS(Local_62);
						TASK_TURN_PED_TO_FACE_ENTITY(Local_62, TASK_TURN_PED_TO_FACE_ENTITY(), -1);
						iLocal_75 = 0;
	...
	if (func_478(Local_62))
	{
		switch (iLocal_76)
		{
			case 0:
				...
				if (HAS_ANIM_DICT_LOADED("rcmepsilonism6") && !HAS_ANIM_DICT_LOADED(Local_62, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					TASK_PLAY_ANIM(Local_62, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_76 = 1;
			...
			case 1:
				...
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(Local_62, vLocal_78[iLocal_77 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
			...
			case 3:
				CLEAR_PED_TASKS(Local_62);
				TASK_PLAY_ANIM(Local_62, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
				_0x2208438012482A1A(Local_62, 0, 0);
				iLocal_76 = 4;
				func_521("Eps 6: Done Tom idle anim");
				break;
			
			case 4:
				if (IS_ENTITY_PLAYING_ANIM(Local_62, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(Local_62, "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						if (iLocal_77 >= 2)
						{
							iLocal_77 = 0;
						...
						TASK_PLAY_ANIM(Local_62, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						_0x2208438012482A1A(Local_62, 0, 0);
						iLocal_76 = 1;
...
int func_439()
{
	if (func_478(PLAYER_PED_ID()) && func_478(Local_62))
	{
		...
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_62, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
		{
			func_521("Player damaged cultist");
			return 1;
		}
	}
	else if (DOES_ENTITY_EXIST(Local_62))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_62, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
		{
...
void func_440()
{
	...
	if (DOES_ENTITY_EXIST(Local_62))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_62, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
		{
			if (IS_ENTITY_DEAD(Local_62, 0))
			{
...
int func_441()
{
	if ((func_244(Local_62, 0, 1116471296, 1126825984, 0, 0, 0, 0) || func_241(PLAYER_PED_ID(), Local_62, 0)) || func_431())
	{
		if (func_244(Local_62, 0, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			func_521("Player threatened cultist");
		}
		if (func_241(PLAYER_PED_ID(), Local_62, 0))
		{
...
void func_442()
{
	if (bLocal_100 == 0)
	{
		if (func_479(Local_62) && func_478(PLAYER_PED_ID()))
		{
			if (iLocal_99 == 0)
			{
				if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), Local_62) && IS_ENTITY_TOUCHING_ENTITY(Local_62))
				{
					func_20();
			...
			{
				if (IS_PED_GETTING_UP(Local_62) || IS_PED_GETTING_UP(Local_62))
				{
					if (!func_22() && !IS_MESSAGE_BEING_DISPLAYED())
					{
...
void func_445()
{
	switch (iLocal_70)
	{
		case 0:
			...
			SET_ROADS_IN_ANGLED_AREA(-36.25134f, -465.8315f, 39.12256f, 25.801f, -287.1716f, 47.75863f, 59.5f, 0, false, 1);
		...
		case 1:
			...
			if (func_239())
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), vLocal_54.x, 0))
				{
					...
					if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
					{
						if (func_421(PLAYER_PED_ID(), Local_60, 0) < 2300f)
						{
							iLocal_70 = 2;
						}
					}
				...
				else
				{
					...
					if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(vLocal_54.x, true), true) > 80f)
					{
						...
						else if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(vLocal_54.x, true), true) > 120f)
						{
							if (func_414())
							{
								bLocal_101 = true;
	...
	switch (iLocal_71)
	{
		case 0:
			if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
			{
				if (func_239())
				{
					vVar0 = { GET_ENTITY_COORDS(vLocal_54.x, true) };
					if (vVar0.z > 15f)
					{
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_478(Local_62))
			{
				...
				PLAY_SOUND_FROM_ENTITY(iLocal_104, "DEVICE", PLAY_SOUND_FROM_ENTITY(Local_62), "EPSILONISM_04_SOUNDSET", false, 0);
				PLAY_SOUND_FROM_ENTITY(iLocal_105, "IDLE_BEEP_NPC", PLAY_SOUND_FROM_ENTITY(Local_62), "EPSILONISM_04_SOUNDSET", false, 0);
			}
		...
		case 1:
			...
			else if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(vLocal_54.x, true), true) > 50f)
			{
				if (!iLocal_84)
				{
					if (IS_SCRIPTED_CONVERSATION_ONGOING())
				...
				{
					if ((GET_GAME_TIMER() - iLocal_87) > 7500 && !GET_GAME_TIMER())
					{
					...
					if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(vLocal_54.x, true), true) > 100f)
					{
						iLocal_128 = 1;
						iLocal_70 = 0;
						iLocal_69 = 6;
...
{
	if (((!func_462(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_279(0)) || func_461(1))
			{
			}
			else
			{
...
int func_482(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_485(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar3))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				{
					CLEAR_AREA_OF_VEHICLES(-2892.93f, 3192.37f, 11.66f, 11f, 0, 0, 0, 0, false, 0);
			...
			if (DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				if (Global_76822)
				{
					if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
					{
						SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -2907.29f, 3215.91f, 9.86f, 1, false, 0, 1);
						SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 215.2149f);
					}
				}
			}
			else
			...
			if (func_478(uParam0->f_28[0]) && func_479(PLAYER_PED_ID()))
			{
				iVar5 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
...
void func_488()
{
	...
	SET_ROADS_BACK_TO_ORIGINAL(-195.7097f, 1881.432f, 196.1571f, 842.2352f, 2249.857f, 48.50136f, true);
	SET_ROADS_BACK_TO_ORIGINAL(816.8527f, 2107.934f, 63.37452f, 176.1676f, 2902.73f, 46.61533f, true);
	SET_ROADS_BACK_TO_ORIGINAL(-36.25134f, -465.8315f, 39.12256f, 25.801f, -287.1716f, 47.75863f, true);
	func_489(0);
...
void func_502(bool bParam0)
{
	...
	if (!func_514())
	{
		...
		{
			func_182(iVar0, 1, 0);
			func_503(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_504(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_507())
	{
		...
		{
			iVar2 = func_362(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
