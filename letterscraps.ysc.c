				...
				if (IS_SCREEN_FADED_IN())
				{
					if (!func_20())
					{
						if (((!IS_MOBILE_PHONE_CALL_ONGOING() && !func_14()) && !func_13()) && !func_12())
						{
							...
							iLocal_55 = 0x67D02A194A2FC2BD("LETTER_SCRAPS");
...
void func_21()
{
	switch (iLocal_43)
	{
		...
		case 1:
			if (!func_60(14) && !IS_SCREEN_FADED_OUT())
			{
...
int func_26(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_111560.f_10044.f_108, func_32(func_33(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_40(var uParam0, var uParam1, vector3 vParam2)
{
	...
	if ((uParam1[iVar0 /*11*/])->f_10)
	{
		...
		{
			if (HAS_PICKUP_BEEN_COLLECTED((uParam1[iVar0 /*11*/])->f_1) || func_55((uParam1[iVar0 /*11*/])->f_1))
			{
	...
	{
		if ((vdist2(vParam2, GET_PICKUP_COORDS((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_60(13)) || func_60(14))
		{
...
void func_46()
{
	...
	iVar3 = 0;
	STAT_GET_INT(func_48(0), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_47(18, iVar0);
	}
	STAT_GET_INT(func_48(1), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_47(19, iVar0);
	}
	STAT_GET_INT(func_48(3), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_47(20, iVar0);
...
void func_70()
{
	...
	{
		func_47(13, floor(Global_111560.f_10189.f_3853));
	}
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_76577)
		{
			if (func_71() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
