...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!func_218(&Var0, 1))
		{
			if (Var0 == 30)
			{
				if (func_217(PLAYER_PED_ID(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f)
				{
	...
	if (*uParam0 == 30)
	{
		if (func_205(uParam0->f_28[0]))
		{
			if (bLocal_223)
			{
				if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					if (func_173(PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 15f)
					{
						func_307("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_173(PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 10f)
				{
...
int func_174(var uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_217(PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
			...
			else if ((!func_175(PLAYER_PED_ID(), -828834893) && func_205(PLAYER_PED_ID(PLAYER_PED_ID(), 0))) && func_148(PLAYER_PED_ID(PLAYER_PED_ID(), 0), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK_LEAVE_ANY_VEHICLE(TASK_LEAVE_ANY_VEHICLE(), 0, 0);
			}
		}
...
int func_176(var uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_217(PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
			...
			else if ((!func_175(PLAYER_PED_ID(), -828834893) && func_205(PLAYER_PED_ID(PLAYER_PED_ID(), 0))) && func_148(PLAYER_PED_ID(PLAYER_PED_ID(), 0), 4f, 1, 1056964608, 0, 1, 0))
			{
				TASK_LEAVE_ANY_VEHICLE(TASK_LEAVE_ANY_VEHICLE(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					if (func_205(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0)))
					{
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_191()) || Global_110607) || Global_30738) || func_190()) || func_189(8, -1)) || func_93()) || func_188()) || func_187()) || func_186()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_191()) || Global_30738) || func_190()) || func_189(8, -1)) || func_187()) || func_93()) || func_188()) || func_186()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_191()) || Global_110607) || Global_30738) || func_190()) || func_189(8, -1)) || func_187()) || func_93()) || func_188()) || func_186()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_191()) || Global_110607) || Global_30738) || func_190()) || func_189(8, -1)) || func_93()) || func_188()) || func_186()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_191() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_189(8, -1)) || func_186()) || func_185()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_191()) || Global_30738) || func_190()) || func_189(8, -1)) || func_188()) || func_187()) || func_186()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_191()) || func_188()) || Global_110607) || Global_30738) || func_190()) || Global_42561) || func_189(8, -1)) || func_187()) || func_185()) || func_186()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_191()) || Global_110607) || Global_30738) || func_190()) || func_189(8, -1)) || func_187()) || func_185()) || func_93()) || func_188()) || func_186())
						{
							return 0;
						}
						break;
...
void func_192()
{
	switch (iLocal_56)
	{
		...
		case 1:
			if (func_217(PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_217(PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_143();
				bLocal_223 = true;
				iLocal_56 = 0;
...
int func_206(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_205(PLAYER_PED_ID()) && func_205(iParam0->f_28[0])) && !func_145()) && (PLAYER_PED_ID() - iParam0->f_60) > iParam6) && func_217(PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_208(int iParam0, char* sParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_217(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_217(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_213(iParam0);
				}
			}
...
void func_219(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_205(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_221(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_220(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_221(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_220(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_229(int iParam0, float fParam1)
{
	...
	if (func_205(PLAYER_PED_ID()) && func_205(iParam0))
	{
		if (func_240(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_237(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_237(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_244(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_237(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_271(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_269(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmjosh3"))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_273(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_269(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmjosh2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_275(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		_SET_DOOR_AJAR_ANGLE(904342475, 0f, false, false);
		_SET_DOOR_ACCELERATION_LIMIT(904342475, 4, false, true);
		iVar0++;
	}
	else
	...
	if (bParam1)
	{
		_SET_DOOR_AJAR_ANGLE(-795418380, 0f, false, false);
		_SET_DOOR_ACCELERATION_LIMIT(904342475, 4, false, true);
		iVar0++;
	}
	else
