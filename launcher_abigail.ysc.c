...
int func_188(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && !func_146()) && (PLAYER_PED_ID() - uParam0->f_60) > iParam6) && func_192(PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
{
	if (func_127(*uParam1) && func_127(PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				iParam0->f_166 = (GET_GAME_TIMER() + GET_GAME_TIMER(1000, 2000));
				func_191(&(iParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
				TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						TASK_PLAY_ANIM(*uParam1, cLocal_55, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
					else if (func_205(PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
				if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "outro", 3) && IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "outro") > 0.99f)
				{
					TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			
			case 3:
				if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "intro", 3) && IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_194(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_146())
				{
					if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "loop_talk", 3))
					{
						...
						{
							iParam0->f_166 = (GET_GAME_TIMER() + GET_GAME_TIMER(7000, 10000));
							if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
							{
								TASK_PLAY_ANIM(*uParam1, cLocal_55, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "loop_look", 3) && IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "loop_look") > 0.99f)
				{
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						if (GET_GAME_TIMER() > iParam0->f_166)
...
void func_215(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_217(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_216(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_217(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_216(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_226(int iParam0, float fParam1)
{
	...
	{
		if (func_237(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
int func_232(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_234(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_234(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_241(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_234(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_259(&iVar0) || !HAS_ANIM_DICT_LOADED(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_261(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!HAS_MODEL_LOADED(iVar0) || !HAS_MODEL_LOADED(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
