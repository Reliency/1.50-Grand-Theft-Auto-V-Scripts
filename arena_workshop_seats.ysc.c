...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
...
void func_4(int iParam0)
{
	...
	Global_1590446[PLAYER_ID() /*871*/].f_865 = iParam0;
}
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 4:
			...
			vVar2 = { GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0, 2) };
			vVar3 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0f, 2) };
			iVar4 = vVar3.z;
			fVar5 = 0.05f;
			...
			TASK_GO_STRAIGHT_TO_COORD(TASK_GO_STRAIGHT_TO_COORD(), vVar2, 1f, 500, iVar4, fVar5);
		...
		case 5:
			...
			vVar7 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_48(uParam0), func_47(uParam0), 0f, 2) };
			fVar8 = vVar7.z;
			if ((iVar6 != 1 && iVar6 != 0) || func_34(GET_ENTITY_HEADING(GET_ENTITY_HEADING()), fVar8, 5f))
			{
				uParam0->f_43.f_1 = _0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216, 0, 1.12f);
				NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_43.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1148846080, 0);
				NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_43.f_1);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar9 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iVar9))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(iVar9) >= 1f)
				{
					...
					func_49(uParam0, &sVar1);
					uParam0->f_43.f_1 = _0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216, 0, 1.12f);
					NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_43.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1148846080, 0);
					NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 8:
			iVar10 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
			iVar11 = GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(), 1785177548);
			if (iVar11 == 0 || iVar11 == 1)
			{
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iVar10))
				{
					if ((GET_SYNCHRONIZED_SCENE_PHASE(iVar10) >= 0.7f || GET_SYNCHRONIZED_SCENE_PHASE(GET_SYNCHRONIZED_SCENE_PHASE(), 364629851)) || GET_SYNCHRONIZED_SCENE_PHASE(GET_SYNCHRONIZED_SCENE_PHASE(), 2116425869))
					{
						NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
						func_4(-1);
						func_5(uParam0, 1);
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_43.f_4 == 6)
	{
		...
		fVar1 = vmag(vVar0);
		if ((uParam0->f_43.f_4 == 6 && !HAS_ANIM_EVENT_FIRED(HAS_ANIM_EVENT_FIRED(), -1322051853)) && !func_32(&(uParam0->f_43), 12))
		{
		...
		else
		{
			...
			bVar2 = false;
			if (((func_26(func_27()) && func_25()) && func_24(Global_2424073[PLAYER_ID() /*421*/].f_309.f_8, 4)) && func_23(Global_2424073[PLAYER_ID() /*421*/].f_309.f_8))
			{
				bVar2 = true;
			}
			if (((((!IS_PAUSE_MENU_ACTIVE() && !func_32(&(uParam0->f_43), 0)) && !func_32(&(uParam0->f_43), 4)) && !func_22()) && !func_20(1)) && uParam0->f_43.f_8.f_2 != 3)
			{
				...
				if (uParam0->f_43.f_4 == 6)
				{
					...
					if (((IS_DISABLED_CONTROL_JUST_PRESSED(2, iVar3) && !IS_DISABLED_CONTROL_JUST_PRESSED(2, 203)) && !Global_2509234) && !Global_2509232)
					{
						func_30(uParam0);
					}
					if (((((IS_DISABLED_CONTROL_JUST_PRESSED(2, 203) && !IS_DISABLED_CONTROL_JUST_PRESSED(2, iVar3)) && func_26(func_27())) && func_25()) && func_24(Global_2424073[IS_DISABLED_CONTROL_JUST_PRESSED() /*421*/].f_309.f_8, 4)) && func_23(Global_2424073[IS_DISABLED_CONTROL_JUST_PRESSED() /*421*/].f_309.f_8))
					{
						Global_2509234 = 1;
						Global_2509232 = 1;
					}
...
bool func_18(int iParam0, int iParam1)
{
	...
	iVar0 = iParam1 + 20;
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_318.f_1, iVar0);
}
...
bool func_23(int iParam0)
{
	...
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_318.f_1, 1);
}
...
int func_25()
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1612.283f, -3021.792f, -76.18069f, -1612.22f, -3005.203f, -74.20517f, 12.75f, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
void func_30(var uParam0)
{
	...
	uParam0->f_43.f_1 = _0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216, 0, 1.12f);
	func_50(uParam0, &sVar0);
	NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_43.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_43.f_1);
	func_7(&(uParam0->f_43.f_5));
	func_65(uParam0, 8);
}
...
int func_57(var uParam0)
{
	...
	while (iVar1 < 10)
	{
		if (((DOES_ENTITY_EXIST(uVar0[iVar1]) && !DOES_ENTITY_EXIST(uVar0[iVar1])) && DOES_ENTITY_EXIST(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || vdist2(DOES_ENTITY_EXIST(uVar0[iVar1], false), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
int func_62(int iParam0, vector3 vParam1, int iParam2)
{
	if (DOES_ENTITY_EXIST(iParam0))
	{
		if (iParam2 == 3)
		{
			if (func_34(GET_ENTITY_HEADING(iParam0), (vParam1.z - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_34(GET_ENTITY_HEADING(iParam0), vParam1.z, 45f))
		{
			return 1;
		}
	}
...
void func_67(var uParam0)
{
	...
	else if (uParam0->f_43.f_4 > 4)
	{
		...
		SET_PED_CAPSULE(SET_PED_CAPSULE(), func_68());
...
void func_69(var uParam0)
{
	...
	func_70(&(uParam0->f_43), 1, IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0));
	func_70(&(uParam0->f_43), 3, IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1));
	func_70(&(uParam0->f_43), 0, func_45(0));
	func_70(&(uParam0->f_43), 2, IS_PED_RUNNING(IS_PED_RUNNING()));
}
...
int func_72()
{
	if ((IS_SCREEN_FADED_OUT() && !func_85()) && !Global_2509232)
	{
		return 1;
	}
	if (!func_84())
	...
	if (Global_2424073[PLAYER_ID() /*421*/].f_309.f_8 == func_19())
	{
		return 1;
	}
	return 0;
...
int func_84()
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 207.5193f, 5163.855f, -86.59737f, 211.7083f, 5163.879f, -83.6007f, 6.25f, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
bool func_85()
{
	return IS_BIT_SET(Global_1676879.f_4, 10);
}
...
int func_86()
{
	if (Global_2424073[PLAYER_ID() /*421*/].f_309.f_8 != func_19())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2424073[NETWORK_IS_SCRIPT_ACTIVE() /*421*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
		NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, Global_2424073[NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT() /*421*/].f_309.f_8);
		func_95(0, -1, 0);
