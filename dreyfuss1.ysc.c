...
void __EntryFunction__()
{
	...
	if (func_437(Local_82.f_28[0]))
	{
		...
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_89, true, 1);
	}
	func_436();
	if (func_447())
	{
...
void func_15()
{
	...
	{
		func_17(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_83(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_83(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_83(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_83(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_83(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_74(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_83(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_60(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_83(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_83(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_61(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_61(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_61(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_61(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_94(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_94(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_83(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_156(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_83(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_83(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_163()
{
	...
	{
		if (func_158(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_174()
{
	...
	{
		func_163();
		_0xBF59707B3E5ED531(func_175(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
int func_209()
{
	return func_210(GET_THIS_SCRIPT_NAME(), 0);
}
...
{
	if (IS_BIT_SET(Global_98669.f_20, 17))
	{
		return 0;
	}
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_437(iLocal_89))
			{
				...
				if (IS_PED_IN_ANY_VEHICLE(iLocal_89, 0))
				{
		...
		case 1:
			...
			if (!func_437(iLocal_89))
			{
				...
				if (!IS_BIT_SET(Global_111560.f_18569.f_382, 0))
				{
					SET_BIT(&(Global_111560.f_18569.f_382), 0);
				}
				func_295(4);
			}
			else if (func_293(PLAYER_PED_ID(), iLocal_89) > 250f)
			{
...
void func_247()
{
	if (!bLocal_280)
	{
		if (func_259(PLAYER_PED_ID(), iLocal_89, fLocal_267, 1))
		{
...
void func_248(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!iLocal_297)
		{
			if (!*iParam0)
			{
				if ((func_249(iLocal_89) && !IS_PED_RAGDOLL(iLocal_89)) && !IS_PED_RAGDOLL(iLocal_89))
				{
					if (func_259(PLAYER_PED_ID(), iLocal_89, fLocal_267, 1))
					{
						if (!func_242())
...
int func_250(int iParam0)
{
	if (iLocal_304 == 0)
	{
		...
		else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_89, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), iParam0) && iLocal_288 < 4)
		{
			func_243();
			iLocal_304 = 1;
		}
...
int func_254(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_256(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_256(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	...
	if (DOES_BLIP_EXIST(*iParam0))
	{
		if ((GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_262(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_262(sParam2, 0, 0))
					{
...
void func_266(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_291(iParam1) && IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_272(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_279() || func_278(Global_4456448.f_190930)) || func_277())
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			iVar1 = func_276(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(iVar0, iVar1) || (_0xE33FFA906CE74880(iVar0) == 562680400 && iVar1 != -1)) || (_0xE33FFA906CE74880(iVar0) == 1181327175 && iVar1 != -1)) || (((_0xE33FFA906CE74880(iVar0) == -1693015116 && iVar1 == 0) && func_275(iVar0, 10)) && _0xE33FFA906CE74880(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_273(int iParam0)
{
	if (iParam0 != func_231())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_274(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_286(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_289(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1) || func_287(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_298()
{
	...
	{
		case 0:
			SET_ROADS_IN_AREA(Local_83, Local_83.f_3, true, 1);
			_SET_UNK_MAP_FLAG(2);
			if (func_437(Local_82.f_35[0]))
			{
				...
				while (iVar0 < 3)
				{
					vLocal_295[iVar0 /*3*/] = { GET_ENTITY_COORDS(Local_82.f_35[0], true) };
					iVar0++;
				}
			}
		...
		case 1:
			...
			else
			{
				if (func_437(Local_82.f_35[0]))
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0) && IS_PED_IN_ANY_VEHICLE(Local_82.f_35[0], IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0)))
					{
					...
					if (((!iLocal_265 && !iLocal_266) && IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_89)) && !IS_PED_SITTING_IN_ANY_VEHICLE(Local_82.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, false, true, 0))
					{
						TASK_VEHICLE_MISSION_PED_TARGET(iLocal_89, Local_82.f_35[0], TASK_VEHICLE_MISSION_PED_TARGET(), 8, 90f, 786469, 100f, 1f, 1);
						iLocal_266 = 1;
					}
				}
				func_250(0);
				func_263(&uLocal_305, iLocal_89, 0, 0, 1, 1, 1);
				if (((!iLocal_265 && func_259(PLAYER_PED_ID(), iLocal_89, 10f, 1)) && PLAYER_PED_ID(PLAYER_PED_ID())) && PLAYER_PED_ID(iLocal_89))
				{
					TASK_VEHICLE_MISSION_PED_TARGET(iLocal_89, Local_82.f_35[0], TASK_VEHICLE_MISSION_PED_TARGET(), 8, 90f, 786468, 100f, 1f, 1);
					iLocal_265 = 1;
				}
				if (!func_304())
				{
...
int func_300()
{
	if (func_437(Local_82.f_35[0]))
	{
		if (IS_PED_IN_VEHICLE(iLocal_89, Local_82.f_35[0], 0))
		{
...
void func_302()
{
	...
	vLocal_295[2 /*3*/] = { GET_ENTITY_COORDS(Local_82.f_35[0], true) };
}
...
int func_303()
{
	...
	{
		iVar0 = 0;
		if (IS_VEHICLE_TYRE_BURST(Local_82.f_35[0], 0, 0))
		{
			iVar0++;
		}
		if (IS_VEHICLE_TYRE_BURST(Local_82.f_35[0], 1, 0))
		{
			iVar0++;
		}
		if (IS_VEHICLE_TYRE_BURST(Local_82.f_35[0], 4, 0))
		{
			iVar0++;
		}
		if (IS_VEHICLE_TYRE_BURST(Local_82.f_35[0], 5, 0))
		{
			iVar0++;
		}
		if (iVar0 > 1)
...
int func_305(int iParam0)
{
	...
	iVar0 = GET_CLOSEST_VEHICLE(GET_CLOSEST_VEHICLE(Local_82.f_35[0], true), 20f, iParam0, 6);
	if (DOES_ENTITY_EXIST(iVar0))
	{
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_3(Local_82.f_35[0]))
			{
				...
				SET_VEHICLE_ENGINE_ON(Local_82.f_35[0], true, true, 0);
				SET_VEHICLE_DOOR_OPEN(Local_82.f_35[0], 0, 0, false);
			}
			if (func_437(iLocal_89))
			{
				...
				if (func_3(Local_82.f_35[0]))
				{
					...
					iLocal_263 = _ADD_SPEED_ZONE_FOR_COORD(_ADD_SPEED_ZONE_FOR_COORD(Local_82.f_35[0], true), 100f, 10f, 0);
				}
				else
				{
					TASK_SMART_FLEE_PED(iLocal_89, TASK_SMART_FLEE_PED(), 500f, -1, 0, 0);
				}
			}
		...
		case 1:
			...
			else
			{
				...
				if ((func_307(242628503) && GET_SEQUENCE_PROGRESS(iLocal_89) > 0) && func_303())
				{
					func_295(3);
				}
			}
...
int func_308()
{
	if (DOES_ENTITY_EXIST(Local_82.f_35[0]))
	{
		if (func_307(242628503))
		{
			...
			{
				if (!IS_ENTITY_AT_COORD(Local_82.f_35[0], vLocal_80, 20f, 20f, 100f, false, true, 0))
				{
					sLocal_274 = "DREY1_CGONE";
					iLocal_265 = 1;
					func_295(3);
				...
				else if (!IS_ENTITY_AT_COORD(Local_82.f_35[0], vLocal_80, 5f, 5f, 100f, false, true, 0))
				{
...
int func_309(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_256(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_314()
{
	...
	{
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01_l"), -1482.992f, 523.4556f, 117.9981f, true, 0f, 0);
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01_r"), -1477.865f, 525.6363f, 118.0456f, true, 0f, 0);
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01_l"), -1482.992f, 523.4556f, 117.9981f, true, 1f, 0);
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01_r"), -1477.865f, 525.6363f, 118.0456f, true, -1f, 0);
		return 1;
	}
	return 0;
}
...
void func_316()
{
	switch (iLocal_88)
	{
		case 0:
			...
			if (((IS_SCREEN_FADED_IN() && !func_447()) && func_437(iLocal_89)) && func_294(IS_SCREEN_FADED_IN(), Local_82.f_28[0], 1) > 4f)
			{
				SET_GAMEPLAY_ENTITY_HINT(iLocal_89, 0f, 0f, -0.5f, 1, -1, 3000, 2000, 0);
			...
			iLocal_321 = GET_CLOSEST_OBJECT_OF_TYPE(-1459.57f, 485.16f, 115.2f, 10f, joaat("prop_yoga_mat_02"), 1, 0, 1);
			...
			switch (iLocal_318)
			{
				case 0:
					if (func_437(PLAYER_PED_ID()))
					{
						...
						{
							TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), iLocal_89, -1, 0, 2);
							iLocal_318++;
						}
					}
					break;
				...
				case 2:
					if (IS_CUTSCENE_PLAYING())
					{
						...
						CLEAR_AREA_OF_VEHICLES(-1473.376f, 517.8441f, 116.8854f, 30f, 0, 0, 0, 0, false, 0);
						func_311(500, 0);
						iLocal_318++;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_437(iLocal_89))
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_89, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
						}
					}
					break;
			}
...
void func_318(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_322(IS_PED_INJURED())) && !func_320(IS_PED_INJURED(), 0)) && !func_319()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_322(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_326(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_327(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
	...
	if (DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_376(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_373(GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_348(iParam0, 0, 0)) || func_348(iParam0, 1, 0)) || func_348(iParam0, 2, 0)) || func_367(iParam0) != 145) || func_347(iParam0)) || func_346(iParam0)) || func_345(iParam0)) || func_344(iParam0)) || !func_334(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_346(iParam0))
		{
		}
...
{
	return (shift_right(iParam0, 26) & 31 * func_356(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_369(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_387(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_391(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_390(PLAYER_PED_ID(), -828834893))
				{
...
void func_393()
{
	...
	if (iLocal_320 == 0)
	{
		if (func_437(iLocal_89))
		{
			if (func_294(PLAYER_PED_ID(), iLocal_89, 1) < 3f)
			{
				iLocal_320 = 1;
				SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 0);
				CLEAR_PED_TASKS(CLEAR_PED_TASKS());
				TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), iLocal_89, 0);
			}
		}
	}
}
...
void func_395()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_391(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_416(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_281(0)) || func_415(1))
			{
			}
			else
			{
...
void func_419(int iParam0)
{
	...
	CLEAR_AREA(-1462.177f, 485.6856f, 115.2016f, 200f, 1, 0, 0, false);
	if (!func_430())
	{
		CLEAR_PED_TASKS_IMMEDIATELY(CLEAR_PED_TASKS_IMMEDIATELY());
		func_429(PLAYER_PED_ID(), -1462.177f, 485.6856f, 115.2016f, 97.1913f, 0, 1);
	}
	func_2(&iLocal_94);
	func_4(&iLocal_89);
	func_2(&(Local_82.f_35[0]));
	...
	if (!func_430())
	{
		func_422(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 100f, 12, 5000, 0, 0);
	}
	func_421(0, -1, 1);
	if (iParam0 == 1)
	{
...
void func_424()
{
	if (!func_437(Local_82.f_35[0]))
	{
		...
		Local_82.f_35[0] = CREATE_VEHICLE(iLocal_96, vLocal_80, fLocal_81, true, true, false);
		SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_96);
	}
	if (func_437(Local_82.f_35[0]))
	{
		_0x0AD9E8F87FF7C16F(Local_82.f_35[0], 0);
...
void func_425()
{
	...
	if (func_437(iLocal_89))
	{
		...
		SET_ENTITY_IS_TARGET_PRIORITY(iLocal_89, 1, 0);
		SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_89, true, 1);
		SET_PED_PATHS_WIDTH_PLANT(iLocal_89, 0);
...
void func_436()
{
	...
	func_432();
	CLEAR_BIT(&(Global_111560.f_18569.f_382), 0);
	REQUEST_ADDITIONAL_TEXT("DREY1", 0);
	func_426(&uLocal_98, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_425();
	func_424();
}
...
{
	SET_ROADS_IN_AREA(-1594.9f, 457.8715f, -100f, -1366.784f, 635.579f, 900f, bParam0, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1473.517f, 508f, 115.601f, -1471.017f, 514.829f, 120f, bParam0, 1);
}
...
int func_440(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				TASK_LOOK_AT_ENTITY(uParam0->f_28[0], TASK_LOOK_AT_ENTITY(), -1, 2096, 2);
			}
		...
		case 3:
			...
			if (func_437(uParam0->f_28[0]))
			{
				CLEAR_AREA_OF_PEDS(CLEAR_AREA_OF_PEDS(uParam0->f_28[0], true), 50f, 0);
			}
			CLEAR_AREA_OF_VEHICLES(-1471.166f, 510.6191f, 115.8419f, 4f, 0, 0, 0, 0, false, 0);
			func_438(0);
			return 1;
			break;
	}
...
void func_448()
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_317, 0);
...
void func_464(bool bParam0)
{
	...
	if (!func_481())
	{
		...
		{
			func_168(iVar0, 1, 0);
			func_465(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_466(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_472())
	{
		...
		{
			iVar2 = func_467(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
