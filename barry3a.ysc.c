...
void func_1()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&iLocal_42);
			if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_43.f_4, 0))
			{
				...
				else
				{
					iLocal_241 = 1;
					iLocal_242 = 1;
					if (GET_PROFILE_SETTING(203) == 0 || !func_212())
					{
						func_210(2);
						iLocal_240 = 0;
					}
		...
		case 1:
			...
			else if (!iLocal_241)
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_43.f_4, 0))
				{
					...
					{
						iLocal_242 = 0;
						if (IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 6f, 6f, 2f, true, true, 0))
						{
							func_214(&iLocal_42);
							iLocal_41 = 0;
							iLocal_40 = 6;
			...
			else if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_43.f_4, 0))
			{
				CLEAR_PRINTS();
				iLocal_241 = 0;
				iLocal_240 = 1;
			...
			else if (IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 6f, 6f, 2f, true, true, 0))
			{
				func_214(&iLocal_42);
				iLocal_41 = 0;
				iLocal_40 = 6;
...
void func_215()
{
	...
	{
		case 0:
			if (IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 10f, 10f, 2f, false, true, 0))
			{
				func_214(&iLocal_42);
				_SET_UNK_MAP_FLAG(0);
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_43.f_4, 0))
		...
		case 1:
			if (IS_ENTITY_AT_COORD(Local_43.f_4, vLocal_53, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_217();
					if (!func_216(PLAYER_PED_ID(), Local_43.f_4, 55f, 1) && !PLAYER_PED_ID(Local_43.f_4))
					{
						iLocal_41 = 2;
					}
					else if ((iLocal_237 && func_209(5)) && (GET_PROFILE_SETTING(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
void func_242()
{
	switch (iLocal_41)
	{
		case 0:
			func_214(&iLocal_42);
			if (!func_212() || GET_PROFILE_SETTING(203) == 0)
			{
				func_210(2);
				func_253(&uLocal_254);
				iLocal_235 = 0;
...
void func_245()
{
	...
	{
		if (!func_212() && IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_43.f_4, 0))
		{
			if (!iLocal_229)
			{
				iLocal_229 = 1;
			...
			if ((GET_GAME_TIMER() - iLocal_231) > Local_228[iLocal_230 /*2*/].f_1 && (func_247() || iLocal_230 == 0))
			{
				if (iLocal_230 != 2 || GET_ENTITY_SPEED(Local_43.f_4) > 10f)
				{
					if (func_235() || GET_PROFILE_SETTING(203) == 0)
					{
...
int func_247()
{
	if (IS_COP_PED_IN_AREA_3D(IS_COP_PED_IN_AREA_3D(IS_COP_PED_IN_AREA_3D(), true) - Vector(70f, 70f, 70f), IS_COP_PED_IN_AREA_3D(IS_COP_PED_IN_AREA_3D(), true) + Vector(70f, 70f, 70f)))
	{
		return 1;
	}
	return 0;
...
void func_248(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!IS_SCRIPTED_CONVERSATION_ONGOING() && func_249(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_254()
{
	switch (iLocal_41)
	{
		case 0:
			...
			if (func_209(3) && (GET_PROFILE_SETTING(203) == 0 || !func_212()))
			{
				func_210(3);
				func_253(&uLocal_254);
			}
	...
	switch (iLocal_41)
	{
		case 0:
			...
			if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_43.f_4, 0))
			{
				func_214(&iLocal_42);
				iLocal_42 = func_213(vLocal_53, 5, 1);
				if (func_209(0) && (GET_PROFILE_SETTING(203) == 0 || !func_212()))
				{
					func_210(0);
					func_253(&uLocal_254);
				}
		...
		case 1:
			if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_43.f_4, 0))
			{
				...
				else
				{
					...
					if (IS_PED_SITTING_IN_VEHICLE(IS_PED_SITTING_IN_VEHICLE(), Local_43.f_4) && IS_PED_SITTING_IN_VEHICLE(Local_43.f_4, vLocal_53, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_243 = 0;
						iLocal_41 = 2;
					}
					if (!iLocal_236)
					{
						if (((GET_GAME_TIMER() - iLocal_231) > 8000 && iLocal_230 >= 4) && !func_212())
						{
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_331(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_201(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_260(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_269(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_272(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_284(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_289(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_286(Var7.f_1)) && iVar9 < 51)
			{
...
int func_295(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_316())
		{
			*uParam0 = func_300(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_7() == 0)
		{
			return IS_BIT_SET(func_69(func_298(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_300(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_315(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_301(iVar0, 0), true);
...
{
	return (shift_right(iParam0, 26) & 31 * func_323(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_362(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_359(GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_267(iParam0) != 145) || func_353(iParam0)) || func_352(iParam0)) || func_351(iParam0)) || func_350(iParam0)) || !func_340(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_352(iParam0))
		{
		}
...
void func_365()
{
	...
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, false, 1);
		iLocal_42 = func_208(Local_43.f_4, 1, 5);
		iLocal_40 = 1;
		iLocal_41 = 0;
	}
...
void func_367(int iParam0)
{
	switch (Local_56[iParam0 /*29*/].f_24)
	{
		case 0:
			if (!DOES_ENTITY_EXIST(Local_56[iParam0 /*29*/].f_1))
			{
				if (func_204(Local_56[iParam0 /*29*/]))
				{
					...
					{
						Local_56[iParam0 /*29*/].f_1 = CREATE_PED_INSIDE_VEHICLE(Local_56[iParam0 /*29*/], 6, iLocal_59, -1, 1, true);
						Local_56[iParam0 /*29*/].f_2 = CREATE_PED_INSIDE_VEHICLE(Local_56[iParam0 /*29*/], 6, iLocal_59, 0, 1, true);
					}
				}
			...
			else if (!IS_ENTITY_DEAD(Local_56[iParam0 /*29*/].f_1, 0))
			{
				SET_PED_AS_COP(Local_56[iParam0 /*29*/].f_1, 1);
				...
				{
					SET_PED_AS_COP(Local_56[iParam0 /*29*/].f_2, 1);
		...
		case 1:
			if (func_207(PLAYER_PED_ID(), Local_56[iParam0 /*29*/].f_3, 275f))
			{
				if (func_386(iParam0))
				{
...
void func_370(int iParam0, int iParam1)
{
	...
	if (func_204(Local_56[iParam0 /*29*/].f_1))
	{
		...
		_0x52D59AB61DDC05DD(Local_56[iParam0 /*29*/].f_1, 1);
		func_368(&(Local_56[iParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_204(Local_56[iParam0 /*29*/].f_2))
	{
		...
		_0x52D59AB61DDC05DD(Local_56[iParam0 /*29*/].f_2, 1);
		func_368(&(Local_56[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_204(Local_56[iParam0 /*29*/]))
	{
		SET_VEHICLE_ENGINE_ON(Local_56[iParam0 /*29*/], true, true, 0);
...
int func_372(int iParam0)
{
	...
	if (func_204(iParam0))
	{
		...
		if (IS_PED_BEING_JACKED(iParam0) && func_216(iParam0, IS_PED_BEING_JACKED(), 2f, 1))
		{
			return 1;
		}
...
int func_373(int iParam0, float fParam1)
{
	...
	if (func_204(PLAYER_PED_ID()) && func_204(iParam0))
	{
		if (func_384(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_381(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_381(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (IS_ENTITY_IN_ANGLED_AREA(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, true, 0))
	{
		return 1;
	}
	else if (Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && IS_ENTITY_IN_ANGLED_AREA(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_390()
{
	switch (iLocal_243)
	{
		...
		case 2:
			...
			{
				if ((!iLocal_247 && GET_GAME_TIMER() >= iLocal_245) && !func_212())
				{
...
void func_393(bool bParam0)
{
	...
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, true, 1);
}
...
void func_399()
{
	...
	if (iLocal_246)
	{
		if ((!IS_CUTSCENE_PLAYING() && !func_403(0)) && !func_398())
		{
...
{
	if (((!func_417(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_403(0)) || func_416(1))
			{
			}
			else
			{
...
void func_420()
{
	if (func_204(Local_43.f_4))
	{
		...
		_0x51BB2D88D31A914B(Local_43.f_4, false);
		_0x192547247864DFDD(Local_43.f_4, false);
		if (!bLocal_46)
		{
...
void func_429(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_433(IS_PED_INJURED())) && !func_431(IS_PED_INJURED(), 0)) && !func_430()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_433(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_437(bool bParam0)
{
	...
	{
		SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -1243.316f, -1041.637f, 7.5121f, 1, false, 0, 1);
		SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 28.2f);
	}
	func_426(500, 1);
}
...
void func_442(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	func_206(&iLocal_49);
	func_203(&(Local_43.f_4));
	Local_43.f_4 = CREATE_VEHICLE(Local_43.f_5, vParam0, fParam1, true, true, false);
	SET_VEHICLE_COLOUR_COMBINATION(Local_43.f_4, 1);
	if (bParam2)
	{
		func_443(PLAYER_PED_ID(), Local_43.f_4, -1);
	}
	_0x51BB2D88D31A914B(Local_43.f_4, false);
	_0x192547247864DFDD(Local_43.f_4, false);
	SET_VEHICLE_STRONG(Local_43.f_4, true);
	...
	iLocal_49 = CREATE_OBJECT(iLocal_51, vParam0, true, true, false);
	ATTACH_ENTITY_TO_ENTITY(iLocal_49, Local_43.f_4, 0, vLocal_50, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	SET_ENTITY_COLLISION(iLocal_49, true, 0);
	bLocal_46 = true;
	func_421(Local_43.f_4, 0);
...
void func_451()
{
	...
	if (func_204(PLAYER_PED_ID()))
	{
		func_238(&uLocal_63, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	iLocal_236 = 0;
	iLocal_247 = 0;
	iLocal_230 = 0;
	...
	sLocal_253 = "DEFAULT";
	func_452(49, 1, 0);
	iLocal_54[0] = ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	iLocal_54[1] = ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
void func_463()
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_54[0], 0);
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_54[1], 0);
	_SET_UNK_MAP_FLAG(0);
...
int func_474(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_477())
	{
		...
		{
			iVar2 = func_328(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
