...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_173())
		{
			...
			{
				fLocal_31 = vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), vLocal_32);
			}
			func_171(&iVar1);
			func_31(&iVar2);
			if (iLocal_39 > 3)
...
void func_31(int iParam0)
{
	...
	switch (iLocal_43)
	{
		...
		case 3:
			...
			{
				CLEAR_AREA_OF_VEHICLES(vLocal_45, 4f, 0, 0, 0, 0, false, 0);
				if (DOES_ENTITY_EXIST(iLocal_44))
				{
					DELETE_VEHICLE(&iLocal_44);
				}
				iLocal_44 = CREATE_VEHICLE(func_162(), vLocal_45, fLocal_46, true, true, false);
				SET_VEHICLE_RADIO_ENABLED(iLocal_44, false);
				SET_MODEL_AS_NO_LONGER_NEEDED(func_162());
				if (DOES_ENTITY_EXIST(iLocal_44))
				{
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_47)
				{
					if (IS_PED_IN_ANY_VEHICLE(iLocal_28, 0))
					{
			...
			if (*iParam0)
			{
				if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(iLocal_44, 0))
				{
					SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), iLocal_44, -1);
				}
			}
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(iLocal_44, 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_44, 1))
				{
					func_160();
				}
			}
			if (!IS_ENTITY_DEAD(iLocal_44, 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					...
					if (iVar2 == iLocal_44)
					{
						if (vdist2(vLocal_45, GET_ENTITY_COORDS(iLocal_28, true)) < 100f)
						{
							REQUEST_SCRIPT("Traffick_Ground");
							if (DOES_ENTITY_EXIST(iLocal_29) && !DOES_ENTITY_EXIST(iLocal_29, 0))
							{
		...
		case 6:
			if (HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					iLocal_30 = start_new_script_with_args("Traffick_Ground", &Var4, 97, 29500);
					func_81(16);
					SET_SCRIPT_AS_NO_LONGER_NEEDED("Traffick_Ground");
					SET_ENTITY_AS_MISSION_ENTITY(iLocal_44, true, 0);
					SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_44);
...
{
	return (shift_right(iParam0, 26) & 31 * func_40(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_85(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_22();
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		func_102(PLAYER_PED_ID());
		func_95(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_94())
		{
			func_87(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_96(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_101(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_98(Var7.f_1)) && iVar9 < 51)
			{
...
int func_107(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_130())
		{
			*uParam0 = func_113(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_109(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_111() == 0)
		{
			return IS_BIT_SET(func_88(func_110(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_113(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_129(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_114(iVar0, 0), true);
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) != 145) || func_150(iParam0)) || func_149(iParam0)) || func_148(iParam0)) || func_147(iParam0)) || !func_137(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_149(iParam0))
		{
		}
...
void func_161()
{
	...
	if (!DOES_ENTITY_EXIST(iLocal_29))
	{
		if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), vLocal_32) < 2500f)
			{
	...
	switch (iLocal_39)
	{
		...
		case 3:
			...
			if (HAS_MODEL_LOADED(joaat("cuban800")))
			{
				...
				{
					CLEAR_AREA_OF_VEHICLES(vLocal_42, 8f, 0, 0, 0, 0, false, 0);
					iLocal_40 = CREATE_VEHICLE(joaat("cuban800"), vLocal_42, 25.29f, true, true, false);
		...
		case 4:
			if (DOES_ENTITY_EXIST(iLocal_40))
			{
				if (IS_ENTITY_DEAD(iLocal_40, 0) || IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
				{
					iLocal_39 = 9;
					return;
				}
			...
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(iLocal_40, 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_40, 1))
				{
					func_160();
				}
			}
				...
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					...
					if (iVar2 == iLocal_40)
					{
						...
						if (DOES_ENTITY_EXIST(iLocal_29) && !DOES_ENTITY_EXIST(iLocal_29, 0))
						{
							if (GET_ENTITY_MODEL(iLocal_29) != joaat("dune") && GET_ENTITY_MODEL(iLocal_29) != joaat("cuban800"))
							{
								if (!IS_ENTITY_IN_ANGLED_AREA(iLocal_29, 2137.12f, 4799.97f, 39.67854f, 2116.64f, 4790.417f, 45.45295f, 25f, 0, true, 0))
								{
									func_133(iLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
							}
		...
		case 6:
			if (HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					if (!*iParam0)
					{
						func_82(GET_THIS_SCRIPT_NAME(), 0);
					}
					iLocal_30 = start_new_script("Traffick_Air", 29500);
					func_81(15);
				...
				if (Global_98703)
				{
					*iParam0 = 1;
					if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
					{
						if (!IS_PED_INJURED(IS_PED_INJURED()))
						{
							SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 2136.446f, 4791.483f, 39.9702f, 1, false, 0, 1);
						}
					}
					REQUEST_MODEL(joaat("cuban800"));
					REQUEST_SCRIPT("Traffick_Air");
...
int func_173()
{
	...
	if (!func_177(6))
	{
		...
		if (IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0))
		{
		}
		if (!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()))
		{
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_130()) || func_181()) || func_174()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_182()) || Global_30738) || func_176()) || func_175(8, -1)) || func_174()) || func_130()) || func_181()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_174()) || func_130()) || func_181()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_130()) || func_181()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_182() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_175(8, -1)) || func_180()) || func_179()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_182()) || Global_30738) || func_176()) || func_175(8, -1)) || func_181()) || func_174()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_182()) || func_181()) || Global_110607) || Global_30738) || func_176()) || Global_42561) || func_175(8, -1)) || func_174()) || func_179()) || func_180()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_182()) || Global_110607) || Global_30738) || func_176()) || func_175(8, -1)) || func_174()) || func_179()) || func_130()) || func_181()) || func_180())
						{
							return 0;
						}
						break;
...
void func_187()
{
	if (!iLocal_58)
	{
		iLocal_57 = ADD_SCENARIO_BLOCKING_AREA(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), 0, 1, 1, 1);
		iLocal_58 = 1;
	}
}
