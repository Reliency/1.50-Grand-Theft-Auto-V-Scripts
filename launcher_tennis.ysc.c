...
void __EntryFunction__()
{
	...
	iLocal_62 = GET_PLAYER_PED(GET_PLAYER_PED());
	iLocal_68 = 0;
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH()) > 1 && !func_180(uLocal_67, 4194304))
	{
		if (iLocal_78 != 263)
		{
	...
	while (true)
	{
		...
		if (DOES_ENTITY_EXIST(iLocal_62) && !DOES_ENTITY_EXIST(iLocal_62, 0))
		{
			vLocal_64 = { GET_ENTITY_COORDS(iLocal_62, true) };
			...
			switch (iLocal_68)
			{
				...
				case 3:
					...
					if (!func_178(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (ARE_STRINGS_EQUAL(&(Global_98669.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_165(3) && !Global_98703)
						{
							...
							{
								if ((!func_180(uLocal_67, 1) || !DOES_ENTITY_EXIST(func_164())) && !Global_98703)
								{
									func_173(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), vLocal_86, vLocal_87, fLocal_88, 1, false, iLocal_76) || (fLocal_90 > 0f && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), true), func_139(vLocal_86, vLocal_87, 0.5f), false) > fLocal_90))
							{
								bVar2 = false;
							}
							else if (fLocal_89 > 0f)
							{
								if (ABSF((vLocal_64.z - vLocal_86.z)) > fLocal_89)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_138(uLocal_63))
								{
									...
									else if (!func_180(uLocal_67, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_136(&iLocal_69);
				...
				case 6:
					...
					if (func_180(uLocal_67, 2097152))
					{
						if (!func_165(3) && !IS_THREAD_ACTIVE(iLocal_51))
						{
							func_173(10);
						}
					}
					...
					{
						PLAYSTATS_ODDJOB_DONE(round((func_11(&iLocal_80) * 1000f)), iLocal_72, 0);
						func_10(&iLocal_80);
						...
						if (iLocal_72 != -1)
						{
							if (func_180(Global_110211, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_72), 0, Global_98706, 0);
...
{
	_0x5AAB586FFEC0FD96(iParam0);
	_0xF79F9DEF0AADE61A(iParam0);
}
...
void func_38()
{
	...
	if (!_0x66680A92700F43DF(_0x66680A92700F43DF()))
	{
	}
}
...
void func_44(int iParam0, int iParam1, var uParam2)
{
	...
	while (iVar0 <= 11)
	{
		...
		{
			_0x39D55A620FCB6A3A(iParam0, iVar0, Var1.f_3, Var1.f_4);
		}
		iVar0++;
	}
	...
	while (iVar2 <= 8)
	{
		...
		if (uVar6[iVar2] != iVar5)
		{
			...
			{
				_IS_PED_PROP_VALID(iParam0, iVar4, Var1.f_3, Var1.f_4);
			}
		}
		iVar2++;
	}
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_51(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_51(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_146()
{
	if (func_167(6) || func_167(7))
	{
		...
		{
			switch (func_147(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
			{
				case 1:
					return func_166(96);
					break;
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_158()) || func_157()) || func_156()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_160()) || Global_30738) || func_159()) || func_142(8, -1)) || func_156()) || func_158()) || func_157()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_156()) || func_158()) || func_157()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_158()) || func_157()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_160() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_142(8, -1)) || func_144()) || func_155()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_160()) || Global_30738) || func_159()) || func_142(8, -1)) || func_157()) || func_156()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_160()) || func_157()) || Global_110607) || Global_30738) || func_159()) || Global_42561) || func_142(8, -1)) || func_156()) || func_155()) || func_144()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_160()) || Global_110607) || Global_30738) || func_159()) || func_142(8, -1)) || func_156()) || func_155()) || func_158()) || func_157()) || func_144())
						{
							return 0;
						}
						break;
...
void func_162()
{
	...
	if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
	{
		if (func_131(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
			iVar0 = func_130(PLAYER_PED_ID());
...
void func_169()
{
	...
	if (bLocal_93 && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
...
void func_181()
{
	...
	if ((GET_RAIN_LEVEL() + GET_RAIN_LEVEL()) > 0.1f)
	{
		bLocal_93 = false;
	}
}
