	...
	while (true)
	{
		...
		switch (iLocal_37)
		{
			...
			case 1:
				...
				if (((((HAS_MODEL_LOADED(joaat("prop_phone_ing")) && HAS_MODEL_LOADED("amb@world_human_stand_mobile@female@standing@call@enter")) && HAS_MODEL_LOADED("amb@world_human_stand_mobile@female@standing@call@base")) && HAS_MODEL_LOADED("amb@world_human_stand_mobile@female@standing@call@exit")) && HAS_MODEL_LOADED("amb@world_human_smoking@female@enter")) && HAS_MODEL_LOADED("amb@world_human_smoking@female@idle_a"))
				{
					iLocal_37 = 2;
				}
				break;
...
int func_1()
{
	...
	if ((vdist2(vVar0, vVar1) > 10000f || IS_ENTITY_DEAD(iLocal_38, 0)) || func_4())
	{
...
void func_18()
{
	...
	{
		if (func_21(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
