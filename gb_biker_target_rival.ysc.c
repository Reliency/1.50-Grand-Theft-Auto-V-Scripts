...
void func_3(int iParam0)
{
	...
	iVar0 = iParam0;
	CLEAR_BIT(&(Global_2416074.f_388), iVar0);
	CLEAR_BIT(&(Global_2416074.f_389), iVar0);
	CLEAR_BIT(&(Global_2416074.f_390), iVar0);
	CLEAR_BIT(&(Global_2416074.f_392), iVar0);
	CLEAR_BIT(&(Global_2416074.f_396), iVar0);
	CLEAR_BIT(&(Global_2416074.f_391), iVar0);
}
...
int func_12(int iParam0)
{
	if (func_5(iParam0, 0, 1))
	{
		...
		if (func_75(iParam0))
		{
			func_72(iParam0, func_73(func_74(PLAYER_ID())), 1, 0);
		}
		if (func_70(iParam0))
		{
...
int func_23(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_53(PLAYER_ID()) || (func_52() && func_51())) && !PLAYER_ID(Global_2531497.f_4591, 31)) && !bParam4)
	{
		iVar1 = func_50();
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_58(iParam1, iParam0, iVar0, 0) && !IS_BIT_SET(Global_4456448.f_15, 18)) || ((func_29(IS_BIT_SET(iParam1), IS_BIT_SET(iParam0), 0) && IS_BIT_SET(Global_4456448.f_15, 23)) && !IS_BIT_SET(Global_4456448.f_15, 18)))
			{
				return func_22(1);
			}
...
int func_48(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_6())
	{
		...
		if (IS_BIT_SET(Global_4456448.f_15, 26) && !func_29(iParam0, IS_BIT_SET(iParam1), 0))
		{
			iVar0 = func_36(1);
		}
	}
...
int func_64(int iParam0)
{
	...
	if (GET_HASH_KEY(GET_HASH_KEY()) == func_65())
	{
		return 1;
	}
	return 0;
...
int func_79()
{
	...
	if (func_65() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_65()) == 0)
		{
			return 1;
		}
	}
