...
void __EntryFunction__()
{
	...
	Global_41947 = GET_GAME_TIMER() + 20000;
	iVar0 = 0;
				...
				if (iLocal_90 == 1)
				{
					if (func_146(0))
					{
						if (func_145())
						{
							...
							if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 3))
							{
								if (func_140())
								{
									iLocal_90 = 2;
...
void func_67()
{
	...
	{
		if (func_69(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_74(int iParam0)
{
	...
	if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 3))
	{
		...
		if (iVar0 != -1)
		{
			if (func_75(PLAYER_PED_ID(), iVar0, (Global_41397[iVar0 /*5*/].f_3 * 0.35f)))
			{
				func_150(&iParam0, 0);
				func_133(0);
				iLocal_90 = 0;
...
void func_76()
{
	...
	if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 1))
	{
		if (!func_54(26))
		{
			if (func_84())
...
{
	iParam0->f_1 = (func_78(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
int func_90()
{
	...
	if (iVar0 >= 0 && iVar0 < 3)
	{
		if (DOES_ENTITY_EXIST(Global_94533[iVar0]))
		{
			return 0;
		}
	}
...
int func_93()
{
	if (DOES_ENTITY_EXIST(Global_96177[2]))
	{
		return 0;
	}
	return 1;
...
int func_94()
{
	if (DOES_ENTITY_EXIST(Global_96177[1]))
	{
		return 0;
	}
	return 1;
...
int func_95()
{
	if (DOES_ENTITY_EXIST(Global_96177[0]))
	{
		return 0;
	}
	return 1;
...
bool func_105()
{
	return IS_BIT_SET(Global_111560.f_18569[26 /*6*/], 3);
}
...
int func_107()
{
	...
	if (Global_93701 == -1)
	{
		Global_93701 = GET_GAME_TIMER();
	}
	if ((GET_GAME_TIMER() - Global_93701) > 240000)
	{
		Global_93701 = -1;
		return 1;
	}
	...
	{
		fVar0 = vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), func_108(212, 0));
		if (fVar0 > 22500f)
		{
			Global_93701 = -1;
			return 1;
...
int func_118()
{
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (vdist2(func_108(181, 0), GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)) > 40000f)
		{
			return 1;
		}
	}
	...
	if ((GET_GAME_TIMER() - Global_93701) > 30000)
	{
		Global_93701 = -1;
		return 1;
	}
...
void func_128(int iParam0)
{
	...
	if (Global_41943 != -1)
	{
		if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 1) && !Global_111560.f_7683.f_913)
		{
			func_150(iParam0, 0);
		}
		else
		{
			...
			if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 15))
			{
				switch (func_66())
				{
					case 0:
				...
				CLEAR_BIT(&(Global_111560.f_7683[Global_41943 /*15*/].f_1), 15);
			}
			if (func_54(3))
			{
				if (!func_53(1))
...
void func_150(int iParam0, int iParam1)
{
	...
	if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 1))
	{
		if (!Global_111560.f_7683.f_913)
		{
			SET_BIT(&(Global_111560.f_7683[Global_41943 /*15*/].f_1), 10);
	...
	if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 10) || iParam1)
	{
		...
		if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 8))
		{
			func_154(&(Global_111560.f_7683[Global_41943 /*15*/]));
		}
	}
	else if (IS_BIT_SET(Global_111560.f_7683[Global_41943 /*15*/].f_1, 11))
	{
	...
	else if ((GET_GAME_TIMER() - iLocal_86) >= 10000 || iLocal_85 >= 1)
	{
		if (func_66() == 2)
		{
			if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
			{
				...
				{
					if (_IS_VEHICLE_RADIO_LOUD(_IS_VEHICLE_RADIO_LOUD(_IS_VEHICLE_RADIO_LOUD(), 0)))
					{
						switch (iLocal_85)
						{
							case -1:
...
int func_161()
{
	...
	if (bVar3)
	{
		...
		if (func_163(&uLocal_91, "CBRADAU", &Var0, 1, 1, 0, 0))
		{
			...
			PLAY_SOUND_FRONTEND(iLocal_89, "Background_Loop", "CB_RADIO_SFX", true);
			return 1;
		}
	}
	else
...
int func_179(int iParam0)
{
	...
	{
		case 5:
			if (((((((((IS_PREV_WEATHER_TYPE("SMOG") || IS_PREV_WEATHER_TYPE("OVERCAST")) || IS_PREV_WEATHER_TYPE("RAIN")) || IS_PREV_WEATHER_TYPE("THUNDER")) || IS_PREV_WEATHER_TYPE("SNOW")) || IS_PREV_WEATHER_TYPE("SMOG")) || IS_PREV_WEATHER_TYPE("OVERCAST")) || IS_PREV_WEATHER_TYPE("RAIN")) || IS_PREV_WEATHER_TYPE("THUNDER")) || IS_PREV_WEATHER_TYPE("SNOW"))
			{
				return 0;
			}
			break;
...
void func_186(int iParam0)
{
	...
	while (iVar0 < Global_111560.f_7683.f_866 && !iLocal_78)
	{
		...
		if ((*iParam0 >= Global_41947 || IS_BIT_SET(Global_111560.f_7683.f_765[iVar0 /*10*/].f_1, 21)) || iVar1)
		{
...
int func_188(var uParam0)
{
	...
	if (IS_BIT_SET(uParam0->f_2, func_202()) || bVar2)
	{
		iVar1 = 0;
		while (iVar1 < 3)
		{
...
void func_194(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_195(_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_196(iParam1)), 0));
		}
		else
		{
			func_195(_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_196(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
...
void func_222(var uParam0)
{
	...
	switch (iLocal_83)
	{
		case 0:
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				if (func_245(48))
				{
					...
					{
						if ((((!DOES_ENTITY_EXIST(func_239(60)) && !DOES_ENTITY_EXIST(func_239(61))) && Global_76573 == -1) && !func_238()) && !func_237())
						{
							if (func_66() == 0)
							{
								func_177(&uLocal_91, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
							...
							{
								func_177(&uLocal_91, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
								func_177(&uLocal_91, 3, 0, "DBLIMPOperator", 0, 1);
								cVar0[0] = "DAB_HELLO";
							...
							{
								func_177(&uLocal_91, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
								func_177(&uLocal_91, 3, 0, "DBLIMPOperator", 0, 1);
								cVar0[0] = "DAB_HELLO";
								cVar0[1] = "DAB_TREVOR";
								cVar0[2] = "DAB_SEND";
		...
		case 2:
			if (GET_GAME_TIMER() > Global_41947)
			{
				iLocal_83++;
			}
			break;
...
int func_223()
{
	...
	while (iVar0 < 2)
	{
		if (GET_DISTANCE_BETWEEN_COORDS(vVar4, vVar3[iVar0 /*3*/], true) < fVar1)
		{
			fVar1 = GET_DISTANCE_BETWEEN_COORDS(vVar4, vVar3[iVar0 /*3*/], true);
			iVar2 = iVar0;
		}
		iVar0++;
	}
...
int func_237()
{
	...
	iVar1 = GET_PED_NEARBY_VEHICLES(GET_PED_NEARBY_VEHICLES(), &uVar0);
	iVar2 = 0;
	while (iVar2 <= (iVar1 - 1))
	{
		if (GET_ENTITY_MODEL(uVar0[iVar2]) == joaat("blimp"))
		{
			if (!IS_ENTITY_DEAD(uVar0[iVar2], 0) && IS_ENTITY_DEAD(uVar0[iVar2], 0))
			{
				return 1;
			}
		}
...
int func_238()
{
	...
	{
		if (GET_ENTITY_MODEL(GET_ENTITY_MODEL(GET_ENTITY_MODEL(), 1)) == joaat("blimp"))
		{
			return 1;
		}
	}
...
void func_246(var uParam0)
{
	...
	while (iVar0 < Global_111560.f_7683.f_650)
	{
		...
		if (func_9(iVar1))
		{
			if (IS_BIT_SET(Global_111560.f_7683.f_199[iVar0 /*15*/].f_2, iVar1))
			{
					...
					if (*uParam0 >= Global_41948[Global_111560.f_7683.f_199[iVar0 /*15*/].f_6])
					{
						...
						if (!bVar2)
						{
							...
							if (iVar3 < 9)
							{
								...
								while (iVar4 < 3)
								{
									if (IS_BIT_SET(Global_111560.f_7683[iVar3 /*15*/].f_2, iVar4))
									{
										func_8(iVar4);
									}
									iVar4++;
...
{
	if (IS_BIT_SET(uParam0->f_2, func_202()))
	{
		switch (func_66())
		{
			case 0:
				func_177(&Global_41778, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
				break;
			
			case 1:
				func_177(&Global_41778, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				break;
			
			case 2:
				func_177(&Global_41778, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
				break;
		}
	}
	switch (uParam0->f_6)
		...
		if (func_245(Global_111560.f_7683.f_137[iVar0 /*15*/].f_6))
		{
			if (*uParam0 >= Global_41948[Global_111560.f_7683.f_137[iVar0 /*15*/].f_6])
			{
				...
				if (iVar1 == -1)
				{
					...
					while (iVar2 < 3)
					{
						if (IS_BIT_SET(Global_111560.f_7683.f_137[iVar0 /*15*/].f_2, iVar2))
						{
							func_8(iVar2);
						}
						iVar2++;
...
void func_262(int iParam0)
{
	...
	while (iVar0 < Global_111560.f_7683.f_764 && !iLocal_78)
	{
		...
		if ((*iParam0 >= Global_41947 || IS_BIT_SET(Global_111560.f_7683.f_651[iVar0 /*14*/].f_1, 21)) || iVar1)
		{
...
int func_265(var uParam0)
{
	...
	if (IS_BIT_SET(uParam0->f_2, func_202()))
	{
		if (func_279(uParam0->f_6, &Var3, iVar1, iVar0, 0, iVar2, 0, 1, 0, uParam0->f_13))
		{
			if (!IS_BIT_SET(uParam0->f_1, 18))
			{
				...
				while (iVar6 < 3)
				{
					if (IS_BIT_SET(uParam0->f_2, iVar6) && iVar6 != func_202())
					{
						switch (iVar6)
						{
							case 0:
	...
	else if (!IS_BIT_SET(uParam0->f_1, 18))
	{
		if (uParam0->f_12 >= 2 || IS_BIT_SET(uParam0->f_1, 19))
		{
			...
			while (iVar8 < 3)
			{
				if (IS_BIT_SET(uParam0->f_2, iVar8))
				{
					switch (iVar8)
					{
						case 0:
...
void func_284(int iParam0)
{
	...
	while (iVar0 < Global_111560.f_7683.f_136 && !iLocal_78)
	{
		...
		if (IS_BIT_SET(Global_111560.f_7683[iVar0 /*15*/].f_1, 0))
		{
			iVar1 = 0;
			...
			if ((*iParam0 >= Global_41947 || IS_BIT_SET(Global_111560.f_7683[iVar0 /*15*/].f_1, 21)) || iVar1)
			{
				if (Global_111560.f_7683[iVar0 /*15*/].f_3 == Global_111560.f_7683.f_919[func_66()] || !IS_BIT_SET(Global_111560.f_7683[iVar0 /*15*/].f_2, func_202()))
				{
...
void func_291(int iParam0)
{
	...
	while (iVar0 < Global_111560.f_7683.f_136 && !iLocal_78)
	{
		...
		if (!IS_BIT_SET(Global_111560.f_7683[iVar0 /*15*/].f_1, 0))
		{
			...
			if ((*iParam0 >= Global_41947 || iVar1) || IS_BIT_SET(Global_111560.f_7683[iVar0 /*15*/].f_1, 21))
			{
				if (Global_111560.f_7683[iVar0 /*15*/].f_3 == Global_111560.f_7683.f_919[func_66()] || !IS_BIT_SET(Global_111560.f_7683[iVar0 /*15*/].f_2, func_202()))
				{
