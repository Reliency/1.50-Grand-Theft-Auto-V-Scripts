...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 42)
		{
			...
			{
				SET_CUTSCENE_PED_COMPONENT_VARIATION(func_207(), 4, 0, 0, func_206());
...
void func_147()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_148(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_165()
{
	return func_166(GET_THIS_SCRIPT_NAME(), 0);
}
...
int func_169(vector3 vParam0, bool bParam1)
{
	...
	SET_BLIP_SCALE(iVar0, func_170(SET_BLIP_SCALE(), 1f, 1f));
	...
	if (func_127(PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= (iParam0->f_28 - 1))
		{
			if (DOES_ENTITY_EXIST(iParam0->f_28[iVar0]))
			{
				...
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0->f_28[iVar0], HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0->f_28[iVar0], true), 7.5f, 1))
					{
						if (func_179(2))
						{
							func_176(iParam0->f_27, *iParam0);
...
{
	if (func_190(uParam1, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
	{
		if (func_179(2))
		{
			if (func_177(iParam0->f_27))
	...
	if (func_127(*uParam1))
	{
		switch (*iParam0)
		{
			...
			case 1:
				...
				{
					PLAY_SOUND_FROM_COORD(iParam0->f_1, "TRUNK_THUMPS", PLAY_SOUND_FROM_COORD(*uParam1, 0f, -2.2f, 0.5f), 0, false, 0, 0);
					_PLAY_AMBIENT_SPEECH_WITH_VOICE(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_192(0), 0);
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_145()) && (PLAYER_PED_ID() - iParam0->f_60) > iParam6) && func_197(PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_198(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_179(2))
		{
			if (!func_145())
			{
				if (((func_127(PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && func_127(iParam0->f_28[1])) && func_197(PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			else if (((func_200(sParam3) && !*uParam8 == 1) && func_127(PLAYER_PED_ID())) && func_197(PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_316("pause conversation");
				func_199(1);
				*uParam8 = 1;
			}
			if (func_197(PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_208(int iParam0, char* sParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_197(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_197(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_213(iParam0);
				}
			}
			...
			if (DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_221(PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_224(int iParam0, float fParam1)
{
	...
	{
		if (func_235(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
int func_230(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_232(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_232(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_239(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_232(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_252(var uParam0, var uParam1)
{
	...
	if (DOES_ENTITY_EXIST(*uParam1) && DOES_ENTITY_EXIST(iLocal_54))
	{
		*uParam0 = CREATE_PED(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, true);
		...
		SET_ENTITY_ROTATION(*uParam0, vVar1, 2, 1);
...
void func_262(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				iLocal_67 = ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
				...
				CLEAR_AREA(-554.17f, 307.68f, 82.84f, 2f, 1, 0, 0, false);
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, 1);
			...
			else
			{
				...
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, true, 1);
		...
		case 39:
			if (bParam1)
			{
				iLocal_67 = ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
				SET_PED_NON_CREATION_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, 1);
				REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0);
				CLEAR_AREA(-1035.73f, 365.44f, 68.91f, 35f, 1, 0, 0, false);
				CLEAR_AREA_OF_VEHICLES(-1035.73f, 365.44f, 68.91f, 27f, 0, 0, 0, 0, false, 0);
			...
			else
			{
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_67, 0);
				CLEAR_PED_NON_CREATION_AREA();
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, true, 1);
			}
			break;
		...
		case 41:
			if (bParam1)
			{
				iLocal_67 = ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
				SET_PED_NON_CREATION_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f);
				CLEAR_AREA(-1096.855f, 67.6858f, 52.952f, 15f, 1, 0, 0, false);
			}
			else
			{
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_67, 0);
		...
		case 42:
			if (bParam1)
			{
				iLocal_67 = ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
void func_263(bool bParam0)
{
	...
	vVar2 = { vVar0 };
	vVar3 = { vVar1 };
	SET_ROADS_IN_ANGLED_AREA(vVar2, vVar3, 25f, 0, bParam0, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vVar0, vVar1, bParam0, 1);
	if (!bParam0)
	{
		REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(vVar0, vVar1, 0);
		CLEAR_AREA(-1100.5f, 789.8f, 164.34f, 40f, 1, 0, 0, false);
	}
}
...
int func_266(var uParam0, var uParam1)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_259(&iVar0) || !HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[1], ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[1], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			...
			while (iVar2 <= 4)
			{
				...
				SET_PED_PATH_PREFER_TO_AVOID_WATER(uParam0->f_28[iVar2], 1);
			...
			SET_VEHICLE_ENGINE_ON(uParam0->f_35[0], true, true, 0);
			...
			while (iVar2 <= 2)
			{
				SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_35[iVar2], 1084227584);
				iVar2++;
			}
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
...
int func_270(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_259(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			OPEN_SEQUENCE_TASK(&iVar3);
			TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sVar2, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
			SET_SEQUENCE_TO_REPEAT(iVar3, 1);
			CLOSE_SEQUENCE_TASK(iVar3);
			TASK_PERFORM_SEQUENCE(uParam0->f_28[0], iVar3);
			CLEAR_SEQUENCE_TASK(&iVar3);
...
int func_271(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_259(&iVar0) || !HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			if (!DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				if (func_127(uParam0->f_35[0]))
				{
					...
					SET_VEHICLE_DOOR_OPEN(uParam0->f_35[0], 2, 0, true);
		...
		case 3:
			...
			if (func_126(uParam0->f_28[0]))
			{
				...
				TASK_PLAY_ANIM(uParam0->f_28[0], sVar2, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_126(uParam0->f_28[2]))
			{
				...
				if (HAS_ANIM_DICT_LOADED(sVar2))
				{
					TASK_PLAY_ANIM(uParam0->f_28[2], sVar2, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
...
int func_275(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_259(&iVar0) || !HAS_ANIM_DICT_LOADED(uParam0->f_48))
			{
				return 0;
			}
			iLocal_51 = 2;
	...
	switch (iLocal_51)
	{
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(uParam0->f_28[1]))
			{
				...
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iVar2, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[1], iVar2, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
