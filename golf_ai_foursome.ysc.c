...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (iVar2)
		{
			...
			case 3:
				if (((HAS_ANIM_DICT_LOADED(func_336()) && HAS_ANIM_DICT_LOADED("GOLF_I", false, -1)) && HAS_ANIM_DICT_LOADED("move_m@golfer@")) && func_331(&uVar4))
				{
					func_328(&uVar3);
					iVar2 = 4;
				}
			...
			case 4:
				if (!IS_PED_INJURED(IS_PED_INJURED()) && func_327(IS_PED_INJURED()))
				{
					if (((!IS_SPHERE_VISIBLE(func_326(&Var1, (2 + iVar5 * 2)), 10f) && !IS_SPHERE_VISIBLE(IS_SPHERE_VISIBLE(), func_326(&Var1, (2 + iVar5 * 2)), 10f, 10f, 10f, false, true, 0)) || ((func_325() || IS_SPHERE_VISIBLE()) || IS_SPHERE_VISIBLE())) || func_324(4))
					{
						if (iVar6 == 0)
						{
							func_320(&Var1, &(Var0[iVar5 /*170*/]), (2 + iVar5 * 2), GET_RANDOM_INT_IN_RANGE(1, 3));
						}
...
void func_1(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	...
	func_299(&(uParam2->f_15[uParam2->f_165 /*34*/]), PLAYER_PED_ID(), uParam2, uParam2->f_165, uParam1);
	uParam2->f_165++;
	if (uParam2->f_165 >= func_319(uParam2))
	{
		uParam2->f_165 = 0;
	}
	bVar1 = GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0;
	Var2.f_2 = 1097859072;
	Var2.f_3 = 1500;
	Var2.f_4 = 45;
	Var2.f_5 = 1103626240;
	...
	while (iVar0 < func_319(uParam2))
	{
		if (DOES_ENTITY_EXIST(func_298(&(uParam2->f_15[iVar0 /*34*/]))))
		{
			if (IS_ENTITY_DEAD(func_298(&(uParam2->f_15[iVar0 /*34*/])), 0) && !func_297(uParam2, iVar0, 16777216))
			{
				func_295(uParam2);
				return;
			}
	...
	{
		if (GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0) == func_293(uParam2, 0))
		{
			SET_ENTITY_AS_MISSION_ENTITY(func_293(uParam2, 0), false, 0);
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uParam2->f_152[0]));
			func_284(uParam2, 0, 0);
			if (DOES_ENTITY_EXIST(func_283(uParam2, 0)) && !DOES_ENTITY_EXIST(func_283(uParam2, 0), 0))
			{
				if (GET_SCRIPT_TASK_STATUS(func_283(uParam2, 0), -1794415470) != 1)
				{
					CLEAR_PED_TASKS(func_283(uParam2, 0));
					TASK_TURN_PED_TO_FACE_ENTITY(func_283(uParam2, 0), TASK_TURN_PED_TO_FACE_ENTITY(), -1);
				}
			}
			if (DOES_ENTITY_EXIST(func_283(uParam2, 1)) && !DOES_ENTITY_EXIST(func_283(uParam2, 1), 0))
			{
				if (GET_SCRIPT_TASK_STATUS(func_283(uParam2, 1), -1794415470) != 1)
				{
					CLEAR_PED_TASKS(func_283(uParam2, 1));
					TASK_TURN_PED_TO_FACE_ENTITY(func_283(uParam2, 1), TASK_TURN_PED_TO_FACE_ENTITY(), -1);
				}
			}
		}
		if (GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0) == func_293(uParam2, 1))
		{
			SET_ENTITY_AS_MISSION_ENTITY(func_293(uParam2, 1), false, 0);
	...
	if (func_278(uParam0, 1) || func_324(1))
	{
		...
		while (iVar0 < func_319(uParam2))
		{
			if (DOES_ENTITY_EXIST(func_298(&(uParam2->f_15[iVar0 /*34*/]))))
			{
				if (!IS_ENTITY_DEAD(func_298(&(uParam2->f_15[iVar0 /*34*/])), 0))
				{
					SET_ENTITY_COORDS(func_298(&(uParam2->f_15[iVar0 /*34*/])), func_277(&(uParam2->f_15[iVar0 /*34*/])), 1, false, 0, 1);
				}
			}
			iVar0++;
		}
	...
	switch (func_275(uParam2))
	{
		case 5:
			...
			{
				if ((((DOES_ENTITY_EXIST(func_273(uParam2, uParam2->f_165)) && !DOES_ENTITY_EXIST(func_273(uParam2, uParam2->f_165), 0)) && DOES_ENTITY_EXIST(func_283(uParam2, uParam2->f_165))) && !func_297(uParam2, uParam2->f_165, 16777216)) && func_272(func_273(uParam2, uParam2->f_165), func_283(uParam2, uParam2->f_165), 1) < 25f)
				{
					if (GET_SCRIPT_TASK_STATUS(func_283(uParam2, uParam2->f_165), -1794415470) != 1 && !func_297(uParam2, uParam2->f_165, 67108864))
					{
						CLEAR_PED_TASKS(func_283(uParam2, uParam2->f_165));
						if (!IS_PED_IN_VEHICLE(func_283(uParam2, uParam2->f_165), func_273(uParam2, uParam2->f_165), 0))
						{
							if (uParam2->f_165 == func_270(uParam2, func_271(uParam2, uParam2->f_165)))
							{
								if (!DOES_ENTITY_EXIST(func_283(uParam2, uParam2->f_165 + 1)) || !DOES_ENTITY_EXIST(func_283(uParam2, uParam2->f_165 + 1)))
								{
									TASK_ENTER_VEHICLE(func_283(uParam2, uParam2->f_165), func_273(uParam2, uParam2->f_165), -1, -1, 1f, 1, 0);
								}
							}
							else
							{
								TASK_ENTER_VEHICLE(func_283(uParam2, uParam2->f_165), func_273(uParam2, uParam2->f_165), -1, 0, 1f, 1, 0);
							}
						}
					}
				}
				else
				{
					...
					while (iVar0 < func_319(uParam2))
					{
						if (iVar0 != func_269(uParam2))
						{
							...
							if (DOES_ENTITY_EXIST(func_283(uParam2, iVar0)) && !DOES_ENTITY_EXIST(func_283(uParam2, iVar0), 0))
							{
								CLEAR_PED_TASKS(func_283(uParam2, iVar0));
								TASK_FOLLOW_NAV_MESH_TO_COORD(func_283(uParam2, iVar0), vVar7, 1f, -1, 1048576000, 0, 1193033728);
							}
						}
						iVar0++;
					}
		...
		case 2:
			...
			{
				SET_PED_RESET_FLAG(func_64(uParam2), 129, true);
			}
			if (func_63(uParam2, -1, 0))
			{
				...
				if (func_274(uParam2, 1048576))
				{
					...
					TASK_TURN_PED_TO_FACE_COORD(func_64(uParam2), func_41(uParam1, func_312(uParam2)), 0);
				}
			}
...
void func_2(var uParam0, var uParam1, bool bParam2)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		...
		if (DOES_ENTITY_EXIST(func_298(&(uParam0->f_15[iVar0 /*34*/]))))
		{
			if (!IS_ENTITY_DEAD(func_298(&(uParam0->f_15[iVar0 /*34*/])), 0))
			{
				SET_ENTITY_COORDS(func_298(&(uParam0->f_15[iVar0 /*34*/])), func_265(uParam1, iVar1, iVar0), 1, false, 0, 1);
			}
		}
		iVar0++;
	}
	if (bParam2)
	{
		...
		if (func_3(func_326(uParam1, iVar1), func_41(uParam1, iVar1), &vVar2, &fVar4, 0f, 0f, 0f, 0f, 0f, 0f, 0))
		{
			...
			while (iVar5 < 2)
			{
				if (DOES_ENTITY_EXIST(func_293(uParam0, iVar5)))
				{
					if (!IS_ENTITY_DEAD(func_293(uParam0, iVar5), 0) && !IS_ENTITY_DEAD(vVar2 + FtoV(to_float(iVar5)) * vVar3, 5f))
					{
						SET_ENTITY_COORDS(func_293(uParam0, iVar5), vVar2 + FtoV(to_float(iVar5)) * vVar3, 1, false, 0, 1);
						SET_ENTITY_HEADING(func_293(uParam0, iVar5), fVar4);
					}
				}
				iVar5++;
			}
...
int func_3(vector3 vParam0, struct<2> Param1, var uParam2, var uParam3, float fParam4, vector3 vParam5, struct<2> Param6, float fParam7, bool bParam8)
{
	...
	{
		if (!GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, iVar1, uParam3, fParam4, &uVar2, 1, 3f, 0f))
		{
			return 0;
		}
		else if ((vdist2(vParam0, *uParam3) > 100f && !IS_ANY_VEHICLE_NEAR_POINT(*uParam3, 5f)) && !func_7(*uParam3))
		{
	...
	if (ABSF((ABSF((Param1 - vParam0.x), (Param1.f_1 - vParam0.y)) - *fParam4)) > 90f)
	{
...
int func_7(vector3 vParam0)
{
	...
	if (func_8(vParam0, vVar0) > fVar1)
	{
		...
		if (IS_POINT_IN_ANGLED_AREA(vParam0, -1227.909f, -68.76888f, 43.06714f, -1260.599f, -50.60131f, 44.63058f, 2.74f, 0, false))
		{
			return 1;
		}
	}
...
int func_18(var uParam0, var uParam1)
{
	...
	if (vdist2(GET_ENTITY_COORDS(func_64(uParam0), true), func_41(uParam1, func_312(uParam0))) < IntToFloat(iVar1))
	{
		if (DOES_ENTITY_EXIST(func_25(uParam0)) && !DOES_ENTITY_EXIST(func_293(uParam0, func_252(uParam0)), 0))
		{
			if (vdist2(GET_ENTITY_COORDS(func_25(uParam0), true), func_41(uParam1, func_312(uParam0))) > IntToFloat(iVar1))
			{
				return 1;
			}
	...
	if (vdist2(GET_ENTITY_COORDS(func_64(uParam0), true), func_19(uParam0)) < IntToFloat(iVar0))
	{
		return 0;
	}
	return 1;
...
void func_20(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		if (((iParam2 == 0 && (iVar0 == 0 || iVar0 == 1)) || (iParam2 == 1 && (iVar0 == 2 || iVar0 == 3))) && func_23(uParam0, iVar0) == 4)
		{
			...
			TASK_PERFORM_SEQUENCE(func_283(uParam0, iVar0), uParam0->f_15[iVar0 /*34*/].f_21);
...
void func_38(var uParam0)
{
	...
	{
		DETACH_ENTITY(uParam0->f_4, 1, true);
...
void func_42(var uParam0, int iParam1, vector3 vParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	SET_ENTITY_COORDS(func_283(uParam0, iParam1), vParam2, 0, false, 0, 1);
	iVar1 = func_271(uParam0, iParam1);
	if (DOES_ENTITY_EXIST(func_293(uParam0, iVar1)) && iParam5)
	{
		vVar2 = { 0f, 0f, 0f };
		vVar3 = { 0f, 0f, 0f };
		fVar4 = 0f;
		...
		if (!IS_ENTITY_DEAD(func_293(uParam0, iVar1), 0))
		{
			...
			if (bVar5 && !IS_SPHERE_VISIBLE(vVar2, 5f))
			{
				SET_ENTITY_COORDS(func_293(uParam0, iVar1), vVar2, 1, false, 0, 1);
				SET_ENTITY_HEADING(func_293(uParam0, iVar1), fVar4);
			}
		}
	}
}
...
{
	if (!GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, uParam3, fParam4, 1, 1077936128, 0))
	{
		return 0;
	}
	if (ABSF((ABSF((Param1 - vParam0.x), (Param1.f_1 - vParam0.y)) - *fParam4)) > 90f)
...
void func_67(var uParam0, var uParam1, var uParam2)
{
	...
	switch (func_34(uParam2))
	{
		case 0:
			...
			if (!DOES_ENTITY_EXIST(func_249(uParam2)))
			{
				func_244(uParam2, func_246(vVar0, func_247(func_248(uParam1, func_312(uParam2)), func_19(uParam2))));
			}
			else if (!func_243())
			{
				SET_ENTITY_COORDS(func_249(uParam2), vVar0, 1, false, 0, 1);
			}
			func_242(uParam2, GET_ENTITY_COORDS(func_249(uParam2), true));
			...
			SET_ENTITY_RECORDS_COLLISIONS(func_249(uParam2), 0);
		...
		case 3:
			if (func_193(uParam2) || func_40(&(uParam2->f_15[func_269(uParam2) /*34*/]), 1048576))
			{
				...
				if (DOES_ENTITY_EXIST(func_64(uParam2)) && !DOES_ENTITY_EXIST(func_64(uParam2), 0))
				{
					if (vdist2(GET_ENTITY_COORDS(func_64(uParam2), true), func_19(uParam2)) > 9f)
					{
			...
			else if (GET_ENTITY_SPEED(func_64(uParam2)) == 0f && func_171(&(uParam2->f_162), 15f))
			{
				func_259(&(uParam2->f_162));
				CLEAR_PED_TASKS(func_64(uParam2));
				if (!func_266(uParam2, -1))
		...
		case 4:
			if (func_170(PLAYER_PED_ID(), uParam2->f_15[func_269(uParam2) /*34*/].f_2, 0) < 1f)
			{
				if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), uParam2->f_15[func_269(uParam2) /*34*/].f_2))
				{
					CLEAR_PED_TASKS_IMMEDIATELY(uParam2->f_15[func_269(uParam2) /*34*/].f_2);
					func_203(uParam1, uParam2, uParam0, 0, 0, 0, 1, 0);
					func_276(uParam2, 0);
					func_262(uParam2, 1);
			...
			{
				if (((uParam2->f_1 == 4 || uParam2->f_1 == 6) || func_274(uParam2, 1048576)) && DOES_ENTITY_EXIST(func_249(uParam2)))
				{
					if (((func_156(func_64(uParam2)) || func_171(&(uParam2->f_162), 2.5f)) || func_274(uParam2, 1048576)) && DOES_ENTITY_HAVE_PHYSICS(func_249(uParam2)))
					{
						if (func_274(uParam2, 1048576))
						{
							if (bLocal_0)
				...
				else if (!DOES_ENTITY_EXIST(func_249(uParam2)))
				{
					uParam2->f_1 = 0;
					func_262(uParam2, 0);
				}
		...
		case 6:
			func_118(uParam0, uParam2, 1);
			if ((func_88(uParam2) || func_87(uParam2)) || func_7(GET_ENTITY_COORDS(func_249(uParam2), true)))
			{
				func_86(uParam2);
			}
			else
		...
		case 8:
			...
			{
				CLEAR_PED_TASKS(func_64(uParam2));
				OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
				TASK_GO_TO_COORD_ANY_MEANS(0, func_267(uParam1, func_312(uParam2), func_269(uParam2)), 1f, 0, 0, 786603, -1082130432);
				TASK_TURN_PED_TO_FACE_COORD(0, func_41(uParam1, func_312(uParam2)), 0);
				CLOSE_SEQUENCE_TASK(uParam2->f_15[func_269(uParam2) /*34*/].f_21);
				TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_269(uParam2) /*34*/].f_21);
				CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
			}
			break;
			...
			if (!func_118(uParam0, uParam2, 0))
			{
				if (func_70(uParam1, uParam2) && !func_266(uParam2, func_269(uParam2)))
				{
					if (!func_274(uParam2, 1048576))
					{
						...
						CLEAR_PED_TASKS(func_64(uParam2));
						OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_265(uParam1, func_312(uParam2), func_269(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
						TASK_TURN_PED_TO_FACE_COORD(0, func_326(uParam1, func_312(uParam2)), 0);
						CLOSE_SEQUENCE_TASK(uParam2->f_15[func_269(uParam2) /*34*/].f_21);
						TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_269(uParam2) /*34*/].f_21);
						CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
					}
					...
					{
						SET_ENTITY_COORDS(func_64(uParam2), func_265(uParam1, func_312(uParam2), func_269(uParam2)), 1, false, 0, 1);
					}
				}
				else if (func_194(uParam2) || func_274(uParam2, 67108864))
				{
					if (!func_274(uParam2, 1048576))
					{
						if (!func_63(uParam2, func_269(uParam2), 0))
						{
							...
							CLEAR_PED_TASKS(func_64(uParam2));
							OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_267(uParam1, func_312(uParam2), func_269(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
							TASK_TURN_PED_TO_FACE_COORD(0, func_41(uParam1, func_312(uParam2)), 0);
							CLOSE_SEQUENCE_TASK(uParam2->f_15[func_269(uParam2) /*34*/].f_21);
							TASK_PERFORM_SEQUENCE(func_64(uParam2), uParam2->f_15[func_269(uParam2) /*34*/].f_21);
							CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_269(uParam2) /*34*/].f_21));
					...
					{
						SET_ENTITY_COORDS(func_64(uParam2), func_267(uParam1, func_312(uParam2), func_269(uParam2)), 1, false, 0, 1);
					}
				}
				else if (!func_274(uParam2, 1048576))
				{
					if (!func_63(uParam2, func_269(uParam2), 0) && DOES_ENTITY_EXIST(func_25(uParam2)))
					{
...
void func_77(var uParam0, var uParam1)
{
	if (!bLocal_376)
	{
		...
		func_242(uParam1, GET_ENTITY_COORDS(func_249(uParam1), true));
		func_84(uParam1, vdist(func_19(uParam1), func_41(uParam0, func_312(uParam1))));
	}
	else
	{
		SET_ENTITY_COORDS(func_249(uParam1), func_19(uParam1) + Vector(0.05f, 0f, 0f), 1, false, 0, 1);
		func_82(uParam1);
		func_80(uParam1);
	}
	SET_ENTITY_MAX_SPEED(func_249(uParam1), 150f);
...
void func_89(var uParam0, var uParam1, var uParam2)
{
	...
	vVar4 = { GET_ENTITY_COORDS(iVar0, true) };
	...
	{
		func_59(uParam2, GET_ENTITY_COORDS(iVar0, true), func_99(GET_ENTITY_COORDS(iVar0)));
		func_74(uParam2, 2);
		func_310(uParam0, 268435456);
		if (DOES_ENTITY_EXIST(iVar5))
		{
			if (IS_ENTITY_TOUCHING_ENTITY(iVar0, iVar5) && !func_274(uParam2, 268435456))
			{
				PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IMPACT_FLAG_MASTER", func_249(uParam2), 0, false, 0);
				SET_ENTITY_COLLISION(iVar5, false, 0);
	...
	{
		if (!func_278(uParam0, 268435456) && vdist2(vVar4, vVar3) < (0.3f * 0.3f))
		{
			PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_CUP_MISS_MASTER", func_249(uParam2), 0, false, 0);
	...
	if (((fVar2 < 0.25f || (fVar2 < 6f && func_98(uParam1, uParam2))) || func_274(uParam2, 256)) || func_97())
	{
		...
		{
			func_59(uParam2, GET_ENTITY_COORDS(iVar0, true), func_99(GET_ENTITY_COORDS(iVar0)));
			func_58(uParam2, GET_COLLISION_NORMAL_OF_LAST_HIT_FOR_ENTITY(iVar0));
			if (func_98(uParam1, uParam2))
			{
			}
			func_259(&(uParam2->f_159));
		}
		if ((!func_98(uParam1, uParam2) && (((func_274(uParam2, 256) || vdist2(vVar4, vVar3) < (0.1601f * 0.1601f)) || func_97()) || func_93(uParam1, uParam2))) && 0)
		{
		...
		else if (func_171(&(uParam2->f_159), 0.5f))
		{
			...
			SET_ENTITY_RECORDS_COLLISIONS(iVar0, 0);
	...
	{
		SET_ENTITY_COORDS(iVar0, func_90(uParam2), 1, false, 0, 1);
		SET_ENTITY_RECORDS_COLLISIONS(iVar0, 0);
		func_202(iVar0, 1);
		func_262(uParam2, 6);
		func_74(uParam2, 68);
...
void func_92(int iParam0, struct<2> Param1, float fParam2, struct<2> Param3, var uParam4)
{
	...
	APPLY_FORCE_TO_ENTITY(iParam0, 0, vVar0, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
}
...
int func_93(var uParam0, var uParam1)
{
	...
	if (vdist(vVar0, func_41(uParam0, func_312(uParam1))) > fVar1)
	{
		return 0;
	}
	return 1;
...
int func_98(var uParam0, var uParam1)
{
	...
	if (!DOES_ENTITY_EXIST(func_249(uParam1)))
	{
		return 0;
	}
	vVar0 = { GET_ENTITY_COORDS(func_249(uParam1), false) };
...
{
	PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IN_WATER_MASTER", func_249(uParam0), 0, false, 0);
	return;
	START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_golf_landing_water", START_PARTICLE_FX_NON_LOOPED_AT_COORD(func_249(uParam0), true), 0f, 0f, func_247(START_PARTICLE_FX_NON_LOOPED_AT_COORD(func_249(uParam0), true), func_19(uParam0)), 1065353216, 0, 0, 0);
}
...
void func_105(var uParam0, var uParam1, var uParam2)
{
	...
	DRAW_DEBUG_LINE(DRAW_DEBUG_LINE(iVar0, true), DRAW_DEBUG_LINE(iVar0, true) + func_6(vVar9), 0, 0, 0, 255);
	if (func_100(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
	{
		if (DOES_ENTITY_EXIST(iVar1))
		{
			if (IS_ENTITY_TOUCHING_ENTITY(iVar0, iVar1))
			{
				...
				{
					SET_ENTITY_COLLISION(iVar1, false, 0);
				}
			}
		}
		fVar10 = 1f;
		...
		fVar12 = 0f;
		fVar13 = 0f;
		switch (func_99(GET_LAST_MATERIAL_HIT_BY_ENTITY(iVar0)))
		{
			case 1:
				fVar10 = 0.89f;
				fVar11 = 0.75f;
		...
		if (!bLocal_379)
		{
			...
			APPLY_FORCE_TO_ENTITY(iVar0, 0, vVar9, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
		}
		...
		if (!func_278(uParam0, 64))
		{
			...
			{
				_GET_GROUND_Z_COORD_WITH_OFFSETS(_GET_GROUND_Z_COORD_WITH_OFFSETS(iVar0, true) + Vector(1f, 0f, 0f), &uVar4, &vVar15);
				...
				SET_ENTITY_VELOCITY(iVar0, vVar14);
			}
			func_125(uParam0, 64);
		...
		{
			vVar18 = { GET_ENTITY_VELOCITY(iVar0) };
			if (fVar10 != 1f)
			{
				vVar18 = { vVar18 * Vector(fVar10, fVar10, fVar10) };
				SET_ENTITY_VELOCITY(iVar0, vVar18);
			}
		}
	}
	else
	{
		...
		if (!bLocal_378 && !func_111(uParam2))
		{
			...
			APPLY_FORCE_TO_ENTITY(iVar0, 0, vVar19, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
		}
		if (!bLocal_379)
		{
			APPLY_FORCE_TO_ENTITY(iVar0, 0, vVar9, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
	...
	if (func_110(uParam2))
	{
		SET_PAD_SHAKE(0, 50, func_108(0, func_109(256, (SET_PAD_SHAKE(round(uParam2->f_1.f_6)) + SET_PAD_SHAKE(round(uParam2->f_1.f_5))) + 30)));
	}
	if (!func_274(uParam2, 2))
	{
		...
		if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0) && func_256(&(uParam2->f_159), 0.2f))
		{
			...
			func_78(uParam2, vdist(GET_ENTITY_COORDS(iVar0, true), func_19(uParam2)));
			func_74(uParam2, 2);
			func_169(&(uParam2->f_159));
			func_106(uParam2);
		}
	...
	{
		func_92(iVar0, GET_ENTITY_COORDS(iVar0, true), func_41(uParam1, func_312(uParam2)));
	}
	else if ((fVar3 < 0.5f && (ABSF(uParam2->f_1.f_5) + ABSF(uParam2->f_1.f_6)) < 0.05f) || (fVar3 < 6f && func_98(uParam1, uParam2)))
	{
		if (!func_96(&(uParam2->f_159)))
		{
			func_59(uParam2, GET_ENTITY_COORDS(iVar0, true), func_99(GET_ENTITY_COORDS(iVar0)));
	...
	{
		vLocal_386 = { GET_ENTITY_VELOCITY(iVar0) };
	}
	func_310(uParam0, 32);
}
...
void func_106(var uParam0)
{
	...
	sVar0 = "";
	switch (GET_LAST_MATERIAL_HIT_BY_ENTITY(func_249(uParam0)))
	{
		case -461750719:
		case 930824497:
	...
	if (!func_107(sVar0))
	{
		START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, START_PARTICLE_FX_NON_LOOPED_AT_COORD(func_249(uParam0), true), 0f, 0f, func_247(START_PARTICLE_FX_NON_LOOPED_AT_COORD(func_249(uParam0), true), func_19(uParam0)), 1065353216, 0, 0, 0);
	}
}
...
void func_112(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_107(sVar0))
	{
		if (bParam1)
		{
			PLAY_SOUND_FROM_COORD(-1, sVar0, PLAY_SOUND_FROM_COORD(func_249(uParam0), true), 0, false, 0, 0);
		}
		else
		{
			PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_249(uParam0), 0, false, 0);
		}
	}
}
...
int func_118(var uParam0, var uParam1, bool bParam2)
{
	...
	if (IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar2, 3))
	{
		if (GET_ENTITY_ANIM_CURRENT_TIME(iVar0, func_119(0), &cVar2) > 0.95f)
		{
			return 0;
		}
	}
	if (bParam2)
	{
		if (!IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar2, 3) && (((IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), "iron_swing_action", 3) || IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), "putt_action", 3)) || IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), "wedge_swing_action", 3)) || IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), "wood_swing_action", 3)))
		{
			TASK_PLAY_ANIM(iVar0, func_119(0), &cVar2, 8f, -2f, -1, 0, 0, 0, 0, 0);
		}
		return 1;
	}
	return 0;
...
int func_124(int iParam0, float fParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		if (IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar0, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar0) >= fParam1)
			{
				return 1;
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar1, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar1) >= fParam1)
			{
				return 1;
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar2, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar2) >= fParam1)
			{
				return 1;
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar3, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar3) >= fParam1)
			{
				return 1;
			}
		}
...
int func_126(var uParam0, var uParam1, var uParam2)
{
	...
	SET_ENTITY_RECORDS_COLLISIONS(func_249(uParam2), 1);
	SET_OBJECT_PHYSICS_PARAMS(func_249(uParam2), -1f, -1f, 0f, 0f, 0.01f, -1f, -1f, -1f, -1f, -1f, -1082130432);
	...
	else
	{
		...
		{
			vVar14 = { func_131(vVar14, (fVar16 * (ACOS(ACOS(fVar15)) - 15f))) };
		}
		vVar10.y = ((vVar14.y / ABSF(vVar14.y)) * sqrt(ABSF((((vVar10.z * vVar10.z) - 1f) / (((vVar14.x * vVar14.x) / (vVar14.y * vVar14.y)) + 1f)))));
	...
	SET_ENTITY_VELOCITY(func_249(uParam2), vVar6);
	SET_ENTITY_MAX_SPEED(func_249(uParam2), 150f);
	func_125(uParam0, 32);
...
void func_128(var uParam0, bool bParam1)
{
	...
	return;
	if (!func_194(uParam0) && DOES_ENTITY_EXIST(func_249(uParam0)))
	{
		iVar0 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_golf_ball_trail", func_249(uParam0), 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
		if (bParam1)
		{
...
void func_129(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_107(sVar0))
	{
		if (iParam2 || !DOES_ENTITY_EXIST(func_249(uParam1)))
		{
			PLAY_SOUND_FROM_COORD(-1, sVar0, func_19(uParam1), 0, false, 0, 0);
		}
		else
		{
			PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_249(uParam1), 0, false, 0);
		}
	}
}
...
void func_150()
{
	...
	{
		if (func_154(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
int func_156(int iParam0)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		if (IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar0, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar0) > 0.16f)
			{
				return 1;
			}
		}
		...
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar1) > 0.134f)
			{
				return 1;
			}
		}
		...
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar2) > 0.119f)
			{
				return 1;
			}
		}
		...
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar3) > 0.159f)
			{
				return 1;
			}
		}
...
void func_162(var uParam0, var uParam1, int iParam2, float fParam3)
{
	...
	switch (func_136(uParam0))
	{
		...
		case 3:
		case 2:
			PLAY_SOUND_FROM_ENTITY(-1, "GOLF_FORWARD_SWING_HARD_MASTER", func_163(uParam0), 0, false, 0);
			break;
...
void func_166(var uParam0)
{
	switch (func_136(uParam0))
	{
		case 0:
		case 1:
			PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BACK_SWING_HARD_MASTER", func_163(uParam0), 0, false, 0);
			break;
...
int func_172(var uParam0, var uParam1)
{
	...
	if (DOES_ENTITY_EXIST(func_173(uParam1)) && func_35(uParam1) == 3)
	{
		return 1;
	}
	if (!DOES_ENTITY_EXIST(iVar0))
	...
	vVar1 = { GET_ENTITY_COORDS(func_249(uParam1), false) };
	if (func_35(uParam1) != 3 && vdist2(vVar1, func_41(uParam0, func_312(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	if (vdist2(vVar1, func_41(uParam0, func_312(uParam1))) > (55f * 55f))
	{
		return 0;
	}
	return 1;
	...
	if (!IS_PED_INJURED(iVar0))
	{
		...
		switch (func_168(uParam1))
		{
			...
			case 1:
				...
				if (!IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar10, 3))
				{
					TASK_PLAY_ANIM(iVar0, func_119(0), &cVar10, 8f, -8f, -1, 2, 0, 0, 0, 0);
					if (bLocal_0)
					{
					}
				}
				...
				{
					fVar4 = GET_ENTITY_ANIM_CURRENT_TIME(iVar0, func_119(0), &cVar10);
					if (GET_ENTITY_ANIM_CURRENT_TIME(iVar0, func_119(0), &cVar10) >= 0.975f)
					{
						if (bLocal_0)
						{
						}
						SET_ENTITY_ANIM_SPEED(iVar0, func_119(0), &cVar10, 0f);
						if (uParam2->f_10 == 0)
						{
					...
					{
						SET_ENTITY_ANIM_SPEED(iVar0, func_119(0), &cVar10, 0.6f);
					}
					if (fVar4 < fVar2)
					{
						SET_ENTITY_ANIM_CURRENT_TIME(iVar0, func_119(0), &cVar10, fVar2);
						SET_ENTITY_ANIM_SPEED(iVar0, func_119(0), &cVar10, 0.8f);
					}
				}
				break;
			...
			case 3:
				...
				if (IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar10, 3))
				{
					...
					if (fVar4 < fVar2)
					{
						TASK_PLAY_ANIM(iVar0, func_119(0), &cVar9, 4f, -8f, -1, 10, 0, 0, 0, 0);
						func_177(uParam1, 0);
					}
					else
					{
						SET_ENTITY_ANIM_CURRENT_TIME(iVar0, func_119(0), &cVar10, (fVar4 - fVar3));
						if (bLocal_0)
						{
						}
					}
				...
				{
					if (!IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar9, 3))
					{
						TASK_PLAY_ANIM(iVar0, func_119(0), &cVar9, 4f, -8f, -1, 10, 0, 0, 0, 0);
						if (bLocal_0)
						{
			...
			case 4:
				...
				if (!IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar11, 3))
				{
					if (HAS_ENTITY_ANIM_FINISHED(iVar0, func_119(0), &cVar10, 3))
					{
						TASK_PLAY_ANIM(iVar0, func_119(0), &cVar11, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
					}
					else if (IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar10, 3))
					{
						fVar1 = GET_ENTITY_ANIM_CURRENT_TIME(iVar0, func_119(0), &cVar10);
						TASK_PLAY_ANIM(iVar0, func_119(0), &cVar11, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
...
char* func_178(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	vVar2 = { GET_ENTITY_COORDS(func_298(uParam0), true) };
	if (bParam3)
	{
	...
	vVar7 = { GET_ENTITY_FORWARD_VECTOR(func_298(uParam0)) };
	vVar8 = { func_6(vVar3 - vVar2) };
	vVar9 = { func_131(vVar7, 90f) };
	vVar10 = { vVar7 };
	func_179(&vVar10, fVar4, vVar9);
	fVar11 = ACOS(func_8(vVar7, vVar8));
	fVar12 = (fVar11 - fVar4);
	vVar13 = { func_6(vVar10) };
	func_179(&vVar13, fVar12, vVar9);
	DRAW_DEBUG_LINE(vVar2, vVar2 + vVar8, 255, 0, 0, 255);
	DRAW_DEBUG_LINE(vVar2, vVar2 + vVar7, 0, 0, 255, 255);
	DRAW_DEBUG_LINE(vVar2, vVar2 + vVar13, 255, 255, 255, 255);
	DRAW_DEBUG_LINE(vVar2, vVar2 + vVar10, 0, 0, 0, 255);
	if (fVar11 < fVar4)
	{
...
{
	iParam0->f_1 = (func_191(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
Vector3 func_196(var uParam0, var uParam1)
{
	...
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), (func_116(uParam0) + fVar1), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_269(uParam0) /*34*/])))) * ((func_165(uParam0, 1) * fVar2) / 100f)), 0f, 0f) };
	}
	else if (func_35(uParam0) != 3)
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), func_116(uParam0), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_269(uParam0) /*34*/])))) * (func_165(uParam0, 1) / 100f)), 0f, 0f) };
	}
	else
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), func_116(uParam0), Vector(-uParam0->f_1.f_1, -uParam0->f_1.f_1, -uParam0->f_1.f_1) * Vector(0f, 0f, (func_165(uParam0, 1) / 100f))) };
	}
...
void func_204(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	...
	{
		TASK_STAND_STILL(func_298(uParam0), -1);
	}
	else
	{
		iParam5 = 1;
	...
	vVar1 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_277(uParam0), func_117(uParam0), func_228(iVar0)) };
	vVar2 = { GET_ENTITY_COORDS(func_298(uParam0), true) };
	if (bParam3)
	{
		CLEAR_PED_TASKS_IMMEDIATELY(func_298(uParam0));
	}
	if (iParam5 || func_40(uParam0, 1048576))
	{
		...
		if (GET_GROUND_Z_FOR_3D_COORD(vVar1 + Vector(1f, 0f, 0f), &fVar3, 0, 0))
		{
			if ((ABSF((fVar3 - vVar2.z)) < 0.35f || fVar3 < vVar1.z) || bParam7)
			{
				vVar1.z = fVar3;
			}
		}
		...
		else
		{
			...
			if (bVar4)
			{
				SET_ENTITY_HEADING(func_298(uParam0), func_117(uParam0));
				SET_ENTITY_COORDS(func_298(uParam0), vVar1, 0, true, 1, 1);
			}
		}
	}
	else
	{
		CLEAR_PED_TASKS(func_298(uParam0));
		OPEN_SEQUENCE_TASK(&(uParam0->f_21));
		if (func_243() || func_186(uParam0))
		{
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar1, 1f, -1, 0.25f, 512, iParam2);
		...
		TASK_PERFORM_SEQUENCE(func_298(uParam0), uParam0->f_21);
...
void func_205(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	bVar2 = true;
	if (DOES_ENTITY_EXIST(func_164(uParam0)))
	{
		if (iVar1 == GET_ENTITY_MODEL(func_164(uParam0)))
		{
			bVar2 = false;
		}
	}
	...
	if (!bParam2 || bVar2)
	{
		...
		{
			ATTACH_ENTITY_TO_ENTITY(func_164(uParam0), iVar3, ATTACH_ENTITY_TO_ENTITY(iVar3, 28422), func_207(iVar3, iVar0), func_206(iVar3, iVar0), 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_209(var uParam0, var uParam1)
{
	...
	func_38(uParam0);
	iVar0 = CREATE_OBJECT_NO_OFFSET(func_211(uParam1, func_123(uParam0)), func_277(uParam0), false, true, false);
	return iVar0;
}
...
int func_210(int iParam0, int iParam1)
{
	...
	{
		return ((IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), "wood_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "wood_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "wood_idle_c", 3));
	}
	else if (iParam1 >= 6 && iParam1 <= 13)
	{
		return ((IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), "iron_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "iron_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "iron_idle_c", 3));
	}
	else if (iParam1 >= 14 && iParam1 <= 18)
	{
		return ((IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), "wedge_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "wedge_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "wedge_idle_c", 3));
	}
	else if (iParam1 == 19)
	{
		return ((IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), "putt_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "putt_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(iParam0, func_119(1), "putt_idle_c", 3));
	}
	return 0;
}
...
void func_212(var uParam0, var uParam1)
{
	...
	{
		_0x2208438012482A1A(func_298(uParam0), 1, 0);
		_0xED3C76ADFA6D07C4(func_298(uParam0));
...
void func_213(int iParam0, char[4] cParam1, char[4] cParam2, bool bParam3, float fParam4, float fParam5, int iParam6, float fParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	Var1.f_20 = iParam6;
	TASK_SCRIPTED_ANIMATION(iParam0, &Var1, &Var0, &Var0, iParam8, iParam9);
}
...
int func_215(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, float fParam10)
{
	...
	if (!func_224())
	{
		if (func_223(PLAYER_ID(), 1, 0) && !(func_222() || func_221()))
		{
			if (((bParam7 && func_220(PLAYER_ID(), 1, 0)) && PLAYER_ID()) && Global_2424073[PLAYER_ID() /*421*/].f_222 == 1)
			{
			}
			else if (func_219() == 28)
			{
	...
	if (((!vParam0.x == Global_2437549.f_1234 || !vParam0.y == Global_2437549.f_1234.f_1) || !vParam0.z == Global_2437549.f_1234.f_2) || !fParam1 == Global_2437549.f_1237)
	{
		...
		{
			if (IS_TIME_EQUAL_TO(IS_TIME_EQUAL_TO(), Global_2437549.f_1238) < func_218(0))
			{
				return 0;
			}
			STOP_PLAYER_TELEPORT();
...
int func_241(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (DOES_ENTITY_EXIST(func_249(uParam1)))
		{
			vVar0 = { GET_ENTITY_COORDS(func_249(uParam1), true) };
		}
	}
	if (vdist2(vVar0, func_41(uParam0, func_312(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	return 1;
...
int func_246(vector3 vParam0, float fParam1)
{
	...
	iVar0 = CREATE_OBJECT(joaat("prop_golf_ball"), vParam0, true, true, false);
	_0xC6033D32241F6FB5(iVar0, 1);
...
void func_253(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (IS_ENTITY_DEAD(func_273(uParam0, iParam1), 0))
	{
		func_276(uParam0, 2);
		return;
	}
	fVar1 = 144f;
	bVar6 = vdist2(GET_ENTITY_COORDS(func_293(uParam0, func_271(uParam0, iParam1)), true), uParam0->f_15[iParam1 /*34*/].f_10) < fVar1;
	if (!IS_PED_IN_VEHICLE(iVar2, func_273(uParam0, iParam1), 0) && !bVar6)
	{
		if (GET_SCRIPT_TASK_STATUS(iVar2, -1794415470) != 1)
		{
			TASK_ENTER_VEHICLE(iVar2, func_273(uParam0, iParam1), -1, -1, 1f, 1, 0);
		}
		return;
	}
	iVar7 = 786603;
	...
	if (((DOES_ENTITY_EXIST(iVar2) && !DOES_ENTITY_EXIST(iVar2, 0)) && DOES_ENTITY_EXIST(iVar2, -1817882002) != 1) && !func_40(&(uParam0->f_15[iParam1 /*34*/]), 33554432))
	{
		...
		TASK_VEHICLE_DRIVE_TO_COORD(func_283(uParam0, func_255(uParam0, iParam1)), func_273(uParam0, iParam1), uParam0->f_15[iParam1 /*34*/].f_10, 4f, 0, 0, iVar7, 4f, -1f);
	}
	if (bVar6)
	{
		CLEAR_PED_TASKS(func_283(uParam0, func_255(uParam0, iParam1)));
		func_57(&(uParam0->f_15[iParam1 /*34*/]), 33554432);
		if (!func_266(uParam0, -1))
		{
			TASK_EVERYONE_LEAVE_VEHICLE(func_273(uParam0, iParam1));
			iVar8 = 1;
			func_20(uParam0, uParam2, func_271(uParam0, iParam1), 0, 36485, 45335);
			iVar3 = 0;
			while (iVar3 < func_319(uParam0))
			{
				if (DOES_ENTITY_EXIST(func_283(uParam0, iVar3)) && !DOES_ENTITY_EXIST(func_283(uParam0, iVar3), 0))
				{
					if (IS_PED_IN_ANY_VEHICLE(func_283(uParam0, iVar3), 0))
					{
						iVar8 = 0;
					}
				}
		...
		else if ((vdist2(func_264(uParam0, iParam1), func_41(uParam2, func_312(uParam0))) < 1600f && vdist2(GET_ENTITY_COORDS(func_273(uParam0, iParam1), true), func_41(uParam2, func_312(uParam0))) < 1600f) && !func_297(uParam0, iParam1, 67108864))
		{
		...
		else if (IS_PED_IN_ANY_VEHICLE(func_283(uParam0, iParam1), 0))
		{
			TASK_VEHICLE_PARK(func_283(uParam0, func_255(uParam0, iParam1)), func_273(uParam0, iParam1), TASK_VEHICLE_PARK(func_273(uParam0, iParam1), true), 0f, 3, 360f, 0);
			if (bParam3)
			{
				TASK_LEAVE_ANY_VEHICLE(func_283(uParam0, iParam1), 0, 0);
				func_276(uParam0, 2);
...
int func_261(var uParam0, int iParam1)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		if (iVar0 >= iParam1)
		{
			if (!IS_ENTITY_DEAD(func_283(uParam0, iVar0), 0) && !IS_ENTITY_DEAD(func_273(uParam0, iVar0), 0))
			{
				if ((!IS_PED_IN_VEHICLE(func_283(uParam0, iVar0), func_273(uParam0, iVar0), 0) && !func_297(uParam0, iVar0, 16777216)) && !func_297(uParam0, iVar0, 67108864))
				{
					return 0;
				}
			}
...
int func_268(var uParam0, var uParam1, int iParam2)
{
	...
	vVar1 = { GET_ENTITY_COORDS(func_250(&(uParam1->f_15[iParam2 /*34*/])), false) };
	if (vdist2(vVar1, func_41(uParam0, func_312(uParam1))) > (55f * 55f))
	{
		return 0;
	}
...
int func_286(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_390)
		{
			iLocal_391 = GET_ENTITY_HEALTH(iParam0);
			bLocal_390 = true;
		}
		iLocal_392 = GET_ENTITY_HEALTH(iParam0);
	...
	if (func_287(PLAYER_PED_ID(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (IS_PED_RAGDOLL(iParam0) && func_294(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_289(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (IS_PED_PLANTING_BOMB(iParam0) || func_290(iVar1))
			{
				if (IS_ENTITY_AT_COORD(iParam1, IS_ENTITY_AT_COORD(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (IS_PED_FACING_PED(IS_PED_FACING_PED(iParam1), iParam0, 120f) && IS_PED_FACING_PED(iParam1, iParam0, 17))
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1))
				{
					...
					{
						if (func_272(PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
...
{
	return func_272(GET_PLAYER_PED(GET_PLAYER_PED()), iParam0, bParam1);
}
...
void func_295(var uParam0)
{
	...
	while (iVar0 < func_319(uParam0))
	{
		...
		if (DOES_ENTITY_EXIST(uParam0->f_15[iVar0 /*34*/].f_2) && !DOES_ENTITY_EXIST(uParam0->f_15[iVar0 /*34*/].f_2, 0))
		{
...
void func_299(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	...
	if (!DOES_ENTITY_EXIST(func_298(uParam0)))
	{
		return;
	}
	if (IS_ENTITY_DEAD(func_298(uParam0), 0) || IS_ENTITY_DEAD(func_298(uParam0)))
	{
		return;
	}
	...
	if (GET_SCRIPT_TASK_STATUS(func_298(uParam0), -1794415470) == 1)
	{
		return;
	}
	...
	if (vdist2(vVar0, vVar1) > (150f * 150f))
	{
		...
		if (vVar0.z > 100f)
		{
			if (DOES_ENTITY_EXIST(uParam0->f_3))
			{
				...
				{
					SET_ENTITY_COORDS(uParam0->f_3, vVar0.x, vVar0.y, 50f, 1, false, 0, 1);
				}
			}
		}
	}
	else
	{
		if (func_40(uParam0, 262144))
		{
			if (DOES_ENTITY_EXIST(uParam0->f_3))
			{
				if (!IS_ENTITY_DEAD(uParam0->f_3, 0))
				{
					...
					if (GET_GROUND_Z_FOR_3D_COORD(vVar4, &uVar3, 0, 0))
					{
						uParam0->f_7.f_2 = uVar3;
						SET_ENTITY_COORDS(uParam0->f_3, uParam0->f_7, 1, false, 0, 1);
					}
				}
			}
		...
		if (func_40(uParam0, 524288) && func_266(uParam2, -1))
		{
			...
			if (GET_SCRIPT_TASK_STATUS(func_298(uParam0), 1435919172) == 1)
			{
				CLEAR_PED_TASKS(func_298(uParam0));
			}
		}
	...
	else if (func_40(uParam0, 524288))
	{
		...
		{
			func_266(uParam2, -1);
			if (GET_GROUND_Z_FOR_3D_COORD(vVar2, &uVar3, 0, 0))
			{
				vVar2.z = uVar3;
				SET_ENTITY_COORDS(uParam0->f_2, vVar2, 1, false, 0, 1);
			}
		}
...
{
	if (DOES_ENTITY_EXIST(func_283(uParam0, iParam1)) && !DOES_ENTITY_EXIST(func_283(uParam0, iParam1), 0))
	{
		if (!HAS_ENTITY_CLEAR_LOS_TO_ENTITY(func_283(uParam0, iParam1), HAS_ENTITY_CLEAR_LOS_TO_ENTITY(), 17))
		{
		...
		{
			TASK_SMART_FLEE_PED(func_283(uParam0, iParam1), TASK_SMART_FLEE_PED(), 150f, -1, 0, 0);
		}
		if (IS_PED_IN_MELEE_COMBAT(func_283(uParam0, iParam1)))
		{
			CLEAR_PED_TASKS(func_283(uParam0, iParam1));
			TASK_SMART_FLEE_PED(func_283(uParam0, iParam1), TASK_SMART_FLEE_PED(), 150f, -1, 0, 0);
		}
	}
...
void func_302(var uParam0, var uParam1)
{
	...
	func_54(uParam0, 2);
	func_44(uParam1, uParam0);
	if (!IS_PED_INJURED(func_283(uParam0, 0)))
	{
		...
		SET_ENTITY_COORDS(func_283(uParam0, 0), -1241.802f, 107.3439f, 55.7186f, 1, false, 0, 1);
		SET_ENTITY_HEADING(func_283(uParam0, 0), 342.8433f);
	}
	if (!IS_PED_INJURED(func_283(uParam0, 1)))
	{
		vVar0 = { -1236.201f, 112.7829f, 56.23418f };
		iVar1 = func_308(uParam0, 1);
		CLEAR_PED_TASKS_IMMEDIATELY(func_283(uParam0, 1));
		if (DOES_ENTITY_EXIST(iVar1))
		{
			DELETE_OBJECT(&iVar1);
		}
		...
		SET_ENTITY_COORDS(func_283(uParam0, 1), -1243.465f, 104.3183f, 55.5857f, 1, false, 0, 1);
		SET_ENTITY_HEADING(func_283(uParam0, 1), 306.093f);
	}
	if (DOES_ENTITY_EXIST(func_293(uParam0, 0)) && DOES_ENTITY_EXIST(func_293(uParam0, 0), 0))
	{
		SET_ENTITY_COORDS(func_293(uParam0, 0), -1257.234f, 94.0251f, 54.784f, 0, false, 0, 1);
		SET_ENTITY_HEADING(func_293(uParam0, 0), 240.9284f);
	}
	func_276(uParam0, 2);
}
...
void func_311(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	{
		if (!DOES_ENTITY_EXIST(func_293(uParam1, iVar2)))
		{
			if (iVar2 == 1)
			{
				vVar3 = { Vector(10f, 10f, 10f) * GET_ENTITY_FORWARD_VECTOR(func_293(uParam1, 0)) };
			}
			if (func_43(func_326(uParam0, iParam2) + vVar3, func_41(uParam0, func_312(uParam1)), &vVar0, &fVar1))
			{
				func_284(uParam1, CREATE_VEHICLE(joaat("caddy"), vVar0, fVar1, true, true, false), iVar2);
				SET_VEHICLE_EXTRA(func_293(uParam1, iVar2), 5, true);
				_SET_ENTITY_SOMETHING(func_293(uParam1, iVar2), true);
			}
		}
		iVar2++;
	}
...
void func_313(var uParam0, var uParam1, int iParam2)
{
	...
	if (!DOES_ENTITY_EXIST(func_283(uParam1, iParam2)))
	{
		iVar1 = func_316(&iVar2, 1065437102);
		func_314(uParam1, iParam2, CREATE_PED(iVar2, iVar1, vVar0, 0f, 1, true));
		SET_ENTITY_HEADING(func_283(uParam1, iParam2), func_247(vVar0, func_326(uParam0, func_312(uParam1))));
		if (HAS_ANIM_SET_LOADED("move_m@golfer@"))
		{
			SET_PED_WEAPON_MOVEMENT_CLIPSET(func_283(uParam1, iParam2), "move_m@golfer@");
		}
		_0x2F3C3D9F50681DE4(func_283(uParam1, iParam2), 1);
	}
}
...
void func_338(var uParam0)
{
	...
	{
		(*uParam0)[iVar0 /*3*/] = (vdist(func_326(uParam0, iVar0), func_248(uParam0, iVar0)) + vdist(func_248(uParam0, iVar0), func_41(uParam0, iVar0)));
