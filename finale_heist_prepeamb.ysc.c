...
void func_137()
{
	...
	func_144();
	func_109();
	if (func_76(PLAYER_PED_ID(), vLocal_50, 150f) && !PLAYER_PED_ID(PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, true, 0))
	{
		CLEAR_AREA_OF_VEHICLES(vLocal_50, 6f, 0, 1, 0, 0, false, 0);
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, false, 1);
	}
	if (!IS_BIT_SET(iLocal_49, 18))
	{
		if (!func_15(0) && !func_117())
		{
			func_143(sLocal_45[4], 7500, 0);
			SET_BIT(&iLocal_49, 18);
		}
	}
...
void func_144()
{
	...
	{
		case 0:
			if (((!DOES_BLIP_EXIST(iLocal_245) && DOES_BLIP_EXIST(iLocal_49, 0)) && !DOES_BLIP_EXIST(iLocal_49, 1)) && DOES_BLIP_EXIST(iLocal_49, 18))
			{
...
int func_145(vector3 vParam0, bool bParam1)
{
	...
	SET_BLIP_SCALE(iVar0, func_146(SET_BLIP_SCALE(), 1f, 1f));
	...
	if (func_103(35))
	{
		if (iLocal_38 == 0)
		{
			if (!IS_BIT_SET(iLocal_49, 1))
			{
				if (func_85(iLocal_51))
				{
					IS_ENTITY_AT_COORD(iLocal_51, vLocal_50, 4f, 4f, 2f, true, true, 0);
					if (IS_ENTITY_IN_ANGLED_AREA(iLocal_51, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, 0, true, 0))
					{
						func_150(24, 46);
			...
			{
				if (!func_76(iLocal_51, vLocal_50, 10f) || IS_ENTITY_UPSIDEDOWN(iLocal_51))
				{
					CLEAR_BIT(&iLocal_49, 1);
				}
			}
							...
							if (func_85(iVar0))
							{
								if (!func_168(iVar0))
								{
									if (func_161(iVar0) && !func_160())
									{
										...
										{
											if (!IS_BIT_SET(iLocal_49, 19))
											{
												func_69(9);
												SET_BIT(&iLocal_49, 19);
											}
											else if (func_70(PLAYER_PED_ID()) == 0)
											{
												func_69(17);
											}
											else
...
int func_172()
{
	...
	{
		iLocal_40 = 1;
		func_173(192, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true));
		return 1;
	}
	return 0;
}
...
void func_190(int iParam0, var uParam1)
{
	...
	func_191(&uLocal_80, Local_44, PLAYER_PED_ID(), Local_44.f_1, 0, 1);
...
void func_209()
{
	...
	if (((((((Global_41396 == 15 && iLocal_37 != 3) && IS_BIT_SET(iLocal_49, 5)) && !func_169()) && Global_76574 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
...
void func_211(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_214(func_89())) && !func_213())
			{
