...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (DOES_ENTITY_EXIST(Global_96177[iVar0]))
			{
...
void func_8(vector3 vParam0, vector3 vParam1, var uParam2)
{
	...
	{
		if (HAS_BULLET_IMPACTED_IN_BOX(vParam0, vParam1, 1, 1))
		{
			*uParam2++;
			if (*uParam2 > 6)
			{
		...
		else if ((IS_EXPLOSION_IN_AREA(0, vParam0, vParam1) || IS_EXPLOSION_IN_AREA(2, vParam0, vParam1)) || IS_EXPLOSION_IN_AREA(vParam0, vParam1, joaat("weapon_grenadelauncher"), 1))
		{
			Global_93722 = 5;
		}
	}
...
void func_9(vector3 vParam0, vector3 vParam1)
{
	...
	if (GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1))
	{
		...
		{
			if (IS_EXPLOSION_IN_AREA(3, vParam0, vParam1))
			{
				Global_93722 = 2;
			}
		}
...
{
	if ((IS_PED_DUCKING(IS_PED_DUCKING()) || IS_PED_DUCKING(IS_PED_DUCKING(), 0)) || IS_PED_DUCKING(IS_PED_DUCKING()))
	{
		if (IS_ENTITY_IN_AREA(IS_ENTITY_IN_AREA(), vParam0, vParam1, 0, 1, 0))
		{
			if (*uParam2 < 0)
			{
...
void func_13(vector3 vParam0, vector3 vParam1)
{
	...
	if (GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1))
	{
		...
		{
			if (IS_PROJECTILE_TYPE_IN_AREA(vParam0, vParam1, iVar0, 1))
			{
				Global_93722 = 0;
			}
		}
...
void func_36(var uParam0, int iParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam5)
{
	...
	{
		*uParam2 = GET_INTERIOR_FROM_ENTITY(GET_INTERIOR_FROM_ENTITY());
		if (!IS_STRING_NULL_OR_EMPTY(sParam5))
		{
			if (!IS_VALID_INTERIOR(*uParam3))
			{
				*uParam3 = GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam4, sParam5);
			}
		}
		func_38(iParam1);
		*uParam0 = 0;
	}
	if (IS_VALID_INTERIOR(*uParam2) && IS_VALID_INTERIOR(*uParam2))
	{
		if (*uParam2 == *uParam3)
		{
			...
			if (GET_CURRENT_PED_VEHICLE_WEAPON(GET_CURRENT_PED_VEHICLE_WEAPON(), &iVar0))
			{
				if (iVar0 != joaat("weapon_unarmed") && iVar0 != joaat("object"))
				{
					SET_CURRENT_PED_VEHICLE_WEAPON(SET_CURRENT_PED_VEHICLE_WEAPON(), joaat("weapon_unarmed"));
				}
			}
		}
...
{
	iParam0->f_1 = (func_40(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
int func_45(int iParam0, vector3 vParam1, float fParam2)
{
	...
	if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), vParam1, true) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_98719)
...
int func_46(int iParam0)
{
	...
	if (GET_RANDOM_EVENT_FLAG() && Global_111550)
	{
		return 0;
	}
	if (!func_31(iParam0))
	...
	if (!IS_BIT_SET(Global_111560.f_9080.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
void func_51()
{
	...
	func_52(&uLocal_153, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
void func_60(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		if (DOES_ENTITY_EXIST((*uParam1)[iVar0]) && DOES_ENTITY_EXIST((*uParam1)[iVar0], 1))
		{
	...
	while (iVar0 < *uParam2)
	{
		...
		if (DOES_ENTITY_EXIST((*uParam3)[iVar0]))
		{
			...
			{
				DETACH_ENTITY((*uParam3)[iVar0], 1, true);
			}
		}
		...
		if (DOES_ENTITY_EXIST((*uParam3)[iVar0]) && DOES_ENTITY_EXIST((*uParam3)[iVar0], 1))
		{
		...
		if (DOES_ENTITY_EXIST((*uParam5)[iVar0]) && DOES_ENTITY_EXIST((*uParam5)[iVar0], 1))
		{
...
int func_78()
{
	...
	while (iVar6 < 11)
	{
		...
		{
			iVar7 = GET_CLOSEST_OBJECT_OF_TYPE(vVar1, 10f, iVar0, 0, 0, 1);
			if (DOES_ENTITY_EXIST(iVar7))
			{
				if (iVar3 == 825812850)
				{
					SET_ENTITY_ROTATION(iVar7, 0f, 0f, 21f, 2, 1);
				}
		...
		else if (!_DOES_DOOR_EXIST(iVar3))
		{
		}
		else
		{
			_SET_DOOR_ACCELERATION_LIMIT(iVar3, 3, true, true);
			_SET_DOOR_AJAR_ANGLE(iVar3, 0f, true, true);
			if (((iVar6 != 6 && iVar6 != 7) && iVar6 != 8) && iVar6 != 9)
			{
				REMOVE_DOOR_FROM_SYSTEM(iVar3);
			}
		}
		iVar6++;
	}
...
void func_83(int iParam0)
{
	...
	if (DOES_ENTITY_EXIST(*iParam0))
	{
		if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(*iParam0, 1))
		{
...
int func_86(int iParam0, char* sParam1, int iParam2)
{
	...
	if (GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP() == 64 && GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP(iParam0) != joaat("prop_bong_01"))
	{
		if (!IS_ENTITY_DEAD(iParam0, 0) && !IS_ENTITY_DEAD(iParam0, 1))
		{
	...
	{
		if (IS_ENTITY_A_VEHICLE(iParam0) && IS_ENTITY_A_VEHICLE(IS_ENTITY_A_VEHICLE()))
		{
			if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), IS_PED_IN_VEHICLE(iParam0), 0))
			{
				return 0;
			}
		}
