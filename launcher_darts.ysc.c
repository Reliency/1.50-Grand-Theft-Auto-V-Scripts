...
void __EntryFunction__()
{
	...
	{
		vLocal_56 = { GET_ENTITY_COORDS(iScriptParam_104, true) };
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH()) > 1 && !func_115(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar2 = 0f;
			if (GET_GROUND_Z_FOR_3D_COORD(Var0.f_1[0 /*3*/], &fVar2, 0, 0))
			{
				if (fVar2 != 0f)
				{
		...
		if (DOES_ENTITY_EXIST(iLocal_53) && !DOES_ENTITY_EXIST(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_99(3) && !Global_98703)
						{
							...
							{
								if ((!func_115(uLocal_58, 1) || !DOES_ENTITY_EXIST(func_98())) && !Global_98703)
								{
									func_108(10);
									break;
								}
						...
						if (bVar4)
						{
							...
							{
								iLocal_94 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_56, 2f, iLocal_78, 1, 0, 1);
								func_85(&uLocal_58, 128);
								bVar4 = false;
							}
							else
							{
								vLocal_83 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_94, vLocal_82) };
							...
							if (GET_INTERIOR_FROM_ENTITY(GET_INTERIOR_FROM_ENTITY()) != iLocal_84)
							{
								bVar4 = false;
							}
							...
							if (bVar4)
							{
								...
								if (func_77(uLocal_54))
								{
									...
									else if (!func_115(uLocal_58, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_75(&iLocal_60);
				...
				case 6:
					...
					if (func_115(uLocal_58, 2097152))
					{
						if (!func_99(3) && !IS_THREAD_ACTIVE(iLocal_50))
						{
							func_108(10);
						}
					}
					...
					{
						PLAYSTATS_ODDJOB_DONE(round((func_9(&iLocal_71) * 1000f)), iLocal_63, 0);
						func_8(&iLocal_71);
						...
						if (iLocal_63 != -1)
						{
							if (func_115(Global_110211, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_17(iLocal_63), 0, Global_98706, 0);
...
int func_23()
{
	...
	vVar0 = { GET_ENTITY_ROTATION(iLocal_94, 2) };
...
void func_37()
{
			...
			if (fVar5 < (10f * 10f))
			{
				...
				if (!func_101(6) && !func_101(7))
				{
					if (!IS_ENTITY_DEAD(iLocal_87, 0))
					{
						...
						TASK_START_SCENARIO_IN_PLACE(iLocal_87, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
					if (!IS_ENTITY_DEAD(iLocal_88, 0))
					{
						FREEZE_ENTITY_POSITION(iLocal_88, false);
						TASK_LOOK_AT_ENTITY(iLocal_88, iLocal_87, -1, 2049, 3);
						TASK_START_SCENARIO_IN_PLACE(iLocal_88, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
				}
				else
				{
					if (!IS_ENTITY_DEAD(iLocal_87, 0))
					{
						...
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 1f, 20000, 1048576000, 0, 1193033728);
						}
					...
					if (!IS_ENTITY_DEAD(iLocal_88, 0))
					{
						...
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 1f, 20000, 1048576000, 0, 1193033728);
						}
		...
		else if (iLocal_91 == 1)
		{
			if (fVar5 >= (10f * 10f))
			{
				...
				else
				{
					if (!IS_ENTITY_DEAD(iLocal_87, 0))
					{
						SET_ENTITY_COORDS(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 1, false, 0, 1);
						TASK_STAND_STILL(iLocal_87, -1);
						if (!IS_ENTITY_ATTACHED(iLocal_87))
						{
							FREEZE_ENTITY_POSITION(iLocal_87, true);
					...
					if (!IS_ENTITY_DEAD(iLocal_88, 0))
					{
						SET_ENTITY_COORDS(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 1, false, 0, 1);
						TASK_STAND_STILL(iLocal_88, -1);
						if (!IS_ENTITY_ATTACHED(iLocal_88))
						{
							FREEZE_ENTITY_POSITION(iLocal_88, true);
	...
	if (!iLocal_97)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			if (((IS_PED_SHOOTING(IS_PED_SHOOTING()) || IS_PED_SHOOTING(IS_PED_SHOOTING(), 0)) || IS_PED_SHOOTING(937.0616f, -117.8927f, 72.9163f, 1021.849f, -120.5357f, 72.9163f, 1, 1)) || IS_PED_SHOOTING(1991.473f, 3045.98f, 49.532f, 1996.906f, 3052.17f, 46.3392f, 0))
			{
				if (!IS_ENTITY_DEAD(iLocal_87, 0))
				{
					TASK_SMART_FLEE_PED(iLocal_87, TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
				}
				if (!IS_ENTITY_DEAD(iLocal_88, 0))
				{
					TASK_SMART_FLEE_PED(iLocal_88, TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
				}
				bVar3 = true;
			}
			else
			{
				...
				while (iVar2 < iVar1)
				{
					...
					{
						if (IS_PED_IN_MELEE_COMBAT(uVar0[iVar2]) || IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT(), uVar0[iVar2]))
						{
							if (!IS_ENTITY_DEAD(iLocal_87, 0))
							{
								TASK_SMART_FLEE_PED(iLocal_87, TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
	...
	if (iLocal_92 == 1)
	{
		...
		else if (iLocal_95 == GET_INTERIOR_FROM_ENTITY(GET_INTERIOR_FROM_ENTITY()))
		{
			func_38(140, 3);
			func_38(139, 3);
			if (!IS_PED_INJURED(iLocal_87) && !IS_PED_INJURED(iLocal_88))
	...
	else if (iLocal_92 == 2)
	{
		...
		else if (iLocal_96 == GET_INTERIOR_FROM_ENTITY(GET_INTERIOR_FROM_ENTITY()))
		{
			if (!IS_PED_INJURED(iLocal_87) && !IS_PED_INJURED(iLocal_88))
			{
				if (iLocal_98)
...
int func_49(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_50(GET_ENTITY_MODEL(GET_ENTITY_MODEL(), 1)));
				switch (iVar0)
				{
...
void func_51(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_52(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_89487[26 /*34*/].f_6) == 0)
			{
				Global_111560.f_7256[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_111560.f_7256[iParam0], true, true);
			}
...
var func_54()
{
	...
	func_57(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_56(&uVar0, GET_CLOCK_MONTH());
	func_55(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_60(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_78(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3)
{
	...
	{
		case 0:
			uParam0->f_2 = START_SHAPE_TEST_LOS_PROBE(vParam1, vParam2, 19, iParam3, 7);
			*uParam0 = 1;
			break;
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_92()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_96()) || Global_30738) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_96() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_81(8, -1)) || func_83()) || func_91()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_96()) || Global_30738) || func_95()) || func_81(8, -1)) || func_93()) || func_92()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_96()) || func_93()) || Global_110607) || Global_30738) || func_95()) || Global_42561) || func_81(8, -1)) || func_92()) || func_91()) || func_83()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_96()) || Global_110607) || Global_30738) || func_95()) || func_81(8, -1)) || func_92()) || func_91()) || func_94()) || func_93()) || func_83())
						{
							return 0;
						}
						break;
...
void func_102()
{
	...
	if (bLocal_90)
	{
		...
		if ((fVar2 > 45f || Global_111522) && !DOES_ENTITY_EXIST(iLocal_87))
		{
			if (Global_111522)
			{
				Global_111522 = 0;
			...
			fVar9 = 142.6717f;
			fVar10 = 44.8785f;
			iVar11 = GET_INTERIOR_AT_COORDS(func_71(iLocal_92));
			if (IS_VALID_INTERIOR(iVar11))
			{
				_LOAD_INTERIOR(iVar11);
			...
			iLocal_87 = CREATE_PED(26, iLocal_85, func_104(iLocal_92 == 1, vVar3, vVar5), func_103(iLocal_92 == 1, fVar7, fVar9), 1, true);
			iLocal_88 = CREATE_PED(26, iLocal_86, func_104(iLocal_92 == 1, vVar4, vVar6), func_103(iLocal_92 == 1, fVar8, fVar10), 1, true);
			SET_ENTITY_AS_MISSION_ENTITY(iLocal_87, true, 0);
			SET_ENTITY_AS_MISSION_ENTITY(iLocal_88, true, 0);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_87, true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_88, true);
			iLocal_98 = 1;
...
void func_116()
{
	...
	iLocal_69 = 67;
	bVar0 = false;
	if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), func_71(2), 100f, 100f, 100f, false, false, 0))
	{
		bVar0 = true;
	}
	if (!bVar0)
	...
	iLocal_84 = GET_INTERIOR_AT_COORDS(vLocal_56);
