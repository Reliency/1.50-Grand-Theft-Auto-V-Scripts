...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (_0x35F0B98A8387274D(_0x35F0B98A8387274D()) == 32)
			{
				if (ScriptParam_98.f_16 != (50 + PLAYER_ID()))
				{
					func_35(2);
				}
			}
			else if (ScriptParam_98.f_16 != _0x35F0B98A8387274D(_0x35F0B98A8387274D()))
			{
				func_35(2);
			}
		}
...
void func_1()
{
	...
	while (iLocal_71 < 6)
	{
		if (func_7(INT_TO_PLAYERINDEX(iLocal_70), 0, 1))
		{
			if (IS_BIT_SET(Local_96[iLocal_70 /*4*/].f_2, iLocal_71))
			{
				SET_BIT(&(Local_73.f_2[iLocal_71]), iLocal_70);
			}
			else
			{
				CLEAR_BIT(&(Local_73.f_2[iLocal_71]), iLocal_70);
			}
		}
		else
		{
			CLEAR_BIT(&(Local_73.f_9[iLocal_71]), iLocal_70);
			CLEAR_BIT(&(Local_73.f_9[iLocal_71]), iLocal_70);
		}
	...
	if (iLocal_94[iParam0] == 0)
	{
		if (_0x4BC2854478F3A749(iParam1) == -1)
		{
			if (_0x160AA1B32F6139B8(iParam1) != iParam2)
			{
				...
				{
					SET_BIT(&(iLocal_94[iParam0]), iVar0);
					_SET_DOOR_ACCELERATION_LIMIT(iParam1, iParam2, true, true);
...
void func_9()
{
	...
	if ((IS_BIT_SET(Global_2540191, iLocal_72) || IS_BIT_SET(Global_2540191.f_1, iLocal_72)) || IS_BIT_SET(Global_2540191.f_2, iLocal_72))
	{
		if (IS_BIT_SET(Global_2540191, iLocal_72))
		{
			SET_BIT(&(Local_96[SET_BIT() /*4*/].f_2), iLocal_72);
		}
		if (IS_BIT_SET(Global_2540191.f_1, iLocal_72))
		{
			CLEAR_BIT(&(Local_96[CLEAR_BIT() /*4*/].f_2), iLocal_72);
		}
		if (IS_BIT_SET(Global_2540191.f_2, iLocal_72))
		{
			SET_BIT(&(Local_96[SET_BIT() /*4*/].f_3), iLocal_72);
		}
	}
	else if (fVar0 <= 20f)
	{
		if (IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_72 /*17*/].f_3, Local_69[iLocal_72 /*17*/].f_6, Local_69[iLocal_72 /*17*/].f_9, 0, true))
		{
			if (!IS_BIT_SET(Local_96[IS_BIT_SET() /*4*/].f_2, iLocal_72))
			{
				SET_BIT(&(Local_96[SET_BIT() /*4*/].f_2), iLocal_72);
			}
		}
		if ((iLocal_72 == 0 || iLocal_72 == 1) || iLocal_72 == 5)
		{
			if (Global_2460418)
			{
				if (IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_72 /*17*/].f_10, Local_69[iLocal_72 /*17*/].f_13, Local_69[iLocal_72 /*17*/].f_16, 0, true))
				{
					if (!IS_BIT_SET(Local_96[IS_BIT_SET() /*4*/].f_2, iLocal_72))
					{
						SET_BIT(&(Local_96[SET_BIT() /*4*/].f_2), iLocal_72);
		...
		if ((iLocal_72 == 2 || iLocal_72 == 3) || iLocal_72 == 4)
		{
			if (func_11() >= 0)
			{
				...
				else if (IS_BIT_SET(Local_96[IS_BIT_SET() /*4*/].f_2, iLocal_72) && !IS_BIT_SET(vVar1, Local_69[iLocal_72 /*17*/].f_3, Local_69[iLocal_72 /*17*/].f_6, Local_69[iLocal_72 /*17*/].f_9, 0, true))
				{
					CLEAR_BIT(&(Local_96[CLEAR_BIT() /*4*/].f_2), iLocal_72);
				}
			}
	...
	else if (IS_BIT_SET(Local_96[IS_BIT_SET() /*4*/].f_2, iLocal_72))
	{
		CLEAR_BIT(&(Local_96[CLEAR_BIT() /*4*/].f_2), iLocal_72);
	}
	iLocal_72++;
...
void func_14()
{
	...
	{
		func_22(iVar0, &Var3);
		if (GET_DISTANCE_BETWEEN_COORDS(func_13(GET_DISTANCE_BETWEEN_COORDS()), Var3.f_1, true) < 150f)
		{
			bVar2 = false;
			iVar1 = 0;
			while (iVar1 < 32)
			{
				...
				if (func_7(iVar4, 1, 1))
				{
					if (func_15(iVar4) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(iVar4), Var3.f_4[0 /*3*/], Var3.f_4[1 /*3*/], Var3.f_11, 0, true, 0))
					{
						bVar2 = true;
						iVar1 = 32;
					}
			...
			if (bVar2)
			{
				if (fLocal_97[iVar0] != 1f)
				{
					...
					_SET_DOOR_AJAR_ANGLE(Var3, fLocal_97[iVar0], false, false);
					_SET_DOOR_ACCELERATION_LIMIT(Var3, 0, false, true);
				}
			}
			else if (fLocal_97[iVar0] != 0f)
			{
				...
				_0x06C0023BED16DD6B(Var3, 1);
				_SET_DOOR_AJAR_ANGLE(Var3, fLocal_97[iVar0], false, false);
				_SET_DOOR_ACCELERATION_LIMIT(Var3, 1, false, true);
			}
		}
		iVar0++;
	}
...
void func_30(struct<15> Param0, bool bParam1)
{
	if (Param0 != 0)
	{
		ADD_DOOR_TO_SYSTEM(Param0, Param0.f_2, Param0.f_3, 0, bParam1, Param0.f_11);
		if (Param0.f_9)
		{
		...
		if (Param0.f_12 != 0f)
		{
			_SET_DOOR_AJAR_ANGLE(Param0, Param0.f_12, false, bParam1);
		}
		if (!Param0.f_6)
		{
			if (Param0.f_7)
			{
				_SET_DOOR_ACCELERATION_LIMIT(Param0, Param0.f_8, bParam1, false);
			}
		}
		if (Param0.f_10)
		{
		...
		if (Param0.f_14 != 0f)
		{
			_0x03C27E13B42A0E82(Param0, Param0.f_14, bParam1, 0);
		}
		if (Param0.f_13 != 0f)
		{
			_0x9BA001CB45CBF627(Param0, Param0.f_13, bParam1, 0);
		}
	}
}
...
{
	Local_96[PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
}
...
int func_52(struct<21> Param0)
{
	...
	func_54(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_73, 30);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_96, 129);
	if (!func_53())
	{
		return 0;
	}
