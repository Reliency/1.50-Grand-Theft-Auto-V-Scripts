...
int func_10()
{
	...
	{
		if ((IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()) && IS_PLAYER_PLAYING(IS_PLAYER_PLAYING())) && !IS_PLAYER_PLAYING())
		{
			if (func_26(0))
			{
				func_11(48, 4, 0);
...
void func_20()
{
	...
	{
		if (func_23(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
