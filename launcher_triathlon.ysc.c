...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH()) > 1 && !func_118(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar1 = 0f;
			if (GET_GROUND_Z_FOR_3D_COORD(ScriptParam_97.f_1[0 /*3*/], &fVar1, 0, 0))
			{
				if (fVar1 != 0f)
				{
		...
		if (DOES_ENTITY_EXIST(iLocal_53) && !DOES_ENTITY_EXIST(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_100(3) && !Global_98703)
						{
							...
							{
								if ((!func_118(uLocal_58, 1) || !DOES_ENTITY_EXIST(func_99())) && !Global_98703)
								{
									func_111(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_78(uLocal_54))
								{
									...
									else if (!func_118(uLocal_58, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_76(&iLocal_60);
				...
				case 6:
					...
					if (func_118(uLocal_58, 2097152))
					{
						if (!func_100(3) && !IS_THREAD_ACTIVE(iLocal_50))
						{
							func_111(10);
						}
					}
					...
					{
						PLAYSTATS_ODDJOB_DONE(round((func_32(&iLocal_71) * 1000f)), iLocal_63, 0);
						func_31(&iLocal_71);
						...
						if (iLocal_63 != -1)
						{
							if (func_118(Global_110211, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_98706, 0);
...
void func_4()
{
	...
	{
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_85, true, 1);
	}
	if (DOES_ENTITY_EXIST(iLocal_83))
	{
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_83, true, 1);
	}
	if (DOES_ENTITY_EXIST(iLocal_84))
	{
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_84, true, 1);
	}
	iLocal_86 = ADD_SCENARIO_BLOCKING_AREA((vLocal_79.x - 3f), (vLocal_79.y - 3f), (vLocal_79.z - 3f), (vLocal_79.x + 3f), (vLocal_79.y + 3f), (vLocal_79.z + 3f), 0, 1, 1, 1);
	func_7();
	func_5();
}
...
void func_8(int iParam0, bool bParam1)
{
	...
	if (bParam1 != IS_BIT_SET(Global_31111[iVar0 /*23*/].f_11, 13))
	{
		SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 18);
	}
	if (bParam1)
	{
		SET_BIT(&(Global_31111[iVar0 /*23*/].f_11), 13);
	}
	else
	{
		CLEAR_BIT(&(Global_31111[iVar0 /*23*/].f_11), 13);
	}
}
...
void func_19(int iParam0)
{
	...
	if (iVar1 < 3)
	{
		CLEAR_BIT(&(Global_111560.f_20405.f_150[iVar1]), iVar0);
		CLEAR_BIT(&(Global_111560.f_20405.f_150[iVar1]), iVar0);
	}
}
...
float func_32(int iParam0)
{
	if (func_35(iParam0))
	{
		...
		{
			return (func_33(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_33(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
void func_60()
{
	...
	else if ((IS_PED_INJURED(iLocal_85) || IS_PED_INJURED(91, IS_PED_INJURED(iLocal_85, true), 40f)) || IS_PED_INJURED(118, IS_PED_INJURED(iLocal_85, true), 40f))
	{
		func_79("TRI_DEATH", -1);
		iVar0 = iLocal_69;
		func_73(iLocal_69);
	...
	if (DOES_ENTITY_EXIST(iLocal_85))
	{
		if (!IS_ENTITY_DEAD(iLocal_85, 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (vdist2(GET_ENTITY_COORDS(iLocal_85, true), GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)) <= 144f)
			{
				if (GET_SCRIPT_TASK_STATUS(iLocal_85, 150319005) != 1)
				{
					TASK_LOOK_AT_ENTITY(iLocal_85, TASK_LOOK_AT_ENTITY(), -1, 0, 2);
				}
			}
...
void func_61()
{
	...
	if (GET_GAME_TIMER() > iLocal_90 && fLocal_57 < (30f * 30f))
	{
		...
		if (GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) <= 0.5f)
		{
			...
			iVar3 = GET_PED_NEARBY_PEDS(GET_PED_NEARBY_PEDS(), &uVar2, iVar0);
			iVar5 = 0;
			while (iVar5 < iVar3)
			{
				if (!IS_PED_INJURED(uVar2[iVar5]) && !IS_PED_INJURED(iVar4))
				{
			...
			if (DOES_ENTITY_EXIST(iVar4) && !DOES_ENTITY_EXIST(iVar4))
			{
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_63(iParam3), 0);
}
...
void func_65()
{
	...
	{
		if (func_68(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_95()) || func_94()) || func_93()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_97()) || Global_30738) || func_96()) || func_82(8, -1)) || func_93()) || func_95()) || func_94()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_93()) || func_95()) || func_94()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_95()) || func_94()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_97() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_82(8, -1)) || func_84()) || func_92()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_97()) || Global_30738) || func_96()) || func_82(8, -1)) || func_94()) || func_93()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_97()) || func_94()) || Global_110607) || Global_30738) || func_96()) || Global_42561) || func_82(8, -1)) || func_93()) || func_92()) || func_84()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_97()) || Global_110607) || Global_30738) || func_96()) || func_82(8, -1)) || func_93()) || func_92()) || func_95()) || func_94()) || func_84())
						{
							return 0;
						}
						break;
...
void func_103()
{
	...
	if (bLocal_87)
	{
		CLEAR_AREA_OF_OBJECTS(vLocal_78, 25f, 0);
		...
		if (!DOES_ENTITY_EXIST(iLocal_81))
		{
			...
			iLocal_81 = CREATE_OBJECT(joaat("prop_tri_table_01"), vVar1, true, true, false);
		...
		if (!DOES_ENTITY_EXIST(iLocal_82))
		{
			...
			iLocal_82 = CREATE_OBJECT(joaat("prop_chair_08"), vLocal_79, true, true, false);
		...
		if (!DOES_ENTITY_EXIST(iLocal_83))
		{
			...
			iLocal_83 = CREATE_OBJECT(joaat("p_cs_clipboard"), vVar1, true, true, false);
			SET_ENTITY_ROTATION(iLocal_83, -90f, 0f, 90f, 2, 0);
		...
		if (!DOES_ENTITY_EXIST(iLocal_85))
		{
			...
			iLocal_85 = CREATE_PED(4, joaat("a_m_y_roadcyc_01"), vLocal_79, fVar0, 1, true);
		...
		if (!DOES_ENTITY_EXIST(iLocal_84))
		{
			...
			iLocal_84 = CREATE_OBJECT(joaat("prop_pencil_01"), vVar2, true, true, false);
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_pencil_01"));
		}
		if (!IS_PED_INJURED(iLocal_85))
		{
			if (DOES_SCENARIO_EXIST_IN_AREA(vLocal_79, 3f, 1))
			{
				TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_85, vLocal_79, 2f, 0);
			}
			else
			{
				switch (iLocal_91)
				...
				TASK_START_SCENARIO_AT_POSITION(iLocal_85, "PROP_HUMAN_SEAT_CHAIR", vVar3, fVar4, -1, 0, 1);
			}
		}
		iVar8 = 0;
		while (iVar8 < iLocal_92)
		{
			...
			if (!func_104(vVar5))
			{
				iLocal_92[iVar8] = ADD_NAVMESH_BLOCKING_OBJECT(vVar5, vVar6, fVar7, 0, 7);
			}
			iVar8++;
		}
	}
...
void func_126()
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_86, 0);
	if (!iLocal_89)
	{
