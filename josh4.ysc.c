...
void func_1()
{
	...
	switch (iLocal_46)
	{
		case 0:
			...
			{
				SET_ENTITY_PROOFS(iLocal_390, false, false, false, false, false, false, 0, false);
			}
			if (func_439(iLocal_391))
			{
				SET_ENTITY_PROOFS(iLocal_391, false, false, false, false, false, false, 0, false);
			}
			...
			{
				TASK_LOOK_AT_ENTITY(Local_386.f_28[0], TASK_LOOK_AT_ENTITY(), -1, 0, 2);
			}
			_SET_UNK_MAP_FLAG(2);
		...
		case 1:
			...
			func_209();
			func_207();
			if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) <= 0 && !func_206())
			{
				iVar0 = 1;
				...
				{
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_390, 0))
					{
						func_203(777);
					}
				}
...
void func_7()
{
	...
	{
		func_9(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_32(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_75(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_75(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_75(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_75(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_52(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_75(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_75(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_86(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_86(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_75(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	...
	{
		if (func_150(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_166()
{
	...
	{
		func_155();
		_0xBF59707B3E5ED531(func_167(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_207()
{
	if (iLocal_414 == 0)
	{
		if (func_208(PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
...
void func_209()
{
	if (iLocal_409 == 0)
	{
		if (!IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, true, 0))
		{
			while (func_206())
			{
				func_229();
			...
			func_228(&uLocal_221, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		if (iLocal_49 != 0)
		{
			if ((GET_GAME_TIMER() - iLocal_412) > 6000)
			{
				...
				else if (iLocal_49 == 1)
				{
					if (func_439(Local_386.f_28[0]))
					{
						if (func_210(PLAYER_PED_ID(), Local_386.f_28[0], 1) < 75f)
						{
...
int func_214()
{
	...
	if (PLAYER_ID() == func_217())
	{
		return 0;
	}
	if (func_215(PLAYER_ID()))
	{
		return 0;
	}
		...
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_439(Local_386.f_28[0]))
				{
					...
					{
						if (IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_391, 0))
						{
							func_487("Back gate blocked");
							vLocal_55 = { -1130.35f, 307.92f, 65.19f };
							OPEN_SEQUENCE_TASK(&iLocal_389);
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_55, 2f, 20000, 1f, 1, 1193033728);
						...
						else
						{
							...
							if (func_204(iLocal_391))
							{
								TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_391, TASK_VEHICLE_MISSION_PED_TARGET(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								TASK_SMART_FLEE_PED(0, TASK_SMART_FLEE_PED(), 500f, -1, 0, 0);
				...
				SET_PED_CAN_BE_DRAGGED_OUT(Local_386.f_28[0], 1);
		...
		case 1:
			if (func_439(Local_386.f_28[0]))
			{
				if (!iLocal_406)
				{
					...
					{
						if (func_210(Local_386.f_28[0], PLAYER_PED_ID(), 0) < 20f)
						{
							func_228(&uLocal_221, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_228(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
							if (func_206())
				...
				if (func_204(iLocal_391))
				{
					if (IS_PED_IN_VEHICLE(Local_386.f_28[0], iLocal_391, 1))
					{
						if (GET_VEHICLE_ENGINE_HEALTH(iLocal_391) < 20f)
						{
							CLEAR_PED_TASKS(Local_386.f_28[0]);
							TASK_LEAVE_ANY_VEHICLE(Local_386.f_28[0], 0, 4416);
							TASK_SMART_FLEE_PED(Local_386.f_28[0], TASK_SMART_FLEE_PED(), 510f, -1, 0, 0);
							func_234(&iLocal_391);
						}
					}
					if (func_439(PLAYER_PED_ID()))
					{
						if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_391, 1))
						{
							CLEAR_PED_TASKS(Local_386.f_28[0]);
							TASK_SMART_FLEE_PED(Local_386.f_28[0], TASK_SMART_FLEE_PED(), 510f, -1, 0, 0);
							func_234(&iLocal_391);
				...
				if (func_210(PLAYER_PED_ID(), Local_386.f_28[0], 1) > 350f)
				{
				...
				if (func_439(PLAYER_PED_ID()) && func_439(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
						if (func_210(PLAYER_PED_ID(), Local_386.f_28[0], 1) < 10f)
						{
							if (!func_206() && (GET_GAME_TIMER() - iLocal_413) > 8000)
							{
			...
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_386.f_28[0], HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
				{
...
void func_237()
{
	switch (Local_47.f_11)
	{
		case 0:
			...
			while (iLocal_393 <= 4)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), Local_415[iLocal_393 /*7*/], Local_415[iLocal_393 /*7*/].f_3, Local_415[iLocal_393 /*7*/].f_6, 0, true, 2))
				{
					...
					while ((!HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_47.f_9, Local_47.f_10) || !HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_43)) || !HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_42))
					{
						wait(0);
					}
		...
		case 1:
			if (!DOES_ENTITY_EXIST(Local_47.f_7))
			{
				...
				SET_VEHICLE_ON_GROUND_PROPERLY(Local_47.f_7, 1084227584);
				SET_ENTITY_QUATERNION(Local_47.f_7, Local_47.f_3, Local_47.f_4, Local_47.f_5, Local_47.f_6);
				Local_47.f_8 = CREATE_PED_INSIDE_VEHICLE(Local_47.f_7, 6, iLocal_42, -1, 1, true);
		...
		case 2:
			if (func_204(Local_47.f_7))
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(Local_47.f_8, 0))
					{
						START_PLAYBACK_RECORDED_VEHICLE(Local_47.f_7, Local_47.f_9, Local_47.f_10, 1);
						_0x1F2E4E06DEA8992B(Local_47.f_7, 1);
...
void func_239()
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_439(Local_386.f_28[iVar0]))
				{
					if (func_210(Local_386.f_28[iVar0], PLAYER_PED_ID(), 0) > 10f)
					{
		...
		case 2:
			if ((GET_GAME_TIMER() - iLocal_394) > 20000)
			{
				...
				if (func_439(Local_386.f_28[1]))
				{
					...
					TASK_ARREST_PED(Local_386.f_28[1], TASK_ARREST_PED());
				}
				iLocal_48 = 4;
				iLocal_394 = GET_GAME_TIMER();
			}
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (func_439(Local_386.f_28[iVar0]))
				{
					if (func_210(Local_386.f_28[iVar0], PLAYER_PED_ID(), 0) > 12f)
					{
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				while (iVar0 <= (Local_386.f_28 - 1))
				{
					if (func_439(Local_386.f_28[iVar0]))
					{
						...
						OPEN_SEQUENCE_TASK(&iLocal_389);
						TASK_SHOOT_AT_ENTITY(0, TASK_SHOOT_AT_ENTITY(), -1, -687903391);
						CLOSE_SEQUENCE_TASK(iLocal_389);
				...
				func_228(&uLocal_56, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
			...
			else
			{
				...
				while (iVar1 <= (Local_386.f_28 - 1))
				{
					...
					{
						if (func_210(Local_386.f_28[iVar1], PLAYER_PED_ID(), 1) > 20f)
						{
				...
				if ((GET_GAME_TIMER() - iLocal_411) > 15000)
				{
					...
					while (iVar1 <= (Local_386.f_28 - 1))
					{
						if (func_439(Local_386.f_28[iVar1]))
						{
							if (func_210(Local_386.f_28[iVar1], PLAYER_PED_ID(), 1) >= 50f)
							{
	...
	if (iLocal_48 != 3)
	{
		...
		while (iVar0 <= (Local_386.f_28 - 1))
		{
			if (func_439(Local_386.f_28[iVar0]))
			{
				if (IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), Local_386.f_28[iVar0]))
				{
				...
				if (iLocal_48 != 4)
				{
					if (func_210(Local_386.f_28[iVar0], PLAYER_PED_ID(), 0) < 2.3f)
					{
...
int func_240(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_439(PLAYER_PED_ID()) && func_439(iParam0))
	{
		...
		if (!IS_PED_ARMED(IS_PED_ARMED(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(IS_PED_IN_MELEE_COMBAT()))
			{
				...
				{
					return func_253(PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_241(int iParam0, float fParam1)
{
	...
	if (func_439(PLAYER_PED_ID()) && func_439(iParam0))
	{
		if (func_252(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 6))
			{
				fVar0 = 40f;
...
{
	return func_243(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_247(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_249(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_249(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_257(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_249(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_259()
{
	...
	else
	{
		switch (iLocal_50)
		{
			...
			case 1:
				if (!func_206() && !IS_MESSAGE_BEING_DISPLAYED())
				{
					if (iLocal_51)
					{
						func_228(&uLocal_56, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_262()
{
	...
	if (_0xB56BBBCC2955D9CB())
	{
		if (func_439(Local_386.f_28[1]))
		{
			...
			_0x2A56C06EBEF2B0D9("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (func_439(Local_386.f_28[2]))
		{
			func_487("Trying to set Cop 2 component variation (intro loop)");
			_0x2A56C06EBEF2B0D9("Cop_with_notepad", Local_386.f_28[2], 0);
		}
	}
	switch (iLocal_46)
	{
		...
		case 1:
			switch (iLocal_408)
			{
				case 0:
					if (func_290(1, 1093140480, 0))
					{
						...
						if (func_204(iVar0))
						{
							...
							else if (IS_ENTITY_IN_ANGLED_AREA(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, true, 0))
							{
						...
						if (func_204(iLocal_390))
						{
							SET_ENTITY_COORDS(iLocal_390, -1107.5f, 280.33f, 64.01f, 1, false, 0, 1);
							SET_ENTITY_HEADING(iLocal_390, 97.97f);
							SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_390, 1084227584);
						}
						iLocal_408++;
					}
					break;
				...
				case 2:
					if (((HAS_ANIM_DICT_LOADED("rcmjosh4") && HAS_ANIM_DICT_LOADED("combat@gestures@pistol@halt")) && HAS_ANIM_DICT_LOADED("combat@gestures@pistol@glances")) && HAS_ANIM_DICT_LOADED(iLocal_392))
					{
						iLocal_408++;
					}
					break;
...
void func_265(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_269(IS_PED_INJURED())) && !func_267(IS_PED_INJURED(), 0)) && !func_266()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_269(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_273()
{
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_439(Local_386.f_28[0]))
		{
			...
			OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK_LOOK_AT_ENTITY(0, TASK_LOOK_AT_ENTITY(), -1, 2, 2);
			TASK_PLAY_ANIM(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(iLocal_389);
			TASK_PERFORM_SEQUENCE(Local_386.f_28[0], iLocal_389);
			CLEAR_SEQUENCE_TASK(&iLocal_389);
			FORCE_PED_MOTION_STATE(Local_386.f_28[0], 247561816, false, 1, 0);
		}
	}
	...
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_439(Local_386.f_28[1]))
		{
			FORCE_PED_MOTION_STATE(Local_386.f_28[1], 1063765679, false, 1, 0);
			OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK_LOOK_AT_ENTITY(0, TASK_LOOK_AT_ENTITY(), -1, 1026, 2);
			TASK_AIM_GUN_AT_ENTITY(0, TASK_AIM_GUN_AT_ENTITY(), -1, 1);
	...
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_439(Local_386.f_28[2]))
		{
			FORCE_PED_MOTION_STATE(Local_386.f_28[2], 1063765679, false, 1, 0);
			OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK_LOOK_AT_ENTITY(0, TASK_LOOK_AT_ENTITY(), -1, 1026, 2);
			TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1103.72f, 289.46f, 63.23f, TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1106.08f, 288.55f, 63.31f, TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			TASK_AIM_GUN_AT_ENTITY(0, TASK_AIM_GUN_AT_ENTITY(), -1, 1);
			CLOSE_SEQUENCE_TASK(iLocal_389);
...
void func_275(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_277(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_289()
{
	...
	if (func_439(Local_386.f_28[1]))
	{
		iLocal_387 = CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, CREATE_WEAPON_OBJECT(Local_386.f_28[1], true), 1, 1065353216, 0, 0, 1);
		REGISTER_ENTITY_FOR_CUTSCENE(Local_386.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_487("*** Registered Cop standing");
	}
	if (func_439(Local_386.f_28[2]))
	{
		iLocal_388 = CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, CREATE_WEAPON_OBJECT(Local_386.f_28[2], true), 1, 1065353216, 0, 0, 1);
...
int func_290(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_294(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_293(PLAYER_PED_ID(), -828834893))
				{
...
void func_297(int iParam0)
{
	...
	REQUEST_ANIM_DICT("combat@gestures@pistol@glances");
	REQUEST_MODEL(iLocal_392);
	while ((!HAS_ANIM_DICT_LOADED("combat@gestures@pistol@halt") || !HAS_ANIM_DICT_LOADED("combat@gestures@pistol@glances")) || !HAS_ANIM_DICT_LOADED(iLocal_392))
	{
		wait(0);
	}
	if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
	{
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, false, 0f, 0);
	}
	if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
	{
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, false, 0f, 0);
	}
	if (func_439(Local_386.f_28[0]))
	{
		if (iParam0 == 1)
		{
			SET_ENTITY_COORDS(Local_386.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, false, 0, 1);
			SET_ENTITY_HEADING(Local_386.f_28[0], 193.1737f);
			TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
	...
	if (iParam0 == 1)
	{
		if (func_439(Local_386.f_28[2]))
		{
			...
			SET_ENTITY_COORDS(Local_386.f_28[2], -1106.08f, 288.55f, 63.31f, 1, false, 0, 1);
			OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK_AIM_GUN_AT_ENTITY(0, TASK_AIM_GUN_AT_ENTITY(), -1, 1);
			CLOSE_SEQUENCE_TASK(iLocal_389);
			TASK_PERFORM_SEQUENCE(Local_386.f_28[2], iLocal_389);
	...
	if (iParam0 == 1)
	{
		if (func_439(Local_386.f_28[1]))
		{
			...
			SET_ENTITY_COORDS(Local_386.f_28[1], -1102.41f, 289.73f, 63.18f, 1, false, 0, 1);
			OPEN_SEQUENCE_TASK(&iLocal_389);
			TASK_AIM_GUN_AT_ENTITY(0, TASK_AIM_GUN_AT_ENTITY(), -1, 1);
			CLOSE_SEQUENCE_TASK(iLocal_389);
			TASK_PERFORM_SEQUENCE(Local_386.f_28[1], iLocal_389);
...
void func_299()
{
	...
	{
		case 0:
			if (!func_5(0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
		...
		case 1:
			if (!func_5(0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				if (func_439(PLAYER_PED_ID()) && func_264(Local_386.f_28[0]))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, true, 0))
					{
						if (!func_300())
						{
							if (!func_293(PLAYER_PED_ID(), -875674219))
							{
								TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), Local_386.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_400)
				{
					...
					{
						if (IS_ENTITY_PLAYING_ANIM(Local_386.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_206())
						{
							TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_487("Done Josh leadin anim");
							if (func_264(Local_386.f_28[2]))
							{
								TASK_PLAY_ANIM(Local_386.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_487("Done Notepad cop leadin anim");
							}
							if (func_264(Local_386.f_28[1]))
							{
								TASK_PLAY_ANIM(Local_386.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
				...
				{
					if ((func_439(PLAYER_PED_ID()) && func_264(Local_386.f_28[0])) && !func_300())
					{
						if (!func_293(PLAYER_PED_ID(), -875674219))
						{
							TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), Local_386.f_28[0], 0);
					...
					if (func_264(Local_386.f_28[0]))
					{
						if (IS_ENTITY_PLAYING_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							...
							if (func_210(PLAYER_PED_ID(), Local_386.f_28[0], 1) <= 2f)
							{
								if (func_206())
								{
									func_229();
...
void func_302()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_294(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_322(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_307(0)) || func_321(1))
			{
			}
			else
			{
...
void func_325()
{
	if (func_439(Local_386.f_28[1]))
	{
		SET_ENTITY_COORDS_NO_OFFSET(Local_386.f_28[1], -1102.48f, 290.2f, 64.22f, 0, 0, 1);
		SET_ENTITY_HEADING(Local_386.f_28[1], 177.74f);
	}
	else
	{
		Local_386.f_28[1] = CREATE_PED(6, iLocal_42, -1102.92f, 290.12f, -200f, 40.46f, 0, false);
	}
	if (func_439(Local_386.f_28[2]))
	{
		SET_ENTITY_COORDS_NO_OFFSET(Local_386.f_28[2], -1103.94f, 290.21f, 64.28f, 0, 0, 1);
		SET_ENTITY_HEADING(Local_386.f_28[2], -167.67f);
	}
	else
	{
		Local_386.f_28[2] = CREATE_PED(6, iLocal_42, -1102.73f, 290.91f, -200f, 92.06f, 0, false);
	}
	if (!func_331())
	{
		func_330(PLAYER_PED_ID(), vLocal_53, fLocal_54, 1, 1);
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_297(1);
...
int func_328(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		_SET_DOOR_AJAR_ANGLE(-1502457334, 0f, false, false);
		_SET_DOOR_ACCELERATION_LIMIT(-1502457334, 3, false, true);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		_SET_DOOR_AJAR_ANGLE(-1994188940, 0f, false, false);
		_SET_DOOR_ACCELERATION_LIMIT(-1994188940, 3, false, true);
		iVar0++;
	}
	else
	{
...
int func_329(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		_SET_DOOR_AJAR_ANGLE(904342475, 1f, false, false);
		_SET_DOOR_ACCELERATION_LIMIT(904342475, 4, false, true);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		...
		_SET_DOOR_AJAR_ANGLE(-795418380, -0.9f, false, false);
		_SET_DOOR_ACCELERATION_LIMIT(-795418380, 4, false, true);
		iVar0++;
	}
	else
	{
...
void func_334(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_339(*iParam1, 0, &uVar0))
		{
...
int func_339(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_366(iVar0, bParam1, uParam2) && !func_365(PLAYER_ID())) && !func_349(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_347(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_345(iParam0)) && !bVar1) && !(func_344(IS_BIG_VEHICLE(iParam0)) && func_341(IS_BIG_VEHICLE())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_340(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_364(PLAYER_ID()) || func_363(PLAYER_ID()))
	{
		if (func_350(iParam0))
		{
			return 1;
...
int func_351(int iParam0)
{
	...
	if (func_352(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_353(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_355(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_366(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_347(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_370(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_283(iParam0, 0, 0)) || func_283(iParam0, 1, 0)) || func_283(iParam0, 2, 0)) || func_386(iParam0) != 145) || func_385(iParam0)) || func_384(iParam0)) || func_340(iParam0)) || func_383(iParam0)) || !func_373(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_384(iParam0))
		{
		}
...
int func_390(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_362(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_393(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_393(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_392(iParam0);
	if (func_391(*iParam0))
	{
...
void func_396(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_397(iParam0, iParam1))
				{
	...
	if (func_423(uParam0))
	{
		...
		if (func_422(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_408(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_408(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_410(iParam0, uVar1[iVar3], 1) && func_409(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_404(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_411(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_370(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_370(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_370(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_414(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_413())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_370(iVar2 + 1)))
				{
...
int func_441(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 3:
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
				SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, true, 0f, 0);
			}
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
			{
				SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, true, 0f, 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
