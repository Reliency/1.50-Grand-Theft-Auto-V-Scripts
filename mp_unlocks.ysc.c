...
{
	if (_BEGIN_SCALEFORM_MOVIE_METHOD_N("SHOW_COLUMN"))
	{
...
{
	if (_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT"))
	{
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam1);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam2);
...
int func_39(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 5:
			if ((((func_41() || func_40()) || IS_PC_VERSION()) || IS_PC_VERSION()) || IS_PC_VERSION())
			{
				iVar0 += 2;
				iVar0 += 2;
				iVar0++;
...
{
	if (_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT_EMPTY"))
	{
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
	}
	END_SCALEFORM_MOVIE_METHOD();
...
void func_44(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_COLUMN_HIGHLIGHT"))
	{
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam1);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bParam2);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bParam3);
		END_SCALEFORM_MOVIE_METHOD();
	}
}
...
void func_47(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	if (_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT"))
	{
		...
		if (bParam8)
		{
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(21);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bParam8);
		}
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam7);
		END_SCALEFORM_MOVIE_METHOD();
	}
}
...
int func_49(int iParam0)
{
	...
	iVar1 = func_52(iVar0);
	iVar2 = func_51(iVar0);
	if ((IS_CONTROL_JUST_RELEASED(2, iParam0) || IS_CONTROL_JUST_RELEASED(2, iParam0)) || func_50(iParam0, &(Global_1373500.f_1060), 1))
	{
		...
		if (iVar0 > 180)
		{
			if (func_55(&uLocal_116, iLocal_118, 0))
			{
				if (iLocal_120)
				{
					...
					if (_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_COLUMN_INPUT_EVENT"))
					{
						_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
