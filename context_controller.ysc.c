			...
			case 0:
				...
				if (iVar3 != iVar2)
				{
					if (iVar2 != -1)
					{
						...
						{
							if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE()), 0))
							{
...
void func_1()
{
	...
	if (bLocal_113)
	{
		...
		if (bLocal_114)
		{
			ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&Local_116);
		}
		else
		{
			ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_42311);
			ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Local_116);
		}
		END_TEXT_COMMAND_DISPLAY_HELP(0, 0, bVar0, 50);
	}
	else
	{
		BEGIN_TEXT_COMMAND_DISPLAY_HELP(&Local_115);
...
void func_10(int iParam0)
{
	...
	while (iVar0 < 6)
	{
		if (Global_42116[iVar0 /*32*/] && Global_42116[iVar0 /*32*/].f_4)
		{
			...
			{
				if (!IS_THREAD_ACTIVE(Global_42116[iVar0 /*32*/].f_31))
				{
					if (*iParam0 > -1)
					{
						func_11();
...
void func_26()
{
	if (!IS_PLAYER_SWITCH_IN_PROGRESS() && !func_32())
	{
		if (func_31(0))
		{
			if (!IS_STRING_NULL_OR_EMPTY(&(Global_2448961.f_684.f_12)))
			{
				func_30();
				func_27(6, 0, 0);
			}
	...
	if (Global_1573306 != -1)
	{
		...
		if (IS_XBOX360_VERSION() || IS_XBOX360_VERSION())
		{
			...
			if (iLocal_118)
			{
				...
				else
				{
					...
					{
						StringCopy(&(Global_2097152[func_38() /*10828*/].f_10651.f_18[Global_1573306 /*6*/]), NETWORK_GET_GAMERTAG_FROM_HANDLE(&(Var0[0 /*13*/])), 24);
					}
					func_37();
				}
			}
		...
		else if (IS_PS3_VERSION() || IS_PS3_VERSION())
		{
			if (func_36(Var0[0 /*13*/]))
			{
				...
				{
					case 0:
						iLocal_120 = _0xD66C9E72B3CC4982(&Var0, 1);
						if (iLocal_120 >= 0)
						{
							iLocal_119++;
						}
					...
					case 1:
						iVar2 = _0x58CC181719256197(iLocal_120, &Var1, 1);
						switch (iVar2)
						{
							case -1:
								func_37();
		...
		else
		{
			if (func_36(Var0[0 /*13*/]))
			{
				StringCopy(&(Global_2097152[func_38() /*10828*/].f_10651.f_18[Global_1573306 /*6*/]), NETWORK_MEMBER_ID_FROM_GAMER_HANDLE(&(Var0[0 /*13*/])), 24);
			}
			func_37();
		}
	}
