...
void __EntryFunction__()
{
	...
	{
		func_45();
		if (func_33() || NETWORK_END_TUTORIAL_SESSION())
		{
			func_46();
		}
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			{
				if ((((((((!Global_1573977 && !func_23(3)) && !func_20(PLAYER_ID(), 0)) && !PLAYER_ID()) && PLAYER_ID(PLAYER_ID())) && !func_18(PLAYER_ID())) && !func_16(func_17(PLAYER_ID()))) && !func_14(PLAYER_ID(), 146)) && !func_10(PLAYER_ID()))
				{
					if (func_9(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 4, 100, 0))
					{
...
int func_26()
{
	...
	if (Global_1590446[PLAYER_ID() /*871*/] == -1)
	{
		return 0;
	}
	return 1;
...
int func_28()
{
	switch (Local_117)
	{
		case 0:
			...
			{
				Local_117.f_4 = ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
			}
		...
		case 1:
			if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 1693.164f, 2559.616f, 44.5649f) >= 1030225f)
			{
				Local_117 = 2;
			}
			break;
		...
		case 2:
			if (Global_1573977 || func_23(3))
			{
				REMOVE_SCENARIO_BLOCKING_AREA(Local_117.f_4, 0);
			}
			return 1;
			break;
	}
