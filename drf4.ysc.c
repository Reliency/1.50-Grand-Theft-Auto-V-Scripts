	...
	while (true)
	{
		...
		switch (iLocal_48)
		{
			...
			case 3:
				...
				if (IS_PED_JUMPING_OUT_OF_VEHICLE(IS_PED_JUMPING_OUT_OF_VEHICLE()) || IS_PED_JUMPING_OUT_OF_VEHICLE(IS_PED_JUMPING_OUT_OF_VEHICLE()))
				{
					func_57(0);
				}
				if (func_56())
...
void func_17(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_19() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_19() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_25(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_19() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_51()
{
	...
	{
		if (func_54(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
float func_67(var uParam0)
{
	if (func_70(uParam0))
	{
		...
		{
			return (func_68(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	iParam0->f_1 = (func_68(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
void func_90(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	func_123(uParam0, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
struct<4> func_106(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_111(&(Global_111560.f_19956), 8) && iParam1) && iParam0 != 4) && func_109(3) > 0) && GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
...
void func_113(var uParam0, var uParam1, var uParam2, int iParam3)
{
	if (iParam3 == 0)
	{
		func_92(uParam0, uParam1, uParam2, "DRF_OVG", GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
		func_92(uParam0, uParam1, uParam2, "DRF_TMG", func_115(func_116(), 0, 2), 1, 0);
	}
	else if (iParam3 == 1)
	{
		func_92(uParam0, uParam1, uParam2, "DRF_OVO", GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
...
{
	if (Global_95160 != 0 && (GET_GAME_TIMER() - Global_95160) < 1800000)
	{
		return 0;
	}
	REQUEST_ADDITIONAL_TEXT("SHRINK", 0);
