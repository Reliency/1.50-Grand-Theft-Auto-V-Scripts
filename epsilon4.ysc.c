...
void __EntryFunction__()
{
	...
	iLocal_426 = ADD_NAVMESH_BLOCKING_OBJECT(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, 0, 7);
	iLocal_427 = ADD_NAVMESH_BLOCKING_OBJECT(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, 0, 7);
	iLocal_428 = ADD_NAVMESH_BLOCKING_OBJECT(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, 0, 7);
	...
	uLocal_290 = _0xBE197EAA669238F4(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_399();
	func_382();
	func_381();
	Local_434 = 0;
	...
	while (true)
	{
		...
		{
			if (func_346(PLAYER_PED_ID()) == iLocal_89)
			{
...
void func_11()
{
	...
	while (func_346(PLAYER_PED_ID()) == iLocal_89)
	{
		wait(0);
		HIDE_HUD_COMPONENT_THIS_FRAME(2);
		if (HAS_ANIM_DICT_LOADED("weapons@holster_1h"))
		{
			if (!IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), "weapons@holster_1h", "holster", 3))
			{
				TASK_PLAY_ANIM(TASK_PLAY_ANIM(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else if (GET_ENTITY_ANIM_CURRENT_TIME(GET_ENTITY_ANIM_CURRENT_TIME(), "weapons@holster_1h", "holster") >= 0.5f)
			{
...
void func_25()
{
	...
	{
		func_12(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_49(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_92(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_92(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_92(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_92(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(iParam0, func_92(iVar0), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
						}
						func_83(iVar0);
						if (Global_76387 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, iParam4);
		}
		if (Global_76387 == 1)
		{
			iVar2 = 0;
...
void func_68(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_69(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_92(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_92(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_103(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_103(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_92(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_165(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76389[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_92(iParam1)) && Global_76389[1 /*14*/].f_4 == GET_PED_DRAWABLE_VARIATION(iParam0, func_92(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_172()
{
	...
	{
		if (func_167(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_183()
{
	...
	{
		func_172();
		_0xBF59707B3E5ED531(func_184(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_229()
{
	switch (Local_434.f_1)
	{
		case 0:
			...
			HIDE_HUD_COMPONENT_THIS_FRAME(2);
			REMOVE_WEAPON_FROM_PED(REMOVE_WEAPON_FROM_PED(), iLocal_89);
			Local_434.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (IS_ENTITY_DEAD(Local_298[0 /*8*/], 0))
			{
				func_239(6);
				Local_434.f_9 = 2;
				Local_434.f_1 = 3;
			}
			else if (IS_ENTITY_DEAD(Local_298[1 /*8*/], 0))
			{
				func_239(6);
				Local_434.f_9 = 3;
				Local_434.f_1 = 3;
			}
			else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_298[0 /*8*/], HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_298[0 /*8*/], 0, 2))
			{
				func_239(6);
				Local_434.f_9 = 4;
				Local_434.f_1 = 3;
			}
			else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_298[1 /*8*/], HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_298[1 /*8*/], 0, 2))
			{
				func_239(6);
				Local_434.f_9 = 5;
				Local_434.f_1 = 3;
			...
			{
				if (func_230(PLAYER_PED_ID(), Local_298[0 /*8*/], 1) >= 50f)
				{
...
int func_236(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_238(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_238(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_240()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (_0xB56BBBCC2955D9CB())
		{
			...
			{
				func_294("Michael", PLAYER_PED_ID(), 0, 2);
			}
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (!func_288(iLocal_292))
		{
			...
			SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_292, 1084227584);
		}
		...
		if (func_347(PLAYER_PED_ID()))
		{
			...
			SET_PLAYER_FORCED_AIM(SET_PLAYER_FORCED_AIM(), 1);
			...
			if (iLocal_283 == 0)
			{
				...
				{
					iLocal_303 = func_271(PLAYER_PED_ID(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
			...
			if (iLocal_283 >= 2)
			{
				if (func_231(PLAYER_PED_ID()))
				{
					GIVE_WEAPON_TO_PED(GIVE_WEAPON_TO_PED(), joaat("weapon_unarmed"), -1, true, true);
				}
			}
			SET_PLAYER_FORCED_AIM(SET_PLAYER_FORCED_AIM(), 0);
			...
			if (iLocal_283 >= 2)
			{
				if (IS_CUTSCENE_PLAYING())
				{
					if (GET_CUTSCENE_TIME() > 17000)
					{
						if (!IS_NEW_LOAD_SCENE_ACTIVE())
						{
							NEW_LOAD_SCENE_START(1847.472f, 4756.157f, 36.6968f, func_255(271.4718f), 145f, 0);
						}
					}
				}
			}
...
void func_242(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_246(IS_PED_INJURED())) && !func_244(IS_PED_INJURED(), 0)) && !func_243()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_246(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_250()
{
	...
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(255);
	...
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(10f);
	END_SCALEFORM_MOVIE_METHOD();
	...
	if (func_231(PLAYER_PED_ID()))
	{
		if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
		{
			...
			else
			{
				...
				if (func_346(PLAYER_PED_ID()) != iLocal_89)
				{
					GIVE_WEAPON_TO_PED(GIVE_WEAPON_TO_PED(), iLocal_89, -1, true, true);
				}
				FORCE_PED_MOTION_STATE(FORCE_PED_MOTION_STATE(), -1871534317, false, 1, 0);
				return 1;
			}
...
void func_252()
{
	if (func_231(Local_298[1 /*8*/]))
	{
		if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			...
			{
				TASK_GO_STRAIGHT_TO_COORD(Local_81.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				func_402("Did Jimmy regular exit");
			}
			FORCE_PED_MOTION_STATE(Local_298[1 /*8*/], -668482597, false, 1, 0);
		}
	}
}
...
void func_253()
{
	if (func_231(Local_298[0 /*8*/]))
	{
		if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			...
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(Local_81.f_28[0], TASK_FOLLOW_NAV_MESH_TO_COORD(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
				func_402("Did Marnie regular exit");
			}
			FORCE_PED_MOTION_STATE(Local_298[0 /*8*/], -668482597, false, 1, 0);
		}
	}
}
	...
	if (func_231(iLocal_303))
	{
		if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Artefact_Detector", 0))
		{
			if (iLocal_283 < 2)
			{
				...
				GIVE_WEAPON_OBJECT_TO_PED(iLocal_303, GIVE_WEAPON_OBJECT_TO_PED());
				func_5(&iLocal_303);
				if (!DOES_ENTITY_EXIST(Local_301))
				{
					func_402("*** Recreating gDetector.hObj after cutscene...");
					Local_301 = GET_CURRENT_PED_WEAPON_ENTITY_INDEX(GET_CURRENT_PED_WEAPON_ENTITY_INDEX());
				}
			}
			else
			{
...
void func_257(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_259(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_271(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_275(iVar2, iVar6) != 0)
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			if (HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_275(iVar2, iVar6)))
			{
				if (func_274(func_275(iVar2, iVar6)))
				{
					iVar7 = GET_WEAPON_COMPONENT_TYPE_MODEL(func_275(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_275(iVar2, iVar6) != 0)
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			if (HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_275(iVar2, iVar6)))
			{
				GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_275(iVar2, iVar6));
...
int func_278(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_285(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_284(PLAYER_PED_ID(), -828834893))
				{
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_95, "SET_COLOUR");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(67);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(200);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(255);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(255);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(209);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(67);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(255);
	...
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_95, "SET_DISTANCE");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(100f);
	END_SCALEFORM_MOVIE_METHOD();
	SET_TEXT_RENDER_ID(iLocal_96);
	DRAW_SCALEFORM_MOVIE(iLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
...
void func_290(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_291())
		{
			if ((ARE_STRINGS_EQUAL(Local_301.f_14, "NO_RECENT_ANIM") || !ARE_STRINGS_EQUAL(Local_301, "rcm_epsilonism4", Local_301.f_14, 3)) || ARE_STRINGS_EQUAL(Local_301, "rcm_epsilonism4", Local_301.f_14) >= 0.98f)
			{
				if (fLocal_302 > 80f)
				{
				...
				PLAY_ENTITY_ANIM(Local_301, Local_301.f_14, "rcm_epsilonism4", 16f, false, false, 0, 0f, 0);
			}
		}
	}
	else if (func_291())
	{
		...
		{
			if (IS_ENTITY_PLAYING_ANIM(Local_301, "rcm_epsilonism4", Local_301.f_14, 1))
			{
				if (GET_ENTITY_ANIM_CURRENT_TIME(Local_301, "rcm_epsilonism4", Local_301.f_14) <= 0.05f)
				{
					STOP_ENTITY_ANIM(Local_301, Local_301.f_14, "rcm_epsilonism4", -4f);
...
void func_303()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (iLocal_283 == 0)
		{
			if (!func_335())
			{
				...
				SET_ENTITY_HEADING(SET_ENTITY_HEADING(), fLocal_84);
			}
			func_287(&(Local_298[1 /*8*/]), 1);
			func_287(&(Local_298[0 /*8*/]), 1);
			if (func_347(Local_298[1 /*8*/]))
			{
				...
				SET_ENTITY_COORDS(Local_298[1 /*8*/], 1829.75f, 4693.5f, 38.51f, 1, false, 0, 1);
				SET_ENTITY_HEADING(Local_298[1 /*8*/], 27.46f);
				vVar2 = { GET_ENTITY_COORDS(Local_298[1 /*8*/], true) };
				GET_GROUND_Z_FOR_3D_COORD(1829.75f, 4693.5f, 38.51f, &fVar1, 0, 0);
				SET_ENTITY_COORDS(Local_298[1 /*8*/], vVar2.x, vVar2.y, fVar1, 1, false, 0, 1);
				func_402("Setting Jimmy position (0)");
			}
			if (func_347(Local_298[0 /*8*/]))
			{
				SET_ENTITY_COORDS(Local_298[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, false, 0, 1);
		...
		{
			SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 1754.634f, 4675.789f, 42.9068f, 1, false, 0, 1);
			SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 293.2275f);
			if (func_347(Local_298[1 /*8*/]))
			{
				SET_ENTITY_COORDS(Local_298[1 /*8*/], 1758.586f, 4670.085f, 42.6276f, 1, false, 0, 1);
				SET_ENTITY_HEADING(Local_298[1 /*8*/], 262.4368f);
				func_402("Setting Jimmy position (1)");
			}
			if (func_347(Local_298[0 /*8*/]))
			{
				SET_ENTITY_COORDS(Local_298[0 /*8*/], 1759.917f, 4683.584f, 42.7266f, 1, false, 0, 1);
		...
		{
			SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 1758.454f, 4829.431f, 39.729f, 1, false, 0, 1);
			SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 168.2012f);
			if (func_347(Local_298[0 /*8*/]))
			{
				SET_ENTITY_COORDS(Local_298[0 /*8*/], 1755.005f, 4827.329f, 40.0736f, 1, false, 0, 1);
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (iLocal_283 == 0)
		{
			...
			if (func_347(Local_298[1 /*8*/]))
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(Local_298[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
		...
		func_330(&uLocal_98, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	if (Local_434.f_1 == 1)
	{
		...
		else if (!func_328(&uLocal_356, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
		{
			func_239(6);
			Local_434.f_9 = 8;
			Local_434.f_1 = 3;
		...
		else
		{
			...
			if (DOES_ENTITY_EXIST(Local_293[iLocal_283 /*43*/].f_1))
			{
				if (iLocal_283 == 0)
				{
					if (func_230(PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
					{
						if (!HAS_CUTSCENE_LOADED())
						{
					...
					else if (func_230(PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
					{
						if (HAS_CUTSCENE_LOADED())
						{
				...
				else if (func_230(PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
				{
					if (!HAS_CUTSCENE_LOADED())
					{
			...
			if (iLocal_283 == 0)
			{
				...
				{
					if (IS_CONTROL_JUST_PRESSED(0, 25) || iLocal_409 < IS_CONTROL_JUST_PRESSED())
					{
						CLEAR_HELP(1);
						iLocal_409 = GET_GAME_TIMER() + 1000;
						iLocal_408++;
			...
			{
				func_322(&iLocal_94);
				if (!func_328(&uLocal_304, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)))
				{
					iLocal_269 = 0;
					STOP_SCRIPTED_CONVERSATION(false);
					CLEAR_PRINTS();
				...
				{
					if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91))
						{
							if (func_231(iLocal_291))
							{
								TASK_LOOK_AT_ENTITY(iLocal_291, TASK_LOOK_AT_ENTITY(), 10000, 0, 2);
							}
						}
						iLocal_421 = GET_GAME_TIMER();
						iLocal_270 = 1;
				...
				{
					if (!func_282() && (GET_GAME_TIMER() - iLocal_288) >= 7500)
					{
						if ((ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91) || !ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), iLocal_291, 30f, 30f, 30f, 0, 1, 0)) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91))
							{
								if (func_231(iLocal_291))
								{
									TASK_LOOK_AT_ENTITY(iLocal_291, TASK_LOOK_AT_ENTITY(), 5000, 0, 2);
								}
							}
							iLocal_271 = 1;
							iLocal_421 = GET_GAME_TIMER();
				...
				else if (iLocal_268 == 0 && !func_306(PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 9f))
				{
					if (func_306(PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 20f))
					{
						if (!iLocal_273)
						{
							if (!func_282())
					...
					{
						if (func_305(PLAYER_PED_ID(), iLocal_291, 30f, 1) || iLocal_283 == 2)
						{
							if (!func_282() && (GET_GAME_TIMER() - iLocal_286) > 15000)
							{
								if (bLocal_266)
								{
									if (iLocal_282 == 0)
									{
										...
										{
											if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_347(iLocal_291))
												{
													TASK_LOOK_AT_ENTITY(iLocal_291, TASK_LOOK_AT_ENTITY(), 3000, 0, 2);
												}
												iLocal_286 = GET_GAME_TIMER();
												iLocal_412++;
												if (iLocal_283 == 2)
									...
									{
										if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_286 = GET_GAME_TIMER();
											iLocal_414++;
										}
								...
								{
									if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_41, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_347(iLocal_291))
										{
											TASK_LOOK_AT_ENTITY(iLocal_291, TASK_LOOK_AT_ENTITY(), 3000, 0, 2);
				...
				if (iLocal_283 == 0)
				{
					if (iLocal_415 < 5)
					{
						if (((GET_GAME_TIMER() - iLocal_417) > 7500 && !func_282()) && !GET_GAME_TIMER())
						{
							if (func_231(Local_298[0 /*8*/]))
							{
								if (func_230(Local_298[0 /*8*/], PLAYER_PED_ID(), 1) < 4f)
								{
				...
				else if (iLocal_283 == 1)
				{
					if (iLocal_415 < 4)
					{
						if (((GET_GAME_TIMER() - iLocal_417) > 7500 && !func_282()) && !GET_GAME_TIMER())
						{
							if (func_231(Local_298[1 /*8*/]))
							{
								if (func_230(Local_298[1 /*8*/], PLAYER_PED_ID(), 1) < 4f)
								{
				...
				if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), Local_293[iLocal_283 /*43*/].f_2, 6.2f, 6.2f, 2f, false, false, 1))
				{
					if (iLocal_289 == -1)
					{
				...
				else if (!func_306(PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_267 = 0;
				}
			}
			else
			{
				...
				else if (iLocal_274 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY(), iLocal_291, 30f, 30f, 30f, 0, 1, 0))
						{
							if (!func_282() && !IS_MESSAGE_BEING_DISPLAYED())
							{
								if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_274 = 1;
								}
							}
					...
					else if (!func_282() && !IS_MESSAGE_BEING_DISPLAYED())
					{
						if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_274 = 1;
				...
				else if (iLocal_275 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (IS_ENTITY_AT_ENTITY(IS_ENTITY_AT_ENTITY(), iLocal_291, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_282() && (GET_GAME_TIMER() - iLocal_288) >= 7500) && !GET_GAME_TIMER())
							{
								if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_275 = 1;
								}
							}
					...
					else if ((!func_282() && (GET_GAME_TIMER() - iLocal_288) >= 7500) && !GET_GAME_TIMER())
					{
						if (ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_308(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_275 = 1;
...
int func_311()
{
	...
	if (PLAYER_ID() == func_314())
	{
		return 0;
	}
	if (func_312(PLAYER_ID()))
	{
		return 0;
	}
...
void func_324(var uParam0)
{
	...
	fVar0 = vdist(uParam0->f_2, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true));
	vVar1 = { GET_ENTITY_FORWARD_VECTOR(GET_ENTITY_FORWARD_VECTOR()) };
	...
	vVar4 = { uParam0->f_2 - GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
	vVar5 = { uParam0->f_2 - GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(), 0f, -5f, 0f) };
	bVar6 = ((vVar4.x * vVar2.x) + (vVar4.y * vVar2.y)) > 0f;
	fVar7 = (1f - (GET_ANGLE_BETWEEN_2D_VECTORS(vVar2.x, vVar2.y, vVar5.x, vVar5.y) / 180f));
	if (fVar0 >= 10f)
	{
	...
	else if (iLocal_284 < GET_GAME_TIMER())
	{
		...
		{
			STOP_SOUND(Local_301.f_3);
			PLAY_SOUND_FROM_ENTITY(Local_301.f_4, "CONTINUAL_BEEP", PLAY_SOUND_FROM_ENTITY(), "EPSILONISM_04_SOUNDSET", false, 0);
			Local_301.f_6 = 1;
		}
		else
		{
			...
			PLAY_SOUND_FROM_ENTITY(Local_301.f_3, "IDLE_BEEP", PLAY_SOUND_FROM_ENTITY(), "EPSILONISM_04_SOUNDSET", false, 0);
			if (bVar8)
			{
				SET_PAD_SHAKE(0, 200, 150);
			}
	...
	if (IS_AIM_CAM_ACTIVE())
	{
		if (Local_301.f_7 == 0)
		{
			PLAY_SOUND_FROM_ENTITY(Local_301.f_5, "SCAN", PLAY_SOUND_FROM_ENTITY(), "EPSILONISM_04_SOUNDSET", false, 0);
			Local_301.f_7 = 1;
		}
		else if (bVar8)
		{
	...
	else
	{
		...
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_95, "SET_DISTANCE");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_302);
		END_SCALEFORM_MOVIE_METHOD();
		SET_TEXT_RENDER_ID(iLocal_96);
		DRAW_SCALEFORM_MOVIE(iLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
...
void func_325(var uParam0)
{
	...
	if (func_347(*uParam0) && IS_PED_IN_GROUP(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_296[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
			...
			else if (uParam0->f_2 == 0)
			{
				...
				if (Local_296[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_298[1 /*8*/])
					{
						...
						TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
					...
					else
					{
						...
						TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
				...
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 2)
				{
					...
					TASK_PLAY_ANIM(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
		...
		case 4:
			...
			{
				if (!IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), uParam0->f_4, 1f, 1f, 1f, false, true, 0) || iLocal_283 > 0)
				{
					if (!IS_PED_IN_GROUP(*uParam0))
					{
						CLEAR_PED_TASKS(*uParam0);
						SET_PED_AS_GROUP_MEMBER(*uParam0, func_326());
						SET_PED_CONFIG_FLAG(*uParam0, 167, true);
					}
					iLocal_418 = GET_GAME_TIMER();
					if (iLocal_283 == 0)
					{
						SET_GROUP_FORMATION(func_326(), 0);
					}
					else
					{
						SET_GROUP_FORMATION(func_326(), 0);
					}
					SET_GROUP_FORMATION_SPACING(func_326(), 4f, -1f, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (IS_PED_SPRINTING(IS_PED_SPRINTING()) || IS_PED_SPRINTING(IS_PED_SPRINTING()))
				{
					if ((((GET_GAME_TIMER() - iLocal_419) > 7500 && !func_282()) && !GET_GAME_TIMER()) && !iLocal_267)
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
				...
				{
					if ((((iLocal_420 < 4 && !func_282()) && !IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_267) && !func_348())
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
		...
		case 5:
			...
			{
				TASK_GO_TO_ENTITY(*uParam0, TASK_GO_TO_ENTITY(), 20000, 4.5f, 2f, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_347(iParam0) && func_231(PLAYER_PED_ID()))
	{
		if (iLocal_299 == 0)
		{
			if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), iParam0) && IS_ENTITY_TOUCHING_ENTITY(iParam0))
			{
		...
		{
			if (IS_PED_GETTING_UP(iLocal_300) || IS_PED_GETTING_UP(iLocal_300))
			{
				if (!func_282() && !IS_MESSAGE_BEING_DISPLAYED())
				{
...
{
	PLAY_SOUND_FROM_ENTITY(Local_301.f_2, "DEVICE", PLAY_SOUND_FROM_ENTITY(), "EPSILONISM_04_SOUNDSET", false, 0);
	if (Local_301.f_13 == 0)
	{
...
void func_331(var uParam0, int iParam1)
{
	if (func_347(*uParam0))
	{
		...
		CLEAR_PED_TASKS_IMMEDIATELY(*uParam0);
		SET_ENTITY_COORDS(*uParam0, Local_296[iParam1 /*6*/], 1, false, 0, 1);
...
{
	if (func_347(*uParam0) && func_347(PLAYER_PED_ID()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		TASK_LOOK_AT_ENTITY(*uParam0, TASK_LOOK_AT_ENTITY(), -1, 0, 2);
		if (bParam1)
		{
			TASK_TURN_PED_TO_FACE_ENTITY(*uParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
		}
		uParam0->f_4 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
	}
	else
	{
		uParam0->f_1 = 0;
...
void func_340()
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (func_278(1, 1093140480, 0))
		{
			...
			{
				FREEZE_ENTITY_POSITION(Local_81.f_28[1], false);
				if (func_231(GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_81.f_28[1])))
				{
	...
	if (Local_434.f_1 == 1)
	{
		...
		if (func_231(PLAYER_PED_ID()))
		{
			...
			{
				func_402("*** Forcing Michael's move state");
				func_343(PLAYER_PED_ID(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				GIVE_WEAPON_TO_PED(GIVE_WEAPON_TO_PED(), iLocal_89, -1, true, true);
			}
		}
...
void func_341()
{
	...
	if (func_231(Local_298[1 /*8*/]))
	{
		if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			GET_GROUND_Z_FOR_3D_COORD(1829.8f, 4693.48f, 38.5f, &fVar0, 0, 0);
			SET_ENTITY_COORDS(Local_298[1 /*8*/], 1829.8f, 4693.48f, fVar0, 1, false, 0, 1);
		}
	}
}
...
void func_342()
{
	if (func_231(Local_298[0 /*8*/]))
	{
		if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			...
			TASK_GO_STRAIGHT_TO_COORD(Local_298[0 /*8*/], Local_296[Local_298[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			FORCE_PED_MOTION_STATE(Local_298[0 /*8*/], -668482597, false, 1, 1);
			Local_298[0 /*8*/].f_7 = 1;
...
void func_345()
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (!func_413(0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
	...
	if (Local_434.f_1 == 1)
	{
		...
		{
			PLAY_SOUND_FROM_COORD(-1, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", false, 0, 0);
			iLocal_284 = GET_GAME_TIMER();
		}
		if (!func_413(0) && IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
			if (func_230(PLAYER_PED_ID(), Local_81.f_28[0], 1) >= 3f)
			{
				if (!IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (!iLocal_263)
					{
						...
						{
							SET_GAMEPLAY_ENTITY_HINT(Local_81.f_28[0], 0f, 0f, 0.2f, 1, 30000, 2000, 2000, 0);
							SET_GAMEPLAY_HINT_FOV(fLocal_429);
							_0xF8BDBF3D573049A1(fLocal_430);
							_0xD1F8363DFAD03848(fLocal_431);
							_0x5D7B620DAE436138(fLocal_432);
							_0xC92717EF615B6704(fLocal_433);
							...
							if (func_231(PLAYER_PED_ID()))
							{
								...
								CLOSE_SEQUENCE_TASK(iLocal_97);
								TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(), iLocal_97);
								CLEAR_SEQUENCE_TASK(&iLocal_97);
			...
			if (!iLocal_264)
			{
				...
				{
					TASK_LOOK_AT_ENTITY(Local_81.f_28[0], TASK_LOOK_AT_ENTITY(), -1, 48, 2);
					TASK_PLAY_ANIM(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					REMOVE_CUTSCENE();
			...
			else if (func_347(Local_81.f_28[0]))
			{
				if (IS_ENTITY_PLAYING_ANIM(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					...
					if (func_230(PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 1.5f)
					{
						SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 0);
						CLEAR_PED_TASKS(CLEAR_PED_TASKS());
					}
...
{
	if (((!func_362(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_225(0)) || func_361(1))
			{
			}
			else
			{
...
int func_377(var uParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4)
{
	...
	{
		*uParam0 = CREATE_PED(5, iParam4, vParam1, fParam2, 1, true);
...
void func_378(var uParam0)
{
	...
	uParam0->f_1 = CREATE_OBJECT_NO_OFFSET(*uParam0, vVar0, true, true, false);
	if (DOES_ENTITY_EXIST(uParam0->f_1))
	{
		SET_ENTITY_ROTATION(uParam0->f_1, uParam0->f_5, 0, 1);
		func_379("Rock rot vector: ", GET_ENTITY_ROTATION(uParam0->f_1, 0));
		func_379("Rock actual position: ", GET_ENTITY_COORDS(uParam0->f_1, false));
...
void func_380()
{
	...
	Local_301.f_13 = 0;
	Local_301.f_14 = "NO_RECENT_ANIM";
	iLocal_95 = 0x67D02A194A2FC2BD("digiscanner");
...
void func_400()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_285(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_405(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (func_347(PLAYER_PED_ID()))
			{
				iVar3 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
			}
...
void func_415()
{
	...
	if (func_347(PLAYER_PED_ID()))
	{
		...
		SET_CURRENT_PED_WEAPON(SET_CURRENT_PED_WEAPON(), joaat("weapon_unarmed"), true);
		CLEAR_PED_TASKS(CLEAR_PED_TASKS());
		SET_PED_CAPSULE(SET_PED_CAPSULE(), 0f);
	}
	if (IS_NEW_LOAD_SCENE_ACTIVE())
	{
		NEW_LOAD_SCENE_STOP();
	}
	_0x61F95E5BB3E0A8C6(uLocal_290);
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_92, 0);
...
void func_418(bool bParam0)
{
	...
	if (!func_433())
	{
		...
		{
			func_177(iVar0, 1, 0);
			func_419(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_420(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_426())
	{
		...
		{
			iVar2 = func_421(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
