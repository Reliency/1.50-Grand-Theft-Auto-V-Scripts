...
void __EntryFunction__()
{
	...
	if (HAS_FORCE_CLEANUP_OCCURRED(19))
	{
		...
		if (func_574(PLAYER_PED_ID()))
		{
			func_565(PLAYER_PED_ID(), 1);
			func_564(PLAYER_PED_ID(), 0);
		}
		else
		{
			func_563(0);
		...
		if (ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL3"))
		{
			func_560("B1_FAIL3", 1);
		}
		else if (IS_PLAYER_DEAD(IS_PLAYER_DEAD()))
		{
			func_560("B1_FAIL2", 1);
		}
		else
	...
	while (true)
	{
		...
		SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(), fLocal_111);
		SET_PLAYER_WEAPON_DAMAGE_MODIFIER(SET_PLAYER_WEAPON_DAMAGE_MODIFIER(), fLocal_110);
		if (func_9())
		{
			func_1();
		}
...
void func_1()
{
	...
	bVar0 = func_8(PLAYER_PED_ID(), vLocal_106, 1) < (fLocal_107 + 10f);
	if (iLocal_113)
	{
		if (bVar0 == 0 && bLocal_477 == 0)
		{
			...
			iLocal_114 = GET_GAME_TIMER() + 10000;
			func_3(0);
			iLocal_113 = 0;
		}
	}
	else if (func_8(PLAYER_PED_ID(), vLocal_106, 1) > fLocal_107)
	{
		if (GET_GAME_TIMER() > iLocal_114 && bLocal_477 == 0)
		{
			func_2("B1_FAIL");
		}
	}
...
void func_10(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_60(1);
			TRIGGER_MUSIC_EVENT("RC18A_STOP");
			if (IS_STRING_NULL_OR_EMPTY(sLocal_97))
			{
				func_543(1);
			}
			else
		...
		case 2:
			...
			else if (ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL"))
			{
			...
			else if (ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL2"))
			{
				func_11();
			}
			break;
...
void func_11()
{
	if (GET_GAME_TIMER() > iLocal_96 && iLocal_96 != -1)
	{
...
int func_13(int iParam0)
{
	...
	if (_0xB56BBBCC2955D9CB())
	{
		if (func_574(PLAYER_PED_ID()))
		{
			_0x2A56C06EBEF2B0D9("Michael", _0x2A56C06EBEF2B0D9(), _0x2A56C06EBEF2B0D9(_0x2A56C06EBEF2B0D9()));
			SET_PED_USING_ACTION_MODE(SET_PED_USING_ACTION_MODE(), false, -1, 0);
		}
		SET_CUTSCENE_PED_PROP_VARIATION(sLocal_246, 1, 0, 0, 0);
	}
	switch (iLocal_99)
	{
		case 0:
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				{
					DETACH_ENTITY(iLocal_101, 1, false);
				}
				OPEN_SEQUENCE_TASK(&iVar2);
				TASK_PLAY_ANIM(0, sLocal_256, sLocal_270, 8f, -8f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, sLocal_256, sLocal_271, 8f, -8f, -1, 1, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(iVar2);
				TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(), iVar2);
				CLEAR_SEQUENCE_TASK(&iVar2);
			}
			iVar3 = CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", CREATE_CAM_WITH_PARAMS(), CREATE_CAM_WITH_PARAMS(2), CREATE_CAM_WITH_PARAMS(), 1, 2);
			vVar0 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) - GET_ENTITY_COORDS() };
			ATTACH_CAM_TO_ENTITY(iVar3, ATTACH_CAM_TO_ENTITY(), -vVar0, 1);
			if (DOES_CAM_EXIST(iVar3))
			{
				SET_CAM_ACTIVE(iVar3, true);
			}
			iLocal_96 = GET_GAME_TIMER() + 6000;
			func_41(&uLocal_308, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
			iLocal_99 = 2;
			break;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_40(&uLocal_308, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) || GET_GAME_TIMER() > iLocal_96)
				{
					if (GET_GAME_TIMER() < iLocal_96)
					{
					}
					iLocal_96 = GET_GAME_TIMER() + 4500;
					bVar1 = true;
				}
			}
			else if (func_17(&uLocal_308, "BARY1AU", "BARY1_PREOUT", "BARY1_PREOUT_2", 8, 0, 0) || GET_GAME_TIMER() > iLocal_96)
			{
				iLocal_96 = GET_GAME_TIMER() + 2000;
				if (GET_GAME_TIMER() < iLocal_96)
				{
				}
				bVar1 = true;
		...
		case 4:
			...
			if (iParam0 == 1)
			{
				...
				{
					func_16();
					ANIMPOSTFX_PLAY(sLocal_255, 0, 0);
					iLocal_96 = GET_GAME_TIMER() + 3500;
					bVar1 = true;
				}
			}
			else
		...
		case 3:
			if (iParam0 == 1)
			{
				bVar1 = GET_GAME_TIMER() > iLocal_96;
			}
			else
			{
				if (GET_GAME_TIMER() < iLocal_96)
				...
				if (func_12(PLAYER_PED_ID()))
				{
					...
					if (func_12(iLocal_101) && IS_ENTITY_ATTACHED(iLocal_101))
					{
						DETACH_ENTITY(iLocal_101, 1, false);
					}
				}
		...
		case 5:
			if (GET_GAME_TIMER() > iLocal_96)
			{
				if (iParam0 == 1)
				{
					...
					CLEAR_AREA_OF_VEHICLES(vLocal_108, 200f, 0, 0, 0, 0, false, 0);
					REMOVE_DECALS_IN_RANGE(vLocal_108, 500f);
					CLEAR_AMBIENT_ZONE_STATE(sLocal_473, 1);
					if (func_12(PLAYER_PED_ID()))
					{
...
int func_15(int iParam0, int iParam1)
{
	...
	iVar0 = CREATE_OBJECT_NO_OFFSET(CREATE_OBJECT_NO_OFFSET(iParam0), CREATE_OBJECT_NO_OFFSET(CREATE_OBJECT_NO_OFFSET(), iVar1, 0f, 0f, 0f), true, true, false);
	if (!DOES_ENTITY_EXIST(iVar0))
	{
		return 0;
	}
	ATTACH_ENTITY_TO_ENTITY(iVar0, ATTACH_ENTITY_TO_ENTITY(), ATTACH_ENTITY_TO_ENTITY(ATTACH_ENTITY_TO_ENTITY(), iVar1), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	return iVar0;
}

void func_16()
{
	if (ANIMPOSTFX_IS_RUNNING(sLocal_253))
	{
		ANIMPOSTFX_STOP(sLocal_253);
	}
	if (ANIMPOSTFX_IS_RUNNING(sLocal_254))
	{
		ANIMPOSTFX_STOP(sLocal_254);
	}
	if (ANIMPOSTFX_IS_RUNNING(sLocal_255))
	{
		ANIMPOSTFX_STOP(sLocal_255);
	}
}
...
void func_44(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_49(IS_PED_INJURED())) && !func_46(IS_PED_INJURED(), 0)) && !func_45()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_49(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_68()
{
	...
	while (iVar0 < Local_502)
	{
		if (func_4(&(Local_502[iVar0 /*33*/])))
		{
			...
			TASK_SMART_FLEE_COORD(Local_502[iVar0 /*33*/].f_2, TASK_SMART_FLEE_COORD(TASK_SMART_FLEE_COORD(), true), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}
...
void func_70(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_12(iLocal_101) && IS_ENTITY_ATTACHED(iLocal_101))
			{
				DETACH_ENTITY(iLocal_101, 1, true);
			}
			OPEN_SEQUENCE_TASK(&iVar0);
			TASK_PLAY_ANIM(0, sLocal_256, sLocal_266, 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, sLocal_256, sLocal_269, 8f, -2f, -1, 0, 0, 0, 0, 0);
		...
		case 2:
			if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(), 242628503) == 7)
			{
				...
				START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_alien_teleport", START_PARTICLE_FX_NON_LOOPED_AT_COORD(START_PARTICLE_FX_NON_LOOPED_AT_COORD(), true), START_PARTICLE_FX_NON_LOOPED_AT_COORD(START_PARTICLE_FX_NON_LOOPED_AT_COORD(), 2), fLocal_491, 0, 0, 0);
				PLAY_SOUND_FROM_ENTITY(-1, "SPAWN", PLAY_SOUND_FROM_ENTITY(), "BARRY_01_SOUNDSET", false, 0);
				fLocal_126 = 255f;
				*iParam0 = 4;
			}
			break;
		...
		case 4:
			fLocal_126 = (fLocal_126 - (GET_FRAME_TIME() * 512f));
			if (fLocal_126 <= 0f)
			{
				fLocal_126 = 0f;
			...
			func_80(PLAYER_PED_ID(), floor(fLocal_126), &iLocal_118);
			break;
...
int func_71()
{
	...
	{
		case 0:
			iLocal_545 = CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", vLocal_571, vLocal_572, 50f, 0, 2);
			Local_546.f_11 = iLocal_545;
			iLocal_570 = GET_GAME_TIMER() + 400;
			iLocal_569++;
			break;
		...
		case 3:
			if (GET_GAME_TIMER() > iLocal_570)
			{
				SET_ENTITY_COORDS(SET_ENTITY_COORDS(), vLocal_571, 1, false, 0, 1);
				...
				{
					if (DOES_CAM_EXIST(iLocal_545))
					{
						SET_CAM_ROT(iLocal_545, vLocal_572, 2);
						SET_CAM_ACTIVE(iLocal_545, true);
						ATTACH_CAM_TO_ENTITY(iLocal_545, ATTACH_CAM_TO_ENTITY(), 0f, 0f, 4f, 0);
					}
				}
				else
				{
		...
		case 6:
			if (IS_GAMEPLAY_CAM_RENDERING())
			{
				if (DOES_CAM_EXIST(iLocal_545))
				{
					SET_CAM_ACTIVE(iLocal_545, false);
					DESTROY_CAM(iLocal_545, 0);
				}
				return 1;
			}
			break;
...
int func_75(var uParam0, float fParam1)
{
	...
	if (!uParam0->f_15)
	{
		if (DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			if (!IS_ENTITY_DEAD(iVar7, 0))
			{
				fVar2 = GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iVar7, true), GET_DISTANCE_BETWEEN_COORDS(uParam0->f_11), true);
			}
			else
			{
				fVar2 = GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iVar7, false), GET_DISTANCE_BETWEEN_COORDS(uParam0->f_11), true);
			}
			fVar2 = func_78(fVar2, 50f, 4000f);
			iVar1 = round((((fVar2 / ((4000f - 50f) / (2000f - 1000f))) + 400f) * fParam1));
			if (IS_PED_IN_ANY_VEHICLE(iVar7, 0))
			{
				iVar6 = GET_VEHICLE_PED_IS_USING(iVar7);
				bVar5 = true;
			}
			vVar3 = { _GET_GAMEPLAY_CAM_ROT(2) };
			uParam0->f_24 = 0;
			SET_CAM_FOV(uParam0->f_9, SET_CAM_FOV());
			...
			if (bVar5)
			{
				vVar4 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar6, GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS()) };
				ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, vVar4, 1);
			}
			else
			{
				vVar4 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar7, GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS()) };
				ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar7, vVar4, 1);
			}
			SET_CAM_ROT((*uParam0)[uParam0->f_24], vVar3, 2);
			SET_CAM_FOV((*uParam0)[uParam0->f_24], SET_CAM_FOV());
			...
			{
				vVar4 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar6, GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS()) };
				ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, vVar4 + Vector(15f, 0f, 0f), 1);
			}
			else
			{
				ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar7, 0f, 0f, 5f, 0);
			}
			...
			if (bVar5)
			{
				ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, 0f, 0f, 75f, 0);
			}
			else
			{
				ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar7, 0f, 0f, 75f, 0);
			}
			SET_CAM_ROT((*uParam0)[uParam0->f_24], -87.5f, 0f, vVar3.z, 2);
			SET_CAM_FOV((*uParam0)[uParam0->f_24], SET_CAM_FOV());
			_0x0FB82563989CF4FB(uParam0->f_9, (*uParam0)[uParam0->f_24], 400, 1);
			uParam0->f_24++;
			uParam0->f_27 += 400;
			vVar8 = { GET_CAM_ROT(uParam0->f_11, 2) };
			vVar8.x = 21f;
			ADD_CAM_SPLINE_NODE(uParam0->f_9, ADD_CAM_SPLINE_NODE(uParam0->f_11), vVar8, iVar1, 3, 2);
	...
	if (uParam0->f_15 && !uParam0->f_16)
	{
		if (DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (!Global_22211.f_111)
			{
				...
				{
					Global_22211.f_109 = GET_SOUND_ID();
					Global_22211.f_110 = GET_HASH_KEY(GET_HASH_KEY());
				}
				PLAY_SOUND(Global_22211.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, 0, 0, 1);
	...
	if (uParam0->f_16)
	{
		if (DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (bVar9)
			{
				...
				{
					if (GET_CAM_SPLINE_PHASE(uParam0->f_9) > 0.5f && GET_CAM_SPLINE_PHASE(uParam0->f_9))
					{
						uParam0->f_18 = 1;
					}
				}
	...
	if (uParam0->f_17)
	{
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_22211.f_109 != -1 && Global_22211.f_110 == GET_HASH_KEY(GET_HASH_KEY()))
		{
			STOP_SOUND(Global_22211.f_109);
			RELEASE_SOUND_ID(Global_22211.f_109);
...
void func_81(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_333(1, 1093140480, 0) && HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				iLocal_274 = 0;
				if (func_12(PLAYER_PED_ID()))
				{
				...
				func_332();
				CLEAR_AREA_OF_VEHICLES(vLocal_108, 250f, 0, 0, 0, 0, false, 0);
				CLEAR_AREA_OF_PEDS(vLocal_108, 50f, 0);
				CLEAR_AREA_OF_OBJECTS(vLocal_108, 30f, 0);
				REMOVE_DECALS_IN_RANGE(vLocal_108, 500f);
				CLEAR_PLAYER_WANTED_LEVEL(CLEAR_PLAYER_WANTED_LEVEL());
				func_283();
				REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_246, 2, func_577(49), 0);
				REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_248, 2, joaat("prop_protest_table_01"), 0);
				REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_247, 2, joaat("prop_chair_08"), 0);
				if (func_574(PLAYER_PED_ID()))
				{
		...
		case 2:
			...
			else
			{
				...
				{
					if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(sLocal_246, 0)))
					{
						Local_94.f_28[0] = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_PED_INDEX_FROM_ENTITY_INDEX(sLocal_246, 0));
						SET_PED_PROP_INDEX(Local_94.f_28[0], 1, 0, 0, false);
					}
				}
				if (!func_574(Local_94.f_41[0]))
				{
					if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(sLocal_248, 0)))
					{
						Local_94.f_41[0] = GET_OBJECT_INDEX_FROM_ENTITY_INDEX(GET_OBJECT_INDEX_FROM_ENTITY_INDEX(sLocal_248, 0));
					}
				}
				if (!func_574(Local_94.f_41[1]))
				{
					if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(sLocal_247, 0)))
					{
						Local_94.f_41[1] = GET_OBJECT_INDEX_FROM_ENTITY_INDEX(GET_OBJECT_INDEX_FROM_ENTITY_INDEX(sLocal_247, 0));
					}
				}
				if (CAN_SET_ENTER_STATE_FOR_REGISTERED_ENTITY(sLocal_248, 0))
				{
		...
		case 3:
			...
			func_53(1, 1, 1, 1);
			func_275(PLAYER_PED_ID(), vLocal_108);
			SET_ENTITY_HEADING(SET_ENTITY_HEADING(), fLocal_109);
			SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
			SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			wait(250);
			func_282(250, 0);
...
void func_82()
{
	if (iLocal_127 == iLocal_123 && HAS_PED_GOT_WEAPON(HAS_PED_GOT_WEAPON(), iLocal_127, 0))
	{
		SET_PED_INFINITE_AMMO(SET_PED_INFINITE_AMMO(), 0, iLocal_127);
	}
	if (func_574(PLAYER_PED_ID()))
	{
		func_565(PLAYER_PED_ID(), 1);
...
void func_280(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_281(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_283()
{
	...
	if (DOES_ENTITY_EXIST(func_331()) && !func_58(vLocal_542, vLocal_104, 0))
	{
		CLEAR_AREA(vLocal_542, 3f, 1, 0, 0, false);
		if (func_574(func_331()))
		{
			SET_ENTITY_COORDS(func_331(), vLocal_542, 1, false, 0, 1);
			SET_ENTITY_HEADING(func_331(), fLocal_543);
			SET_VEHICLE_ON_GROUND_PROPERLY(func_331(), 1084227584);
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_302(iParam0, 0, 0)) || func_302(iParam0, 1, 0)) || func_302(iParam0, 2, 0)) || func_322(iParam0) != 145) || func_301(iParam0)) || func_300(iParam0)) || func_299(iParam0)) || func_298(iParam0)) || !func_288(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_300(iParam0))
		{
		}
...
var func_305()
{
	...
	func_315(&uVar0, GET_CLOCK_SECONDS());
	func_314(&uVar0, GET_CLOCK_MINUTES());
	func_313(&uVar0, GET_CLOCK_HOURS());
	func_308(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_307(&uVar0, GET_CLOCK_MONTH());
	func_306(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_311(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_324(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_332()
{
	if (IS_AUDIO_SCENE_ACTIVE(sLocal_258))
	{
		STOP_AUDIO_SCENE(sLocal_258);
	}
	CLEAR_AMBIENT_ZONE_STATE(sLocal_473, 1);
	...
	SPECIAL_ABILITY_UNLOCK(func_33(0));
	SET_PED_USING_ACTION_MODE(SET_PED_USING_ACTION_MODE(), false, -1, 0);
	func_72();
...
int func_333(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_339(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_338(PLAYER_PED_ID(), -828834893))
				{
...
void func_344(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_522 != 0 && GET_GAME_TIMER() > iLocal_522)
			{
				iLocal_522 = 0;
				iLocal_521 = 0;
			}
			if (IS_AUDIO_SCENE_ACTIVE(sLocal_258))
			{
				SET_AUDIO_SCENE_VARIABLE(sLocal_258, "DrugsEffect", ((sin((((to_float(SET_AUDIO_SCENE_VARIABLE()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
...
void func_345()
{
	...
	{
		iLocal_281 = (GET_GAME_TIMER() + GET_GAME_TIMER(20000, 40000));
		if ((iLocal_280 - GET_GAME_TIMER()) < 2500)
		{
			iLocal_280 = (GET_GAME_TIMER() + GET_GAME_TIMER(3000, 5000));
		}
	}
}
...
void func_351()
{
	...
	if (!iLocal_474)
	{
		iLocal_498 = (GET_GAME_TIMER() + GET_GAME_TIMER(iLocal_499, iLocal_500));
		return;
	}
	if (bLocal_477)
	{
		iLocal_498 = (GET_GAME_TIMER() + GET_GAME_TIMER(iLocal_499 * 3, iLocal_500 * 2));
		return;
	}
...
int func_352(var uParam0)
{
	...
	{
		*uParam0 = { _GET_OBJECT_OFFSET_FROM_COORDS(_GET_OBJECT_OFFSET_FROM_COORDS(_GET_OBJECT_OFFSET_FROM_COORDS(), true), _GET_OBJECT_OFFSET_FROM_COORDS(0f, 360f), 0f, _GET_OBJECT_OFFSET_FROM_COORDS(fLocal_496, fLocal_497), 6f) };
	}
...
int func_353(var uParam0, bool bParam1)
{
	...
	if (func_355(PLAYER_PED_ID(), vVar0, fVar1))
	{
		return 0;
	}
	if (GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_106, true) > fLocal_107)
	{
		return 0;
	}
	if (!IS_POINT_IN_ANGLED_AREA(vVar0, Local_125[0 /*3*/], Local_125[1 /*3*/], Local_125.f_7, 0, true))
	{
		return 0;
	}
	if (bLocal_117)
...
Vector3 func_356(vector3 vParam0, float fParam1, float fParam2)
{
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_357(vVar0, GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
...
void func_358(var uParam0)
{
	...
	{
		SET_ENTITY_HEALTH(uParam0->f_2, (iLocal_485 / 4), 0);
...
int func_359(var uParam0, vector3 vParam1, int iParam2, bool bParam3)
{
	...
	uParam0->f_2 = CREATE_PED(26, iLocal_275, vParam1, 0f, 1, true);
	...
	SET_PED_CONFIG_FLAG(uParam0->f_2, 122, true);
	STOP_PED_SPEAKING(uParam0->f_2, true);
	DISABLE_PED_PAIN_AUDIO(uParam0->f_2, true);
	...
	SET_ENTITY_MAX_HEALTH(uParam0->f_2, iLocal_485);
	SET_ENTITY_HEALTH(uParam0->f_2, iLocal_485, 0);
	uParam0->f_4 = CREATE_OBJECT_NO_OFFSET(iLocal_276, CREATE_OBJECT_NO_OFFSET(uParam0->f_2, 0f, -5f, 0f), true, true, false);
	...
	uParam0->f_5 = CREATE_OBJECT_NO_OFFSET(iLocal_276, CREATE_OBJECT_NO_OFFSET(uParam0->f_2, 0f, -5f, 0f), true, true, false);
	...
	uParam0->f_6 = CREATE_OBJECT_NO_OFFSET(iLocal_276, CREATE_OBJECT_NO_OFFSET(uParam0->f_2, 0f, 5f, 0f), true, true, false);
	...
	*uParam0 = 1;
	uParam0->f_32 = 0;
	uParam0->f_7 = (GET_GAME_TIMER() + iParam2 * 500);
	uParam0->f_16 = (GET_GAME_TIMER() + GET_GAME_TIMER(iLocal_486, iLocal_487));
	uParam0->f_10 = func_360(uParam0->f_2, PLAYER_PED_ID(), 1);
	uParam0->f_11 = GET_RANDOM_FLOAT_IN_RANGE(2f, 3f);
	uParam0->f_14 = (fLocal_509 + (GET_RANDOM_FLOAT_IN_RANGE(fLocal_513, fLocal_514) * fLocal_509));
	uParam0->f_15 = 0f;
	if (iLocal_116 == 1)
	{
	}
	TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_268, 1000f, -8f, -1, 1, 0, 0, 0, 0);
	iLocal_524++;
	return 1;
}
...
void func_361(int iParam0)
{
	...
	fVar0 = func_362(GET_ENTITY_COORDS(iParam0, true), GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 1);
...
int func_364(var uParam0)
{
	...
	while (iVar0 < 9)
	{
		if (iVar1 < vVar2.x)
		{
			if (!IS_ANY_PED_NEAR_POINT(vLocal_541[iVar0 /*3*/], 1.5f))
			{
...
void func_368(int iParam0)
{
	...
	{
		REMOVE_WEAPON_FROM_PED(REMOVE_WEAPON_FROM_PED(), *iParam0);
	}
	*iParam0 = func_370(*iParam0);
	iVar0 = func_369(*iParam0);
	GIVE_WEAPON_TO_PED(GIVE_WEAPON_TO_PED(), *iParam0, iVar0, true, true);
	if (*iParam0 == iLocal_123)
	{
		SET_PED_INFINITE_AMMO(SET_PED_INFINITE_AMMO(), 1, *iParam0);
	}
	else
	{
		SET_AMMO_IN_CLIP(SET_AMMO_IN_CLIP(), *iParam0, 0);
		SET_PED_AMMO(SET_PED_AMMO(), *iParam0, 0, 0);
...
float func_376(var uParam0)
{
	if (func_379(uParam0))
	{
		...
		{
			return (func_377(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	iParam0->f_1 = (func_377(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			...
			func_389();
			func_388(iLocal_127);
			SET_AMBIENT_ZONE_STATE(sLocal_473, 1, 0);
			break;
		
		case 1:
			CLEAR_PRINTS();
			START_AUDIO_SCENE(sLocal_258);
			CLEAR_PED_BLOOD_DAMAGE(CLEAR_PED_BLOOD_DAMAGE());
			iLocal_524 = 0;
			iLocal_525 = 0;
			iLocal_481 = 0;
		...
		if (func_373(&iLocal_534, fLocal_537))
		{
			if (func_367(&iVar0))
			{
				if (func_385(vParam0, fParam1, &vVar1))
				{
					...
					func_380(&iLocal_534);
					fLocal_537 = GET_RANDOM_FLOAT_IN_RANGE(1.5f, 2.5f);
				}
				else
				{
					func_380(&iLocal_534);
...
void func_388(int iParam0)
{
	...
	if (func_574(PLAYER_PED_ID()))
	{
		if (!HAS_PED_GOT_WEAPON(HAS_PED_GOT_WEAPON(), iParam0, 0))
		{
			GIVE_WEAPON_TO_PED(GIVE_WEAPON_TO_PED(), iParam0, 10, true, true);
		}
		else if (!GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1) || iVar0 != iParam0)
		{
			SET_CURRENT_PED_WEAPON(SET_CURRENT_PED_WEAPON(), iParam0, true);
		}
		ADD_AMMO_TO_PED(ADD_AMMO_TO_PED(), iParam0, 10000);
		SET_PED_INFINITE_AMMO(SET_PED_INFINITE_AMMO(), 1, iParam0);
		...
		_PED_SKIP_NEXT_RELOADING(_PED_SKIP_NEXT_RELOADING());
...
{
	func_41(&uLocal_308, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	iLocal_279 = GET_GAME_TIMER() + 1500;
	iLocal_281 = (iLocal_279 + GET_RANDOM_INT_IN_RANGE(20000, 40000));
	iLocal_280 = (iLocal_279 + GET_RANDOM_INT_IN_RANGE(12000, 18000));
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_333(1, 1093140480, 0))
			{
				if (func_574(Local_94.f_28[0]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_28[0], sLocal_246, 0, 0, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_28[0], sLocal_246, 2, func_577(49), 0);
				}
				if (func_574(Local_94.f_41[0]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[0], sLocal_248, 0, 0, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[0], sLocal_248, 2, joaat("prop_protest_table_01"), 0);
				}
				if (func_574(Local_94.f_41[1]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[1], sLocal_247, 0, 0, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[1], sLocal_247, 2, joaat("prop_chair_08"), 0);
				}
				if (func_574(Local_94.f_41[2]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[2], sLocal_250, 0, 0, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[2], sLocal_250, 2, joaat("p_a4_sheets_s"), 0);
				}
				if (func_574(Local_94.f_41[3]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[3], sLocal_251, 0, 0, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[3], sLocal_251, 2, joaat("p_cs_lighter_01"), 0);
				}
				if (func_574(Local_94.f_41[4]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[4], sLocal_252, 0, 0, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_41[4], sLocal_252, 2, joaat("p_cs_joint_01"), 0);
				}
				if (func_574(PLAYER_PED_ID()))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), "Michael", 0, 0, 0);
				}
				GIVE_WEAPON_TO_PED(GIVE_WEAPON_TO_PED(), iLocal_127, -1, false, false);
				iLocal_530 = func_428(PLAYER_PED_ID(), iLocal_127, 1, 0, 0, 0, 0, 0, 0);
				REGISTER_ENTITY_FOR_CUTSCENE(iLocal_530, sLocal_249, 0, 0, 0);
				func_427();
				START_CUTSCENE(0);
				_0x48621C9FCA3EBD28(1);
				...
				if (func_574(Local_94.f_41[4]))
				{
					if (IS_ENTITY_ATTACHED(Local_94.f_41[4]))
					{
						DETACH_ENTITY(Local_94.f_41[4], 1, true);
					}
				}
				func_426(0, 0, 1, 0);
				func_418();
		...
		case 2:
			...
			else
			{
				...
				if (bLocal_35)
				{
					...
					func_416(0.1f, 0.1f, "NUMBER", GET_CUTSCENE_TIME(), 0);
				}
				if (func_410(&uLocal_128))
				{
					if (!iLocal_529)
				...
				{
					REQUEST_WEAPON_HIGH_DETAIL_MODEL(iLocal_530);
					if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_249, 0))
					{
						GIVE_WEAPON_OBJECT_TO_PED(iLocal_530, GIVE_WEAPON_OBJECT_TO_PED());
					}
				}
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_250, 0))
				{
					if (func_574(Local_94.f_41[2]))
					{
						DELETE_OBJECT(&(Local_94.f_41[2]));
					}
				}
				if (iLocal_272 == 0)
				{
		...
		case 3:
			...
			if (iLocal_272 == 0)
			{
				...
				if (!ANIMPOSTFX_IS_RUNNING(sLocal_254))
				{
					ANIMPOSTFX_PLAY(sLocal_254, 0, 1);
				}
			}
			else
			{
			...
			func_275(PLAYER_PED_ID(), vLocal_108);
			SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 327.2303f);
			func_388(iLocal_127);
			wait(500);
			iLocal_100 = 4;
			break;
...
void func_418()
{
	if (func_328(func_330(), 1))
	{
		if (func_574(func_331()))
		{
			vLocal_542 = { GET_ENTITY_COORDS(func_331(), true) };
			fLocal_543 = GET_ENTITY_HEADING(func_331());
		}
	}
...
int func_428(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_432(iVar2, iVar6) != 0)
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			if (HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_432(iVar2, iVar6)))
			{
				if (func_431(func_432(iVar2, iVar6)))
				{
					iVar7 = GET_WEAPON_COMPONENT_TYPE_MODEL(func_432(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_432(iVar2, iVar6) != 0)
	{
		if (!IS_ENTITY_DEAD(iParam0, 0))
		{
			if (HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_432(iVar2, iVar6)))
			{
				GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_432(iVar2, iVar6));
...
void func_435(int iParam0)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			Global_111560.f_2358.f_539.f_1730[iVar1 /*4*/][iVar0] = _0xA13E93403F26C812(iVar1);
			iVar1++;
		}
	}
}
...
void func_436(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_438(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_437(Var7.f_1)) && iVar9 < 51)
			{
...
void func_439(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			if (func_574(Local_94.f_28[0]))
			{
				if (_0xEE778F8C7E1142E2(0) == 4)
				{
					SET_GAMEPLAY_ENTITY_HINT(Local_94.f_28[0], 0f, 0f, 0.8f, 1, -1, 3000, 2000, 0);
					_0x5D7B620DAE436138(0f);
				}
				else
				{
					SET_GAMEPLAY_ENTITY_HINT(Local_94.f_28[0], 0.5f, 0f, 0.8f, 1, -1, 3000, 2000, 0);
		...
		case 1:
			if (HAS_ANIM_DICT_LOADED(sLocal_257) && !func_336())
			{
				uVar0 = 16;
				func_41(&uVar0, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
				func_41(&uVar0, 5, Local_94.f_28[0], "BARRY", 0, 1);
				if (func_40(&uVar0, "BARY1AU", "BARY1_LEADIN", 7, 0, 0, 0))
				{
					TASK_PLAY_ANIM(Local_94.f_28[0], sLocal_257, "leadin", 8f, -4f, -1, 2, 0, 0, 0, 0);
					TASK_LOOK_AT_ENTITY(Local_94.f_28[0], TASK_LOOK_AT_ENTITY(), -1, 2048, 4);
					*iParam0 = 2;
					iLocal_95 = GET_GAME_TIMER() + 30000;
				}
			}
			break;
		...
		case 2:
			if (func_574(Local_94.f_28[0]))
			{
				if (!func_336() || GET_GAME_TIMER() > iLocal_95)
				{
					*iParam0 = 4;
				}
			}
...
void func_443()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_339(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_446(var uParam0)
{
	...
	{
		vVar0 = { GET_PED_BONE_COORDS(uParam0->f_2, 31086, vLocal_516) };
	...
	if (func_475(uParam0) && bLocal_477 == 1)
	{
		...
		TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_64(uParam0);
		func_66(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	switch (uParam0->f_1)
	{
		case 1:
			if (GET_GAME_TIMER() > uParam0->f_7)
			{
				...
				uParam0->f_1 = 2;
				uParam0->f_15 = 0f;
				SET_ENTITY_ALPHA(uParam0->f_2, floor(uParam0->f_15), false);
			}
			break;
		...
		case 2:
			...
			SET_PED_CAN_BE_TARGETTED(uParam0->f_2, false);
			func_361(uParam0->f_2);
			TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_268, 8f, -8f, -1, 1, 0, 0, 0, 0);
			START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_teleport", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_491, 0, 0, 0);
			uParam0->f_7 = GET_GAME_TIMER() + 450;
			uParam0->f_1 = 3;
			SET_PED_NAME_DEBUG(uParam0->f_2, "TELEPORT ST");
			PLAY_SOUND_FROM_ENTITY(-1, "SPAWN", uParam0->f_2, "BARRY_01_SOUNDSET", false, 0);
			func_6(&(uParam0->f_3));
			break;
		...
		case 4:
			...
			func_6(&(uParam0->f_3));
			func_66(&(uParam0->f_17));
			START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_alien_teleport", START_PARTICLE_FX_NON_LOOPED_AT_COORD(uParam0->f_2, true), START_PARTICLE_FX_NON_LOOPED_AT_COORD(uParam0->f_2, 2), fLocal_491, 0, 0, 0);
			PLAY_SOUND_FROM_ENTITY(-1, "SPAWN", uParam0->f_2, "BARRY_01_SOUNDSET", false, 0);
			uParam0->f_7 = GET_GAME_TIMER() + 450;
			uParam0->f_1 = 5;
		...
		case 6:
			...
			if (func_352(&vVar0))
			{
				...
				uParam0->f_7 = (GET_GAME_TIMER() + GET_GAME_TIMER(1250, 2000));
				uParam0->f_14 = (fLocal_509 + (GET_RANDOM_FLOAT_IN_RANGE(fLocal_513, fLocal_514) * fLocal_509));
				if (iLocal_116 == 1)
				{
				}
		...
		case 9:
			...
			if (!uParam0->f_32)
			{
				...
				{
					TASK_GO_TO_ENTITY(uParam0->f_2, TASK_GO_TO_ENTITY(), 20000, 0.5f, 2f, 1073741824, 0);
				}
			}
			if (!func_9())
			{
		...
		case 12:
			...
			if (IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), sLocal_256, sLocal_264, 3))
			{
			}
			else if (GET_GAME_TIMER() > uParam0->f_7)
			{
				...
				if (HAS_PED_GOT_WEAPON(HAS_PED_GOT_WEAPON(), iLocal_127, 0))
				{
					if (GET_AMMO_IN_PED_WEAPON(GET_AMMO_IN_PED_WEAPON(), iLocal_127) > 0)
					{
						if (GET_AMMO_IN_CLIP(GET_AMMO_IN_CLIP(), iLocal_127, &iVar2))
						{
							if (iVar2 == 0)
							{
								_PED_SKIP_NEXT_RELOADING(_PED_SKIP_NEXT_RELOADING());
		...
		case 13:
			...
			if (bLocal_477 == 1)
			{
				...
				{
					TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 4f, -4f, -1, 1, 0, 0, 0, 0);
				}
				return;
			}
			uParam0->f_1 = 14;
			uParam0->f_7 = (GET_GAME_TIMER() + GET_GAME_TIMER((iLocal_480 - 1500), (iLocal_480 - 500)));
			break;
		
		case 14:
			SET_PED_NAME_DEBUG(uParam0->f_2, "WATCH END");
			if (GET_GAME_TIMER() > uParam0->f_7 && !GET_GAME_TIMER(GET_GAME_TIMER(), sLocal_256, sLocal_264, 3))
			{
				uParam0->f_1 = 9;
			}
			break;
		...
		case 17:
			SET_ENTITY_COORDS(uParam0->f_5, SET_ENTITY_COORDS(uParam0->f_4, true), 1, false, 0, 1);
		...
		case 18:
			if (!IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				uParam0->f_7 = (GET_GAME_TIMER() + iLocal_508);
				func_65(&(uParam0->f_21));
				func_65(&(uParam0->f_22));
				func_65(&(uParam0->f_23));
				func_65(&(uParam0->f_24));
				uParam0->f_12 = 0f;
				uParam0->f_22 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_impact", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, (fLocal_489 / 3f), 0, 0, 0);
				uParam0->f_23 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_beam", uParam0->f_4, 0f, 0f, 0f, vLocal_517, fLocal_510, 0, 0, 0);
				SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST(uParam0->f_23, uParam0->f_12);
				TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			{
				if (((IS_PED_FALLING(uParam0->f_2) || IS_PED_FALLING(uParam0->f_2)) || IS_PED_FALLING(uParam0->f_2)) || IS_PED_FALLING(uParam0->f_2))
				{
					return;
				}
			}
			if (GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
			{
				TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) == 1)
			{
				SET_ENTITY_HEADING(uParam0->f_4, SET_ENTITY_HEADING(uParam0->f_2));
				if (!DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_22))
				{
					uParam0->f_22 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_490, 0, 0, 0);
				}
				if (iLocal_116 == 1)
				{
				}
		...
		case 7:
			if (func_447(uParam0) || GET_GAME_TIMER() > uParam0->f_7)
			{
				vVar0 = { GET_ENTITY_COORDS(uParam0->f_2, true) };
				if (GET_GROUND_Z_FOR_3D_COORD(vVar0, &uVar1, 0, 0))
				{
					vVar0.z = uVar1;
				}
				START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_disintegrate", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_492, 0, 0, 0);
				PLAY_SOUND_FROM_COORD(-1, "DESPAWN", vVar0, "BARRY_01_SOUNDSET", false, 0, 0);
				if (iLocal_116 == 1)
				{
				}
				uParam0->f_1 = 8;
...
int func_447(var uParam0)
{
	...
	if (!func_448(GET_ENTITY_VELOCITY(uParam0->f_2), 0f, 0f, 0f, 0.125f, 0))
	{
		if (iLocal_116 == 1)
		{
		}
	...
	if (IS_PED_RAGDOLL(uParam0->f_2) || IS_PED_RAGDOLL(uParam0->f_2))
	{
		return 0;
	}
	return 1;
...
void func_449(var uParam0)
{
	...
	vVar3 = { GET_ENTITY_COORDS(uParam0->f_4, true) };
	vVar4 = { vVar3 + GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((uParam0->f_12 + 3f)) };
	if (uParam0->f_26 == 0)
	{
		uParam0->f_26 = START_SHAPE_TEST_LOS_PROBE(vVar3, vVar4, 511, uParam0->f_2, 7);
	}
	else
	{
		iVar1 = GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar5, &uVar6, &uVar7);
		if (iVar1 == 0)
		{
			uParam0->f_26 = 0;
		}
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				SET_ENTITY_RENDER_SCORCHED(SET_ENTITY_RENDER_SCORCHED(), 1);
				uParam0->f_27 = { _0x21C235BC64831E5A(vVar5, vVar3, vVar4, 0) };
				...
				if (GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, vVar2, true) <= 0.7f)
				{
					fLocal_111 = 0f;
					if (ABSF((uParam0->f_27.f_2 - vVar2.z)) < 1f)
					{
						...
						{
							SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vVar3, vVar4, 0, 1, joaat("weapon_pistol"), 0, 0, 1, -1082130432);
						}
						if (iLocal_503 == 1)
						{
							APPLY_FORCE_TO_ENTITY(APPLY_FORCE_TO_ENTITY(), 1, Vector(fLocal_515, fLocal_515, fLocal_515) * APPLY_FORCE_TO_ENTITY(uParam0->f_4), 0f, 0f, 0f, 0, 0, 1, 1, 0, 1);
						}
						if (iLocal_504 == 0)
						{
							if (GET_PED_ARMOUR(GET_PED_ARMOUR()) > 0)
							{
						...
						if (GET_GAME_TIMER() > uParam0->f_8)
						{
							...
							{
								case 0:
									APPLY_PED_BLOOD_SPECIFIC(APPLY_PED_BLOOD_SPECIFIC(), iVar0, 0.657f, 0.566f, 126.36f, 0.07f, 1, 0f, "cs_trev1_blood");
									break;
								
								case 1:
									APPLY_PED_BLOOD_SPECIFIC(APPLY_PED_BLOOD_SPECIFIC(), iVar0, 0.582f, 0.383f, 111.36f, 0.05f, 3, 0f, "cs_trev1_blood");
									break;
								
								case 2:
									APPLY_PED_BLOOD_SPECIFIC(APPLY_PED_BLOOD_SPECIFIC(), iVar0, 0.709f, 0.396f, 126.36f, 0f, 3, 0f, "cs_trev1_blood");
									break;
								
								default:
									APPLY_PED_BLOOD_SPECIFIC(APPLY_PED_BLOOD_SPECIFIC(), iVar0, 0.582f, 0.383f, 200.36f, 0.1f, 2, 0f, "cs_trev1_blood");
									break;
							}
							if ((GET_ENTITY_HEALTH(GET_ENTITY_HEALTH()) - iLocal_505) <= 100)
							{
								func_68();
								func_60(1);
							...
							{
								APPLY_DAMAGE_TO_PED(APPLY_DAMAGE_TO_PED(), iLocal_505, 0, 0);
							}
							uParam0->f_8 = (GET_GAME_TIMER() + round((IntToFloat(iLocal_506) * 1.25f)));
							SET_PAD_SHAKE(0, (iLocal_506 / 2), 255);
							SET_PAD_SHAKE(0, (iLocal_506 / 2), 255);
						}
					}
				}
	...
	{
		SET_ENTITY_COORDS(uParam0->f_5, SET_ENTITY_COORDS(uParam0->f_4, true) + SET_ENTITY_COORDS(uParam0->f_4) * Vector(uParam0->f_12, uParam0->f_12, uParam0->f_12), 1, false, 0, 1);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_23))
	{
		SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST(uParam0->f_23, uParam0->f_12);
	...
	{
		uParam0->f_24 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_489, 0, 0, 0);
	}
}

void func_450(vector3 vParam0, vector3 vParam1, int iParam2)
{
	SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(), 0f);
	...
	if (iParam2 == 1)
	{
		APPLY_DAMAGE_TO_PED(APPLY_DAMAGE_TO_PED(), 100000, 1, 0);
		EXPLODE_PED_HEAD(EXPLODE_PED_HEAD(), joaat("weapon_sniperrifle"));
	}
}
...
void func_451()
{
	...
	{
		iLocal_282 = (GET_GAME_TIMER() + GET_GAME_TIMER(4000, 7000));
	}
}
...
void func_453(var uParam0)
{
	...
	vVar1 = { func_457(_GET_GAMEPLAY_CAM_ROT(2)) };
	vVar2 = { vVar0 + vVar1 * FtoV(_0xD0082607100D7193()) };
	fVar5 = (fLocal_489 * 1.25f);
	if (func_456(&vVar3, GET_ENTITY_COORDS(uParam0->f_4, true), GET_ENTITY_COORDS(uParam0->f_5, true), vVar1, vVar2))
	{
		if (IS_SPHERE_VISIBLE(vVar3, 0.5f))
		{
			iVar6 = func_454(vVar1, vVar0, GET_ENTITY_COORDS(uParam0->f_4, true));
			iVar7 = func_454(vVar1, vVar0, GET_ENTITY_COORDS(uParam0->f_5, true));
			if (iVar6 > 0 && iVar7 < 0)
			{
				vVar3 = { vVar3 - GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * Vector(fLocal_518, fLocal_518, fLocal_518) };
			}
			else if (iVar6 < 0 && iVar7 > 0)
			{
				vVar3 = { vVar3 + GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((fLocal_518 * 4.5f)) };
			}
			if (!DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_25))
			{
				uParam0->f_25 = START_PARTICLE_FX_LOOPED_AT_COORD("scr_alien_impact", vVar3, 0f, 0f, 0f, fVar5, 0, 0, 0, false);
			}
...
void func_458(int iParam0, vector3 vParam1)
{
	...
	func_459(GET_ENTITY_COORDS(iParam0, true), vParam1, &fVar0, &fVar1, 1);
...
void func_461(var uParam0)
{
	...
	else if (GET_SCRIPT_TASK_STATUS(uParam0->f_2, -982327190) != 1)
	{
		...
		uParam0->f_7 = (GET_GAME_TIMER() + iLocal_507 * 2);
	}
	if (!func_9())
	{
		return;
	...
	if (uParam0->f_26 == 0)
	{
		vVar4 = { GET_PED_BONE_COORDS(GET_PED_BONE_COORDS(), 31086, 0f, 0f, 0f) };
		uParam0->f_26 = START_SHAPE_TEST_LOS_PROBE(vVar3, vVar4, 511, START_SHAPE_TEST_LOS_PROBE(), 7);
		if (GET_GAME_TIMER() > uParam0->f_7 && uParam0->f_32)
		{
			func_66(&(uParam0->f_17));
			uParam0->f_17 = GET_SOUND_ID();
			PLAY_SOUND_FROM_ENTITY(uParam0->f_17, "MIND_CONTROL", uParam0->f_2, "BARRY_01_SOUNDSET", false, 0);
			uParam0->f_1 = 17;
		}
	}
	else
	{
		iVar1 = GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar4, &uVar5, &uVar6);
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				TASK_PLAY_ANIM(0, sLocal_256, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(iVar2);
				...
				uParam0->f_7 = (GET_GAME_TIMER() + iLocal_507);
				func_66(&(uParam0->f_17));
				uParam0->f_17 = GET_SOUND_ID();
				PLAY_SOUND_FROM_ENTITY(uParam0->f_17, "MIND_CONTROL", uParam0->f_2, "BARRY_01_SOUNDSET", false, 0);
			}
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_463(iParam3), 0);
}
...
void func_464(var uParam0)
{
	...
	iLocal_481 = (GET_GAME_TIMER() + iLocal_482);
	bLocal_477 = true;
	_0xCCD078C2665D2973(1);
	SET_PED_NAME_DEBUG(uParam0->f_2, "SUMMON");
	func_442();
	iVar0 = func_467(GET_DISABLED_CONTROL_NORMAL(0, 30));
	...
	{
		START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_teleport", START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(), 0f, 0f, 0f, 0f, 0f, 0f, fLocal_491, 0, 0, 0);
		uParam0->f_19 = GET_GAME_TIMER() + 2000;
	}
	if (uParam0->f_18 > iLocal_483 || GET_SCRIPT_TASK_STATUS(uParam0->f_2, 242628503) > 1)
	{
		if (IS_ENTITY_PLAYING_ANIM(uParam0->f_2, sLocal_256, sLocal_261, 3) || IS_ENTITY_PLAYING_ANIM(uParam0->f_2, sLocal_256, sLocal_259, 3))
		{
			TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_263, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		if (IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), sLocal_256, sLocal_262, 3))
		{
			CLEAR_PED_TASKS(CLEAR_PED_TASKS());
			TASK_PLAY_ANIM(TASK_PLAY_ANIM(), sLocal_256, sLocal_264, 8f, -4f, -1, 0, 0, 0, 0, 0);
			_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
		}
		else if (IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), sLocal_256, sLocal_260, 3))
		{
			CLEAR_PED_TASKS(CLEAR_PED_TASKS());
			TASK_PLAY_ANIM(TASK_PLAY_ANIM(), sLocal_256, sLocal_264, 8f, -4f, -1, 0, 0, 0, 0, 0);
			_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
	...
	if (GET_GAME_TIMER() > uParam0->f_7)
	{
		TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_265, 8f, -8f, -1, 0, 0, 0, 0, 0);
		func_66(&(uParam0->f_17));
		func_465();
	}
}
...
void func_468(var uParam0)
{
	...
	if (!func_471(uParam0->f_2, PLAYER_PED_ID(), 1126825984, 0))
	{
		return;
	}
	if (!HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uParam0->f_2, HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT()))
	{
		return;
	}
	func_361(uParam0->f_2);
	OPEN_SEQUENCE_TASK(&iVar0);
	TASK_PLAY_ANIM(0, sLocal_256, sLocal_259, 8f, -8f, -1, 0, 0, 0, 0, 0);
	TASK_PLAY_ANIM(0, sLocal_256, sLocal_261, 8f, -8f, -1, 1, 0, 0, 0, 0);
	CLOSE_SEQUENCE_TASK(iVar0);
	TASK_PERFORM_SEQUENCE(uParam0->f_2, iVar0);
	CLEAR_SEQUENCE_TASK(&iVar0);
	_0x2208438012482A1A(uParam0->f_2, 0, 0);
	func_470(PLAYER_PED_ID(), uParam0->f_2);
	OPEN_SEQUENCE_TASK(&iVar0);
	TASK_PLAY_ANIM(0, sLocal_256, sLocal_260, 8f, -8f, -1, 0, 0, 0, 0, 0);
	TASK_PLAY_ANIM(0, sLocal_256, sLocal_262, 8f, -8f, -1, 1, 0, 0, 0, 0);
	CLOSE_SEQUENCE_TASK(iVar0);
	TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(), iVar0);
	CLEAR_SEQUENCE_TASK(&iVar0);
	_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
	...
	if (iLocal_523 == 0)
	{
		...
		uParam0->f_7 = (GET_GAME_TIMER() + iLocal_484) + 2000;
		SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_484 + 2000, 2000, 2000);
	}
	else
	{
		uParam0->f_7 = (GET_GAME_TIMER() + iLocal_484);
		SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_484, 2000, 2000);
	}
	iLocal_523++;
	uParam0->f_18 = 0;
	SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 0);
	...
	func_66(&(uParam0->f_17));
	uParam0->f_17 = GET_SOUND_ID();
	PLAY_SOUND_FROM_ENTITY(uParam0->f_17, "PLAYER_BEAMED_UP", uParam0->f_2, "BARRY_01_SOUNDSET", false, 0);
	START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_teleport", START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(), 0f, 0f, 0f, 0f, 0f, 0f, fLocal_491, 0, 0, 0);
	uParam0->f_19 = GET_GAME_TIMER() + 2000;
}
...
void func_470(int iParam0, int iParam1)
{
	...
	fVar0 = func_362(GET_ENTITY_COORDS(iParam0, true), GET_ENTITY_COORDS(iParam1, true), 1);
	SET_ENTITY_HEADING(iParam0, fVar0);
}
...
int func_471(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_424(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_424(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_472(var uParam0)
{
	...
	return ((iLocal_478 == 1 && GET_GAME_TIMER() > iLocal_481) && uParam0->f_30 == iLocal_479);
}
...
int func_477(var uParam0)
{
	if (!func_481(uParam0))
	{
		uParam0->f_10 = func_360(uParam0->f_2, PLAYER_PED_ID(), 0);
		if (IS_ENTITY_DEAD(uParam0->f_2, 0) || IS_ENTITY_DEAD(uParam0->f_2))
		{
			if (func_67(uParam0))
			{
				iLocal_476 = 0;
			...
			if (uParam0->f_1 == 11)
			{
				if (GET_SCRIPT_TASK_STATUS(GET_SCRIPT_TASK_STATUS(), 242628503) == 1)
				{
					CLEAR_PED_TASKS(CLEAR_PED_TASKS());
				}
				if (IS_GAMEPLAY_HINT_ACTIVE())
			...
			func_480("ALIEN_DEATH", "ALIENS", GET_ENTITY_COORDS(uParam0->f_2, true), 10);
			func_64(uParam0);
			func_66(&(uParam0->f_17));
			func_14(&(uParam0->f_4));
			func_14(&(uParam0->f_5));
			...
			if (iLocal_521 == 0)
			{
				iLocal_522 = GET_GAME_TIMER() + 10000;
			}
			iLocal_521++;
...
void func_479()
{
	...
	{
		iLocal_280 = (GET_GAME_TIMER() + GET_GAME_TIMER(10000, 20000));
		if ((iLocal_281 - GET_GAME_TIMER()) < 2500)
		{
			iLocal_281 = (GET_GAME_TIMER() + GET_GAME_TIMER(3000, 5000));
		}
	}
}
...
{
	_PLAY_AMBIENT_SPEECH_AT_COORDS(sParam0, sParam1, vParam2, func_463(iParam3));
}
...
{
	if (((!func_502(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_486(0)) || func_501(1))
			{
			}
			else
			{
...
int func_508(int iParam0, int iParam1)
{
	...
	{
		wait(0);
		if (GET_GAME_TIMER() > iVar0 && !GET_GAME_TIMER(iParam0))
		{
			return 0;
		}
	}
...
void func_509()
{
	...
	func_526();
	func_525();
	SPECIAL_ABILITY_LOCK(func_33(0));
	...
	if (func_522() == 1)
	{
		...
		if (func_574(PLAYER_PED_ID()))
		{
			if (IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), sLocal_256, sLocal_262, 3))
			{
				STOP_ANIM_TASK(STOP_ANIM_TASK(), sLocal_256, sLocal_262, -8f);
			}
			if (IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), sLocal_256, sLocal_260, 3))
			{
				STOP_ANIM_TASK(STOP_ANIM_TASK(), sLocal_256, sLocal_260, -8f);
			}
			SET_ENTITY_VISIBLE(SET_ENTITY_VISIBLE(), true, 0);
			func_435(PLAYER_PED_ID());
			REMOVE_ALL_PED_WEAPONS(REMOVE_ALL_PED_WEAPONS(), 1);
...
int func_537(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_87() == 0)
		{
			return IS_BIT_SET(func_148(func_535(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_543(bool bParam0)
{
	...
	if (!func_558())
	{
		...
		{
			func_232(iVar0, 1, 0);
			func_544(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_545(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_551())
	{
		...
		{
			iVar2 = func_546(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
void func_564(int iParam0, bool bParam1)
{
	...
	iVar0 = func_32(iParam0);
	if (func_31(iVar0) && !IS_PED_INJURED(iParam0))
	{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar15)
			{
				...
				{
					if (!_IS_DLC_DATA_EMPTY(Var9) && !func_437(Var9.f_1))
					{
						if (iVar7 == 0)
						{
...
bool func_571(int iParam0)
{
	...
	if (iParam0 == -61829581)
	{
		if (NETWORK_IS_GAME_IN_PROGRESS() && func_573())
		{
			return 1;
		}
		else
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_railgun"):
			if (!func_297() || NETWORK_IS_GAME_IN_PROGRESS())
			{
				return 0;
			}
			break;
	...
	while (iVar0 < GET_NUM_DLC_WEAPONS())
	{
		if (GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (_IS_DLC_DATA_EMPTY(Var1) || func_437(Var1.f_1))
				{
					return 0;
				}
			}
