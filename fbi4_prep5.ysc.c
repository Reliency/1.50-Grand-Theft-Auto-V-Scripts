...
int func_95(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_38(PLAYER_PED_ID(), vLocal_200, 354.7487f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_100()
{
	...
	switch (iLocal_82)
	{
		...
		case 1:
			func_106();
			if (func_105(PLAYER_PED_ID(), vLocal_200, 2f) && func_104(28))
			{
				if (!iLocal_196)
				{
					CLEAR_PLAYER_WANTED_LEVEL(CLEAR_PLAYER_WANTED_LEVEL());
			...
			else
			{
				...
				else
				{
					...
					if (!func_105(PLAYER_PED_ID(), vLocal_200, 75f))
					{
						if (!iLocal_195)
						{
							func_22(&iLocal_197);
					...
					else if (func_105(PLAYER_PED_ID(), vLocal_200, 12f))
					{
						if (iLocal_195)
						{
							func_22(&iLocal_197);
...
int func_123(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_150(iVar0, bParam1, uParam2) && !func_149(PLAYER_ID())) && !func_133(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_131(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_129(iParam0)) && !bVar1) && !(func_128(IS_BIG_VEHICLE(iParam0)) && func_125(IS_BIG_VEHICLE())))
	{
...
int func_135(int iParam0)
{
	...
	if (func_136(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_150(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_131(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_172(iParam0, 0, 0)) || func_172(iParam0, 1, 0)) || func_172(iParam0, 2, 0)) || func_171(iParam0) != 145) || func_170(iParam0)) || func_169(iParam0)) || func_124(iParam0)) || func_168(iParam0)) || !func_158(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_169(iParam0))
		{
		}
...
int func_177(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_146(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_180(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_180(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_179(iParam0);
	if (func_178(*iParam0))
	{
...
void func_183(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_184(iParam0, iParam1))
				{
	...
	if (func_212(uParam0))
	{
		...
		if (func_211(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_198(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_198(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_199(iParam0, uVar1[iVar3], 1) && func_97(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_194(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_200(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_154(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_154(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_203(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_202())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_154(iVar2 + 1)))
				{
...
void func_223()
{
	if (!bLocal_28 && iLocal_81 != 3)
	{
		if (iLocal_81 > 0)
		{
			...
			if (!bLocal_193)
			{
				if (!func_105(PLAYER_PED_ID(), vLocal_200, 150f))
				{
					func_230(2);
				}
				else if (!func_105(PLAYER_PED_ID(), vLocal_200, 75f))
				{
					if (!bLocal_201)
					{
						CLEAR_PRINTS();
...
void func_242(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_244() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_244() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_243(iParam0));
...
bool func_248(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_244() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_295(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
