...
void func_4()
{
	...
	while (iVar1 <= (16 - 1))
	{
		if (Local_22[iVar1] != -1)
		{
			if ((!IS_BIT_SET(iLocal_39, iVar1) && iVar0 >= Local_22[iVar1]) && iVar0 < Local_22.f_17[iVar1])
			{
				func_5();
				SET_BIT(&iLocal_39, iVar1);
			}
		}
		iVar1++;
	}
...
void func_8(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_13(IS_PED_INJURED())) && !func_10(IS_PED_INJURED(), 0)) && !func_9()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_13(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_18(bool bParam0)
{
	...
	{
		SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 689.1f, 586.5f, 130.5f, 1, false, 0, 1);
	...
	while (IS_ENTITY_WAITING_FOR_WORLD_COLLISION(IS_ENTITY_WAITING_FOR_WORLD_COLLISION()))
	{
		wait(0);
	}
...
int func_30(char* sParam0, var uParam1, int iParam2)
{
	...
	if (*uParam1 == 0)
	{
		*uParam1 = 0x67D02A194A2FC2BD(sParam0);
	}
	...
	{
		wait(0);
		if (GET_GAME_TIMER() > iVar0 && !GET_GAME_TIMER(*uParam1))
		{
			return 0;
		}
	}
...
void func_47(var uParam0)
{
	...
	{
		if (DOES_ENTITY_EXIST(uParam0->f_17[iVar0]) && !DOES_ENTITY_EXIST(uParam0->f_17[iVar0], 0))
		{
