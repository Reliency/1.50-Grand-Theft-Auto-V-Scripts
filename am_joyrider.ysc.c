...
void __EntryFunction__()
{
	...
	iLocal_43 = 64;
	iLocal_101 = 20;
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_71(NETWORK_IS_GAME_IN_PROGRESS(), 0, 1))
	{
	...
	while (true)
	{
		...
		switch (func_43(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				...
				{
					func_41();
					vLocal_95[PARTICIPANT_ID_TO_INT() /*3*/] = 1;
				}
				else if (func_42() == 4)
				{
					vLocal_95[PARTICIPANT_ID_TO_INT() /*3*/] = 3;
				}
				break;
			...
			case 3:
				...
				{
					vLocal_95[PARTICIPANT_ID_TO_INT() /*3*/] = 4;
				}
				break;
...
int func_2()
{
	if (Local_93.f_9 == 0)
	{
		...
		else
		{
			...
			if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(Local_93.f_3), IS_PED_IN_VEHICLE(Local_93.f_2), 0))
			{
				return 1;
			}
		}
...
void func_7()
{
	...
	if (NETWORK_IS_PARTICIPANT_ACTIVE(NETWORK_IS_PARTICIPANT_ACTIVE(iLocal_103)))
	{
		iVar1 = NETWORK_GET_PLAYER_INDEX(NETWORK_GET_PLAYER_INDEX(iLocal_103));
		...
		if (func_71(iVar1, 1, 1))
		{
			if (IS_BIT_SET(Local_93.f_1, 0))
			{
				if (iVar0 == 1)
				{
					if (IS_ENTITY_AT_ENTITY(iVar2, IS_ENTITY_AT_ENTITY(Local_93.f_2), 250f, 250f, 250f, 0, 1, 0))
					{
	...
	iLocal_103++;
	if (iLocal_103 == _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		iLocal_103 = 0;
		iLocal_104 = 1;
	}
...
int func_9()
{
	...
	if ((!NETWORK_DOES_NETWORK_ID_EXIST(Local_93.f_3) && func_34(Local_93.f_5)) && NETWORK_DOES_NETWORK_ID_EXIST(Local_93.f_2))
	{
		if (func_4(Local_93.f_2))
		{
			...
			{
				SET_PED_RANDOM_COMPONENT_VARIATION(SET_PED_RANDOM_COMPONENT_VARIATION(Local_93.f_3), 0);
				if (func_10())
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(SET_PED_RELATIONSHIP_GROUP_HASH(Local_93.f_3), Global_1574999);
				}
				else
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(SET_PED_RELATIONSHIP_GROUP_HASH(Local_93.f_3), Global_1575002);
				}
				SET_PED_KEEP_TASK(SET_PED_KEEP_TASK(Local_93.f_3), true);
				if (func_10())
				{
					iVar0 = GET_RANDOM_INT_IN_RANGE(0, 10);
					if (iVar0 < 5)
					{
						GIVE_DELAYED_WEAPON_TO_PED(GIVE_DELAYED_WEAPON_TO_PED(Local_93.f_3), joaat("weapon_pistol"), 25000, func_10());
					}
					else if (iVar0 > 6)
					{
						GIVE_DELAYED_WEAPON_TO_PED(GIVE_DELAYED_WEAPON_TO_PED(Local_93.f_3), joaat("weapon_microsmg"), 25000, func_10());
					}
					else
					{
						GIVE_DELAYED_WEAPON_TO_PED(GIVE_DELAYED_WEAPON_TO_PED(Local_93.f_3), joaat("weapon_pumpshotgun"), 25000, func_10());
					}
				}
				iVar0 = GET_RANDOM_INT_IN_RANGE(0, 10);
				if (iVar0 == 0 || iVar0 == 1)
				{
					SET_PED_COMBAT_ABILITY(SET_PED_COMBAT_ABILITY(Local_93.f_3), 0);
				}
				else if ((iVar0 == 2 || iVar0 == 3) || iVar0 == 4)
				{
					SET_PED_COMBAT_ABILITY(SET_PED_COMBAT_ABILITY(Local_93.f_3), 2);
				}
				else
				{
					SET_PED_COMBAT_ABILITY(SET_PED_COMBAT_ABILITY(Local_93.f_3), 1);
				}
				iVar0 = GET_RANDOM_INT_IN_RANGE(0, 4);
				if (iVar0 == 0)
				{
					SET_PED_COMBAT_ATTRIBUTES(SET_PED_COMBAT_ATTRIBUTES(Local_93.f_3), 5, true);
				}
				else if (iVar0 == 1)
				{
					SET_PED_COMBAT_ATTRIBUTES(SET_PED_COMBAT_ATTRIBUTES(Local_93.f_3), 17, true);
				}
				else if (iVar0 == 2)
				{
					SET_PED_COMBAT_ATTRIBUTES(SET_PED_COMBAT_ATTRIBUTES(Local_93.f_3), 13, true);
				}
				if (func_10())
				{
					SET_PED_COMBAT_ATTRIBUTES(SET_PED_COMBAT_ATTRIBUTES(Local_93.f_3), 20, true);
				}
				if (func_10())
				{
					SET_PED_COMBAT_ATTRIBUTES(SET_PED_COMBAT_ATTRIBUTES(Local_93.f_3), 2, true);
				}
				iVar0 = GET_RANDOM_INT_IN_RANGE(0, 4);
				if (iVar0 == 0)
				{
					SET_PED_COMBAT_MOVEMENT(SET_PED_COMBAT_MOVEMENT(Local_93.f_3), 2);
				}
				else if (iVar0 == 1)
				{
					SET_PED_COMBAT_MOVEMENT(SET_PED_COMBAT_MOVEMENT(Local_93.f_3), 1);
				}
				else if (iVar0 == 2)
				{
					SET_PED_COMBAT_MOVEMENT(SET_PED_COMBAT_MOVEMENT(Local_93.f_3), 3);
				}
				_0x49E50BDB8BA4DAB2(_0x49E50BDB8BA4DAB2(Local_93.f_3), 1);
				SET_PED_GET_OUT_UPSIDE_DOWN_VEHICLE(SET_PED_GET_OUT_UPSIDE_DOWN_VEHICLE(Local_93.f_3), 1);
				SET_PED_CONFIG_FLAG(SET_PED_CONFIG_FLAG(Local_93.f_3), 29, true);
				SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(Local_93.f_3), 3);
				SET_ENTITY_HEALTH(SET_ENTITY_HEALTH(Local_93.f_3), round((200f * Global_262145.f_154)), 0);
				SET_VEHICLE_RADIO_LOUD(SET_VEHICLE_RADIO_LOUD(Local_93.f_2), 1);
				_0x25367DE49D64CF16(_0x25367DE49D64CF16(Local_93.f_2), 1);
				func_41();
				TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(Local_93.f_3), iLocal_97);
	...
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_93.f_2))
	{
		if (func_34(Local_93.f_4))
		{
			if (func_16(&vVar0, &fVar1))
			{
				...
				{
					SET_VEHICLE_ENGINE_ON(SET_VEHICLE_ENGINE_ON(Local_93.f_2), true, true, 0);
					SET_VEHICLE_IS_WANTED(SET_VEHICLE_IS_WANTED(Local_93.f_2), 1);
					SET_VEHICLE_IS_STOLEN(SET_VEHICLE_IS_STOLEN(Local_93.f_2), true);
					_DYNAMIC_MIXER_RELATED_FN(_DYNAMIC_MIXER_RELATED_FN(Local_93.f_2), "JOYRIDER_GROUP", 0f);
...
void func_14(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (func_15(PLAYER_ID(), vParam0, iParam2) > -1)
	{
...
bool func_16(var uParam0, float fParam1)
{
	...
	if (!bVar0)
	{
		if (_0xA4822F1CF23F4810(&(Local_93.f_6), uParam0, &uVar2, 0f, 180f, 40f, false, 1, 1))
		{
			...
			{
				if (GET_DISTANCE_BETWEEN_COORDS(-1367.557f, -3220.598f, 12.9448f, Local_93.f_6, true) >= 600f && GET_DISTANCE_BETWEEN_COORDS(750f, -3200f, 6f, Local_93.f_6, true) >= 700f)
				{
					if (GET_DISTANCE_BETWEEN_COORDS(func_33(GET_DISTANCE_BETWEEN_COORDS()), *uParam0, true) <= (250f - 50f))
					{
						if (iLocal_102 <= 5)
						{
...
int func_18(vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	...
	if (iParam2 && !bParam5)
	{
		if (func_71(PLAYER_ID(), 1, 1))
		{
			if (!IS_SCREEN_FADED_OUT())
			{
				...
				if (GET_DISTANCE_BETWEEN_COORDS(func_23(GET_DISTANCE_BETWEEN_COORDS()), vParam0, true) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_71(iVar1, 1, 1))
		{
			if (!func_20(iVar1, 0) && _0x3B39236746714134(_0x3B39236746714134(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER_ID()))
				{
					if ((func_19(iVar1) || !bParam8) && !Global_2424073[iVar1 /*421*/].f_259)
					{
						...
						if (!bParam5)
						{
							...
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_23(iVar1), vParam0, true) <= (fVar2 + fParam1))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_71(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!IS_PED_INJURED(IS_PED_INJURED(iVar1)) && func_19(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && GET_PLAYER_TEAM(GET_PLAYER_TEAM()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(GET_PLAYER_TEAM()) == -1)
						{
							if (((GET_PLAYER_TEAM(GET_PLAYER_TEAM()) == -1 && uParam7) && bParam4) && func_27(iVar1))
							{
							}
							else if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(iVar1)))
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_33(iVar1), vParam0, true) < fParam1)
								{
									return 1;
								}
							}
...
bool func_35()
{
	...
	{
		if (GET_NTH_CLOSEST_VEHICLE_NODE(func_33(GET_NTH_CLOSEST_VEHICLE_NODE()), iLocal_100, &(Local_93.f_6), 4, 3f, 0f))
		{
			SET_BIT(&iLocal_96, 1);
		}
		else
...
void func_39()
{
	switch (vLocal_95[PARTICIPANT_ID_TO_INT() /*3*/].f_2)
	{
		case 0:
			func_41();
			func_40();
			if (Local_93.f_9 > 0)
			{
				vLocal_95[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 1;
			}
			break;
...
void func_40()
{
	...
	if (!IS_BIT_SET(vLocal_95[IS_BIT_SET() /*3*/].f_1, 0))
	{
		if (func_4(Local_93.f_2) && !func_3(Local_93.f_3))
		{
			iVar0 = GET_ENTITY_HEALTH(GET_ENTITY_HEALTH(Local_93.f_2));
			fVar1 = GET_ENTITY_SPEED(GET_ENTITY_SPEED(Local_93.f_2));
			if (iVar0 < 200)
			{
				func_41();
				TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(Local_93.f_3), iLocal_99);
				SET_BIT(&(vLocal_95[SET_BIT() /*3*/].f_1), 0);
			}
			else if (fVar1 < 3f)
			{
				if ((((IS_ENTITY_UPSIDEDOWN(IS_ENTITY_UPSIDEDOWN(Local_93.f_2)) || IS_ENTITY_UPSIDEDOWN(IS_ENTITY_UPSIDEDOWN(Local_93.f_2), 3, 10000)) || IS_ENTITY_UPSIDEDOWN(IS_ENTITY_UPSIDEDOWN(Local_93.f_2), 1, 10000)) || IS_ENTITY_UPSIDEDOWN(IS_ENTITY_UPSIDEDOWN(Local_93.f_2), 0, 10000)) || IS_ENTITY_UPSIDEDOWN(IS_ENTITY_UPSIDEDOWN(Local_93.f_2), 2, 10000))
				{
					func_41();
					TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(Local_93.f_3), iLocal_98);
					SET_BIT(&(vLocal_95[SET_BIT() /*3*/].f_1), 0);
				}
			}
		}
...
void func_41()
{
	if (!IS_BIT_SET(iLocal_96, 0))
	{
		if (func_4(Local_93.f_2))
		{
			...
			TASK_VEHICLE_MISSION_COORS_TARGET(0, TASK_VEHICLE_MISSION_COORS_TARGET(Local_93.f_2), Local_93.f_6, 14, 30f, 786468, 15f, 1f, 0);
			TASK_VEHICLE_DRIVE_WANDER(0, TASK_VEHICLE_DRIVE_WANDER(Local_93.f_2), 30f, 786468);
			CLOSE_SEQUENCE_TASK(iLocal_97);
			OPEN_SEQUENCE_TASK(&iLocal_98);
			TASK_LEAVE_ANY_VEHICLE(0, 0, 1);
			CLOSE_SEQUENCE_TASK(iLocal_98);
			OPEN_SEQUENCE_TASK(&iLocal_99);
			TASK_VEHICLE_MISSION_COORS_TARGET(0, TASK_VEHICLE_MISSION_COORS_TARGET(Local_93.f_2), Local_93.f_6, 5, 30f, 786468, 99999f, 1f, 0);
			TASK_LEAVE_ANY_VEHICLE(0, 0, 1);
...
void func_60()
{
	...
	{
		SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_93.f_4, false);
	}
	if (func_4(Local_93.f_2))
	{
		_0x18EB48CFC41F2EA0(_0x18EB48CFC41F2EA0(Local_93.f_2), 0f);
	}
...
void func_64(struct<21> Param0)
{
	...
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_95, 97);
	if (!func_66())
	{
		func_60();
	}
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			...
			SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_93.f_4, true);
			Local_93.f_5 = func_65(1);
		}
		func_62(9, 1);
		START_AUDIO_SCENE("JOYRIDER_RADIO_SCENE");
		vLocal_95[PARTICIPANT_ID_TO_INT() /*3*/] = 0;
	}
	else
	{
		func_60();
