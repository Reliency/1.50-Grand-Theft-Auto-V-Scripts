...
void func_4()
{
	if (Local_237.f_116 > 0 && !DOES_ENTITY_EXIST(Local_237.f_64))
	{
		if (Local_237.f_8 != -1)
		{
			STOP_SOUND(Local_237.f_8);
			RELEASE_SOUND_ID(Local_237.f_8);
			Local_237.f_8 = -1;
		}
		if (Local_237.f_7 != -1)
		{
			STOP_SOUND(Local_237.f_7);
			RELEASE_SOUND_ID(Local_237.f_7);
			Local_237.f_7 = -1;
		}
		REMOVE_ANIM_DICT(func_7(Local_237.f_10));
		func_6(0);
...
void func_8()
{
	...
	if (IS_ENTITY_PLAYING_ANIM(Local_237.f_64, func_7(Local_237.f_10), "prop_body_loop_outro", 3))
	{
		return;
	}
	if (Local_237.f_8 != -1)
...
{
	if (IS_BIT_SET(Local_237, iParam0))
	{
		CLEAR_BIT(&Local_237, iParam0);
	}
}
...
void func_11(var uParam0, bool bParam1)
{
	...
	bVar1 = true;
	if (ARE_STRINGS_EQUAL(&(uParam0->f_16), &(Var0.f_2)))
	{
	...
	if (bVar1)
	{
		...
		{
			uParam0->f_32 = 1;
			TRIGGER_SCRIPT_EVENT(1, &Var0, 39, iVar2);
		}
	}
}
	...
	if (func_20(&(Local_237.f_11)))
	{
		if (func_18(&(Local_237.f_11), Local_237.f_6, 0))
		{
			if (func_25())
			{
				if (!func_24(6))
				{
					STOP_ANIM_PLAYBACK(Local_237.f_64, 1, 1);
					STOP_ANIM_PLAYBACK(Local_237.f_64, 0, 1);
					func_23(6);
				}
				if (PLAY_ENTITY_ANIM(Local_237.f_64, "prop_body_loop_outro", func_7(Local_237.f_10), 0.125f, false, 0, 0, 0f, 0))
				{
					if (func_22(PLAYER_ID(), Local_237.f_64))
					{
						Local_237.f_8 = GET_SOUND_ID();
						PLAY_SOUND_FROM_COORD(Local_237.f_8, "fortune_bell", PLAY_SOUND_FROM_COORD(Local_237.f_64, true), "dlc_ch_nazar_speaks_sounds", false, 0, 0);
					}
					func_9(6);
					func_6(5);
				}
...
int func_22(int iParam0, int iParam1)
{
	...
	if ((!DOES_ENTITY_EXIST(iParam1) || !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(iParam0))) || DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(iParam0), 0))
	{
		return 0;
	}
	vVar0 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(iParam0), true) };
	fVar1 = vVar0.z;
	if (fVar1 <= -48f)
	{
		return GET_DISTANCE_BETWEEN_COORDS(vVar0, GET_DISTANCE_BETWEEN_COORDS(iParam1, true), true) <= 4f;
	}
	return 0;
}
...
void func_23(int iParam0)
{
	if (!IS_BIT_SET(Local_237, iParam0))
	{
		SET_BIT(&Local_237, iParam0);
	}
}

bool func_24(int iParam0)
{
	return IS_BIT_SET(Local_237, iParam0);
}

bool func_25()
{
	REQUEST_ANIM_DICT(func_7(Local_237.f_10));
	return HAS_ANIM_DICT_LOADED(func_7(Local_237.f_10));
}
...
struct<16> func_31(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 41:
			switch (GET_NEXT_WEATHER_TYPE_HASH_NAME())
			{
				case 1420204096:
...
void func_34()
{
	...
	if (IS_ENTITY_PLAYING_ANIM(Local_237.f_64, func_7(Local_237.f_10), "prop_body_loop_intro", 3))
	{
		fVar0 = GET_ENTITY_ANIM_CURRENT_TIME(Local_237.f_64, func_7(Local_237.f_10), "prop_body_loop_intro");
		if (fVar0 >= 0.96f)
		{
			if (func_36())
			{
...
void func_35()
{
	...
	Var0.f_19 = -1;
	PLAY_ENTITY_SCRIPTED_ANIM(Local_237.f_64, &(Local_237.f_19), &(Local_237.f_41), &Var0, 0.125f, 0.125f);
...
void func_38()
{
	if (func_25())
	{
		if (PLAY_ENTITY_ANIM(Local_237.f_64, "prop_body_loop_intro", func_7(Local_237.f_10), 0.125f, false, 0, 0, 0f, 0))
		{
			if (func_22(PLAYER_ID(), Local_237.f_64))
			{
				Local_237.f_7 = GET_SOUND_ID();
				PLAY_SOUND_FROM_COORD(Local_237.f_7, "fortune_mech_loop", PLAY_SOUND_FROM_COORD(Local_237.f_64, true), "dlc_ch_nazar_speaks_sounds", false, 0, 0);
			}
			func_6(2);
		}
	}
...
void func_40(int iParam0)
{
	...
	if (GET_EVENT_DATA(1, iParam0, &Var0, 6))
	{
		...
		{
			if (DOES_ENTITY_EXIST(Local_237.f_64))
			{
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (NETWORK_IS_PLAYER_ACTIVE(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_13(PLAYER_ID(), 0) && !func_50()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_46(iVar26) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
...
void func_54()
{
	...
	{
		SET_BIT(&Global_2508077, 1);
	}
	else if (Local_237.f_2 == 42)
	{
		SET_BIT(&Global_2508077, 2);
	}
	else if (Local_237.f_2 == 43)
	{
		SET_BIT(&Global_2508077, 3);
	}
...
void func_56(int iParam0)
{
	...
	if (!func_57(iParam0))
	{
		...
		{
			iVar0 = (iVar0 - 32);
			SET_BIT(&(Global_2531497.f_6321), iVar0);
		}
		else
		{
			SET_BIT(&(Global_2531497.f_6320), iVar0);
		}
	}
}
...
void func_59(bool bParam0)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_273.f_389.f_2, 14))
		{
			SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_273.f_389.f_2), 14);
		}
	}
	else if (IS_BIT_SET(Global_1590446[IS_BIT_SET() /*871*/].f_273.f_389.f_2, 14))
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_273.f_389.f_2), 14);
	}
}
...
void func_66()
{
	...
	Var0 = -438538740;
	Var0.f_2 = 1;
	Var0.f_6 = ABSI(ABSI(ABSI(), Local_237.f_13));
	Var1 = { func_31(Local_237.f_2) };
	Var0.f_8 = GET_HASH_KEY(func_67(&Var1));
	if (Local_237.f_2 == 19)
	{
		Var0.f_9 = 1;
	}
	0xF9096193DF1F99D4(&Var0);
}
...
void func_70()
{
	...
	else if (func_71(PLAYER_PED_ID(), 11))
	{
...
int func_71(int iParam0, int iParam1)
{
	...
	if (func_75(iParam0))
	{
		...
		return IS_ENTITY_PLAYING_ANIM(iParam0, &(Var0.f_17), Var0.f_1, 3);
	}
	return 0;
}
...
bool func_78()
{
	...
	if (!func_24(3))
	{
		if (func_71(PLAYER_PED_ID(), Local_237.f_63))
		{
			func_23(3);
		}
	}
	...
	{
		Local_237.f_1 = NETWORK_STOP_SYNCHRONISED_SCENE(func_80());
		fVar0 = func_79(Local_237.f_63);
		if (GET_SYNCHRONIZED_SCENE_PHASE(Local_237.f_1) >= fVar0)
		{
			func_23(4);
		}
	}
...
int func_89()
{
	...
	if (iVar6 >= 10)
	{
		iVar1 = GET_RANDOM_INT_IN_RANGE(0, 19);
	}
	return iVar1;
}
...
void func_90()
{
	...
	Local_237.f_9 = func_91(PLAYER_ID());
	Local_237.f_67.f_4 = 0;
	Local_237.f_67.f_3 = 0;
...
void func_93()
{
	...
	else if (func_95(PLAYER_ID()) == Local_237.f_66 && Local_237.f_66 == 11)
	{
		func_94();
	}
...
int func_96()
{
	...
	if (func_95(PLAYER_ID()) != Local_237.f_66)
	{
		return 0;
	}
	return 1;
...
int func_97(int iParam0)
{
	if (iParam0 != func_92())
	{
		return IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_416, 1);
	}
	return 0;
}
...
int func_98(int iParam0)
{
	if (iParam0 != func_92())
	{
		return IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_416, 0);
	}
	return 0;
}
...
int func_99()
{
	...
	if (IS_BIT_SET(Global_1703069, func_100(11)))
	{
		return 1;
	}
	return 0;
...
bool func_105()
{
	return IS_BIT_SET(Global_1703069, 0);
}
...
int func_106()
{
	...
	if (func_107() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_107()) == 0)
		{
			return 1;
		}
	}
...
void func_120(struct<18> Param0)
{
	...
	func_123(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&uLocal_236, 1);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_203, 33);
	if (!func_122())
	{
		func_118();
	}
...
void func_121()
{
	if (IS_BIT_SET(Global_1703069, func_100(11)))
	{
		CLEAR_BIT(&Global_1703069, func_100(11));
	}
}
