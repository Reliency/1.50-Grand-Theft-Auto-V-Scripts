...
void __EntryFunction__()
{
	...
	if (Var0 == 17)
	{
		iLocal_57 = ADD_SCENARIO_BLOCKING_AREA(vVar1 - Vector(40f, 40f, 40f), vVar1 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", false);
	}
	else if (Var0 == 18)
	{
		iLocal_57 = ADD_SCENARIO_BLOCKING_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_190() && func_189(Var0.f_28[0])) && !IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && IS_ANY_SPEECH_PLAYING(iLocal_56)) && IS_ANY_SPEECH_PLAYING("EXTREME_04_DOM_A", false, -1)) && IS_ANY_SPEECH_PLAYING("EXTREME_04_DOM_B", false, -1)) && IS_ANY_SPEECH_PLAYING("EXTREME_04_DOM_C", false, -1))
			{
				PLAY_SOUND_FROM_ENTITY(iLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_55 == 0 && func_189(PLAYER_PED_ID())) && PLAYER_PED_ID(PLAYER_PED_ID(), vVar1, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
...
void func_146()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_147(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_168(vector3 vParam0, bool bParam1)
{
	...
	SET_BLIP_SCALE(iVar0, func_169(SET_BLIP_SCALE(), 1f, 1f));
...
int func_171(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, true, 0))
		{
			if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
			...
			else if ((!func_172(PLAYER_PED_ID(), -828834893) && func_189(PLAYER_PED_ID(PLAYER_PED_ID(), 0))) && func_147(PLAYER_PED_ID(PLAYER_PED_ID(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK_LEAVE_ANY_VEHICLE(TASK_LEAVE_ANY_VEHICLE(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					if (func_189(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0)))
					{
...
int func_191(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_189(PLAYER_PED_ID()) && func_189(iParam0->f_28[0])) && !func_190()) && (PLAYER_PED_ID() - iParam0->f_60) > iParam6) && func_195(PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
	...
	if (func_189(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_207(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_207(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_217(int iParam0, float fParam1)
{
	...
	if (func_189(PLAYER_PED_ID()) && func_189(iParam0))
	{
		if (func_228(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_225(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_225(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_225(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					...
					if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
					{
						TASK_LOOK_AT_ENTITY(uParam0->f_28[0], TASK_LOOK_AT_ENTITY(), -1, 48, 2);
					}
				}
				else
				{
