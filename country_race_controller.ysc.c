...
void __EntryFunction__()
{
	...
	{
		if (vdist2(func_60(), GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)) < 40000f)
		{
...
void func_23()
{
	if (func_43())
	{
		if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), func_60(), 5f, 5f, 5f, true, true, 0))
		{
			DISABLE_CONTROL_ACTION(0, 74, 1);
			SET_IK_TARGET(iLocal_151, 1, SET_IK_TARGET(), 0, 0f, 0f, 0f, 0, 150, 400);
			if (func_41())
			{
				if (func_38())
				{
					...
					func_33();
					func_32();
					if (((!IS_PLAYER_SWITCH_IN_PROGRESS() && !func_31(1)) && !func_30(0)) && IS_PLAYER_SWITCH_IN_PROGRESS(joaat("appinternet")) == 0)
					{
						if (IS_CONTROL_JUST_PRESSED(2, 51))
						{
							...
							SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), 0), true);
							HIDE_HELP_TEXT_THIS_FRAME();
							iLocal_148 = 1;
						}
					}
...
{
	BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	END_TEXT_COMMAND_DISPLAY_HELP(0, iParam1, bParam2, iParam3);
}
...
void func_33()
{
	if (((((GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 3 && GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 4) && !GET_FOLLOW_VEHICLE_CAM_VIEW_MODE()) && GET_FOLLOW_VEHICLE_CAM_VIEW_MODE(GET_FOLLOW_VEHICLE_CAM_VIEW_MODE())) && func_34(iLocal_151)) && GET_FOLLOW_VEHICLE_CAM_VIEW_MODE(GET_FOLLOW_VEHICLE_CAM_VIEW_MODE()) < 20f)
	{
		if (iLocal_153)
		{
			if (!IS_GAMEPLAY_HINT_ACTIVE())
			{
				SET_GAMEPLAY_ENTITY_HINT(iLocal_151, 0f, 0f, 0f, 1, 2000, 2000, 2000, 0);
				iLocal_153 = 0;
			}
		}
	}
...
int func_43()
{
	if ((!Global_111560.f_25068.f_9 && !Global_111560.f_25068.f_8) && vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), func_60()) < 84100f)
	{
		...
		if (!Global_111560.f_25068.f_9)
		{
			...
			{
				if (!HAS_THIS_ADDITIONAL_TEXT_LOADED("C_RACE", 3) && HAS_THIS_ADDITIONAL_TEXT_LOADED(joaat("mission_stat_watcher")) <= 0)
				{
	...
	{
		if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), func_60()) > 90000f)
		{
...
void func_44(bool bParam0)
{
	if (!DOES_ENTITY_EXIST(iLocal_150) && !DOES_ENTITY_EXIST(iLocal_151))
	{
		...
		if (HAS_MODEL_LOADED(func_50()) && HAS_MODEL_LOADED(joaat("a_m_y_motox_02")))
		{
			...
			SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_150, 1084227584);
			...
			_0x2B6747FAA9DB9D6B(iLocal_150, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(func_50());
			iLocal_151 = CREATE_PED(26, joaat("a_m_y_motox_02"), func_47(), func_46(), 1, true);
			func_45(iLocal_151);
			SET_AMBIENT_VOICE_NAME(iLocal_151, "A_M_Y_RACER_01_WHITE_MINI_01");
			TASK_START_SCENARIO_IN_PLACE(iLocal_151, "WORLD_HUMAN_STAND_IMPATIENT", -1, 1);
...
void func_51()
{
	...
	{
		if ((!IS_PED_FLEEING(iLocal_151) && !IS_PED_FLEEING(iLocal_151, 0)) && !IS_PED_FLEEING(iLocal_151))
		{
			...
			{
				_0xF1C03A5352243A30(iLocal_151);
				TASK_COMBAT_PED(iLocal_151, TASK_COMBAT_PED(), 0, 16);
			}
			fLocal_154 = GET_ENTITY_SPEED(GET_ENTITY_SPEED());
		}
...
int func_52(int iParam0)
{
	...
	if (func_61(iParam0))
	{
		...
		if (GET_ENTITY_HEALTH(iParam0) + 100 < GET_ENTITY_HEALTH(iParam0))
		{
			return 1;
		}
	}
...
int func_54()
{
	...
	{
		if (IS_ENTITY_DEAD(iLocal_151, 0))
		{
			return 1;
		}
		...
		else if (IS_PED_SHOOTING(IS_PED_SHOOTING()))
		{
			return 1;
		}
	}
	...
	{
		if (IS_ENTITY_DEAD(iLocal_150, 0))
		{
			return 1;
		}
		else
		{
			...
			if (HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(), iLocal_150, 0, -1))
			{
				return 1;
			}
		}
...
void func_56()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
		if (vdist2(func_60(), GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true)) > 160000f)
		{
			func_62(0);
		}
	}
...
void func_62(bool bParam0)
{
	...
	if (func_61(iLocal_151))
	{
		...
		{
			TASK_WANDER_STANDARD(iLocal_151, 1193033728, 0);
		}
	}
	...
	if (bParam0)
	{
		CLEAR_AREA(func_60(), 100f, 1, 0, 0, false);
	}
	if (IS_GAMEPLAY_HINT_ACTIVE())
	{
		STOP_GAMEPLAY_HINT(0);
