...
void __EntryFunction__()
{
	...
	sLocal_205 = "";
	iLocal_209 = 8;
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH("appSmuggler")) > 1)
	{
		func_376(0, 1);
	}
	func_366();
	...
	{
		func_364();
		if (!IS_BIT_SET(iLocal_197, 5) && func_363())
		{
			func_361();
			func_338();
		}
		if (!IS_BIT_SET(iLocal_197, 8) && IS_BIT_SET(iLocal_197, 5))
		{
			func_332();
		}
		func_325();
		...
		{
			if (!Global_1676879.f_2897 && IS_SCREEN_FADED_OUT())
			{
				func_1();
				Global_1676739 = 1;
				func_376(0, 1);
...
void func_6()
{
	...
	{
		if (_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_389))
		{
			iVar0 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_389);
			switch (iVar0)
			{
				case 0:
					func_251();
				...
				case 29:
					...
					{
						iLocal_207 = 2;
						_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SHOW_SCREEN", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
					}
					break;
...
int func_12(int iParam0)
{
	...
	if (!func_178(PLAYER_ID(), iParam0, 0))
	{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_92(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		
		case 233:
			return func_85(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		...
		case 158:
			return func_63(iParam1, iParam2, INT_TO_PLAYERINDEX(iParam5), iParam4);
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_138(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
		
		case 233:
			return func_129(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_120(iParam1, iParam3, INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_114(iParam1, iParam3, INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "SHOW_OVERLAY");
	func_183(sParam0);
...
int func_189(int iParam0, int iParam1)
{
	...
	fVar1 = (to_float(func_191(iParam0, iParam1)) * fVar0);
	return round(fVar1);
}
...
bool func_195()
{
	return IS_BIT_SET(iLocal_197, 10);
}
...
int func_237()
{
	...
	if (!bVar0)
	{
		if (!_NETWORK_SHOP_GET_TRANSACTIONS_ENABLED_FOR_CHARACTER(func_137()) || _NETWORK_SHOP_GET_TRANSACTIONS_ENABLED_FOR_CHARACTER())
		{
...
void func_250()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "HIDE_OVERLAY");
	END_SCALEFORM_MOVIE_METHOD();
	func_182(0);
...
void func_252()
{
	if (func_253())
	{
		if (!IS_BIT_SET(iLocal_197, 0))
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "GET_CURRENT_SELECTION");
			iLocal_389 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
...
void func_256()
{
	if (func_196())
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "UPDATE_SELL_COOLDOWN");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_258(Global_2509201.f_26, Global_2509201.f_28));
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_257(Global_2509201.f_28));
		END_SCALEFORM_MOVIE_METHOD();
	}
	else
	{
...
int func_258(int iParam0, var uParam1, int iParam2)
{
	...
	iVar0 = (iParam2 - ABSI(ABSI(ABSI(), iParam0)));
	iVar0 = (iVar0 / 1000);
	return iVar0;
}
...
void func_259()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "UPDATE_STEAL_COOLDOWN");
	iVar0 = 1;
	while (iVar0 <= 8)
	{
		...
		if (func_179(iVar1))
		{
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_258(Global_2509201[iVar2 /*2*/], Global_2509201.f_17[iVar2]));
		}
		else
		{
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
...
void func_260(int iParam0)
{
	...
	iVar3 = round((func_190(func_194(iParam0), iVar0) * 100f));
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "ADD_CARGO");
	...
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(to_float(iVar3));
...
void func_261()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "SET_STATS");
	0x77FE3402004CD1B0(sVar0);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar1);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar2);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fVar9);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar3);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fVar10);
	...
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_201);
...
char* func_272(int iParam0)
{
	...
	if (((func_14(iParam0, 28) || func_14(PLAYER_ID(), 28)) || func_275(iParam0)) && !func_273(iParam0))
	{
...
void func_295()
{
	...
	if (((NETWORK_IS_PLAYER_ACTIVE(iVar0) && func_201(iVar0)) && !func_66(iVar0, 0)) && !func_302())
	{
		if (!func_301())
		{
	...
	if (IS_BIT_SET(iLocal_202, iLocal_198))
	{
...
void func_296()
{
	...
	if (iVar1 != -1 && iVar1 < 31)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "REMOVE_ACTIVE_ORGANISATION");
		0x77FE3402004CD1B0(&(Local_387[iVar1 /*16*/]));
		END_SCALEFORM_MOVIE_METHOD();
		StringCopy(&(Local_387[iVar1 /*16*/]), "", 64);
		CLEAR_BIT(&iLocal_202, iLocal_198);
		func_297(INT_TO_PLAYERINDEX(iLocal_198));
	}
}
...
void func_298(int iParam0, int iParam1)
{
	...
	if (func_15(iParam0))
	{
		...
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "ADD_ACTIVE_ORGANISATION");
		0x77FE3402004CD1B0(func_300(iParam0));
		0x77FE3402004CD1B0(sVar1);
		iVar2 = 0;
		while (iVar2 < iVar3)
		{
			0x77FE3402004CD1B0(&(Var4[iVar2 /*16*/]));
			iVar2++;
		}
		END_SCALEFORM_MOVIE_METHOD();
		sVar1 = func_300(iParam0);
		func_299(iParam0, func_31(iParam0));
		SET_BIT(&iLocal_202, iParam1);
	}
	else
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "ADD_ACTIVE_ORGANISATION");
...
int func_302()
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (!func_15(INT_TO_PLAYERINDEX(iLocal_198)))
			{
				return 1;
			}
			else
			{
				return iLocal_203[iVar0] != func_31(INT_TO_PLAYERINDEX(iLocal_198));
			}
		}
		iVar0++;
	}
...
void func_303()
{
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
		if (iLocal_207 == 1)
		{
			iLocal_207 = 0;
			PLAY_SOUND_FRONTEND(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
		if (iLocal_207 == 0)
		{
			iLocal_207 = 1;
			PLAY_SOUND_FRONTEND(-1, "Show_Source_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
	...
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_306(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (IS_CONTROL_JUST_PRESSED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_306(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_306(2, 189, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 189))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_306(2, 190, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 190))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_306(2, 201, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 201))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_306(2, 202, 1);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_306(2, 204, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 204))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_388, "SET_ANALOG_STICK_INPUT");
			iLocal_390 = iVar0;
			iLocal_391 = iVar1;
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_390);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_391);
			END_SCALEFORM_MOVIE_METHOD();
		}
	}
	func_306(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_392 != 127) || iVar3 != 127) || iLocal_393 != 127)
	{
		...
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_392);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_393);
...
void func_304()
{
	...
	{
		iLocal_207 = 0;
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SHOW_SCREEN", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
		PLAY_SOUND_FRONTEND(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
		return;
	}
	if (func_305())
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_388, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
	}
...
void func_308()
{
	...
	_SET_UI_LAYER(1);
	DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_388, 255, 255, 255, 255, 0);
	func_319();
	func_312(0);
	func_309(1);
	...
	if (!IS_BIT_SET(iLocal_197, 9))
	{
		if (!func_305())
		{
			if (!func_363())
			{
				...
				if ((!func_330(2) && !IS_BIT_SET(Global_1676734, 2)) && IS_BIT_SET(iLocal_197, 13))
				{
					func_329("HAPP_HELP_3", 14000);
					SET_BIT(&Global_1676734, 2);
					func_326(2);
				}
			}
			else
...
void func_332()
{
	...
	iVar2 = 8 + 1;
	if (!IS_BIT_SET(iLocal_197, 7) && !func_337())
	{
		iVar1 = 0;
		while (iVar1 < iVar2)
		{
	...
	if (!IS_BIT_SET(iLocal_197, 7) && !IS_BIT_SET(&Var0))
	{
		func_329(&Var0, iLocal_200);
		SET_BIT(&iLocal_197, 7);
	}
	else if (IS_BIT_SET(iLocal_197, 7))
	{
...
int func_336(int iParam0)
{
	...
	iVar0 = iParam0;
	if (!IS_BIT_SET(iLocal_197, 9) && iParam0 != 2)
	{
		return 0;
	}
	switch (iParam0)
	{
		case 0:
			if ((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && IS_BIT_SET(iLocal_197, 11))
			{
				return 1;
			}
			break;
		...
		case 1:
			if ((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && IS_BIT_SET(iLocal_197, 12))
			{
				return 1;
			}
			break;
		...
		case 2:
			if ((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && IS_BIT_SET(iLocal_197, 13))
			{
				return 1;
			}
			break;
		...
		case 3:
			if (((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && IS_BIT_SET(iLocal_197, 9)) && iLocal_207 == 0)
			{
				return 1;
			}
			break;
		...
		case 4:
			if ((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && iLocal_207 == 1)
			{
				return 1;
			}
			break;
		...
		case 5:
			if (((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && iLocal_207 == 1) && (IS_BIT_SET(Global_1676734, 4) || func_330(4)))
			{
				return 1;
			}
			break;
		...
		case 6:
			if ((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && iLocal_207 == 2)
			{
				return 1;
			}
			break;
		...
		case 7:
			if (((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && iLocal_207 == 2) && (IS_BIT_SET(Global_1676734, 6) || func_330(6)))
			{
				return 1;
			}
			break;
		...
		case 8:
			if (((((!func_330(iParam0) && !IS_BIT_SET(Global_1676734, iVar0)) && IS_BIT_SET(iLocal_197, 14)) && iLocal_207 == 2) && (IS_BIT_SET(Global_1676734, 6) || func_330(6))) && (IS_BIT_SET(Global_1676734, 7) || func_330(7)))
			{
				return 1;
			}
			break;
...
void func_361()
{
	...
	if (!IS_BIT_SET(iLocal_197, 4) && !func_337())
	{
		if (iLocal_207 == 0)
		{
	...
	else if (IS_BIT_SET(iLocal_197, 4))
	{
...
{
	func_364();
	iLocal_388 = 0x67D02A194A2FC2BD("HANGAR_CARGO");
	while (!HAS_SCALEFORM_MOVIE_LOADED(iLocal_388))
	{
		wait(0);
	}
	func_313(1);
...
{
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_388);
	func_372(iParam0);
	func_374(0);
	func_377();
