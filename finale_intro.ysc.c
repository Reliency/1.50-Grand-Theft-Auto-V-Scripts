...
void func_6()
{
	...
	{
		REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), "FRANKLIN", 0, joaat("player_one"), 0);
	}
...
void func_9(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_75(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
...
int func_14(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	bVar1 = false;
	if (func_23(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_21(iParam0)) && !bVar1) && !(func_20(IS_BIG_VEHICLE(iParam0)) && func_16(IS_BIG_VEHICLE())))
	{
...
int func_42(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_23(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_64(iParam0, 0, 0)) || func_64(iParam0, 1, 0)) || func_64(iParam0, 2, 0)) || func_63(iParam0) != 145) || func_62(iParam0)) || func_61(iParam0)) || func_15(iParam0)) || func_60(iParam0)) || !func_50(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_61(iParam0))
		{
		}
...
int func_69(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_38(GET_ENTITY_MODEL(*uParam0), 1) && GET_ENTITY_MODEL(*uParam0, 24) != func_72(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_72(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_71(uParam0);
	if (func_70(*uParam0))
	{
...
int func_76(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	if (iVar2 != 0)
	{
		...
		while (iVar0 < 9)
		{
			if (DOES_ENTITY_EXIST(Global_96030[iVar0]) && DOES_ENTITY_EXIST(Global_96030[iVar0], 0))
			{
				if (GET_ENTITY_MODEL(Global_96030[iVar0]) == iVar2 && Global_96040[iVar0] == iParam0)
				{
					if (fParam3 == -1f || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(Global_96030[iVar0], false), vParam2, true) <= fParam3)
					{
						return 1;
					}
				}
...
void func_81()
{
	...
	{
		if (func_84(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_104(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_106()
{
	...
	while (!HAS_CUTSCENE_LOADED())
	{
		...
		{
			func_107("FRANKLIN", PLAYER_PED_ID(), 0, 2);
		}
		wait(0);
	}
}
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_112(GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_112(GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
		}
	}
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_114(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_122(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_122(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_114(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
