		...
		switch (Global_111560.f_24981.f_2)
		{
					...
					if (!func_247())
					{
						if (func_225(4, 62, 2, -1, 0))
						{
							if (func_222(Local_43.f_4, Local_43.f_5))
							{
								...
								CLEAR_BIT(&(Global_111560.f_24981), 9);
			...
			case 1:
				if (func_192() == 2)
				{
					...
					if (!IS_BIT_SET(Global_111560.f_24981, 8))
					{
						if (!func_247())
						{
							SET_BIT(&(Global_111560.f_24981), 8);
						}
						else
						{
							wait(2000);
					...
					else if (func_247())
					{
						...
						else
						{
							if (IS_BIT_SET(Global_111560.f_24981, 8))
							{
								CLEAR_BIT(&(Global_111560.f_24981), 8);
							}
							wait(2000);
						}
					}
...
void func_28(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1:
		case 2:
			SET_BIT(&(Global_111560.f_24981), func_73(Local_43.f_4));
			if (iParam0 == 1)
			{
				func_72(0);
				iVar0 = 8;
				SET_BIT(&(Global_111560.f_24981), func_71(Local_43.f_4));
			}
			else
			{
				func_72(1);
				iVar0 = 4;
				CLEAR_BIT(&(Global_111560.f_24981), func_71(Local_43.f_4));
			...
			if (func_36())
			{
				if (IS_BIT_SET(Global_111560.f_24981, func_71(Local_43.f_4)))
				{
					iLocal_212 = func_201();
...
void func_30()
{
	...
	iVar0 = (iVar0 - 1);
	if (iVar0 >= 0 && IS_BIT_SET(Global_111560.f_24981, func_71(iVar0)))
	{
		Local_43.f_5 = 1;
	}
	else
...
int func_35()
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!IS_BIT_SET(Global_111560.f_24981, iVar0))
		{
			return iVar0;
		}
		iVar0++;
...
void func_74(int iParam0)
{
	...
	if (!IS_BIT_SET(Global_111560.f_24981, 9))
	{
		if (func_17(Global_111560.f_24981.f_3))
		{
			if (func_249())
			{
				if (func_225(4, 62, 2, -1, 0))
				{
					...
					{
						SET_BIT(&(Global_111560.f_24981), 9);
					}
				}
			}
		}
...
void func_109()
{
	...
	{
		if (func_99(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_111(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_116(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_113(Var7.f_1)) && iVar9 < 51)
			{
...
int func_122(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_145())
		{
			*uParam0 = func_128(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_124(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_126() == 0)
		{
			return IS_BIT_SET(func_102(func_125(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_128(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_144(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_129(iVar0, 0), true);
...
void func_147(int iParam0)
{
	...
	iLocal_213 = start_new_script_with_args(&Var0, &Local_43, 8, 29500);
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_158()) || Global_110607) || Global_30738) || func_164()) || func_163(8, -1)) || func_145()) || func_162()) || func_156()) || func_157()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_158()) || Global_30738) || func_164()) || func_163(8, -1)) || func_156()) || func_145()) || func_162()) || func_157()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_158()) || Global_110607) || Global_30738) || func_164()) || func_163(8, -1)) || func_145()) || func_162()) || func_157()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_163(8, -1)) || func_157()) || func_161()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_158()) || Global_30738) || func_164()) || func_163(8, -1)) || func_162()) || func_156()) || func_157()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_158()) || func_162()) || Global_110607) || Global_30738) || func_164()) || Global_42561) || func_163(8, -1)) || func_156()) || func_161()) || func_157()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_158()) || Global_110607) || Global_30738) || func_164()) || func_163(8, -1)) || func_156()) || func_161()) || func_145()) || func_162()) || func_157())
						{
							return 0;
						}
						break;
...
void func_173(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_31(26, func_32(uParam0->f_4), 0))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				if ((!func_191() && !IS_AMBIENT_SPEECH_PLAYING(IS_AMBIENT_SPEECH_PLAYING())) && !IS_AMBIENT_SPEECH_PLAYING())
				{
...
void func_206(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_208() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_208() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_207(iParam0));
...
bool func_212(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_208() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		...
		{
			if (IS_BIT_SET(iParam0, func_108()) && !IS_BIT_SET(iParam4, 19))
			{
				return 0;
			}
		}
	...
	{
		if (!IS_BIT_SET(iParam0, func_108()))
		{
			return 0;
		}
	}
	...
	if (iParam3 != -1)
	{
		if (func_227(PLAYER_PED_ID(), iParam3, 0))
		{
			return 0;
		}
	}
...
float func_228(var uParam0)
{
	if (func_231(uParam0))
	{
		...
		{
			return (func_229(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_247()
{
	...
	vVar0 = { func_248(GET_PLAYER_INDEX()) };
	fVar1 = Local_43.f_3;
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
...
void func_250()
{
	...
	if (iLocal_219 != 0)
	{
		...
		{
			case 1:
				iLocal_214 = 0x67D02A194A2FC2BD("MIDSIZED_MESSAGE");
				iLocal_219 = 2;
				break;
...
void func_253()
{
	if (Global_111560.f_24981.f_1 == 0)
	{
		...
		{
			CLEAR_BIT(&(Global_111560.f_24981), 0);
			CLEAR_BIT(&(Global_111560.f_24981), 1);
			CLEAR_BIT(&(Global_111560.f_24981), 2);
			CLEAR_BIT(&(Global_111560.f_24981), 3);
			CLEAR_BIT(&(Global_111560.f_24981), 4);
			CLEAR_BIT(&(Global_111560.f_24981), 5);
			CLEAR_BIT(&(Global_111560.f_24981), 6);
			CLEAR_BIT(&(Global_111560.f_24981), 7);
			CLEAR_BIT(&(Global_111560.f_24981), 8);
			CLEAR_BIT(&(Global_111560.f_24981), 9);
			iLocal_212 = func_201();
