...
void __EntryFunction__()
{
	...
	if (!func_279(32))
	{
		...
		if (iLocal_37 == 2)
		{
			SET_BIT(&iLocal_49, 10);
			vLocal_52 = { func_278(25) };
			fLocal_53 = func_277(25);
			if (func_276(&Local_54, 25))
			{
				if (!IS_BIT_SET(iLocal_49, 14))
				{
					SET_BIT(&iLocal_49, 14);
				}
			}
		}
	}
...
void func_1(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			if ((!func_2(func_3(iParam0)) && !Global_110200) && !IS_BIT_SET(iLocal_49, 15))
			{
				SET_BIT(&iLocal_49, 15);
				CLEAR_HELP(1);
			}
		}
		else if ((IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_110200) && !IS_HELP_MESSAGE_BEING_DISPLAYED(iLocal_49, 15))
		{
			SET_BIT(&iLocal_49, 15);
			CLEAR_HELP(1);
		}
...
void func_4(int iParam0)
{
	...
	CLEAR_BIT(&(uLocal_47[func_5(iParam0)]), iVar0);
}
...
void func_7()
{
	if (((IS_BIT_SET(iLocal_49, 0) && !IS_BIT_SET(iLocal_49, 1)) && !IS_BIT_SET(iLocal_49, 14)) && func_13())
	{
...
int func_8()
{
	...
	else if (HAS_SCALEFORM_MOVIE_LOADED(Global_19467) == 1)
	{
		if (func_11())
		{
			if (func_10())
			{
				...
				while ((!_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iVar0) && iVar6 == 0) && _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(Global_19467) == 1)
				{
					wait(0);
				...
				iVar1 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iVar0);
				...
				iVar3 = iVar2;
				if (HAS_SCALEFORM_MOVIE_LOADED(Global_19467) == 0)
				{
					iVar3 = 145;
				}
				if (iVar6 == 1)
...
void func_16(int iParam0)
{
	...
	if (iLocal_40 == 0)
	{
		switch (iLocal_41)
		{
			case 0:
				func_108(1);
				iLocal_74 = 0x67D02A194A2FC2BD("MP_BIG_MESSAGE_FREEMODE");
				func_1(46, 1);
				iLocal_75 = GET_GAME_TIMER() + 3000;
				if (!IS_BIT_SET(iLocal_49, 10))
				{
					func_92();
				}
				func_91(iParam0, 1);
			...
			case 2:
				if (HAS_SCALEFORM_MOVIE_LOADED(iLocal_74) && HAS_SCALEFORM_MOVIE_LOADED())
				{
					if (GET_GAME_TIMER() < iLocal_75)
					{
...
void func_17()
{
	...
	if (!IS_BIT_SET(iLocal_49, 2))
	{
		if (!func_77(0f, 0f, 0f, vLocal_52, 0))
		{
			if (func_76(PLAYER_PED_ID(), vLocal_52, 100f) && !func_75())
			{
				if (func_85(func_74(25)))
				{
					iLocal_51 = func_74(25);
					SET_ENTITY_AS_MISSION_ENTITY(iLocal_51, true, 1);
					if (func_85(iLocal_51))
					{
						if (!DECOR_EXIST_ON(iLocal_51, "GetawayVehicleValid"))
						{
							if (DECOR_SET_BOOL(iLocal_51, "GetawayVehicleValid", 1))
							{
							}
						}
						SET_BIT(&iLocal_49, 0);
			...
			{
				if (!func_76(PLAYER_PED_ID(), vLocal_52, 100f))
				{
				}
			}
		}
	...
	else
	{
		if (!func_77(0f, 0f, 0f, vLocal_52, 0))
		{
			if (!func_76(PLAYER_PED_ID(), vLocal_52, 100f))
			{
				if (func_85(iLocal_51))
				{
					if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_51, 0))
					{
						func_21(iLocal_51, vLocal_52, fLocal_53, 25, 1);
						CLEAR_BIT(&iLocal_49, 2);
						_0x02398B627547189C(iLocal_51, 0);
						func_20(&iLocal_51);
						CLEAR_BIT(&iLocal_49, 0);
					}
					else
					{
						func_68(0);
...
void func_18()
{
	if (IS_BIT_SET(iLocal_49, 2) && IS_BIT_SET(iLocal_49, 0))
	{
		if (func_85(iLocal_51))
		{
			if (func_19(PLAYER_PED_ID(), iLocal_51, 10f, 1))
			{
				if (vdist2(GET_ENTITY_COORDS(iLocal_51, true), vLocal_52) >= 100f)
				{
					func_68(0);
				}
			}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_39(iParam0, 0, 0)) || func_39(iParam0, 1, 0)) || func_39(iParam0, 2, 0)) || func_61(iParam0) != 145) || func_38(iParam0)) || func_37(iParam0)) || func_36(iParam0)) || func_35(iParam0)) || !func_25(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_37(iParam0))
		{
		}
...
var func_41()
{
	...
	func_44(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_43(&uVar0, GET_CLOCK_MONTH());
	func_42(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_47(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_68(bool bParam0)
{
	if (IS_BIT_SET(iLocal_49, 14))
	{
		...
		iLocal_40 = 0;
		iLocal_41 = 0;
		CLEAR_BIT(&iLocal_49, 6);
		CLEAR_BIT(&iLocal_49, 7);
		CLEAR_BIT(&iLocal_49, 0);
		CLEAR_BIT(&iLocal_49, 1);
		CLEAR_BIT(&iLocal_49, 8);
		CLEAR_BIT(&iLocal_49, 12);
		CLEAR_BIT(&iLocal_49, 2);
		CLEAR_BIT(&iLocal_49, 14);
		if (iLocal_37 == 4)
		{
			if (HAS_SCALEFORM_MOVIE_LOADED(iLocal_74))
			{
...
void func_69(int iParam0)
{
	...
	iVar0 = func_6(iParam0);
	SET_BIT(&(uLocal_47[func_5(iParam0)]), iVar0);
}
...
void func_92()
{
	...
	if (iLocal_42 == 0)
	{
		STAT_SET_INT(joaat("fl_co_fb4p3"), Global_111560.f_10011.f_21, 1);
		if (func_101())
		{
...
void func_95()
{
	...
	{
		func_97(13, floor(Global_111560.f_10189.f_3853));
	}
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_76577)
		{
			if (func_96() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
			...
			case 1:
				if (iLocal_42 != 2)
				{
					if (!IS_STRING_NULL_OR_EMPTY(&Var0))
					{
						...
						else if (IS_BIT_SET(iLocal_49, 10) && IS_BIT_SET() == 0)
						{
							func_127("LOCAUD", Local_44.f_7);
							func_126(1);
							iLocal_40 = 2;
...
void func_131()
{
	...
	{
		if (!IS_BIT_SET(iLocal_49, 1))
		{
			if (!func_76(PLAYER_PED_ID(), vLocal_50, 5f))
			{
				if (func_133())
				{
...
bool func_132()
{
	return IS_THREAD_ACTIVE(Global_111560.f_18098.f_395);
}
...
void func_136()
{
	...
	{
		if (func_76(PLAYER_PED_ID(), vLocal_52, 60f))
		{
			if (func_85(func_74(25)))
			{
				if (vdist2(GET_ENTITY_COORDS(func_74(25), true), vLocal_52) >= 100f)
				{
					func_68(0);
				}
			}
...
int func_141()
{
	...
	{
		iLocal_40 = 1;
		func_142(192, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true));
		return 1;
	}
	return 0;
}
...
void func_142(int iParam0, vector3 vParam1)
{
	...
	if (DOES_BLIP_EXIST(Global_31111[iParam0 /*23*/].f_19))
	{
		SET_BLIP_COORDS(Global_31111[iParam0 /*23*/].f_19, vParam1);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= 2)
...
void func_160(int iParam0, var uParam1)
{
	...
	func_161(&uLocal_80, Local_44, PLAYER_PED_ID(), Local_44.f_1, 0, 1);
...
{
	Local_44.f_6 = GET_NAME_OF_ZONE(GET_NAME_OF_ZONE(GET_NAME_OF_ZONE(), true));
	func_168(iParam0);
}
...
void func_171()
{
	if (!IS_BIT_SET(iLocal_49, 6))
	{
		if (func_85(iLocal_51))
		{
			vLocal_52 = { GET_ENTITY_COORDS(iLocal_51, true) };
...
void func_174()
{
	if (IS_BIT_SET(iLocal_49, 0) && IS_BIT_SET(iLocal_49, 1))
	{
		if (!IS_BIT_SET(iLocal_49, 11))
		{
			func_265(1);
		}
	}
	else if (IS_BIT_SET(iLocal_49, 11))
	{
		func_265(0);
	}
}
...
void func_175()
{
	if ((IS_BIT_SET(iLocal_49, 0) && Global_41396 == 15) && !func_208())
	{
		if (iLocal_38 == 0)
		{
			if (!IS_BIT_SET(iLocal_49, 1) && IS_BIT_SET(iLocal_49, 0))
			{
				if (!func_76(PLAYER_PED_ID(), vLocal_50, 5f))
				{
					if (IS_BIT_SET(iLocal_49, 20) || func_133())
					{
						if ((func_250(PLAYER_PED_ID()) && !PLAYER_PED_ID(uLocal_47[0], 17)) && !PLAYER_PED_ID(uLocal_47[1], 18))
						{
							if (IS_PED_STOPPED(IS_PED_STOPPED()))
							{
								...
								if (IS_BIT_SET(iLocal_49, 0))
								{
									if (!func_205() && func_185(GET_ENTITY_COORDS(iLocal_51, true)))
									{
										if (func_182(iLocal_51))
										{
											if (func_181(iLocal_51))
											{
												...
												vLocal_50 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
												return;
											}
										}
									}
									if (IS_BIT_SET(iLocal_49, 20))
									{
										func_1(46, 0);
										CLEAR_BIT(&iLocal_49, 20);
										iLocal_245 = -1;
									}
									vLocal_50 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
								}
					...
					{
						if ((IS_PED_STOPPED(IS_PED_STOPPED()) && IS_PED_STOPPED(IS_PED_STOPPED(), 0)) && !IS_PED_STOPPED(iLocal_49, 20))
						{
							if (iLocal_245 != -1)
							{
								if ((GET_GAME_TIMER() - iLocal_245) > 1000)
								{
									SET_BIT(&iLocal_49, 20);
								}
							}
							else
							{
			...
			else if (IS_BIT_SET(iLocal_49, 0))
			{
				if (!func_76(PLAYER_PED_ID(), vLocal_50, 10f))
				{
					CLEAR_BIT(&iLocal_49, 1);
				}
				else if (!IS_PED_STOPPED(IS_PED_STOPPED()))
				{
				...
				else if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					if (func_85(iLocal_51))
					{
						if (GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0) != iLocal_51)
						{
							func_1(46, 0);
							func_177(0);
							func_176();
...
int func_181(int iParam0)
{
	...
	if (!_0x639431E895B9AA57(_0x639431E895B9AA57(), iParam0, -1, 0, false) && !_0x639431E895B9AA57(_0x639431E895B9AA57(), iParam0, 0, 0, false))
	{
		func_69(37);
		return 0;
	}
...
int func_182(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		if (func_85(iParam0))
		{
			GET_MODEL_DIMENSIONS(GET_MODEL_DIMENSIONS(iParam0), &vVar1, &vVar2);
			vVar1 = { vVar1 + Vector(-1f, -1f, -2f) };
			vVar2 = { vVar2 + Vector(1f, 1f, 2f) };
			if (!IS_AREA_OCCUPIED(IS_AREA_OCCUPIED(iParam0, vVar1), IS_AREA_OCCUPIED(iParam0, vVar2), 0, 1, 0, 0, 0, iParam0, 0))
			{
				iVar0++;
			}
			else if (func_13())
			...
			if (iVar0 == 2)
			{
				if (func_183(GET_ENTITY_COORDS(iParam0, true)))
				{
					return 1;
				}
			}
...
int func_184()
{
	...
	GET_PED_NEARBY_PEDS(GET_PED_NEARBY_PEDS(), &uVar0, -1);
	iVar1 = 0;
	while (iVar1 <= 4)
	{
		if (func_250(uVar0[iVar1]) && uVar0[iVar1] != PLAYER_PED_ID())
		{
			if (vdist2(vLocal_50, GET_ENTITY_COORDS(uVar0[iVar1], true)) <= 16f)
			{
				return 1;
			}
		}
...
int func_187(vector3 vParam0)
{
	...
	fVar0 = vdist2(vParam0, Global_93838[func_188(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_188(vector3 vParam0, bool bParam1)
{
	...
	while (iVar0 <= (7 - 1))
	{
		...
		{
			if (!bParam1 || IS_BIT_SET(Global_111560.f_7224.f_17[iVar0], 0))
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_93838[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_189(vector3 vParam0)
{
	...
	fVar0 = vdist2(vParam0, Global_93902[func_190(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_192(vector3 vParam0, vector3 vParam1)
{
	...
	fVar0 = ABSF((vParam0.z - vParam1.z));
	if (fVar0 <= 5f)
	{
		return 1;
	}
...
int func_197()
{
	...
	while (iVar0 <= (4 - 1))
	{
		...
		{
			if (IS_BIT_SET(Local_68[iVar0 /*261*/].f_258, iVar1))
			{
...
{
	if (IS_ENTITY_IN_ANGLED_AREA(IS_ENTITY_IN_ANGLED_AREA(), uParam0->f_1, uParam0->f_4, uParam0->f_7, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_201()
{
	...
	iVar0 = func_203(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 145, 1);
	fVar1 = vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), Global_93737[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
int func_205()
{
	if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 1276.123f, -1723.665f, 53.6551f) <= 52900f)
	{
		if (func_13())
		{
			func_69(30);
	...
	else if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 111.8564f, -751.7169f, 44.757f) <= 160000f)
	{
		if (func_13())
		{
			func_69(31);
...
int func_206(float fParam0)
{
	if (iLocal_42 == 1)
	{
		if (func_76(PLAYER_PED_ID(), Global_94645[1 /*15*/], fParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER_PED_ID(), Global_94645[0 /*15*/], fParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER_PED_ID(), Global_94645[3 /*15*/], fParam0))
		{
			return 1;
		}
	}
	...
	if ((Global_41396 == 15 && iLocal_38 == 0) && !func_208())
	{
		if (!IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!IS_BIT_SET(iLocal_49, 0))
			{
				...
				else if (IS_BIT_SET(iLocal_49, 8))
				{
					iVar1 = GET_PLAYERS_LAST_VEHICLE();
					if (func_85(iVar1))
					{
						if (func_19(PLAYER_PED_ID(), iVar1, 10f, 1) && !PLAYER_PED_ID(iVar1, "Getaway_Winched"))
						{
							iLocal_51 = iVar1;
							SET_ENTITY_AS_MISSION_ENTITY(iLocal_51, true, 1);
							SET_BIT(&iLocal_49, 0);
			...
			else if (func_85(iLocal_51))
			{
				...
				{
					if (DECOR_SET_BOOL(iLocal_51, "GetawayVehicleValid", 0))
					{
					}
					func_207(17, 46);
					func_207(18, 46);
...
{
	if (GET_ENTITY_HEALTH(iParam0) < 300 || GET_ENTITY_HEALTH(iParam0) < 300f)
	{
		func_69(6);
		return 0;
	}
...
int func_212()
{
	if (IS_PED_IN_ANY_TAXI(IS_PED_IN_ANY_TAXI()))
	{
		if ((GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(), 0), 0, 0) == GET_PED_IN_VEHICLE_SEAT() || GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(), 0), 1, 0) == GET_PED_IN_VEHICLE_SEAT()) || GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(GET_PED_IN_VEHICLE_SEAT(), 0), 2, 0) == GET_PED_IN_VEHICLE_SEAT())
		{
			return 1;
		}
	}
...
int func_217(int iParam0)
{
	...
	if (!func_218(iVar0))
	{
		if (GET_VEHICLE_MODEL_ACCELERATION(iVar0) > 0.165f && GET_VEHICLE_MODEL_ACCELERATION(iVar0) > 31f)
		{
			return 1;
		}
	}
...
int func_222(var uParam0)
{
	...
	if (func_250(PLAYER_PED_ID()) && PLAYER_PED_ID(PLAYER_PED_ID(), 0))
	{
		iVar0 = GET_PLAYERS_LAST_VEHICLE();
		if (func_85(iVar0))
		{
	...
	switch (iLocal_67)
	{
		case 0:
			if (IS_BIT_SET(iLocal_49, 0))
			{
				...
				{
					sLocal_70 = GET_NAME_OF_ZONE(GET_NAME_OF_ZONE(GET_NAME_OF_ZONE(), true));
					iLocal_67 = 1;
				}
				else if (iLocal_73 == -1)
				{
		...
		case 1:
			if ((GET_GAME_TIMER() - Local_68[iLocal_72 /*261*/].f_259) > 500)
			{
				if (!IS_STRING_NULL_OR_EMPTY(sLocal_70) && !IS_STRING_NULL_OR_EMPTY(Local_68[iLocal_72 /*261*/][iLocal_71 /*8*/]))
				{
					...
					{
						CLEAR_BIT(&(Local_68[iLocal_72 /*261*/].f_258), iLocal_71);
					}
				}
				else
				{
...
void func_224()
{
	...
	if (((((((Global_41396 == 15 && iLocal_37 != 3) && IS_BIT_SET(iLocal_49, 5)) && !func_208()) && Global_76574 == -1) && !func_234()) && !func_84(9)) || func_103(35))
	{
		func_233();
		func_231();
		switch (iLocal_39)
	...
	else if (((((((Global_41396 != 15 || Global_41396 != 0) || Global_41396 != 2) || Global_41396 != 4) || Global_41396 != 17) || func_208()) || Global_76574 == -1) || Global_110615)
	{
		...
		if (IS_BIT_SET(uLocal_47[func_5(iVar1)], iVar1))
		{
			func_225(iVar1, 0);
		}
	}
...
void func_225(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_228(func_89())) && !func_227())
			{
		...
		case 2:
			...
			else
			{
				...
				else if (IS_BIT_SET(iLocal_49, 15))
				{
					func_4(iParam0);
					CLEAR_BIT(&iLocal_49, 15);
					iLocal_39 = 4;
				}
			}
			break;
		...
		case 3:
			if (!func_2(func_3(iParam0)))
			{
				if (fLocal_48 >= 7.5f || IS_BIT_SET(iLocal_49, 15))
				{
					func_4(iParam0);
					CLEAR_BIT(&iLocal_49, 15);
					iLocal_39 = 4;
...
int func_229(int iParam0)
{
	...
	{
		if (IS_BIT_SET(Global_111560.f_7683.f_651[iVar0 /*14*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
	...
	{
		if (IS_BIT_SET(Global_111560.f_7683.f_765[iVar0 /*10*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
...
void func_237()
{
	if (iLocal_37 != 4)
	{
		if (iLocal_37 != 2)
		{
			if (IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_110200)
			{
				SET_BIT(&iLocal_49, 15);
				CLEAR_HELP(1);
			}
		...
		if (HAS_THIS_ADDITIONAL_TEXT_LOADED("GETAWY", 5))
		{
			...
			CLEAR_BIT(&iLocal_49, 4);
			CLEAR_BIT(&iLocal_49, 5);
			func_265(0);
			if (func_132())
			{
				func_1(1, 1);
...
{
	func_240();
	if (IS_BIT_SET(iLocal_49, 4))
	{
		if (!IS_BIT_SET(iLocal_49, 5) && !IS_BIT_SET(iLocal_49, 16))
		{
...
int func_241()
{
	if (iLocal_42 != 2)
	{
		...
		{
			if (!IS_BIT_SET(iLocal_49, 16))
			{
				SET_BIT(&iLocal_49, 16);
			}
			return 1;
		}
		else if (IS_BIT_SET(iLocal_49, 16))
		{
			CLEAR_BIT(&iLocal_49, 16);
		}
		if (func_242())
		{
			return 0;
...
void func_243()
{
	if (!IS_BIT_SET(iLocal_49, 13))
	{
		if (func_244())
		{
			SET_BIT(&iLocal_49, 13);
		}
	}
	else if (!func_244())
	{
...
int func_246(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_96() == 0)
		{
			return IS_BIT_SET(func_247(func_249(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_252()
{
	...
	if (!func_84(14) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) > 0)
	{
		return 1;
	}
	return 0;
