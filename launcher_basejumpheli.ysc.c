...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH()) > 1 && !func_159(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
		...
		if (DOES_ENTITY_EXIST(iLocal_53) && !DOES_ENTITY_EXIST(iLocal_53, 0))
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_137(3) && !Global_98703)
						{
							...
							{
								if ((!func_159(uLocal_58, 1) || !DOES_ENTITY_EXIST(func_136())) && !Global_98703)
								{
									func_152(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							{
								iVar3 = GET_VEHICLE_PED_IS_USING(GET_VEHICLE_PED_IS_USING());
								if (bVar2)
								{
									if (iLocal_54 == iVar3)
									{
							...
							if (bVar2)
							{
								...
								if (func_116(iLocal_54))
								{
									...
									else if (!func_159(uLocal_58, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_114(&iLocal_60);
				...
				case 6:
					...
					if (func_159(uLocal_58, 2097152))
					{
						if (!func_137(3) && !IS_THREAD_ACTIVE(iLocal_50))
						{
							func_152(10);
						}
					}
					if (!IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != -1)
						{
							if (func_159(Global_110211, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_98706, 0);
...
{
	func_3(&uLocal_79);
	SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_247);
	SET_PED_AS_NO_LONGER_NEEDED(&(Local_247.f_3));
}
...
void func_16(int iParam0, int iParam1)
{
	...
	if (DOES_CAM_EXIST(*iParam0) && DOES_CAM_EXIST(*iParam0))
	{
		vVar2 = { GET_CAM_COORD(*iParam0) };
		vVar0 = { GET_CAM_ROT(*iParam0, 2) };
		if (IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			vVar1 = { GET_ENTITY_COORDS(iParam1, true) };
		}
		fVar3 = ATAN2((vVar1.z - vVar2.z), ATAN2(vVar1, vVar2, false));
		if (fVar3 > vVar0.x)
		{
...
void func_26()
{
	if (DOES_ENTITY_EXIST(Local_247) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
	{
	}
	if (IS_CAM_ACTIVE(iLocal_252))
	{
		SET_CAM_ACTIVE(iLocal_252, false);
		RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
		DESTROY_CAM(iLocal_252, 0);
	}
	func_2();
}
...
void func_36()
{
	...
	if (IS_VEHICLE_DRIVEABLE(Local_247, 0))
	{
		SET_VEHICLE_DOORS_LOCKED(Local_247, 1);
	}
}
...
void func_51()
{
	...
	if (DOES_ENTITY_EXIST(iVar2) && iVar2 != iLocal_54)
	{
		Local_247.f_1 = iVar2;
	}
	if (!iLocal_249)
	...
	if (func_107(Local_247.f_3, Local_247, 1, 1, 1, 1, 0) || IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		func_150(0);
		iLocal_249 = 0;
		if (DOES_ENTITY_EXIST(Local_247.f_3) && !DOES_ENTITY_EXIST(Local_247.f_3))
		{
			if (IS_VEHICLE_DRIVEABLE(Local_247, 0) && IS_VEHICLE_DRIVEABLE(Local_247.f_3, Local_247, 0))
			{
				TASK_VEHICLE_MISSION_COORS_TARGET(Local_247.f_3, Local_247, TASK_VEHICLE_MISSION_COORS_TARGET(Local_247, true) + Vector(100f, 100f, 100f) * TASK_VEHICLE_MISSION_COORS_TARGET(Local_247) + Vector(500f, 0f, 0f), 4, TASK_VEHICLE_MISSION_COORS_TARGET(Local_247), 262144, 50f, 50f, 1);
			}
			else
			{
				TASK_SMART_FLEE_PED(Local_247.f_3, TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
			}
			SET_PED_KEEP_TASK(Local_247.f_3, true);
			SET_PED_CONFIG_FLAG(Local_247.f_3, 251, false);
			SET_PED_CONFIG_FLAG(Local_247.f_3, 255, false);
			Local_247.f_3 = 0;
		}
	...
	fVar6 = vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), func_106(iLocal_81));
	if (fVar6 < 11664f)
	{
		if (!iLocal_251)
		{
			REQUEST_MODEL(func_105(iLocal_81));
			iLocal_251 = 1;
		}
	}
	else if (fVar6 > 13924f)
	{
		if (iLocal_251)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(func_105(iLocal_81));
			iLocal_251 = 0;
		}
	}
	if (fVar6 < 10000f)
	{
		if (!DOES_ENTITY_EXIST(Local_247.f_3))
		{
			if ((HAS_MODEL_LOADED(func_105(iLocal_81)) && HAS_MODEL_LOADED(Local_247)) && HAS_MODEL_LOADED(Local_247, 0))
			{
				Local_247.f_3 = CREATE_PED_INSIDE_VEHICLE(Local_247, 4, func_105(iLocal_81), -1, 1, true);
				if (!IS_PED_INJURED(Local_247.f_3))
				{
					SET_PED_HELMET(Local_247.f_3, 0);
					func_104(Local_247.f_3, iLocal_81);
					func_103();
					SET_AMBIENT_VOICE_NAME(Local_247.f_3, func_102(iLocal_81));
					func_100(&uLocal_82, 0, Local_247.f_3, func_101(iLocal_81), 1, 1);
					TASK_STAND_STILL(Local_247.f_3, -1);
					SET_PED_CONFIG_FLAG(Local_247.f_3, 251, true);
					SET_PED_CONFIG_FLAG(Local_247.f_3, 255, true);
				}
				SET_VEHICLE_ENGINE_ON(Local_247, true, true, 0);
				SET_HELI_BLADES_SPEED(Local_247, fVar7);
			}
		}
		else
		{
			SET_ENTITY_AS_MISSION_ENTITY(Local_247.f_3, true, 0);
			if (!DOES_CAM_EXIST(iLocal_252) || !DOES_CAM_EXIST(iLocal_252))
			{
				SET_HELI_BLADES_SPEED(Local_247, fVar7);
			}
			if (!IS_BIT_SET(Local_247.f_169, 0))
			{
				if (IS_SCREEN_FADED_IN())
				{
					if (!IS_PED_INJURED(Local_247.f_3) && !IS_PED_INJURED(IS_PED_INJURED()))
					{
						if (vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), GET_ENTITY_COORDS(Local_247.f_3, true)) < 400f)
						{
							func_78(&uLocal_82, "OJBJAUD", func_98(iLocal_81), 8, 0, 0, 0);
							TASK_LOOK_AT_ENTITY(Local_247.f_3, TASK_LOOK_AT_ENTITY(), 6000, 0, 2);
							SET_BIT(&(Local_247.f_169), 0);
						}
					}
				}
			}
	...
	else if (fVar6 > 12100f)
	{
		if (DOES_ENTITY_EXIST(Local_247.f_3))
		{
			...
			if (!IS_ENTITY_ON_SCREEN(iVar3))
			{
				SET_ENTITY_AS_MISSION_ENTITY(iVar3, true, 0);
				DELETE_PED(&iVar3);
			}
			else
			{
	...
	func_16(&iLocal_252, Local_247);
	if ((IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_247, 1) && !IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE())) && func_76(Local_247.f_3, Local_247))
	{
		vVar5 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_247, GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(), 0, 0f, 0f, 0f)) };
		if (vVar5.x < 0f || vVar5.y < 1f)
		{
			SET_AUDIO_FLAG("DisableFlightMusic", 1);
			SET_VEH_RADIO_STATION(Local_247, "OFF");
			...
			if (!DOES_CAM_EXIST(iLocal_252))
			{
				func_65(0, 0, 1);
				func_58(1);
				iLocal_252 = CREATE_CAMERA_WITH_PARAMS(26379945, func_57(iLocal_81), func_56(iLocal_81), func_55(iLocal_81), 0, 2);
				SET_CAM_ACTIVE(iLocal_252, true);
				RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
				SHAKE_CAM(iLocal_252, "HAND_SHAKE", 0.07f);
			}
			if (IS_VEHICLE_DRIVEABLE(Local_247, 0))
			{
				iVar0 = GET_SCRIPT_TASK_STATUS(Local_247.f_3, -1273030092);
				if (iVar0 != 0 && iVar0 != 1)
				{
					SET_PED_CONFIG_FLAG(Local_247.f_3, 134, true);
					func_23(&iVar1);
					...
					func_22(&iLocal_253);
					while (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_247, 0) && func_53(&iLocal_253) < 2f)
					{
						wait(0);
					}
					func_9(&iLocal_253);
					if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), Local_247, 0))
					{
						bVar8 = false;
						RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
						if (DOES_CAM_EXIST(iLocal_252))
					...
					if (!IS_ENTITY_DEAD(Local_247.f_3, 0) && !IS_ENTITY_DEAD(Local_247, 0))
					{
						OPEN_SEQUENCE_TASK(&iVar4);
						TASK_STAND_STILL(0, 500);
						TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_247, TASK_VEHICLE_MISSION_COORS_TARGET(Local_247, true) + Vector(100f, 100f, 100f) * TASK_VEHICLE_MISSION_COORS_TARGET(Local_247) + Vector(500f, 0f, 0f), 4, TASK_VEHICLE_MISSION_COORS_TARGET(Local_247), 262144, 50f, 50f, 1);
						CLOSE_SEQUENCE_TASK(iVar4);
						TASK_PERFORM_SEQUENCE(Local_247.f_3, iVar4);
	...
	if (!bVar8)
	{
		if ((IS_VEHICLE_DRIVEABLE(Local_247, 0) && vdist2(IS_VEHICLE_DRIVEABLE(IS_VEHICLE_DRIVEABLE(), true), IS_VEHICLE_DRIVEABLE(Local_247, true)) < 225f) && !IS_VEHICLE_DRIVEABLE(IS_VEHICLE_DRIVEABLE(), 1))
		{
		...
		if ((!IS_PED_INJURED(Local_247.f_3) && IS_PED_INJURED(Local_247.f_3, -982327190) != 0) && IS_PED_INJURED(Local_247.f_3, -982327190) != 1)
		{
			TASK_STAND_STILL(Local_247.f_3, -1);
		}
	}
...
void func_67(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_72(IS_PED_INJURED())) && !func_69(IS_PED_INJURED(), 0)) && !func_68()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_72(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
{
	if (((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam1)) || DOES_ENTITY_EXIST(iParam0, 0)) || DOES_ENTITY_EXIST(iParam1, 0))
	{
		return 0;
	}
	if (IS_PED_IN_VEHICLE(iParam0, iParam1, 0) && func_77(iParam0, iParam1) == -1)
	{
		return 1;
	}
	return 0;
...
char* func_98(int iParam0)
{
	...
	bVar0 = func_92(PLAYER_PED_ID()) == true;
	switch (iParam0)
	{
		case 0:
...
int func_107(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	iVar0 = PLAYER_PED_ID();
	if (((!DOES_ENTITY_EXIST(iParam1) || DOES_ENTITY_EXIST(iParam1, 0)) || !DOES_ENTITY_EXIST(iParam1, 0)) || DOES_ENTITY_EXIST(iParam1))
	{
		return 1;
	}
	if (DOES_ENTITY_EXIST(iParam0))
	{
		if (!IS_PED_INJURED(iParam0) && !IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, 0), iVar0, 1))
				{
					return 1;
				}
			}
			if (IS_PED_ARMED(iVar0, 4))
			{
				...
				{
					if (IS_ENTITY_AT_COORD(iParam0, IS_ENTITY_AT_COORD(iVar0, true), 45f, 45f, 45f, false, true, 0))
					{
						return 1;
					}
				}
			...
			if (IS_PED_BEING_JACKED(iParam0) || !func_76(iParam0, iParam1))
			{
				return 1;
			}
...
{
	return func_109(GET_PLAYER_PED(GET_PLAYER_PED()), iParam0, bParam1);
}
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_119(8, -1)) || func_132()) || func_131()) || func_130()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_134()) || Global_30738) || func_133()) || func_119(8, -1)) || func_130()) || func_132()) || func_131()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_119(8, -1)) || func_130()) || func_132()) || func_131()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_119(8, -1)) || func_132()) || func_131()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_134() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_119(8, -1)) || func_121()) || func_129()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_134()) || Global_30738) || func_133()) || func_119(8, -1)) || func_131()) || func_130()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_134()) || func_131()) || Global_110607) || Global_30738) || func_133()) || Global_42561) || func_119(8, -1)) || func_130()) || func_129()) || func_121()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_134()) || Global_110607) || Global_30738) || func_133()) || func_119(8, -1)) || func_130()) || func_129()) || func_132()) || func_131()) || func_121())
						{
							return 0;
						}
						break;
...
void func_142(vector3 vParam0, float fParam1)
{
	...
	fLocal_57 = vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), vParam0);
	if (!IS_PED_INJURED(IS_PED_INJURED()) && (fLocal_57 > 25f || IS_PED_INJURED()))
	{
		if (fLocal_57 < 25600f)
		{
			if (!IS_SPHERE_VISIBLE(vParam0, 6f) || IS_SPHERE_VISIBLE())
			{
				bVar1 = true;
			}
		}
	...
	if (bVar1)
	{
		...
		if (iLocal_81 == 3)
		{
			Local_247 = CREATE_VEHICLE(joaat("frogger"), vParam0, fParam1, true, true, false);
			SET_VEHICLE_COLOUR_COMBINATION(Local_247, 5);
		}
		else
		{
			Local_247 = CREATE_VEHICLE(joaat("maverick"), vParam0, fParam1, true, true, false);
			SET_VEHICLE_COLOUR_COMBINATION(Local_247, 6);
		}
		iLocal_54 = Local_247;
		_SET_ENTITY_SOMETHING(iLocal_54, true);
		if (GET_GROUND_Z_FOR_3D_COORD(vParam0, &uVar0, 0, 0))
		{
			SET_VEHICLE_ON_GROUND_PROPERLY(Local_247, 1084227584);
		}
		SET_VEHICLE_HAS_STRONG_AXLES(Local_247, true);
		iLocal_249 = 1;
	}
	else
	{
