			...
			switch (iLocal_80)
			{
				case 0:
					if (func_223(1, 1093140480, 0))
					{
						...
						if (_DOES_DOOR_EXIST(1736361794))
						{
							...
							_SET_DOOR_ACCELERATION_LIMIT(1736361794, 0, true, false);
						}
						START_CUTSCENE(0);
				...
				case 2:
					if (IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_216(PLAYER_PED_ID(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
							FORCE_PED_MOTION_STATE(FORCE_PED_MOTION_STATE(), -668482597, false, 1, 0);
							SIMULATE_PLAYER_INPUT_GAIT(SIMULATE_PLAYER_INPUT_GAIT(), 1f, 4000, 0, 1, 0);
...
void func_207(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_211(IS_PED_INJURED())) && !func_209(IS_PED_INJURED(), 0)) && !func_208()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_211(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_217(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_218(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_223(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_230(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_229(PLAYER_PED_ID(), -828834893))
				{
...
{
	if (((!func_247(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_246(0)) || func_245(1))
			{
			}
			else
			{
...
void func_266(bool bParam0)
{
	...
	if (!func_287())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_267(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_268(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_274())
	{
		...
		{
			iVar2 = func_269(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
