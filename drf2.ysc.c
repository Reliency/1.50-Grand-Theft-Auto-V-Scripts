...
void __EntryFunction__()
{
	...
	if (HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		...
		if (bVar13)
		{
			if (DOES_ENTITY_EXIST(iLocal_380) && DOES_ENTITY_EXIST(iLocal_380))
			{
				func_271(80, 1);
				STAT_SET_BOOL(joaat("sp_killed_dr_friedlander"), true, 1);
			}
			func_269(0, 0);
		}
		else
	...
	SET_BIT(&(Global_111560.f_10011.f_25), 6);
	switch (func_253())
	{
		case 0:
			fVar12 = 3.6f;
	...
	if (!IS_PLAYER_DEAD(IS_PLAYER_DEAD()) && !IS_PLAYER_DEAD(IS_PLAYER_DEAD()))
	{
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				DISPLAY_RADAR(false);
				func_245();
				while (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
				{
					wait(0);
				}
				TASK_FOLLOW_NAV_MESH_TO_COORD(TASK_FOLLOW_NAV_MESH_TO_COORD(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 1048576000, 0, 1193033728);
				iVar8 = CREATE_CAMERA_WITH_PARAMS(26379945, -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				iVar9 = CREATE_CAMERA_WITH_PARAMS(26379945, -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
			...
			case 1:
				...
				if (bVar4)
				{
					if (!bVar5)
					{
						if (_0xB56BBBCC2955D9CB())
						{
							...
							{
								func_139(&vLocal_387, PLAYER_PED_ID(), 0, 2);
							}
				...
				{
					if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(iLocal_379, 0))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), &vLocal_387, 0, 0, 0);
						REGISTER_ENTITY_FOR_CUTSCENE(iLocal_379, &vLocal_391, 0, 0, 0);
					}
					START_CUTSCENE(0);
			...
			case 2:
				...
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&vLocal_387, 0))
				{
					func_134(iLocal_379, 1, 0);
				}
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&vLocal_391, 0))
				{
			...
			case 3:
				...
				if (IS_SCREEN_FADED_OUT() || bVar14)
				{
					...
					while (IS_NEW_LOAD_SCENE_ACTIVE() && !IS_NEW_LOAD_SCENE_ACTIVE())
					{
						wait(0);
						func_122();
					}
				...
				else if ((func_137(&iLocal_231) > 5f && func_136()) || (HAS_CUTSCENE_LOADED() && ((Local_61.f_20 != 1 || func_137(&iLocal_231) > fVar12) || func_95(iLocal_62, iLocal_379, &iLocal_384))))
				{
					func_92();
					if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
					{
			...
			case 14:
				if (DOES_CAM_EXIST(iLocal_384))
				{
					...
					DESTROY_CAM(iLocal_384, 0);
				}
				if (((func_91() && IS_CUTSCENE_PLAYING()) && !IS_CUTSCENE_PLAYING()) && !IS_CUTSCENE_PLAYING())
				{
					STOP_CUTSCENE(0);
				}
				if (CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					if (iLocal_62 == 4)
					{
						...
						if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
						{
							...
							SET_ENTITY_COLLISION(SET_ENTITY_COLLISION(), true, 0);
					...
					else
					{
						...
						if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
						{
							...
							SET_ENTITY_COLLISION(SET_ENTITY_COLLISION(), true, 0);
							FREEZE_ENTITY_POSITION(FREEZE_ENTITY_POSITION(), false);
							func_88(PLAYER_PED_ID(), -1902.609f, -559.9267f, 10.7916f);
							SET_ENTITY_HEADING(SET_ENTITY_HEADING(), fLocal_398);
							...
							{
								if (!IS_ENTITY_DEAD(iLocal_382, 0))
								{
									SET_ENTITY_COORDS(iLocal_382, func_79(iLocal_382), 1, false, 0, 1);
							...
							if (IS_SCREEN_FADED_OUT())
							{
								if (!iLocal_408)
								{
									NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_78(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_408 = 1;
									wait(0);
								}
								if (!iLocal_409)
				...
				else
				{
					if (!iLocal_408)
					{
						if (GET_CUTSCENE_TIME() > 60000)
						{
							if (iLocal_62 == 4)
							{
								NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_78(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_78(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_409)
					{
						if (_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_137(&iVar7) > func_76(func_253()))
							{
								if (func_253() == 4)
								{
									iLocal_380 = CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, true);
									SET_PED_COMPONENT_VARIATION(iLocal_380, 3, iLocal_404, iLocal_405, 0);
									SET_PED_COMPONENT_VARIATION(iLocal_380, 4, 0, iLocal_406, 0);
									SET_PED_MONEY(iLocal_380, (2000 + SET_PED_MONEY(5, 301)));
			...
			case 15:
				...
				else if (!DOES_ENTITY_EXIST(iLocal_380) || func_74(iLocal_380, DOES_ENTITY_EXIST(), 1) > 300f)
				{
					...
					{
						CLEAR_AREA_OF_PROJECTILES(CLEAR_AREA_OF_PROJECTILES(iLocal_380, true), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					...
					if (func_77(&iLocal_246))
					{
						...
						{
							SIMULATE_PLAYER_INPUT_GAIT(SIMULATE_PLAYER_INPUT_GAIT(), 2f, 1000, 0, 1, 0);
							SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), false, 0);
							func_135(&iLocal_246);
						}
					}
					if (!iLocal_411)
					{
						...
						if (func_137(&iLocal_243) > 2f)
						{
							...
							iLocal_384 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar16, vVar17, 50f, 0, 2);
							SET_CAM_ACTIVE_WITH_INTERP(iLocal_384, iLocal_385, 2660, 1, 1);
							if (DOES_ENTITY_EXIST(iLocal_382) && !DOES_ENTITY_EXIST(iLocal_382, 0))
							{
					...
					else if (DOES_CAM_EXIST(iLocal_385))
					{
						...
						{
							SET_GAMEPLAY_CAM_RELATIVE_HEADING(func_56(SET_GAMEPLAY_CAM_RELATIVE_HEADING() == 2, -16f, 0f));
							RENDER_SCRIPT_CAMS(false, true, 340, 0, 0, 0);
					...
					if (iLocal_410 && IS_PLAYER_CONTROL_ON(IS_PLAYER_CONTROL_ON()))
					{
					...
					if (!IS_PED_INJURED(iLocal_380))
					{
						...
						{
							if (IS_PED_IN_ANY_VEHICLE(iLocal_380, 0))
							{
								iVar0 = 1;
							}
							if (!IS_PED_FLEEING(iLocal_380))
							{
								if ((((((((!IS_VEHICLE_DRIVEABLE(iLocal_381, 0) || IS_VEHICLE_DRIVEABLE(IS_VEHICLE_DRIVEABLE(), iLocal_381, 1)) || IS_VEHICLE_DRIVEABLE(iLocal_381, 0, 2000)) || IS_VEHICLE_DRIVEABLE(iLocal_381, 1, 2000)) || IS_VEHICLE_DRIVEABLE(iLocal_381, 2, 2000)) || IS_VEHICLE_DRIVEABLE(iLocal_381, 3, 2000)) || (iVar0 && !IS_VEHICLE_DRIVEABLE(iLocal_380, 0))) || func_50(iLocal_381)) || func_46(iLocal_381))
								{
									TASK_SMART_FLEE_PED(iLocal_380, TASK_SMART_FLEE_PED(), 3000f, -1, 0, 0);
								}
							}
						}
						...
						if (!bVar15 && !IS_ENTITY_IN_ANGLED_AREA(iLocal_380, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, true, 0))
						{
			...
			case 17:
				...
				if (func_137(&iLocal_234) > 4f || IS_SCREEN_FADED_OUT())
				{
					...
					if (!func_1(80))
					{
						if (DOES_ENTITY_EXIST(iLocal_380))
						{
							if (DOES_ENTITY_EXIST(iLocal_381) && DOES_ENTITY_EXIST(iLocal_380, iLocal_381, 0))
							{
...
void func_6(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_8() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_8() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_14(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_8() /*10828*/].f_6168.f_10, iParam0);
}
...
int func_46(int iParam0)
{
	...
	if ((func_49(PLAYER_PED_ID()) && PLAYER_PED_ID(PLAYER_PED_ID(), 0)) && func_47(iParam0))
	{
...
{
	iParam0->f_1 = (func_52(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
void func_57()
{
	...
	if ((!DOES_ENTITY_EXIST(iLocal_380) || DOES_ENTITY_EXIST(iLocal_380, 0)) || DOES_ENTITY_EXIST(DOES_ENTITY_EXIST(), 0))
	{
		return;
	}
	...
	fVar3 = vdist2(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), GET_ENTITY_COORDS(iLocal_380, true));
	if (iLocal_401 < 7)
	{
		if (iLocal_401 <= 0)
		{
		...
		{
			if (fVar3 <= 144f && !IS_SCRIPTED_SPEECH_PLAYING(IS_SCRIPTED_SPEECH_PLAYING()))
			{
				iVar1 = GET_RANDOM_INT_IN_RANGE(0, (7 - iLocal_401));
				while (iVar2 >= 0 && iVar2 < 7)
				{
					if (!IS_BIT_SET(iLocal_400, iVar2))
					{
						if (iVar1 == 0)
						{
							SET_BIT(&iLocal_400, iVar2);
							iVar1 = iVar2;
							iVar2 = -2;
						}
						else
	...
	if (iLocal_403 < 8)
	{
		if (iLocal_403 <= 0)
		{
			if (func_137(&iLocal_252) > 1f && !IS_SCRIPTED_SPEECH_PLAYING(iLocal_380))
			{
				iVar1 = GET_RANDOM_INT_IN_RANGE(0, 8);
				SET_BIT(&iLocal_402, iVar1);
		...
		else if (func_137(&iLocal_252) > 10.3f)
		{
			...
			{
				iVar1 = GET_RANDOM_INT_IN_RANGE(0, (8 - iLocal_403));
				iVar2 = 0;
				while (iVar2 >= 0)
				{
					if (!IS_BIT_SET(iLocal_402, iVar2))
					{
						if (iVar1 == 0)
						{
							SET_BIT(&iLocal_402, iVar2);
							iVar1 = iVar2;
							iVar2 = -2;
						}
						else
...
Vector3 func_79(int iParam0)
{
	...
	GET_MODEL_DIMENSIONS(GET_MODEL_DIMENSIONS(iParam0), &uVar4, &Var5);
...
void func_80(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_84(IS_PED_INJURED())) && !func_82(IS_PED_INJURED(), 0)) && !func_81()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_84(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_90()
{
	...
	if (!IS_VEHICLE_DRIVEABLE(iLocal_381, 0))
	{
		DELETE_VEHICLE(&iLocal_381);
		iLocal_381 = CREATE_VEHICLE(iLocal_57, vLocal_396, fLocal_399, true, true, false);
	...
	if ((!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(iLocal_381, 0)) && IS_ENTITY_DEAD(iLocal_381, 0))
	{
		SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -1907.827f, -560.0641f, 10.8064f, 1, false, 0, 1);
		SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 260.195f);
		SET_ENTITY_COORDS(iLocal_381, vLocal_396, 1, false, 0, 1);
		...
		if ((!iLocal_409 || !DOES_ENTITY_EXIST(iLocal_380)) || DOES_ENTITY_EXIST(iLocal_380, 0))
		{
			iLocal_380 = CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, true);
			SET_PED_COMPONENT_VARIATION(iLocal_380, 3, iLocal_404, iLocal_405, 0);
			SET_PED_COMPONENT_VARIATION(iLocal_380, 4, 0, iLocal_406, 0);
		...
		{
			SET_ENTITY_COORDS(iLocal_380, -1899.7f, -562.2f, 10.7945f, 1, false, 0, 1);
		...
		if (IS_SCREEN_FADED_OUT())
		{
			if (!iLocal_408)
			{
				NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_78(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_408 = 1;
				wait(0);
			}
			while (!IS_NEW_LOAD_SCENE_LOADED() || (!IS_NEW_LOAD_SCENE_LOADED(iLocal_380) && !IS_NEW_LOAD_SCENE_LOADED(iLocal_380)))
			{
				wait(0);
			}
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		...
		fVar0 = 2f;
		if (!IS_PED_INJURED(iLocal_380) && !IS_PED_INJURED(iLocal_381, 0))
		{
			OPEN_SEQUENCE_TASK(&iLocal_386);
			TASK_ENTER_VEHICLE(0, iLocal_381, -1, -1, fVar0, 1, 0);
			TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_381, -1783.73f, -629.1945f, 9.89f, 20f, 0, TASK_VEHICLE_DRIVE_TO_COORD(iLocal_381), 786484, 10f, 12f);
			...
			FORCE_PED_MOTION_STATE(iLocal_380, -530524, true, 1, 1);
		}
		iLocal_383 = ADD_BLIP_FOR_ENTITY(iLocal_380);
		SET_BLIP_COLOUR(iLocal_383, 1);
		func_121(&iLocal_237);
		SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		iLocal_385 = CREATE_CAMERA_WITH_PARAMS(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
		RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
		DISPLAY_RADAR(false);
		DISPLAY_HUD(false);
	}
	CLEAR_AREA(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, false);
...
int func_95(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_96())
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()) && !IS_PED_INJURED(iParam1))
		{
			if (!IS_ENTITY_PLAYING_ANIM(IS_ENTITY_PLAYING_ANIM(), &cVar1, &Var3, 3))
			{
				TASK_PLAY_ANIM(TASK_PLAY_ANIM(), &cVar1, &Var3, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(iParam1, &cVar1, &cVar4, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(TASK_PLAY_ANIM(), &cVar2, &cVar5, 2f, -1000f, -1, 32 | iVar0, 0, 0, 4, 0);
				TASK_PLAY_ANIM(iParam1, &cVar2, &cVar6, 2f, -1000f, -1, 32 | iVar0, 0, 0, 0, 0);
				_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
				_0x2208438012482A1A(iParam1, 0, 0);
				if (DOES_CAM_EXIST(*iParam2))
				{
					DESTROY_CAM(*iParam2, 0);
				}
				if (!DOES_CAM_EXIST(*iParam2))
				{
					*iParam2 = CREATE_CAMERA(26379945, 0);
				}
			...
			else if (GET_ENTITY_ANIM_CURRENT_TIME(GET_ENTITY_ANIM_CURRENT_TIME(), &cVar1, &Var3) >= 0.99f)
			{
				return 1;
			}
		}
...
void func_100(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_105(iParam0->f_1, 256) || (func_105(iParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_105(iParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
			...
			if (bVar4)
			{
				if (BEGIN_SCALEFORM_MOVIE_METHOD(*iParam0, "SET_DATA_SLOT"))
				{
					...
					while (iVar7 < iParam0->f_2[iVar6 /*15*/].f_14)
					{
						...
						bVar2 = IS_BIT_SET(iParam0->f_2[iVar6 /*15*/].f_13, iVar7);
					...
					if (IS_PC_VERSION())
					{
						if (func_105(iParam0->f_1, 4096))
						{
							if (iParam0->f_2[iVar6 /*15*/].f_1)
							{
								...
								_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0->f_2[iVar6 /*15*/].f_3[0 /*2*/].f_1);
							}
							else
							{
...
void func_109(char* sParam0, var uParam1, int iParam2)
{
	...
	iVar0 |= 98304;
	_REQUEST_CUTSCENE_EX(sParam0, iVar0, 8);
}
	...
	*iParam2 = GET_PLAYERS_LAST_VEHICLE();
	if (DOES_ENTITY_EXIST(*iParam2))
	{
		...
		else
		{
			...
			if (IS_THIS_MODEL_A_BOAT(iVar0) || IS_THIS_MODEL_A_BOAT(iVar0))
			{
				*iParam2 = 0;
			}
			else
			{
				iVar1 = GET_PED_IN_VEHICLE_SEAT(*iParam2, -1, 0);
	...
	if (DOES_ENTITY_EXIST(Global_95196[0]))
	{
		*uParam1 = Global_95196[0];
		SET_ENTITY_AS_MISSION_ENTITY(*uParam1, true, 1);
	}
	...
	if (!DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = CREATE_VEHICLE(iParam7, vParam5, fParam6, true, true, false);
	...
	if (DOES_ENTITY_EXIST(*iParam2))
	{
		...
		{
			SET_ENTITY_AS_MISSION_ENTITY(*iParam2, true, 0);
		}
	}
	func_75(uParam4, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_75(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
	if (DOES_CAM_EXIST(*iParam3))
	{
		DESTROY_CAM(*iParam3, 0);
	}
	if (!DOES_CAM_EXIST(*iParam3))
	{
		*iParam3 = CREATE_CAMERA(26379945, 0);
	}
...
void func_134(int iParam0, int iParam1, int iParam2)
{
	...
	StringCopy(&cVar6, "drfriedlander_idle_01", 24);
	if (iParam1 && !IS_PED_INJURED(IS_PED_INJURED()))
	{
		SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -1907.39f, -577.33f, 17.64f, 1, false, 0, 1);
		SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 318.6574f);
		TASK_PLAY_ANIM(TASK_PLAY_ANIM(), &cVar1, &cVar3, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(TASK_PLAY_ANIM(), &cVar2, &cVar5, 1000f, -2f, -1, 32 | iVar0, 0, 0, 4, 0);
		_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
	}
	if (iParam2 && !IS_PED_INJURED(iParam0))
	{
		SET_ENTITY_COORDS(iParam0, -1907.69f, -574.77f, 17.67f, 1, false, 0, 1);
		SET_ENTITY_HEADING(iParam0, 177f);
		TASK_PLAY_ANIM(iParam0, &cVar1, &cVar4, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(iParam0, &cVar2, &cVar6, 1000f, -2f, -1, 32 | iVar0, 0, 0, 0, 0);
...
float func_137(int iParam0)
{
	if (func_77(iParam0))
	{
		...
		{
			return (func_52(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_146(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_162(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_154(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_154(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = _GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_146(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
struct<4> func_226(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_231(&(Global_111560.f_19956), 8) && iParam1) && iParam0 != 4) && func_229(3) > 0) && GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
