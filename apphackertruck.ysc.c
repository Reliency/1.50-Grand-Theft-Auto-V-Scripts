...
void __EntryFunction__()
{
	...
	iLocal_374 = 1;
	iLocal_375 = -1;
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH("appBusinessHub")) > 1)
	{
		func_531(0, 1);
	}
...
void func_4()
{
	...
	func_443();
	if (IS_BIT_SET(iLocal_197, 3))
	{
		if (_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(iLocal_379))
		{
			iVar0 = _GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(iLocal_379);
			switch (iVar0)
			{
				case 0:
					func_442();
...
void func_6()
{
	...
	while (iVar0 < 5)
	{
		...
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "ADD_JOB");
		...
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar1);
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "SHOW_JOB_OVERLAY");
...
void func_29()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "CLEAR_JOBS");
	END_SCALEFORM_MOVIE_METHOD();
	iVar0 = 0;
	while (iVar0 < 9)
	{
...
void func_37(int iParam0)
{
	...
	{
		iLocal_377 = func_203(PLAYER_ID(), iVar0);
...
int func_39(int iParam0)
{
	...
	if (!func_200(PLAYER_ID(), iParam0, 0))
	{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_114(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		
		case 233:
			return func_107(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(iParam5), iParam4);
		...
		case 158:
			return func_85(iParam1, iParam2, INT_TO_PLAYERINDEX(iParam5), iParam4);
...
int func_135(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_160(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
		
		case 233:
			return func_151(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(iParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_142(iParam1, iParam3, INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
		
		case 158:
			return func_136(iParam1, iParam3, INT_TO_PLAYERINDEX(iParam5), 0, -1, 0, 0);
...
int func_205()
{
	if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[5 /*12*/].f_4 == 1 && !func_23(5))
	{
		return 1;
	}
	return 0;
...
void func_206()
{
	...
	else if (func_207(PLAYER_ID(), func_210(PLAYER_ID())))
	{
	...
	else
	{
		...
		else
		{
			...
			if (iVar9 <= 0)
			{
				if (!func_214())
				{
					iVar9 = (Global_262145.f_15084 - ABSI(ABSI(ABSI(), Global_2509053.f_142)));
				}
			}
			if (iVar9 > 0)
			{
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar0);
			func_8(&Var3);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar9);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar10);
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar5);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(-1);
			END_SCALEFORM_MOVIE_METHOD();
			iVar0++;
		}
...
int func_215(int iParam0)
{
	...
	if (func_220(iParam0))
	{
		if (func_219(iParam0))
		{
			...
			iVar2 = ((iVar1 + func_216()) - 0xF12E6CD06C73D69E());
			return iVar2;
		}
	}
	return -1;
...
bool func_231()
{
	return IS_BIT_SET(iLocal_197, 6);
}
...
int func_246(int iParam0, int iParam1)
{
	...
	while (iVar2 < 32)
	{
		...
		{
			bVar9 = ((func_54(iVar6) != iVar5 || iVar5 == func_18()) && iVar6 != PLAYER_ID());
			iVar4 = 0;
			while (iVar4 < 10)
			{
				if (iVar0[iVar4] != -1)
				{
					...
					if (!func_307(vVar7))
					{
						if (DOES_BLIP_EXIST(Global_2416074[iVar6]))
						{
							vVar8 = { GET_BLIP_COORDS(Global_2416074[iVar6]) };
							vVar8.z = _0x336511A34F2E5185(vVar8.x, vVar8.y);
						}
						else
						{
						...
						if (!func_307(vVar8))
						{
							if (vdist2(vVar8, vVar7) < (func_250(iParam0, bVar9) * func_250(iParam0, bVar9)))
							{
								iVar0[iVar4] = -1;
								if (!bVar9)
								{
...
int func_247(int iParam0, int iParam1)
{
	...
	{
		case 240:
			if (DOES_BLIP_EXIST(Global_2416074[DOES_BLIP_EXIST()]))
			{
				vVar0 = { GET_BLIP_COORDS(Global_2416074[GET_BLIP_COORDS()]) };
				vVar0.z = _0x336511A34F2E5185(vVar0.x, vVar0.y);
			}
			else
			{
				vVar0 = { func_251(PLAYER_ID()) };
			}
			if (vdist2(func_308(iParam0, iParam1), vVar0) > (func_248(iParam0) * func_248(iParam0)))
			{
				return 1;
			}
			break;
...
Vector3 func_251(int iParam0)
{
	...
	{
		vVar1 = { func_305(func_306(Global_1590446[PLAYER_ID() /*871*/].f_273.f_26)) };
		if (vmag(vVar1) > 0f)
		{
			return vVar1;
		}
...
int func_301(int iParam0)
{
	if (iParam0 != func_18())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_309(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_325(int iParam0)
{
	if (func_42(PLAYER_ID()))
	{
		return func_326(PLAYER_ID(), iParam0);
	}
	return 0;
}
...
void func_327()
{
	...
	while (iVar0 < 9)
	{
		...
		bVar4 = ((func_331(PLAYER_ID()) && func_329(PLAYER_ID())) && !func_239(PLAYER_ID()));
		iVar5 = 0;
		iVar6 = 0;
...
int func_328(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = ABSI((iParam2 - ABSI(ABSI(iVar1, iParam0))));
	iVar0 = (iVar0 / 1000);
	return iVar0;
}
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "SHOW_OVERLAY");
	func_8(sParam0);
...
void func_347(int iParam0)
{
	...
	{
		CLEAR_BIT(&(Global_1676879.f_3), 28);
	}
	iLocal_204 = iParam0;
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "SHOW_SCREEN");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
	END_SCALEFORM_MOVIE_METHOD();
}
...
void func_348()
{
	...
	switch (func_441())
	{
		...
		case 3:
			...
			{
				SET_BIT(&(Global_1676879.f_4), 4);
				func_428(167);
			}
			break;
		
		case 4:
			if (func_207(PLAYER_ID(), func_210(PLAYER_ID())))
			{
				func_344("HT_VC_P1", "SEC_V_STEAL_F", "OR_OVRLY_OK", "", 1, 0, 0, -1, -1, 0, 0);
			}
			else if (func_383())
			{
				SET_BIT(&(Global_1676879.f_4), 5);
				func_381();
				func_380(1);
				func_531(0, 1);
			}
		...
		case 5:
			if (func_356(func_35(PLAYER_ID()), 225))
			{
...
int func_365()
{
	...
	if (!bVar0)
	{
		if (!_NETWORK_SHOP_GET_TRANSACTIONS_ENABLED_FOR_CHARACTER(func_159()) || _NETWORK_SHOP_GET_TRANSACTIONS_ENABLED_FOR_CHARACTER())
		{
...
int func_398(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1628955[PLAYER_ID() /*614*/].f_11.f_354[iVar0] = func_404(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1628955[PLAYER_ID() /*614*/].f_11.f_354[iVar0] = func_399(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
void func_407()
{
	...
	iVar3 = Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_1;
	Global_1676815 = 0;
	iVar0 = 0;
	while (iVar0 < 32)
	{
	...
	while (iVar0 < 32)
	{
		...
		else if (func_409(PLAYER_ID(), Global_1676816[iVar0]))
		{
			iVar7 = func_408(iVar5, &(Global_1676816[iVar0]));
			if (func_409(PLAYER_ID(), Global_1676816[iVar0]))
			{
...
int func_410(var uParam0)
{
	...
	while (iVar2 < 3)
	{
		if (func_409(PLAYER_ID(), (iVar1 + iVar2)))
		{
			return 1;
		}
		iVar2++;
...
void func_413(bool bParam0)
{
	...
	if (!bParam0)
	{
		...
		while (iVar0 < 32)
		{
			...
			{
				if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_130.f_1 < 32)
				{
					if (func_410(Global_1676816[iVar0]))
					{
						Global_1676816[iVar0] = 0;
...
int func_414(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (iVar3 > 0)
	{
		if (!NETWORK_CAN_SPEND_MONEY(iVar3, false, true, 0, -1, 0))
		{
			PLAY_SOUND_FRONTEND(-1, "Select_Mission_Unavailable", "DLC_GR_MOC_Computer_Sounds", true);
			return 0;
		}
	...
	if (iVar3 >= 0 && (iVar3 == 0 || (iVar3 > 0 && (func_379() || NETWORK_CAN_SPEND_MONEY(iVar3, false, true, 0, -1, 0)))))
	{
		if (iVar3 > 0)
		{
		...
		if (func_379())
		{
			_NETWORK_SHOP_SET_TELEMETRY_NONCE_SEED(func_369(func_376()));
		}
		0x30FD873ECE50E9F6(iVar3, iParam0, 0x30FD873ECE50E9F6(&cVar1), 0, 1);
		if (func_379())
		{
			func_361(func_376());
		}
...
int func_421(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	if (*iParam7)
	{
		...
		{
			case 0:
				if (!NETWORK_CAN_SPEND_MONEY(iParam1, false, true, 0, -1, 0))
				{
					*iParam8 = 3;
					return 1;
				}
...
{
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_193 = uParam0;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_193.f_1 = uParam1;
}
...
{
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_230 = uParam0;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_230.f_22 = uParam1;
}
...
{
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_182 = uParam0;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_182.f_1 = uParam1;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_182.f_2 = uParam2;
	Global_1628955[PLAYER_ID() /*614*/].f_11.f_182.f_3 = uParam3;
}
...
void func_442()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "HIDE_OVERLAY");
	END_SCALEFORM_MOVIE_METHOD();
	func_345(0);
...
void func_443()
{
	if (func_444())
	{
		if (!IS_BIT_SET(iLocal_197, 3))
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "GET_CURRENT_SELECTION");
			iLocal_379 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
...
void func_445()
{
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_450(2, 206, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 206))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_450(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (IS_CONTROL_JUST_PRESSED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_450(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_450(2, 189, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 189))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_450(2, 190, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 190))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_450(2, 201, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 201))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_450(2, 202, 1);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_450(2, 204, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 204))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_378, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "SET_ANALOG_STICK_INPUT");
			iLocal_380 = iVar0;
			iLocal_381 = iVar1;
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_380);
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_381);
			END_SCALEFORM_MOVIE_METHOD();
		}
	}
	func_450(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_382 != 127) || iVar3 != 127) || iLocal_383 != 127)
	{
		...
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_382);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_383);
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar4);
		END_SCALEFORM_MOVIE_METHOD();
	}
...
void func_446()
{
	...
	else if (IS_BIT_SET(iLocal_197, 5))
	{
		CLEAR_BIT(&iLocal_197, 5);
		func_316();
	}
	else if (func_448())
	{
...
void func_447()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "HIDE_JOB_OVERLAY");
	END_SCALEFORM_MOVIE_METHOD();
	CLEAR_BIT(&iLocal_197, 4);
	CLEAR_BIT(&iLocal_197, 5);
}

bool func_448()
{
	return IS_BIT_SET(iLocal_197, 4);
}

bool func_449()
{
	return IS_BIT_SET(iLocal_197, 0);
}
...
void func_452()
{
	...
	_SET_UI_LAYER(1);
	DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_378, 255, 255, 255, 255, 0);
	func_463();
	func_456(0);
	func_453(1);
}
...
void func_469(int iParam0)
{
	...
	else
	{
		func_238(&uLocal_386);
		iLocal_200 = 0;
		if (!func_211(12) || IS_BIT_SET(iLocal_197, 7))
		{
			if (func_1(&uLocal_384, 500, 0))
			{
				func_238(&uLocal_384);
...
void func_470(int iParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "UPDATE_MISSION");
	iVar0 = iParam0;
	iVar1 = 0;
...
int func_472(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			return (func_324(PLAYER_ID()) && func_325(0));
			break;
		
		case 3:
			return (func_315(PLAYER_ID()) && func_325(0));
			break;
		
		case 4:
			return ((func_34(PLAYER_ID()) && func_475(1)) && !func_474(5));
			break;
		
		case 5:
			if (func_473(PLAYER_ID()) && func_32(PLAYER_ID()))
			{
				return 1;
			}
			break;
	...
	switch (iParam0)
	{
		...
		case 6:
			...
			while (iVar0 < 6)
			{
				...
				if (func_20(iVar1))
				{
					if (func_27(iVar1) == func_476(iParam0) && func_21(PLAYER_ID(), iVar1))
					{
						iVar2 = func_19(PLAYER_ID(), iVar1);
						if (Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[iVar2 /*12*/].f_7 || Global_1366477[iVar2] != 0)
						{
							return Global_1590446[PLAYER_ID() /*871*/].f_273.f_179[iVar2 /*12*/].f_4 > 0;
						}
					}
				}
				iVar0++;
		...
		case 2:
			...
			while (iVar0 < func_228())
			{
				...
				if (iVar1 <= 0)
				{
					if (!func_214())
					{
						iVar1 = (Global_262145.f_15084 - ABSI(ABSI(ABSI(), Global_2509053.f_142)));
					}
				}
				if (iVar1 >= 0)
				{
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_378, "UPDATE_COOLDOWN");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
				...
				else
				{
					...
					if (!bVar4)
					{
						...
						if (iVar3 <= 0)
						{
							if (!func_214())
							{
								iVar3 = (Global_262145.f_15084 - ABSI(ABSI(ABSI(), Global_2509053.f_142)));
							}
						}
...
void func_498()
{
	...
	{
		if (func_501(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_509()
{
	...
	if (!IS_BIT_SET(iLocal_197, 8) && !func_517())
	{
		if (IS_BIT_SET(iLocal_197, 10))
		{
			if (IS_BIT_SET(Global_1676734, 16) || IS_BIT_SET(iLocal_197, 12))
			{
				SET_BIT(&iLocal_197, 9);
				return;
			}
			else if (IS_BIT_SET(Global_1676879.f_3, 28))
			{
				if (!IS_BIT_SET(iLocal_197, 11))
				{
					if (func_515())
					{
						if (!IS_BIT_SET(Global_1676734, 17))
						{
							bVar0 = true;
							iLocal_201 = 9000;
							iLocal_202 = func_514(1);
							SET_BIT(&Global_1676734, 17);
		...
		else
		{
			...
			if (((IS_BIT_SET(iLocal_197, 4) && iLocal_206 == 0) && !func_479(22143, -1, -1)) && !bVar0)
			{
				bVar0 = true;
				iLocal_201 = 9000;
				iLocal_202 = 2;
	...
	else if (IS_BIT_SET(iLocal_197, 8))
	{
...
void func_518()
{
	...
	else if (func_451() || IS_CONTROL_JUST_RELEASED(2, 199))
	{
		func_531(0, 1);
	}
...
{
	func_518();
	iLocal_378 = 0x67D02A194A2FC2BD("hacker_truck_desktop");
	while (!HAS_SCALEFORM_MOVIE_LOADED(iLocal_378))
	{
		wait(0);
	}
	func_457(1);
...
{
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_378);
	func_527(iParam0);
	func_529(0);
	func_532();
