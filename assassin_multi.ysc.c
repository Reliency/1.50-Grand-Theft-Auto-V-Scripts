...
void __EntryFunction__()
{
	...
	iLocal_134 = 100;
	iLocal_135 = 3;
	iLocal_725 = _0x4A9923385BDB9DAD();
	iLocal_726 = _GET_BLIP_INFO_ID_ITERATOR();
	iLocal_968 = 1;
	iLocal_1149 = -1;
	fLocal_1151 = 1f;
	...
	if (HAS_FORCE_CLEANUP_OCCURRED(3))
	{
		...
		{
			SET_ENTITY_VISIBLE(iLocal_1171, true, 0);
			SET_ENTITY_COLLISION(iLocal_1171, true, 0);
			SET_ENTITY_CAN_BE_DAMAGED(iLocal_1171, true);
		}
	...
	iLocal_1266 = ADD_SCENARIO_BLOCKING_AREA(vLocal_1253 - Vector(2f, 2f, 2f), vLocal_1253 + Vector(2f, 2f, 2f), 0, 1, 1, 1);
	func_508();
	iLocal_1150 = 1;
	...
	while (true)
	{
		...
		if (func_499(&uScriptParam_1871))
		{
			if (func_498())
			{
				...
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1266, 0);
				func_518();
...
int func_21(var uParam0)
{
	...
	{
		case 0:
			if (IntToFloat(iLocal_1235) >= ((fLocal_1250 * 1f) / 2f) && !IS_MESSAGE_BEING_DISPLAYED())
			{
...
float func_45(int iParam0)
{
	if (func_497(iParam0))
	{
		...
		{
			return (func_46(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_50(iParam2), 1);
}
	...
	if (iLocal_968 > 4)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1263 && !IS_ENTITY_IN_WATER(iVar0)) && !IS_ENTITY_IN_WATER(iVar0))
					{
						iLocal_1263 = iVar0;
						SET_ENTITY_AS_MISSION_ENTITY(iLocal_1263, true, 0);
						_0x02398B627547189C(iLocal_1263, 0);
					}
				}
			}
		}
...
void func_53(struct<39> Param0, var uParam1, var uParam2)
{
	...
	switch (iLocal_970)
	{
		...
		case 1:
			...
			if (func_141(&uLocal_139, 1, 0) && _0x6F259F82D873B8B8())
			{
...
void func_61(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_63() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_63() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_62(iParam0));
...
bool func_69(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_63() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_101(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_107(uParam0->f_1, 256) || (func_107(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_107(uParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_110(var uParam0, bool bParam1)
{
	...
	func_106(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, true));
	func_105("ES_HELP");
	if (IS_PC_VERSION())
	{
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
	...
	if (bParam1)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		func_106(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, true));
		func_105("ES_XPAND");
		if (IS_PC_VERSION())
		{
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
...
void func_112(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_127();
		DRAW_RECT(0.5f, (fVar1 - (func_130((2f - 0.5f)) - 0.001388889f)), fVar6, func_125(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_111((fVar11 / (0.6f * func_130(25f))), 0f, 1f);
					func_127();
					DRAW_RECT(0.5f, (fVar1 + func_130((2f * 0.5f))), fVar6, func_125(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_130((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_130((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					END_TEXT_COMMAND_DISPLAY_TEXT(fVar20, (fVar1 + func_130((2f * 2f))), 0);
					break;
...
void func_122(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			DRAW_SPRITE("CommonMenu", func_118(7, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_115(5, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_118(5, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_115(6, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_118(6, 0), (fParam4 - 0.006f), ((fParam2 + func_130(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_142(var uParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	func_106(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, true));
	func_105("ES_HELP_TU");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
	func_106(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, true));
	func_105("ES_HELP_TD");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
	func_106(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, true));
	func_105("ES_HELP_AB");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	END_SCALEFORM_MOVIE_METHOD();
...
void func_145()
{
	...
	if (!iLocal_128)
	{
		...
		else
		{
			...
			if (!IS_STRING_NULL_OR_EMPTY(&(Local_716.f_18)))
			{
				if (bLocal_126)
				{
...
void func_154(int iParam0)
{
	if (func_497(iParam0))
	{
		if (!func_47(iParam0))
		{
			iParam0->f_2 = (func_46(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
			SET_BIT(iParam0, 2);
		}
	}
}
...
{
	iParam0->f_1 = (func_46(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
	...
	switch (iLocal_968)
	{
		...
		case 4:
			...
			if (bLocal_1204)
			{
				...
				CLEAR_AREA(vLocal_1256, 5f, 1, 0, 0, false);
		...
		case 7:
			...
			if (iLocal_1167 >= 2)
			{
				if (DOES_ENTITY_EXIST(iLocal_1259))
				{
					if (func_281(iLocal_1259, PLAYER_PED_ID(), 1) > 500f)
					{
						SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1259);
					}
				}
			}
			if (!iLocal_1226)
			...
			{
				if ((func_264(uParam0, uParam1) || (IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), *uParam1) && func_263(*uParam1, 1) < 150f)) || (IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), *uParam1) && func_263(*uParam1, 1) < 150f))
				{
					func_262(*uParam1);
					iLocal_968 = 10;
				}
		...
		case 10:
			...
			{
				if (iLocal_1206 && !IS_PED_INJURED(*uParam1))
				{
					func_258();
					PLAY_PAIN(*uParam1, 1, 0f, 0);
				}
		...
		case 11:
			...
			{
				if (!IS_PED_INJURED(*uParam1) && iLocal_1167 == 2)
				{
				...
				if (iLocal_1167 == 1)
				{
					if (!IS_PED_INJURED(uParam1->f_7))
					{
						...
						TASK_PLAY_ANIM(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_quick_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
void func_166(var uParam0, int iParam1)
{
	...
	*iParam1 = 0;
	...
	if (DOES_ENTITY_EXIST(iLocal_1258))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1258);
	}
	if (DOES_ENTITY_EXIST(iLocal_1261))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1261);
	}
	if (DOES_ENTITY_EXIST(iLocal_1260))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1260);
	}
	iLocal_1208 = 0;
	iLocal_1238 = 0;
	iLocal_132 = 0;
...
void func_183(int iParam0, var uParam1)
{
	...
	while (iVar0 <= 1)
	{
		if (DOES_ENTITY_EXIST(Local_1870[iVar0 /*9*/]))
		{
			SET_PED_AS_NO_LONGER_NEEDED(&(Local_1870[iVar0 /*9*/]));
		}
		iVar0++;
	}
}
...
void func_184()
{
	...
	while (iVar0 < 4)
	{
		if (DOES_ENTITY_EXIST(iLocal_1262[iVar0]))
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&(iLocal_1262[iVar0]));
		}
		iVar0++;
	}
}
...
void func_185()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1265[iVar0]);
		}
		iVar0++;
	}
}
...
void func_191(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_215(iParam1) && IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_196(char* sParam0)
{
	if (!func_197(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_217(sParam0)) || func_217("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_197(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_204() || func_203(Global_4456448.f_190930)) || func_202())
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			iVar1 = func_201(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(iVar0, iVar1) || (_0xE33FFA906CE74880(iVar0) == 562680400 && iVar1 != -1)) || (_0xE33FFA906CE74880(iVar0) == 1181327175 && iVar1 != -1)) || (((_0xE33FFA906CE74880(iVar0) == -1693015116 && iVar1 == 0) && func_200(iVar0, 10)) && _0xE33FFA906CE74880(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_198(int iParam0)
{
	if (iParam0 != func_28())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_199(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_210(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_213(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1) || func_211(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
	...
	switch (iLocal_1168)
	{
				...
				if (!IS_PED_INJURED(*uParam1))
				{
					...
					if (IS_PED_IN_VEHICLE(*uParam1, uParam1->f_1, 0))
					{
						if (IS_VEHICLE_DRIVEABLE(uParam1->f_1, 0))
						{
							if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
							{
								TASK_VEHICLE_MISSION_PED_TARGET(*uParam1, uParam1->f_1, TASK_VEHICLE_MISSION_PED_TARGET(), 8, 35f, 786468, 500f, -1f, 1);
							}
							else
							{
								TASK_VEHICLE_MISSION(*uParam1, uParam1->f_1, TASK_VEHICLE_MISSION(TASK_VEHICLE_MISSION(), 0), 8, 35f, 786468, 500f, -1f, 1);
							}
						}
					}
					else
					{
						TASK_SMART_FLEE_PED(*uParam1, TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
					}
				}
				settimera(0);
				iLocal_1168 = 2;
		...
		case 2:
			...
			else if (!IS_PED_INJURED(*uParam1))
			{
				...
				if ((func_263(*uParam1, 1) < 15f && !func_51()) && !IS_PED_RAGDOLL(*uParam1))
				{
					if (!iLocal_1211)
					{
...
{
	func_44(&iLocal_1267);
	fLocal_1249 = GET_RANDOM_FLOAT_IN_RANGE(3f, 7f);
}
...
int func_224(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_225(PLAYER_PED_ID(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (IS_PED_RAGDOLL(iParam0) && func_263(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_227(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (IS_PED_PLANTING_BOMB(iParam0) || func_228(iVar1))
			{
				if (IS_ENTITY_AT_COORD(iParam1, IS_ENTITY_AT_COORD(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (IS_PED_FACING_PED(IS_PED_FACING_PED(iParam1), iParam0, 120f) && IS_PED_FACING_PED(iParam1, iParam0, 17))
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1))
				{
					...
					{
						if (func_281(PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
...
int func_231(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (IS_ENTITY_A_VEHICLE(iParam0))
	{
		SET_BLIP_SCALE(iVar0, func_104(SET_BLIP_SCALE(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(iVar0, func_104(SET_BLIP_SCALE(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	else if (IS_ENTITY_AN_OBJECT(iParam0))
	{
...
void func_232(var uParam0)
{
	switch (iLocal_1168)
	{
		...
		case 1:
			if (!iLocal_1206)
			{
				if ((((func_223(*uParam0, 0, &Local_120, &uLocal_122, 0, 1, 0, 1, 1) || HAS_BULLET_IMPACTED_IN_AREA(HAS_BULLET_IMPACTED_IN_AREA(*uParam0, true), 15f, 0, 1)) || iLocal_1208) || func_263(*uParam0, 1) < 5f) || (HAS_BULLET_IMPACTED_IN_AREA(HAS_BULLET_IMPACTED_IN_AREA()) && func_263(*uParam0, 1) <= 35f))
				{
		...
		case 1:
			...
			if (((func_223(*uParam1, uParam1->f_1, &Local_120, &uLocal_122, 0, 1, 0, 1, 1) || func_223(uParam1->f_7, uParam1->f_1, &Local_120, &uLocal_122, 0, 1, 0, 1, 1)) || func_243(uParam1)) || (func_242(*uParam1, 50f) && iLocal_1208))
			{
				if (!IS_PED_INJURED(*uParam1))
				{
					if (fVar1 <= 75f)
					{
						if (!IS_ENTITY_DEAD(uParam1->f_1, 0))
						{
							...
							{
								iLocal_1294 = CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
								ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_1294, uParam1->f_1, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uParam1->f_1, "seat_dside_r"));
								TASK_SYNCHRONIZED_SCENE(*uParam1, iLocal_1294, "veh@boat@marquis@rps@enter_exit", "jump_out", 4f, -4f, 0, 1, 1148846080, 0);
							}
						}
					}
					else
					{
						...
						if (!IS_ENTITY_DEAD(uParam1->f_1, 0))
						{
							iLocal_1294 = CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
							ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_1294, uParam1->f_1, ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uParam1->f_1, "seat_dside_r"));
							TASK_SYNCHRONIZED_SCENE(*uParam1, iLocal_1294, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_m", 4f, -1000f, 0, 1, 1148846080, 0);
						}
					}
				}
				if (!IS_PED_INJURED(uParam1->f_7))
				{
					...
					{
						TASK_PLAY_ANIM(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_steer_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
						TASK_PLAY_ANIM(0, "oddjobs@assassinate@multi@yachttarget@lapdance", "exit_cower_loop_f", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					}
					CLOSE_SEQUENCE_TASK(iVar0);
					TASK_PERFORM_SEQUENCE(uParam1->f_7, iVar0);
				...
				if (!IS_PED_INJURED(uParam1->f_9))
				{
					if (GET_SCRIPT_TASK_STATUS(uParam1->f_9, 1805844857) != 1)
					{
						...
						TASK_SMART_FLEE_PED(uParam1->f_9, TASK_SMART_FLEE_PED(), 200f, -1, 0, 0);
			...
			else
			{
				...
				if (!iLocal_1212)
				{
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_1258, 0))
					{
						if (!IS_PED_INJURED(uParam1->f_9))
						{
							if (GET_SCRIPT_TASK_STATUS(uParam1->f_9, 1805844857) != 1)
			...
			if (!IS_ENTITY_DEAD(*uParam1, 0))
			{
				if (!IS_ENTITY_DEAD(uParam1->f_1, 0))
				{
					if (GET_PED_IN_VEHICLE_SEAT(uParam1->f_1, -1, 0) != *uParam1)
					{
						if (bLocal_1221)
						{
							if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1294))
							{
								fVar2 = GET_SYNCHRONIZED_SCENE_PHASE(iLocal_1294);
							}
							if (fVar2 > 0.8f)
							{
					...
					{
						TASK_VEHICLE_MISSION_COORS_TARGET(*uParam1, uParam1->f_1, TASK_VEHICLE_MISSION_COORS_TARGET(TASK_VEHICLE_MISSION_COORS_TARGET(), true), 8, 20f, 786468, 500f, -1f, 1);
					}
				}
				if (!iLocal_1210)
				{
	...
	switch (iLocal_1234)
	{
		case 0:
			if (!func_51())
			{
				if (iLocal_1233 == -1)
				{
					iLocal_1233 = GET_RANDOM_INT_IN_RANGE(0, 4);
				}
		...
		case 2:
			if (func_220())
			{
				if (iLocal_1233 == -1)
				{
					iLocal_1233 = GET_RANDOM_INT_IN_RANGE(0, 3);
				}
				else if (iLocal_1233 == 0)
				{
...
int func_241(int iParam0)
{
	switch (*iParam0)
	{
		case 0:
			...
			TASK_LOOK_AT_ENTITY(Local_971, TASK_LOOK_AT_ENTITY(), 5000, 0, 2);
			*iParam0++;
			break;
...
int func_243(var uParam0)
{
	...
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_1, 1) || IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_1))
		{
			return 1;
		}
	}
...
void func_244(var uParam0, var uParam1)
{
	...
	switch (iLocal_1168)
	{
		...
		case 1:
			if (((((func_223(*uParam1, 0, &Local_120, &uLocal_122, 1, 0, 0, 1, 1) || func_254(&bLocal_1213)) || func_253(*uParam1, &iLocal_1273, 1f, 20f, &uLocal_1214)) || (func_242(*uParam1, 25f) && iLocal_1208)) || IS_EXPLOSION_IN_ANGLED_AREA(-1, -1218.042f, -1549.616f, -3.3703f, -1185.349f, -1597.103f, 10.5993f, 46f)) || iLocal_1208)
			{
				STOP_SCRIPTED_CONVERSATION(false);
				...
				if (IS_PED_SHOOTING(IS_PED_SHOOTING()) || (iVar2 && iVar1 != joaat("weapon_unarmed")))
				{
					TASK_SMART_FLEE_PED(*uParam1, TASK_SMART_FLEE_PED(), 500f, -1, 0, 0);
				}
				else
				{
					TASK_COMBAT_PED(*uParam1, TASK_COMBAT_PED(), 0, 16);
				}
				func_266(0);
				SET_ENTITY_LOAD_COLLISION_FLAG(*uParam1, true, 1);
				iLocal_1208 = 1;
		...
		case 2:
			...
			{
				iVar0 = func_249(0, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 20f);
				if (iVar0 != 0)
				{
		...
		if (!func_51())
		{
			if (!iLocal_1208)
			{
				if (!iLocal_1209)
				{
					...
					else if (func_263(*uParam0, 1) < 20f && !IS_MESSAGE_BEING_DISPLAYED())
					{
						func_248(uParam0);
					}
				}
...
void func_248(var uParam0)
{
	...
	else if (iLocal_1238 < 7)
	{
		if (func_45(&iLocal_1267) > fLocal_1249 && !func_51())
		{
			...
			func_44(&iLocal_1267);
			fLocal_1249 = GET_RANDOM_FLOAT_IN_RANGE(5f, 8f);
			iLocal_1238++;
		}
	}
}
...
var func_249(bool bParam0, vector3 vParam1, float fParam2)
{
	...
	while (iVar0 <= 1)
	{
		if (!IS_PED_INJURED(Local_1870[iVar0 /*9*/]))
		{
			if ((bParam0 && IS_PED_MALE(Local_1870[iVar0 /*9*/])) || (!bParam0 && !IS_PED_MALE(Local_1870[iVar0 /*9*/])))
			{
	...
	if (!IS_PED_INJURED(Local_1870[iVar0 /*9*/]))
	{
		switch (Local_1870[iVar0 /*9*/].f_8)
		{
			case 0:
				...
				{
					if (GET_SCRIPT_TASK_STATUS(Local_1870[iVar0 /*9*/], 242628503) != 1)
					{
						CLEAR_PED_TASKS(Local_1870[iVar0 /*9*/]);
						OPEN_SEQUENCE_TASK(&iVar1);
						TASK_GO_TO_COORD_ANY_MEANS(0, Local_1870[iVar0 /*9*/].f_1, 1f, 0, 0, 786603, -1082130432);
						TASK_TURN_PED_TO_FACE_COORD(0, vLocal_1253, 0);
						CLOSE_SEQUENCE_TASK(iVar1);
						TASK_PERFORM_SEQUENCE(Local_1870[iVar0 /*9*/], iVar1);
						CLEAR_SEQUENCE_TASK(&iVar1);
					}
				}
				else if (GET_SCRIPT_TASK_STATUS(Local_1870[iVar0 /*9*/], 242628503) != 1 && GET_SCRIPT_TASK_STATUS(Local_1870[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 1:
				if (GET_SCRIPT_TASK_STATUS(Local_1870[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 2:
				if (GET_SCRIPT_TASK_STATUS(Local_1870[iVar0 /*9*/], -1146898486) != 1)
				{
					TASK_WANDER_STANDARD(Local_1870[iVar0 /*9*/], 1193033728, 0);
				}
				break;
			}
	}
	...
	if (!IS_PED_RAGDOLL(iParam0))
	{
		if (bParam1)
		{
			if (IS_PED_MALE(iParam0))
			{
				...
				if (iVar0 == 0)
				{
					TASK_PLAY_ANIM(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_a", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
				}
				else if (iVar0 == 1)
				{
					TASK_PLAY_ANIM(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_b", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
				}
				else
				{
					TASK_PLAY_ANIM(iParam0, "oddjobs@assassinate@multi@", "react_big_variations_c", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
				}
			}
			else
			{
				...
				if (iVar0 == 0)
				{
					TASK_PLAY_ANIM(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
				}
				else
				{
					TASK_PLAY_ANIM(iParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
...
int func_253(int iParam0, int iParam1, float fParam2, float fParam3, var uParam4)
{
	if (func_263(iParam0, 1) < fParam3)
	{
		...
		{
			if (IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
			{
				if (!func_497(iParam1))
				{
					func_44(iParam1);
...
void func_255()
{
	if (DOES_ENTITY_EXIST(Local_971))
	{
		if (!IS_PED_INJURED(Local_971))
		{
			SET_PED_RESET_FLAG(Local_971, 187, true);
			SET_PED_RESET_FLAG(Local_971, 155, true);
		}
	}
}
...
void func_260(var uParam0)
{
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
	{
		if (!IS_PED_INJURED(*uParam0))
		{
			...
			{
				ATTACH_ENTITY_TO_ENTITY(*uParam0, uParam0->f_1, 0, vVar0, vVar1, 1, 1, 0, 0, 2, 1);
			}
		}
		if (!IS_PED_INJURED(uParam0->f_7))
		{
			...
			{
				ATTACH_ENTITY_TO_ENTITY(uParam0->f_7, uParam0->f_1, 0, vVar2, vVar3, 1, 1, 1, 0, 2, 1);
			}
		}
	}
}
...
{
	return func_281(GET_PLAYER_PED(GET_PLAYER_PED()), iParam0, bParam1);
}
...
int func_265(int iParam0)
{
	if (iLocal_1167 == 0)
	{
		if ((func_223(*iParam0, 0, &Local_120, &uLocal_122, 0, 0, 0, 1, 1) || func_254(&bLocal_1213)) || IS_EXPLOSION_IN_SPHERE(-1, vLocal_1253, 25f))
		{
			return 1;
		}
	}
	...
	if (!iLocal_1217)
	{
		...
		while (iVar0 <= 1)
		{
			if (!IS_PED_INJURED(Local_1870[iVar0 /*9*/]))
			{
				...
				if (iVar1 == 0 || iVar1 == 1)
				{
					if (GET_SCRIPT_TASK_STATUS(Local_1870[iVar0 /*9*/], 1805844857) != 1)
					{
						TASK_SMART_FLEE_PED(Local_1870[iVar0 /*9*/], TASK_SMART_FLEE_PED(), 200f, -1, 0, 0);
						SET_PED_KEEP_TASK(Local_1870[iVar0 /*9*/], true);
					}
				}
				else if (GET_SCRIPT_TASK_STATUS(Local_1870[iVar0 /*9*/], 1805844857) != 1)
				{
					TASK_GO_TO_COORD_ANY_MEANS(Local_1870[iVar0 /*9*/], func_267(), 2f, 0, 0, 786603, -1082130432);
					SET_PED_KEEP_TASK(Local_1870[iVar0 /*9*/], true);
				}
			}
			if (bParam0)
...
int func_268(int iParam0, var uParam1)
{
	if (IS_SCREEN_FADED_IN())
	{
		...
		else if (DOES_ENTITY_EXIST(*iParam0))
		{
			if (IS_PED_INJURED(*iParam0))
			{
				if (IS_VEHICLE_DRIVEABLE(iParam0->f_1, 0) && IS_VEHICLE_DRIVEABLE(*iParam0, iParam0->f_1, 1))
				{
					iLocal_953 = 1;
				}
			...
			else if (IS_VEHICLE_DRIVEABLE(iParam0->f_1, 0))
			{
				...
				{
					if (GET_ENTITY_SPEED(iParam0->f_1) > 10f && GET_ENTITY_SPEED(iParam0->f_1, *iParam0))
					{
						if (IS_PED_IN_ANY_VEHICLE(*iParam0, 0))
						{
...
void func_272(var uParam0, int iParam1)
{
	switch (iLocal_1167)
	{
		...
		case 1:
			...
			{
				iParam1->f_9 = CREATE_PED(5, uParam0->f_16, uParam0->f_22, uParam0->f_25, 1, true);
				_0x2208438012482A1A(iParam1->f_9, 0, 0);
				TASK_START_SCENARIO_AT_POSITION(iParam1->f_9, "WORLD_HUMAN_SUNBATHE", uParam0->f_22, uParam0->f_25, 0, 0, 1);
			...
			if (!IS_PED_INJURED(iParam1->f_7))
			{
				...
				SET_PED_DIES_IN_WATER(iParam1->f_7, 0);
			...
			if (DOES_ENTITY_EXIST(iParam1->f_1))
			{
				...
				SET_VEHICLE_RADIO_LOUD(iParam1->f_1, 1);
				_SET_ENTITY_SOMETHING(iParam1->f_1, true);
			}
			if (!IS_PED_INJURED(*iParam1))
			{
				SET_PED_DIES_IN_WATER(*iParam1, 0);
			...
			iLocal_1258 = CREATE_VEHICLE(joaat("seashark"), -2190.741f, -470.3163f, -0.4779f, 308.1181f, true, true, false);
			REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1266, 0);
			iLocal_1266 = ADD_SCENARIO_BLOCKING_AREA(Vector(-0.10296f, -468.8926f, -2182.363f) - Vector(15f, 15f, 15f), Vector(-0.10296f, -468.8926f, -2182.363f) + Vector(15f, 15f, 15f), 0, 1, 1, 1);
			iLocal_1233 = -1;
			iLocal_1234 = 0;
			break;
		
		case 2:
			if ((!IS_PED_INJURED(*iParam1) && IS_PED_INJURED(iParam1->f_11[0])) && IS_PED_INJURED(iParam1->f_11[1]))
			{
				func_38(&(iParam1->f_16), 3, *iParam1, "OJAmlWASHER", 0, 1);
				ATTACH_ENTITY_TO_ENTITY(*iParam1, iParam1->f_11[0], 0, -2.1f, -0.4f, 0.25f, 0f, 0f, 180f, 1, 1, 0, 0, 2, 1);
				TASK_PLAY_ANIM(*iParam1, "oddjobs@assassinate@multi@windowwasher", "_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 3:
			if (!IS_PED_INJURED(*iParam1))
			{
				...
				GIVE_PED_HELMET(*iParam1, 0, 4096, -1);
				SET_PED_HELMET(*iParam1, 1);
				...
				if (IS_VEHICLE_DRIVEABLE(iParam1->f_1, 0))
				{
					...
					SET_VEHICLE_ON_GROUND_PROPERLY(iParam1->f_1, 1084227584);
				}
			}
			iLocal_1260 = CREATE_VEHICLE(joaat("camper"), -1400.575f, 738.8264f, 182.1478f, 194.607f, true, true, false);
			SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1260, 1084227584);
			iLocal_1261 = CREATE_VEHICLE(joaat("bjxl"), -1371.269f, 734.4243f, 182.5433f, 182.766f, true, true, false);
			SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1261, 1084227584);
			break;
	}
	if (!IS_PED_INJURED(*iParam1))
	{
...
void func_273()
{
	...
	Local_1870[0 /*9*/] = CREATE_PED(5, joaat("a_f_y_fitness_02"), Local_1870[0 /*9*/].f_1, 169.9513f, 1, true);
	func_252(Local_1870[0 /*9*/], 1);
	Local_1870[1 /*9*/] = CREATE_PED(5, joaat("a_f_y_beach_01"), Local_1870[1 /*9*/].f_1, 257.4617f, 1, true);
	func_252(Local_1870[1 /*9*/], 1);
	SET_PED_COMBAT_ATTRIBUTES(Local_1870[0 /*9*/], 17, true);
	SET_PED_COMBAT_ATTRIBUTES(Local_1870[0 /*9*/], 1, false);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1870[0 /*9*/], true);
	SET_PED_COMBAT_ATTRIBUTES(Local_1870[1 /*9*/], 17, true);
	SET_PED_COMBAT_ATTRIBUTES(Local_1870[1 /*9*/], 1, false);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1870[1 /*9*/], true);
}
...
void func_274(var uParam0, int iParam1)
{
	...
	if (uParam0->f_14 != 0 && uParam0->f_274 != 0)
	{
		...
		{
			iParam1->f_7 = CREATE_PED(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, 1, true);
			if (uParam0->f_274 == 1)
			{
				TASK_PLAY_ANIM(iParam1->f_7, "ODDJOBS@ASSASSINATE@VICE@HOOKER", "idle_b", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
				SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(iParam1->f_7, 1);
	...
	if (uParam0->f_15 != 0)
	{
		...
		if (uParam0->f_274 == 1)
		{
			...
			iLocal_955 = CREATE_PED_INSIDE_VEHICLE(iParam1->f_8, 4, uParam0->f_16, -1, 1, true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_955, true);
	...
	while (iVar0 < 4)
	{
		if (!func_275(uParam0->f_249[iVar0 /*3*/]))
		{
			...
			SET_ENTITY_RECORDS_COLLISIONS(iParam1->f_11[iVar0], 1);
			SET_ENTITY_COLLISION(iParam1->f_11[iVar0], true, 0);
			if (iVar0 == 1)
			{
...
void func_277(var uParam0, var uParam1)
{
	if (!DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = CREATE_PED(4, *uParam0, uParam0->f_1, uParam0->f_4, 1, true);
		...
		if (!iLocal_957)
		{
			ADD_RELATIONSHIP_GROUP("Target", &iLocal_967);
			iLocal_957 = 1;
		}
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_967, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_967);
		SET_PED_RELATIONSHIP_GROUP_HASH(*uParam1, iLocal_967);
		if (uParam0->f_268)
		{
...
{
	return func_250(GET_PLAYER_PED(GET_PLAYER_PED()), vParam0, bParam1);
}
...
void func_282()
{
	...
	if (func_497(&iLocal_1279))
	{
		if (func_45(&iLocal_1279) > 30f)
		{
			...
			if (iLocal_1230 == 1)
			{
				if (vdist(vVar0, vLocal_1292[0 /*3*/]) < 100f || IS_PED_IN_FLYING_VEHICLE(IS_PED_IN_FLYING_VEHICLE()))
				{
					if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
					{
			...
			{
				if (vdist(vVar0, vLocal_1292[1 /*3*/]) < 100f || IS_PED_IN_FLYING_VEHICLE(IS_PED_IN_FLYING_VEHICLE()))
				{
					if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
					{
						SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 2, 0);
			...
			{
				if (vdist(vVar0, vLocal_1292[2 /*3*/]) < 100f || IS_PED_IN_FLYING_VEHICLE(IS_PED_IN_FLYING_VEHICLE()))
				{
					if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
					{
						SET_PLAYER_WANTED_LEVEL(SET_PLAYER_WANTED_LEVEL(), 2, 0);
...
void func_283()
{
	if (iLocal_1167 == 2)
	{
		if (!DOES_ROPE_EXIST(&iLocal_1252))
		{
			if (!IS_PED_INJURED(Local_971))
			{
				if (!iLocal_1206)
				{
					SET_ENTITY_LOAD_COLLISION_FLAG(Local_971, true, 1);
					SET_PED_TO_RAGDOLL(Local_971, 1, 1, 0, 1, 1, 0);
				}
			}
		...
		else if (!DOES_ROPE_EXIST(&iLocal_1251))
		{
			if (!IS_PED_INJURED(Local_971))
			{
				if (!iLocal_1206)
...
void func_284(var uParam0, var uParam1)
{
	...
	{
		vVar3 = { GET_ENTITY_COORDS(uParam1->f_11[0], true) };
	}
	else
	{
	...
	if (!IS_ENTITY_DEAD(*uParam1, 0))
	{
		vVar1 = { GET_ENTITY_COORDS(*uParam1, true) };
	}
	switch (iLocal_1240)
	{
		case 0:
						...
						if (DOES_ENTITY_EXIST(uParam1->f_11[0]))
						{
							if (DOES_ENTITY_EXIST(uParam1->f_11[1]))
							{
								...
								else
								{
									if (!DOES_ROPE_EXIST(&iLocal_1252))
									{
										iLocal_1252 = ADD_ROPE(-648.59f, 305.73f, fVar5, 0f, 90f, 0f, fVar6, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (!DOES_ROPE_EXIST(&iLocal_1251))
									{
										iLocal_1251 = ADD_ROPE(-638.93f, 304.92f, fVar5, 0f, 90f, 0f, fVar6, 0, -1f, 5f, 0.5f, 0, 0, 1, 5f, 1, 0);
									}
									if (DOES_ROPE_EXIST(&iLocal_1251) && DOES_ROPE_EXIST(&iLocal_1252))
									{
										ATTACH_ENTITIES_TO_ROPE(iLocal_1252, uParam1->f_11[1], uParam1->f_11[0], -648.59f, 305.73f, fVar5, -648.59f, 305.73f, vVar3.z, fVar6, 0, 0, 0, 0);
										ATTACH_ENTITIES_TO_ROPE(iLocal_1251, uParam1->f_11[1], uParam1->f_11[0], -638.93f, 304.92f, fVar5, -638.93f, 304.92f, vVar3.z, fVar6, 0, 0, 0, 0);
										bLocal_1215 = true;
										iLocal_1240 = 1;
									}
								}
				...
				if (IS_ENTITY_ON_SCREEN(uParam1->f_11[0]))
				{
					if (iLocal_1168 < 2)
					{
						if (!IS_PED_INJURED(*uParam1))
						{
							...
							TASK_PLAY_ANIM(0, "oddjobs@assassinate@multi@windowwasher", "_idle_to_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
		...
		case 2:
			vVar2 = { GET_ENTITY_COORDS(uParam1->f_11[0], true) };
			if (IS_ENTITY_DEAD(*uParam1, 0))
			{
				iLocal_1240 = 3;
			}
			if (DOES_ROPE_EXIST(&iLocal_1252) && DOES_ROPE_EXIST(&iLocal_1251))
			{
				START_ROPE_WINDING(iLocal_1252);
				START_ROPE_WINDING(iLocal_1251);
				if (vVar2.z >= 125f)
				{
					if (iLocal_1168 < 2)
					{
						...
						{
							OPEN_SEQUENCE_TASK(&iVar4);
							TASK_PLAY_ANIM(0, "oddjobs@assassinate@multi@windowwasher", "_up_to_wash", 8f, -8f, -1, 0, 0, 0, 0, 0);
					...
					STOP_ROPE_WINDING(iLocal_1252);
					STOP_ROPE_WINDING(iLocal_1251);
					iLocal_1240 = 3;
...
void func_285()
{
	if (!DOES_ENTITY_EXIST(iLocal_1264))
	{
		if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
				iLocal_1264 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
				if (DOES_ENTITY_EXIST(iLocal_1264) && !DOES_ENTITY_EXIST(iLocal_1264, 0))
				{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_293(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_302()
{
	...
	if (!DOES_ENTITY_EXIST(iLocal_1172))
	{
		return;
	}
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
...
void func_304(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_371(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_364(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_306(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_306(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_10();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_316())
		{
			func_312(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_318(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_323(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_320(Var7.f_1)) && iVar9 < 51)
			{
...
int func_328(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_350())
		{
			*uParam0 = func_334(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_330(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_332() == 0)
		{
			return IS_BIT_SET(func_70(func_331(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_334(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_349(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_335(iVar0, 0), true);
...
var func_351()
{
	...
	func_361(&uVar0, GET_CLOCK_SECONDS());
	func_360(&uVar0, GET_CLOCK_MINUTES());
	func_359(&uVar0, GET_CLOCK_HOURS());
	func_354(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_353(&uVar0, GET_CLOCK_MONTH());
	func_352(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_357(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_398(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!HAS_ADDITIONAL_TEXT_LOADED(3) && !func_394(&(uParam0->f_34))) && !func_390(uParam1))
	{
		func_501(uParam1);
		return 0;
	}
...
void func_416()
{
	if (!DOES_ENTITY_EXIST(iLocal_1262[0]))
	{
		iLocal_1262[0] = CREATE_VEHICLE(iLocal_1265[0], -723.8201f, -916.5402f, 18.0145f, 267.798f, true, true, false);
	}
	if (!DOES_ENTITY_EXIST(iLocal_1262[1]))
	{
		iLocal_1262[1] = CREATE_VEHICLE(iLocal_1265[1], -735.5003f, -931.6205f, 18.0173f, 359.3239f, true, true, false);
		SET_ENTITY_LOD_DIST(iLocal_1262[1], 100);
	}
	if (!DOES_ENTITY_EXIST(iLocal_1262[2]))
	{
		iLocal_1262[2] = CREATE_VEHICLE(iLocal_1265[0], -726.7143f, -940.2681f, 18.0173f, 178.3615f, true, true, false);
	}
	if (!DOES_ENTITY_EXIST(iLocal_1262[3]))
	{
		iLocal_1262[3] = CREATE_VEHICLE(iLocal_1265[2], -730.5711f, -909.9425f, 18.0349f, 357.4066f, true, true, false);
	}
}
	...
	if (func_401(uParam0))
	{
		...
		if (func_400(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_435(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_310(iParam0, 0, 0)) || func_310(iParam0, 1, 0)) || func_310(iParam0, 2, 0)) || func_291(iParam0) != 145) || func_425(iParam0)) || func_424(iParam0)) || func_423(iParam0)) || func_422(iParam0)) || !func_421(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_424(iParam0))
		{
		}
...
int func_435(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_436(iParam0, uVar1[iVar3], 1) && func_402(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_209(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_438(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_293(iParam0, iParam1))
				{
...
void func_439(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_296(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_296(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_296(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_447(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_446())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_296(iVar2 + 1)))
				{
...
int func_440(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_444(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_443(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_443(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_442(iParam0);
	if (func_441(*iParam0))
	{
...
void func_456(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!HAS_ADDITIONAL_TEXT_LOADED(3) || !func_394(&(uParam0->f_34))) || !func_390(uParam1))
	{
		func_501(uParam1);
		wait(0);
	}
...
void func_472()
{
	...
	while (iVar0 < 3)
	{
		REQUEST_MODEL(iLocal_1265[iVar0]);
		iVar0++;
	}
}
...
void func_475(var uParam0)
{
	...
	switch (iLocal_1170)
	{
		case 0:
			...
			if ((HAS_ANIM_DICT_LOADED("oddjobs@assassinate@multi@call") && HAS_ANIM_DICT_LOADED(-1559354806)) && func_389())
			{
				bLocal_1225 = true;
			}
			if (bLocal_1225)
			{
				if (DOES_ENTITY_EXIST(iLocal_1171))
				{
					...
					CLEAR_AREA(-700.1226f, -916.8699f, 18.1667f, 5f, 1, 0, 0, false);
					...
					if (DOES_ENTITY_EXIST(iLocal_1171))
					{
						SET_ENTITY_VISIBLE(iLocal_1171, false, 0);
						SET_ENTITY_COLLISION(iLocal_1171, false, 0);
						SET_ENTITY_CAN_BE_DAMAGED(iLocal_1171, false);
						iLocal_1172 = CREATE_OBJECT(-1559354806, -700.1226f, -916.8699f, 18.1667f, true, true, false);
						SET_ENTITY_ROTATION(iLocal_1172, 0f, 0f, 0f, 2, 1);
						SET_ENTITY_COLLISION(iLocal_1172, false, 0);
						SET_ENTITY_CAN_BE_DAMAGED(iLocal_1172, false);
					}
					iLocal_1196 = FORMAT_FOCUS_HEADING(-700.1226f, -916.8699f, 18.1667f, 350f, 12, 127);
					func_481(1, 1, 1, 0, 0, 0);
					if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
					{
						_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
						SET_ENTITY_COORDS(SET_ENTITY_COORDS(), vLocal_1176, 1, false, 0, 1);
						SET_ENTITY_HEADING(SET_ENTITY_HEADING(), fLocal_1177);
						SET_CURRENT_PED_WEAPON(SET_CURRENT_PED_WEAPON(), joaat("weapon_unarmed"), true);
						REMOVE_PED_HELMET(REMOVE_PED_HELMET(), 1);
					}
					iLocal_1195 = CREATE_SYNCHRONIZED_SCENE(vLocal_1193, vLocal_1194, 2);
					if (DOES_ENTITY_EXIST(iLocal_1172))
					{
						ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_1195, iLocal_1172, -1);
					}
					TASK_SYNCHRONIZED_SCENE(TASK_SYNCHRONIZED_SCENE(), iLocal_1195, "oddjobs@assassinate@multi@call", "ass_multi_target_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_1172, iLocal_1195, "ass_multi_target_call_phone", "oddjobs@assassinate@multi@call", 1000f, -2f, 0, 1148846080);
					if (!DOES_CAM_EXIST(iLocal_1173))
					{
						iLocal_1174 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1181, vLocal_1182, 35f, 1, 2);
						iLocal_1173 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1183, vLocal_1184, 35f, 0, 2);
						SET_CAM_ACTIVE_WITH_INTERP(iLocal_1173, iLocal_1174, 2500, 1, 1);
						RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
						SHAKE_CAM(iLocal_1173, "HAND_SHAKE", 0.2f);
					}
					func_416();
					func_38(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_38(&(uParam0->f_16), 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				...
				else
				{
					...
					if (!DOES_ENTITY_EXIST(iLocal_1171))
					{
						iLocal_1171 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_1175, 5f, 1281992692, 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1192)
			{
				if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
				{
					if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1195))
					{
						if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_1195) > 0.05f)
						{
			...
			if (((func_497(&iLocal_1185) && func_45(&iLocal_1185) > fLocal_1178) || (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1195) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1195) >= 0.978f)) || bLocal_1191)
			{
				iLocal_1170 = 3;
			}
			break;
		...
		case 2:
			...
			if (bLocal_1191)
			{
				if (IS_SCREEN_FADED_OUT())
				{
					...
					{
						_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
						SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -700.2628f, -917.5313f, 18.2147f, 1, false, 0, 1);
						SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 73.3924f);
					}
					STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_1172, -1000f, 1);
					wait(0);
		...
		case 3:
			...
			if (_0x07C313F94746702C(iLocal_1196))
			{
				_0x1EE7D8DF4425F053(iLocal_1196);
			}
			SET_ENTITY_COLLISION(iLocal_1172, true, 0);
			CLEAR_HD_AREA();
			DISPLAY_RADAR(true);
			DISPLAY_HUD(true);
			...
			SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_1171);
			iLocal_968 = 4;
			break;
	}
}
...
int func_479(int iParam0, float fParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5, float fParam6)
{
	if (DOES_CAM_EXIST(*iParam0))
	{
		if (func_497(&iLocal_1188))
		{
			...
			{
				SET_CAM_COORD(iLocal_1173, vParam2);
				SET_CAM_ROT(iLocal_1173, vParam3, 2);
				SET_CAM_FOV(iLocal_1173, fParam4);
				if (bParam5)
				{
					SHAKE_CAM(iLocal_1173, "HAND_SHAKE", fParam6);
				}
				return 1;
			}
		}
...
void func_481(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_485(IS_PED_INJURED())) && !func_483(IS_PED_INJURED(), 0)) && !func_482()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_485(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
