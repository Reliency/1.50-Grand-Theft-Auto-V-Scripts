...
void __EntryFunction__()
{
	...
	if (!DOES_ENTITY_EXIST(ScriptParam_260.f_4))
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			if (iLocal_207 == 2)
			...
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ScriptParam_260, 5f, joaat("prop_dart_bd_cab_01"), 0))
			{
				ScriptParam_260.f_4 = GET_CLOSEST_OBJECT_OF_TYPE(ScriptParam_260, 5f, joaat("prop_dart_bd_cab_01"), 1, 0, 1);
				_0x163F8B586BC95F2A(ScriptParam_260, 5f, joaat("prop_dart_bd_cab_01"), &ScriptParam_260, &vVar19, 0);
	...
	{
		vVar19 = { GET_ENTITY_COORDS(ScriptParam_260.f_4, true) };
	}
	if (!IS_ENTITY_DEAD(func_498(), 0))
	{
		func_496(iLocal_202, 1);
		if (IS_PED_IN_ANY_VEHICLE(func_498(), 0))
		{
			TASK_LEAVE_ANY_VEHICLE(func_498(), 0, 0);
		}
	...
	while (true)
	{
		...
		{
			DRAW_SCALEFORM_MOVIE_3D(Var4, Var4.f_18, Var4.f_21, Var4.f_24, Var4.f_24, 2);
		}
		if ((IS_PED_INJURED(ScriptParam_260.f_5) && !IS_PED_INJURED(func_498())) || (IS_PED_INJURED(func_498()) && IS_PED_INJURED(func_498())))
		{
			func_469(&Var0, &Var5, &Var6);
		}
		if (!IS_PED_INJURED(iLocal_170[0]))
		{
			SET_PED_RESET_FLAG(iLocal_170[0], 239, true);
			SET_PED_RESET_FLAG(iLocal_170[0], 124, true);
			func_462();
			_DISABLE_INPUT_GROUP(0);
			_DISABLE_INPUT_GROUP(2);
			iVar14 = 0;
			while (iVar14 < GET_PED_NEARBY_PEDS(GET_PED_NEARBY_PEDS(), &uVar26, -1))
			{
			...
			switch (Var0)
			{
				case 0:
					...
					{
						vLocal_239 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Var0.f_243, 0.7792f, -1.138f, 0.1814f) };
						vLocal_240 = { -7.9947f, 0f, (Var0.f_243.f_4 + 36.19176f) };
						iLocal_84 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_239, vLocal_240, 65f, 0, 2);
				...
				case 1:
					if (timera() > 500 && !IS_PED_RAGDOLL(IS_PED_RAGDOLL()))
					{
						CLEAR_AREA(ScriptParam_260, 0.5f, 1, 0, 0, false);
						if (!IS_PED_INJURED(IS_PED_INJURED()) && IS_PED_INJURED(IS_PED_INJURED(), 1))
						{
							CLEAR_SEQUENCE_TASK(&iLocal_205);
							OPEN_SEQUENCE_TASK(&iLocal_205);
							TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							CLOSE_SEQUENCE_TASK(iLocal_205);
							TASK_PERFORM_SEQUENCE(TASK_PERFORM_SEQUENCE(), iLocal_205);
						}
						vLocal_42 = { vLocal_42 };
						Var0 = 2;
					}
				...
				case 2:
					...
					if (DOES_ENTITY_EXIST(Var0.f_243))
					{
						vVar19 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Var0.f_243, Var4.f_18) };
					}
					func_452(&Var4, &Var5);
				...
				case 3:
					if (func_449(&Var4, &Var5))
					{
						...
						if (!IS_ENTITY_DEAD(func_498(), 0))
						{
							...
							switch (iLocal_250)
							{
								...
								case 19:
									...
									SET_PED_COMPONENT_VARIATION(func_498(), 5, 2, 0, 0);
									break;
						...
						iLocal_36 = CREATE_OBJECT(iLocal_37, vVar3, true, true, false);
						Var0.f_446[0] = 0;
						Var0.f_446[1] = 0;
						Var0 = 4;
					}
				...
				case 4:
					...
					{
						iVar27 = CREATE_OBJECT(joaat("prop_dart_1"), vVar3, true, true, false);
						func_439(Var0.f_243.f_4, Var2, &uVar26, &ScriptParam_260);
						func_438(&Var4, sLocal_251, sLocal_252);
						CLEAR_PED_TASKS(iLocal_170[1]);
						iLocal_206 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
						if (!IS_PED_INJURED(IS_PED_INJURED()))
						{
							FORCE_PED_MOTION_STATE(FORCE_PED_MOTION_STATE(), -1871534317, false, 0, 0);
						}
						func_437(&(Var0.f_257), 0, PLAYER_PED_ID(), sLocal_251, 0, 1);
						if (IS_ENTITY_DEAD(func_498(), 0))
						{
							if (iLocal_207 == 2)
							{
				...
				case 5:
					if ((((!IS_PED_INJURED(iLocal_170[1]) && IS_PED_INJURED(iLocal_170[0])) && !IS_PED_INJURED(iLocal_170[0], 1)) && IS_PED_INJURED(iLocal_170[1])) && !IS_PED_INJURED(iLocal_170[1], 1))
					{
						bLocal_178 = func_432(&uLocal_194);
						if ((func_431() && GET_GAME_TIMER() >= iLocal_196 + 1000) && iVar13 != 9)
						{
						...
						{
							case -1:
								if (!IS_PED_INJURED(iLocal_170[1]))
								{
									iLocal_200 = CREATE_SYNCHRONIZED_SCENE(CREATE_SYNCHRONIZED_SCENE(ScriptParam_260.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (CREATE_SYNCHRONIZED_SCENE(ScriptParam_260.f_4) - 3.783146f), 2);
									iLocal_206 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
									PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_206, iLocal_200, "darts_ig_intro_cam", "mini@dartsintro");
									SET_CAM_ACTIVE(iLocal_206, true);
									RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
									TASK_CLEAR_LOOK_AT(iLocal_170[0]);
									TASK_CLEAR_LOOK_AT(iLocal_170[1]);
									CLEAR_PED_TASKS_IMMEDIATELY(iLocal_170[0]);
									CLEAR_PED_TASKS_IMMEDIATELY(iLocal_170[1]);
									TASK_SYNCHRONIZED_SCENE(iLocal_170[1], iLocal_200, "mini@dartsintro", "darts_ig_intro_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_SYNCHRONIZED_SCENE(iLocal_170[0], iLocal_200, "mini@dartsintro", "darts_ig_intro_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_PLAY_ANIM(iLocal_170[1], "mini@dartsintro", "darts_ig_intro_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
									TASK_PLAY_ANIM(iLocal_170[0], "mini@dartsintro", sVar22, 8f, -8f, -1, 32, 0, 0, 0, 0);
									PLAY_SYNCHRONIZED_ENTITY_ANIM(iVar27, iLocal_200, "darts_ig_intro_dart", "mini@dartsintro", 1000f, 8f, 0, 1148846080);
									func_424(&iVar25);
									iVar13++;
								}
								break;
							...
							case 0:
								if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_200))
								{
									if (!bVar9)
									{
									...
									else if (!IS_AMBIENT_SPEECH_PLAYING(iLocal_170[0]))
									{
										if (!bVar10)
										{
											if (!func_420(&iVar25))
									...
									switch (iLocal_31)
									{
										...
										case 1:
											if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_200) > 0.25f)
											{
												func_424(&iVar25);
										...
										case 2:
											if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_200) > 0.55f)
											{
										...
										case 3:
											if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_200) > 0.85f)
											{
												func_418("DARTS_HOW_3A", -1);
												iLocal_31++;
											}
									...
									if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_200) > 0.95f)
									{
										iLocal_190 = 1;
										iVar13++;
									}
							...
							case 1:
								if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_200) > 0.99f)
								{
									if (!IS_PED_INJURED(iLocal_170[1]))
									{
										...
										iLocal_31 = 0;
										CLEAR_HELP(1);
										DESTROY_CAM(iLocal_206, 0);
										CLEAR_PED_TASKS(iLocal_170[0]);
										CLEAR_PED_TASKS(iLocal_170[1]);
										STOP_SYNCHRONIZED_ENTITY_ANIM(iVar27, -1000f, 0);
										DELETE_OBJECT(&iVar27);
										STOP_AUDIO_SCENE(func_414(0));
										func_421(&iVar25);
										Var0 = 6;
										iVar13 = 0;
									}
							...
							case 3:
								if (!IS_PED_INJURED(iLocal_170[1]))
								{
									iLocal_200 = CREATE_SYNCHRONIZED_SCENE(CREATE_SYNCHRONIZED_SCENE(ScriptParam_260.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (CREATE_SYNCHRONIZED_SCENE(ScriptParam_260.f_4) - 3.783146f), 2);
									iLocal_206 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
									PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_206, iLocal_200, "darts_ig_intro_alt1_cam", "mini@dartsintro_alt1");
									SET_CAM_ACTIVE(iLocal_206, true);
									RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
									TASK_CLEAR_LOOK_AT(iLocal_170[0]);
									TASK_CLEAR_LOOK_AT(iLocal_170[1]);
									CLEAR_PED_TASKS_IMMEDIATELY(iLocal_170[0]);
									CLEAR_PED_TASKS_IMMEDIATELY(iLocal_170[1]);
									TASK_SYNCHRONIZED_SCENE(iLocal_170[1], iLocal_200, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_SYNCHRONIZED_SCENE(iLocal_170[0], iLocal_200, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_PLAY_ANIM(iLocal_170[1], "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
									TASK_PLAY_ANIM(iLocal_170[0], "mini@dartsintro_alt1", sVar22, 8f, -8f, -1, 32, 0, 0, 0, 0);
									PLAY_SYNCHRONIZED_ENTITY_ANIM(iVar27, iLocal_200, "darts_ig_intro_alt1_dart", "mini@dartsintro_alt1", 1000f, 8f, 0, 1148846080);
									func_424(&iVar25);
									iVar13++;
								}
								break;
							...
							case 9:
								if (IS_SCREEN_FADED_OUT())
								{
									...
									if (!IS_PED_INJURED(iLocal_170[1]))
									{
										SET_ENTITY_COORDS(iLocal_170[0], Var2, 1, false, 0, 1);
										SET_ENTITY_HEADING(iLocal_170[0], Var0.f_243.f_4);
										SET_ENTITY_COORDS(iLocal_170[1], Var2.f_3, 1, false, 0, 1);
										SET_ENTITY_HEADING(iLocal_170[1], Var0.f_243.f_4);
										CLEAR_PED_TASKS(iLocal_170[0]);
										CLEAR_PED_TASKS(iLocal_170[1]);
									}
									DESTROY_CAM(iLocal_206, 0);
				...
				case 6:
					switch (iVar13)
					{
						case 0:
							...
							START_AUDIO_SCENE(func_414(1));
							iVar13 = 0;
							Var0 = 7;
							break;
						
						case 1:
							if ((GET_GAME_TIMER() - iLocal_196) > 1500)
							{
				...
				case 8:
					...
					{
						case 0:
							if (!DOES_ENTITY_EXIST(func_498()))
							{
								if (!IS_BIT_SET(Global_111521, 10))
								{
									SET_BIT(&Global_111521, 10);
								}
								else
								{
									CLEAR_BIT(&Global_111521, 10);
								}
								func_405(&Var5);
								iVar13++;
							}
						...
						case 1:
							if (IS_PC_VERSION())
							{
								if (fLocal_89 != _GET_ASPECT_RATIO(0))
								{
									fLocal_89 = _GET_ASPECT_RATIO(0);
									SET_CAM_FOV(iLocal_75, func_404(fLocal_89));
									SET_CAM_FOV(iLocal_76, func_404(fLocal_89));
								}
							}
							if (func_344(&Var5, &(Var0.f_452), &(Var0.f_453)))
							{
								STOP_AUDIO_SCENE(func_414(1));
								if (Var0.f_452 > 0)
								{
									iVar13 = 0;
					...
					switch (iVar13)
					{
						case 0:
							if (func_423(&(Var0.f_254)) > 0.5f)
							{
								...
								iVar33 = func_240();
								iLocal_200 = CREATE_SYNCHRONIZED_SCENE(vVar20, vVar21, 2);
								iLocal_206 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
								PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_206, iLocal_200, sLocal_259[iVar33], "mini@dartsoutro");
								SET_CAM_ACTIVE(iLocal_206, true);
								RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
								if (!IS_PED_INJURED(iLocal_170[0]) && !IS_PED_INJURED(iLocal_170[1]))
								{
									if (Var0.f_454)
									{
										...
										TASK_SYNCHRONIZED_SCENE(iLocal_170[0], iLocal_200, "mini@dartsoutro", sLocal_257[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_SYNCHRONIZED_SCENE(iLocal_170[1], iLocal_200, "mini@dartsoutro", sLocal_258[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_PLAY_ANIM(TASK_PLAY_ANIM(), sLocal_255, sLocal_256[TASK_PLAY_ANIM(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
									}
									else
									{
										PLAY_SOUND_FRONTEND(-1, "OTHER_TEXT", "HUD_AWARDS", true);
										func_238(&iLocal_170);
										TASK_SYNCHRONIZED_SCENE(iLocal_170[1], iLocal_200, "mini@dartsoutro", sLocal_257[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_SYNCHRONIZED_SCENE(iLocal_170[0], iLocal_200, "mini@dartsoutro", sLocal_258[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_PLAY_ANIM(iLocal_170[1], sLocal_254, sLocal_256[TASK_PLAY_ANIM(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
									}
								}
								iVar13++;
							}
						...
						case 2:
							func_421(&(Var0.f_254));
							iLocal_184 = 0;
							STOP_AUDIO_SCENE(func_414(3));
							func_413();
							if (DOES_CAM_EXIST(iLocal_206))
							{
								DESTROY_CAM(iLocal_206, 0);
							}
							iVar13 = 0;
				...
				case 13:
					...
					switch (iVar13)
					{
						case 0:
							...
							if (!bLocal_186)
							{
								RENDER_SCRIPT_CAMS(false, bLocal_186, 3000, 1, 0, 0);
							}
							else
							{
							...
							CLEAR_PRINTS();
							TASK_LOOK_AT_ENTITY(iLocal_170[0], iLocal_170[1], 5000, 2049, 3);
							func_435(&iVar25);
							iVar13++;
							break;
				...
				case 14:
					...
					if (IS_CONTROL_JUST_RELEASED(2, 201))
					{
						...
						iLocal_203 = 2;
						bVar7 = true;
						if (IS_AUDIO_SCENE_ACTIVE(func_414(2)))
						{
							STOP_AUDIO_SCENE(func_414(2));
						}
						Var0 = 13;
					}
...
{
	if (!IS_ENTITY_DEAD(func_498(), 0) || iParam2)
	{
...
int func_10(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (!uParam0->f_563)
	{
		switch (func_500(GET_PLAYER_PED(GET_PLAYER_PED())))
		{
			case 1:
...
void func_15(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_33();
		DRAW_RECT(0.5f, (fVar1 - (func_37((2f - 0.5f)) - 0.001388889f)), fVar6, func_28(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_14((fVar11 / (0.6f * func_37(25f))), 0f, 1f);
					func_33();
					DRAW_RECT(0.5f, (fVar1 + func_37((2f * 0.5f))), fVar6, func_28(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_37((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_37((25f * 0.2f)));
...
void func_25(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			DRAW_SPRITE("CommonMenu", func_21(7, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_18(5, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_21(5, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_18(6, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_21(6, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_41(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (iLocal_173)
	{
		...
		if ((IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_200) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_200) >= 0.995f) || !IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_200))
		{
			bLocal_186 = true;
			if (DOES_CAM_EXIST(iLocal_206))
			{
				...
				if (!IS_PED_INJURED(iLocal_170[0]) && !IS_PED_INJURED(iLocal_170[1]))
				{
					CLEAR_PED_TASKS_IMMEDIATELY(iLocal_170[0]);
					CLEAR_PED_TASKS_IMMEDIATELY(iLocal_170[1]);
					_0x2208438012482A1A(iLocal_170[0], 0, 0);
					_0x2208438012482A1A(iLocal_170[1], 0, 0);
				}
			}
			func_108();
		}
		...
		else if (((IS_CONTROL_JUST_PRESSED(0, 234) || IS_CONTROL_JUST_PRESSED(0, 235)) && uParam0->f_248 == 1) && bVar1)
		{
			...
			if (iLocal_172)
			{
				vVar3 = { GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_195 /*26*/], true) };
		...
		else if (((IS_CONTROL_JUST_PRESSED(0, 211) || IS_CONTROL_JUST_PRESSED(0, 211)) && bVar1) && (iLocal_191 || !IS_CONTROL_JUST_PRESSED()))
		{
			uParam1->f_680 = 1;
			func_120(&(uParam1->f_509), 0, 0, 1, 1);
			func_119(&(uParam1->f_509), "DARTS_CONT", 2, 215, 1, 1, 0);
	...
	else if (!uParam0->f_457)
	{
		...
		iVar7 = func_240();
		iLocal_200 = CREATE_SYNCHRONIZED_SCENE(vVar5, vVar6, 2);
		iLocal_206 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
		PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_206, iLocal_200, sLocal_259[iVar7], "mini@dartsoutro");
		SET_CAM_ACTIVE(iLocal_206, true);
		RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
		if (!IS_PED_INJURED(iLocal_170[0]) && !IS_PED_INJURED(iLocal_170[1]))
		{
			if (uParam0->f_454)
			{
				TASK_SYNCHRONIZED_SCENE(iLocal_170[0], iLocal_200, "mini@dartsoutro", sLocal_257[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_SYNCHRONIZED_SCENE(iLocal_170[1], iLocal_200, "mini@dartsoutro", sLocal_258[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_PLAY_ANIM(TASK_PLAY_ANIM(), sLocal_255, sLocal_256[TASK_PLAY_ANIM(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
			}
			else
			{
				TASK_SYNCHRONIZED_SCENE(iLocal_170[1], iLocal_200, "mini@dartsoutro", sLocal_257[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_SYNCHRONIZED_SCENE(iLocal_170[0], iLocal_200, "mini@dartsoutro", sLocal_258[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_PLAY_ANIM(iLocal_170[1], sLocal_254, sLocal_256[TASK_PLAY_ANIM(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
			}
		}
		bLocal_186 = false;
...
void func_50(vector3 vParam0)
{
	...
	if (bLocal_88)
	{
		SET_CAM_COORD(iLocal_86, vVar0);
		SET_CAM_ACTIVE_WITH_INTERP(iLocal_86, iLocal_85, 500, 1, 1);
		bLocal_88 = false;
	}
	else
	{
		SET_CAM_COORD(iLocal_85, vVar0);
...
void func_57(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_59() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_59() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_65(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_59() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_91()
{
	...
	{
		if (func_93(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
			iVar0 = func_500(PLAYER_PED_ID());
...
void func_122(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_124(uParam0->f_1, 256) || (func_124(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_124(uParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_129(var uParam0, int iParam1)
{
	...
	if (iParam1 == 188 || iParam1 == 187)
	{
		...
		if (((!IS_CONTROL_PRESSED(2, iParam1) && !IS_CONTROL_PRESSED(2, iParam1)) && (iVar1 < 75 && iVar1 > -75)) || func_150(&(uParam0->f_246.f_3), 250, 0))
		{
			return 1;
		}
	}
	else if ((!IS_CONTROL_PRESSED(2, iParam1) && !IS_CONTROL_PRESSED(2, iParam1)) || func_150(&(uParam0->f_246.f_3), 250, 0))
	{
		return 1;
	}
	return 0;
...
void func_136(struct<30> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15, bool bParam16, bool bParam17)
{
	...
	switch (Param0.f_29[iParam14])
	{
		...
		case 8:
			...
			{
				BEGIN_TEXT_COMMAND_SCALEFORM_STRING(func_138(func_141(iParam15), 0));
				END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
...
void func_154(var uParam0)
{
	...
	Global_1838577.f_87[iVar2 /*3*/] = { func_155(PLAYER_ID()) };
}
...
int func_173()
{
	if (IS_PAUSE_MENU_ACTIVE() && !func_195())
	{
		return 1;
	}
	return 0;
...
int func_204(int iParam0, bool bParam1)
{
	...
	if ((IS_ORBIS_VERSION() && (((iVar1 == 4 || iVar1 == 2) || iVar1 == 1) || iVar1 == 5)) || (!func_210() && IS_ORBIS_VERSION()))
	{
	...
	{
		func_207(&(Global_1840924.f_3), func_209(&(Global_1840924.f_3)));
		if ((func_187(&(Global_1840924.f_49)) && !func_150(&(Global_1840924.f_49), 2000, 1)) && !NETWORK_IS_SIGNED_ONLINE())
		{
			SET_BIT(iParam0, 3);
			StringCopy(&(Global_1840924.f_3.f_1), "", 64);
			func_205(&(Global_1840924.f_3), 0);
...
int func_214(var uParam0)
{
	...
	switch (Global_1835013)
	{
		...
		case 4:
			if (NETWORK_IS_GAME_IN_PROGRESS() && func_216())
			{
				if (func_215())
				{
					Global_1835013 = 99;
...
void func_237(var uParam0, float fParam1)
{
	...
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_9);
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fParam1);
	END_SCALEFORM_MOVIE_METHOD();
}
...
void func_245(int iParam0)
{
	...
	ATTACH_CAM_TO_ENTITY(iLocal_80, iParam0, -0.0301f, 1.498f, 0.7435f, 1);
	POINT_CAM_AT_ENTITY(iLocal_80, iParam0, 0.0557f, -1.4905f, 0.4958f, 1);
			...
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_303("DARTS_SHT_USE") && !func_303("DARTS_INSTR_W")) && !func_303("DARTS_INSTR_B")) && !func_303("DARTS_AIM_HLP")) && !func_303("DARTS_STD_HLP")) && !func_303("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						SET_BIT(&(Global_111560.f_18965.f_6), iLocal_199);
	...
	while (iLocal_31 < 3 && uParam0->f_1 == 6)
	{
		...
		else if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24)
		{
			...
			else
			{
				...
				vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_34), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) };
				if (DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]))
				{
			...
			if (bLocal_180)
			{
				if (iLocal_182)
				{
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/] = CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_1, vLocal_40, true, true, false);
					vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_34), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) };
					SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], vVar0, 1, false, 0, 1);
			...
			if (bLocal_180)
			{
				if (iLocal_182)
				{
					...
					while (iVar2 < iLocal_31 + 1)
					{
						...
						{
							uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/] = CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_1, vLocal_40, true, true, false);
							vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_11.f_1 + fLocal_34), uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_11.f_2) };
							if (DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/]))
							{
								SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/], vVar0, 1, false, 0, 1);
							}
							fVar3 = GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
							uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_17 = { 90f, fVar3, uParam0->f_243.f_4 };
							SET_ENTITY_ROTATION(uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/], uParam0->f_5[iLocal_30 /*79*/][iVar2 /*26*/].f_17, 0, 1);
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			if (IS_CONTROL_JUST_PRESSED(2, 190))
			{
				...
				vVar0 = { GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_195 /*26*/], true) };
				func_50(vVar0);
			}
		...
		case 2:
			if (IS_CONTROL_JUST_PRESSED(2, 201) || (iLocal_181 && bLocal_180))
			{
				iLocal_171 = 1;
			}
			...
			if (iLocal_171 || timerb() > 2000)
			{
				...
				if (uParam0->f_425[iLocal_30] != uParam0->f_422[iLocal_30])
				{
					...
					PLAY_SOUND_FROM_COORD(-1, "DARTS_SCOREBOARD_MASTER", uParam0->f_243.f_1, 0, false, 0, 0);
				}
...
int func_251(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iVar2 < 75)
	{
		...
		else if (IS_BIT_SET(iVar0, 2))
		{
			...
			else if (iVar1 < 68 && !DOES_ENTITY_EXIST(func_498()))
			{
				func_4(*uParam1, "DARTS_PLAYING_POORLY", 0, 4);
			}
			else if (iVar1 < 86)
...
void func_265(int iParam0)
{
	switch (iParam0)
	{
		...
		case 7:
			Global_111560.f_18965.f_7 = (to_float(Global_111560.f_18965.f_2) / to_float(Global_111560.f_18965.f_5));
			break;
		
		case 8:
			Global_111560.f_18965.f_8 = (to_float(Global_111560.f_18965.f_4) / to_float(Global_111560.f_18965.f_5));
			break;
	}
}
...
void func_270(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_DART_MASTER", uParam1->f_1, 0, false, 0, 0);
	}
	if (fVar0 < 0.009f)
	{
		PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BULLSEYE_MASTER", uParam1->f_1, 0, false, 0, 0);
		uParam0->f_20 = 50;
	}
	else if (fVar0 < 0.021f)
	{
		PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, 0);
		uParam0->f_20 = 25;
	}
	else if (fVar0 > 0.3f)
	{
		PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_WALL_MASTER", uParam1->f_1, 0, false, 0, 0);
		uParam0->f_20 = 0;
	}
	...
	else
	{
		...
		{
			uParam0->f_21 = 3;
			PLAY_SOUND_FROM_COORD(-1, "DARTS_SCORE_TRIPLE_MASTER", uParam1->f_1, 0, false, 0, 0);
		}
		else if (fVar0 > 0.2132f && fVar0 < 0.226f)
		{
			uParam0->f_21 = 2;
			PLAY_SOUND_FROM_COORD(-1, "DARTS_SCORE_DOUBLE_MASTER", uParam1->f_1, 0, false, 0, 0);
		}
		else
		{
			uParam0->f_21 = 1;
		...
		while (iVar4 < 21)
		{
			if (fVar1 >= (fVar2 - 9f) && fVar1 < (fVar2 + 9f))
			{
				...
				{
					PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_WIRE_MASTER", uParam1->f_1, 0, false, 0, 0);
				}
...
int func_273(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (uParam0->f_2.f_1 > (uParam0->f_8.f_1 - 0.04f))
	{
		uParam0->f_23 = 1;
		uParam0->f_24 = 0;
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_11, (uParam0->f_11.f_1 + fLocal_34), uParam0->f_11.f_2) };
		SET_ENTITY_COORDS(*uParam0, vVar0, 1, false, 0, 1);
		return 1;
	}
	vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_2, (uParam0->f_2.f_1 + fLocal_34), uParam0->f_2.f_2) };
	SET_ENTITY_COORDS(*uParam0, vVar0, 1, false, 0, 1);
...
void func_274(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (func_277())
	{
		_SET_UI_LAYER(iParam5);
		if (iParam3 == 1)
		{
			DRAW_SPRITE(sParam0, sParam1, func_276(Var0), func_275(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, iParam6);
		}
		else
		{
			DRAW_SPRITE(sParam0, sParam1, func_276(Var0), func_275(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, iParam6);
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!bParam4 && uParam3->f_3 < 30)
	{
		...
		iVar6 = GET_RANDOM_INT_IN_RANGE(func_288(uParam3), 150);
		if (uParam3->f_2 > 140)
		{
	...
	else
	{
		...
		uParam0->f_24 = 1;
		func_287(uParam0);
		*uParam0 = CREATE_OBJECT(uParam0->f_1, vLocal_40, false, false, false);
		fVar1 = GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
		vVar7 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, vLocal_41) };
		vVar8 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_8, (uParam0->f_8.f_1 + fLocal_34), uParam0->f_8.f_2) };
		fVar2 = GET_HEADING_FROM_VECTOR_2D((vVar7.x - vVar8.x), (vVar7.y - vVar8.y));
		fVar2 = (fVar2 - 180f);
...
void func_298(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_34), uParam0->f_14.f_2) };
	if (iParam3 == 1)
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_34), uParam0->f_14.f_2) };
	}
	GET_SCREEN_COORD_FROM_WORLD_COORD(vVar0, &Local_38, &(Local_38.f_1));
...
void func_300()
{
	...
	if (IS_CONTROL_PRESSED(2, 229))
	{
		...
		{
			iLocal_50 = 1;
			if (!IS_BIT_SET(Global_111521, 1))
			{
				func_418("DARTS_SHT_USE", -1);
				SET_BIT(&Global_111521, 1);
			}
		}
	}
	else if (bLocal_49)
...
int func_302(var uParam0, var uParam1, bool bParam2)
{
	...
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		SET_ENTITY_COORDS(*uParam0, vLocal_40, 1, false, 0, 1);
	}
	else
	{
		*uParam0 = CREATE_OBJECT(uParam0->f_1, vLocal_40, false, false, false);
	...
	vVar1 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, vLocal_41) };
	vVar2 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, (uParam0->f_14 + 0.0035f), (uParam0->f_14.f_1 + fLocal_34), uParam0->f_14.f_2) };
	fVar5 = GET_HEADING_FROM_VECTOR_2D((vVar1.x - vVar2.x), (vVar1.y - vVar2.y));
	fVar5 = (fVar5 - 180f);
	fVar3 = 90f;
	...
	vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_8, (uParam0->f_8.f_1 + fLocal_34), uParam0->f_8.f_2) };
	GET_SCREEN_COORD_FROM_WORLD_COORD(vVar0, &Local_39, &(Local_39.f_1));
	return 1;
}
...
void func_304(int iParam0, int iParam1)
{
	...
	else if (iParam0 == 2)
	{
		...
		{
			if (!IS_BIT_SET(Global_111521, 2))
			{
				func_418("DARTS_FST_HLP", -1);
				SET_BIT(&Global_111521, 2);
			}
			iLocal_51 = 1;
		}
	}
...
void func_307(vector3 vParam0)
{
	...
	iLocal_87 = CREATE_CAMERA_WITH_PARAMS(26379945, vParam0, vVar0, 65f, 0, 2);
...
int func_312(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 3:
			...
			{
				if (IS_CAM_ACTIVE(iLocal_208))
				{
					SET_CAM_ACTIVE(iLocal_208, false);
				}
				DESTROY_CAM(iLocal_208, 0);
			}
			*uParam0 = 0;
			return 0;
			break;
...
void func_323(var uParam0)
{
	...
	{
		if ((IS_CONTROL_PRESSED(2, 201) || IS_CONTROL_PRESSED(2, 223)) && iLocal_54)
		{
			*uParam0 = 6;
		}
	}
...
void func_327(var uParam0)
{
	...
	if (*uParam0 != 13)
	{
		...
		if (IS_CONTROL_JUST_RELEASED(2, 235) || IS_CONTROL_JUST_RELEASED(2, 235))
		{
			if (!bLocal_179)
			{
				*uParam0 = 14;
...
int func_332(int iParam0, var uParam1)
{
	if (iParam0 >= 10)
	{
		if (!IS_BIT_SET(Global_111560.f_18965.f_6, 12))
		{
			*uParam1 = 12;
			return 1;
		}
...
int func_344(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (func_399())
		{
			...
			Global_4268348 = GET_GAME_TIMER() + 300;
		}
		else if (func_396() && GET_GAME_TIMER() > Global_4268348)
		{
			if (Global_4268347 == uParam0->f_660)
			{
				iVar2 = func_395(0);
		...
		if (IS_CONTROL_JUST_RELEASED(2, 202) || func_346())
		{
			func_345(0, 0);
			func_331(&(uParam0->f_666), 8, 0);
		...
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			if (GET_HASH_KEY(&(Global_22350.f_4690)) != 0 && Global_22350.f_4766 != -1)
			{
				...
				if (Global_22350.f_4768 != 0)
				{
					...
					DRAW_SPRITE(func_24(Global_22350.f_4768), func_21(Global_22350.f_4768, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
			...
			if (GET_HASH_KEY(&(Global_4268271.f_21)) != 0 && Global_4268271.f_65 != -1)
			{
				...
				if (Global_4268271.f_67 != 0)
				{
					...
					DRAW_SPRITE(func_24(Global_4268271.f_67), func_21(Global_4268271.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
				fVar49 = (fVar49 + (((_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar52)
									{
										if (func_18(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_18(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_24(26), func_21(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
										}
										if (func_18(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_18(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_24(27), func_21(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
												}
											}
										}
									}
												...
												if (func_18(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_18(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_22350.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar28)]), func_21(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar28)]), func_21(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
									...
									if (GET_HASH_KEY(&(Global_22350.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_351() && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
												...
												if (func_18(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_18(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar14)]), func_21(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (Global_22347 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else if (Global_22350.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar14)]), func_21(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar14)]), func_21(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
													}
									...
									if (func_18(Global_22350.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_18(Global_22350.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												DRAW_SPRITE(func_24(Global_22350.f_4433[iVar22]), func_21(Global_22350.f_4433[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_348(Global_22350.f_4433[iVar22])), (fVar37 * func_348(Global_22350.f_4433[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0);
											}
										}
									}
								}
...
int func_370(bool bParam0, bool bParam1)
{
	...
	if ((((((((!IS_SCREEN_FADED_IN() || (func_372(8, -1) && func_371() != 65)) || (IS_SCREEN_FADED_IN() != 0 && !bParam1)) || (IS_SCREEN_FADED_IN() && !bParam0)) || IS_SCREEN_FADED_IN()) || Global_76837) || Global_22350.f_8384) || IS_SCREEN_FADED_IN()) || Global_98721.f_1417)
	{
		return 0;
	}
	return 1;
...
int func_376(int iParam0)
{
	...
	if ((fVar0 > 0.8f || IS_CONTROL_PRESSED(2, 190)) || IS_CONTROL_PRESSED(2, 190))
	{
		if (!func_420(iParam0))
		{
			func_375(iParam0);
...
int func_407(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5)
{
	...
	if ((func_431() && GET_GAME_TIMER() >= iLocal_196 + 1000) && *iParam0 != 8)
	{
		if (!IS_SCREEN_FADED_OUT() && !IS_SCREEN_FADED_OUT())
		{
			DO_SCREEN_FADE_OUT(500);
	...
	switch (*iParam0)
	{
		...
		case 5:
			if (!IS_CAM_INTERPOLATING(iLocal_83) && !func_303("DARTS_DBL_WIN"))
			{
...
void func_409(vector3 vParam0, float fParam1, vector3 vParam2, vector3 vParam3, int iParam4)
{
	...
	SET_CAM_COORD(iLocal_83, SET_CAM_COORD(vParam0, fParam1, vParam2));
	SET_CAM_ROT(iLocal_83, Vector(fParam1, 0f, 0f) - vParam3, 2);
...
void func_415(vector3 vParam0, float fParam1, vector3 vParam2, vector3 vParam3, int iParam4, bool bParam5)
{
	...
	SET_CAM_COORD(iLocal_82, SET_CAM_COORD(vParam0, fParam1, vParam2));
	SET_CAM_ROT(iLocal_82, Vector(fParam1, 0f, 0f) - vParam3, 2);
	if (bParam5)
	{
...
int func_432(var uParam0)
{
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		if (!func_433(iVar0))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()) && IS_PED_INJURED(iVar0, IS_PED_INJURED(), vLocal_169, 0, 1, 0))
			{
...
void func_439(float fParam0, struct<4> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	if (DOES_ENTITY_EXIST(func_498()) && !DOES_ENTITY_EXIST(func_498()))
	{
		REMOVE_PED_FROM_GROUP(func_498());
	}
	else
	{
		if (DOES_ENTITY_EXIST(uParam5->f_5) && !DOES_ENTITY_EXIST(uParam5->f_5))
		{
			SET_ENTITY_AS_MISSION_ENTITY(uParam5->f_5, true, 1);
		...
		{
			iLocal_170[1] = CREATE_PED(26, iLocal_204, Param1.f_3, fParam0, 1, true);
		}
		if (DECOR_EXIST_ON(iLocal_170[1], "Darts_name"))
		{
			iVar0 = DECOR_GET_INT(iLocal_170[1], "Darts_name");
			if (954610991 == iVar0)
			{
				sLocal_252 = func_445("RAYMOND");
				iLocal_253 = 954610991;
		...
		DECOR_SET_INT(iLocal_170[1], "Darts_name", iLocal_253);
	}
	iVar1 = GET_ENTITY_MODEL(iLocal_170[1]);
	func_440(iVar1);
	TASK_TURN_PED_TO_FACE_ENTITY(iLocal_170[1], iLocal_170[0], 0);
	TASK_TURN_PED_TO_FACE_ENTITY(iLocal_170[0], iLocal_170[1], 0);
}
...
int func_441(var uParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < GET_PED_NEARBY_PEDS(GET_PED_NEARBY_PEDS(), uParam0, -1))
	{
...
void func_446(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	vLocal_40 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_1, uParam0->f_4, vLocal_41) };
...
int func_449(var uParam0, var uParam1)
{
	...
	if ((((((((((((!HAS_MODEL_LOADED(iLocal_28) || !HAS_MODEL_LOADED(iLocal_29)) || !HAS_MODEL_LOADED(iLocal_37)) || !HAS_MODEL_LOADED(iLocal_204)) || !HAS_MODEL_LOADED(*uParam0)) || !HAS_MODEL_LOADED(uParam1->f_645)) || !HAS_MODEL_LOADED(uParam1->f_57)) || !HAS_MODEL_LOADED(uParam1->f_62)) || !HAS_MODEL_LOADED(3)) || !HAS_MODEL_LOADED("Darts")) || !HAS_MODEL_LOADED(sLocal_254)) || !HAS_MODEL_LOADED(sLocal_255)) || !func_450(0, -1, 0))
	{
		return 0;
	}
	return 1;
...
void func_452(var uParam0, var uParam1)
{
	...
	*uParam0 = 0x67D02A194A2FC2BD("darts_scoreboard");
...
int func_453()
{
	return 0x67D02A194A2FC2BD("MIDSIZED_MESSAGE");
}
...
void func_455(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	...
	{
		iParam0->f_18 = { _GET_OBJECT_OFFSET_FROM_COORDS(vParam2, fParam3, -0.687645f, -0.350352f, 0.343273f) };
...
void func_460(vector3 vParam0, float fParam1)
{
	...
	vVar1 = { _GET_OBJECT_OFFSET_FROM_COORDS(vParam0, fParam1, vVar8) };
	vVar3 = { fVar10, 0f, (fParam1 - fVar9) };
	vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(vParam0, fParam1, vVar11) };
	vVar2 = { fVar13, 0f, (fParam1 - fVar12) };
	vVar4 = { _GET_OBJECT_OFFSET_FROM_COORDS(vParam0, fParam1, vVar14) };
	vVar5 = { 0.8351f, -0.0048f, (fParam1 - 186.5073f) };
	vVar15 = { _GET_OBJECT_OFFSET_FROM_COORDS(vParam0, fParam1, vVar16) };
	vVar6 = { 0.8351f, -0.0048f, (fParam1 - 186.5073f) };
	iLocal_75 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar0, vVar2, fVar7, 0, 2);
	iLocal_76 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar1, vVar3, fVar7, 0, 2);
	iLocal_77 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar4, vVar5, 65f, 0, 2);
	iLocal_78 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar15, vVar6, 65f, 0, 2);
	iLocal_79 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
	iLocal_80 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
	iLocal_82 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
	iLocal_83 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
	iLocal_81 = CREATE_CAMERA_WITH_PARAMS(26379945, 1996.235f, 3048.456f, 48.0237f, -3.4831f, 0.0223f, 60.6925f, 38.1f, 0, 2);
...
void func_469(int iParam0, var uParam1, var uParam2)
{
	...
	if (!IS_ENTITY_DEAD(func_498(), 0))
	{
		SET_PED_AS_GROUP_MEMBER(func_498(), func_481());
...
void func_474()
{
	...
	{
		func_85(13, floor(Global_111560.f_10189.f_3853));
	}
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_76577)
		{
			if (func_475() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
...
void func_476(int iParam0, bool bParam1)
{
	...
	{
		_0x0BCA1D2C47B0D269(103, iLocal_106[1], 0f);
		_0x0BCA1D2C47B0D269(99, iLocal_106[2], 0f);
		_0x0BCA1D2C47B0D269(109, iLocal_106[3], 0f);
		_0x0BCA1D2C47B0D269(106, iLocal_106[5], 0f);
		_0x0BCA1D2C47B0D269(2, iLocal_106[10], 0f);
		_0x0BCA1D2C47B0D269(107, iLocal_106[8], 0f);
		_0x0BCA1D2C47B0D269(116, iLocal_106[6], 0f);
	}
}
...
void func_477(var uParam0)
{
	...
	if (!Global_76845)
	{
		if (!IS_PLAYER_DEAD(IS_PLAYER_DEAD()))
		{
			if (!Global_76846)
			{
				if (IS_SCREEN_FADED_OUT() && !func_472(0))
				{
...
{
	if (DOES_ENTITY_EXIST(*uParam0) && !DOES_ENTITY_EXIST(*uParam0))
	{
		CLEAR_SEQUENCE_TASK(&iLocal_205);
		OPEN_SEQUENCE_TASK(&iLocal_205);
		if (DOES_ENTITY_EXIST(iLocal_170[0]))
		{
			TASK_LOOK_AT_ENTITY(0, iLocal_170[0], 8000, 2049, 3);
		}
		...
		if (bLocal_183)
		{
			if (!IS_BIT_SET(Global_111521, 10))
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_207 == 2, vLocal_242, vLocal_244), 1f, 20000, 0.25f, 0, func_123(iLocal_207 == 2, fLocal_246, fLocal_248));
			}
			else
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_207 == 2, vLocal_241, vLocal_243), 1f, 20000, 0.25f, 0, func_123(iLocal_207 == 2, fLocal_245, fLocal_247));
			}
			TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
		}
		else
		{
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_207 == 2, vLocal_241, vLocal_243), 1f, 20000, 0.25f, 0, func_123(iLocal_207 == 2, 172.6813f, 142.6717f));
			TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_IMPATIENT", 0, 1);
		}
		CLOSE_SEQUENCE_TASK(iLocal_205);
		TASK_PERFORM_SEQUENCE(*uParam0, iLocal_205);
		SET_PED_KEEP_TASK(*uParam0, true);
	}
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_204);
}
...
{
	if (IS_PED_INJURED(func_498()))
	{
		return;
	}
	if (bParam1)
	{
		if (!IS_PED_GROUP_MEMBER(func_498(), func_481()))
		{
			return;
		}
		if (!IS_PED_INJURED(func_497()))
		{
			if (!IS_PED_GROUP_MEMBER(func_497(), func_481()))
			{
				return;
			}
		}
