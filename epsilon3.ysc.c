...
void func_28()
{
	switch (iLocal_84)
	{
		...
		case 1:
			...
			if (func_238(PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 1.4f)
			{
				if ((!func_237() && func_236(Local_81.f_28[0])) && (GET_GAME_TIMER() - iLocal_261) > 5000)
				{
			...
			else if ((!IS_MESSAGE_BEING_DISPLAYED() && !func_237()) && (IS_MESSAGE_BEING_DISPLAYED() - iLocal_260) > iLocal_262)
			{
				if (func_236(Local_81.f_28[0]))
				{
					if (func_238(PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 10f)
					{
						if (iLocal_263 < 5)
						{
			...
			if (func_236(Local_81.f_28[0]))
			{
				if (func_237())
				{
					if (iLocal_263 < 5)
					{
						if (!IS_PED_HEADTRACKING_PED(Local_81.f_28[0], IS_PED_HEADTRACKING_PED()))
						{
							TASK_LOOK_AT_ENTITY(Local_81.f_28[0], TASK_LOOK_AT_ENTITY(), -1, 0, 2);
						}
					}
				}
				else if (IS_PED_HEADTRACKING_PED(Local_81.f_28[0], IS_PED_HEADTRACKING_PED()))
				{
					TASK_CLEAR_LOOK_AT(Local_81.f_28[0]);
				}
				if (func_238(PLAYER_PED_ID(), Local_81.f_28[0], 1) >= 100f && !PLAYER_PED_ID(PLAYER_PED_ID(Local_81.f_28[0], true), 3f))
				{
					iLocal_84 = 3;
				}
				if ((((((_0x2F09F7976C512404(_0x2F09F7976C512404(Local_81.f_28[0], false), 5f) || _0x2F09F7976C512404(_0x2F09F7976C512404(Local_81.f_28[0], false), 5f, 0)) || _0x2F09F7976C512404(_0x2F09F7976C512404(Local_81.f_28[0], false), joaat("weapon_grenadelauncher"), 5f, 0)) || _0x2F09F7976C512404(_0x2F09F7976C512404(Local_81.f_28[0], false), joaat("weapon_rpg"), 5f, 0)) || _0x2F09F7976C512404(_0x2F09F7976C512404(Local_81.f_28[0], false), joaat("weapon_grenade"), 5f, 0)) || _0x2F09F7976C512404(_0x2F09F7976C512404(Local_81.f_28[0], false), joaat("weapon_molotov"), 5f, 0)) || _0x2F09F7976C512404(_0x2F09F7976C512404(Local_81.f_28[0], false), joaat("weapon_flare"), 5f, 0))
				{
				...
				if (IS_PED_INJURED(Local_81.f_28[0]) || IS_PED_INJURED(Local_81.f_28[0]))
				{
					TRIGGER_MUSIC_EVENT("EPS_FAIL");
					TASK_PERFORM_SEQUENCE(Local_81.f_28[0], iLocal_256);
					iLocal_251 = 2;
...
void func_34()
{
	...
	{
		func_224(13, floor(Global_111560.f_10189.f_3853));
	}
...
void func_186()
{
	...
	{
		func_15();
		_0xBF59707B3E5ED531(func_187(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_227(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_228(_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_229(iParam1)), 0));
		}
		else
		{
			func_228(_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _SET_NOTIFICATION_MESSAGE_2(func_229(iParam1)), 0));
		}
		switch (Global_19486)
		{
			case 0:
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_325())
			{
				...
				while (!HAS_CUTSCENE_LOADED() && !HAS_CUTSCENE_LOADED(0))
				{
					wait(0);
				}
				func_284(0, 0, 0);
		...
		case 1:
			...
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_85, 0))
			{
				if (func_236(Local_81.f_28[0]))
				{
					TASK_PLAY_ANIM(Local_81.f_28[0], sLocal_82, "base_loop", 1000f, -8f, -1, 262145, 0.01f, 0, 0, 0);
		...
		case 2:
			...
			if (func_236(Local_81.f_28[0]))
			{
				TASK_PLAY_ANIM(Local_81.f_28[0], sLocal_82, "base_loop", 1000f, -8f, -1, 262145, 0, 0, 0, 0);
				func_254(Local_81.f_28[0], 1843.82f, 4705.74f, 40.8f, 143.14f, 1, 1);
			}
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MICHAEL", 0))
			{
...
void func_247(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_251(IS_PED_INJURED())) && !func_249(IS_PED_INJURED(), 0)) && !func_248()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_251(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_255(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_256(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_269(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_274(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_273(PLAYER_PED_ID(), -828834893))
				{
...
void func_277()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_274(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	func_276();
	if (func_236(Local_81.f_28[0]) && func_236(PLAYER_PED_ID()))
	{
		if (func_238(PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 9f)
		{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			REQUEST_ADDITIONAL_TEXT("EPS3", 0);
			while (!HAS_ANIM_DICT_LOADED(sLocal_82) && !HAS_ANIM_DICT_LOADED(0))
			{
				wait(0);
			}
			if (func_246(PLAYER_PED_ID()))
			{
				iLocal_258 = GET_PED_RELATIONSHIP_GROUP_HASH(GET_PED_RELATIONSHIP_GROUP_HASH());
			}
			...
			if (func_238(PLAYER_PED_ID(), Local_81.f_28[0], 1) >= 4f)
			{
				if (!IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (func_236(Local_81.f_28[0]))
					{
						if (func_288())
						{
							SET_GAMEPLAY_ENTITY_HINT(Local_81.f_28[0], 0f, 0f, -0.5f, 1, 30000, 2000, 2000, 0);
						}
						else
						{
							SET_GAMEPLAY_ENTITY_HINT(Local_81.f_28[0], -0.75f, 0f, -0.5f, 1, 30000, 2000, 2000, 0);
						}
						SET_GAMEPLAY_HINT_FOV(fLocal_264);
						_0xF8BDBF3D573049A1(fLocal_265);
						_0xD1F8363DFAD03848(fLocal_266);
						_0x5D7B620DAE436138(fLocal_267);
						_0xC92717EF615B6704(fLocal_268);
		...
		case 1:
			if (func_236(Local_81.f_28[0]))
			{
				if (iLocal_254 == 0)
				{
					if (((func_238(PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 3f && !PLAYER_PED_ID(PLAYER_PED_ID(), 1847.705f, 4703.014f, 36.58427f, 1844.084f, 4709.532f, 39.73755f, 5f, 0, true, 0)) && !PLAYER_PED_ID(PLAYER_PED_ID(), 1842.977f, 4705.946f, 36.78089f, 1842.161f, 4707.852f, 40.10524f, 2.5f, 0, true, 0)) && !PLAYER_PED_ID(PLAYER_PED_ID(), 1843.527f, 4704.969f, 36.83727f, 1844.178f, 4703.326f, 40.25331f, 2.5f, 0, true, 0))
					{
						if (IS_GAMEPLAY_HINT_ACTIVE())
						{
						...
						TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), Local_81.f_28[0], 0);
						TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_81.f_28[0], 7000, 0, 2);
						iLocal_254 = 1;
					}
				}
				if (func_238(PLAYER_PED_ID(), Local_81.f_28[0], 1) >= 4f)
			...
			if (!bLocal_252)
			{
				...
				{
					TASK_LOOK_AT_ENTITY(Local_81.f_28[0], TASK_LOOK_AT_ENTITY(), -1, 2048, 2);
					TASK_PLAY_ANIM(Local_81.f_28[0], sLocal_82, "leadin", 8f, -8f, -1, 786434, 0, 0, 0, 0);
				}
			}
			else if (!func_237())
			{
...
{
	if (((!func_303(0) || Global_76846) || Global_76835 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76831)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_282(0)) || func_302(1))
			{
			}
			else
			{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				...
				{
					if (DOES_ENTITY_EXIST(uParam0->f_28[0]) && func_246(DOES_ENTITY_EXIST()))
					{
...
void func_326()
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_257, 0);
	if (func_341())
	{
	}
...
void func_342(bool bParam0)
{
	...
	if (!func_359())
	{
		...
		{
			func_180(iVar0, 1, 0);
			func_343(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_110647[iVar0 /*10*/].f_9 == -1)
...
int func_344(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_350())
	{
		...
		{
			iVar2 = func_345(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
