...
void func_184(int iParam0)
{
	...
	{
		if (func_127(iParam0->f_28[0]) && !IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_127(PLAYER_PED_ID()) && !func_185(PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
				vVar0 = { GET_ENTITY_COORDS(iParam0->f_28[0], true) };
...
void func_186()
{
	...
	if ((GET_GAME_TIMER() - iLocal_58) > 1250)
	{
		PLAY_SOUND_FROM_COORD(iLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", false, 0, 0);
		iLocal_58 = GET_GAME_TIMER();
	}
}
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	...
	if (!*uParam6 == 3)
	{
		if (func_175(2))
		{
			if (!func_146())
			{
				if ((func_127(PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && func_194(PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			else if (func_189(sParam3))
			{
				if (!*uParam6 == 1)
				{
					...
					{
						if (func_194(PLAYER_PED_ID(), vParam1, 1) >= 20f)
						{
			...
			if (func_194(PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam6 == 1)
			{
...
void func_195(int iParam0, char* sParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_194(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_198(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_194(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_205(iParam2) && !IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, TASK_TURN_PED_TO_FACE_ENTITY(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_205(iParam2) || IS_PED_FACING_PED(iParam0, IS_PED_FACING_PED(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_215(int iParam0, float fParam1)
{
	...
	{
		if (func_226(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(GET_ENTITY_COORDS(iParam1, true) - GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_223(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_230(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(vParam1 - GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_242()
{
	iLocal_56 = 0x67D02A194A2FC2BD("digiscanner");
...
int func_244(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 3:
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, false, 1);
			CLEAR_AREA_OF_VEHICLES(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, false, 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if ((func_127(uParam0->f_28[0]) && DOES_ENTITY_EXIST(uParam0->f_41[0])) && DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_28[0], ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, 0, 0, 0, 0, 2, 1);
				ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[0], ATTACH_ENTITY_TO_ENTITY(uParam0->f_28[0], 64729), 0.1f, 0.08f, 0f, 162.72f, 5.4f, 1.8f, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				bVar2 = false;
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 45)
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, true, 1);
	}
	if (bParam1)
	{
