		...
		case 0:
			...
			if (iLocal_44 == 1)
			{
				...
				if (func_17(iLocal_58))
				{
					...
					{
						if (func_14(iLocal_58, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 35f))
						{
						...
						if (!func_2(iLocal_58, 1805844857))
						{
							if (!IS_PED_FLEEING(iLocal_58))
							{
								if (!IS_ENTITY_PLAYING_ANIM(iLocal_58, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 3))
								{
									...
									TASK_SMART_FLEE_PED(iLocal_58, TASK_SMART_FLEE_PED(), 50f, -1, 0, 0);
...
int func_10()
{
	...
	if (func_17(iLocal_58))
	{
		...
		{
			if (!IS_PED_RAGDOLL(iLocal_58) || IS_PED_RAGDOLL(iLocal_58))
			{
				REQUEST_ANIM_DICT("special_ped@maude@exit_flee");
				if (HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_50, false);
					if (func_2(iLocal_58, 1785177548))
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_58, -1000f, 1);
					}
					TASK_SYNCHRONIZED_SCENE(iLocal_58, iLocal_50, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1148846080, 0);
					_0x2208438012482A1A(iLocal_58, 0, 0);
					if (func_11(iLocal_54))
					{
						if (IS_ENTITY_PLAYING_ANIM(iLocal_54, "special_ped@maude@base", "base_chair", 3))
						{
							STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_54, -16f, 0);
						}
						iVar0 = 0;
						iVar0 += 16;
						iVar0 += 64;
						iVar0 += 512;
						iVar0 += 4096;
						PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_54, iLocal_50, "Female_Flee_Table_Left_Maude_Chair", "special_ped@maude@exit_flee", 16f, -4f, iVar0, 1148846080);
					}
					return 1;
				}
			}
	...
	switch (iLocal_43)
	{
		case 0:
			if (!DOES_ENTITY_EXIST(iLocal_56))
			{
				...
				{
					iLocal_56 = GET_CLOSEST_OBJECT_OF_TYPE(2727.4f, 4145.56f, 43.68f, 10f, -380698483, 1, 0, 1);
					if (func_11(iLocal_56))
					{
						SET_ENTITY_COORDS(iLocal_56, 2727.4f, 4145.56f, 43.68f, 1, false, 0, 1);
			...
			if (func_17(iLocal_58))
			{
				if (!IS_PED_HEADTRACKING_PED(iLocal_58, IS_PED_HEADTRACKING_PED()))
				{
					TASK_LOOK_AT_ENTITY(iLocal_58, TASK_LOOK_AT_ENTITY(), -1, 0, 2);
				}
				SET_PED_KEEP_TASK(iLocal_58, true);
			}
		...
		case 1:
			...
			if (func_17(iLocal_58))
			{
				vVar0 = { GET_ENTITY_COORDS(iLocal_58, false) };
				if (!func_243(0))
				{
					if (vdist2(vVar0, GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false)) > 14400f)
					{
						if (!IS_SPHERE_VISIBLE(vVar0, 2.5f) || IS_SPHERE_VISIBLE(iLocal_58))
						{
							iLocal_43 = 2;
						}
					}
...
void func_33()
{
	...
	{
		func_35(13, floor(Global_111560.f_10189.f_3853));
	}
...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_101(iParam1)) > 0 && GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_101(iParam1), Global_76389[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4, 0);
		}
	}
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_78(GET_ENTITY_MODEL(iParam0), 14, iVar0, GET_ENTITY_MODEL(iParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_79(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_79(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || _IS_TAG_RESTRICTED(func_79(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || _IS_TAG_RESTRICTED(func_79(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_119(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_112(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, _IS_TAG_RESTRICTED(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_112(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, _IS_TAG_RESTRICTED(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
void func_181()
{
	...
	{
		if (func_176(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
void func_192()
{
	...
	{
		func_181();
		_0xBF59707B3E5ED531(func_193(Global_111560.f_2358.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
int func_239(vector3 vParam0, vector3 vParam1, int iParam2, float fParam3)
{
	if (iLocal_53 < iLocal_51)
	{
		if (!func_20())
		{
			...
			{
				if (GET_GAME_TIMER() - iLocal_52) > (iParam2 + GET_GAME_TIMER(0, 2000))
				{
...
int func_243(bool bParam0)
{
	if (func_17(iLocal_58))
	{
		if ((HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_58) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_58)) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_58))
		{
			return 1;
		}
		if (IS_PED_SITTING_IN_ANY_VEHICLE(IS_PED_SITTING_IN_ANY_VEHICLE()))
		{
			if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), iLocal_58))
			{
				return 1;
			}
			if (DOES_ENTITY_EXIST(iLocal_54))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), iLocal_54))
				{
					return 1;
				}
			}
			if (DOES_ENTITY_EXIST(iLocal_56))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), iLocal_56))
				{
					return 1;
				}
			}
			if (DOES_ENTITY_EXIST(iLocal_55))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), iLocal_55))
				{
					return 1;
				}
			}
		...
		{
			if (IS_ENTITY_AT_ENTITY(iLocal_58, IS_ENTITY_AT_ENTITY(), 3f, 3f, 3f, 0, 1, 0))
			{
				return 1;
			}
		}
		...
		if (IS_EXPLOSION_IN_SPHERE(-1, IS_EXPLOSION_IN_SPHERE(iLocal_58, true), 15f))
		{
			return 1;
		}
...
int func_251(int iParam0, float fParam1)
{
	...
	if (func_11(PLAYER_PED_ID()) && func_11(iParam0))
	{
		if (func_260(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
{
	return func_253(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
	...
	switch (iLocal_43)
	{
		case 0:
			...
			if (func_11(iLocal_58))
			{
				...
				{
					_0x2A56C06EBEF2B0D9(sLocal_60, iLocal_58, 0);
				}
			}
			func_352();
			if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
				if (func_349())
				{
					if (func_344(1, 1093140480, 0))
					{
						...
						func_340();
						REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), sLocal_59, 0, 0, 0);
						if (func_11(iLocal_58))
						{
				...
				if (func_17(iLocal_58))
				{
					if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_60, 0) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_61, 0))
					{
						if (HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
						{
							...
							_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_47, false);
							TASK_SYNCHRONIZED_SCENE(iLocal_58, iLocal_47, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1148846080, 0);
							iVar0 = 0;
							iVar0 = 16;
							iVar0 = 64;
							iVar0 = 512;
							iVar0 = 4096;
							PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_54, iLocal_47, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar0, 1148846080);
							SET_PED_KEEP_TASK(iLocal_58, true);
						}
					}
				}
...
void func_263()
{
	...
	if (!func_11(iVar0))
	{
		iVar0 = GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_229, 10f, 0, 16390);
		if (!func_11(iVar0))
		{
			return;
		}
...
int func_274()
{
	...
	REQUEST_ADDITIONAL_TEXT("MAUDE1", 0);
	if (HAS_ANIM_DICT_LOADED("special_ped@maude@base") && HAS_ANIM_DICT_LOADED(0))
	{
		return 1;
	}
	return 0;
...
void func_275(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_40 = ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar1, 0, 1, 1, 1);
			...
			{
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_40, 0);
	...
	if (DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_325(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_322(GET_ENTITY_COORDS(Global_102125.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_296(iParam0, 0, 0)) || func_296(iParam0, 1, 0)) || func_296(iParam0, 2, 0)) || func_315(iParam0) != 145) || func_295(iParam0)) || func_294(iParam0)) || func_293(iParam0)) || func_292(iParam0)) || !func_282(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_294(iParam0))
		{
		}
...
var func_298()
{
	...
	func_308(&uVar0, GET_CLOCK_SECONDS());
	func_307(&uVar0, GET_CLOCK_MINUTES());
	func_306(&uVar0, GET_CLOCK_HOURS());
	func_301(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_300(&uVar0, GET_CLOCK_MONTH());
	func_299(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_304(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_335(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_337(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_340()
{
	...
	if (!DOES_ENTITY_EXIST(iLocal_57))
	{
		...
		{
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, iVar1, 0))
			{
				iLocal_57 = GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, iVar1, 1, 0, 1);
			}
		}
	}
}
...
int func_344(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		...
		{
			if (!func_347(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_349()
{
	...
	if (iLocal_48 == 0)
	{
		...
		{
			if (!func_350(PLAYER_PED_ID(), Local_41.f_28[0], 7f, 1))
			{
				SET_GAMEPLAY_ENTITY_HINT(Local_41.f_28[0], 0f, 0f, 0f, 1, -1, 2000, 2000, 0);
				...
				if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					TASK_FOLLOW_TO_OFFSET_OF_ENTITY(TASK_FOLLOW_TO_OFFSET_OF_ENTITY(), Local_41.f_28[0], 0f, 1.2f, 0f, 1f, -1, 1036831949, 1);
				}
			...
			else
			{
				if (!IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
				{
					TASK_TURN_PED_TO_FACE_ENTITY(TASK_TURN_PED_TO_FACE_ENTITY(), Local_41.f_28[0], 0);
				}
				iLocal_49 = -1;
			}
			TASK_LOOK_AT_ENTITY(TASK_LOOK_AT_ENTITY(), Local_41.f_28[0], 4000, 0, 2);
		}
		iLocal_48++;
	}
	else if (iLocal_48 == 1)
	{
		if ((iLocal_49 == -1 || (GET_GAME_TIMER() - iLocal_49) > 3000) || (func_11(Local_41.f_28[0]) && func_350(GET_GAME_TIMER(), Local_41.f_28[0], 4.5f, 1)))
		{
			return 1;
		}
	}
...
void func_353()
{
	if (IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			if (func_347(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_363(var uParam0)
{
	...
	switch (iLocal_39)
	{
		...
		case 1:
			if (!func_368(&iVar0) || !HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_39 = 2;
		...
		case 3:
			if (func_17(uParam0->f_28[0]) && func_11(uParam0->f_41[0]))
			{
				...
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uParam0->f_59, false);
				...
				iVar3 += 512;
				iVar3 += 4096;
				PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], uParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar3, 1148846080);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_377(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_178(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_381(*iParam1, 0, &uVar0))
		{
...
int func_381(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_408(iVar0, bParam1, uParam2) && !func_407(PLAYER_ID())) && !func_391(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_389(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_387(iParam0)) && !bVar1) && !(func_386(IS_BIG_VEHICLE(iParam0)) && func_382(IS_BIG_VEHICLE())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_293(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_406(PLAYER_ID()) || func_405(PLAYER_ID()))
	{
		if (func_392(iParam0))
		{
			return 1;
...
int func_393(int iParam0)
{
	...
	if (func_394(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_395(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_397(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_408(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_389(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
...
int func_413(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_404(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_416(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_416(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_415(iParam0);
	if (func_414(*iParam0))
	{
...
void func_418(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_310(iParam0, iParam1))
				{
	...
	if (func_441(uParam0))
	{
		...
		if (func_440(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_426(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_426(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_428(iParam0, uVar1[iVar3], 1) && func_427(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_316(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_429(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_318(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_318(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_318(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_432(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_431())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_318(iVar2 + 1)))
				{
