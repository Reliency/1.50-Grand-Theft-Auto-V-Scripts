...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 2:
			if (func_50(PLAYER_PED_ID(), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				vVar3 = { GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0, 2) };
				vVar4 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_39(uParam0), func_38(uParam0), 0f, 2) };
				iVar5 = vVar4.z;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_29.f_1 = _0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
				NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_29.f_1, &sVar0, &sVar1, 2f, -1000f, 13, 16, 1.5f, 0);
				NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_29.f_1);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar7 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iVar7))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(iVar7) >= 1f)
				{
					...
					func_40(uParam0, &sVar1);
					uParam0->f_29.f_1 = _0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
					NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_29.f_1, &sVar0, &sVar1, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_29.f_1);
					func_25(&(uParam0->f_29), 8);
		...
		case 8:
			iVar8 = NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_29.f_4 == 6)
	{
		...
		fVar1 = vmag(vVar0);
		if ((uParam0->f_29.f_4 == 6 && !HAS_ANIM_EVENT_FIRED(HAS_ANIM_EVENT_FIRED(), -1322051853)) && !func_8(&(uParam0->f_29), 12))
		{
			if (fVar1 >= 0.35f)
			{
				func_23(uParam0);
...
void func_24(var uParam0)
{
	...
	uParam0->f_29.f_1 = _0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216, 0, 1065353216);
	func_41(uParam0, &sVar0);
	NETWORK_CREATE_SYNCHRONISED_SCENE(NETWORK_CREATE_SYNCHRONISED_SCENE(), uParam0->f_29.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_29.f_1);
	func_9(&(uParam0->f_29.f_5));
	func_52(uParam0, 8);
}
...
int func_47(var uParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(NETWORK_IS_PARTICIPANT_ACTIVE(iVar0)))
		{
			...
			if ((iVar1 != PLAYER_ID() && func_48(iVar1, 1, 1)) && func_50(PLAYER_ID(iVar1), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_54(var uParam0)
{
	...
	else if (uParam0->f_29.f_4 > 4)
	{
		...
		SET_PED_CAPSULE(SET_PED_CAPSULE(), func_55(uParam0));
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_29), 1, IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0));
	func_57(&(uParam0->f_29), 3, IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1));
	func_57(&(uParam0->f_29), 0, func_36(0));
	func_57(&(uParam0->f_29), 2, IS_PED_RUNNING(IS_PED_RUNNING()));
}
...
int func_61()
{
	...
	if (func_62() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_62()) == 0)
		{
			return 1;
		}
	}
...
{
	return IS_ENTITY_IN_ANGLED_AREA(iParam0, 362.0188f, 4823.182f, -59.98693f, 374.756f, 4823.096f, -56.23059f, 9f, 0, true, 0);
}
...
int func_73()
{
	if (Global_1590291 != func_60())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1590291, 1, 0))
		{
			return 0;
		}
...
{
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_273.f_267.f_1, 0);
}
