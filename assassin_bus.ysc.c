...
void __EntryFunction__()
{
	...
	iLocal_143 = 100;
	iLocal_144 = 3;
	iLocal_734 = _0x4A9923385BDB9DAD();
	iLocal_735 = _GET_BLIP_INFO_ID_ITERATOR();
	iLocal_980 = 1;
	iLocal_1327 = -1;
	fLocal_1329 = 1f;
	...
	iLocal_1391 = 1;
	iLocal_1413 = -1;
	iLocal_1416 = GET_RANDOM_INT_IN_RANGE(5, 15);
	iLocal_1421 = GET_RANDOM_INT_IN_RANGE(5, 10);
	iLocal_1426 = 1000;
	fLocal_1434 = 0.5f;
	fLocal_1438 = 15f;
	...
	if (HAS_FORCE_CLEANUP_OCCURRED(3))
	{
		...
		func_542();
		func_540();
		if (DOES_ENTITY_EXIST(iLocal_1348))
		{
			SET_ENTITY_VISIBLE(iLocal_1348, true, 0);
			SET_ENTITY_COLLISION(iLocal_1348, true, 0);
			SET_ENTITY_CAN_BE_DAMAGED(iLocal_1348, true);
		}
		func_539();
	...
	while (true)
	{
		...
		if (func_487(&uScriptParam_1911))
		{
			if (func_486())
			{
				...
				func_483();
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1466[0], 0);
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1466[1], 0);
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1466[2], 0);
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1466[3], 0);
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1466[4], 0);
				REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1466[5], 0);
...
void func_1(struct<39> Param0, var uParam1, var uParam2)
{
	...
	switch (iLocal_982)
	{
		...
		case 1:
			...
			if (func_102(&uLocal_148, 1, 0) && _0x6F259F82D873B8B8())
			{
...
void func_10(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_111560.f_20559.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_12() /*10828*/].f_6168.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_111560.f_20559.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_12() /*10828*/].f_6168.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_18(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_12() /*10828*/].f_6168.f_10, iParam0);
}
...
void func_58(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_64(uParam0->f_1, 256) || (func_64(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_64(uParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_66(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (!uParam0->f_563)
	{
		switch (func_46(GET_PLAYER_PED(GET_PLAYER_PED())))
		{
			case 1:
...
void func_67(var uParam0, bool bParam1)
{
	...
	func_63(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, true));
	func_62("ES_HELP");
	if (IS_PC_VERSION())
	{
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
	...
	if (bParam1)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
		_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		func_63(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, true));
		func_62("ES_XPAND");
		if (IS_PC_VERSION())
		{
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(true);
...
void func_69(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_87();
		DRAW_RECT(0.5f, (fVar1 - (func_90((2f - 0.5f)) - 0.001388889f)), fVar6, func_82(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_68((fVar11 / (0.6f * func_90(25f))), 0f, 1f);
					func_87();
					DRAW_RECT(0.5f, (fVar1 + func_90((2f * 0.5f))), fVar6, func_82(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_90((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_90((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					END_TEXT_COMMAND_DISPLAY_TEXT(fVar20, (fVar1 + func_90((2f * 2f))), 0);
					break;
...
void func_79(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			DRAW_SPRITE("CommonMenu", func_75(7, 0), (fParam4 - 0.006f), ((fParam2 + func_90(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_72(5, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_75(5, 0), (fParam4 - 0.006f), ((fParam2 + func_90(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_72(6, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_75(6, 0), (fParam4 - 0.006f), ((fParam2 + func_90(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_103(var uParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	func_63(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, true));
	func_62("ES_HELP_TU");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
	func_63(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, true));
	func_62("ES_HELP_TD");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
	func_63(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, true));
	func_62("ES_HELP_AB");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	END_SCALEFORM_MOVIE_METHOD();
...
void func_106()
{
	...
	if (!iLocal_137)
	{
		...
		else
		{
			...
			if (!IS_STRING_NULL_OR_EMPTY(&(Local_725.f_18)))
			{
				if (bLocal_135)
				{
...
void func_114()
{
	if (DOES_ENTITY_EXIST(iLocal_1463) && DOES_ENTITY_EXIST(iLocal_1463, 0))
	{
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !DOES_ENTITY_EXIST(iParam0, 0)) || func_133(iParam0, 0, 0)) || func_133(iParam0, 1, 0)) || func_133(iParam0, 2, 0)) || func_156(iParam0) != 145) || func_132(iParam0)) || func_131(iParam0)) || func_130(iParam0)) || func_129(iParam0)) || !func_119(DOES_ENTITY_EXIST(iParam0)))
	{
		if (func_131(iParam0))
		{
		}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_159(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_164()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 <= 2)
		{
			if (!IS_PED_INJURED(Local_1898[iVar0 /*30*/].f_14[iVar1]) && IS_PED_INJURED(Local_1898[iVar0 /*30*/].f_14[iVar1], 0))
			{
				SET_PED_COMBAT_ATTRIBUTES(Local_1898[iVar0 /*30*/].f_14[iVar1], 3, false);
				SET_PED_FLEE_ATTRIBUTES(Local_1898[iVar0 /*30*/].f_14[iVar1], 2, false);
				SET_PED_KEEP_TASK(Local_1898[iVar0 /*30*/].f_14[iVar1], true);
			}
			iVar1++;
		}
		iVar0++;
...
float func_165(int iParam0)
{
	if (func_168(iParam0))
	{
		...
		{
			return (func_166(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
int func_169(var uParam0, int iParam1)
{
	...
	switch (iLocal_980)
	{
		...
		case 7:
			...
			{
				func_372();
				if (func_370(uParam0->f_6, fLocal_1438) && IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()))
				{
					if (DOES_BLIP_EXIST(iParam1->f_2))
					{
						REMOVE_BLIP(&(iParam1->f_2));
			...
			else if (!IS_PLAYER_WANTED_LEVEL_GREATER(IS_PLAYER_WANTED_LEVEL_GREATER(), 0))
			{
			...
			func_365(iParam1);
			func_364();
			if ((((IS_PLAYER_WANTED_LEVEL_GREATER(IS_PLAYER_WANTED_LEVEL_GREATER(), 0) && func_363(iParam1->f_1, 1) < fLocal_1438) || !func_362(iParam1->f_1)) || IS_PLAYER_WANTED_LEVEL_GREATER(-1, uParam0->f_9, 25f)) || IS_PLAYER_WANTED_LEVEL_GREATER(iParam1->f_1, IS_PLAYER_WANTED_LEVEL_GREATER(), 1))
			{
			...
			if (func_350(&Local_983, uParam0))
			{
				if (iLocal_965 == 1)
				{
					if (GET_PED_LAST_DAMAGE_BONE(*iParam1, &iVar0) && iVar0 != -1)
					{
						if (!func_349(*iParam1))
						{
							START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE("scr_ojbusass_bus_impact", *iParam1, 0f, 0f, 0f, START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(iParam1->f_1), iVar0, 2f, 0, 0, 0);
						}
					}
					else if (!func_349(*iParam1))
					{
						START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE("scr_ojbusass_bus_impact", *iParam1, 0f, 0f, 0f, START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(iParam1->f_1), 31086, 2f, 0, 0, 0);
					}
				}
...
int func_174(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_176() == 0)
		{
			return IS_BIT_SET(func_19(func_175(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_202(int iParam0)
{
	...
	{
		case 0:
			if (!IS_ENTITY_DEAD(iParam0->f_1, 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iParam0->f_1, 0))
				{
		...
		case 1:
			if (!IS_ENTITY_DEAD(iParam0->f_1, 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
			{
				if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iParam0->f_1, 0))
				{
					vVar1 = { GET_ENTITY_COORDS(iParam0->f_1, false) };
					vVar0 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false) };
					if (vdist2(vVar1, vVar0) < 2500f)
					{
			...
			else if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && IS_ENTITY_DEAD(iParam0->f_1))
			{
				if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iParam0->f_1, 0))
				{
					vVar1 = { GET_ENTITY_COORDS(iParam0->f_1, false) };
		...
		case 2:
			if (IS_VEHICLE_DRIVEABLE(iParam0->f_1, 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iParam0->f_1, 0))
				{
					iLocal_1433 = 0;
...
void func_204(int iParam0, bool bParam1)
{
	...
	if (func_165(&iLocal_1489) > fLocal_1439)
	{
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			iVar2 = GET_PED_IN_VEHICLE_SEAT(iParam0, iVar0, 0);
			if (!IS_PED_INJURED(iVar2))
			{
				if (!bParam1)
				{
					if (iVar1 == 0)
					{
						PLAY_PAIN(iVar2, 6, 0f, 0);
					}
					else if (iVar1 == 1)
					{
						PLAY_PAIN(iVar2, 7, 0f, 0);
					}
					else if (iVar1 == 2)
					{
						PLAY_PAIN(iVar2, 3, 0f, 0);
					}
				}
			}
		}
		fLocal_1439 = GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
		func_183(&iLocal_1489);
	}
}
...
void func_206(int iParam0)
{
	...
	else if (IS_VEHICLE_DRIVEABLE(iParam0->f_1, 0))
	{
		if (DOES_ENTITY_EXIST(*iParam0))
		{
			if (DOES_ENTITY_EXIST(iParam0->f_8))
			{
				if (IS_VEHICLE_DRIVEABLE(iParam0->f_8, 0) && IS_VEHICLE_DRIVEABLE(*iParam0, iParam0->f_8, 0))
				{
...
void func_207(var uParam0, int iParam1)
{
	...
	switch (iLocal_1345)
	{
		...
		case 1:
			if (func_344(uParam0) && func_343(uParam0))
			{
				CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED());
				func_342();
		...
		case 2:
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam1->f_1, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
			{
				func_352(Local_1346, uParam0, 2);
				return;
			}
			if (IS_VEHICLE_DRIVEABLE(iParam1->f_1, 0))
			{
				if (func_340(iParam1))
				{
					func_339();
	...
	if (iLocal_1345 > 4)
	{
		if (func_225(*iParam1, 175f, 0))
		{
			...
			{
				if (!IS_ENTITY_ON_SCREEN(*iParam1) || IS_ENTITY_ON_SCREEN(*iParam1))
				{
					if (DOES_BLIP_EXIST(iParam1->f_2))
					{
						REMOVE_BLIP(&(iParam1->f_2));
						...
						if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iParam0->f_1, 0))
						{
							...
							if (fVar0 > 10f)
							{
								if (!IS_PED_INJURED(*iParam0))
								{
									...
									{
										if (IS_VEHICLE_DRIVEABLE(iParam0->f_8, 0))
										{
											if (IS_PED_IN_VEHICLE(*iParam0, iParam0->f_8, 0))
											{
												func_220(iParam0);
											}
											else if (!iLocal_1380)
	...
	if (!IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_168(&iLocal_1477))
		{
			if (!func_221())
			{
				...
				{
					if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_1, 0))
					{
						if (iLocal_1429 != 0)
						{
							func_214(uParam0);
...
{
	if (!IS_PED_INJURED(iParam1) && IS_PED_INJURED(iParam1, uParam0->f_1, 0))
	{
		return 1;
	}
	return 0;
...
void func_214(var uParam0)
{
	...
	switch (iLocal_1427)
	{
		case 0:
			...
			{
				iLocal_1426 = GET_ENTITY_HEALTH(uParam0->f_1);
				iLocal_1427++;
			}
			break;
		...
		case 1:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1426 - 50) || HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam0->f_1))
				{
					if (func_213(uParam0, iLocal_1453))
					{
						func_201(&(uParam0->f_16), 4, iLocal_1453, "BusPed1", 0, 1);
		...
		case 2:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1426 - 150) || HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam0->f_1))
				{
					if (func_213(uParam0, iLocal_1454))
					{
						func_201(&(uParam0->f_16), 5, iLocal_1454, "BusPed2", 0, 1);
		...
		case 3:
			if (!func_221())
			{
				if (iVar0 < (iLocal_1426 - 200) || HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam0->f_1))
				{
...
{
	iLocal_1421 = GET_RANDOM_INT_IN_RANGE(iParam0, iParam1);
	func_183(&iLocal_1477);
	func_183(&iLocal_1483);
	iLocal_1417++;
}
...
{
	iLocal_1416 = GET_RANDOM_INT_IN_RANGE(iParam0, iParam1);
	func_183(&iLocal_1474);
	func_183(&iLocal_1483);
	iLocal_1415++;
}
	...
	if (iLocal_1345 < 4)
	{
		if (DOES_ENTITY_EXIST(iParam1->f_1))
		{
			...
			if (iLocal_1345 >= 3)
			{
				if (IS_VEHICLE_DRIVEABLE(iParam1->f_1, 0))
				{
					if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iParam1->f_1, 0))
					{
						if (bLocal_1378 == 1)
						{
							bLocal_1378 = false;
		...
		if (!bLocal_1378)
		{
			if (!IS_ENTITY_DEAD(iParam1->f_1, 0))
			{
				vLocal_1447 = { GET_ENTITY_COORDS(iParam1->f_1, true) };
			}
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				vLocal_1448 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
			}
			if (vdist2(vLocal_1448, vLocal_1447) > 10000f)
			{
				if (!IS_PED_GETTING_INTO_A_VEHICLE(IS_PED_GETTING_INTO_A_VEHICLE()))
				{
...
void func_223(int iParam0)
{
	if (func_168(iParam0))
	{
		if (!func_167(iParam0))
		{
			iParam0->f_2 = (func_166(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
			SET_BIT(iParam0, 2);
		}
	}
}
...
void func_224()
{
	REMOVE_BLIP(&(Local_1898[0 /*30*/].f_9));
	REMOVE_BLIP(&(Local_1898[1 /*30*/].f_9));
	REMOVE_BLIP(&(Local_1898[2 /*30*/].f_9));
	REMOVE_BLIP(&(Local_1898[3 /*30*/].f_9));
}
...
void func_226(var uParam0, int iParam1)
{
	if (!iLocal_1377 == 1)
	{
		if (iLocal_1345 < 4)
		{
			if (((((func_235(*iParam1, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1) || func_233(&uLocal_1414)) || iLocal_1424 >= 2) || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || !GET_PLAYER_WANTED_LEVEL(iParam1->f_1, 0)) || func_232(*iParam1, iParam1->f_8, 1097859072))
			{
				if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0)
				{
				}
				...
				if (IS_VEHICLE_DRIVEABLE(iParam1->f_1, 0))
				{
					if (DOES_ENTITY_EXIST(*iParam1))
					{
						if (!IS_PED_INJURED(*iParam1))
						{
							if (func_363(*iParam1, 1) < 30f || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(*iParam1, HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(), 1))
							{
								func_224();
								if (DOES_BLIP_EXIST(iParam1->f_2))
								{
								...
								iLocal_1381 = 1;
								if ((func_230(iParam1) && !IS_ENTITY_ON_SCREEN(iParam1->f_1)) && !IS_ENTITY_ON_SCREEN(*iParam1))
								{
...
{
	SET_PLAYER_WANTED_LEVEL_NO_DROP(SET_PLAYER_WANTED_LEVEL_NO_DROP(), iParam0, 0);
	SET_PLAYER_WANTED_LEVEL_NOW(SET_PLAYER_WANTED_LEVEL_NOW(), 0);
	SET_WANTED_LEVEL_DIFFICULTY(SET_WANTED_LEVEL_DIFFICULTY(), fParam1);
...
{
	TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iParam0, iParam1, "OJASbs_102", 52, 0, 20, -1, -1f, 0, 1073741824);
	vLocal_1440 = { -455.2892f, -326.1364f, 41.22218f };
	WAYPOINT_RECORDING_GET_NUM_POINTS("OJASbs_102", &iLocal_1430);
	SET_ENTITY_LOAD_COLLISION_FLAG(iParam0, true, 1);
	fLocal_1435 = _GET_VEHICLE_MAX_SPEED(iParam1);
	_SET_VEHICLE_ENGINE_POWER_MULTIPLIER(iParam1, (fLocal_1434 * 100f));
...
int func_230(var uParam0)
{
	if (!IS_ENTITY_DEAD(uParam0->f_1, 0) && !IS_ENTITY_DEAD(uParam0->f_8, 0))
	{
		if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
		{
			...
			{
				if (func_231(uParam0->f_8, Local_1898[iLocal_1413 /*30*/].f_5, 1) > 5f || IS_ENTITY_TOUCHING_ENTITY(uParam0->f_1, uParam0->f_8))
				{
					return 0;
				}
			}
...
int func_232(int iParam0, int iParam1, float fParam2)
{
	if (DOES_ENTITY_EXIST(iParam1))
	{
		if (IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			else if (IS_ENTITY_TOUCHING_ENTITY(IS_ENTITY_TOUCHING_ENTITY(), iParam1))
			{
				return 1;
			}
		}
...
int func_234()
{
	if (bLocal_1378)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			if (IS_PED_ARMED(IS_PED_ARMED(), 4))
			{
				if (IS_PED_SHOOTING(IS_PED_SHOOTING()) && !IS_PED_SHOOTING(IS_PED_SHOOTING()))
				{
					return 1;
				}
			}
...
int func_236(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_237(PLAYER_PED_ID(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (IS_PED_RAGDOLL(iParam0) && func_363(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_239(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (IS_PED_PLANTING_BOMB(iParam0) || func_240(iVar1))
			{
				if (IS_ENTITY_AT_COORD(iParam1, IS_ENTITY_AT_COORD(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (IS_PED_FACING_PED(IS_PED_FACING_PED(iParam1), iParam0, 120f) && IS_PED_FACING_PED(iParam1, iParam0, 17))
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (GET_CURRENT_PED_WEAPON(GET_CURRENT_PED_WEAPON(), &iVar0, 1))
				{
					...
					{
						if (func_241(PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
...
void func_249(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_272(iParam1) && IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_254(char* sParam0)
{
	if (!func_255(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_274(sParam0)) || func_274("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_255(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_262() || func_261(Global_4456448.f_190930)) || func_260())
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			...
			iVar1 = func_259(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(iVar0, iVar1) || (_0xE33FFA906CE74880(iVar0) == 562680400 && iVar1 != -1)) || (_0xE33FFA906CE74880(iVar0) == 1181327175 && iVar1 != -1)) || (((_0xE33FFA906CE74880(iVar0) == -1693015116 && iVar1 == 0) && func_258(iVar0, 10)) && _0xE33FFA906CE74880(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_256(int iParam0)
{
	if (iParam0 != func_192())
	{
		...
		else if ((Global_1312873 && iParam0 == PLAYER_ID()) && func_257(iParam0, 1, 0))
		{
			return Global_2424073[iParam0 /*421*/].f_309.f_5 != -1;
		}
	}
...
int func_267(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_270(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 1) || func_268(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
	...
	if (!IS_ENTITY_DEAD(iParam0, 0))
	{
		if (GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1 && GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 0)
		{
			if (func_231(iParam0, vLocal_1440, 1) <= 50f)
			{
				...
				TASK_GO_TO_COORD_ANY_MEANS(0, vLocal_1440, 2f, 0, 0, 786603, -1082130432);
...
void func_278(int iParam0, int iParam1)
{
	...
	if (func_165(&iLocal_1486) > 1f)
	{
		...
		if (DOES_ENTITY_EXIST(iParam0) && DOES_ENTITY_EXIST(iParam1, 0))
		{
			if (IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iParam1))
			{
				if (fVar0 > 150f)
				...
				if (fLocal_1436 != 0f)
				{
					SET_DRIVE_TASK_CRUISE_SPEED(iParam0, fLocal_1436);
				}
			}
		}
	}
...
void func_279()
{
	if (!iLocal_1396)
	{
		if (!IS_PED_INJURED(iLocal_1498))
		{
			CLEAR_PED_TASKS(iLocal_1498);
			TASK_PLAY_ANIM(iLocal_1498, "oddjobs@assassinate@bus@", "looking_for_help", 8f, -8f, -1, 1, 0, 0, 0, 0);
			PLAY_PAIN(iLocal_1498, 6, 0f, 0);
			iLocal_1396 = 1;
		}
	}
	else if (DOES_ENTITY_EXIST(iLocal_1498))
	{
		if (func_235(iLocal_1498, 0, &uLocal_120, &uLocal_131, 0, 0, 0, 1, 1))
		{
			if (GET_SCRIPT_TASK_STATUS(iLocal_1498, 1805844857) != 1)
			{
				CLEAR_PED_TASKS(iLocal_1498);
				TASK_SMART_FLEE_PED(iLocal_1498, TASK_SMART_FLEE_PED(), 1000f, -1, 0, 0);
			}
		}
		if (func_363(iLocal_1498, 1) > 100f)
		{
			if (!IS_ENTITY_ON_SCREEN(iLocal_1498) || IS_ENTITY_ON_SCREEN(iLocal_1498))
			{
				DELETE_PED(&iLocal_1498);
			}
		}
	}
}
	...
	switch (iLocal_1412)
	{
		case 0:
			if (func_300(1, 3f))
			{
				...
				{
					REGISTER_ENTITY_FOR_CUTSCENE(*uParam0, "Mugger", 0, REGISTER_ENTITY_FOR_CUTSCENE(*uParam0), 0);
				}
				if (!IS_ENTITY_DEAD(iLocal_1498, 0))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(iLocal_1498, "Mugging_Victim", 0, joaat("a_f_o_genstreet_01"), 0);
				}
				if (!IS_ENTITY_DEAD(uParam1->f_1, 0))
				{
					if (bLocal_1399)
		...
		case 1:
			if (IS_CUTSCENE_PLAYING())
			{
				...
				if (DOES_CAM_EXIST(iLocal_1464) && DOES_CAM_EXIST(iLocal_1464))
				{
					SET_CAM_ACTIVE(iLocal_1464, false);
					DESTROY_CAM(iLocal_1464, 0);
					RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
				}
				else if (DOES_CAM_EXIST(iLocal_1464))
				{
					DESTROY_CAM(iLocal_1464, 0);
				}
				if ((DOES_ENTITY_EXIST(*uParam0) && !DOES_ENTITY_EXIST(*uParam0)) && DOES_ENTITY_EXIST(uParam1->f_8, 0))
				{
				...
				{
					if (DOES_ENTITY_EXIST(iLocal_1498) && !DOES_ENTITY_EXIST(iLocal_1498))
					{
						func_279();
					}
				}
				...
				{
					if (((DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()) && !DOES_ENTITY_EXIST(DOES_ENTITY_EXIST())) && DOES_ENTITY_EXIST(uParam1->f_1)) && !DOES_ENTITY_EXIST(uParam1->f_1, 0))
					{
						SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), uParam1->f_1, -1);
			...
			if (HAS_CUTSCENE_FINISHED())
			{
				...
				if (!IS_PED_INJURED(*uParam0))
				{
					if (DOES_ENTITY_EXIST(uParam1->f_8) && DOES_ENTITY_EXIST(uParam1->f_8, 0))
					{
					...
					else
					{
						...
						TASK_SMART_FLEE_PED(*uParam0, TASK_SMART_FLEE_PED(), 500f, -1, 0, 0);
					}
				}
...
void func_282(int iParam0, int iParam1)
{
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		SET_VEHICLE_DOOR_SHUT(iParam0, 1, iParam1);
		SET_VEHICLE_DOOR_SHUT(iParam0, 0, iParam1);
	}
}
...
void func_283(int iParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= 2)
		{
			if (!IS_PED_INJURED(Local_1898[iParam1 /*30*/].f_14[iVar0]))
			{
				if (iVar0 == 0)
				{
				...
				CLEAR_PED_TASKS(Local_1898[iParam1 /*30*/].f_14[iVar0]);
				OPEN_SEQUENCE_TASK(&iVar1);
				TASK_TURN_PED_TO_FACE_ENTITY(0, iParam0, 0);
				TASK_PLAY_ANIM(0, "misscommon@response", sVar2, 8f, -8f, -1, 0, 0, 0, 0, 0);
				TASK_WANDER_STANDARD(0, 1193033728, 0);
				CLOSE_SEQUENCE_TASK(iVar1);
				TASK_PERFORM_SEQUENCE(Local_1898[iParam1 /*30*/].f_14[iVar0], iVar1);
...
void func_286(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(IS_PED_INJURED()) && !func_290(IS_PED_INJURED())) && !func_288(IS_PED_INJURED(), 0)) && !func_287()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
			}
		}
		else if (((!IS_PED_INJURED(IS_PED_INJURED()) && !func_290(IS_PED_INJURED())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(SET_ENTITY_INVINCIBLE(), false);
		}
		Global_76575 = 0;
...
void func_294(int iParam0, int iParam1)
{
	...
	if (iParam1 == 1)
	{
		...
		{
			if (func_349(PLAYER_PED_ID()))
			{
				SET_CURRENT_PED_WEAPON(SET_CURRENT_PED_WEAPON(), iLocal_1499, false);
			}
		}
	}
}
...
void func_295(vector3 vParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	{
		func_297();
		REMOVE_PLAYER_HELMET(REMOVE_PLAYER_HELMET(), 0);
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_296(CLEAR_AREA_OF_PEDS()), 50f, 0);
		}
		...
		if (iParam4 == 1)
		{
			...
			if (func_349(PLAYER_PED_ID()))
			{
				iLocal_1499 = GET_SELECTED_PED_WEAPON(GET_SELECTED_PED_WEAPON());
...
void func_298(int iParam0)
{
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (!bLocal_1399)
		{
			SET_VEHICLE_DOOR_OPEN(iParam0, 1, 0, false);
		}
		SET_VEHICLE_DOOR_OPEN(iParam0, 0, 0, false);
	}
}

void func_299()
{
	if (_0x07C313F94746702C(iLocal_1497))
	{
		_0x1EE7D8DF4425F053(iLocal_1497);
		iLocal_1406 = 0;
	}
}
...
int func_300(int iParam0, float fParam1)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		if (!func_303(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0), fParam1, 1, 1056964608, 0, 1, 0))
		{
			iVar0 = 0;
		}
		if (!IS_VEHICLE_ON_ALL_WHEELS(IS_VEHICLE_ON_ALL_WHEELS(IS_VEHICLE_ON_ALL_WHEELS(), 0)))
		{
			iVar0 = 0;
		}
	}
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_1, 0))
		{
			...
			if (func_267(&uLocal_1899, 1, 0, 0))
			{
				...
				if (!DOES_CAM_EXIST(iLocal_140))
				{
					iLocal_140 = CREATE_CAMERA(26379945, 0);
					_0x661B5C8654ADD825(iLocal_140, 1);
					...
					if (bLocal_1398)
					{
						ATTACH_CAM_TO_ENTITY(iLocal_140, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, 1);
						POINT_CAM_AT_ENTITY(iLocal_140, uParam0->f_1, -0.0074f, -3.4691f, 1.1139f, 1);
					}
					else if (bLocal_1399)
					{
						ATTACH_CAM_TO_ENTITY(iLocal_140, uParam0->f_1, -0.0387f, -5.3568f, 0.8942f, 1);
						POINT_CAM_AT_ENTITY(iLocal_140, uParam0->f_1, 0.0245f, -2.4095f, 0.3379f, 1);
					}
					else
					{
						ATTACH_CAM_TO_ENTITY(iLocal_140, uParam0->f_1, 0.0467f, -6.4343f, 1.5665f, 1);
...
void func_307(var uParam0, var uParam1)
{
	...
	if (iVar0 == 3)
	{
		if (!IS_ENTITY_DEAD(uParam0->f_1, 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_1, 1))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(uParam0->f_1, 112.8744f, -780.2048f, 29.41912f, 118.2785f, -782.2339f, 34.38423f, 2.5f, 0, true, 0))
				{
	...
	if (!IS_SPHERE_VISIBLE(Local_1898[iVar0 /*30*/].f_1, 15f))
	{
		CLEAR_AREA_OF_VEHICLES(Local_1898[iVar0 /*30*/].f_1, 15f, 0, 0, 0, 0, false, 0);
	}
	if (iLocal_1391)
	{
		fVar1 = ((GET_ENTITY_SPEED(GET_ENTITY_SPEED()) / 5f) + 6f);
	...
	if (iLocal_1391)
	{
		if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0) && IS_VEHICLE_DRIVEABLE(IS_VEHICLE_DRIVEABLE(), uParam0->f_1, 0))
		{
			if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), Local_1898[iVar0 /*30*/].f_21, 5f, 5f, 2f, true, true, 0))
			{
			}
		}
	}
	if (!IS_ENTITY_DEAD(uParam0->f_1, 0))
	{
		if (IS_PED_SITTING_IN_VEHICLE(IS_PED_SITTING_IN_VEHICLE(), uParam0->f_1))
		{
			if (Local_1898[iVar0 /*30*/])
			{
				vVar3 = { GET_PED_BONE_COORDS(GET_PED_BONE_COORDS(), 31086, 0f, 0f, 0f) };
				if ((((GET_DISTANCE_BETWEEN_COORDS(vVar3, Local_1898[iVar0 /*30*/].f_21, true) <= fVar1 && GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS())) && GET_DISTANCE_BETWEEN_COORDS(iLocal_1497)) && !func_334(iVar0)) && !bLocal_1387)
				{
					iLocal_1391 = 0;
				}
				if (iLocal_1429 > 0)
...
void func_308(var uParam0, var uParam1, int iParam2)
{
	...
	SET_PED_RESET_FLAG(SET_PED_RESET_FLAG(), 287, true);
	SET_PED_RESET_FLAG(SET_PED_RESET_FLAG(), 309, true);
	switch (iLocal_1411)
	{
		case 0:
			if (Local_1898[iParam2 /*30*/])
			{
				...
				if (GET_DISTANCE_BETWEEN_COORDS(vVar0, 0f, 0f, 0f, true) > 0.23f)
				{
					bLocal_1388 = true;
				...
				iLocal_1464 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1443, vLocal_1444, 65f, 0, 2);
				SET_CAM_FOV(iLocal_1464, 38f);
				SET_CAM_ACTIVE(iLocal_1464, true);
				if (!bLocal_1384)
				{
					ATTACH_CAM_TO_ENTITY(iLocal_1464, uParam0->f_1, -4.4984f, 8.6802f, -0.3745f, 1);
					POINT_CAM_AT_ENTITY(iLocal_1464, uParam0->f_1, -2.0642f, 7.0391f, 0.243f, 1);
				}
				CLEAR_AREA_OF_OBJECTS(Local_1898[iParam2 /*30*/].f_1, 30f, 0);
				CLEAR_AREA_OF_PEDS(Local_1898[iParam2 /*30*/].f_1, 30f, 0);
				REMOVE_PARTICLE_FX_IN_RANGE(Local_1898[iParam2 /*30*/].f_1, 7f);
				RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
				if (iParam2 == 0)
				{
					func_328(uParam0);
				...
				else
				{
					...
					SET_ENTITY_COORDS(uParam0->f_1, vLocal_1442, 1, false, 0, 1);
					SET_ENTITY_HEADING(uParam0->f_1, fLocal_1449);
					...
					vVar2 = { GET_ENTITY_COORDS(uParam0->f_1, true) };
					fVar4 = GET_ENTITY_HEADING(uParam0->f_1);
					vVar3 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar2, fVar4, 2f, 5.6201f, 0.1098f) };
					TASK_LOOK_AT_COORD(TASK_LOOK_AT_COORD(), vVar3, 5000, 0, 2);
				}
		...
		case 2:
			...
			if ((func_165(&iLocal_1468) > 1.5f && !bLocal_1388) || (bLocal_1388 && !func_221()))
			{
				...
				func_183(&iLocal_1468);
				REMOVE_BLIP(&(Local_1898[iParam2 /*30*/].f_9));
	...
	if (iLocal_1411 == 1)
	{
		if (func_310(iLocal_142))
		{
			...
			if (!IS_ENTITY_DEAD(uParam0->f_1, 0))
			{
				SET_ENTITY_HEADING(uParam0->f_1, Local_1898[iParam2 /*30*/].f_20);
			}
			REMOVE_BLIP(&(Local_1898[iParam2 /*30*/].f_9));
			if (iParam2 == iLocal_1413)
			{
				...
				if (!IS_PED_INJURED(*uParam0))
				{
					if (IS_VEHICLE_DRIVEABLE(uParam0->f_8, 0))
					{
						...
						SET_ENTITY_COORDS(uParam0->f_8, Local_1898[iLocal_1413 /*30*/].f_5, 1, false, 0, 1);
						SET_ENTITY_HEADING(uParam0->f_8, Local_1898[iLocal_1413 /*30*/].f_8);
				...
				CLEAR_AREA(Local_1898[iLocal_1413 /*30*/].f_5, 30f, 0, 0, 0, false);
				CLEAR_AREA_OF_OBJECTS(Local_1898[iLocal_1413 /*30*/].f_5, 30f, 0);
...
{
	if (func_311() && GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
void func_314(var uParam0, var uParam1, int iParam2)
{
	...
	if (DOES_ENTITY_EXIST(Local_1898[iParam2 /*30*/].f_14[2]))
	{
		DELETE_PED(&(Local_1898[iParam2 /*30*/].f_14[2]));
	}
...
void func_315(var uParam0, var uParam1)
{
	if (!DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = CREATE_PED(4, *uParam0, uParam0->f_1, uParam0->f_4, 1, true);
		SET_PED_MODEL_IS_SUPPRESSED(*uParam0, true);
		...
		if (!iLocal_969)
		{
			ADD_RELATIONSHIP_GROUP("Target", &iLocal_979);
			iLocal_969 = 1;
		}
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_979, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_979);
		SET_PED_RELATIONSHIP_GROUP_HASH(*uParam1, iLocal_979);
		if (uParam0->f_268)
		{
		...
		else if (uParam0->f_274 == 1)
		{
			...
			SET_PED_MONEY(*uParam1, SET_PED_MONEY(80, 100));
...
void func_316(var uParam0, int iParam1)
{
	...
	CLEAR_AREA(Local_1898[iParam1 /*30*/].f_1, 10f, 0, 0, 0, false);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA((Local_1898[iParam1 /*30*/].f_1 - 30f), (Local_1898[iParam1 /*30*/].f_1.f_1 - 30f), (Local_1898[iParam1 /*30*/].f_1.f_2 - 30f), (Local_1898[iParam1 /*30*/].f_1 + 30f), (Local_1898[iParam1 /*30*/].f_1.f_1 + 30f), (Local_1898[iParam1 /*30*/].f_1.f_2 + 30f), false, 1);
	if (!DOES_ENTITY_EXIST(Local_1898[iParam1 /*30*/].f_14[0]))
	{
		Local_1898[iParam1 /*30*/].f_14[0] = CREATE_PED(4, uParam0->f_16, vVar0[0 /*3*/], Local_1898[iParam1 /*30*/].f_4, 1, true);
		if (iParam1 == 0)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 3, 2, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 8, 0, 0, 0);
		}
		else if (iParam1 == 1)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 0, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 2, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 2, 2, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 3, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 8, 1, 0, 0);
		}
		else if (iParam1 == 3)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 0, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 2, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 3, 1, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[0], 4, 0, 0, 0);
		}
		TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[0], TASK_LOOK_AT_ENTITY(), -1, 2048, 4);
		TASK_PLAY_ANIM(Local_1898[iParam1 /*30*/].f_14[0], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[iParam1 /*30*/].f_14[0], true);
		_DYNAMIC_MIXER_RELATED_FN(Local_1898[iParam1 /*30*/].f_14[0], "PASSENGERS_Group", 0);
	}
	if (!DOES_ENTITY_EXIST(Local_1898[iParam1 /*30*/].f_14[1]))
	{
		Local_1898[iParam1 /*30*/].f_14[1] = CREATE_PED(4, joaat("a_m_m_eastsa_01"), vVar0[1 /*3*/], Local_1898[iParam1 /*30*/].f_4, 1, true);
		if (iParam1 == 0)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 3, 1, 3, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		else if (iParam1 == 1)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 0, 0);
		}
		else if (iParam1 == 2)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 3, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 2, 0);
		}
		else if (iParam1 == 3)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 0, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 3, 2, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[1], 4, 0, 1, 0);
		}
		TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[1], TASK_LOOK_AT_ENTITY(), -1, 2048, 4);
		TASK_PLAY_ANIM(Local_1898[iParam1 /*30*/].f_14[1], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[iParam1 /*30*/].f_14[1], true);
		_DYNAMIC_MIXER_RELATED_FN(Local_1898[iParam1 /*30*/].f_14[1], "PASSENGERS_Group", 0);
	}
	if (!DOES_ENTITY_EXIST(Local_1898[iParam1 /*30*/].f_14[2]))
	{
		Local_1898[iParam1 /*30*/].f_14[2] = CREATE_PED(4, uParam0->f_14, vVar0[2 /*3*/], Local_1898[iParam1 /*30*/].f_4, 1, true);
		if (iParam1 == 0)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 3, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 2, 0);
		}
		else if (iParam1 == 1)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 3, 1, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 2)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 3, 1, 2, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		else if (iParam1 == 3)
		{
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 0, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 2, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 3, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_1898[iParam1 /*30*/].f_14[2], 4, 0, 1, 0);
		}
		TASK_LOOK_AT_ENTITY(Local_1898[iParam1 /*30*/].f_14[2], TASK_LOOK_AT_ENTITY(), -1, 2048, 4);
		TASK_PLAY_ANIM(Local_1898[iParam1 /*30*/].f_14[2], "oddjobs@assassinate@bus@", "base", 4f, -4f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[iParam1 /*30*/].f_14[2], true);
		_DYNAMIC_MIXER_RELATED_FN(Local_1898[iParam1 /*30*/].f_14[2], "PASSENGERS_Group", 0);
	}
	if (iParam1 == 3)
	{
		if (!DOES_ENTITY_EXIST(Local_1898[iParam1 /*30*/].f_19))
		{
			Local_1898[iParam1 /*30*/].f_19 = CREATE_VEHICLE(uParam0->f_15, Local_1898[iParam1 /*30*/].f_5, Local_1898[iParam1 /*30*/].f_8, true, true, false);
			SET_VEHICLE_ON_GROUND_PROPERLY(Local_1898[iParam1 /*30*/].f_19, 1084227584);
		}
	}
}
	...
	while (iVar0 <= 2)
	{
		if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
		{
			if (!IS_PED_INJURED(Local_1898[iParam1 /*30*/].f_14[iVar0]))
			{
				...
				{
					SET_PED_INTO_VEHICLE(Local_1898[iParam1 /*30*/].f_14[iVar0], uParam0->f_1, iVar1);
				}
			}
		}
		iVar0++;
...
void func_320()
{
	iLocal_1498 = CREATE_PED(5, joaat("a_f_o_genstreet_01"), 110.6556f, -776.3679f, 30.439f, 346.1708f, 1, true);
	SET_PED_COMPONENT_VARIATION(iLocal_1498, 0, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_1498, 2, 1, 2, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_1498, 3, 0, 2, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_1498, 4, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_1498, 8, 1, 2, 0);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_1498, true);
}
...
var func_322(vector3 vParam0, int iParam1)
{
	...
	while (iVar3 <= 2)
	{
		if (!IS_ENTITY_DEAD(Local_1898[iParam1 /*30*/].f_14[iVar3], 0))
		{
...
{
	if (!DOES_CAM_EXIST(iLocal_1464))
	{
		iLocal_1464 = CREATE_CAMERA_WITH_PARAMS(26379945, CREATE_CAMERA_WITH_PARAMS(), CREATE_CAMERA_WITH_PARAMS(2), 35f, 0, 2);
	}
	if (!DOES_CAM_EXIST(iLocal_1465))
	{
		iLocal_1465 = CREATE_CAMERA_WITH_PARAMS(26379945, CREATE_CAMERA_WITH_PARAMS(), CREATE_CAMERA_WITH_PARAMS(2), 34f, 0, 2);
	}
	if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0) && !IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
	{
		if (bLocal_1398)
		{
			ATTACH_CAM_TO_ENTITY(iLocal_1464, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, 1);
			POINT_CAM_AT_ENTITY(iLocal_1464, uParam0->f_1, 1.2599f, 5.969f, 0.7051f, 1);
		}
		else if (bLocal_1399)
		{
			ATTACH_CAM_TO_ENTITY(iLocal_1464, uParam0->f_1, -1.6144f, 4.8097f, 0.4117f, 1);
			POINT_CAM_AT_ENTITY(iLocal_1464, uParam0->f_1, 1.328f, 4.756f, -0.1711f, 1);
		}
		else
		{
			ATTACH_CAM_TO_ENTITY(iLocal_1464, uParam0->f_1, -1.7004f, 5.5826f, 1.0005f, 1);
		...
		SET_CAM_NEAR_CLIP(iLocal_1464, 0.55f);
		SET_CAM_ACTIVE(iLocal_1464, true);
	}
	_SET_FAR_SHADOWS_SUPPRESSED(0);
...
void func_324(var uParam0, int iParam1)
{
	...
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
	{
		...
		fVar3 = GET_ENTITY_HEADING(GET_ENTITY_HEADING());
	}
	if (bLocal_1398)
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar2, fVar3, 2.519f, 5.6f, 0.1098f) };
	...
	if (!IS_PED_INJURED(iVar1))
	{
		...
		SET_ENTITY_COORDS(iVar1, vVar0.x, vVar0.y, fVar4, 1, false, 0, 1);
...
void func_325(var uParam0, int iParam1)
{
	...
	if (DOES_ENTITY_EXIST(iVar0) && !DOES_ENTITY_EXIST(iVar0, 0))
	{
		...
		if (iParam1 == 0)
		{
			SET_PED_MOVEMENT_CLIPSET(iVar0, "move_m@casual@d", 1048576000);
			TASK_FOLLOW_NAV_MESH_TO_COORD(iVar0, 305.2689f, -768.1415f, 28.17335f, 1f, 20000, 1048576000, 0, 1193033728);
			FORCE_PED_MOTION_STATE(iVar0, -668482597, false, 0, 0);
		}
		else if (iParam1 == 1)
		{
			SET_PED_MOVEMENT_CLIPSET(iVar0, "move_m@casual@d", 1048576000);
			TASK_GO_STRAIGHT_TO_COORD(iVar0, 358.6953f, -1065.935f, 28.39328f, 1f, 20000, 1193033728, 1056964608);
		}
		else if (iParam1 == 3)
		{
			TASK_GO_STRAIGHT_TO_COORD(iVar0, 111.6832f, -781.5098f, 30.26971f, 1f, 20000, 1193033728, 1056964608);
		}
		else
		{
...
void func_326(var uParam0, int iParam1)
{
	switch (iLocal_1431)
	{
		case 0:
			...
			{
				case 0:
					TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(), uParam0->f_1, "OJASbs01", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNG", 9, 0, 0, 0);
					break;
				
				case 1:
					TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(), uParam0->f_1, "OJASbs02", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGa", 9, 0, 0, 0);
					break;
				
				case 2:
					TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(), uParam0->f_1, "OJASbs03", 786603, 0, 16, -1, 3f, 0, 1073741824);
					func_212(&(uParam0->f_16), "OJASAUD", "OJASbs_WRNGb", 9, 0, 0, 0);
					break;
				
				case 3:
					TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(), uParam0->f_1, "OJASbs04", 786603, 0, 16, -1, 3f, 0, 1073741824);
		...
		case 1:
			if (func_168(&iLocal_1468))
			{
				if (func_165(&iLocal_1468) > 3f)
				{
					...
					DETACH_CAM(iLocal_1464);
					STOP_CAM_POINTING(iLocal_1464);
					SET_CAM_COORD(iLocal_1464, vLocal_1443);
					SET_CAM_ROT(iLocal_1464, vLocal_1444, 2);
...
void func_327(var uParam0, int iParam1, bool bParam2)
{
	...
	if (iParam1 == 0)
	{
		...
		fLocal_1449 = 160.65f;
		vLocal_1445 = { _GET_OBJECT_OFFSET_FROM_COORDS(vLocal_1442, fLocal_1449, vVar1) };
	}
	else if (iParam1 == 1)
	{
	...
	GET_GROUND_Z_FOR_3D_COORD(vLocal_1442, &uVar0, 0, 0);
	SET_PED_COORDS_KEEP_VEHICLE(SET_PED_COORDS_KEEP_VEHICLE(), vLocal_1445);
	SET_ENTITY_HEADING(uParam0->f_1, fLocal_1449);
	SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_1, 1084227584);
	...
	if (bLocal_1398)
	{
		vLocal_1441 = { _GET_OBJECT_OFFSET_FROM_COORDS(vLocal_1442, fLocal_1449, 2f, 5.6201f, 0.1098f) };
	}
	else if (bLocal_1399)
	{
		vLocal_1441 = { _GET_OBJECT_OFFSET_FROM_COORDS(vLocal_1442, fLocal_1449, 2f, 5.6201f, 0.1098f) };
	...
	if (bParam2)
	{
		TASK_LOOK_AT_COORD(TASK_LOOK_AT_COORD(), vLocal_1441, 5000, 0, 2);
	}
}
...
void func_328(var uParam0)
{
	...
	if (DOES_ENTITY_EXIST(uParam0->f_1) && !DOES_ENTITY_EXIST(uParam0->f_1, 0))
	{
		iVar1 = 0;
		while (iVar1 < 8)
		{
			if (!IS_VEHICLE_SEAT_FREE(uParam0->f_1, iVar1, 0))
			{
				iVar0[iVar1] = GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, iVar1, 0);
				SET_ENTITY_AS_MISSION_ENTITY(iVar0[iVar1], true, 0);
...
void func_329(int iParam0)
{
	...
	fVar0 = GET_ENTITY_HEADING(GET_ENTITY_HEADING());
	fVar1 = (Local_1898[iParam0 /*30*/].f_4 + 180f);
	vVar2 = { -sin(fVar0), cos(fVar0), 0f };
	vVar3 = { Local_1898[iParam0 /*30*/].f_1 - vVar4 };
	vVar5 = { GET_ENTITY_SPEED_VECTOR(GET_ENTITY_SPEED_VECTOR(), 0) };
	vVar6 = { GET_ENTITY_FORWARD_VECTOR(GET_ENTITY_FORWARD_VECTOR()) };
	if (!bLocal_1386)
	{
...
void func_333()
{
	if (DOES_ENTITY_EXIST(iLocal_1458[0]))
	{
		SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_1458[0]));
	}
	if (DOES_ENTITY_EXIST(iLocal_1458[1]))
	{
		SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_1458[1]));
	}
	if (DOES_ENTITY_EXIST(iLocal_1458[2]))
	{
		SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_1458[2]));
	}
	if (DOES_ENTITY_EXIST(iLocal_1458[3]))
	{
		SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_1458[3]));
	}
}
...
void func_335(int iParam0)
{
	if (!iLocal_1406)
	{
		if (func_368(Local_1898[iParam0 /*30*/].f_1, 1) <= 100f)
		{
			...
			{
				iLocal_1497 = _0x1F3F018BC3AFA77C(Local_1898[iParam0 /*30*/].f_24, Local_1898[iParam0 /*30*/].f_27, 25f, 12, 127);
				if (iLocal_1429 == 3)
				{
					REQUEST_CUTSCENE("ASS_MCS_1", 8);
					_0xEF39EE20C537E98C(133.2094f, -791.931f, 35.3551f, -4.9404f, 0f, 68.7852f);
...
void func_337()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!DOES_BLIP_EXIST(Local_1898[iVar0 /*30*/].f_9))
			{
				vVar1 = { _GET_OBJECT_OFFSET_FROM_COORDS(Local_1898[iVar0 /*30*/].f_1, Local_1898[iVar0 /*30*/].f_4, 0f, 3f, 0f) };
				Local_1898[iVar0 /*30*/].f_9 = func_338(vVar1, 1);
				SET_BLIP_NAME_FROM_TEXT_FILE(Local_1898[iVar0 /*30*/].f_9, &(Local_1898[iVar0 /*30*/].f_10));
			}
		}
		iVar0++;
	}
...
int func_338(vector3 vParam0, bool bParam1)
{
	...
	SET_BLIP_SCALE(iVar0, func_61(SET_BLIP_SCALE(), 1f, 1f));
...
void func_339()
{
	if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_1459, 0))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1459);
	}
	if (!IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_1460, 0))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1460);
	}
}
...
int func_340(var uParam0)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_1, 0))
		{
			SET_ENTITY_AS_MISSION_ENTITY(uParam0->f_1, true, 0);
			return 1;
		}
		else
		{
...
int func_345(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(iVar0, func_61(SET_BLIP_SCALE(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	else if (IS_ENTITY_AN_OBJECT(iParam0))
	{
				...
				if (!iLocal_1395)
				{
					...
					while (iVar0 < 9)
					{
						if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
						{
							...
							{
								iLocal_1457 = GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, iVar0, 0);
...
void func_347(int iParam0, bool bParam1)
{
	...
	if (!iLocal_1402)
	{
		if (!IS_ENTITY_DEAD(iParam0->f_1, 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(iParam0->f_1) || HAS_ENTITY_COLLIDED_WITH_ANYTHING(HAS_ENTITY_COLLIDED_WITH_ANYTHING()))
			{
				iLocal_1402 = 1;
			}
		}
	...
	if (iLocal_1392 && iLocal_1402)
	{
		if (!iLocal_1390)
		{
			...
			while (iVar0 < 9)
			{
				if (IS_VEHICLE_DRIVEABLE(iParam0->f_1, 0))
				{
					if (GET_PED_IN_VEHICLE_SEAT(iParam0->f_1, iVar0, 0) != 0)
					{
						iVar1 = GET_PED_IN_VEHICLE_SEAT(iParam0->f_1, iVar0, 0);
						if (!bParam1)
						{
						...
						if (bParam1)
						{
							if ((iVar0 % 2) == 0)
							{
								TASK_PLAY_ANIM(iVar1, "veh@bus@passenger@rps@idle_panic", "sit", 8f, -8f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
							}
							else
							{
								TASK_PLAY_ANIM(iVar1, "veh@bus@passenger@rds@idle_panic", "sit", 8f, -8f, -1, 1, TASK_PLAY_ANIM(0f, 1f), 0, 0, 0);
							}
						}
					}
				}
...
int func_350(var uParam0, var uParam1)
{
	if (IS_SCREEN_FADED_IN())
	{
		...
		else if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (IS_PED_INJURED(*uParam0))
			{
				if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0) && IS_VEHICLE_DRIVEABLE(*uParam0, uParam0->f_1, 1))
				{
					iLocal_965 = 1;
				}
			...
			else if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
			{
				if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam0->f_1, 0))
				{
					if (GET_ENTITY_SPEED(uParam0->f_1) > 10f && GET_ENTITY_SPEED(uParam0->f_1, *uParam0))
					{
						if (IS_PED_IN_ANY_VEHICLE(*uParam0, 0))
						{
...
void func_351(int iParam0)
{
	if (!iLocal_1409)
	{
		if (DOES_ENTITY_EXIST(iParam0->f_8) && !DOES_ENTITY_EXIST(iParam0->f_8, 0))
		{
			if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && IS_ENTITY_DEAD(IS_ENTITY_DEAD(), iParam0->f_8, 0))
			{
				_SET_VEHICLE_ENGINE_POWER_MULTIPLIER(iParam0->f_8, 0f);
				iLocal_1409 = 1;
			}
		}
	}
...
{
	return func_241(GET_PLAYER_PED(GET_PLAYER_PED()), iParam0, bParam1);
}
	...
	if (iLocal_980 > 4)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				{
					if ((iVar0 != iLocal_1463 && GET_ENTITY_MODEL(iVar0) != joaat("bus")) && GET_ENTITY_MODEL(iVar0) != joaat("coach"))
					{
						iLocal_1463 = iVar0;
						SET_ENTITY_AS_MISSION_ENTITY(iLocal_1463, true, 1);
						_0x02398B627547189C(iLocal_1463, 0);
					}
				}
			}
		}
...
void func_365(int iParam0)
{
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
		{
			iLocal_1461 = GET_VEHICLE_PED_IS_USING(GET_VEHICLE_PED_IS_USING());
			iLocal_1467 = GET_ENTITY_MODEL(iLocal_1461);
			if (iLocal_1467 != 0)
			{
...
int func_367(var uParam0)
{
	if (!DOES_ENTITY_EXIST(iLocal_1458[3]))
	{
		...
		if ((HAS_MODEL_LOADED(uParam0->f_16) && HAS_MODEL_LOADED(uParam0->f_14)) && HAS_MODEL_LOADED(joaat("a_m_m_eastsa_01")))
		{
			if (!DOES_ENTITY_EXIST(iLocal_1458[0]))
			{
				iLocal_1458[0] = CREATE_PED(4, joaat("a_m_m_eastsa_01"), 435.0773f, -650.2194f, 27.74271f, 85.9928f, 1, true);
				SET_PED_COMPONENT_VARIATION(iLocal_1458[0], 0, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_1458[0], 2, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_1458[0], 3, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_1458[0], 4, 1, 2, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_1458[0], 10, 1, 1, 0);
				if (DOES_SCENARIO_EXIST_IN_AREA(435.0773f, -650.2194f, 27.74271f, 2f, 1))
				{
					TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[0], 435.0773f, -650.2194f, 27.74271f, 2f, -1);
				}
				else
				{
					TASK_WANDER_STANDARD(iLocal_1458[0], 1193033728, 0);
				}
			}
			if (!DOES_ENTITY_EXIST(iLocal_1458[1]))
			{
				iLocal_1458[1] = CREATE_PED(4, uParam0->f_16, 436.3171f, -642.8832f, 27.73943f, 32.8396f, 1, true);
				if (DOES_SCENARIO_EXIST_IN_AREA(436.3171f, -642.8832f, 27.73943f, 2f, 1))
				{
					TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[1], 436.3171f, -642.8832f, 27.73943f, 2f, -1);
				}
				else
				{
					TASK_WANDER_STANDARD(iLocal_1458[1], 1193033728, 0);
				}
			}
			if (!DOES_ENTITY_EXIST(iLocal_1458[2]))
			{
				iLocal_1458[2] = CREATE_PED(4, uParam0->f_14, 435.6569f, -645.5588f, 27.73775f, 343.8998f, 1, true);
				if (DOES_SCENARIO_EXIST_IN_AREA(435.6569f, -645.5588f, 27.73775f, 2f, 1))
				{
					TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[2], 435.6569f, -645.5588f, 27.73775f, 2f, -1);
				}
				else
				{
					TASK_WANDER_STANDARD(iLocal_1458[2], 1193033728, 0);
				}
			}
			iLocal_1458[3] = CREATE_PED(4, joaat("a_m_m_eastsa_01"), 436.6802f, -629.7325f, 27.71444f, 179.4746f, 1, true);
			SET_PED_COMPONENT_VARIATION(iLocal_1458[1], 0, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(iLocal_1458[1], 2, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(iLocal_1458[1], 3, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(iLocal_1458[1], 4, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(iLocal_1458[1], 10, 1, 0, 0);
			if (DOES_SCENARIO_EXIST_IN_AREA(436.6802f, -629.7325f, 27.71444f, 2f, 1))
			{
				TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_1458[3], 436.6802f, -629.7325f, 27.71444f, 2f, -1);
			}
			else
			{
				TASK_WANDER_STANDARD(iLocal_1458[3], 1193033728, 0);
			}
			return 1;
		}
	}
...
{
	return func_231(GET_PLAYER_PED(GET_PLAYER_PED()), vParam0, bParam1);
}
...
void func_375()
{
	if (!DOES_ENTITY_EXIST(iLocal_1462))
	{
		if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
		{
			if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
			{
				iLocal_1462 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
				if (DOES_ENTITY_EXIST(iLocal_1462) && !DOES_ENTITY_EXIST(iLocal_1462, 0))
				{
					func_377(iLocal_1462);
				}
			}
...
void func_376()
{
	...
	if (!DOES_ENTITY_EXIST(iLocal_1349))
	{
		return;
	}
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
	...
	if (vdist2(vVar0, vLocal_1352) > 10000f)
	{
		if (DOES_ENTITY_EXIST(iLocal_1349))
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(-1559354806);
			DELETE_OBJECT(&iLocal_1349);
		}
		if (DOES_ENTITY_EXIST(iLocal_1348))
		{
			SET_ENTITY_VISIBLE(iLocal_1348, true, 0);
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			if (Global_96030[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_148(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_383(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_431(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_424(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_385(&Global_105109, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_385(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_43();
	...
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		...
		func_401(PLAYER_PED_ID());
		func_394(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_393())
		{
			func_389(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_395(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_400(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_397(Var7.f_1)) && iVar9 < 51)
			{
...
int func_405(var uParam0)
{
	if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(IS_ENTITY_DEAD()))
	{
		if (func_178())
		{
			*uParam0 = func_407(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false), 6, -1, 0, 1, -1);
...
int func_407(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_177(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_408(iVar0, 0), true);
...
int func_435(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if ((((!GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_101") || !GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_102")) || !GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_103")) || !GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_104")) || !GET_IS_WAYPOINT_RECORDING_LOADED("ODDJOBS@assassinate@vice@incar"))
		{
		}
	}
	...
	if ((!HAS_ADDITIONAL_TEXT_LOADED(3) && !func_441(&(uParam0->f_34))) && !func_436(uParam1))
	{
		func_488(uParam1);
		return 0;
	}
...
void func_448(var uParam0, var uParam1)
{
	...
	SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
	if (!DOES_ENTITY_EXIST(Local_1898[3 /*30*/].f_19))
	{
		Local_1898[3 /*30*/].f_19 = CREATE_VEHICLE(uParam0->f_15, Local_1898[3 /*30*/].f_5, Local_1898[3 /*30*/].f_8, true, true, false);
		SET_VEHICLE_ON_GROUND_PROPERLY(Local_1898[3 /*30*/].f_19, 1084227584);
	}
	iLocal_1405 = 0;
	iLocal_1408 = 0;
	iLocal_1429 = 3;
	...
	SET_ENTITY_COORDS(uParam1->f_8, 110.2194f, -775.8312f, 30.4426f, 1, false, 0, 1);
	SET_ENTITY_HEADING(uParam1->f_8, 77.2454f);
	SET_PED_INTO_VEHICLE(*uParam1, uParam1->f_8, -1);
	iLocal_1392 = 0;
	TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(*uParam1, uParam1->f_8, "OJASbs_102", 52, 0, 20, -1, -1f, 0, 1073741824);
	vLocal_1440 = { -455.2892f, -326.1364f, 41.22218f };
	WAYPOINT_RECORDING_GET_NUM_POINTS("OJASbs_102", &iLocal_1430);
	SET_ENTITY_LOAD_COLLISION_FLAG(*uParam1, true, 1);
	fLocal_1435 = _GET_VEHICLE_MAX_SPEED(uParam1->f_8);
	_SET_VEHICLE_ENGINE_POWER_MULTIPLIER(uParam1->f_8, (fLocal_1434 * 100f));
...
{
	if (DOES_ENTITY_EXIST(uParam1->f_1) && !DOES_ENTITY_EXIST(uParam1->f_1, 0))
	{
		Local_1898[0 /*30*/].f_14[0] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_16, 3, 1, true);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[0 /*30*/].f_14[0], true);
		Local_1898[0 /*30*/].f_14[1] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 4, 1, true);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[1], 0, 0, 2, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[1], 2, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[1], 3, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[1], 4, 0, 0, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[0 /*30*/].f_14[1], true);
		Local_1898[0 /*30*/].f_14[2] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_14, 5, 1, true);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[2], 0, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[2], 2, 2, 0, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[2], 3, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[2], 4, 0, 2, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[0 /*30*/].f_14[2], 8, 1, 0, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[0 /*30*/].f_14[2], true);
		Local_1898[1 /*30*/].f_14[0] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_16, 6, 1, true);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[1 /*30*/].f_14[0], true);
		Local_1898[1 /*30*/].f_14[1] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 7, 1, true);
		SET_PED_COMPONENT_VARIATION(Local_1898[1 /*30*/].f_14[1], 0, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[1 /*30*/].f_14[1], 3, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[1 /*30*/].f_14[1], 4, 0, 0, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[1 /*30*/].f_14[1], true);
		Local_1898[1 /*30*/].f_14[2] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_14, 8, 1, true);
		SET_PED_COMPONENT_VARIATION(Local_1898[1 /*30*/].f_14[2], 0, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[1 /*30*/].f_14[2], 3, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[1 /*30*/].f_14[2], 4, 0, 2, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[1 /*30*/].f_14[2], true);
		Local_1898[2 /*30*/].f_14[0] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_16, 0, 1, true);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[2 /*30*/].f_14[0], true);
		Local_1898[2 /*30*/].f_14[1] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, joaat("a_m_m_eastsa_01"), 1, 1, true);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[1], 0, 0, 2, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[1], 2, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[1], 3, 1, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[1], 4, 0, 1, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[2 /*30*/].f_14[1], true);
		Local_1898[2 /*30*/].f_14[2] = CREATE_PED_INSIDE_VEHICLE(uParam1->f_1, 4, uParam0->f_14, 2, 1, true);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[2], 0, 0, 2, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[2], 2, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[2], 3, 1, 2, 0);
		SET_PED_COMPONENT_VARIATION(Local_1898[2 /*30*/].f_14[2], 4, 0, 1, 0);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1898[2 /*30*/].f_14[2], true);
	}
}
...
void func_450(var uParam0)
{
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0->f_1, 0))
	{
		SET_ENTITY_COORDS(uParam0->f_1, 118.3466f, -786.1586f, 30.3105f, 1, false, 0, 1);
...
void func_451()
{
	...
	while (iVar0 < 4)
	{
		...
		while (iVar1 < 3)
		{
			if (DOES_ENTITY_EXIST(Local_1898[iVar0 /*30*/].f_14[iVar1]))
			{
				DELETE_PED(&(Local_1898[iVar0 /*30*/].f_14[iVar1]));
			}
			iVar1++;
		}
		iVar0++;
...
{
	CLEAR_AREA(vLocal_1446, 50f, 1, 0, 0, false);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA((vLocal_1446.x - 40f), (vLocal_1446.y - 40f), (vLocal_1446.z - 40f), (vLocal_1446.x + 40f), (vLocal_1446.y + 40f), (vLocal_1446.z + 40f), false, 1);
	if (DOES_ENTITY_EXIST(uParam1->f_1))
	{
		if (!bLocal_1389)
		{
			if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), uParam1->f_1, 0))
			{
				CLEAR_PED_TASKS_IMMEDIATELY(CLEAR_PED_TASKS_IMMEDIATELY());
				SET_ENTITY_COORDS(SET_ENTITY_COORDS(), uParam0->f_9, 1, false, 0, 1);
			}
			else
			{
				SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 423.25f, -641.36f, 28.5068f, 1, false, 0, 1);
			}
		}
...
{
	iParam0->f_1 = (func_166(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
...
{
	iLocal_1459 = CREATE_VEHICLE(uParam0->f_5, 439.7705f, -571.9359f, 27.5068f, 325f, true, true, false);
	SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1459, 1084227584);
	iLocal_1460 = CREATE_VEHICLE(uParam0->f_5, 406.7046f, -625.4039f, 27.5068f, 91f, true, true, false);
	SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1460, 1084227584);
}
...
void func_457(var uParam0, var uParam1)
{
	...
	func_201(&(uParam1->f_16), 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (uParam0->f_14 != 0 && uParam0->f_274 != 0)
	{
		...
		{
			uParam1->f_7 = CREATE_PED(4, uParam0->f_14, uParam0->f_18, uParam0->f_21, 1, true);
			if (uParam0->f_274 == 1)
			{
	...
	if (uParam0->f_15 != 0)
	{
		...
		if (uParam0->f_274 == 1)
		{
			...
			iLocal_967 = CREATE_PED_INSIDE_VEHICLE(uParam1->f_8, 4, uParam0->f_16, -1, 1, true);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_967, true);
	...
	while (iVar0 < 4)
	{
		if (!func_336(uParam0->f_249[iVar0 /*3*/]))
		{
			...
			SET_ENTITY_COLLISION(uParam1->f_11[iVar0], true, 0);
			if (iVar0 == 1)
			{
...
void func_460()
{
	...
	SET_ROADS_IN_ANGLED_AREA(426.035f, -644.93f, -100f, 421.035f, -644.93f, 100f, 55f, 0, false, 1);
	...
	iLocal_1466[0] = ADD_SCENARIO_BLOCKING_AREA(vVar0[0 /*3*/] - Vector(8f, 8f, 8f), vVar0[0 /*3*/] + Vector(8f, 8f, 8f), 0, 1, 1, 1);
	iLocal_1466[1] = ADD_SCENARIO_BLOCKING_AREA(vVar0[1 /*3*/] - Vector(8.5f, 8.5f, 8.5f), vVar0[1 /*3*/] + Vector(8.5f, 8.5f, 8.5f), 0, 1, 1, 1);
	iLocal_1466[2] = ADD_SCENARIO_BLOCKING_AREA(vVar0[2 /*3*/] - Vector(8.5f, 8.5f, 8.5f), vVar0[2 /*3*/] + Vector(8.5f, 8.5f, 8.5f), 0, 1, 1, 1);
	iLocal_1466[3] = ADD_SCENARIO_BLOCKING_AREA(vVar0[3 /*3*/] - Vector(9.5f, 9.5f, 9.5f), vVar0[3 /*3*/] + Vector(9.5f, 9.5f, 9.5f), 0, 1, 1, 1);
	iLocal_1466[4] = ADD_SCENARIO_BLOCKING_AREA(vVar0[4 /*3*/] - Vector(8f, 8f, 8f), vVar0[4 /*3*/] + Vector(8f, 8f, 8f), 0, 1, 1, 1);
	iLocal_1466[5] = ADD_SCENARIO_BLOCKING_AREA(vVar0[5 /*3*/] - Vector(15f, 15f, 15f), vVar0[5 /*3*/] + Vector(15f, 15f, 15f), 0, 1, 1, 1);
}
...
void func_461(var uParam0, var uParam1, bool bParam2)
{
	...
	if (uParam0->f_274 == 0)
	{
		while (((((((((!GET_IS_WAYPOINT_RECORDING_LOADED("OJASbs_102") || !GET_IS_WAYPOINT_RECORDING_LOADED("OJASbs01")) || !GET_IS_WAYPOINT_RECORDING_LOADED("OJASbs02")) || !GET_IS_WAYPOINT_RECORDING_LOADED("OJASbs03")) || !GET_IS_WAYPOINT_RECORDING_LOADED("OJASbs04")) || !GET_IS_WAYPOINT_RECORDING_LOADED("ODDJOBS@assassinate@old_lady")) || !GET_IS_WAYPOINT_RECORDING_LOADED(uParam0->f_5)) || !GET_IS_WAYPOINT_RECORDING_LOADED(uParam0->f_15)) || !GET_IS_WAYPOINT_RECORDING_LOADED()) || !GET_IS_WAYPOINT_RECORDING_LOADED("move_m@casual@d"))
		{
			func_488(uParam1);
			wait(0);
		}
	...
	{
		while (((((!GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_101") || !GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_102")) || !GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_103")) || !GET_IS_WAYPOINT_RECORDING_LOADED("OJAShk_104")) || !GET_IS_WAYPOINT_RECORDING_LOADED("ODDJOBS@assassinate@vice@incar")) || !GET_IS_WAYPOINT_RECORDING_LOADED("mini@hookers_spvanilla"))
		{
			func_488(uParam1);
			wait(0);
		}
	...
	while ((!HAS_ADDITIONAL_TEXT_LOADED(3) || !func_441(&(uParam0->f_34))) || !func_436(uParam1))
	{
		func_488(uParam1);
		wait(0);
	}
	if (uParam0->f_274 == 1)
	{
		CLEAR_AREA_OF_VEHICLES(uParam0->f_18, 100f, 0, 0, 0, 0, false, 0);
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-690.763f, -1607.467f, -100.9649f, -404.4197f, -1856.529f, 100.5908f, false, 1);
...
void func_471(var uParam0)
{
	switch (iLocal_1347)
	{
		case 0:
			...
			if (HAS_ANIM_DICT_LOADED("oddjobs@assassinate@bus@call") && HAS_ANIM_DICT_LOADED(-1559354806))
			{
			...
			if (bLocal_1370)
			{
				if (DOES_ENTITY_EXIST(iLocal_1348))
				{
					...
					CLEAR_AREA(-26.48f, -110.66f, 56.0227f, 3f, 1, 0, 0, false);
					...
					if (DOES_ENTITY_EXIST(iLocal_1348))
					{
						SET_ENTITY_VISIBLE(iLocal_1348, false, 0);
						SET_ENTITY_COLLISION(iLocal_1348, false, 0);
						SET_ENTITY_CAN_BE_DAMAGED(iLocal_1348, false);
						iLocal_1349 = CREATE_OBJECT(-1559354806, -26.48f, -110.66f, 56.0227f, true, true, false);
						SET_ENTITY_ROTATION(iLocal_1349, 0f, 0f, 157.62f, 2, 1);
						SET_ENTITY_COLLISION(iLocal_1349, false, 0);
						SET_ENTITY_CAN_BE_DAMAGED(iLocal_1349, false);
						SET_ENTITY_VISIBLE(SET_ENTITY_VISIBLE(), true, 0);
					}
					iLocal_1376 = FORMAT_FOCUS_HEADING(-26.48f, -110.66f, 56.0227f, 350f, 12, 127);
					func_286(1, 1, 1, 0, 0, 0);
					CLEAR_AREA_OF_PEDS(vLocal_1353, 5f, 0);
					if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
					{
						_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
						SET_ENTITY_COORDS(SET_ENTITY_COORDS(), vLocal_1353, 1, false, 0, 1);
						SET_ENTITY_HEADING(SET_ENTITY_HEADING(), fLocal_1354);
						REMOVE_PED_HELMET(REMOVE_PED_HELMET(), 1);
					}
					iLocal_1373 = CREATE_SYNCHRONIZED_SCENE(vLocal_1371, vLocal_1372, 2);
					if (DOES_ENTITY_EXIST(iLocal_1349))
					{
						ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_1373, iLocal_1349, -1);
					}
					TASK_SYNCHRONIZED_SCENE(TASK_SYNCHRONIZED_SCENE(), iLocal_1373, "oddjobs@assassinate@bus@call", "ass_bus_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_1349, iLocal_1373, "ass_bus_call_phone", "oddjobs@assassinate@bus@call", 1000f, -2f, 0, 1148846080);
					if (!DOES_CAM_EXIST(iLocal_1350))
					{
						iLocal_1351 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1358, vLocal_1359, 36f, 1, 2);
						iLocal_1350 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1360, vLocal_1361, 36f, 0, 2);
						SET_CAM_ACTIVE_WITH_INTERP(iLocal_1350, iLocal_1351, 2500, 1, 1);
						RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
						SHAKE_CAM(iLocal_1350, "HAND_SHAKE", 0.2f);
					}
					func_201(&(uParam0->f_16), 3, 0, "LESTER", 0, 1);
					func_201(&(uParam0->f_16), 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					DISPLAY_RADAR(false);
					DISPLAY_HUD(false);
					iLocal_1375 = ADD_NAVMESH_BLOCKING_OBJECT(-26.48f, -110.66f, 56.0227f, 3f, 3f, 3f, 0f, 0, 7);
					SET_CURRENT_PED_WEAPON(SET_CURRENT_PED_WEAPON(), joaat("weapon_unarmed"), true);
				...
				else
				{
					...
					if (!DOES_ENTITY_EXIST(iLocal_1348))
					{
						iLocal_1348 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_1352, 5f, 1281992692, 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1369)
			{
				if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0))
				{
					if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1373))
					{
						if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_1373) > 0.05f)
						{
			...
			if (func_168(&iLocal_1362))
			{
				if ((func_165(&iLocal_1362) > fLocal_1355 || (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1373) && IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1373) >= 0.962f)) || bLocal_1368)
				{
					iLocal_1347 = 3;
				}
			}
		...
		case 2:
			...
			if (bLocal_1368)
			{
				if (IS_SCREEN_FADED_OUT())
				{
					...
					{
						_0x2208438012482A1A(_0x2208438012482A1A(), 0, 0);
						SET_ENTITY_COORDS(SET_ENTITY_COORDS(), -25.8488f, -109.9882f, 56.0738f, 1, false, 0, 1);
						SET_ENTITY_HEADING(SET_ENTITY_HEADING(), 236.2218f);
					}
					STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_1349, -1000f, 1);
					wait(0);
					DO_SCREEN_FADE_IN(500);
					DESTROY_ALL_CAMS(0);
					RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
		...
		case 3:
			...
			if (_0x07C313F94746702C(iLocal_1376))
			{
				_0x1EE7D8DF4425F053(iLocal_1376);
			}
			SET_ENTITY_COLLISION(iLocal_1349, true, 0);
			DISPLAY_RADAR(true);
			DISPLAY_HUD(true);
			CLEAR_PED_TASKS(CLEAR_PED_TASKS());
			SET_PLAYER_CONTROL(SET_PLAYER_CONTROL(), true, 0);
			...
			SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_1348);
			iLocal_980 = 4;
			break;
	}
}
...
int func_474(int iParam0, float fParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5, float fParam6)
{
	if (DOES_CAM_EXIST(*iParam0))
	{
		if (func_168(&iLocal_1365))
		{
			...
			{
				SET_CAM_COORD(iLocal_1350, vParam2);
				SET_CAM_ROT(iLocal_1350, vParam3, 2);
				SET_CAM_FOV(iLocal_1350, fParam4);
				if (bParam5)
				{
					SHAKE_CAM(iLocal_1350, "HAND_SHAKE", fParam6);
				}
				return 1;
			}
		}
...
void func_483()
{
	if (DOES_ENTITY_EXIST(iLocal_1461))
	{
		if (IS_PED_IN_VEHICLE(IS_PED_IN_VEHICLE(), iLocal_1461, 0))
		{
			CLEAR_PED_TASKS_IMMEDIATELY(CLEAR_PED_TASKS_IMMEDIATELY());
			SET_ENTITY_COORDS(SET_ENTITY_COORDS(), 421.5518f, -640.2153f, 27.5072f, 1, false, 0, 1);
		}
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_1461, true, 0);
		DELETE_VEHICLE(&iLocal_1461);
	}
}
...
void func_484(int iParam0, vector3 vParam1, vector3 vParam2)
{
	...
	DISABLE_NAVMESH_IN_AREA(vParam1, vParam2, 0);
}
...
void func_488(var uParam0)
{
	...
	if (uParam0->f_271)
	{
		if ((GET_FRAME_COUNT() >= (uParam0->f_272 + uParam0->f_273) || GET_FRAME_COUNT(Global_98669.f_20, 2)) || GET_FRAME_COUNT(Global_98669.f_20, 13))
		{
			iVar0 = 0;
			while (iVar0 < 15)
			{
	...
	if (func_521(uParam0))
	{
		...
		if (func_520(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_498(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_498(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_500(iParam0, uVar1[iVar3], 1) && func_499(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_157(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(iParam0, true), GET_DISTANCE_BETWEEN_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_502(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_96030[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_96030[iVar0]) == func_148(iParam0, iParam1))
				{
...
void func_503(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_159(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_159(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_159(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_511(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_510())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_HELI(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_159(iVar2 + 1)))
				{
...
int func_504(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_508(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_507(*iParam0, ((*uParam1)[38] - 1)))
	{
...
{
	SET_PED_NON_CREATION_AREA(vParam0, vParam1);
	DISABLE_NAVMESH_IN_AREA(vParam0, vParam1, 1);
	return ADD_SCENARIO_BLOCKING_AREA(vParam0, vParam1, 0, 1, 1, 1);
}
...
void func_532(var uParam0)
{
	...
	_REMOVE_SPEED_ZONE(iLocal_966);
	SET_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(1f);
	SET_RANDOM_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(1f);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-690.763f, -1607.467f, -100.9649f, -404.4197f, -1856.529f, 100.5908f, true, 1);
	...
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA((vVar0.x - 40f), (vVar0.y - 40f), (vVar0.z - 40f), (vVar0.x + 40f), (vVar0.y + 40f), (vVar0.z + 40f), true, 1);
...
void func_539()
{
	if (DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_1375))
	{
		REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_1375);
	}
}
