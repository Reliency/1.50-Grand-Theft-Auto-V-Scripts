...
void __EntryFunction__()
{
		...
		if (HAS_FORCE_CLEANUP_OCCURRED(83))
		{
			...
			switch (GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP())
			{
				...
				case 1:
					...
					func_25(-2009081795);
					bLocal_29 = false;
					while (!IS_PLAYER_PLAYING(IS_PLAYER_PLAYING()))
					{
						wait(1000);
					}
					iLocal_31 = 0;
	...
	while (true)
	{
		...
		vVar2 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), false) };
		...
		if (bLocal_30 != bLocal_29)
		{
			...
			if (bLocal_29 && !bVar4)
			{
				...
				if (bVar5)
				{
					...
					{
						iVar7 = GET_INTERIOR_FROM_ENTITY(GET_INTERIOR_FROM_ENTITY());
					...
					{
						if (!IS_BIT_SET(Global_111560.f_7683.f_923, 0))
						{
							func_10(1628462442, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!IS_BIT_SET(Global_111560.f_7683.f_923, 1))
						{
							func_10(1791324372, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!IS_BIT_SET(Global_111560.f_7683.f_923, 2))
						{
					...
					{
						if (!IS_BIT_SET(Global_111560.f_7683.f_923, 3))
						{
							func_10(1806999335, 7, 4, 31, 3, 10000, 20000, -1, -1, 151, -1, 1024);
						}
						else if (!IS_BIT_SET(Global_111560.f_7683.f_923, 4))
						{
						...
						if ((!func_9(0) && !func_9(4)) && !func_9(3))
						{
							if (_GET_NUMBER_OF_DISPATCHED_UNITS_FOR_PLAYER(11) < 256)
							{
								if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
								{
									if (!IS_PED_INJURED(IS_PED_INJURED()))
									{
										CREATE_INCIDENT_WITH_ENTITY(11, CREATE_INCIDENT_WITH_ENTITY(), iVar0, 0f, &uLocal_33, 0, 0);
									}
								}
							}
...
void func_5(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		SET_BIT(&(Global_111560.f_7224.f_17[iParam0]), 0);
	}
	else
	{
		CLEAR_BIT(&(Global_111560.f_7224.f_17[iParam0]), 0);
	}
	DISABLE_POLICE_RESTART(Global_93838[iParam0 /*9*/].f_8, !bParam1);
...
void func_7(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		SET_BIT(&(Global_111560.f_7224.f_11[iParam0]), 0);
	}
	else
	{
		CLEAR_BIT(&(Global_111560.f_7224.f_11[iParam0]), 0);
	}
	DISABLE_HOSPITAL_RESTART(Global_93902[iParam0 /*9*/].f_8, !bParam1);
