	...
	if (!IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		switch (*iParam0)
		{
			case 0:
				...
				SET_RANDOM_SEED(((SET_RANDOM_SEED() * SET_RANDOM_SEED()) * SET_RANDOM_SEED()));
			...
			case 15:
				...
				if (func_150(iParam0, 0, 1))
				{
					...
					func_118();
					*iParam3 = 0;
					if (IS_CONTROL_JUST_PRESSED(0, 86) || IS_CONTROL_JUST_PRESSED(0, 86))
					{
						func_117();
						func_115();
			...
			case 17:
				if (!IS_THREAD_ACTIVE(iLocal_245))
				{
					...
					else
					{
						...
						func_144(&(Global_111560.f_19968.f_1), 8192);
						func_144(&(Global_111560.f_19968.f_1), 16384);
						if (DOES_ENTITY_EXIST(iLocal_268) && !DOES_ENTITY_EXIST(iLocal_268, 0))
						{
				...
				if (Global_98669 == 10)
				{
					if (Global_98703)
					{
						...
						if (Global_111560.f_19968.f_3 >= 5)
						{
							...
							{
								CLEAR_AREA_OF_VEHICLES(408.8376f, -1638.952f, 28.2928f, 8f, 0, 0, 0, 0, false, 0);
								if (!DOES_ENTITY_EXIST(iLocal_269))
								{
									if (iLocal_265 == joaat("towtruck"))
									{
								...
								if (!IS_ENTITY_DEAD(IS_ENTITY_DEAD(), 0) && !IS_ENTITY_DEAD(iLocal_269, 0))
								{
									SET_PED_INTO_VEHICLE(SET_PED_INTO_VEHICLE(), iLocal_269, -1);
									SET_PED_COORDS_KEEP_VEHICLE(SET_PED_COORDS_KEEP_VEHICLE(), 408.8376f, -1638.952f, 28.2928f);
...
int func_107()
{
	...
	if (HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_51.z = 1;
			iLocal_245 = start_new_script_with_args("Towing", &vLocal_51, 9, 29500);
			SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
			if (!IS_ENTITY_DEAD(iLocal_268, 0))
			{
...
float func_136(int iParam0)
{
	if (func_141(iParam0))
	{
		...
		{
			return (func_137(IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_137(IS_BIT_SET(*iParam0, 4)) - fParam1);
	SET_BIT(iParam0, 1);
	CLEAR_BIT(iParam0, 2);
	iParam0->f_2 = 0f;
}
	...
	if (IS_PED_IN_ANY_VEHICLE(iParam0, 0))
	{
		...
		if (!IS_ENTITY_DEAD(iVar0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) == iParam0)
			{
				...
				{
					iLocal_269 = iVar0;
					if (DOES_ENTITY_EXIST(iLocal_269) && !DOES_ENTITY_EXIST(iLocal_269, 0))
					{
...
void func_146(var uParam0, int iParam1)
{
	if (!func_150(uParam0, 0, 1))
	{
		if (func_143(iParam1))
		{
			if (IS_CONTROL_JUST_PRESSED(0, 86) || IS_CONTROL_JUST_PRESSED(0, 86))
			{
				if ((((((!func_142() && !IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_114(0)) && !func_58(6)) && !func_58(7)) && !IS_HELP_MESSAGE_BEING_DISPLAYED(IS_HELP_MESSAGE_BEING_DISPLAYED()) > 0) && func_106() == 1)
				{
...
void func_148(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	...
	fVar0 = vdist2(vParam1, GET_ENTITY_COORDS(iParam0, true));
	switch (iLocal_71)
	{
		case 0:
		...
		case 2:
			...
			{
				if (!IS_SPHERE_VISIBLE(vLocal_254, fLocal_255) || func_22(Global_111560.f_19968.f_1, 1073741824))
				{
					if (!DOES_ENTITY_EXIST(iLocal_269))
					{
						iLocal_269 = CREATE_VEHICLE(joaat("towtruck"), vParam1, fParam2, true, true, false);
						SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
						iLocal_71 = 3;
					}
				}
		...
		case 3:
			if (IS_PED_IN_ANY_VEHICLE(iParam0, 0))
			{
				if (GET_VEHICLE_PED_IS_IN(iParam0, 0) == iLocal_269)
				{
					iLocal_71 = 0;
				}
			}
			if (IS_ENTITY_DEAD(iLocal_269, 0))
			{
				iLocal_71 = 0;
			}
			if (fVar0 > 62500f)
