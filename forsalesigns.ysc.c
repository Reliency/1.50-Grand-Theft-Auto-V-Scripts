...
void func_1()
{
	...
	if (iLocal_42)
	{
		...
		{
			if ((((!func_51() && !IS_PED_FLEEING(iLocal_44)) && !IS_PED_FLEEING(iLocal_44)) && !IS_PED_FLEEING(iLocal_44)) && !IS_PED_FLEEING(iLocal_44))
			{
				if (func_50(iLocal_44, PLAYER_PED_ID(), 1) <= 3f)
				{
			...
			if (func_50(iLocal_44, PLAYER_PED_ID(), 1) > 150f)
			{
				func_26(&iLocal_44);
			}
		}
	...
	while (iVar0 < 15)
	{
		if (DOES_ENTITY_EXIST(Local_210[iVar0 /*11*/]))
		{
			...
			{
				SET_BIT(&(Global_111560.f_10044.f_108), iVar0);
				func_21(iVar0);
		...
		else if (!IS_BIT_SET(Global_111560.f_10044.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!IS_BIT_SET(Global_111560.f_10044.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_111560.f_10044.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
	...
	if (bLocal_39)
	{
		switch (iLocal_40)
		{
			case 0:
				...
				{
					iLocal_41 = 0x67D02A194A2FC2BD("MIDSIZED_MESSAGE");
...
void func_13(var uParam0, int iParam1, bool bParam2, float fParam3)
{
	...
	{
		if (func_15(PLAYER_PED_ID(), uParam0->f_3, fParam3) && !PLAYER_PED_ID(*uParam0))
		{
...
void func_16(int iParam0, var uParam1)
{
	if (!IS_PED_INJURED(IS_PED_INJURED()))
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(GET_DISTANCE_BETWEEN_COORDS(), true), GET_DISTANCE_BETWEEN_COORDS(*iParam0, true), true) >= 110f && !GET_DISTANCE_BETWEEN_COORDS(*iParam0))
		{
			func_17(iParam0);
			*uParam1 = 0;
		}
...
int func_24(int iParam0)
{
	...
	vVar0 = { GET_ENTITY_ROTATION(iParam0, 0) };
...
int func_54()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (GET_ENTITY_MODEL(uVar2[iVar1]) == func_56(58))
			{
...
void func_68()
{
	...
	{
		func_70(13, floor(Global_111560.f_10189.f_3853));
	}
