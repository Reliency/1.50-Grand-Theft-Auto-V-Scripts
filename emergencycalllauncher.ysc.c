...
void func_3()
{
	...
	{
		Local_210 = { func_5() };
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(&Local_210)) == 0)
		{
			func_4();
		}
		else
...
void func_21()
{
	...
	{
		if (func_24(Global_111560.f_2358.f_539.f_4321) != GET_ENTITY_MODEL(GET_ENTITY_MODEL()))
		{
...
{
	Global_30960 = 1;
	StringCopy(&Global_30961, GET_THIS_SCRIPT_NAME(), 24);
}
