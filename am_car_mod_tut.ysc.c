...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (func_185(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_184() == 2)
				{
					vLocal_138[PARTICIPANT_ID_TO_INT() /*3*/] = 2;
				}
				else if (func_184() == 6)
				{
					vLocal_138[PARTICIPANT_ID_TO_INT() /*3*/] = 5;
				}
				break;
			...
			case 2:
				if (func_184() == 2)
				{
					...
					else if (!IS_BIT_SET(vLocal_138[IS_BIT_SET() /*3*/].f_2, 1))
					{
						func_8();
					}
				}
			...
			case 5:
				...
				{
					vLocal_138[PARTICIPANT_ID_TO_INT() /*3*/] = 6;
				}
				break;
...
void func_3()
{
	...
	if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_137 == 0)
		{
			CLEAR_BIT(&iLocal_140, 0);
			SET_BIT(&iLocal_140, 1);
		}
		iVar0 = iLocal_137;
		if (NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			iVar1 = NETWORK_GET_PLAYER_INDEX(iVar0);
			if (!IS_BIT_SET(vLocal_138[iLocal_137 /*3*/].f_2, 0))
			{
				CLEAR_BIT(&iLocal_140, 1);
			}
			if (func_4(iVar1, 0, 1))
			{
				if (!IS_BIT_SET(Global_1590446[iLocal_137 /*871*/].f_146, 4))
				{
				}
			}
		}
...
void func_8()
{
	...
	SET_BIT(&(vLocal_138[SET_BIT() /*3*/].f_2), 0);
	SET_BIT(&(vLocal_138[SET_BIT() /*3*/].f_2), 1);
	func_70(10, 0);
	func_69(0);
	func_30(1);
	func_23();
...
void func_69(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 18);
	}
	else
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 18);
	}
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	if (DOES_BLIP_EXIST(Global_98721.f_235[iParam0]))
	{
	}
}
...
void func_74()
{
	...
	switch (vLocal_138[PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
			if (!IS_BIT_SET(vLocal_138[IS_BIT_SET() /*3*/].f_2, 0))
			{
				if (!IS_PED_INJURED(IS_PED_INJURED()))
				{
					if (!IS_BIT_SET(iLocal_140, 5))
					{
						if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) == 0)
						{
							...
							else
							{
								if (IS_BIT_SET(iLocal_140, 2))
								{
									CLEAR_BIT(&iLocal_140, 2);
								}
								iVar0 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
								if ((!func_152(iVar0, 0, &uVar1) || !func_151(iVar0)) || func_150(GET_ENTITY_MODEL(iVar0)))
								{
									if (func_149())
									{
										func_148(0);
									...
									if (!IS_BIT_SET(iLocal_140, 8))
									{
										if (func_143())
										{
											if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
											{
												if (iLocal_148 > 0)
												{
													if (func_150(GET_ENTITY_MODEL(iVar0)))
													{
														func_142("FM_CTUT_PRM", -1);
														SET_BIT(&iLocal_140, 8);
														SET_BIT(&iLocal_140, 11);
								...
								else
								{
									...
									if (!func_138() || (func_138() && IS_PLAYER_CONTROL_ON(IS_PLAYER_CONTROL_ON())))
									{
										if (!IS_BIT_SET(iLocal_140, 3))
										{
											func_179("FM_CTUT_MOD", 0);
											SET_BIT(&iLocal_140, 3);
											func_140(&uLocal_141);
											...
											if (iLocal_139 == -1)
											{
												iLocal_139 = func_121(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), 4, -1);
												if (iLocal_139 != -1)
												{
									...
									else if (func_138() && !IS_PLAYER_CONTROL_ON(IS_PLAYER_CONTROL_ON()))
									{
										if (!IS_BIT_SET(iLocal_140, 3))
										{
											SET_BIT(&iLocal_140, 3);
						...
						else
						{
							...
							if (func_149())
							{
								if (!IS_PED_INJURED(IS_PED_INJURED()))
								{
									...
									{
										iVar0 = GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0);
										if ((!func_152(iVar0, 0, &uVar2) || !func_151(iVar0)) || func_150(GET_ENTITY_MODEL(iVar0)))
										{
											func_148(0);
										}
									}
					...
					if (IS_BIT_SET(iLocal_140, 3) || (func_138() && IS_BIT_SET(iLocal_140, 10)))
					{
						if (func_138())
						{
							...
							if (!IS_BIT_SET(iLocal_140, 9))
							{
								if (func_115())
								{
									SET_BIT(&iLocal_140, 9);
									SET_BIT(&(Global_2531497.f_1729), 25);
							...
							if (func_114())
							{
								if (!IS_BIT_SET(Global_2531497.f_1729, 25))
								{
									SET_BIT(&(Global_2531497.f_1729), 25);
								}
							...
							{
								if (func_110(PLAYER_ID()) || (!func_108() && func_107()))
								{
									iVar3 = func_104(GET_VEHICLE_PED_IS_IN(GET_VEHICLE_PED_IS_IN(), 0));
									if (iVar3 > 0)
									{
						...
						else if (IS_BIT_SET(iLocal_140, 9))
						{
							...
							else if (!IS_BIT_SET(vLocal_138[IS_BIT_SET() /*3*/].f_2, 0))
							{
								SET_BIT(&(vLocal_138[SET_BIT() /*3*/].f_2), 0);
							}
						}
					...
					if (!IS_BIT_SET(iLocal_140, 5))
					{
						if (((func_82(PLAYER_ID(), 1, 0) || func_81()) || func_80() > 0) || (!func_78() && !func_138()))
						{
							SET_BIT(&iLocal_140, 5);
							func_23();
						}
					}
					else if (IS_PLAYER_CONTROL_ON(IS_PLAYER_CONTROL_ON()) || func_138())
					{
						if (IS_SCREEN_FADED_IN())
						{
							if ((((!func_82(PLAYER_ID(), 1, 0) && !func_81()) && func_80() == 0) && func_78()) || func_138())
	...
	if (!IS_BIT_SET(vLocal_138[IS_BIT_SET() /*3*/].f_2, 1))
	{
		if (func_76())
		{
			func_8();
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (NETWORK_IS_PLAYER_ACTIVE(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_94(PLAYER_ID(), 0) && !func_93()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_89(iVar26) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar26))
				{
					if (!bVar21)
					{
...
int func_97()
{
	...
	if (func_98() >= 0)
	{
		if (IS_BIT_SET(Global_1323611[func_98() /*141*/].f_102, 2))
		{
			return 1;
		}
	}
...
int func_104(int iParam0)
{
	...
	if (func_106(GET_ENTITY_MODEL(iParam0), 0))
	{
...
bool func_110(int iParam0)
{
	...
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 19);
}
...
void func_111(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&(Global_1590446[SET_BIT() /*871*/].f_146), 20);
	}
	else
	{
		CLEAR_BIT(&(Global_1590446[CLEAR_BIT() /*871*/].f_146), 20);
	}
}
...
bool func_112(int iParam0)
{
	...
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 20);
}
...
bool func_113(int iParam0)
{
	...
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 21);
}
...
int func_121(vector3 vParam0, int iParam1, int iParam2)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_21(iVar0))
		{
			...
			if (func_136(iVar4))
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_122(iVar0, 0), true);
...
bool func_137(int iParam0)
{
	...
	return IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 18);
}
...
int func_143()
{
	if (((((((((((((!func_4(PLAYER_ID(), 1, 1) || PLAYER_ID(PLAYER_ID())) || !PLAYER_ID(PLAYER_ID())) || func_147(8, -1)) || func_147(15, -1)) || func_146()) || func_147(3, -1)) || PLAYER_ID()) || func_82(PLAYER_ID(), 1, 0)) || func_81()) || func_107()) || func_145()) || func_144()) || PLAYER_ID())
	{
		return 0;
	}
	return 1;
...
void func_148(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&(Global_2531497.f_1732), 4);
	}
	else
	{
		CLEAR_BIT(&(Global_2531497.f_1732), 4);
	}
}

bool func_149()
{
	return IS_BIT_SET(Global_2531497.f_1732, 4);
}
...
int func_152(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_177(iVar0, bParam1, uParam2) && !func_176(PLAYER_ID())) && !func_161(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_159(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_157(iParam0)) && !bVar1) && !(func_156(IS_BIG_VEHICLE(iParam0)) && func_154(IS_BIG_VEHICLE())))
	{
		switch (GET_ENTITY_MODEL(iParam0))
		{
			case -801550069:
...
{
	if (func_175(PLAYER_ID()) || func_174(PLAYER_ID()))
	{
		if (func_162(iParam0))
		{
			return 1;
...
int func_163(int iParam0)
{
	...
	if (func_164(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_165(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_167(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_177(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_159(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
...
void func_186()
{
	...
	if (!func_183(0))
	{
		if (func_112(PLAYER_ID()) || iLocal_147)
		{
			func_31(122, 1, -1, 1);
		}
	}
...
int func_196()
{
	...
	if (func_197() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_197()) == 0)
		{
			return 1;
		}
	}
...
void func_207(struct<21> Param0)
{
	...
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_138, 97);
