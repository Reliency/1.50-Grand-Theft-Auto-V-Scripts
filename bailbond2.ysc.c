...
void __EntryFunction__()
{
	...
	if (func_520())
	{
		...
		{
			case 0:
				if (IS_THIS_MODEL_A_PLANE(Global_105109.f_2890.f_12.f_66))
				{
	...
	{
		if (func_433(PLAYER_PED_ID()))
		{
			func_432(PLAYER_PED_ID(), vLocal_339, fLocal_119, 0, 0);
	...
	while (true)
	{
		if (!IS_PED_INJURED(IS_PED_INJURED()))
		{
			...
			vLocal_337 = { GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true) };
			func_421();
			func_420();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER_PED_ID(), vLocal_340, fLocal_120, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER_PED_ID(), vLocal_341, fLocal_121, 0, 1);
						SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					...
					if (!func_71())
					{
						func_432(PLAYER_PED_ID(), vLocal_336, 254.9762f, 0, 0);
						SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
int func_5(int iParam0, float fParam1)
{
	...
	if (func_23(iParam0))
	{
		if (func_6(GET_ENTITY_COORDS(iParam0, true), &vVar0, fParam1, 0))
		{
...
void func_67()
{
	if (func_433(Local_68.f_9))
	{
		...
		{
			_0x2A56C06EBEF2B0D9(sLocal_154, Local_68.f_9, 0);
		}
	}
	if (func_433(Local_75))
	{
		if (_0xB56BBBCC2955D9CB())
		{
			_0x2A56C06EBEF2B0D9(sLocal_153, Local_75, 0);
		}
	}
}
...
void func_106(int iParam0, bool bParam1)
{
	if (func_23(iParam0))
	{
		...
		if (!func_64(iParam0, 1805844857))
		{
			...
			TASK_SMART_FLEE_PED(iParam0, TASK_SMART_FLEE_PED(), 10000f, -1, 0, 0);
		}
		if (bParam1)
		{
...
void func_119()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			func_115();
			func_42(&Local_75, 1);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_322);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_322, 1862763509);
			iVar0 = 0;
			while (iVar0 <= (iLocal_134 - 1))
			{
				if (func_23(Local_69[iVar0 /*20*/]))
...
void func_121(int iParam0)
{
	if (func_23(Local_69[iParam0 /*20*/]))
	{
		...
		SET_PED_ACCURACY(Local_69[iParam0 /*20*/], SET_PED_ACCURACY(10, 20));
		SET_PED_SHOOT_RATE(Local_69[iParam0 /*20*/], SET_PED_SHOOT_RATE(15, 20));
		SET_PED_FIRING_PATTERN(Local_69[iParam0 /*20*/], 445831135);
		if (GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
		{
			SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], true), 45f, 0, 0);
		}
		else
		{
			SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iParam0 /*20*/], true), 35f, 0, 0);
		}
		TASK_LOOK_AT_ENTITY(Local_69[iParam0 /*20*/], TASK_LOOK_AT_ENTITY(), 3000, 0, 2);
		TASK_COMBAT_PED(Local_69[iParam0 /*20*/], TASK_COMBAT_PED(), 0, 16);
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (func_37())
			{
				...
				{
					REGISTER_ENTITY_FOR_CUTSCENE(REGISTER_ENTITY_FOR_CUTSCENE(), sLocal_152, 0, 0, 0);
					if (func_433(Local_75))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_75, sLocal_153, 0, 0, 0);
					}
					if (func_433(Local_68.f_9))
					{
					...
					if (func_433(Local_77))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_77, sLocal_155, 0, 0, 0);
					}
					if (func_433(Local_78))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_78, sLocal_156, 0, 0, 0);
					}
					START_CUTSCENE(0);
					wait(0);
					func_24(800, 0);
	...
	if (func_23(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				vLocal_342 = { GET_ENTITY_COORDS(Local_68.f_9, false) };
			...
			case 2:
				...
				iLocal_82 = 1;
				func_326();
				CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_322);
				CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_322, 1862763509);
				func_117(&(Local_68.f_8));
				iLocal_82 = 1;
				Local_68.f_17 = GET_GAME_TIMER();
				func_324(&uLocal_44, 0, 0);
			...
			switch (Local_68.f_10)
			{
				...
				case 29:
					if (func_120(Local_68.f_18, GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK_COMBAT_PED(Local_68.f_9, TASK_COMBAT_PED(), 0, 16);
						TASK_SET_SPHERE_DEFENSIVE_AREA(Local_68.f_9, vLocal_338, 30f);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
						Local_68.f_10 = 30;
					}
					break;
				...
				case 13:
					if (func_120(Local_68.f_18, GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (IS_PED_USING_ANY_SCENARIO(Local_68.f_9))
						{
							_0xFE07FF6495D52E2A(Local_68.f_9, vLocal_337);
						}
						GET_CURRENT_PED_WEAPON(Local_68.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
...
void func_383()
{
	if (func_59(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), vLocal_336, 100f))
	{
		if (!func_384())
		{
			REQUEST_CUTSCENE(&vLocal_331, 8);
			func_67();
			iLocal_114 = 1;
		}
	}
	...
	{
		if (!func_59(GET_ENTITY_COORDS(GET_ENTITY_COORDS(), true), vLocal_336, 120f))
		{
			if (HAS_CUTSCENE_LOADED())
			{
				REMOVE_CUTSCENE();
			...
			case 1:
				if (!iLocal_110)
				{
					...
					else
					{
						...
						if (IS_ENTITY_AT_COORD(IS_ENTITY_AT_COORD(), vLocal_336, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (IS_PED_IN_ANY_VEHICLE(IS_PED_IN_ANY_VEHICLE(), 0))
						{
							if (func_112(PLAYER_PED_ID(), vLocal_336, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_112(PLAYER_PED_ID(), vLocal_336, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
		...
		switch (iLocal_60)
		{
			...
			case 1:
				...
				if (!iLocal_109)
				{
					...
					else if ((iLocal_129 > 0 && func_112(Local_68.f_9, vLocal_337, 85f)) || GET_ENTITY_HEALTH(Local_68.f_9) < 200)
					{
						Local_68.f_10 = 13;
						Local_68.f_18 = (GET_GAME_TIMER() - 5000);
						iLocal_136 = GET_GAME_TIMER();
...
int func_424(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_433(PLAYER_PED_ID()) && func_433(iParam0))
	{
...
int func_429(int iParam0, float fParam1)
{
	...
	if (func_433(PLAYER_PED_ID()) && func_433(iParam0))
	{
		if (func_431(iParam0) || IS_PLAYER_TARGETTING_ENTITY(IS_PLAYER_TARGETTING_ENTITY(), iParam0))
		{
...
void func_437(bool bParam0, bool bParam1)
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(iLocal_143, 0);
	CLEAR_PED_NON_CREATION_AREA();
...
void func_449(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_89(iParam0) && DOES_ENTITY_EXIST(*iParam1)) && DOES_ENTITY_EXIST(*iParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_453(*iParam1, 0, &uVar0))
		{
...
int func_453(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_478(iVar0, bParam1, uParam2) && !func_477(PLAYER_ID())) && !func_461(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_459(PLAYER_ID()) && (PLAYER_ID(iVar0) || PLAYER_ID(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_457(iParam0)) && !bVar1) && !(func_456(IS_BIG_VEHICLE(iParam0)) && func_454(IS_BIG_VEHICLE())))
	{
...
{
	if (func_476(PLAYER_ID()) || func_475(PLAYER_ID()))
	{
		if (func_462(iParam0))
		{
			return 1;
...
int func_463(int iParam0)
{
	...
	if (func_464(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_465(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_467(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_478(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_459(PLAYER_ID()) && (PLAYER_ID(iParam0) || PLAYER_ID(iParam0)))
	{
		bVar0 = true;
	}
...
int func_483(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_474(GET_ENTITY_MODEL(*iParam0), 1) && GET_ENTITY_MODEL(*iParam0, 24) != func_486(*iParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*iParam0, 24, func_486(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_485(iParam0);
	if (func_484(*iParam0))
	{
	...
	if (func_511(uParam0))
	{
		...
		if (func_510(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_496(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(ARE_STRINGS_EQUAL(), "startup_positioning"))
				{
...
int func_496(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_498(iParam0, uVar1[iVar3], 1) && func_497(GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_499(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_502(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_501())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_521()
{
	...
	SET_PED_NON_CREATION_AREA(vVar0, vVar1);
	iLocal_143 = ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar1, 0, 1, 1, 1);
	CLEAR_AREA(Local_63, 15f, 0, 0, 0, false);
...
void func_522()
{
	...
	if (func_23(Local_68.f_9))
	{
		...
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		SET_SEQUENCE_TO_REPEAT(iLocal_145, 1);
		CLOSE_SEQUENCE_TASK(iLocal_145);
		TASK_PERFORM_SEQUENCE(Local_68.f_9, iLocal_145);
		CLEAR_SEQUENCE_TASK(&iLocal_145);
	}
		...
		if (func_23(Local_69[iVar0 /*20*/]))
		{
			...
			if (iVar0 == 0)
			{
				...
				if (func_23(Local_69[iVar0 /*20*/]))
				{
					...
					SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Local_69[iVar0 /*20*/], 1);
				}
			}
		}
		iVar0++;
		...
		if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
		{
			if (!IS_PED_INJURED(IS_PED_INJURED()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_549()) || func_548()) || func_542()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(IS_PLAYER_BEING_ARRESTED(), 1) || func_544()) || Global_30738) || func_550()) || func_95(8, -1)) || func_542()) || func_549()) || func_548()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE()) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 1)) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE())) || IS_PLAYER_READY_FOR_CUTSCENE(IS_PLAYER_READY_FOR_CUTSCENE(), 0)) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_542()) || func_549()) || func_548()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5) || Global_41943 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(IS_PED_RAGDOLL()) || IS_PED_RAGDOLL(IS_PED_RAGDOLL())) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 1)) || IS_PED_RAGDOLL(IS_PED_RAGDOLL(), 0)) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_549()) || func_548()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_544() || GET_PLAYER_WANTED_LEVEL(GET_PLAYER_WANTED_LEVEL()) > 0) || func_95(8, -1)) || func_543()) || func_547()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(DOES_ENTITY_EXIST()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT()) > 0) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_544()) || Global_30738) || func_550()) || func_95(8, -1)) || func_548()) || func_542()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || func_544()) || func_548()) || Global_110607) || Global_30738) || func_550()) || Global_42561) || func_95(8, -1)) || func_542()) || func_547()) || func_543()) || Global_111560.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || !IS_PED_IN_COMBAT()) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 0)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT(), 1)) || IS_PED_IN_COMBAT(IS_PED_IN_COMBAT())) || func_544()) || Global_110607) || Global_30738) || func_550()) || func_95(8, -1)) || func_542()) || func_547()) || func_549()) || func_548()) || func_543())
						{
							return 0;
						}
						break;
...
int func_555(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_566())
	{
		...
		{
			iVar2 = func_556(GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
